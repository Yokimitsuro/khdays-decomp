...
typedef struct CollisionObjectVtable {
    ...
    s32 (*testSphere0c)(CollisionObject *, CollCastState *);
...
extern s32 func_01ffe4f4(CollisionFace84 *, CollCastState *);
...
void *func_01ffe82c(CollisionNode *node, CollCastState *query)
{
    void *hit = 0;
...
restart:
    if (node->firstSphereFace04 >= 0) {
        face = &query->faces08[node->firstSphereFace04];
        do {
            if ((face->flags10 & 0x4000) == 0 &&
                func_01ffe4f4(face, query) >= 0) {
                hit = face;
            }
    ...
    if ((query->flags00 & 1) == 0) {
        ...
        while (object != 0) {
            if (object->rejectId28 != (u32)rejectId &&
                ...
                object->vtable1c->testSphere0c(object, query) >= 0) {
    ...
    descentChild = 0xf;
    if ((nodeFlags & 0x1010) != 0) {
        nextFrame->centerX04 = (s32)workValue - quarter;
        descentChild = 0;
        nextFrame->centerZ08 = frame->centerZ08 - quarter;
    } else if ((nodeFlags & 0x2020) != 0) {
        nextFrame->centerX04 = (s32)workValue + quarter;
        descentChild = 1;
        nextFrame->centerZ08 = frame->centerZ08 - quarter;
    } else if ((nodeFlags & 0x4040) != 0) {
        nextFrame->centerX04 = (s32)workValue - quarter;
        descentChild = 2;
        nextFrame->centerZ08 = frame->centerZ08 + quarter;
    } else if ((nodeFlags & 0x8080) != 0) {
        nextFrame->centerX04 = (s32)workValue + quarter;
        descentChild = 3;
        nextFrame->centerZ08 = frame->centerZ08 + quarter;
    }
