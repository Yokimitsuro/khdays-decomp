/* NitroSDK GX_LoadBG2Char -- load BG2 character data for the main engine.
 *
...
void GXS_LoadBG3Char_0x0200788c(const void *src, unsigned int offset, unsigned int size) {
    unsigned char *base = (unsigned char *)G2_GetBG2CharPtr();
