/* NitroSDK GX_LoadBG3Char -- load BG3 character data for the main engine.
 *
...
void GXS_LoadBG3Char_0x0200794c(const void *src, unsigned int offset, unsigned int size) {
    unsigned char *base = (unsigned char *)G2_GetBG3CharPtr();
