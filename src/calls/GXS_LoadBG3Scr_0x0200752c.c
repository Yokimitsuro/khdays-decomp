/* NitroSDK GXS_LoadBG1Scr -- load BG1 screen data for the sub engine.
 *
...
void GXS_LoadBG3Scr_0x0200752c(const void *src, unsigned int offset, unsigned int size) {
    unsigned char *base = (unsigned char *)G2S_GetBG1ScrPtr();
