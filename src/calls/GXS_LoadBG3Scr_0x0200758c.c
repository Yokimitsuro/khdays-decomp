/* NitroSDK GX_LoadBG2Scr -- load BG2 screen data for the main engine.
 *
...
void GXS_LoadBG3Scr_0x0200758c(const void *src, unsigned int offset, unsigned int size) {
    unsigned char *base = (unsigned char *)G2_GetBG2ScrPtr();
