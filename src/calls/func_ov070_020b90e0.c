...
extern void *data_ov070_020b9b28;
extern void *data_ov070_020b9b34;
extern void *data_0203d210;

asm void func_ov070_020b90e0(void)
{
    stmfd   sp!, {r4, r5, r6, lr}
    sub     sp, sp, #0x80
    ldr     r1, =data_ov070_020b9ca0
    mov     r6, r0
    ldr     r0, [r1]
    mov     r4, #0
    add     r0, r0, #0x2c
...
_skipFlag:
    ...
    cmp     r0, #0
    bne     _skipRot
    ldr     r0, =data_ov070_020b9b28
    add     r3, sp, #0x68
    ldmia   r0, {r0, r1, r2}
    stmia   r3, {r0, r1, r2}
    ldr     r12, =data_ov070_020b9b34
    add     r3, sp, #0x5c
    ldmia   r12, {r0, r1, r2}
    stmia   r3, {r0, r1, r2}
    ldr     r0, [r6, #0x20]
