 ...
 * WM_EndKeySharing_0x020cd24c but tail-calls func_ov107_020c7da4. Trust the bytes, not the name. */
extern void *func_ov107_020c7da4();

void *WM_EndKeySharing_0x020cd24c() {
    return func_ov107_020c7da4();
}
