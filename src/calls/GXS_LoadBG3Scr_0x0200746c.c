/* NitroSDK GXS_LoadBG0Scr -- load BG0 screen data for the sub engine.
 *
...
void GXS_LoadBG3Scr_0x0200746c(const void *src, unsigned int offset, unsigned int size) {
    unsigned char *base = (unsigned char *)G2S_GetBG0ScrPtr();
