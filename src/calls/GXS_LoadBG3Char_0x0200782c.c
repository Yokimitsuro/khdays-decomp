/* NitroSDK GXS_LoadBG1Char -- load BG1 character data for the sub engine.
 *
...
void GXS_LoadBG3Char_0x0200782c(const void *src, unsigned int offset, unsigned int size) {
    unsigned char *base = (unsigned char *)G2S_GetBG1CharPtr();
