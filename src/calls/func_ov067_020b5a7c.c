...
extern char data_ov067_020b724c[];
extern char data_ov067_020b725c[];
extern char data_ov067_020b726c[];
extern char data_ov067_020b727c[];
extern char data_ov067_020b72e8[];
...
asm void func_ov067_020b5a7c(void)
{
    push    {r3, r4, r5, lr}
    sub     sp, #0x18
    add     r5, r0, #0
...
_L_019e:
    ...
    lsl     r4, r7, #0x12
    lsl     r0, r0, #0
    dcd     data_ov067_020b72e8
    dcd     func_ov067_020b5ccc
    lsl     r4, r4, #0x19
    lsl     r0, r0, #0
    dcd     func_ov067_020b5d9c
    dcd     func_ov067_020b6050
    dcd     func_ov067_020b5c74
    dcd     func_ov067_020b5cac
    dcd     func_ov067_020b5e0c
    dcd     func_ov067_020b6088
    dcd     func_ov067_020b6b40
    lsl     r4, r2, #0x14
    lsl     r0, r0, #0
    dcd     data_ov067_020b727c
    dcd     data_ov067_020b726c
    lsl     r0, r3, #0x14
    lsl     r0, r0, #0
    dcd     data_ov067_020b725c
    lsl     r4, r3, #0x14
    lsl     r0, r0, #0
    dcd     data_ov067_020b724c
    lsl     r4, r4, #0x14
    lsl     r0, r0, #0
}
