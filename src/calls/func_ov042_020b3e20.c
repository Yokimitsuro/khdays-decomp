...
asm void func_ov042_020b3e20(void)
{
...
_L_00f8:
    ...
    add     r0, r4, #0x2000
    ldr     r0, [r0, #0x644]
    ldr     r2, =data_ov042_020b47c8
    add     r3, sp, #8
    mov     r1, r4
    bl      func_ov022_02091298
    add     r3, r4, #0x2000
    ldr     r0, [r3, #0x644]
    ldr     r1, =func_ov042_020b4094
    ldr     r7, =0x783
    str     r1, [r0, #0x20]
    mov     r5, #0x1000
    mov     ip, #0x1800
    ...
    add     r0, r4, #0x2000
    ldr     r2, [r0, #0x644]
    ldr     r3, =func_ov042_020b4094
    ldr     r1, =func_ov042_020b41a0
    str     r3, [r2, #0x50]
    ldr     r0, [r0, #0x644]
    str     r1, [r0, #0x54]
    add     sp, sp, #0x148
