...
extern char data_ov065_020b7258[];
extern char data_ov065_020b7268[];
extern char data_ov065_020b7278[];
extern char data_ov065_020b7288[];
extern char data_ov065_020b72c8[];
...
asm void func_ov065_020b5a90(void)
{
    push    {r3, r4, r5, lr}
    sub     sp, #0x18
    add     r5, r0, #0
...
_L_01a0:
    ...
    lsl     r4, r7, #0x12
    lsl     r0, r0, #0
    dcd     data_ov065_020b72c8
    dcd     func_ov065_020b5d08
    lsl     r4, r4, #0x19
    lsl     r0, r0, #0
    dcd     func_ov065_020b5e2c
    dcd     func_ov065_020b60b8
    dcd     func_ov065_020b5c88
    dcd     func_ov065_020b5cf4
    dcd     func_ov065_020b5f70
    dcd     func_ov065_020b60ec
    dcd     func_ov065_020b6e2c
    lsl     r4, r2, #0x14
    lsl     r0, r0, #0
    dcd     data_ov065_020b7268
    dcd     data_ov065_020b7258
    lsl     r0, r3, #0x14
    lsl     r0, r0, #0
    dcd     data_ov065_020b7278
    lsl     r4, r3, #0x14
    lsl     r0, r0, #0
    dcd     data_ov065_020b7288
    lsl     r4, r4, #0x14
    lsl     r0, r0, #0
}
