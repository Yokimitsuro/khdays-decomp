/* NitroSDK GXS_LoadBG2Scr -- load BG2 screen data for the sub engine.
 *
...
void GXS_LoadBG3Scr_0x020075ec(const void *src, unsigned int offset, unsigned int size) {
    unsigned char *base = (unsigned char *)G2S_GetBG2ScrPtr();
