/* NitroSDK GXS_LoadBG3Char -- load BG3 character data for the sub engine.
 *
 ...
 * shape-matched all 8 to "GXS_LoadBG3Char". The getter is what identifies it -- G2_* is the main engine,
 * G2S_* the sub engine, and the BGn in the getter is the real BG number. Ghidra carries the
 * correct name (GXS_LoadBG3Char). */
...
void GXS_LoadBG3Char_0x020079ac(const void *src, unsigned int offset, unsigned int size) {
    unsigned char *base = (unsigned char *)G2S_GetBG3CharPtr();
