...
extern void *data_ov031_020b4c48;
extern void *data_ov031_020b4c54;
extern void *data_0203d210;

asm void func_ov031_020b4200(void)
{
    stmfd   sp!, {r4, r5, r6, lr}
    sub     sp, sp, #0x80
    ldr     r1, =data_ov031_020b4dc0
    mov     r6, r0
    ldr     r0, [r1]
    mov     r4, #0
    add     r0, r0, #0x2c
...
_skipFlag:
    ...
    cmp     r0, #0
    bne     _skipRot
    ldr     r0, =data_ov031_020b4c48
    add     r3, sp, #0x68
    ldmia   r0, {r0, r1, r2}
    stmia   r3, {r0, r1, r2}
    ldr     r12, =data_ov031_020b4c54
    add     r3, sp, #0x5c
    ldmia   r12, {r0, r1, r2}
    stmia   r3, {r0, r1, r2}
    ldr     r0, [r6, #0x20]
