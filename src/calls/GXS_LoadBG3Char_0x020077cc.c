/* NitroSDK GX_LoadBG1Char -- load BG1 character data for the main engine.
 *
...
void GXS_LoadBG3Char_0x020077cc(const void *src, unsigned int offset, unsigned int size) {
    unsigned char *base = (unsigned char *)G2_GetBG1CharPtr();
