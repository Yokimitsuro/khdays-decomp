 ...
 * bitfield [24-29] of that node's flags word (+0xc) to `val`. */
void func_02016b60(int obj, unsigned int idx, unsigned int val, int slot) {
    int target;
    ...
    *(unsigned int *)(target + 0xc) = *(unsigned int *)(target + 0xc) & ~0x3f000000U | (val << 24);
}
