/* ov120 actor initializer: install the callback table, seed the camera pose,
 ...
 * which is the only place in ov120 that writes it.
 *
...
extern void func_ov120_020cc238(void);
extern void func_ov120_020cc280(void);
extern void func_ov120_020cc2a4(void);
extern void func_ov120_020cc50c(void);
extern void func_ov120_020cc474(void);
extern void func_ov120_020cc568(void);
extern void func_ov120_020cc7a0(void);
extern void func_ov120_020cc444(void);
...
void func_ov120_020cbfc4(int param)
{
    ...
    kinds = data_ov120_020cdee4;

    *(void **)(param + 0x08) = func_ov120_020cc238;
    *(void **)(param + 0x0c) = func_ov120_020cc280;
    *(void **)(param + 0x1c) = func_ov120_020cc2a4;
    *(void **)(param + 0x30) = func_ov120_020cc50c;
    *(void **)(param + 0x34) = func_ov120_020cc474;
    *(void **)(param + 0x1d0) = func_ov120_020cc568;
    *(void **)(param + 0x1e0) = func_ov120_020cc7a0;
    *(void **)(param + 0x1dc) = func_ov120_020cc444;
    ...
    *(int *)(param + 0x6c) = 0;

    {
        ...
        ((void **)self)[0xe4] = func_0203bee8(self[0xe1], 1, data_ov120_020cdf2c);
        ((void **)self)[0xe5] = func_0203bee8(self[0xe1], 1, data_ov120_020cdf38);
        ((void **)self)[0xe6] = func_0203bee8(self[0xe1], 1, data_ov120_020cdf48);
        ((void **)self)[0xe7] = func_0203bee8(self[0xe1], 1, data_ov120_020cdf58);
        ((char **)self)[0xb3] = (char *)((void **)self)[0xe7] + 0x14;
        ((void **)self)[0xe8] = func_ov107_020c9e50(
            func_ov107_020c9440(self, 1), data_ov120_020cdf60);
