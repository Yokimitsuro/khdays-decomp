/* ov120 pose sync: drop the pending node-slot task (unless the actor is in
...
void func_ov120_020cc474(int self)
{
    ...
    (**(struct Ov120PoseNode ***)(self + 0x388))->xform =
