/* func_ov060_020b5a90 -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov060_020b5d30(void);
extern void func_ov060_020b5e28(void);
extern void func_ov060_020b5e6c(void);
extern void func_ov060_020b5ca4(void);
extern void func_ov060_020b5d10(void);
extern void func_ov060_020b5ef8(void);
extern void func_ov060_020b5e98(void);
extern void func_ov060_020b6bf8(void);
...
void func_ov060_020b5a90(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov060_020b7474, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov060_020b7488, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov060_020b5d30;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov060_020b5e28;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov060_020b5e6c;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov060_020b5ca4;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov060_020b5d10;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov060_020b5ef8;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov060_020b5e98;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov060_020b6bf8;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov060_020b741c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov060_020b743c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov060_020b742c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov060_020b740c) : -1;
