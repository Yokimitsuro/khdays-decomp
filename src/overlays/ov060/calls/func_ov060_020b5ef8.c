...
extern void func_ov060_020b6c78(void);
extern void func_ov060_020b7020(void);

void *func_ov060_020b5ef8(int self, int a) {
    ...
    case 0x21:
        ...
        *(short *)(self + 0x64) = 0x2000;
        ...
        cb = (void *)&func_ov060_020b6c78;
        break;
    case 0x22:
        *(int *)((char *)blk + 0x660) = 0;
        (*(void (**)(int, int))(self + 0x664))(self, 0x30);
        cb = (void *)&func_ov060_020b7020;
        break;
    }
    return cb;
}
