/* c634 state-entry handler: clear obj->f28, run func_ov280_020d0628(self), then
...
extern void func_ov280_020d1d6c(void);
struct b8 { unsigned int f:8; };
void func_ov280_020d1c5c(int self) {
    int obj = *(int *)(self + 4);
    int v;
    *(int *)(obj + 0x28) = 0;
    ...
    *(int *)(obj + 0x18) = v;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov280_020d1d6c);
}
