/* Constructor of the ov280 enemy (variant of ov231/ov232's). Installs the handlers (+8,
 * +0xc draw, +0x1c message, +0x28, +0x2c, +0x30, +0x34 update, +0x1d0 hit filter, +0x1dc, +0x1e0),
 * sets the +0x1fc bounds box (+/-2.0 wide, 4.0 tall), the +0x64 pose (scale 2.56) and bit 3 of
 ...
 * of data_ov280_020d3674 into the +0x3b8 pair table (registered, bit 1 of +0x5c) and spawns the two
 * +0x38c children (func_ov280_020d2d88, bit 2 of their body's +0x5c). Registers actions 0/2, 1/2
 * and 4/2 lifted 1.5 above the +0xb0 point and 2/3 (all at rate 1.54); reserves the +0x22c
...
extern void *func_ov280_020d2d88(void *self);
...
extern void func_ov280_020d009c(void);
extern void func_ov280_020d00f4(void);
extern void func_ov280_020d019c(void);
extern void func_ov280_020d05c4(void);
extern void func_ov280_020d02d0(void);
extern void func_ov280_020d030c(void);
extern void func_ov280_020d0348(void);
extern void func_ov280_020d09a0(void);
extern void func_ov280_020d0118(void);
extern void func_ov280_020d0d3c(void);

void func_ov280_020cfc08(char *self)
{
    ParamBlock params;
    KindTable kinds;
    Placement place;
    ...
    *(void **)(self + 0x8) = (void *)func_ov280_020d009c;
    *(void **)(self + 0xc) = (void *)func_ov280_020d00f4;
    *(void **)(self + 0x1c) = (void *)func_ov280_020d019c;
    *(void **)(self + 0x30) = (void *)func_ov280_020d05c4;
    *(void **)(self + 0x28) = (void *)func_ov280_020d02d0;
    *(void **)(self + 0x2c) = (void *)func_ov280_020d030c;
    *(void **)(self + 0x34) = (void *)func_ov280_020d0348;
    *(void **)(self + 0x1d0) = (void *)func_ov280_020d09a0;
    *(void **)(self + 0x1dc) = (void *)func_ov280_020d0118;
    *(ParamBlock *)(self + 0x1fc) = params;
    *(void **)(self + 0x1e0) = (void *)func_ov280_020d0d3c;
    *(int *)(self + 0x70) = 0x2908;
    *(int *)(self + 0x64) = 0;
    *(int *)(self + 0x68) = 0x2908;
    *(int *)(self + 0x6c) = 0;
    *(u16 *)(self + 0x1ae) |= 8;
    ...
    *(int *)(self + 0x3cc) = func_0203bee8(*(void **)(self + 0x384), 1, data_ov280_020d36cc);
    *(int *)(self + 0x3d0) = func_0203bee8(*(void **)(self + 0x384), 1, data_ov280_020d36d8);
    *(int *)(self + 0x3d4) = func_0203bee8(*(void **)(self + 0x384), 3, data_ov280_020d36e4);
    *(int *)(self + 0x3d8) = func_0203bee8(*(void **)(self + 0x384), 3, data_ov280_020d36f0);
    {
        unsigned int v = *(u16 *)(self + 0x60);
        *(u16 *)(self + 0x60) = (u16)((v & ~0xff00) | ((((v << 0x10) >> 0x18 | 0x40) << 0x18) >> 0x10));
    }
    *(int *)(self + 0x388) = func_ov107_020c9e50(func_ov107_020c9440(self, 0x11), data_ov280_020d36fc);
    *(void **)(self + 0x3b8) = func_0203d15c(0x40);
    ...
    for (i = 0; i < 2; i++) {
        ((void **)(self + 0x38c))[i] = func_ov280_020d2d88(self);
        *(int *)(*(int *)((char *)((void **)(self + 0x38c))[i] + 0x9c) + 0x5c) |= 4;
    }
    lift = *(VecFx32 *)(self + 0xb0);
    lift.y += 0x1800;
    func_ov107_020c92b0(self, 0, 2, &lift, 0x1890);
    func_ov107_020c92b0(self, 1, 2, &lift, 0x1890);
    func_ov107_020c92b0(self, 2, 3, 0, 0x1890);
    func_ov107_020c92b0(self, 4, 2, &lift, 0x1890);
    ...
    box.extent[0] = (int)(((long long)FX_Inv(0x2908, 0x1119) * 0x800 + 0x800) >> 12);
    box.extent[1] = 0x400;
    box.extent[2] = (int)(((long long)FX_Inv(0x2908, 0x1119) * 0x800 + 0x800) >> 12);
