/* Draw pre-pass of the ov280 enemy. The +0xa0 pose is copied to +0x3dc and
 * uniformly scaled by 0x2908/0x1119. Outside sub-state 8 a pending slot-6 effect is finished; a
...
void func_ov280_020d0348(char *self)
{
    ...
    *(Srt *)(self + 0x3dc) = *(Srt *)(self + 0xa0);
    ...
    for (i = 0; i < 3; i++) {
        ...
        case 2:
            ...
            off.x = (int)(((long long)FX_Inv(0x2908, 0x1119) * 0x1000LL + 0x800) >> 12);
            off.y = 0;
