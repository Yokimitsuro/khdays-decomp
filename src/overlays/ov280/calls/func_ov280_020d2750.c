/* func_ov280_020d2750 -- the sweep tick: advance the swept point, test it against the world, and
 * score a hit. Entered from func_ov231_020ce9d0, hands off to func_ov280_020d2890.
 *
 * Past 0x5000 on ctx[8] the tracked point is refreshed (func_ov280_020d0628). The point at
...
extern int func_ov280_020d0890(int self, int a, SweepQuery *q, VecFx32 *pt, int n);
...
extern void func_ov280_020d2890(void);
extern VecFx32 data_02041dc8;

void func_ov280_020d2750(int self) {
    int *ctx;
    SweepQuery q;
    int hit;
    ...
    *(VecFx32 *)((char *)ctx + 0x30) = *(VecFx32 *)((char *)ctx + 0x3c);
    ...
    q.limitA = 0x2000;
    q.limitB = 0x1000;
    if (func_ov280_020d0890(self, 0, &q, (VecFx32 *)((char *)ctx + 0x3c), 3) != 0) {
        ctx[7] += 0x3244;
    ...
    func_ov280_020d0cf4(self, 0xb, 0xb, 0, func_ov280_020d2890);
}
