...
extern void func_ov072_020b98f0(char *self, void *block);
extern void func_ov072_020b99c8(char *self, void *block, int alt);
extern void func_ov072_020b9ab8(char *self, void *block);
extern void func_ov072_020b9d3c(char *self, int prev);   /* the callee ignores the second argument */

void func_ov072_020b8a88(char *self, int mode)
{
    int sec = -1;
    int set = 0;
    int i;
    ...
    *(u8 *)(self + 0x2000 + 0xc30) &= ~4;
    ...
    case 0x2e:
        if (mode != *(int *)(self + 0x6bc)) {
            func_ov072_020b9d3c(self, *(int *)(self + 0x6bc));
        }
        break;
    case 0x2f:
        if (mode != *(int *)(self + 0x6bc)) {
            func_ov072_020b98f0(self, self + 0x278 + 0x2c00);
    ...
    case 0x31:
        if (mode != *(int *)(self + 0x6bc)) {
            ...
            func_ov072_020b9ab8(self, self + 0x278 + 0x2c00);
        }
        set = 4;
        break;
    case 0x32:
        if (mode != *(int *)(self + 0x6bc)) {
            func_ov072_020b99c8(self, self + 0x278 + 0x2c00, set);
        }
        *(u8 *)(self + 0x2000 + 0xc30) |= 4;
        set = 3;
        break;
    case 0x30:
        if (mode != *(int *)(self + 0x6bc)) {
            func_ov072_020b99c8(self, self + 0x278 + 0x2c00, 1);
        }
        *(u8 *)(self + 0x2000 + 0xc30) |= 4;
        set = 3;
        break;
