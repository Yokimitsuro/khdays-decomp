...
extern void func_ov072_020b92bc(int root);
...
extern Params data_ov072_020ba5f0;

void func_ov072_020b8404(char *self)
{
    int root = *(int *)&data_ov072_020ba7a0;
    ...
    func_ov072_020b92bc(root);
    p = data_ov072_020ba5f0;
