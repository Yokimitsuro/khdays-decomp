...
void func_ov072_020b92bc(char *self)
{
...
body:
    ...
    *(char **)(part + 0x74) = part;
    func_02014e18(part + 0x48, func_ov072_020b95ec, 0, 6, 3);
    i++;
test:
    if (i < count) {
        goto body;
    ...
    b = bone(rig);
    *(int *)(self + 0x2e68) = b != 0 ? func_02016f10((void *)b, &data_ov072_020ba648) : -1;
    b = bone(rig);
    *(int *)(self + 0x2e6c) = b != 0 ? func_02016f10((void *)b, &data_ov072_020ba658) : -1;
    b = bone(rig);
    *(int *)(self + 0x2e70) = b != 0 ? func_02016f10((void *)b, &data_ov072_020ba638) : -1;
    b = bone(rig);
    *(int *)(self + 0x2e74) = b != 0 ? func_02016f10((void *)b, &data_ov072_020ba618) : -1;
}
