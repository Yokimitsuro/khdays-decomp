...
extern void func_ov072_020b9ac4(int self, char *block, int rate);
extern void func_ov072_020b9b90(int self, char *block);
...
void func_ov072_020b8e18(int self)
{
    int i;
    int frame;
    int len;
    ...
    func_ov072_020b9ac4(self, (char *)(self + 0x2e78), *(short *)(self + 0x2aba));
    func_ov072_020b9b90(self, (char *)(self + 0x2e78));
