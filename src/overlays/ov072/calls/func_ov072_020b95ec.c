/* Trail draw of the ov072 enemy (twin of ov032 020b470c): the drawing key is the +0xae byte while bit 4 of the +8 flags is set
...
void func_ov072_020b95ec(char *self)
{
    MtxFx33 n;
    MtxFx43 m;
    u32 mode1;
