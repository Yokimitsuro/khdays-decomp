...
extern void func_ov072_020b9c84(int a);
extern int data_ov072_020ba7a0;
extern int data_ov072_020ba75c;

typedef struct { int w[5]; } Params;
extern Params data_ov072_020ba604;

void func_ov072_020b9874(int self)
{
    int base = *(int *)&data_ov072_020ba7a0;
    Params p;
    char *blk;
    ...
    *(int *)blk = 0;
    *(int *)(blk + 4) = 0;
    func_0202a634((int)(blk + 0xc), &data_ov072_020ba75c, 1, *(unsigned char *)(base + 9) + 7);
    p = data_ov072_020ba604;
    func_ov022_02092384(self + 0x2648, *(unsigned char *)(self + 9), 5, &p);
    func_ov072_020b9c84(base);
}
