...
void *func_ov072_020b8578(char *self, int msg)
{
    void *next = 0;
    int force = 0;
    Vec3 d;
    ...
    case 1:
        ...
        *(int *)(self + 0x2000 + 0xe80) = 0;
        ...
        break;
    case 2:
        next = (void *)&func_ov072_020ba40c;
        (*(void (**)(char *, int))(self + 0x664))(self, 0x31);
        break;
    case 3:
        *(u16 *)(self + 0x64) = 0x1800;
        next = (void *)&func_ov072_020ba088;
