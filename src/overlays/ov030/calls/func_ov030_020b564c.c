...
extern void func_ov030_020b3f30(struct Ov044Controller *self);
extern int func_ov030_020b40c0(struct Ov044Controller *self,
...
extern void func_ov030_020b477c(struct Ov044Controller *self, int delta);
extern void func_ov030_020b468c(struct Ov044Controller *self);

void func_ov030_020b564c(struct Ov044Controller *self, int delta)
{
...
afterSpawn:
    ...
    i = 0;
    do {
        if (func_ov030_020b40c0(self, motion, delta) != 0) {
            active = 1;
        }
        i++;
        motion++;
...
afterAnimation:
    ...
    func_ov030_020b477c(self, delta);
    func_ov030_020b468c(self);
}
