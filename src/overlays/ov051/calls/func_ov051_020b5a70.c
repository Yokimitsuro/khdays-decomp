/* func_ov051_020b5a70 -- overlay boot of the ov033 enemy (x4: ov033/051/071/089): the ov042 shape (see
...
extern int data_ov051_020b7314;
extern int data_ov051_020b7328;
extern int data_ov051_020b72a8;
extern int data_ov051_020b72c8;
extern int data_ov051_020b72b8;
extern int data_ov051_020b72e8;
extern int data_ov051_020b72d8;
...
void func_ov051_020b5a70(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov051_020b7314, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov051_020b7328, 1, cfg[0] + 7);
    }
    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov051_020b5e4c;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov051_020b5f10;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov051_020b60e0;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov051_020b5cac;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov051_020b5ce4;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov051_020b6170;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov051_020b5d0c;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov051_020b62bc;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov051_020b72a8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov051_020b72c8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x514) = b != 0 ? func_02016f10((void *)b, &data_ov051_020b72b8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov051_020b72e8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov051_020b72d8) : -1;
    if (cfg[3] != 0) {
        *(long long *)obj |= 0x20;
    }
    if (cfg[4] != 0) {
