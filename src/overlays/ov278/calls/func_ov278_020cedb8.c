...
int func_ov278_020cedb8(char *self, int src, unsigned int *hit)
{
    ...
    if ((int)hit[10] > 0) {
        if (!((((struct HitWord *)hit)->lo & 8) != 0 && (((struct HitWord *)hit)->lo & 0x80) != 0 && ((struct HitWord *)hit)->hi == 0x80)) {
            if ((((struct HitWord *)hit)->lo & 0x22) != 0) {
                ...
                func_ov107_020c5af8(self, 0x166, (((struct Parity *)((u8 *)state + 0x50))->b0 & 1) ? 2 : 3, (void *)state[0xe]);
            } else {
                ((struct Parity *)((u8 *)state + 0x50))->b0++;
                func_ov107_020c5af8(self, 0x166, (((struct Parity *)((u8 *)state + 0x50))->b0 & 1) ? 0 : 1, (void *)state[0xe]);
            }
        }
    }
    return 1;
