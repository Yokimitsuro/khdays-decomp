/* Charge entry of the ov278 mount: notes whether each rider (+0x3b4 / +0x3b8) is free (bit 1 of its
...
extern void func_ov278_020d058c(void);

void func_ov278_020d0480(int *node)
{
    int v;
    ...
    *(int *)(*state + 0x54) = 0x3000;
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov278_020d058c);
}
