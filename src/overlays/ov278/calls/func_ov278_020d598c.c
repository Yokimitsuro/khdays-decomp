 ...
 * acceptance the 14-byte message data_ov278_020d6424 carries its +0x74 point raised by 0.5 and its
 * +0x1b4 byte to the rider's +0x24 hook, and reaction 0x166 mode 0xd fires at that raised point.
...
extern const Cmd14 data_ov278_020d6424;

void func_ov278_020d598c(int *node)
{
    Cmd4 note1;
    Cmd4 note2;
    ...
    if (*((u8 *)state + 0x7c) == 0) {
        ...
        *((u8 *)state + 0x7c) = 1;
        ...
        }
        {
            ...
            p->hi = data_ov278_020d63e4[2].hi;
            p->lo = data_ov278_020d63e4[2].lo;
        ...
        *((u8 *)state + 0x7c) = 0;
        ...
        }
        {
            ...
            p->hi = data_ov278_020d63e4[3].hi;
            p->lo = data_ov278_020d63e4[3].lo;
            if (*(void (**)(int, Cmd4 *, int))(*state + 0x24) != 0) {
                (*(void (**)(int, Cmd4 *, int))(*state + 0x24))(*state, p, 4);
            }
        }
