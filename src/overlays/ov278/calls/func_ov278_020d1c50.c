...
extern void func_ov278_020d1d4c(void);
extern void func_ov278_020d2024(void);

void func_ov278_020d1c50(int *node) {
    ...
    *(signed char *)(*state + 0x1c7) = zero - 1;
    ...
    func_0203c634(node, 1, func_ov278_020d20e4);
    func_0203c634(node, 0, func_ov278_020d1d4c);
    func_0203c634(node, 2, func_ov278_020d2024);
}
