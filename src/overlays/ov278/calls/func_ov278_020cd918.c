...
extern void func_ov278_020cda7c(int self);
extern void func_0203c7ac(int a, int b);
struct Buf17 { int w[17]; };
extern const struct Buf17 data_ov278_020d62dc;

void func_ov278_020cd918(int self, int slot, int flag) {
    struct Buf17 buf = data_ov278_020d62dc;
    int i;
    int owner;
    int kind;
