 ...
 * either of the actor's +0x3d0 / +0x3d2 rider counters is empty, the cue at data_ov278_020d63e4
...
extern unsigned short data_ov278_020d63e4[];

void func_ov278_020d5758(int *node) {
    ...
    if (*(short *)(*state + 0x300 + 0xd0) == 0 || *(short *)(*state + 0x300 + 0xd2) == 0) {
        pair[1] = data_ov278_020d63e4[15];
        pair[0] = data_ov278_020d63e4[14];
