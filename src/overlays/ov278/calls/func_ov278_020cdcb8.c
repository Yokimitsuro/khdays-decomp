 ...
 * the four hidden sub-items of data_ov278_020d6320 into the +0x3cc pair table. Four capsules
...
extern void func_ov278_020ce1c0(void);
extern void func_ov278_020ce230(void);
extern void func_ov278_020ce2d0(void);
...
extern void func_ov278_020ce820(void);
...
extern IdTable4 data_ov278_020d6320;
extern char data_ov278_020d64a0[];
extern char data_ov278_020d64ac[];
extern char data_ov278_020d64b8[];
extern char data_ov278_020d64c4[];
extern const char data_ov278_020d64d0[];
...
void func_ov278_020cdcb8(char *self)
{
    IdTable4 ids = data_ov278_020d6320;
    Capsule cap;
    Vec3 axisY;
    Vec3 axisZ;
    Vec3 axisX;
    ...
    *(Callback *)(self + 0x8) = func_ov278_020ce1c0;
    *(Callback *)(self + 0xc) = func_ov278_020ce230;
    *(Callback *)(self + 0x10) = func_ov278_020ce2d0;
    ...
    *(Callback *)(self + 0x1dc) = func_ov278_020ce820;
    ...
    *(int *)(self + 0x3a8) = func_0203bee8(*(int *)(self + 0x388), 1, data_ov278_020d64a0);
    *(int *)(self + 0x3ac) = func_0203bee8(*(int *)(self + 0x388), 3, data_ov278_020d64ac);
    *(int *)(self + 0x3b0) = func_0203bee8(*(int *)(self + 0x388), 1, data_ov278_020d64b8);
    *(int *)(self + 0x3b4) = func_0203bee8(*(int *)(self + 0x388), 3, data_ov278_020d64c4);
    *(int *)(self + 0x3b8) = func_0203bee8(*(int *)(self + 0x388), 3, data_ov278_020d64a0);
    *(int *)(self + 0x3bc) = func_0203bee8(*(int *)(self + 0x388), 3, data_ov278_020d64b8);
    ...
    *(int *)(self + 0x3c8) = func_ov107_020c9e50(func_ov107_020c9440(*(int *)(self + 0x384), 0x3f), data_ov278_020d64d0);
