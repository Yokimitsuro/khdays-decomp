...
extern void func_ov278_020ce984(int self);
extern void func_0203c7ac(int a, int b);
struct Buf17 { int w[17]; };
extern const struct Buf17 data_ov278_020d6330;

void func_ov278_020ce820(int self, int slot, int flag) {
    struct Buf17 buf = data_ov278_020d6330;
    int i;
    int owner;
    int kind;
