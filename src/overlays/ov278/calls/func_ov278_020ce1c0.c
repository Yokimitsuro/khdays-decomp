...
void func_ov278_020ce1c0(int param_1) {
    int i;
    func_0202a440(*(int *)(param_1 + 0x38c));
    func_0203d194(*(int *)(param_1 + 0x38c));
    func_0202a440(*(int *)(param_1 + 0x394));
    func_0203d194(*(int *)(param_1 + 0x394));
    func_0203c7e8(*(int *)(param_1 + 0x388));
    func_ov107_020c9eac(*(int *)(param_1 + 0x3c8));
    func_0203c7e8(*(int *)(param_1 + 0x390));
    for (i = 0; i < 4; i++)
        func_0203c7e8(((struct row8 *)*(int *)(param_1 + 0x3cc))[i].p);
    func_0203d194(*(int *)(param_1 + 0x3cc));
