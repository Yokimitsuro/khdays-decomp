...
extern void func_ov278_020d0700(int actor, int rider);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_ov107_020c9264(int actor, int pose, int flag);
extern void func_ov278_020d0a30(void);

void func_ov278_020d08b0(int *node) {
    ...
    if (state[0xa] >= 0x6800) {
        ...
        *(unsigned char *)(*state + 0x3bd) = 1;
        func_ov278_020d0700(*(int *)(*state + 0x3b4), 0);
        func_ov278_020d0700(*(int *)(*state + 0x3b8), 1);
        state[5] = 0;
    ...
    if (((struct Bits3bc *)(*state + 0x3bc))->b0 != 0) {
        ...
        *((unsigned char *)state + 0x51) = 0;
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov278_020d0a30);
        return;
    }
    state[5] = 0;
