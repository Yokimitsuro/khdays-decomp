...
extern void func_ov278_020d3c44(void);
extern void func_ov278_020d3f04(void);

void func_ov278_020d3b54(int *node) {
    ...
    *(signed char *)(*state + 0x1c7) = zero - 1;
    ...
    func_0203c634(node, 1, func_ov278_020d3fc4);
    func_0203c634(node, 0, func_ov278_020d3c44);
    func_0203c634(node, 2, func_ov278_020d3f04);
}
