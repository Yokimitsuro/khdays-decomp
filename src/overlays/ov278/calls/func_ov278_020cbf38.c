...
extern const char data_ov278_020d6460[];
extern void func_ov278_020cc154(int);
int func_ov278_020cbf38(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x3c8);
    *(signed char *)(obj + 0x19c) = 99;
    OS_SPrintf(buf, data_ov278_020d6460, 99);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov278_020cc154;
