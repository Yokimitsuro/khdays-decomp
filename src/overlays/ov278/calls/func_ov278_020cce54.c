 ...
 * data_ov278_020d62c8 into the +0x3b8 pair table. Two capsules (length 1.5, radius 0.5, along the
...
extern void func_ov278_020cd300(void);
extern void func_ov278_020cd368(void);
extern void func_ov278_020cd450(void);
extern void func_ov278_020cd508(void);
extern void func_ov278_020cd5a0(void);
extern void func_ov278_020d17fc(void);
extern void func_ov278_020cd780(void);
extern void func_ov278_020cd8cc(void);
extern void func_ov278_020cd834(void);
extern void func_ov278_020d1848(void);
extern void func_ov278_020cd918(void);
...
extern IdTable5 data_ov278_020d62c8;
extern char data_ov278_020d6488[];
extern char data_ov278_020d6494[];
...
void func_ov278_020cce54(char *self)
{
    IdTable5 ids = data_ov278_020d62c8;
    Capsule cap;
    Vec3 zero;
    u16 hw;
    int i;
    ...
    *(Callback *)(self + 0x8) = func_ov278_020cd300;
    *(Callback *)(self + 0xc) = func_ov278_020cd368;
    *(Callback *)(self + 0x10) = func_ov278_020cd450;
    *(Callback *)(self + 0x20) = func_ov278_020cd508;
    *(Callback *)(self + 0x1c) = func_ov278_020cd5a0;
    *(Callback *)(self + 0x30) = func_ov278_020d17fc;
    *(Callback *)(self + 0x34) = func_ov278_020cd780;
    *(Callback *)(self + 0x28) = func_ov278_020cd8cc;
    *(Callback *)(self + 0x1d4) = func_ov278_020cd834;
    *(Callback *)(self + 0x1d0) = func_ov278_020d1848;
    *(Callback *)(self + 0x1dc) = func_ov278_020cd918;
    ...
    *(int *)(self + 0x3a0) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov278_020d6488);
    *(int *)(self + 0x3a4) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov278_020d6494);
    *(int *)(self + 0x3a8) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov278_020d6488);
    *(int *)(self + 0x3ac) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov278_020d6494);
