...
extern const struct tbl8 data_ov132_020d0dcc;

void func_ov132_020ce4ac(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov132_020ce4ac(newcenter, half, child, param_4,
