 ...
 * 0x5000, and chain to the next state func_ov215_020d1b64.
 *
...
extern void func_ov215_020d1b64(void);

void func_ov215_020d1a24(int param_1) {
    ...
    *(int *)((char *)node + 0x60) = 0;
    func_0203c634(param_1, *(signed char *)((char *)param_1 + 0x20), &func_ov215_020d1b64);
}
