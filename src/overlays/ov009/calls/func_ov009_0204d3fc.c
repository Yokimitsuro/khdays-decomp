/*
 * func_ov009_0204d3fc -- x3 (ov008/...). Wait for the load to finish, then advance the screen phase.
...
extern void func_ov009_0204e82c(int obj);
...
void func_ov009_0204d3fc(void) {
    int ctx;

    func_ov009_0204e750(*(int *)(data_ov009_020563e4[1] + 0x959c));
    func_ov009_0204e82c(*(int *)(data_ov009_020563e4[1] + 0x95a0));
    ctx = data_ov009_020563e4[1];
    if ((((unsigned int)*(int *)(ctx + 0x95f0) << 0x1d) >> 0x1f) == 0) {
        return;
    }
    if (*(int *)(ctx + 0x95c4) == -1) {
        if (data_ov009_020563e4[0] != 0 && *(int *)(ctx + 0x960c) == 0) {
            func_020336a4(5);
            *(int *)(data_ov009_020563e4[1] + 0x960c) = 1;
        }
        if (func_02034014(1)) {
            return;
        }
        if (data_ov009_020563e4[0] != 0 && func_02033cc8() != 0) {
            return;
        }
        func_ov009_0204e3d8();
