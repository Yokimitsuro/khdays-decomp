 ...
 * param_4(rec, param_3) is nonzero, build a node via func_ov009_02054f30 and append it
...
unsigned short func_ov009_02055354(int param_1, unsigned short *param_2, int param_3,
    ...
    for (i = 0; i < count; i++) {
        if (param_4(param_2, param_3)) {
            int *node = func_ov009_02054f30(param_2, (short *)(param_2 + 0x18));
