...
extern void func_ov009_020517cc(int self, int obj, int arg);
extern void NNSi_FndFreeFromDefaultHeap(void *obj);
void func_ov009_0205180c(int param_1, int param_2, int param_3) {
    int obj = func_0201ef9c(param_2, 0xe);
    func_ov009_020517cc(param_1, obj, param_3);
