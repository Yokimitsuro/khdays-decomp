...
extern int func_ov009_020559ac(int a, void *buf, int size);
...
extern void func_ov009_02055aec(int a, int b, int c);
...
int func_ov009_02055e18(int slot) {
    int probe;
    int *pCounter;
    long long elapsed;
    ...
    func_02020904();
    if (func_ov009_020559ac(0, &probe, 1) != 0) {
    ...
    *(int *)data_0204be14 = 0xc8f592a6;
    ...
    func_ov009_02055aec((data_ov009_020563f8.slot << 1) * 0x2018 + 0x20,
