...
extern void func_ov009_0204f128(void *ctx, void *node, unsigned int sx, unsigned int sy, int flag);
extern void func_ov009_0204f404(DrawParams *p, void *block);

void func_ov009_0204f5ac(void *ctx, DrawParams *p, char *block, int flag) {
    int i;
    int sx = p->sx;
    int sy = p->sy;
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (i == 0) {
            func_ov009_0204f128(ctx, *(void **)(row + 0x34),
