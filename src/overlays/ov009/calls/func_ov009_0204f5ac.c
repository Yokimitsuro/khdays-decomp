...
extern void func_ov009_0204f128(void *owner, int id, unsigned int qtyA, unsigned int qtyB, int flag);
extern void func_ov009_0204f404(TallyParams *p, void *block);

void func_ov009_0204f5ac(void *owner, TallyParams *p, char *block, int flag) {
    int i;
    int scaleA = p->scaleA;
    int scaleB = p->scaleB;
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (i == 0) {
            func_ov009_0204f128(owner, *(int *)(row + 0x34),
