/* func_ov009_020527c0 -- copy the active touch/hit entry into the menu's cursor record, ov009.
...
extern int  data_ov009_020563f4;

void func_ov009_020527c0(void) {
    ...
    for (i = n1; i >= 0; i--) {
        if (buf[i].w[3] == 0) {
            MI_CpuCopy8((unsigned short *)&buf[i], (unsigned short *)data_ov009_020563f4, 8);
            return;
        }
    }
    MI_CpuCopy8((unsigned short *)&buf[n1], (unsigned short *)data_ov009_020563f4, 8);
}
