...
extern void func_ov009_0204f020(void *ctx, void *obj, int a, int b, int flag);
extern void func_ov009_0204f404(Params *p, void *block);

void func_ov009_0204f54c(void *ctx, Params *p, char *block) {
    int one = 1;
    int i;
    int a = p->a;
    ...
    for (i = 0; i < 4; i++) {
        ...
        func_ov009_0204f020(ctx, *(void **)(row + 0x34), a, p->b, one);
    }
