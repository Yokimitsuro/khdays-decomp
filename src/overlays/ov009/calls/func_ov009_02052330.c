...
extern int func_ov009_02051dc4(int a);
extern void MI_CpuFill8(void *dst, int val, int size);
extern int func_ov009_02051d74(int a, int b);
int func_ov009_02052330(int a, int b, unsigned short c, unsigned short d, unsigned short e,
                        short f, short g, int h) {
    int obj = func_ov009_02051dc4(a);
    ...
    *(short *)(obj + 0xa) = f;
    *(short *)(obj + 0xc) = g;
    *(int *)(obj + 0x18) = func_ov009_02051d74(a, b);
    *(int *)(obj + 0x14) = 1;
    return obj;
}
