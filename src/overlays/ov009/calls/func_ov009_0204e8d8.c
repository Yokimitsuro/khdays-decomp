/* func_ov009_0204e8d8 -- forward an input event to a pair of ov008 menu handler slots.
...
int func_ov009_0204e8d8(int param_1, int param_2) {
    int r = 0;
    void *m1 = *(void **)(data_ov009_020562dc[data_ov009_020563ec[0]].obj + 0x18);
    if (param_1 != 0) {
        r = func_ov009_0204e640(m1, param_1);
    }
    if (r == 0) {
        void *m2 = *(void **)(data_ov009_020562d4[data_ov009_020563ec[1]].obj + 0x14);
        if (param_2 != 0) {
