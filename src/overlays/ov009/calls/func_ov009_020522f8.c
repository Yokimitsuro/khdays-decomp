...
extern void func_ov009_02051c58(int ctx, int section);
extern void func_ov009_02051c98(int ctx, int section);
extern void func_ov009_02051d00(int ctx, int section);
extern void NNSi_FndFreeFromDefaultHeap(int ptr);
void func_ov009_020522f8(int ctx, int param2) {
    int *buf = (int *)func_0201ef9c(param2, 0xe);
    int a = buf[0], c = buf[2], b = buf[1];
    func_ov009_02051c58(ctx, (int)buf + a);
    func_ov009_02051c98(ctx, (int)buf + b);
    func_ov009_02051d00(ctx, (int)buf + c);
    if (buf != 0) {
