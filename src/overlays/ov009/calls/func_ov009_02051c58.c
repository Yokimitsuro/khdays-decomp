...
extern void func_ov009_02052530(int owner, void *obj, unsigned short kind);
void func_ov009_02051c58(int param_1, int param_2) {
    ...
    for (i = 0; i < n; i++) {
        ...
        func_ov009_02052530(param_1, obj, *(unsigned short *)(p + 4));
        p += *(int *)p;
    }
}
