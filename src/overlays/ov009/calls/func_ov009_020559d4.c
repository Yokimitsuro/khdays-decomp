/* func_ov009_020559d4 -- write the pending save block to backup memory, 0x80 bytes at a time.
 ...
 * (data_ov009_020563f8+4) and in the context's own slot (+0x2cc); a clean run leaves that slot 0.
...
extern int data_ov009_020563f8[];

void func_ov009_020559d4(int ctx) {
    int src;
    int len;
    int dst;
    int chunk;
