...
extern void func_ov009_02050570(int *self);
extern int func_ov009_0204ee50(int a);
...
extern void func_ov009_0204fcc4(int *self, int a, void *node, int idx);
extern void func_ov009_02050238(int *self, int base, int a, int b, unsigned long long *m);

struct Pair { int a, b; };
struct Self { char pad[0xcc]; struct Pair pairs[3]; };
extern void func_ov009_0204eedc(void *p);

void func_ov009_020507e0(int *self, int base, void *list, int p4) {
    ...
    func_ov009_02050570(self);
    tc = func_ov009_0204ee50(0);
    self[0x3d] = 0;
    self[0x3c] = 0;
    self[0x3a] = 0;
    ...
    for (node = NNS_FndGetNextListObject(list, 0); node != 0;
        ...
        func_ov009_0204fcc4(self, *(unsigned short *)((char *)node + 0xa) * 0xa0 + base, node,
    ...
    for (k = 0; k < 3; k++, base += 0xa0) {
        func_ov009_02050238(self, base, ((struct Self *)self)->pairs[k].a,
    ...
    func_ov009_0204eedc((char *)self + 0x2c);
    if (self[0x3a] != 0) {
        func_02034258(0x13);
        self[0x3a] = 0;
    }
