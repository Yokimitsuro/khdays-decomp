...
extern void func_ov009_02052750(int a, void *b);
extern int func_0201ef9c(int a, int b);
extern void func_ov009_02055564(int a, int b, int c);
extern int data_ov009_02056398;
void func_ov009_02055618(int param_1, int param_2) {
    MI_CpuFill8((void *)param_1, 0, 0x24);
    NNS_FndInitList(param_1 + 0x18, 0x4c);
    func_ov009_02052750(param_1, &data_ov009_02056398);
    *(int *)(param_1 + 0xc) = *(int *)(param_2 + 8);
    *(int *)(param_1 + 0x14) = func_0201ef9c(*(int *)param_2, 0xe);
    func_ov009_02055564(param_1, *(int *)(param_2 + 8), *(int *)(param_2 + 4));
}
