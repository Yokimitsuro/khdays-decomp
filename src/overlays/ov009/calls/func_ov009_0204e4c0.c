/*
 * func_ov009_0204e4c0 -- x3 (ov008/...). Remove one object from the shared UI list and free it.
...
void func_ov009_0204e4c0(void *obj) {
    void *node = NNS_FndGetNextListObject((void *)(data_ov009_020563e4[1] + 0x9660), 0);
    ...
    for (;;) {
        if (node == obj) {
            NNS_FndRemoveListObject((void *)(data_ov009_020563e4[1] + 0x9660), obj);
            if (obj != 0) {
                NNSi_FndFreeFromDefaultHeap(obj);
            }
            return;
        }
        node = NNS_FndGetNextListObject((void *)(data_ov009_020563e4[1] + 0x9660), node);
        if (node == 0) {
            return;
        }
    }
