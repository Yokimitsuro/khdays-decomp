 ...
 * 1 and 6 set the pending flag. Both paths acknowledge the input latch. */
void func_ov009_0205388c(Ov009SaveContext *element)
{
    ...
    case 0:
        ...
        element->variant = 0;
        func_ov009_02052b58(element, variant, 0);
        func_02033b78(0, 0);
        break;
