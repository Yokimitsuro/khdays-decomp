...
extern void func_ov157_020cff14(void);
extern void func_ov157_020cff54(void);
extern void func_ov157_020cff8c(void);
extern void func_ov157_020d0040(void);
extern void func_ov157_020d00a0(void);
...
void func_ov157_020cfd38(char *self)
{
    struct KindPair kinds;
    u16 hw;
    int i;
    kinds = data_ov157_020d0bc4;
    *(Callback *)(self + 0x8) = func_ov157_020cff14;
    *(Callback *)(self + 0xc) = func_ov157_020cff54;
    *(Callback *)(self + 0x1c) = func_ov157_020cff8c;
    *(Callback *)(self + 0x30) = func_ov157_020d00a0;
    *(Callback *)(self + 0x1d0) = func_ov157_020d0040;
    hw = *(u16 *)(self + 0x60);
