/* Message handler of the ov156 enemy (and its byte-identical twins). A "spawned" message (kind 5): sub 0
 * attaches the first two models of the +0x3a0 set to the actor's +0x3a8 placement (mode 0x17);
...
void func_ov157_020ce1ec(int owner, unsigned char *command, int arg)
{
    ...
    if (command[2] == 5) {
        switch (command[3]) {
        case 0:
            (*(int **)(owner + 0x3a0))[1] = func_ov107_020c09a0(*(int *)(owner + 0x3c), (*(int **)(owner + 0x3a0))[0], 0x17, (void *)(owner + 0x3a8), 0, 0);
            (*(int **)(owner + 0x3a0))[3] = func_ov107_020c09a0(*(int *)(owner + 0x3c), (*(int **)(owner + 0x3a0))[2], 0x17, (void *)(owner + 0x3a8), 0, 0);
            break;
        case 1:
