...
extern void func_ov157_020cfcc4(int item, void *from, Vec3 *dir);
extern int func_02023eb4(int bound);
extern void func_0203c634(int *node, int slot, void *cb);

void func_ov157_020cf3bc(int *node)
{
        ...
        *(unsigned char *)(state + 0xe) = 1;
        ...
        for (i = 0; i < 2; i++) {
            if ((((struct hw60 *)((*(int **)(*state + 0x3a4))[i] + 0x60))->lo & 1) == 0) {
                func_ov157_020cfcc4((*(int **)(*state + 0x3a4))[i], (void *)(*(int *)(*state + 0x39c) + 0x14), &dir);
                break;
            }
        }
    }
