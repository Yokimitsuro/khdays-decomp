/*
 * func_ov157_020cf9f4 -- MATCHED (408/408 bytes, 102 instrs). x5 family.
...
extern int func_ov157_020cfb8c;

void func_ov157_020cf9f4(int *self) {
    ...
    *(unsigned char *)((int)state + 0x39) &= ~2;
    ...
    if (c - 1 <= 0) {
        ...
        func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov157_020cfb8c);
        return;
    }
