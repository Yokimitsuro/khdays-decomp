/*
 * func_ov126_020d142c -- x3. AI-state tick: fire, roll a random strafe sign, dispatch.
...
extern void func_ov126_020d1480(void);

void func_ov126_020d142c(int *self) {
    ...
    state[0xb] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov126_020d1480);
}
