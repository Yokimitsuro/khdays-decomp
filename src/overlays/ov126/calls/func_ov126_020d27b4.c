...
extern Cmd14 data_ov126_020d401c;
...
void func_ov126_020d27b4(int *node)
{
    ...
    func_01ffa724(-0x100, (Vec3 *)(*OS_IsThreadAvailable_0x020c9848() + 0x7c), &pull);
...
scaled:
    func_0203ca50((void *)(state[1] + 4), 0x2000, FX_Mul(nLen, 0x3333), 0x2000);
    if (bHit2 != 0 || bHit1 != 0) {
