...
extern void func_ov126_020d24f4(void);
extern void func_ov126_020d2de8(void);

void func_ov126_020d239c(int *node) {
    ...
    switch (p->cur) {
    case 0:
        func_0203c634(node, 1, func_ov126_020d248c);
        break;
    case 1:
        func_0203c634(node, 1, func_ov126_020d24f4);
        break;
    case 2:
        func_0203c634(node, 1, func_ov126_020d2de8);
        break;
    }
    p->next = -1;
}
