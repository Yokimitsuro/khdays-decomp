/*
 * func_ov126_020d25d8 -- aim wind-up tick. Recompute the aim point (anchor midpoint pulled 0x100
...
extern void func_ov126_020d27b4(void);

void func_ov126_020d25d8(int *self) {
    ...
    *(int *)(state[1] + 0x5c) &= ~2;
    ...
    state[0xc] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov126_020d27b4);
}
