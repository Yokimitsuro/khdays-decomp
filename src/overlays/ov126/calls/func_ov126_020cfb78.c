...
extern const char data_ov126_020d4080[];
extern void func_ov126_020cfc04(int);
int func_ov126_020cfb78(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x3b0);
    *(signed char *)(obj + 0x19c) = 6;
    OS_SPrintf(buf, data_ov126_020d4080, 6);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov126_020cfc04;
