...
extern void func_ov126_020d0764(void);
extern void func_ov126_020d0930(void);
void func_ov126_020d0690(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(struct vec4 *)(obj + 0x1a) = *(struct vec4 *)(obj + 0x16);
    ...
    func_0203c634(self, 0, &func_ov126_020d0764);
    func_0203c634(self, 2, &func_ov126_020d0930);
}
