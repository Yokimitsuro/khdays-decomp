/*
 * func_ov126_020d24f4 -- AI-state entry: aim the sub-node at the anchor midpoint, arm it,
...
extern void func_ov126_020d25d8(void);

void func_ov126_020d24f4(int *self) {
    ...
    *(int *)(state[4] + 0x5c) &= ~2;
    ...
    state[0xc] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov126_020d25d8);
}
