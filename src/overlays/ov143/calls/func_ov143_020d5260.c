...
extern void func_ov143_020d5408(void);
extern void func_ov143_020d5448(void);
extern void func_ov143_020d5480(void);
extern void func_ov143_020d5590(void);
extern void func_ov143_020d5534(void);

extern void *func_ov107_020c9440(struct Ov143SubObj *owner, int index);
extern struct Ov143Subitem *func_0203b898(void *item);
extern void func_0203bfb4(struct Ov143Subitem *subscriber, struct Ov143Subitem *item);
extern void func_0203b9fc(struct Ov143Subitem *item, int state, int zero, int enabled);
extern void func_0203c7ac(struct Ov143Subitem *item, int value);
extern void *func_0203d15c(int size);
extern void func_ov107_020c9074(struct Ov143SubObj *owner, struct Ov143Subitem *item);
extern struct Ov143PoolEntry *func_01fffca8(void *pool, int elementSize, int capacity);
extern int func_ov107_020c319c(void *camera);

void func_ov143_020d5260(struct Ov143SubObj *self)
{
    struct Ov143ChildIds ids = data_ov143_020d625c;
    unsigned int flags;
    int i;

    self->fn08 = func_ov143_020d5408;
    self->fn0c = func_ov143_020d5448;
    self->fn1c = func_ov143_020d5480;
    self->fn30 = func_ov143_020d5590;
    self->fn1d0 = func_ov143_020d5534;
