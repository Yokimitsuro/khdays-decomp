...
extern void func_ov143_020d60d0(void);
extern void func_ov143_020d621c(void);
void func_ov143_020d613c(int *node) {
    void *cb = (void *)func_ov143_020d60d0;
    ...
    *(unsigned int *)(state[1] + 0x5c) &= ~2;
    func_0203c634(node, *(signed char *)(node + 8), func_ov143_020d621c);
}
