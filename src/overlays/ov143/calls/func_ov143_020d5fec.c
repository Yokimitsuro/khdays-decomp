...
extern void func_ov143_020d613c(void);
extern void func_ov143_020d61e4(void);
int func_ov143_020d5fec(int param_1, int param_2) {
    int *local_28;
    int iVar1 = func_0203c5c0(*(int *)(param_1 + 0x3c), 0x64, 0x48,
                              func_ov143_020d613c, func_ov143_020d61e4, &local_28);
    int iVar5 = 0;
    *local_28 = param_1;
