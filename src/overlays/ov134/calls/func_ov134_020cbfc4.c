...
extern void func_ov134_020cc228(void), func_ov134_020cc270(void), func_ov134_020cc2c4(void);
extern void func_ov134_020cc544(void), func_ov134_020cc448(void), func_ov134_020cc5a0(void);
extern void func_ov134_020cc7f8(void), func_ov134_020cc294(void);
...
void func_ov134_020cbfc4(int param_1) {
    struct v5 tbl;
    struct { struct v3 t; int scale; } g;
    int i;
    tbl = data_ov134_020cdf78;
    *(void **)(param_1 + 8) = func_ov134_020cc228;
    *(void **)(param_1 + 0xc) = func_ov134_020cc270;
    *(void **)(param_1 + 0x1c) = func_ov134_020cc2c4;
    *(void **)(param_1 + 0x30) = func_ov134_020cc544;
    *(void **)(param_1 + 0x34) = func_ov134_020cc448;
    *(void **)(param_1 + 0x1d0) = func_ov134_020cc5a0;
    *(void **)(param_1 + 0x1e0) = func_ov134_020cc7f8;
    *(void **)(param_1 + 0x1dc) = func_ov134_020cc294;
    ...
    *(void **)(param_1 + 0x394) = func_0203bee8(*(int *)(param_1 + 0x384), 1, data_ov134_020cdfec);
    *(void **)(param_1 + 0x3a0) = func_ov107_020c9e50(func_ov107_020c9440(param_1, 1), &data_ov134_020cdff8);
    ...
    *(void **)(param_1 + 0x398) = func_0203bee8((int)((struct slot *)*(int *)(param_1 + 0x3a4))[0].ptr, 1, data_ov134_020ce000);
    *(void **)(param_1 + 0x39c) = func_0203bee8((int)((struct slot *)*(int *)(param_1 + 0x3a4))[0].ptr, 1, data_ov134_020ce004);
    g.t = data_02041dc8;
    g.scale = 0x99a;
