/*
 * func_ov134_020cd52c -- burst attack tick of the ov134 enemy (and its byte-identical twins).
 *
...
void func_ov134_020cd52c(struct Ov134ActionNode *node)
{
    ...
    if (*(u8 *)(state->pItem04 + 0xad) == 0) {
        ...
        func_0203c634(node, node->bSlot, (void *)&func_ov134_020cd960);
    }
}
