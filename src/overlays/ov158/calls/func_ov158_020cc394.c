 ...
 * (kind 0x15, c0794) there; 4 builds pair 4 through func_ov158_020cded8 from pairs 6 and 5.
...
extern int func_ov158_020cded8(char *self, int item, int a, int b);
extern void func_ov107_020c7500(char *self, u8 *cmd, void *arg3);

void func_ov158_020cc394(char *self, u8 *cmd, void *arg3)
{
    if (cmd[2] == 5) {
        ...
        case 4:
            (*(struct Ov158Pair **)(self + 0x390))[4].pChild =
                func_ov158_020cded8(self, (*(struct Ov158Pair **)(self + 0x390))[4].pItem,
