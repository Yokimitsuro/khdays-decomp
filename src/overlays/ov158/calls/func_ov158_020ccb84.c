...
extern void func_ov158_020ccc68(void);
extern void func_ov158_020ccdf0(void);

void func_ov158_020ccb84(int *node) {
    ...
    *(signed char *)(*state + 0x1c7) = -1;
    ...
    func_0203c634(node, 1, func_ov158_020ccea4);
    func_0203c634(node, 0, func_ov158_020ccc68);
    func_0203c634(node, 2, func_ov158_020ccdf0);
}
