/* func_ov158_020cc2d8 -- x3. Retune the rig, then re-arm the emitter for kinds 6 and 7 only.
 * The rig at +0x384 is always retuned with the kind as a signed 16-bit selector and reset.
...
void func_ov158_020cc2d8(int self, int kind, int arg) {
