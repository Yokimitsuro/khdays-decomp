 ...
 * func_ov158_020ce9a0 and sound 0x150 is loaded. */
struct Ov158Vec3 {
    int x;
    int y;
    int z;
...
extern void func_ov158_020cc244(void);
extern void func_ov158_020cc28c(void);
extern void func_ov158_020cc394(void);
extern void func_ov158_020cc734(void);
extern void func_ov158_020cc548(void);
extern void func_ov158_020cc570(void);
extern void func_ov158_020cc598(void);
extern void func_ov158_020cc790(void);
extern void func_ov158_020cc9a4(void);
extern void func_ov158_020cc2d8(void);
extern void *func_ov158_020ce9a0(int *self);
...
extern int func_ov107_020c3210(struct Ov158Capsule *req);
extern void func_0203355c();

void func_ov158_020cbfc4(int param)
{
    struct Ov158Kinds kinds;
    struct Ov158Capsule req;
    int i;

    kinds = data_ov158_020cf520;

    *(void **)(param + 0x08) = func_ov158_020cc244;
    *(void **)(param + 0x0c) = func_ov158_020cc28c;
    *(void **)(param + 0x1c) = func_ov158_020cc394;
    *(void **)(param + 0x30) = func_ov158_020cc734;
    *(void **)(param + 0x28) = func_ov158_020cc548;
    *(void **)(param + 0x2c) = func_ov158_020cc570;
    *(void **)(param + 0x34) = func_ov158_020cc598;
    *(void **)(param + 0x1d0) = func_ov158_020cc790;
    *(void **)(param + 0x1e0) = func_ov158_020cc9a4;
    *(void **)(param + 0x1dc) = func_ov158_020cc2d8;
    ...
    *(int *)(param + 0x6c) = 0;

    {
        ...
        ((void **)self)[0xe6] = func_0203bee8(self[0xe1], 3, data_ov158_020cf58c);
        ((void **)self)[0xe5] = func_0203bee8(self[0xe1], 3, data_ov158_020cf594);
        ((void **)self)[0xe7] = func_ov107_020c9e50(func_ov107_020c9440(self, 9), data_ov158_020cf598);
        ...
        *((int **)self)[0xe2] = func_ov107_020c319c(self + 0x19);
        ...
        ((void **)self)[0xe8] = func_ov158_020ce9a0(self);
        func_0203355c(0x150);
    }
}
