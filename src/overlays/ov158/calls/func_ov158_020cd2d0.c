/* Start the ov158 leap: reseed the countdown from the owner's frame rate,
...
typedef struct Ov158ActionNode {
    void *pOwner;
    Ov158MoveState *pState;
    void *apHandlers[6];
...
extern void func_ov158_020cd40c(Ov158ActionNode *node);
extern const short data_0203d210[];

void func_ov158_020cd2d0(Ov158ActionNode *node)
{
    Ov158MoveState *state = node->pState;
    ...
    state->vVelocity.y = 0x400;
    {
        ...
        int nNextHandler = (int)func_ov158_020cd40c;
        Ov158ActionNode *pNextNode = node;
