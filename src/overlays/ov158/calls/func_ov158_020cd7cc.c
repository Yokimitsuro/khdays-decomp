...
extern void func_ov158_020cd898(void);
extern unsigned short data_ov158_020cf540[];
void func_ov158_020cd7cc(int self) {
    int obj = *(int *)(self + 4);
    ...
    *(int *)(obj + 0x14) = *(int *)(*(int *)self + 0x2c) * 30 / 5;
    ...
    }
    {
        ...
        p[1] = data_ov158_020cf540[7];
        p[0] = data_ov158_020cf540[6];
    ...
    *(unsigned char *)(obj + 0x54) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov158_020cd898);
}
