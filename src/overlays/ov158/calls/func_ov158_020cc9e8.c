/* func_ov158_020cc9e8 -- pick a randomised approach direction toward the target.
 *
 * Returns a unit XZ direction in *out. One of a 7-member shape family; the twins live in
 * ov137/ov138/ov159/ov160/ov246/ov247 and are byte-identical modulo relocs (matched here, fanned out with dedupprop).
 *
...
void func_ov158_020cc9e8(int *ctx, VecFx32 *out) {
    VecFx32 v;
    int gap;
    int reach;
    int t;
