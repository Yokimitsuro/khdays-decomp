 ...
 * bone's +0x14; in phase 1 past 0x23bb the +0x3a0 emitter is launched (func_ov158_020ce960)
...
extern void func_ov158_020ce960(int emitter, void *at, Vec3 *dir);
extern int func_02023eb4(int bound);
extern void func_0203c634(int *node, int slot, void *cb);
extern unsigned short data_ov158_020cf540[];
extern short data_0203d210[];

void func_ov158_020cdb88(int *node)
{
    ...
    if (*(unsigned char *)((char *)state + 0x54) == 0 && state[0xf] > 0x22aa) {
        ...
        *(unsigned char *)((char *)state + 0x54) = 1;
        ...
        func_ov158_020ce960(*(int *)(*state + 0x3a0), (void *)(*(int *)(*state + 0x398) + 0x14), &dir);
