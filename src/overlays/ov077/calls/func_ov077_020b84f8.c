...
extern void func_ov077_020b9674(void);
extern void func_ov077_020b9820(void);

void *func_ov077_020b84f8(char *self, int msg) {
    char *blk = data_ov077_020b9b80 + 0x2c + 0x2c00;
    void *next = 0;
    Vec3 d;
    unsigned short a;
    int *node;
    ...
    switch (msg) {
    case 0x21:
        next = (void *)&func_ov077_020b9674;
        (*(void (**)(char *, int))(self + 0x664))(self, 0x31);
        break;
    case 0x22:
        next = (void *)&func_ov077_020b9820;
