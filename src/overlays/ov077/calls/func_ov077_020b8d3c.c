/* Second step of the ov077 charge: while the actor is still in stage 0x30 and
...
extern void func_ov077_020b91d4(int self, void *block);
...
void func_ov077_020b8d3c(int self, int *p2, int p3) {
    struct Vec3 vAnchor;
    struct Vec3 vOffset;
    struct Mtx33 mtx;
    ...
    case 1:
        ...
        func_ov077_020b91d4(self, blk + 0x118);
