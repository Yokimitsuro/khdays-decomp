/* Drives the ov077 charge sequence. Instruction-for-instruction the same
 * routine as the matched overlay-family driver on a different block layout: the
...
extern void func_ov077_020b89e4(int self, int *p2);
extern void func_ov077_020b90c0(int p2, int a);
extern void func_ov077_020b8bdc(int self, void *block);
extern void func_ov077_020b9114(int self, void *block, int a);
...
void func_ov077_020b8a20(int self, int *p2, int p3) {
    char *blk = (char *)(*(int *)&data_ov077_020b9b80 + 0x2c + 0x2c00);

    if (*p2 != 0 && (((struct Ov077Self *)self)->nStage6bc != 0x31 ||
                     (((struct Ov077Self *)self)->flags464 & 0x4000000000LL) != 0)) {
        func_ov077_020b89e4(self, p2);
    }
    if (*p2 == 0) {
        return;
    }
    ...
    case 2:
        ...
        func_ov077_020b90c0((int)p2, 1);
        func_ov077_020b8bdc(self, blk);
        func_ov077_020b9114(self, blk + 0x118, 0);
        *p2 = 3;
        *(int *)((char *)p2 + 0x10c) = 0;
        return;
    case 3:
        ...
        func_ov077_020b90c0((int)p2, 2);
        func_ov077_020b8bdc(self, blk);
        func_ov077_020b9114(self, blk + 0x118, 2);
        *p2 = 4;
        *(int *)((char *)p2 + 0x10c) = 0;
        return;
    case 4:
