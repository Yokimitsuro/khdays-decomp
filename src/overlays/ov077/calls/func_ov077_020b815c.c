/* func_ov077_020b815c -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov077_020b83d0(void);
extern void WM_EndKeySharing_0x020b84ec(void);
extern void func_ov077_020b8638(void);
extern void func_ov077_020b8370(void);
extern void func_ov077_020b83a8(void);
extern void func_ov077_020b84f8(void);
extern void func_ov077_020b8670(void);
extern void func_ov077_020b960c(void);
...
void func_ov077_020b815c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov077_020b9ac8, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov077_020b9adc, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov077_020b83d0;
    *(void **)(obj + 0x664 + 0x04) = (void *)&WM_EndKeySharing_0x020b84ec;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov077_020b8638;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov077_020b8370;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov077_020b83a8;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov077_020b84f8;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov077_020b8670;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov077_020b960c;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov077_020b9a5c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov077_020b9a4c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov077_020b9a3c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov077_020b9a2c) : -1;
