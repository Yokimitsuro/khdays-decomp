/* Fires the ov077 charge burst once the gauge reaches the window the current
...
void func_ov077_020b9388(int pActor)
{
    struct Emit emit;
    struct Params prm;
    struct Vec3 vMuzzle;
    int pSceneBlock = data_ov077_020b9b80 + 0x2c + 0x2c00;
    int fireBurst = 0;
    int burstKind;
    int burstSpin;
    int burstScale;
