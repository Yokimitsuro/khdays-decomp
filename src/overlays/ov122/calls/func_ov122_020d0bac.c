/*
 * func_ov122_020d0bac -- Ov122_ChargeTowardTarget_Step.
 *
 * One frame of the charge that follows the seed timer (the caller at 020d0b48). Shared
 * byte-for-byte with ov120 and ov121; against both of them even the relocations match.
 *
 ...
 *
 * Ghidra: Ov122_ChargeTowardTarget_Step(Ov120ActionNode *pNode), types /khdays/Ov120ActionNode,
...
void func_ov122_020d0bac(struct Ov120ActionNode *node)
{
    struct Vec3 vAim;
    struct Vec3 vFacing;
