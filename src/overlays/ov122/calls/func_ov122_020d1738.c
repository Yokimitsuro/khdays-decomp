...
extern void func_ov122_020d17c0(void);

void func_ov122_020d1738(void *node)
{
    int vec[3];
    int *state;
    int scale;
    ...
    scale = func_ov107_020c9f48(*(void **)(state[0] + 0x3a0), vec);
    ...
    *(Vec3i *)((char *)state + 0x28) = *(Vec3i *)((char *)state + 0x1c);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov122_020d17c0);
}
