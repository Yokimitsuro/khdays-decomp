...
struct Ov188Actor {
    ...
    int resource03c;
    char pad040[0x60];
    struct Ov188Transform transform0a0;
    char pad0cc[0x2f8];
    int specialHandle3c4;
    struct Ov188NodeSlot nodes3c8[4];
};

extern void func_0203c960(struct Ov188Transform *transform);
extern void func_0203ca30(struct Ov188Transform *transform,
                          const struct Ov188Vec3 *position);
extern int func_ov107_020c0794(int resource, int node, int kind, int flags,
                               struct Ov188Transform *transform);
extern int func_ov107_020c09a0(int resource, int node, int kind,
                               struct Ov188Transform *transform, int flags,
                               int enabled);
extern int func_ov107_020cb040(struct Ov188Actor *self, int resourceId,
                               int kind, int enabled,
                               struct Ov188Transform *transform);
extern void func_0203c650(int resource, int handle);
extern void func_ov107_020cb100(int handle);
extern void func_ov107_020c7500(struct Ov188Actor *self,
                                struct Ov188Command *command, int arg2);

void func_ov188_020ce254(struct Ov188Actor *self,
                         struct Ov188Command *command, int arg2)
{
    struct Ov188Transform transform;
