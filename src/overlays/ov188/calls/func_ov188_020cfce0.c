...
extern Ov188Actor *func_ov107_020cab14(Ov188Actor *actor, int index);
...
extern void func_ov188_020cfed4(void);

void func_ov188_020cfce0(Ov188ActionNode *node)
{
    Ov188ActionState *state;
    Ov188ActionHitScratch scratch;
    int idx;
