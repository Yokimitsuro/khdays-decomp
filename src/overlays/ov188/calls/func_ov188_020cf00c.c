...
extern void func_0203c634(struct Ov188ActionNode *node, int slot, void *next);
extern void func_ov188_020cf0f0(void);

void func_ov188_020cf00c(struct Ov188ActionNode *node)
{
    ...
    func_0203c634(node, node->slot20, func_ov188_020cf0f0);
}
