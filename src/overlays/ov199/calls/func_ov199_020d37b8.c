...
extern const char data_ov199_020d6140[];
extern void func_ov199_020d3a08(int);
int func_ov199_020d37b8(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x3f8);
    *(signed char *)(obj + 0x19c) = 37;
    OS_SPrintf(buf, data_ov199_020d6140, 37);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov199_020d3a08;
