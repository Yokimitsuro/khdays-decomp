...
extern void func_ov199_020d3cd0(void);
extern void func_ov199_020d3cfc(void);
extern void func_ov199_020d3ec4(void);
extern void func_ov199_020d401c(void);
extern void func_ov199_020d3d7c(void);
extern void func_ov199_020d3db8(void);
extern void func_ov199_020d3df4(void);
extern void func_ov199_020d4078(void);
extern void func_ov199_020d3fe4(void);
extern void func_ov199_020d41d8(void);
extern void func_ov199_020d4204(void);
extern void func_ov199_020d3844(void);
extern void func_ov199_020d388c(void);
extern int func_ov199_020d5574(struct Obj *self);
...
void func_ov199_020d3a08(struct Obj *self)
{
    struct Box box;
    struct Subitem *item;
    int *slot;
    ...
    self->fn08 = func_ov199_020d3cd0;
    self->fn0c = func_ov199_020d3cfc;
    self->fn1c = func_ov199_020d3ec4;
    self->fn30 = func_ov199_020d401c;
    self->fn28 = func_ov199_020d3d7c;
    self->fn2c = func_ov199_020d3db8;
    self->fn34 = func_ov199_020d3df4;
    self->fn1d0 = func_ov199_020d4078;
    self->fn1dc = func_ov199_020d3fe4;
    self->fn1e0 = func_ov199_020d41d8;
    self->fn1e4 = func_ov199_020d4204;
    ...
    self->subitem384->callback74 = func_ov199_020d3844;
    self->subitem384->owner84 = self;
    func_0203bfb4(self->subscriberList9c, self->subitem384);
    self->resourceId3d4 = func_0203bdfc(self->subitem384, data_ov199_020d614c);

    (self->subitem388 = func_0203b898(func_ov107_020c9440(self, 1)))->callback6c = func_ov199_020d388c;
    self->subitem388->owner84 = self;
    func_0203c7ac(self->subitem388, 0);
    self->resourceId3d0 = func_0203bdfc(self->subitem388, data_ov199_020d6154);
    ...
    *self->poolEntry38c = func_ov107_020c319c(self->camera);
    ...
    for (i = 0; i < 3; i++) {
        self->child398[i] = func_ov199_020d5574(self);
    }
