...
extern void func_ov199_020d4234(int a, int b);
extern void func_0203c634(int self, int idx, int cb);
extern int func_ov199_020d4edc;

void func_ov199_020d4e64(int self) {
    int *state = *(int **)(self + 4);

    func_ov199_020d43a4(state, *(struct Vec3 *)(state + 10), 1);
    ...
    func_ov199_020d4234(*state, 2);
    func_0203c634(self, *(signed char *)(self + 0x20), (int)&func_ov199_020d4edc);
}
