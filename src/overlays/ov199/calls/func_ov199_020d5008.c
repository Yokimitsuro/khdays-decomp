...
extern void func_ov199_020d429c(int *s, int b, int c);
extern void func_0203c634(int *self, int idx, void *cb);
extern void func_ov199_020d50e8(void);

typedef struct { int x, y, z; } Vec3;
extern Vec3 data_02041dc8;

void func_ov199_020d5008(int *self) {
    Vec3 v;
    int *s = (int *)self[1];
    int p;
    v = data_02041dc8;
    ...
    func_ov199_020d429c(s, v.y, *s + 0x3d8);
    func_0203c634(self, *(signed char *)((char *)self + 0x20), (void *)&func_ov199_020d50e8);
}
