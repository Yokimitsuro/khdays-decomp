...
extern void func_ov035_020b3d44(char *self);
extern void func_ov035_020b3ef0(char *self);
extern char *data_ov035_020b4ca0;

void *func_ov035_020b482c(char *self)
{
    int r;
    Vec3 d;
    Vec3 sample;
    Vec3 step;
    char *rig = data_ov035_020b4ca0 + 0xa4 + 0x2c00;
    void *next = 0;
    unsigned int *node;
    unsigned short a;
    ...
    if (*(int *)(self + 0x7b0) == 0) {
        if (*(int *)rig == 0) {
            func_ov035_020b3d44(self);
        } else {
            func_ov035_020b3ef0(self);
        }
