 ...
 * and handing the collected list to func_ov149_020d04f8. */
...
extern void func_ov107_020c5af8(struct Self *self, int id, int kind,
                                struct Vec3 *at);
extern int func_ov149_020d04f8(struct Self *self, short *ids);
extern void func_ov107_020c7500(struct Self *self, struct Command *cmd, int arg2);

void func_ov149_020ce114(struct Self *self, struct Command *cmd, int arg2)
{
    struct Other *other;
    void **it;
    int count;
    ...
    if (cmd->type02 == 5) {
        ...
        case 0: {
            ...
            self->pSlots390->field04 = func_ov149_020d04f8(self, ids);
            break;
        }
        }
    }
