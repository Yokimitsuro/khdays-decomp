 ...
 *
 * Same template as func_ov121_020cdde4 with ov149's numbers: ten callbacks
 ...
 * 0x1000 instead of 0x800, and a trailing func_ov149_020cf7d0 whose result is
...
extern void func_ov149_020ce054(void);
extern void func_ov149_020ce09c(void);
extern void func_ov149_020ce114(void);
extern void func_ov149_020ce4ec(void);
extern void func_ov149_020ce370(void);
extern void func_ov149_020ce398(void);
extern void func_ov149_020ce3c0(void);
extern void func_ov149_020ce538(void);
extern void func_ov149_020ce6d4(void);
extern void func_ov149_020ce0e4(void);
...
extern void *func_ov149_020cf7d0();
extern void func_0203355c();

void func_ov149_020cdde4(int param)
{
    ...
    *(void **)(param + 0x08) = func_ov149_020ce054;
    *(void **)(param + 0x0c) = func_ov149_020ce09c;
    *(void **)(param + 0x1c) = func_ov149_020ce114;
    *(void **)(param + 0x30) = func_ov149_020ce4ec;
    *(void **)(param + 0x28) = func_ov149_020ce370;
    *(void **)(param + 0x2c) = func_ov149_020ce398;
    *(void **)(param + 0x34) = func_ov149_020ce3c0;
    *(void **)(param + 0x1d0) = func_ov149_020ce538;
    *(void **)(param + 0x1e0) = func_ov149_020ce6d4;
    *(void **)(param + 0x1dc) = func_ov149_020ce0e4;
    ...
    *(int *)(param + 0x6c) = 0;

    {
        ...
        ((void **)self)[0xe5] = func_0203bee8(self[0xe1], 3, data_ov149_020d07ac);
        ((void **)self)[0xe6] = func_0203bee8(self[0xe1], 1, data_ov149_020d07b0);
        ((char **)self)[0xb3] = (char *)((void **)self)[0xe6] + 0x14;
        ((void **)self)[0xf3] = func_ov107_020c9e50(
            func_ov107_020c9440(self, 1), data_ov149_020d07b8);
        ...
        *((int **)self)[0xe2] = func_ov107_020c319c(&pose);
        ...
        ((void **)self)[0xf2] = func_ov149_020cf7d0(self);
        func_0203355c(0x14e);
    }
}
