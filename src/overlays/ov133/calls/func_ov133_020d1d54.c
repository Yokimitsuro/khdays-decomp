extern int func_ov133_020d47bc(int, int, int, int);
    ...
    if (*(unsigned char *)(param_2 + 2) == 5) {
        ...
        case 3:
            ...
            *(int *)(*(int *)(param_1 + 0x3c4) + 0x1c) = result;
            ...
            break;
        case 4:
            result = func_ov133_020d45d0(param_1, *(unsigned char *)(param_2 + 3), param_3, param_4);
