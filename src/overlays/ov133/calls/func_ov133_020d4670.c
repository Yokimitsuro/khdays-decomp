...
extern void func_ov133_020d4618(void);
extern void func_ov133_020d4758(void);

void func_ov133_020d4670(int *node) {
    int *state = (int *)node[1];
    state[1] = *(int *)(*(int *)(*state + 0x3c4) + 0x20);
    *(void **)(state[1] + 0x6c) = func_ov133_020d4618;
    ...
    *(int *)(state[1] + 0x5c) &= ~2;
    ...
    state[2] = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov133_020d4758);
}
