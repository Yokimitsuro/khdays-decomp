...
extern const struct tbl8 data_ov133_020d4a0c;

void func_ov133_020d20ec(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov133_020d20ec(newcenter, half, child, param_4,
