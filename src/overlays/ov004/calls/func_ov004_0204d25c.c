...
extern void func_ov004_0204cac0(int a, void *b);
extern int func_0201ef9c(int a, int b);
extern void func_ov004_0204d1a8(int a, int b, int c);
extern int data_ov004_020511e0;
void func_ov004_0204d25c(int param_1, int param_2) {
    MI_CpuFill8((void *)param_1, 0, 0x24);
    NNS_FndInitList(param_1 + 0x18, 0x4c);
    func_ov004_0204cac0(param_1, &data_ov004_020511e0);
    *(int *)(param_1 + 0xc) = *(int *)(param_2 + 8);
    *(int *)(param_1 + 0x14) = func_0201ef9c(*(int *)param_2, 0xe);
    func_ov004_0204d1a8(param_1, *(int *)(param_2 + 8), *(int *)(param_2 + 4));
}
