...
extern void func_ov004_0204d640(void *owner, int id, unsigned int qtyA, unsigned int qtyB, int flag);
extern void func_ov004_0204d91c(TallyParams *p, void *block);

void func_ov004_0204dac4(void *owner, TallyParams *p, char *block, int flag) {
    int i;
    int scaleA = p->scaleA;
    int scaleB = p->scaleB;
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (i == 0) {
            func_ov004_0204d640(owner, *(int *)(row + 0x34),
