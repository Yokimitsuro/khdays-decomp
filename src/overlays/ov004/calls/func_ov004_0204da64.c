...
extern void func_ov004_0204d538(void *ctx, void *obj, int a, int b, int flag);
extern void func_ov004_0204d91c(Params *p, void *block);

void func_ov004_0204da64(void *ctx, Params *p, char *block) {
    int one = 1;
    int i;
    int a = p->a;
    ...
    for (i = 0; i < 4; i++) {
        ...
        func_ov004_0204d538(ctx, *(void **)(row + 0x34), a, p->b, one);
    }
