/* Hit filter of the second ov260 sub-part (+0x1d0): while the actor is in move 1, a hit carrying
 * flags 0x01 and 0x10 knocks it back (020c0b90 mode 0 at the +0x18 point), requests move 0 and is
 * accepted; anything else is ignored. */typedef struct { int x, y, z; } Vec3;
struct HitWord { unsigned int lo : 16, hi : 16; };

extern void func_ov107_020c0b90(int owner, int mode, Vec3 at, int flag);

int func_ov260_020d1b94(char *self, int src, unsigned int *hit)
{
