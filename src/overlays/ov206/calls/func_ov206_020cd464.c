/* Ov206_EnterMoveState -- resets the owner's move state (+0x1c6 = 0, +0x1c7 = -1), clears the two
 ...
 * handlers (1: 020cd818, 0: 020cd51c, 2: 020cd72c). */
...
void func_ov206_020cd464(int node)
{
    ...
    *(unsigned short *)(*state + 0x60) =
    ...
    func_0203c634(node, 1, &func_ov206_020cd818);
    func_0203c634(node, 0, &func_ov206_020cd51c);
    func_0203c634(node, 2, &func_ov206_020cd72c);
}
