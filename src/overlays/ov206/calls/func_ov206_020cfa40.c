/* func_ov206_020cfa40 = Ov206_RockFlightTick. Thrown-rock flight tick of the ov206 enemy (x4: ov206/ov207/ov274/ov275). The rock falls (the +0x34
 ...
 * data_ov206_020d05be with the midpoint through the owner's +0x24 hook, fires reaction 0x116 mode
 * 0xc there and records the kind bit. Each breakable in the world's list gets a 0.5 push request;
 * a broken one reports the 0xe message of data_ov206_020d0620 at the sphere's rim. The rock lands
...
extern int func_ov206_020cce14(void *collision, Vec3 *pos, int *out);
...
extern void func_ov206_020d01a4(int *node);
...
void func_ov206_020cfa40(int *node)
{
    ...
    *(Vec3 *)(state + 5) = *(Vec3 *)(state + 0xc);
    ...
    m = func_ov206_020cce14(*(void **)(scan[k].world + 0x7c), &sphere.c, list);
    for (j = 0; j < m; j++) {
        BreakReq req = {0};
        Vec3 d;
        Vec3 rim;
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov206_020d01a4);
}
