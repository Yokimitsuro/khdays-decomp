/*
 * func_ov206_020ce0d4 -- x4 (ov206/207/274/275). AI-state tick: acquire the target, wind up, then
...
extern void func_ov206_020ce1c8(void);
extern int  data_02041dc8;

void func_ov206_020ce0d4(int *self) {
    ...
    *(struct vec *)(state + 5) = *(struct vec *)&data_02041dc8;
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov206_020ce1c8);
}
