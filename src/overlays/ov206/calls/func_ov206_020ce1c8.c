/*
 * func_ov206_020ce1c8 -- x4 (ov206/207/274/275). AI-state tick: face a re-acquired target, and if
...
extern void func_ov206_020ce328(void);
extern short data_0203d210;
extern int  data_02041dc8;

void func_ov206_020ce1c8(int *self) {
    ...
    *(char *)(*(int *)(*state + 0x384) + 0xa8) = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov206_020ce328);
}
