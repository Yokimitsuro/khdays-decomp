 ...
 * on reaching 0x999 fire func_ov107_020c5af8(owner, 0x116, 7, owner->f3bc+4) and
...
extern void func_ov206_020cef14(void);
struct b8 { unsigned int f:8; };
void func_ov206_020cee10(int self) {
    int obj = *(int *)(self + 4);
    if (*(unsigned char *)(obj + 0x52) == 0) {
        int f24 = *(int *)(obj + 0x24) + *(int *)(*(int *)self + 0x2c);
        *(int *)(obj + 0x24) = f24;
        if (f24 >= 0x999) {
            func_ov107_020c5af8(*(int *)obj, 0x116, 7, *(int *)(*(int *)obj + 0x3bc) + 4);
    ...
    *(int *)(obj + 0x24) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov206_020cef14);
}
