...
extern void func_ov206_020cccc0(void);
extern void func_ov206_020ccc3c(void);
extern void func_ov206_020ccb78(void);
int func_ov206_020ccbc0(int param_1) {
    int *entry;
    int spawn = func_0203c5c0(*(int *)(param_1 + 0x3c), 100, 8,
                              &func_ov206_020ccc3c, &func_ov206_020cccc0, &entry);
    entry[0] = param_1;
    entry[1] = **(int **)(*entry + 0x3e0);
    *(int *)(entry[1] + 0x6c) = (int)&func_ov206_020ccb78;
