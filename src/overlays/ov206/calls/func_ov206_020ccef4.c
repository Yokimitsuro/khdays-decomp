...
extern const struct tbl8 data_ov206_020d063c;

void func_ov206_020ccef4(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov206_020ccef4(newcenter, half, child, param_4,
