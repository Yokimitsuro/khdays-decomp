/*
 * func_ov206_020cc8c8 -- x4. Message handler: on kinds 6 and 0xa, (re-)arm the emitter, then map the
...
extern void func_ov206_020cc85c(int a, int b, int c, int d);
extern void func_0203c7ac(int a, int b);
extern struct t17 data_ov206_020d0564;

void func_ov206_020cc8c8(int self, int kind, int arg3) {
    struct t17 table = data_ov206_020d0564;
    ...
    func_ov206_020cc85c(*(int *)(self + 0x384), func_ov107_020c9440(self, table.w[kind]), arg3,
                        self + 0x388);
