/* func_ov206_020cd9c4 -- accumulate time and, once past the threshold, re-face and hand on.
 ...
 * dispatched with func_ov206_020cda8c.
 *
...
extern void func_ov206_020cda8c(void);

void func_ov206_020cd9c4(int self) {
    int *ctx;
    Vec3 v;
    int target;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov206_020cda8c);
}
