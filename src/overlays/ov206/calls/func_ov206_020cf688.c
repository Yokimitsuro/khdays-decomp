 ...
 * (data_ov206_020d05cc, the +4 point packed as 24-bit values) goes to the owner's +0x24 hook,
 ...
 * heading of the direction and the tick hands over to func_ov206_020cf914. */
...
extern void func_ov206_020cf914(int *node);

void func_ov206_020cf688(int *node)
{
    ...
    *(Vec3 *)(state + 0xc) = data_02041dc8;
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov206_020cf914);
}
