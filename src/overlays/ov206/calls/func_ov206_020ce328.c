/* func_ov206_020ce328 -- reset the tuning, quiesce the owner and queue the effect, then hand on.
 ...
 * func_0203c634 with func_ov206_020ce3c0 as the continuation. */
...
extern void func_ov206_020ce3c0(void);
extern Vec3 data_02041dc8;
extern unsigned short data_ov206_020d05a8[];

void func_ov206_020ce328(int self) {
    int *ctx;
    ...
    *(unsigned char *)((char *)ctx + 0x52) = 0;
    ...
    desc.hi = data_ov206_020d05a8[3];
    desc.lo = data_ov206_020d05a8[2];
    id = *(unsigned short *)(ctx[0] + 2);
    desc.lo = id;
    func_02031384(1, &desc, 4, id);

    func_0203c634(self, *(signed char *)(self + 0x20), func_ov206_020ce3c0);
}
