...
extern void func_ov257_020ce0dc(int *node);

void func_ov257_020ce04c(int *node)
{
    ...
    func_ov107_020c5af8(state[0], (short)*(int *)(*state + 0x408), 2, (void *)state[1]);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020ce0dc);
}
