 ...
 * +0x10 step heads for it (func_ov257_020ccf98). The +0x44 timer accumulates the frame rate; between
...
extern void func_ov257_020d101c(int *node);
...
void func_ov257_020d0a00(int *node)
{
    int obj;
    ...
    if (*((u8 *)state + 0x76) == 0 && state[0x15] >= 0x888) {
        func_ov107_020c5af8(state[0], (short)*(int *)(*state + 0x408), 0x1d, (void *)state[1]);
        *((u8 *)state + 0x76) = 1;
    }
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3d0), 0x1d, 0);
    state[0x11] = 0;
    *((u8 *)state + 0x74) = 0;
    *((u8 *)state + 0x75) = 0;
    *((u8 *)state + 0x76) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020d101c);
}
