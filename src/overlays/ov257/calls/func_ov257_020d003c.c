 ...
 * motion 0x12 and the tick hands over to func_ov257_020d00b8. */
typedef unsigned short u16;

extern void func_ov107_020c9264(int owner, int anim, int mode);
extern void func_ov107_020c9ee8(int part, int motion, int mode);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_ov257_020d00b8(int *node);

void func_ov257_020d003c(int *node)
{
    ...
    *((unsigned char *)state + 0x89) = 0;
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3d0), 0x12, 0);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020d00b8);
}
