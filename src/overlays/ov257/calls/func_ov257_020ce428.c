...
extern void func_ov257_020ce504(int *node);

void func_ov257_020ce428(int *node)
{
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3d0), 8, 0);
    func_ov107_020c5af8(state[0], (short)*(int *)(*state + 0x408), 3, (void *)state[2]);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020ce504);
}
