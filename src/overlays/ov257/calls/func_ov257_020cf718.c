 ...
 * the flag clear and the tick hands over to func_ov257_020cf7d4. */
extern void func_ov107_020c5af8(int owner, int id, int mode, void *at);
extern void func_ov107_020c9264(int owner, int anim, int mode);
extern void func_ov107_020c9ee8(int part, int motion, int mode);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_ov257_020cf7d4(int *node);

void func_ov257_020cf718(int *node)
{
    int *state = (int *)node[1];

    state[0x15] += *(int *)(node[0] + 0x2c);
    if (*((unsigned char *)state + 0x76) == 0 && state[0x15] >= 0x1911) {
        func_ov107_020c5af8(state[0], (short)*(int *)(*state + 0x408), 0xc, (void *)state[1]);
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3d0), 0xf, 0);
    *((unsigned char *)state + 0x73) = 0;
    state[0x11] = 0;
    *((unsigned char *)state + 0x76) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020cf7d4);
}
