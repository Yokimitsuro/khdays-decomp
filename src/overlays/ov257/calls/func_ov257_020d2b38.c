...
extern void func_ov257_020d2b80(void);
extern void func_ov257_020d2bf0(void);

int func_ov257_020d2b38(int this_) {
    int *entry;
    int rc = func_0203c5c0(*(int *)(this_ + 0x3c), 0x64, 0x4, func_ov257_020d2b80, func_ov257_020d2bf0, &entry);
    *entry = this_;
    return rc;
}
