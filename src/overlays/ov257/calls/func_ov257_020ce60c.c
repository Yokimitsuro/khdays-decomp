 ...
 * point is resolved (func_ov257_020ccf98) into a direction and a speed that give the +0x10 step.
 * Once the +0xc idle byte clears, animation 0xb plays, the +0x3d0 part plays motion 0xa and the tick
 * hands over to func_ov257_020ce6ac. */
...
extern void func_ov257_020ce6ac(int *node);

void func_ov257_020ce60c(int *node)
{
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3d0), 0xa, 0);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020ce6ac);
}
