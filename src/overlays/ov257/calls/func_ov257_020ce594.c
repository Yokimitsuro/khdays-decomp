...
extern int func_ov257_020ce60c(int);
void func_ov257_020ce594(int param_1) {
    ...
    *(int *)(owner + 0x60) = child;
    if (child == 0) {
        *(signed char *)(*(int *)owner + 0x1c7) = 2;
        ...
        func_ov107_020c9ee8(*(int *)(*(int *)owner + 0x3d0), 9, 0);
        func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov257_020ce60c);
    }
}
