...
extern void func_ov257_020cf5fc(int *node);

void func_ov257_020cf3f8(int *node)
{
    ...
    if (state[0x18] != 0) {
        ...
        if (wall != 0 && wall[2] == 0) {
            ...
            func_ov107_020c5af8(*state, (short)*(int *)(*state + 0x408), 0x2b, &p);
        }
    }
    func_ov107_020c9264(*state, 0x10, 0);
    state[0x15] = 0;
    *((u8 *)state + 0x76) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020cf5fc);
}
