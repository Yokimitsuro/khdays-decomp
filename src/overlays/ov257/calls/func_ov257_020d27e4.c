 ...
 * helper installs its slot-1 (func_ov257_020d296c) and slot-2 (func_ov257_020d291c) ticks. */
...
extern void func_ov257_020d296c(int *node);
extern void func_ov257_020d291c(int *node);

void func_ov257_020d27e4(int *node)
{
    ...
    *(int *)((char *)h->a + 0x5c) &= ~2;
    ...
    h->timer = 0;
    h->done = 0;
    func_0203c634(node, 1, (void *)func_ov257_020d296c);
    func_0203c634(node, 2, (void *)func_ov257_020d291c);
}
