/* Wind-down tick of an ov257 part: the +8 timer accumulates the owner's rate; at 0.75 animation
...
extern void func_ov257_020d275c(int *node);

void func_ov257_020d26c8(int *node)
{
    ...
    if (!(state[2] < 0xc00)) {
        ...
        state[2] = 0;
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020d275c);
        return;
    }
}
