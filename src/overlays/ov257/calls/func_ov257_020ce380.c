 ...
 * is resolved (func_ov257_020ccf98) into the +0x10 step. Once the +0xc idle byte clears, animation
...
extern void func_ov257_020ce428(int *node);

void func_ov257_020ce380(int *node)
{
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3d0), 7, 0);
    *((unsigned char *)state + 0x76) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020ce428);
}
