/* Ramp-up tick of an ov257 part: the +0xc timer accumulates the owner's rate; at 3.0 animation
...
extern void func_ov257_020d2b18(int *node);

void func_ov257_020d2a84(int *node)
{
    ...
    if (!(state[3] < 0x3000)) {
        ...
        state[3] = 0;
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020d2b18);
        return;
    }
}
