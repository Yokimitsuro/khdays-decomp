/* Glide-to-land tick of an ov257 state: the +0x5c path point is resolved (func_ov257_020ccf98)
 ...
 * the tick hands over to func_ov257_020d0900. */
...
extern void func_ov257_020d0900(int *node);

void func_ov257_020d085c(int *node)
{
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3d0), 0x14, 0);
    func_ov107_020c5af8(state[0], (short)*(int *)(*state + 0x408), 3, (void *)state[2]);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020d0900);
}
