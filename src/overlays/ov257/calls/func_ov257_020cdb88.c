 ...
 * for it (func_ov257_020ccf98); with the +0x4c cooldown out a target more than 2.0 above or below,
...
extern void func_ov257_020cdda0(int *node);

void func_ov257_020cdb88(int *node)
{
    ...
    dist = func_ov257_020ccf98(state, state[0x18], &dir, &speed);
    ...
    *(unsigned char *)(*(int *)(*state + 0x384) + 0xa8) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov257_020cdda0);
}
