/* Common update of the ov257 states (slot 0): the attack cues advance (func_ov257_020cd050), the
...
extern void func_ov257_020cd050(int *state, int rate);
...
void func_ov257_020cd57c(int *node)
{
    int *state = (int *)node[1];

    func_ov257_020cd050(state, *(int *)(node[0] + 0x2c));
