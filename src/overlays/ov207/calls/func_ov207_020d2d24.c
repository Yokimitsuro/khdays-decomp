 ...
 * template (data_ov207_020d4236 for the first foot, data_ov207_020d421a for the second) carries
...
extern const PosMsg data_ov207_020d4236;
extern const PosMsg data_ov207_020d421a;
...
void func_ov207_020d2d24(int *node)
{
    ...
    if (state->nTimer > 0x2aa && state->nTimer < 0xc44) {
        SweepFoot(state, 0x3bc, data_ov207_020d4236, hits, &sphere);
        SweepFoot(state, 0x3c0, data_ov207_020d421a, hits, &sphere);
    }
    if (*state->pBusy != 0) {
        return;
    }
