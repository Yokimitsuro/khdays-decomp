/* func_ov207_020d1f68 -- reset the tuning, quiesce the owner and queue the effect, then hand on.
 ...
 * 4-byte descriptor is queued through func_02031384 -- built from data_ov207_020d41e8's +4/+6,
 ...
 * func_0203c634 with func_ov207_020d2000 as the continuation. */
...
extern void func_ov207_020d2000(void);
extern Vec3 data_02041dc8;
extern unsigned short data_ov207_020d41e8[];

void func_ov207_020d1f68(int self) {
    int *ctx;
    ...
    *(unsigned char *)((char *)ctx + 0x52) = 0;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov207_020d2000);
}
