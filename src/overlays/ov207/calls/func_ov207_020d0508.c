/*
 * func_ov207_020d0508 -- x4. Message handler: on kinds 6 and 0xa, (re-)arm the emitter, then map the
...
extern void func_ov207_020d049c(int a, int b, int c, int d);
extern void func_0203c7ac(int a, int b);
extern struct t17 data_ov207_020d41a4;

void func_ov207_020d0508(int self, int kind, int arg3) {
    struct t17 table = data_ov207_020d41a4;
    ...
    func_ov207_020d049c(*(int *)(self + 0x384), func_ov107_020c9440(self, table.w[kind]), arg3,
                        self + 0x388);
