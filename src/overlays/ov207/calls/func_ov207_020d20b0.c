 ...
 * acceptance the overlay's 14-byte template (data_ov207_020d4252) carries the entity's +0x74
 ...
 * func_ov207_020d2460); otherwise the +0x20 step counter fires reaction 0x116 mode 4 at 5 and
...
extern void func_ov207_020d2460(int *node);

void func_ov207_020d20b0(int *node)
{
    ...
    if (state->nHits52 >= 4) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov207_020d2460);
        return;
    }
    state->nStep++;
    if (state->nStep == 5) {
