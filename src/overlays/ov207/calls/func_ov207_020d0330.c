 ...
 *
 * Note func_ov207_020d0800 is called with FOUR arguments and the ROM sets NONE of them:
...
extern int func_ov207_020d0800(int self, int a, int b, int c);
...
void func_ov207_020d0330(int self, unsigned char *msg, int p3, int p4) {
    if (msg[2] == 5) {
        switch (msg[3]) {
        case 0:
            *(int *)(*(int *)(self + 0x3e0) + 4) = func_ov207_020d0800(self, msg[3], p3, p4);
            break;
        case 1:
