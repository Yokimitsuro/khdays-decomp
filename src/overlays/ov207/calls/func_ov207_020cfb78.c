...
extern const char data_ov207_020d42a0[];
extern void func_ov207_020cfc04(int);
int func_ov207_020cfb78(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x3e4);
    *(signed char *)(obj + 0x19c) = 41;
    OS_SPrintf(buf, data_ov207_020d42a0, 41);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov207_020cfc04;
