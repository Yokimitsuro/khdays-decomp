...
extern const struct tbl8 data_ov207_020d427c;

void func_ov207_020d0b34(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov207_020d0b34(newcenter, half, child, param_4,
