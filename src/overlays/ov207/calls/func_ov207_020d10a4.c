/* Ov207_EnterMoveState -- resets the owner's move state (+0x1c6 = 0, +0x1c7 = -1), clears the two
...
extern void func_ov207_020d115c(void);
extern void func_ov207_020d136c(void);

void func_ov207_020d10a4(int node)
{
    ...
    *(unsigned short *)(*state + 0x60) =
    ...
    func_0203c634(node, 1, &func_ov207_020d1458);
    func_0203c634(node, 0, &func_ov207_020d115c);
    func_0203c634(node, 2, &func_ov207_020d136c);
}
