 ...
 * step timer, the +0x388 part's +0xa8 flag clears and the tick hands over to func_ov236_020d4d34. */
...
extern void func_ov236_020d4d34(int *node);
...
void func_ov236_020d45bc(int *node)
{
    Cmd4 note1;
    Cmd4 note2;
    ...
    *(u8 *)(*(int *)(*state + 0x388) + 0xa8) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov236_020d4d34);
}
