 ...
 * data_ov236_020d63da carries its +0x74 point raised by 0.5 to the +0x24 hook, its slot cools for
...
extern const Cmd14 data_ov236_020d63da;
extern void func_ov236_020d1114(int *node);

void func_ov236_020d0bf8(int *node)
{
    ...
    *(u8 *)(state[1] + 0xa8) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov236_020d1114);
}
