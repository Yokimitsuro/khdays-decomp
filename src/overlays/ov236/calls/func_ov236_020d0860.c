...
extern int func_ov236_020d0900(int);
struct b8 { unsigned f : 8; };
void func_ov236_020d0860(int param_1) {
    int owner = *(int *)(param_1 + 4);
    *(unsigned short *)(*(int *)owner + 0x1ae) |= 1;
    ((struct b8 *)(*(int *)(*(int *)owner + 0x3a4) + 8))->f &= ~1;
    func_ov107_020c9264(*(int *)owner, 5, 0);
    func_ov107_020c5af8(*(int *)owner, 0x127, 7, *(int *)(owner + 0x38));
    *(int *)(owner + 0x28) = 0;
    *(unsigned char *)(*(int *)owner + 0x3bc) &= ~1;
    func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov236_020d0900);
}
