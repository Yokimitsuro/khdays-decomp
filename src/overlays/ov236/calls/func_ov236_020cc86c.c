...
extern int func_ov236_020d5f34();
...
void func_ov236_020cc86c(char *self, u8 *cmd, void *arg3)
{
    Srt srt;
    VecFx32 pos;
    ...
    if (cmd[2] == 5) {
        ...
        case 3:
            *(int *)(*(int *)(self + 0x3b0) + 0x3c) =
            ...
            break;
        case 4:
            *(int *)(*(int *)(self + 0x3b0) + 0x44) = func_ov236_020d5f34();
            break;
        case 5:
            *(int *)(self + 0x3c4) = func_ov107_020cb040(self, 0x127, 0xf, 1, *(int *)(self + 0x39c) + 4);
            break;
        }
    }
