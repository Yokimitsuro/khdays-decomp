 ...
 * either of the actor's +0x3bc / +0x3be rider counters is empty, the cue at data_ov236_020d63e8
...
void func_ov236_020d31e0(int *node) {
    ...
    if (*(short *)(*state + 0x300 + 0xbc) == 0 || *(short *)(*state + 0x300 + 0xbe) == 0) {
        pair[1] = data_ov236_020d63e8[9];
        pair[0] = data_ov236_020d63e8[8];
