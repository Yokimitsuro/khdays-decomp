...
extern void func_ov236_020cc5c0(void);
extern void func_ov236_020cc630(void);
extern void func_ov236_020cc6f8(void);
extern void func_ov236_020cc838(void);
extern void func_ov236_020cc86c(void);
extern void func_ov236_020ced5c(void);
extern void func_ov236_020cedb8(void);
extern void func_ov236_020cca44(void);
extern void func_ov236_020ccd14(void);
extern void func_ov236_020ccd68(void);
extern void func_ov236_020cbfc4(void);
extern void func_ov236_020cc110(void);
...
extern int func_ov236_020cce20(char *self);
extern int func_ov236_020cdc84(char *self);
...
void func_ov236_020cc154(char *self)
{
    ...
    *(Callback *)(self + 0x8) = func_ov236_020cc5c0;
    *(Callback *)(self + 0xc) = func_ov236_020cc630;
    *(Callback *)(self + 0x28) = func_ov236_020cc6f8;
    *(Callback *)(self + 0x2c) = func_ov236_020cc838;
    *(Callback *)(self + 0x1c) = func_ov236_020cc86c;
    *(Callback *)(self + 0x30) = func_ov236_020ced5c;
    *(Callback *)(self + 0x1d0) = func_ov236_020cedb8;
    *(Callback *)(self + 0x1dc) = func_ov236_020cca44;
    *(Callback *)(self + 0x1f4) = func_ov236_020ccd14;
    *(Callback *)(self + 0x1ec) = func_ov236_020ccd68;
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov236_020cbfc4;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(int *)(self + 0x39c) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov236_020d64ac);
    *(int *)(self + 0x3a0) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov236_020d64b4);
    hw = *(u16 *)(self + 0x60);
    *(u16 *)(self + 0x60) = (hw & ~0xff00) |
    ...
    *(int *)(self + 0x3ac) = func_ov107_020c9e50(func_ov107_020c9440(self, 0x3f), data_ov236_020d64c0);
    ...
    *(Callback *)(((struct Pair *)*(int *)(self + 0x3b0))[5].res + 0x6c) = func_ov236_020cc110;
    *(char **)(((struct Pair *)*(int *)(self + 0x3b0))[5].res + 0x84) = self;
    *(int *)(self + 0x3b4) = func_ov236_020cce20(self);
    *(unsigned char *)(*(int *)(self + 0x3b4) + 0x19c) = *(unsigned char *)(self + 0x19c);
    *(int *)(self + 0x3b8) = func_ov236_020cdc84(self);
