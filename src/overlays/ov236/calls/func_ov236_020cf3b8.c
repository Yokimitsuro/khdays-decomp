...
extern void func_ov236_020cf4b4(void);
extern void func_ov236_020cf984(void);

void func_ov236_020cf3b8(int *node) {
    ...
    *((unsigned char *)state + 0x52) |= 4;
    func_0203c634(node, 1, func_ov236_020cfa88);
    func_0203c634(node, 0, func_ov236_020cf4b4);
    func_0203c634(node, 2, func_ov236_020cf984);
}
