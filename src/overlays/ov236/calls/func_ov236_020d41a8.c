...
void func_ov236_020d41a8(int *node) {
    ...
    if (stage == 0 && state[0x1e] >= 0xa83) {
        *((unsigned char *)state + 0x7c) = stage + 1;
        if (*(short *)(*state + 0x300 + 0xd2) > 0) {
            func_ov107_020c5af8(*state, 0x127, 5, (void *)(*(int *)(*(int *)(*state + 0x3c4)) + 4));
        }
        ...
        *((unsigned char *)state + 0x7c) += 1;
        if (*(short *)(*state + 0x300 + 0xd0) > 0) {
            func_ov107_020c5af8(*state, 0x127, 4, (void *)(*(int *)(*(int *)(*state + 0x3c0)) + 4));
        }
    }
