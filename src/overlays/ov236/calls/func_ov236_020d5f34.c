/* func_ov236_020d5f34 -- spawn the 0xc-byte task for this reaction (step func_ov236_020d5f9c,
 * completion func_ov236_020d6068, priority 0x64) and seed its payload with (self, hit.x, hit.z)
...
int func_ov236_020d5f34(int obj) {
    int *out;
    int r = func_0203c5c0(*(int *)(obj + 0x3c), 0x64, 0xc, (void *)func_ov236_020d5f9c,
                          (void *)func_ov236_020d6068, &out);
    out[0] = obj;
