 ...
 * 0x3aaa / 0x3bbb / 0x4666 / 0x4777 / 0x5222; each step fires reaction 0x127 at the rear rider's
...
extern void func_ov236_020d57a4(void);

void func_ov236_020d54e0(int *node)
{
    ...
    if (*((u8 *)state + 0x7c) == 0 && state[0x1e] >= 0x3aaa) {
        *((u8 *)state + 0x7c) = 1;
        if (*(short *)(*state + 0x300 + 0xd2) > 0) {
            func_ov107_020c5af8(*state, 0x127, 5, (void *)(**(int **)(*state + 0x3c4) + 4));
        }
    }
    if (*((u8 *)state + 0x7c) == 1 && state[0x1e] >= 0x3bbb) {
        *((u8 *)state + 0x7c) = 2;
        if (*(short *)(*state + 0x300 + 0xd0) > 0) {
            func_ov107_020c5af8(*state, 0x127, 4, (void *)(**(int **)(*state + 0x3c0) + 4));
        }
    }
    ...
    if (*(short *)(*state + 0x300 + 0xd0) == 0) {
        ...
        pp[0] = data_ov236_020d6430[8];
        if (((struct Ov236Actor *)*state)->pfnMessage != 0) {
            ((struct Ov236Actor *)*state)->pfnMessage((struct Ov236Actor *)*state, pp, 4);
        }
    }
    if (*(short *)(*state + 0x300 + 0xd2) == 0) {
        pp = noteRear;
        pp[1] = data_ov236_020d6430[3];
        pp[0] = data_ov236_020d6430[2];
        if (((struct Ov236Actor *)*state)->pfnMessage != 0) {
            ((struct Ov236Actor *)*state)->pfnMessage((struct Ov236Actor *)*state, pp, 4);
        }
    }
    state[5] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov236_020d57a4);
}
