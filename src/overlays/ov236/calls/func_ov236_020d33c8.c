/* func_ov236_020d33c8 -- reaction step: while the gate byte at *node[9] is clear, notify the owner
...
extern void func_ov236_020d3440(void);
extern char data_ov236_020d63e8[];

struct Pair16 { unsigned short a, b; };

void func_ov236_020d33c8(int self) {
    int *node = *(int **)(self + 4);
    struct Pair16 pair;
    struct Pair16 *ps;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), (int)&func_ov236_020d3440);
}
