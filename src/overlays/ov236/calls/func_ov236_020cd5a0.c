 ...
 * effect 0x127 (kind 0xa) at the +0xa0 pose into +0x3c4. The base handler always runs. */
typedef unsigned char u8;
struct Bits3c0 { unsigned int b0 : 1; };
struct Bits28 { u8 b0 : 1; };
struct Ov236SubSlot { int pItem; int pChild; };

extern int func_ov236_020d5e08(char *self, int item, int mode);
...
void func_ov236_020cd5a0(char *self, u8 *cmd, void *arg3)
{
    if (cmd[2] == 0) {
        ...
        *(short *)(self + 0x300 + 0xbe) = *(short *)(cmd + 0x26);
        ...
        case 0: {
            ...
            (*(struct Ov236SubSlot **)(self + 0x3b8))[0].pChild =
                func_ov236_020d5e08(self, (*(struct Ov236SubSlot **)(self + 0x3b8))[0].pItem, mode);
            break;
        }
        case 1: {
            signed char i;
            for (i = 0; i < 2; i++) {
                if (((short *)(self + 0x300 + 0xbc))[i] != 0) {
                    (*(struct Ov236SubSlot **)(self + 0x3b8))[i + 1].pChild =
                        func_ov107_020c09a0(*(int *)(self + 0x3c), (*(struct Ov236SubSlot **)(self + 0x3b8))[i + 1].pItem,
                                            0x17, self + 0xa0, 0, 1);
                }
            }
            break;
        ...
        case 3:
            ...
            break;
        case 4:
            (*(struct Ov236SubSlot **)(self + 0x3b8))[3].pChild =
                func_ov107_020c09a0(*(int *)(self + 0x3c), (*(struct Ov236SubSlot **)(self + 0x3b8))[3].pItem,
                                    0x17, *(char **)(self + 0x3ac) + 4, 0, 0);
            break;
        case 5:
            (*(struct Ov236SubSlot **)(self + 0x3b8))[4].pChild =
                func_ov107_020c09a0(*(int *)(self + 0x3c), (*(struct Ov236SubSlot **)(self + 0x3b8))[4].pItem,
                                    0x17, *(char **)(self + 0x3a8) + 4, 0, 0);
            break;
        case 6:
            *(int *)(self + 0x3c4) = func_ov107_020cb040(self, 0x127, 0xa, 0, self + 0xa0);
            break;
        }
    }
