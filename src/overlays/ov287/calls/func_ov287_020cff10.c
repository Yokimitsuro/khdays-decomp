/*
 * func_ov287_020cff10 -- Ov287_Actor_HandleEvent.
 *
 * The actor class event handler installed in the +0x1c slot by func_ov287_020cfc04, shared
...
void func_ov287_020cff10(struct Actor *actor, struct ActorEventMsg *msg, u32 param)
{
