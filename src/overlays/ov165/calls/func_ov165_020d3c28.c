/* func_ov165_020d3c28: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern const struct Msg data_ov165_020d4ada;
extern void func_ov165_020d3df4(void);

void func_ov165_020d3c28(struct Node *node)
{
    struct State *st;
    struct Msg msg;
    FxVec raw;
    ...
    *(u8 *)(st->pActor + 0x1c5) &= ~0xf;
    ...
    func_0203c634(node, node->bSlot, (void *)func_ov165_020d3df4);
}
