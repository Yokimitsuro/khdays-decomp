/* func_ov165_020d1d6c: ported from a matched sibling family (same shape, constants and offsets adjusted). */
extern int func_ov165_020d4898(int, int, int, int);
    ...
    if (*(unsigned char *)(param_2 + 2) == 0x5) {
        ...
        case 3:
            ...
            *(int *)(*(int *)(param_1 + 0x3c4) + 0x14) = result;
            ...
            break;
        case 4:
            result = func_ov165_020d46ac(param_1, *(unsigned char *)(param_2 + 3), param_3, param_4);
