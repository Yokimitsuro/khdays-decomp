/* func_ov165_020d3448: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
void func_ov165_020d3448(struct Node *node)
{
    struct State *st;
    FxVec vFwd;
    FxVec vToTarget;
    ...
    func_0203c634(node, node->bSlot, (void *)func_ov165_020d38dc);
}
