...
extern const struct tbl8 data_ov165_020d4ae8;

void func_ov165_020d20dc(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov165_020d20dc(newcenter, half, child, param_4,
