/* func_ov165_020d1ef0: release hook of the ov163 enemy (x3), variant of the matched ov131 sibling: the two item transforms are refreshed from the +0x3c0 item before the sub-state-dependent task finishes (no 0x1c4 guard here). */
...
void func_ov165_020d1ef0(char *actor) {
