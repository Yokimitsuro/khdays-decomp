/* func_ov165_020d3df4: ported from the matched ov202 sibling (same shape: throw-release tick with the 0xc00 guard, a fixed 0x3000 radius and the +0x60 bit-7 set at the end). */
/* func_ov165_020d3df4: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern int func_ov165_020d1ffc(void *world, struct Sphere *shape, void **out);
...
extern const struct Msg data_ov165_020d4ab0;
extern const struct Msg data_ov165_020d4acc;
...
void func_ov165_020d3df4(struct Node *node)
{
    struct State *st;
    void *world;
    void *aVictims[4];
    ...
    if (st->nTimer30 < 0xc00) {
        ...
        nHits = func_ov165_020d1ffc(*(void **)((char *)world + 0x7c), &shape, aChildren);
        i = 0;
        if (nHits > 0) {
            do {
