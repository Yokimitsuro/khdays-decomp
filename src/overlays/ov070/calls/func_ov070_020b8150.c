/* Constructor for the ov070 actor. Same routine as the panel-class constructor and
...
void func_ov070_020b8150(struct PanelInitConfig *config)
{
    ...
    *(long long *)object = 0;
    ...
    if (config->alternateName == 0) {
        func_0202b914(*(signed char *)(object + 0x4bc), (void *)data_ov070_020b9bdc, 1,
                      config->objectType + 7);
    } else {
        func_0202b914(*(signed char *)(object + 0x4bc), (void *)data_ov070_020b9bf0, 1,
                      config->objectType + 7);
    }

    *(void **)(object + 0x664 + 0x00) = (void *)&func_ov070_020b8414;
    *(void **)(object + 0x664 + 0x04) = (void *)&func_ov070_020b84f0;
    *(void **)(object + 0x664 + 0x08) = (void *)&func_ov070_020b8608;
    *(void **)(object + 0x664 + 0x0c) = 0;
    *(void **)(object + 0x664 + 0x10) = 0;
    *(void **)(object + 0x664 + 0x14) = (void *)&func_ov070_020b8390;
    *(void **)(object + 0x664 + 0x18) = (void *)&func_ov070_020b83ec;
    *(void **)(object + 0x664 + 0x20) = (void *)&func_ov070_020b8638;
    *(void **)(object + 0x664 + 0x28) = 0;
    *(void **)(object + 0x664 + 0x28) = (void *)&func_ov070_020b8710;
    *(void **)(object + 0x664 + 0x24) = (void *)&func_ov070_020b9000;
...
test:
    ...
    *(int *)(object + 0x520) = bone != 0
        ? func_02016f10((void *)bone, &data_ov070_020b9b70) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x518) = bone != 0
        ? func_02016f10((void *)bone, &data_ov070_020b9b80) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x514) = bone != 0
        ? func_02016f10((void *)bone, &data_ov070_020b9b50) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x51c) = bone != 0
        ? func_02016f10((void *)bone, &data_ov070_020b9b40) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x524) = bone != 0
        ? func_02016f10((void *)bone, &data_ov070_020b9b60) : -1;
