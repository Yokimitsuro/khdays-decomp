/* Build step for the ov070 actor: clears the ready flags, requests animation set 3,
...
struct Ov070Attach {
    char pad000[0x0c];
    struct Ov070Model *model0c;
    char pad010[0x5c];
    struct Ov070Model *model6c;
};
...
struct Ov070Runtime {
    ...
    u8 slot09;
    char pad00a[0x16];
    struct Ov070SceneLink *scene20;
    char pad024[0x22d4];
    struct Ov070BuildBlock buildBlock22f8;
    struct Ov070Attach *attach2644;
};

struct Ov070Descriptor {
    char bytes[0x10];
};
...
extern struct Ov070Descriptor data_ov070_020b9c04;
extern struct Ov070Descriptor data_ov070_020b9c14;
extern struct Ov070Descriptor data_ov070_020b9c28;

u8 func_ov070_020b8710(struct Ov070Runtime *self)
{
    struct Ov070BuildBlock *block = &self->buildBlock22f8;

    block->flags334 = 0;
    func_ov022_020b15b0(self->slot09, 3);
    block->handle340 = func_ov022_020b14a4(
        data_ov070_020b9c04.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov070_020b9c14.bytes, self->slot09, 1,
        &self->attach2644->model6c->field28);
    block->handle348 = func_ov022_020b14a4(
        data_ov070_020b9c28.bytes, self->slot09, 2,
