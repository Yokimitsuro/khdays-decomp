...
extern void func_ov070_020b99e8(struct vec3 *out, void *a, int b, int c);
...
int func_ov070_020b9700(void *param_1, int param_2, int param_3, int param_4) {
    struct vec3 s;
    struct vec3 out;
    int *iVar3 = *(int **)(param_2 + 0x138);

    s = *(struct vec3 *)(param_2 + 0xcc);
    func_ov070_020b99e8(&out, param_1, param_2, param_3);
