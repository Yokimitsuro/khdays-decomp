/* ov070 actor: drive one update pass over the group's parts.
 *
 ...
 * anything else is called through the handler table at data_ov070_020b9bb4 indexed by
 * the kind.
 *
...
extern void func_ov070_020b9574(char *pGroup, char *pPart, int nArg);
extern void func_02033d0c(int nSound, int nVariant, char *pPos, int nOwner);
extern int func_02030788(void);

extern void (*data_ov070_020b9bb4[])(char *pGroup, char *pPart, int nArg);

void func_ov070_020b941c(char *pGroup, int nArg)
{
    char *pPart;
    ...
    do {
        ...
        if (nKind != 0) {
            if (nKind != 2) {
                ...
                func_ov070_020b9574(pGroup, pPart, nArg);
