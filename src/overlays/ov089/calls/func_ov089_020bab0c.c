...
void func_ov089_020bab0c(void)
{
    ...
    *(int *)(base + 4) = 0;
    *(int *)(base + 8) = 0;
    func_0202a634(base + 0xc, &data_ov089_020bc0ec, 1, ((unsigned char *)obj)[9] + 7);
    i = 0;
    slot = base + 0x120;
    zero = 0;
    do {
        func_0202a634(slot, &data_ov089_020bc100, 1, ((unsigned char *)obj)[9] + 7);
