...
extern void func_ov089_020bb97c(char *self);
extern void func_ov089_020bbac8(char *self);
extern int func_ov022_02095524(char *emitter);
extern char *data_ov089_020bc120;

void *func_ov089_020bb3b0(char *self)
{
    int r;
    Vec3 sample;
    Vec3 step;
    ...
    if (*(int *)(rig + 4) == 0) {
        func_ov089_020bb97c(self);
    } else {
        func_ov089_020bbac8(self);
    }
