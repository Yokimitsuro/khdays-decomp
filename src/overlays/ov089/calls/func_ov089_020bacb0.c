...
extern void func_ov089_020bbda4(Vec3 *pos, unsigned int angle, int kind, int grounded);
extern int func_02030788(void);
extern void func_ov022_020ad44c(Vec3 *out, char *self);
extern void func_ov022_020ad588(char *self);
extern short data_0203d210[];

void func_ov089_020bacb0(char *self)
{
    Vec3 dir;
    Vec3 pos;
    ...
    case 4:
        ...
        if (*(int *)(self + 0x7b0) == 0x3000) {
            ...
            pos.y += 0x333;
            func_ov089_020bbda4(&pos, angle, alt, *(int *)(self + 0x24) & 4);
    ...
    case 1:
        if (*(int *)(self + 0x7b0) == 0x9000) {
            ...
            func_ov089_020bbda4(&pos, angle, 1, *(int *)(self + 0x24) & 4);
            if (func_02030788() == 0 && (int)(*(long long *)self & 0x10000) == 0) {
                *(u8 *)(self + 0x47a) = 3;
                *(u8 *)(self + 0x47b) = 0;
            }
    ...
    case 2:
        if (*(int *)(self + 0x7b0) == 0xc000) {
            ...
            func_ov089_020bbda4(&pos, angle, 2, 1);
            if (func_02030788() == 0 && (int)(*(long long *)self & 0x10000) == 0) {
                *(u8 *)(self + 0x47a) = 3;
                *(u8 *)(self + 0x47b) = 1;
            }
