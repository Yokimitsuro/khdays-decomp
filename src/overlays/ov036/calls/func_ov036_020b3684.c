extern void func_ov036_020b49dc(int self);
extern void func_ov036_020b3934(int a, int b, int c);
extern void func_ov036_020b3990(int a, int b);
extern int func_ov022_020912d8(int a);
extern int func_02030788(void);
extern int data_ov036_020b4f40;

void func_ov036_020b3684(int self) {
    char *blk = (char *)(*(int *)&data_ov036_020b4f40 + 0x194);
    func_ov036_020b49dc(self);
    func_ov036_020b3934(self, (int)(blk + 0x2c00), *(short *)(self + 0x2a00 + 0xba));
    func_ov036_020b3990(self, (int)(blk + 0x2c00));
