...
extern void WM_EndKeySharing_0x020b3928(int self);
extern void func_ov036_020b4b68(int self);
...
void func_ov036_020b352c(int self, int mode) {
    int base = data_ov036_020b4f40;
    int flag;
    int ret;

    switch (mode) {
    case 0x2e:
        if (*(int *)(self + 0x6bc) != mode) { WM_EndKeySharing_0x020b3928(self); }
        break;
    case 0x2f:
    case 0x30:
        break;
    }
    if (*(int *)(self + 0x6bc) != mode) { func_ov036_020b4b68(self); }
