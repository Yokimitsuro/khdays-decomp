/*
 * func_ov185_020cef20 -- x3 (ov185/186/187). AI-state tick: seed a randomized strafe and dispatch.
...
extern void func_ov185_020cefa8(void);

void func_ov185_020cef20(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov185_020cefa8);
}
