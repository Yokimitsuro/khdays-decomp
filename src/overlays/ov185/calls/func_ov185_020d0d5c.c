...
extern Pair data_ov185_020d16a0[];
extern void func_ov185_020d0efc(void);
 ...
 */
void func_ov185_020d0d5c(int *self) {
    ...
    if (ctx->direction.y < 0
        ...
        Pair *eventPtr = &event;
        eventPtr->b = data_ov185_020d16a0[0].b;
        eventPtr->a = data_ov185_020d16a0[0].a;
