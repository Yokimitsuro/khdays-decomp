...
extern const struct CameraWork data_ov185_020d1690;
extern struct RollingCounter data_ov185_020d16c0;

extern void func_ov185_020ce034(struct Obj *self);
extern void func_ov185_020ce058(struct Obj *self);
extern void func_ov185_020ce3c0(struct Obj *self);
extern void func_ov185_020ce178(struct Obj *self);
extern void func_ov185_020ce1e0(struct Obj *self);
extern void func_ov185_020ce21c(struct Obj *self);
extern void func_ov185_020ce2a4(struct Obj *self);
extern void func_ov185_020ce40c(struct Obj *self);
extern void func_ov185_020ce59c(struct Obj *self);
extern void func_ov185_020ce0b4(struct Obj *self);
extern void func_ov185_020ce2e4(struct Obj *self);
extern void func_ov185_020ce344(struct Obj *self);
extern void func_ov185_020ce384(struct Obj *self);
...
extern void *func_ov185_020cf9a0(void *spawner);
 ...
 */
void func_ov185_020cdde8(struct Obj *self)
{
    ...
    work = data_ov185_020d1690;
    self->fn08 = func_ov185_020ce034;
    self->fn0c = func_ov185_020ce058;
    self->fn30 = func_ov185_020ce3c0;
    self->fn28 = func_ov185_020ce178;
    self->fn2c = func_ov185_020ce1e0;
    self->fn1c = func_ov185_020ce21c;
    self->fn34 = func_ov185_020ce2a4;
    self->fn1d0 = func_ov185_020ce40c;
    self->fn1e0 = func_ov185_020ce59c;
    self->fn1dc = func_ov185_020ce0b4;
    self->fn1ec = func_ov185_020ce2e4;
    self->fn1f0 = func_ov185_020ce344;
    self->fn1f8 = func_ov185_020ce384;
    ...
    *(struct CameraWork *)self->camera64 = work;
    ...
    func_02016b60(self->subitem384->container88->config78, 0,
                  data_ov185_020d16c0.value);
    func_02016b60(self->subitem384->container88->config78, 2,
                  data_ov185_020d16c0.value);
    func_02016b60(self->subitem384->container88->config78, 3,
                  data_ov185_020d16c0.value);

    data_ov185_020d16c0.value = data_ov185_020d16c0.value + 1;
    if (data_ov185_020d16c0.value >= 0x1f) {
        data_ov185_020d16c0.value = 3;
    }
    ...
    for (i = 0; i < 4; i++) {
        self->entities390[i] = func_ov185_020cf9a0(self->spawner394);
    }
    func_0203355c(0x120);
}
