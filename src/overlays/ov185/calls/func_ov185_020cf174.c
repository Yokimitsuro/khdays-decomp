...
extern void func_ov185_020ce6fc(struct Ov185ActionState *state, struct Vec3 *pos,
 ...
 */
void func_ov185_020cf174(struct Ov120ActionNode *node)
{
    int nDist;
    int nTargetRadius;
    int nRange;
    ...
    func_ov185_020ce6fc(state, &state->vPos18, nDist, nTargetRadius);
