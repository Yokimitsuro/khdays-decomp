...
extern void func_ov185_020d0d5c(void);
...
extern void func_ov185_020d0028(struct Ov185ActionState *state, struct Vec3 *pos);
 ...
 */
void func_ov185_020d0c18(struct Ov120ActionNode *node)
{
    struct Vec3 vDelta;
    ...
    func_ov185_020d0028(state, &state->vPos18);
    ...
    func_0203c634(node, node->bSlot, func_ov185_020d0d5c);
}
