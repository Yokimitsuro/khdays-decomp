/* Build step of the ov052 enemy (byte-identical twin of ov032 020b48e0): clears the ready flags,
...
extern char data_ov052_020b8044[];
extern char data_ov052_020b8054[];
extern char data_ov052_020b8068[];

void func_ov052_020b70e0(char *self)
{
    char *base = data_ov052_020b80c0;
    ...
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov052_020b8044, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov052_020b8054, *(u8 *)(self + 9), 1, model + 0x28);
    *(u8 **)(block + 0x348) = func_ov022_020b14a4(data_ov052_020b8068, *(u8 *)(self + 9), 2, base + 0x284 + 0x2c00);
