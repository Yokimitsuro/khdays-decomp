...
extern void func_ov052_020b6f0c(void);
...
void func_ov052_020b6bdc(char *self)
{
...
body:
    ...
    *(char **)(part + 0x74) = part;
    func_02014e18(part + 0x48, func_ov052_020b6f0c, 0, 6, 3);
    i++;
test:
    if (i < count) {
        goto body;
    ...
    b = bone(rig);
    *(int *)(self + 0x2e68) = b != 0 ? func_02016f10((void *)b, &data_ov052_020b7f68) : -1;
    b = bone(rig);
    *(int *)(self + 0x2e6c) = b != 0 ? func_02016f10((void *)b, &data_ov052_020b7f78) : -1;
    b = bone(rig);
    *(int *)(self + 0x2e70) = b != 0 ? func_02016f10((void *)b, &data_ov052_020b7f58) : -1;
    b = bone(rig);
    *(int *)(self + 0x2e74) = b != 0 ? func_02016f10((void *)b, &data_ov052_020b7f38) : -1;
}
