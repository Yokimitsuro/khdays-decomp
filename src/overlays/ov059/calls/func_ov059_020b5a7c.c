/* func_ov059_020b5a7c -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov059_020b5e58(void);
extern void func_ov059_020b5fd8(void);
extern void func_ov059_020b6a58(void);
...
void func_ov059_020b5a7c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov059_020b7288, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov059_020b729c, 1, cfg[0] + 7);
    }
    ...
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov059_020b5c90;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov059_020b5cc8;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov059_020b5e58;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov059_020b5fd8;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov059_020b6a58;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov059_020b7234) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov059_020b7224) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov059_020b7214) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov059_020b7204) : -1;
