/* func_ov097_020ba830 -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov097_020baad0(void);
extern void func_ov097_020babc8(void);
extern void func_ov097_020bac0c(void);
extern void func_ov097_020baa44(void);
extern void func_ov097_020baab0(void);
extern void func_ov097_020bac98(void);
extern void func_ov097_020bac38(void);
extern void func_ov097_020bb998(void);

extern void *data_ov097_020bc2a0;
extern int data_ov097_020bc214;
extern int data_ov097_020bc228;
extern int data_ov097_020bc1bc;
extern int data_ov097_020bc1dc;
extern int data_ov097_020bc1cc;
extern int data_ov097_020bc1ac;
...
void func_ov097_020ba830(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov097_020bc214, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov097_020bc228, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov097_020baad0;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov097_020babc8;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov097_020bac0c;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov097_020baa44;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov097_020baab0;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov097_020bac98;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov097_020bac38;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov097_020bb998;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov097_020bc1bc) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov097_020bc1dc) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov097_020bc1cc) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov097_020bc1ac) : -1;
