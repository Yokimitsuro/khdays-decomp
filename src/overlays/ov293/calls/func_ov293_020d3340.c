...
extern void func_ov293_020d33b4(void);

void func_ov293_020d3340(int *node) {
    int *state = (int *)node[1];
    state[0xb] -= 0x100;
    *(Vec3 *)(state + 7) = *(Vec3 *)(state + 10);
    if (((unsigned int)(*(unsigned char *)(*state + 0x17a) << 0x1f) >> 0x1f) == 0) return;
    func_ov107_020c9264(*state, 8, 0);
    func_ov107_020c9ee8(*(int *)(*state + 0x39c), 2, 0);
    func_0203c634(node, *(signed char *)(node + 8), func_ov293_020d33b4);
}
