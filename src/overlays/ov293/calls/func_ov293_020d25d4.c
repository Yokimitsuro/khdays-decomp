...
extern void func_ov293_020d269c(void);

void func_ov293_020d25d4(int *node) {
    Vec3 delta;
    ...
    state[0x1] = target;
    if (target != 0) {
        VEC_Subtract((Vec3 *)(target + 0x74), (Vec3 *)state[0x2], &delta);
    ...
    func_0203c634(node, *(signed char *)(node + 8), func_ov293_020d269c);
}
