/* Orbit tick of the ov166 enemy (x3: ov166/167/168), variant of the matched ov178 sibling:
...
extern int func_ov166_020cca08(int node, Vec3 *out);
...
void func_ov166_020cd1a8(int node)
{
    ...
    dist = func_ov166_020cca08(node, &dir);
    if (dist > *(int *)(*state + 0x2d8)) {
        *(Vec3 *)(state + 8) = data_02041dc8;
        ...
        diff = h + (int)(((long long)s * 0x2000 + 0x800) >> 12) - *(int *)(state[2] + 4);
