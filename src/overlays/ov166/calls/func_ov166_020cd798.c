/* Hover-approach tick of the ov166 enemy (x3: ov166/167/168): acquires a target (+0xc; none
...
extern int func_ov166_020ccaa0(int node);
extern int data_02042264;

void func_ov166_020cd798(int node)
{
    ...
    func_01ffa724(0x400, &dir, (Vec3 *)(state + 8));
