...
u8 func_ov073_020b8d74(char *self)
{
    char *block = self + 0x2f8 + 0x2000;

    block[0x334] = 0;
    func_ov022_020b15b0(*(u8 *)(self + 9), 3);
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov073_020ba4dc, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov073_020ba4ec, *(u8 *)(self + 9), 1, self + 0xf10);
    *(u8 **)(block + 0x348) = func_ov022_020b14a4(data_ov073_020ba500, *(u8 *)(self + 9), 2, self + 0xdac);
