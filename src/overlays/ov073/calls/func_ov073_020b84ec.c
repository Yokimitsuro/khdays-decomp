 ...
 */
extern void func_ov073_020ba044(int self, int p);
extern void func_ov073_020ba0c0(int self, int p);
extern void func_ov073_020ba158(int self, int p);
extern void func_ov073_020ba1f0(int self, int p);
extern void func_ov073_020ba004(int self);
...
void func_ov073_020b84ec(int self, int mode) {
    int p = self + 0x2ce4;
    int reached = -1;

    switch (mode - 0x2f) {
    case 0:
        if (*(int *)(self + 0x6bc) != mode) { func_ov073_020ba044(self, p); }
        break;
    case 1:
        if (*(int *)(self + 0x6bc) != mode) { func_ov073_020ba0c0(self, p); }
        break;
    case 2:
        if (*(int *)(self + 0x6bc) != mode) { func_ov073_020ba158(self, p); }
        break;
    case 3:
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov073_020ba1f0(self, p);
            *(int *)(p + 0x10) = 0;
        }
        break;
    case 4:
    ...
    if (mode < 0x2e) {
        ...
        int p2 = self + 0x2ce4;
        if (mode == 0x2e && *(int *)(self + 0x6bc) != mode) { func_ov073_020ba004(self); }
