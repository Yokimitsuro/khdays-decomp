...
extern void func_ov073_020b8ebc(void);
extern void func_ov073_020b92e0(void);
extern void func_ov073_020b912c(void);
extern void func_ov073_020b93f0(void);
extern void func_ov073_020b9600(void);
extern void func_ov073_020b9900(void);

void *func_ov073_020b8b88(char *self, int msg)
{
    ...
    case 2:
        ...
        *(int *)(rig + 0x1c) = *(int *)(self + 0x490);
        break;
    case 3:
        next = (void *)&func_ov073_020b9600;
        *(int *)(rig + 4) = 0;
        *(int *)(rig + 8) = 0;
        *(int *)(self + 0x58) = -0xe66;
        break;
    case 4:
        next = (void *)&func_ov073_020b9900;
