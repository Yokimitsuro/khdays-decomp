 ...
 *  - func_ov025_0208b274 takes TWO args, not four (the ROM sets only r0/r1).
 ...
 */
/* func_ov025_0208c118 -- confirm the highlighted main-menu item, ov008.
 * Looks up the active menu record (func_ov025_02084afc); its two targets are a sub-menu
 ...
 * (func_ov025_02084798(1,-1)). When a sub-menu target is set, descends into it
 * (func_ov025_0208b274). Either way commits the input latch (func_02033b78(0,1)). */
extern int  func_ov025_02084afc(void);
extern void func_ov025_0208b274(int rec, int a);
...
extern void func_ov025_02084830(int a);
extern void func_ov025_02084798(int a, int b);
extern void func_02033b78(int a, int b);

void func_ov025_0208c118(void) {
    int rec = func_ov025_02084afc();
