 ...
 * zero), sample the touch state (func_ov025_020899dc); if it is clear, advance the timed value
...
extern void func_ov025_0209522c(int ctx, int high, int flag);

void func_ov025_02098e9c(int param_1) {
    ...
    func_ov025_0209522c(param_1, (int)((unsigned long long)r >> 32), 1);
}
