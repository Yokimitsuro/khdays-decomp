/* func_ov025_0208e9ec -- ov008 teardown: release the two fixed surfaces (+0x380, +0x488), then each
 * of the twelve 0x108-byte row surfaces at +0x590 whose entry in data_ov025_020b3bb0 is
...
void func_ov025_0208e9ec(int obj) {
    int i;
    char *p;
    ...
    i = 0;
    do {
        if (((int *)&data_ov025_020b3bb0)[i] >= 0) {
            func_0202a7dc((int)p);
        }
        i = i + 1;
        p = p + 0x108;
