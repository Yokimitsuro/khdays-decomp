...
extern int func_ov025_020a96a0(int obj, int a);
extern void func_ov025_020a970c(int obj, int val);
int *func_ov025_020a9750(int *param_1, int param_2, int param_3, int param_4) {
    int sel = 0;
    int result = 0;
    ...
    {
        int r = func_ov025_020a96a0((int)param_1, param_2);
        if (r > param_3) {
            sel = param_4;
            result = 1;
        }
    ...
    if (sel != 0 && sel != *param_1) {
        func_ov025_020a970c((int)param_1, sel);
    }
    return (int *)result;
}
