/* func_ov025_02089774 -- (re)arm an animation node: zero its accumulator
 * (+0x14/+0x18), stamp the current time (+0x1c), rewind to frame 0 (+4) and hand
 * that frame to the resolver. See func_ov025_02088e4c for the ticker. */
extern long long func_020031d4(void);
extern void func_ov025_02089544(int owner, int tag);

void func_ov025_02089774(int param_1, int param_2) {
    *(int *)(param_2 + 0x14) = 0;
    *(int *)(param_2 + 0x18) = 0;
