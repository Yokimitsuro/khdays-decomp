/*
 * func_ov025_020839f0 -- x3 (ov008/...). Tear down the current sub-screen's dynamic resources.
...
void func_ov025_020839f0(void) {
    int obj;

    func_ov025_020851a0(*(int *)(data_ov025_020b5744[1] + 0x959c));
    func_ov025_02085248(*(int *)(data_ov025_020b5744[1] + 0x95a0));
