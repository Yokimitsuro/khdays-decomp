/* func_ov025_02098e30 -- confirm the current grid selection on pen-up.
...
extern void func_ov025_02095648(int obj, int key);
extern void func_02033b78(int a, int b);

void func_ov025_02098e30(int param_1) {
    ...
    func_ov025_02095648(param_1, *(int *)(param_1 + 0x70));
    func_02033b78(0, 2);
}
