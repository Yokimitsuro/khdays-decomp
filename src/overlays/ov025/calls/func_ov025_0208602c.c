...
extern void func_ov025_02085ba8(void *ctx, void *node, unsigned int sx, unsigned int sy, int flag);
extern void func_ov025_02085e84(DrawParams *p, void *block);

void func_ov025_0208602c(void *ctx, DrawParams *p, char *block, int flag) {
    int i;
    int sx = p->sx;
    int sy = p->sy;
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (i == 0) {
            func_ov025_02085ba8(ctx, *(void **)(row + 0x34),
