...
extern void func_ov025_02085ba8(void *owner, int id, unsigned int qtyA, unsigned int qtyB, int flag);
extern void func_ov025_02085e84(TallyParams *p, void *block);

void func_ov025_0208602c(void *owner, TallyParams *p, char *block, int flag) {
    int i;
    int scaleA = p->scaleA;
    int scaleB = p->scaleB;
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (i == 0) {
            func_ov025_02085ba8(owner, *(int *)(row + 0x34),
