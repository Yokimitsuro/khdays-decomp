/* func_ov025_020a1a00 -- Ov008_DrawListEntryRow (804 B, 28 relocs).
 ...
 * mapped through func_ov025_020898cc(0x37, ..., node[5], node[3]) -- and draws it (func_02030278),
...
extern const char data_ov025_020b52c4[];
extern const char data_ov025_020b52cc[];

extern int  func_ov025_02084a64(void);
extern int  func_ov025_02084c84(void);
extern int  func_ov025_02084cb4(void);
extern int  func_ov025_020894b0(int list, int tag);
extern void func_ov025_02089560(int block, int entry, int a, int b);
extern int  func_ov025_020898cc(int a, int b, void *work, int n, ...);
...
void func_ov025_020a1a00(int self, int col, int *node)
{
    int block1, block2, iVar3, entry, iVar5, row;
    unsigned short uVar4;
    short buf[64];

    block1 = func_ov025_02084a64();
    block2 = func_ov025_02084c84();
    iVar3 = func_ov025_02084cb4();
    switch (node[2]) {
    case 1:
        uVar4 = node[7] != 0 ? 0xb : 5;
        entry = func_ov025_020894b0(block1, uVar4);
        func_ov025_02089560(block1, entry, 0, (short)(col << 1));
        break;
    case 5:
    ...
    case 0:
        ...
        break;
    case 4:
        entry = func_ov025_020894b0(block1, 7);
        func_ov025_02089560(block1, entry, 0, (short)(col << 1));
        break;
    case 3:
        ...
        break;
    case 2:
        entry = func_ov025_020894b0(block1, 9);
        func_ov025_02089560(block1, entry, 0, (short)(col << 1));
        break;
    }
    if (node[6] != 0) {
        entry = func_ov025_020894b0(block1, 3);
        func_ov025_02089560(block1, entry, 0xf, (short)(col << 1));
    }
    if (node[3] >= 0)
        func_ov025_020898cc(self + 0x58, 0x37, buf, 0x40, node[5], node[3]);
    else
    ...
    *(int *)(self + 0x1b0) = block2;
    if (node[4] > 0) {
        *(int *)(self + 0x1b0) = iVar3;
        if (node[2] == 3) {
            func_ov025_020898cc(self + 0x58, 0x38, buf, 0x40, node[4]);
        } else if (node[2] == 5 && node[0] == 0x5a) {
            func_020262a0(buf, 0x40, data_ov025_020b52c4, node[4]);
        } else {
            func_020262a0(buf, 0x40, data_ov025_020b52cc, node[4]);
        }
        buf[63] = 0;
