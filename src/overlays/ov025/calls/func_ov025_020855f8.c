/* func_ov025_020855f8 -- forward an input event to a pair of ov008 menu handler slots.
...
int func_ov025_020855f8(int param_1, int param_2) {
    int r = 0;
    void *m1 = *(void **)(data_ov025_020b4ab0[data_ov025_020b574c[0]].obj + 0x30);
    if (param_1 != 0) {
        r = func_ov025_02085090(m1, param_1);
    }
    if (r == 0) {
        void *m2 = *(void **)(data_ov025_020b4a78[data_ov025_020b574c[1]].obj + 0x2c);
        if (param_2 != 0) {
