/*
 * func_ov025_020898cc -- x3 (ov002/...). Variadic thin wrapper around Ov002_MapAndForwardEntry
...
extern int func_ov025_02089908(int a, unsigned b, unsigned short *c, unsigned d, void *va);

unsigned short *func_ov025_020898cc(int a, unsigned b, unsigned short *c, unsigned d, ...) {
    va_list ap;

    va_start(ap, d);
    func_ov025_02089908(a, b, c, d, ap);
    return c;
}
