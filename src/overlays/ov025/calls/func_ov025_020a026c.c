/* func_ov025_020a026c -- Ov025_Reports_UpdateScrollBar: show the up arrow (+0x26c of the page)
 * once the window (+0) has left the top and the down arrow (+0x270) while more than ten reports
...
void func_ov025_020a026c(void)
{
    ...
    func_ov025_0208884c(pPage->nCtx, pPage->pDownArrow, pPage->nTop < pPage->nCount - 10);
