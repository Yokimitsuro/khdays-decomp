 ...
 * func_ov025_0208dc54(Ov008_GetCtxField967c()) - returning as soon as that is non-zero.
 * Otherwise it tears the list back down (func_ov025_0208a19c) and retries with the retry
...
extern void func_ov025_0208a13c(int list, ObjListParams *p);
extern u32  func_ov025_02084ff0(void);
extern int  func_ov025_0208dc54(u32 a);
extern void func_ov025_0208a19c(int list);

void func_ov025_0208d69c(int obj, ObjListParams *params)
{
    ObjListParams local;
    int tries;
    u32 shift;
    ...
    do {
        ...
        func_ov025_0208a13c(obj + 0x13fc, &local);
        if (func_ov025_0208dc54(func_ov025_02084ff0()) != 0) return;
        func_ov025_0208a19c(obj + 0x13fc);
        tries++;
        shift += 0x100;
    } while (tries < 0xc);
    local = *params;
