...
extern void func_ov025_0208951c(int owner, int entry, unsigned short a, unsigned short b);
extern void func_ov025_02089544(int owner, int entry);

void func_ov025_020897b4(int param_1, int param_2, unsigned short param_3, unsigned short param_4) {
    int i = 0;
    int n = *(unsigned short *)(param_2 + 2);
    if (n > 0) {
        do {
            func_ov025_0208951c(param_1, (*(int **)(param_2 + 0x2c))[i], param_3, param_4);
            i = i + 1;
