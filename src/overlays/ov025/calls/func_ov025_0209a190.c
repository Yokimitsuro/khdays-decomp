/* func_ov025_0209a190 -- Ov008_LoadMenuBgWithVariantChars (300 B, 19 relocs).
 ...
 * if func_ov025_02084d50(2) is non-zero it unpacks that alternate subfile, resolves its
 ...
 * func_ov025_020891dc, and registers cells for tags {0,1}. Resource-cell / character-block
...
void func_ov025_0209a190(void)
{
    ...
    *(volatile u32 *)0x04000018 = 0x01e600e3;
    func_ov025_020891dc(ctx, data_ov025_020b4e88);
