...
extern void func_ov025_0208985c(int a, void *b);
extern int func_0201ef9c(int a, int b);
extern void func_ov025_0208a088(int a, int b, int c);
extern int data_ov025_020b4b00;
void func_ov025_0208a13c(int param_1, int param_2) {
    MI_CpuFill8((void *)param_1, 0, 0x24);
    NNS_FndInitList(param_1 + 0x18, 0x4c);
    func_ov025_0208985c(param_1, &data_ov025_020b4b00);
    *(int *)(param_1 + 0xc) = *(int *)(param_2 + 8);
    *(int *)(param_1 + 0x14) = func_0201ef9c(*(int *)param_2, 0xe);
    func_ov025_0208a088(param_1, *(int *)(param_2 + 8), *(int *)(param_2 + 4));
}
