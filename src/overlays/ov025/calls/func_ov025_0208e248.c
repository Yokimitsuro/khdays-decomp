/* func_ov025_0208e248 -- start the ov008 menu cursor tween toward a slot, ov008.
 ...
 * derived shadow/offset positions (func_ov025_0208e1fc). */
...
extern void func_ov025_0208e1fc(int obj);

void func_ov025_0208e248(int obj, unsigned int *rect, unsigned int dur) {
