/*
 * func_ov025_02084b78 -- x3 (ov008/...). Remove one object from the shared UI list and free it.
...
void func_ov025_02084b78(void *obj) {
    void *node = NNS_FndGetNextListObject((void *)(data_ov025_020b5744[1] + 0x9660), 0);
    ...
    for (;;) {
        if (node == obj) {
            NNS_FndRemoveListObject((void *)(data_ov025_020b5744[1] + 0x9660), obj);
            if (obj != 0) {
                NNSi_FndFreeFromDefaultHeap(obj);
            }
            return;
        }
        node = NNS_FndGetNextListObject((void *)(data_ov025_020b5744[1] + 0x9660), node);
        if (node == 0) {
            return;
        }
    }
