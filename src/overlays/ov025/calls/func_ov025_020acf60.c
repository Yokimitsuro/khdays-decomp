/* func_ov025_020acf60 -- scroll the mission list by param_2 and push the resulting bar position.
...
extern void func_ov025_020a9db0(int obj, int bar);

void func_ov025_020acf60(int param_1, int param_2) {
