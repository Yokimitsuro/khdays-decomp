/* func_ov025_020aa0a4 -- Ov008_SwitchMenuTab (196 B, 7 relocs).
 ...
 * the cell up (func_ov025_020894b0) and re-registers it (func_ov025_02089544). It then retargets
 * the sub-object at p+0xc to p->arr138[idx] (func_02030094) and applies p->arr144[idx]
 * (func_ov025_020a9f18), and finally records the new tab in p->curTab.
 *
...
extern void  func_ov025_020a9f18(Ov008TabState *p, void *value);

void func_ov025_020aa0a4(Ov008TabState *p, int idx)
{
    void *ctx = func_ov025_02084a64();
    int old = p->curTab;
    int tag;
    ...
    func_ov025_02089544(ctx, func_ov025_020894b0(ctx, (unsigned short)tag));
    ...
    func_ov025_020a9f18(p, (void *)p->arr144[idx]);
    p->curTab = idx;
}
