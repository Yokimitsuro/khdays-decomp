/* func_ov025_020a1d24 -- Ov008_DrawListWindow (272 B, 9 relocs).
 ...
 * [center-1, center+0xf) it draws the entry at grid row (index % 16) via func_ov025_020a1a00, and
 * tallies the entries and the kind 1/5 entries. When param_4 is set it reports the kind 1/5 count
 * (func_ov025_020a41f0 id 5); when param_3 is set it finalizes (func_ov025_020a4948) and marks
...
extern void func_ov025_020849d8(int a, int b, int c, int d, int e);
extern int  NNS_FndGetNextListObject(void *list, int obj);
extern void func_ov025_020a1a00(int self, int col, int *node);
extern int  func_ov025_020a41f0(int id, int a, ...);
extern void func_ov025_020a4948(void);
extern void func_ov025_02084964(int a);

int func_ov025_020a1d24(int self, int center, int param_3, int param_4)
{
    int iVar4 = 0, uVar5 = 0;
    int *piVar2;

    func_02030158(self + 0x190);
    func_ov025_020849d8(0x1a, 0, 0, 3, 0x20);
    func_ov025_020849d8(0x1a, 0xf, 0, 4, 0x20);
    for (piVar2 = (int *)NNS_FndGetNextListObject((void *)(self + 0x1cc), 0); piVar2 != 0;
        ...
        if (piVar2[8] != 0) {
            if (center - 1 <= iVar4 && iVar4 < center + 0xf)
                func_ov025_020a1a00(self, iVar4 % 16, piVar2);
            iVar4++;
