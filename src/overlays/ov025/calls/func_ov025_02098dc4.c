/* func_ov025_02098dc4 -- confirm the current grid selection on pen-up.
...
extern void func_ov025_0209567c(int obj, int key);
extern void func_02033b78(int a, int b);

void func_ov025_02098dc4(int param_1) {
    ...
    func_ov025_0209567c(param_1, *(int *)(param_1 + 0x70));
    func_02033b78(0, 2);
}
