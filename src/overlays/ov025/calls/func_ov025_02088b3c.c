...
extern void func_ov025_02089414(int owner, void *obj, unsigned short kind);
void func_ov025_02088b3c(int param_1, int param_2) {
    ...
    for (i = 0; i < n; i++) {
        ...
        func_ov025_02089414(param_1, obj, *(unsigned short *)(p + 4));
        p += *(int *)p;
    }
}
