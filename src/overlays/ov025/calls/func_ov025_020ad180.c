/* func_ov025_020ad180 -- Ov008_MissionMenuInitStep: one step of the mission
...
extern void func_ov025_020ad164(void);                                    /* gate 0 handler */
extern u32  func_ov025_020a990c(void);                                    /* FindMinListValue */
extern int  func_ov025_02084ea4(int nDb);                                 /* Ov008_AcquireMsgDb */
extern void func_ov025_020a9984(Ov008MissionMenu *pMenu);                 /* load the flag table */
...
extern void func_ov025_020ac654(Ov008MissionMenu *pMenu);                 /* Ov008_MissionMenuRefreshEntries */
extern void func_ov025_020ac7e8(Ov008MissionMenu *pMenu);                 /* Ov008_LoadMissionMenuGraphics (pMenu unused) */
extern void func_ov025_020ac994(Ov008MissionMenu *pMenu);                 /* Ov008_InitMissionMenuSurfaces */
extern void *func_ov025_02084b2c(void *pFn);                              /* Ov008_AllocCodeNode */
extern void func_ov025_020a9b60(void);                                    /* Ov008_UpdateBg3ScrollFromPage */
extern void  func_ov025_020acbac(Ov008MissionMenu *pMenu);                 /* Ov008_HideMissionMenuWidgets (pMenu unused) */                                    /* Ov008_HideMissionMenuWidgets */
extern void func_ov025_020acd14(Ov008MissionMenu *pMenu);                 /* Ov008_InitMissionMenuTrackers */
...
extern void func_ov025_020a9ad4(int nCtx, u32 nTag, u16 nValue, u16 nFlag); /* Ov008_SetActiveTagValueAndFlag */
...
int func_ov025_020ad180(Ov008MissionMenu *pMenu)
{
    int bDone;
    ...
    case 0:
        ...
        pMenu->bTransfer = func_ov025_02084dd8() == 2;
        if (pMenu->bTransfer) {
            ...
            func_02030cf8(0, func_ov025_020ad164);
        }
        if (pMenu->bTransfer != 0) {
            pMenu->nCursorSlot = func_ov025_020a990c();
        }
        func_ov025_02084ea4(0x15);
        func_ov025_02084ea4(0x19);
        func_ov025_02084ea4(0x1a);
        pMenu->pFlagTable = 0;
        func_ov025_020a9984(pMenu);
        func_ov025_0208985c(pMenu->textCacheA, data_ov025_020b5488);
        func_ov025_0208985c(pMenu->textCacheB, data_ov025_020b54a0);
        if (func_ov025_02084e38() != 0) {
            descriptorA = data_ov025_020b46cc;
            func_ov025_0208a13c(pMenu->missionList, &descriptorA);
        } else {
            descriptorB = data_ov025_020b46c0;
            func_ov025_0208a13c(pMenu->missionList, &descriptorB);
        }
        func_ov025_020ac654(pMenu);
        func_ov025_020ac7e8(pMenu);
        func_ov025_020ac994(pMenu);
        pMenu->pListNode = func_ov025_02084b2c(func_ov025_020a9b60);
        pMenu->nPageScroll = SCROLL_HIDDEN;
        pMenu->nInitStep++;
        break;
    case 1:
        func_ov025_020acbac(pMenu);
        func_ov025_020acd14(pMenu);
        func_ov025_020ab7b0(pMenu);
        func_ov025_020abdd8(pMenu, 0);
        if (pMenu->nSelectable > 1) {
            nCtx = func_ov025_02084a64();
            func_ov025_020a9ad4(nCtx, 0xc, 0, 0);
            func_ov025_020a9ad4(nCtx, 0xd, 0x1e, 0);
        }
        nTab = 0;
        if (func_ov025_02084e38() != 0) {
