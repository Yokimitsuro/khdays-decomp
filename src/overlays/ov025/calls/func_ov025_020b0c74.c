...
extern int func_ov025_020b09a0(void);
extern int func_ov025_020b0a04(void *buf);
extern void func_ov025_020b094c(int a, int b, int c);
...
int func_ov025_020b0c74(void) {
    int ret;
    int status;
    int *word;
    unsigned int i;

    status = func_ov025_020b09a0();
    if (status < 0) {
        goto out_busy;
    }
    if (status != 0) {
        ...
        if (i == 8) {
            ret = 2;
        } else if (func_ov025_020b0a04(data_0204be14) != 0) {
            ret = 0;
            ...
            if (data_ov025_020b5760.blockCounter >= 2) {
                ...
                func_ov025_020b094c(
                    (data_ov025_020b5760.blockCounter
                     + data_ov025_020b5760.slot * 2) * 0x2018 + 0x20,
