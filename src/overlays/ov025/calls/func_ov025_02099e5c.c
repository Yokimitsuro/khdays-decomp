/* func_ov025_02099e5c -- draw a two-digit value as a right-aligned pair of digit sprites.
...
void func_ov025_02099e5c(int tag, int value) {
    int i;
    int ctx = func_ov025_02084a50();

    for (i = 0; i < 2; i++) {
        int digit = value % 10;
        int entry = func_ov025_020894b0(ctx, (unsigned short)(digit + 0x14));
        func_ov025_02089560(ctx, entry, (short)tag--, 0x16);
