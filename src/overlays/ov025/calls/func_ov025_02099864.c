...
extern void func_ov025_02095cbc(int rec, int mode);
extern void func_02033b78(int a, int b);

void func_ov025_02099864(void) {
    int rec = func_ov025_02084afc();
    if (*(int *)(rec + 0x30) != 0) {
        return;
    }
    switch (*(int *)(rec + 0xa4)) {
    case 2: func_ov025_02095cbc(rec, 1); break;
    case 5: func_ov025_02095cbc(rec, 4); break;
    case 7: func_ov025_02095cbc(rec, 0); break;
    }
    func_02033b78(0, 3);
}
