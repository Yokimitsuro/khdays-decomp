...
extern void  func_ov025_02088018(void *object);
extern void  func_ov025_020891b4(void *object);
extern void  NNSi_FndFreeFromDefaultHeap(void *allocation);
extern void  func_ov025_020850c8(void);
extern int   func_020362e8(void *inputHeader);
extern void  func_ov025_02082cfc(void);
...
void func_ov025_0208443c(void)
{
    ...
    func_ov025_02084bf8();
    func_02000fb4(1, data_ov025_020b4a38);
    func_ov025_02088018(data_ov025_020b5744[1]->subsystem0);
    func_ov025_02088018(data_ov025_020b5744[1]->subsystem1);
    func_ov025_020891b4(data_ov025_020b5744[1]->object9500);
    func_ov025_020891b4(data_ov025_020b5744[1]->object954c);

    for (bufferIndex = 0; bufferIndex < 7; bufferIndex++) {
        if (data_ov025_020b5744[1]->
    ...
    func_ov025_020850c8();
    func_020362e8(
        &data_ov025_020b5744[1]->displayState.inputHeader);
    func_ov025_02082cfc();
    ...
    *REG_DISPCNT_SUB =
    ...
    if (data_ov025_020b5744[1]->secondaryMessageContainer != 0) {
        func_02024fd4(
            data_ov025_020b5744[1]->secondaryMessageContainer);
    }
    func_02024fd4(data_ov025_020b5744[1]->tertiaryMessageContainer);
    func_02024fd4(data_ov025_020b5744[1]->primaryMessageContainer);
    ...
    if (data_ov025_020b5744[1] != 0) {
        NNSi_FndFreeFromDefaultHeap(data_ov025_020b5744[1]);
        data_ov025_020b5744[1] = 0;
    }
