/* func_ov025_020af608 -- Ov008_LoadMenuSubBg2 (152 B, 8 relocs).
 ...
 * (data_ov025_020b568c) to the cell-list context. Character-block layout matches the loader family
...
extern u8 data_ov025_020b568c[];
extern Ov008MenuContext *func_ov025_02084b14(void);
...
void func_ov025_020af608(int param_1)
{
    Ov008MenuContext *ctx1 = func_ov025_02084b14();
    void *ctx2 = func_ov025_02084a64();
    void *resource;
    ...
    func_ov025_020891dc(ctx2, data_ov025_020b568c);
}
