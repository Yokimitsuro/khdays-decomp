/* func_ov025_020a5344 -- build the bitmask of occupied ranks for group param_2.
...
unsigned int func_ov025_020a5344(int param_1, unsigned int param_2) {
    unsigned int mask = 0;
    unsigned short *n;
    for (n = func_ov025_0208a1cc(param_1 + 0x4d4, 0); n != 0;
         n = func_ov025_0208a1cc(param_1 + 0x4d4, (int)n)) {
        if (*n == param_2) {
