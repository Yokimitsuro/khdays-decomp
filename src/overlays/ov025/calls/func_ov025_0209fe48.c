/* func_ov025_0209fe48 -- Ov025_Reports_PageUp: scroll the reports window (+0 of the page) up by
 ...
 * are highlighted (Ov025_Reports_HighlightRows 020a0a14) in read-variant mode, the record (or
 * its read variant, +0x40) marked owned (Ov025_QueryItemFlags 0209e820) when it has nothing
