...
extern int func_ov025_02088ca8(int a);
extern void MI_CpuFill8(void *dst, int val, int size);
extern int func_ov025_02088c58(int a, int b);
int func_ov025_02089214(int a, int b, unsigned short c, unsigned short d, unsigned short e,
                        short f, short g, int h) {
    int obj = func_ov025_02088ca8(a);
    ...
    *(short *)(obj + 0xa) = f;
    *(short *)(obj + 0xc) = g;
    *(int *)(obj + 0x18) = func_ov025_02088c58(a, b);
    *(int *)(obj + 0x14) = 1;
    return obj;
}
