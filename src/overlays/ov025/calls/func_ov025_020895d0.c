/* func_ov025_020895d0 -- initialise a tracker node and append it to the owner's list.
...
extern int  func_ov025_020894b0(int owner, unsigned int tag);
extern void NNS_FndAppendListObject(void *list, void *obj);

void func_ov025_020895d0(int *param_1, int param_2, unsigned char param_3, unsigned char param_4,
    ...
    *(int *)(param_2 + 0x24) = param_8;
    if (param_7 == 0xffff) {
        ...
        entry = func_ov025_020894b0((int)param_1, param_7);
    }
