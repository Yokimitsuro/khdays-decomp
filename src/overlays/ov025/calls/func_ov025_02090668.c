/* func_ov025_02090668 -- Ov008_DrawRowCountDigits: write the "placed / owned"
...
extern Font *func_ov025_02084cb4(void);                                   /* wide glyph set */
...
void func_ov025_02090668(Ov008MenuContext *pCtx, int nRow, int nPlaced, int nOwned)
{
    int nY;
    int nLeft;
    u16 nDigit;
    ...
    pFont = func_ov025_02084cb4();
    pCtx->panelSurfaceA.pPixels = func_ov025_02084cb4();
    nX = OWNED_X;
    do {
        nDigit = nOwned % 10;
        nDigit += '0';
    ...
    pCtx->panelSurfaceA.pPixels = func_ov025_02084c84();
}
