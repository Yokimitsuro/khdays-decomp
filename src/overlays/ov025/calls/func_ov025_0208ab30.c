...
extern Entry data_ov025_020b4b30[];
extern Entry data_ov025_020b4bb4[];

void func_ov025_0208ab30(void)
{
    unsigned int i;
    unsigned short v;
    ...
    i = 0;
    do {
        v = data_ov025_020b4b30[i].preset |
            func_020235d0(data_ov025_020b4b30[i].id * 4 + 0x92b, 4);
        func_020235e8(data_ov025_020b4b30[i].id * 4 + 0x92b, 4, v);
        i = i + 1;
    } while (i < 8);
    ...
    i = 0;
    do {
        v = data_ov025_020b4bb4[i].preset |
            func_020235d0(data_ov025_020b4bb4[i].id * 4 + 0x92b, 4);
        func_020235e8(data_ov025_020b4bb4[i].id * 4 + 0x92b, 4, v);
        i = i + 1;
    } while (i < 0xe);
}
