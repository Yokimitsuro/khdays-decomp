 ...
 * at +0x4a38. If a template (param_2) is given, apply it (func_ov025_020883f8) and, when it
 * carries a non-empty payload (param_2[5], param_2[4]>0), load it via func_ov025_0208832c. */
...
extern void func_ov025_020883f8(char *obj, int *tmpl);
extern void func_ov025_0208832c(char *obj, char *data, int count);
extern unsigned char data_0204c058;
int func_ov025_02087f90(char *param_1, int *param_2, int param_3, int param_4) {
    int budget;
    ...
    *(int *)(param_1 + 0x4a74) = func_02020400(0x3c000, budget);
    ...
    if (param_2 != 0) {
        func_ov025_020883f8(param_1, param_2);
        if (param_2[5] != 0 && param_2[4] > 0) {
            func_ov025_0208832c(param_1, (char *)param_2[5], param_2[4]);
        }
    }
    return 1;
}
