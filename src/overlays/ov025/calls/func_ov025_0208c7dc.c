/*
 * func_ov025_0208c7dc -- x3 (ov002/...). Advance or commit a widget's scroll, then clear the dirty
...
void func_ov025_0208c7dc(int param1, int param2, int param3, int param4) {
