/* func_ov025_020a36f0 -- find the node in the list at obj+0x1cc whose (+8, +0) pair matches
...
int *func_ov025_020a36f0(int param_1, int param_2, int param_3, int *param_4) {
    int idx = 0;
    int *n;
