...
extern void func_ov025_020b08bc(void *arg);

extern CardTransferCtx data_ov025_020b5760;

void func_ov025_020b094c(int a, int b, int c) {
    data_ov025_020b5760.thread = NNSi_FndAllocFromDefaultExpHeap(0x2d0);
    data_ov025_020b5760.thread->paramA = a;
    data_ov025_020b5760.thread->paramC = c;
    data_ov025_020b5760.thread->paramB = b;
    OS_CreateThread(data_ov025_020b5760.thread, func_ov025_020b08bc,
