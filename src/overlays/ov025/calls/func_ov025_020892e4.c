 ...
 * param_3 through func_ov025_020894b0. */
typedef unsigned short u16;
typedef unsigned char u8;
extern void *func_ov025_02088ce8(int a);
extern void MI_CpuFill8(void *dst, int val, unsigned int size);
extern void *NNSi_FndAllocFromDefaultExpHeap(unsigned int size);
extern int func_ov025_020894b0(int a, unsigned int tag);
unsigned int *func_ov025_020892e4(int param_1, u16 param_2, int param_3, int param_4,
                                  unsigned int param_5, unsigned int param_6, int param_7) {
    int i;
    unsigned int *n = (unsigned int *)func_ov025_02088ce8(param_1);
    ...
    *(u8 *)((char *)n + 0x24) |= 2;
    n[0xa] = 0x7fffffff;
    for (i = 0; i < param_4; i++) {
        ((int *)n[0xb])[i] = func_ov025_020894b0(param_1, ((u16 *)param_3)[i]);
    }
    return n;
}
