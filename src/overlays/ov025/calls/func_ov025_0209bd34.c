/* func_ov025_0209bd34 -- x3 (ov008/...). Does the cursor at tag `tag` overlap any of the first
...
extern int func_ov025_0208843c(int ctx, int tag);
extern int *func_ov025_020884c8(int ctx, int slot);

int func_ov025_0209bd34(int param1, int tag, int a2, int a3, ...) {
    int dx;
    int i;
    int ctx;
    int *p3;
    ...
    p3 = func_ov025_020884c8(ctx, func_ov025_0208843c(ctx, tag + 1));
    i = 0;
    dx = *(int *)&a2;

    while (1) {
        int *p5 = func_ov025_020884c8(ctx, func_ov025_0208843c(ctx, i + 1));
