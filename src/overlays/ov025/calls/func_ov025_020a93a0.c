/* func_ov025_020a93a0 -- Ov025_MissionList_CursorPrev: move the mission list's cursor slot (+0x54)
 * to the previous accepted slot (Ov025_StepCursorToAcceptedSlot 020a5284) while the +0x68,
...
void func_ov025_020a93a0(Ov008MissionList *pList)
{
    u32 nSlot;
