 ...
 * +0x24, clears the +0x45 byte and hands the tick over to func_ov209_020d5ed8. */
...
extern void func_ov209_020d5ed8(int *node);

void func_ov209_020d5d90(int *node)
{
    ...
    *(unsigned char *)((char *)state + 0x45) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov209_020d5ed8);
}
