 ...
 * +0x7c grid (func_ov209_020d26a8): each struck object (func_ov002_02076dac, power 0xff) gets the
 * message data_ov209_020d65fc at the sphere surface. The shot ends on a solid wall (01fff920, the
 ...
 * and the tick hands over to func_ov209_020d5064. */
...
extern int func_ov209_020d26a8(int grid, Sphere *sphere, int *list);
...
extern void func_ov209_020d5064(int *node);
...
void func_ov209_020d4a8c(int *node)
{
    ...
    *(Vec3 *)(state + 5) = *(Vec3 *)(state + 0x15);
    ...
    n = func_ov209_020d26a8(*(int *)(grid + 0x7c), &sphere, list);
    for (i = 0; i < n; i++) {
        StrikeInfo info = {0};
        Vec3 dir;
        Vec3 pt2;
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov209_020d5064);
}
