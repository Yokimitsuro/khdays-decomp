/*
 * func_ov209_020d3ca4 -- x3 (ov208/209/268). AI-state tick: face the target and fire, branching the
...
extern int  func_ov209_020d2cc4(int obj, void *p);
...
extern void func_ov209_020d3e44(void);
extern short data_0203d210;

void func_ov209_020d3ca4(int *self) {
    ...
    *(char *)((int)state + 0x49) = 0;
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov209_020d3e44);
}
