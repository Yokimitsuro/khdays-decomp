 ...
 * the +0x49 byte and hands the tick over to func_ov209_020d4548. */
...
extern void func_ov209_020d4548(int *node);

void func_ov209_020d44cc(int *node)
{
    ...
    *(unsigned char *)((char *)state + 0x49) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov209_020d4548);
}
