...
extern void func_ov209_020d3754(int);
void func_ov209_020d36f4(int param_1) {
    ...
    *(int *)(child + 0x2c) = 0;
    ...
    if (d < 0) d = -d;
    *(int *)(child + 0x3c) = base + func_02023eb4(d + 1);
    func_ov107_020c9264(*(int *)child, 9, 0);
    func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov209_020d3754);
}
