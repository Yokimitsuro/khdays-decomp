 ...
 * the tick hands over to func_ov209_020d6114. */
...
extern void func_ov209_020d6114(int *node);

void func_ov209_020d5ed8(int *node)
{
    ...
    func_ov107_020c5af8(*state, 0x154, 0xe, (void *)state[2]);
    state[0x10] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov209_020d6114);
}
