 ...
 * of the direction and the tick hands over to func_ov209_020d4964. */
...
extern void func_ov209_020d4964(int *node);

void func_ov209_020d4794(int *node)
{
    ...
    *(Vec3 *)(state + 0x15) = data_02041dc8;
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov209_020d4964);
}
