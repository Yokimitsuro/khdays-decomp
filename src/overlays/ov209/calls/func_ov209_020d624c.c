 ...
 * animation 2) and hands over to func_ov209_020d6574; otherwise the travelled length accumulates
...
extern void func_ov209_020d6574(int *node);

void func_ov209_020d624c(int *node)
{
    ...
    *(Vec3 *)(state + 9) = *(Vec3 *)state[2];
    if (func_01fff920(*(void **)(world + 0x7c), (Vec3 *)state[2], &delta) != 0) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov209_020d6574);
        return;
    }
