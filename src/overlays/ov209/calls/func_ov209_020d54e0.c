/*
 * func_ov209_020d54e0 -- x3. Node update entry: apply a motion, fire an optional callback, tick.
...
extern void func_ov209_020d5ae8(int p, struct vec3 abc);

void func_ov209_020d54e0(int self, struct vec3 v, struct vec3 abc) {
    int *s = (int *)self;
    ...
    if (s[0x14] == 1) {
        func_ov209_020d5ae8(s[0x85], abc);
    }
}
