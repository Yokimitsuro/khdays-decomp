 ...
 * of the direction and the tick hands over to func_ov208_020d2b44. */
...
extern void func_ov208_020d2b44(int *node);

void func_ov208_020d2974(int *node)
{
    ...
    if (*(u8 *)((char *)state + 0x49) == 0 && state[0xb] >= 0xeee) {
        func_ov107_020c5af8(*state, 0x154, 0xa, (void *)state[3]);
    ...
    *(Vec3 *)(state + 0x15) = data_02041dc8;
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov208_020d2b44);
}
