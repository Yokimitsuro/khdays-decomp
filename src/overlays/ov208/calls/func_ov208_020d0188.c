/* Draw handler of the ov208 enemy (x3 with ov209/ov268): unhooks the +0x3ac clip and, in owner
 * mode 1 without bit 2 of the +0x60 flags, pushes the actor away from the entities inside a 0x388c
 * sphere around the +0x3dc bone's +0x14 point lifted 0x25b3: each hit weighs by the sphere radius
...
void func_ov208_020d0188(int self, int slot)
{
    VecFx32 list[4];
    VecFx32 direction;
    Sphere sphere;
