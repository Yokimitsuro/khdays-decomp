/*
 * func_ov208_020d19b8 -- x3. AI-state tick: set the turn rate, aim/steer, transition once the timer
...
extern void func_ov208_020d1afc(void);

void func_ov208_020d19b8(int *self) {
    ...
    *(char *)(state[1] + 0xa8) = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov208_020d1afc);
}
