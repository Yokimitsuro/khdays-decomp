/*
 * func_ov208_020d1afc -- x3 (ov208/209/268). AI-state tick: face the target and fire attack 0xa once
 ...
 */
extern int  func_ov208_020d0ea4(int obj, int flag);
extern void func_0203c634(int self, int idx, int cb);
extern void VEC_Subtract(void *a, void *b, void *c);
extern void func_01ff8d18(void *a, void *b);
extern int  func_020050b4(int x, int z);
extern void func_ov107_020c9264(int a, int b, int c);
extern void func_ov208_020d1be0(void);

void func_ov208_020d1afc(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov208_020d1be0);
}
