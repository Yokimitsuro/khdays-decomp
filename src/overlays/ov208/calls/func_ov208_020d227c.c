/*
 * func_ov208_020d227c -- x3. AI-state tick: kick off a fixed motion, then dispatch.
...
extern void func_ov208_020d22e0(void);

void func_ov208_020d227c(int *self) {
    int *state = (int *)self[1];

    func_ov107_020c0b90(*state, 2, data_02041dc8, 0);
    state[0xb] = 0;
    *((char *)state + 0x49) = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov208_020d22e0);
}
