 ...
 * the tick hands over to func_ov208_020d42f4. */
...
extern void func_ov208_020d42f4(int *node);

void func_ov208_020d40b8(int *node)
{
    ...
    state[0x10] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov208_020d42f4);
}
