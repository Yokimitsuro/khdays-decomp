/*
 * func_ov208_020d1744 -- x3 (ov208/209/268). AI-state tick: wind up, then face the target and reset.
...
extern void func_ov208_020d180c(void);

void func_ov208_020d1744(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov208_020d180c);
}
