 ...
 * pos (e+0x84/+0x88) into a 2-word buffer and call func_ov208_020d0968 with the entity's
...
extern int func_ov208_020d0968(int *buf, int a, int b, int c, int *rect, int *corners,
                               int *acc, int arg);
int func_ov208_020d0888(int param_1, int *param_2, int param_3, int param_4) {
    ...
    for (i = 0; i < *(unsigned short *)(param_1 + 2); i++) {
        ...
        if ((*(unsigned short *)(e + 0x74) & 0x2000) == 0) {
            f.buf[0] = *(int *)(e + 0x84);
            f.buf[1] = *(int *)(e + 0x88);
            func_ov208_020d0968(f.buf, *(int *)(e + 0x8c), *(int *)(e + 0x9c),
