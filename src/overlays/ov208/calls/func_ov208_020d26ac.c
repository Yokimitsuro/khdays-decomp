 ...
 * the +0x49 byte and hands the tick over to func_ov208_020d2728. */
...
extern void func_ov208_020d2728(int *node);

void func_ov208_020d26ac(int *node)
{
    int *state = (int *)node[1];

    func_ov107_020c0b90(*state, 3, data_02041dc8, 0);
    func_ov107_020c5af8(*state, 0x154, 8, (void *)(*(int *)(*state + 0x3c4) + 4));
    state[0xb] = 0;
    *(unsigned char *)((char *)state + 0x49) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov208_020d2728);
}
