/*
 * func_ov208_020d277c -- x3. AI-state tick: during a mid-window, drive two anchors, then transition.
 ...
 */
struct v4 { int w[4]; };
extern void func_ov208_020d0f8c(int a, int b, void *c, int d);
extern void func_0203c634(int self, int idx, int cb);

void func_ov208_020d277c(int *self) {
    ...
    if (state[0xb] > 0x2aa && state[0xb] < 0xc44) {
        ...
        func_ov208_020d0f8c((int)state, 2, &v, 0);
