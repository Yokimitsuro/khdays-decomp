...
extern const char data_ov208_020d4820[];
extern void func_ov208_020cfc80(int);
int func_ov208_020cfb78(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x410);
    *(signed char *)(obj + 0x19c) = 42;
    OS_SPrintf(buf, data_ov208_020d4820, 42);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov208_020cfc80;
