...
extern const struct tbl8 data_ov208_020d47ec;

void func_ov208_020d0968(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov208_020d0968(newcenter, half, child, param_4,
