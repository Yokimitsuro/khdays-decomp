/* Contact sweep of the ov208 enemy (x3 with ov209/ov268): collects the entities in the given box
...
void func_ov208_020d0f8c(int *state, int kind, Sphere *sphere, void *box)
{
    int hits[4];
    Vec3 push;
    Vec3 dir;
    ...
    switch (kind) {
    case 0:
        func_ov107_020c5af8(*state, 0x154, 7, (void *)state[2]);
        break;
    default:
        func_ov107_020c5af8(*state, 0x154, 9, (void *)state[2]);
        break;
    }
}
