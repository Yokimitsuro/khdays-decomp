/*
 * func_ov208_020d36c0 -- x3. Node update entry: apply a motion, fire an optional callback, tick.
...
extern void func_ov208_020d3cc8(int p, struct vec3 abc);

void func_ov208_020d36c0(int self, struct vec3 v, struct vec3 abc) {
    int *s = (int *)self;
    ...
    if (s[0x14] == 1) {
        func_ov208_020d3cc8(s[0x85], abc);
    }
}
