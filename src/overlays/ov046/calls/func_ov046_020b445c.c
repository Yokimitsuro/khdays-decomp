/* func_ov046_020b445c -- enemy state tick, head of a 4-member family (ARM).
 * State 1 accumulates the frame delta at +0x10c and, past 0xa000, notifies func_ov046_020b4608
 ...
 * r0 at that point (nothing has written r0 since entry) because func_ov046_020b4608 takes it as
 ...
 */
extern void func_ov046_020b4608(int *node);
