...
extern void func_ov046_020b4694(void);
extern void func_ov046_020b4824(void);

void *func_ov046_020b3770(char *self, int msg) {
    char *blk = data_ov046_020b4b40 + 0x2c80;
    void *next = 0;
    Vec3 d;
    unsigned short a;
    int *node;
    ...
    switch (msg) {
    case 0x21:
        next = (void *)&func_ov046_020b4694;
        (*(void (**)(char *, int))(self + 0x664))(self, 0x2f);
        break;
    case 0x22:
        *(int *)(blk + 0x118) = 0;
        next = (void *)&func_ov046_020b4824;
