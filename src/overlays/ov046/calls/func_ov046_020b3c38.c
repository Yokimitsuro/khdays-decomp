...
typedef struct Ov046RadialBurstFrame {
    MtxFx33 mRotation;
    VecFx32 vSpawnPosition;
    VecFx32 vRadialOffset;
    VecFx32 vOrigin;
} Ov046RadialBurstFrame;

typedef struct Ov046HeadingSource {
    u8 pad00[0x80];
    u16 nHeading;
} Ov046HeadingSource;

typedef struct Ov046EffectPart {
    u8 pad00[2];
    s8 nState;
    u8 pad03;
    int nLifetime;
...
typedef struct Ov046SceneFlags {
    u8 bSlotSpawnEnabled : 1;
    u8 rest : 7;
} Ov046SceneFlags;

typedef struct Ov046SceneState {
    u32 nFlags;
    u8 pad04[0x1c];
    Ov046HeadingSource *pHeadingSource;
    u8 pad24[0x456];
    u8 nPendingMode;
    u8 nPendingIndex;
    u8 pad47c[0x218];
    Ov046SceneFlags slotSpawnFlags;
    u8 pad695[0x25eb];
    u8 aSlotPool[4];
} Ov046SceneState;

extern Ov046SceneState *data_ov046_020b4b40;
...
extern void func_ov046_020b43bc(int slotPool, VecFx32 *position);
extern int func_02030788(void);
extern void func_02033d0c(int slotId, int variant, VecFx32 *position,
                          int flags);

int func_ov046_020b3c38(void *pContext, Ov046EffectPart *pPart, int nDelta)
{
    const short *pSinCosTable;
    MtxFx33 *pRotation;
    Ov046RadialBurstFrame f;
    int nSpawnVariant;
    int nAngle;
    Ov046SceneState *pScene;

    pScene = data_ov046_020b4b40;
    pPart->nState = 4;
    ...
    if (pPart->nPhase == 2) {
        ...
        do {
            ...
            func_ov046_020b43bc((int)pScene->aSlotPool, &f.vSpawnPosition);
