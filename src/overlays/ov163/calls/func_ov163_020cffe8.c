/* func_ov163_020cffe8: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
void func_ov163_020cffe8(struct Node *node)
{
    struct State *st;
    struct Msg msg;
    FxVec raw;
    ...
    *(u8 *)(st->pActor + 0x1c5) &= ~0xf;
    ...
    func_0203c634(node, node->bSlot, (void *)func_ov163_020d01b4);
}
