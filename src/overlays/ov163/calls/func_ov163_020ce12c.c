/* func_ov163_020ce12c: ported from a matched sibling family (same shape, constants and offsets adjusted). */
extern int func_ov163_020d0c58(int, int, int, int);
...
extern int func_ov163_020d0a6c(int, int, int, int);
extern int func_ov107_020c09a0(int, int, int, int, int, int);
extern void func_ov107_020c7500(int, int, int);
void func_ov163_020ce12c(int param_1, int param_2, int param_3, int param_4) {
    int result;
    if (*(unsigned char *)(param_2 + 2) == 0x5) {
        switch (*(unsigned char *)(param_2 + 3)) {
        case 0:
            if (*(int *)(*(int *)(param_1 + 0x3c4) + 4) == 0) {
                result = func_ov163_020d0c58(param_1, *(int *)(*(int *)(param_1 + 0x3c4) + 4),
                                             param_3, param_4);
                *(int *)(*(int *)(param_1 + 0x3c4) + 4) = result;
            }
            result = func_ov107_020cb040(param_1, 0x153, 4, 0,
                                         *(int *)(param_1 + 0x3c0) + 4);
        ...
        case 3:
            ...
            *(int *)(*(int *)(param_1 + 0x3c4) + 0x14) = result;
            ...
            break;
        case 4:
            result = func_ov163_020d0a6c(param_1, *(unsigned char *)(param_2 + 3), param_3, param_4);
