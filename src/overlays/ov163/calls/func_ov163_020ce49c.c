...
extern const struct tbl8 data_ov163_020d0ea8;

void func_ov163_020ce49c(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov163_020ce49c(newcenter, half, child, param_4,
