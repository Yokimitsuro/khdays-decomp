...
extern void func_ov258_020d0bbc(void);

void func_ov258_020d0af4(int *node)
{
    ...
    *(int *)(*state + 0x5c) &= ~2;
    ...
    func_0203ca50((void *)(*state + 4), 0x2000, 0x2000, 0x2000);
    func_0203c7ac(*state, 0);
    state[5] = 0;
    *(u8 *)(state + 6) = 0;
    *((u8 *)state + 0x19) = 1;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov258_020d0bbc);
}
