...
extern void func_ov258_020d0738(void);
extern void func_ov258_020d07e8(void);

int func_ov258_020d06a0(int owner, int item, Vec3 *pos, int kind)
{
    Ov258Spawn *spawn;
    Vec3 at;
    int handle;

    handle = func_0203c5c0(*(int *)(owner + 0x3c), 100, 0x1c, func_ov258_020d0738, func_ov258_020d07e8, &spawn);
    spawn->owner = owner;
    spawn->item = item;
    at = *pos;
    spawn->pos = *pos;
