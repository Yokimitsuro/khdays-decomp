...
extern void func_ov131_020cebb8(void);
extern void func_ov131_020cecf8(void);

void func_ov131_020cec10(int *node) {
    int *state = (int *)node[1];
    state[1] = *(int *)(*(int *)(*state + 0x3c4) + 0x20);
    *(void **)(state[1] + 0x6c) = func_ov131_020cebb8;
    ...
    *(int *)(state[1] + 0x5c) &= ~2;
    ...
    state[2] = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov131_020cecf8);
}
