...
extern const struct tbl8 data_ov131_020cefac;

void func_ov131_020cc68c(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov131_020cc68c(newcenter, half, child, param_4,
