...
extern const struct CameraWork data_ov186_020d34cc;
extern struct RollingCounter data_ov186_020d34f0;

extern void func_ov186_020d19d8(struct Obj *self);
extern void func_ov186_020d19f4(struct Obj *self);
extern void func_ov186_020d1a6c(struct Obj *self);
extern void func_ov186_020d1c14(struct Obj *self);
extern void func_ov186_020d1bdc(struct Obj *self);
extern void func_ov186_020d1ae0(struct Obj *self);
extern void func_ov186_020d1c60(struct Obj *self);
extern void func_ov186_020d1df0(struct Obj *self);
extern void func_ov186_020d1af8(struct Obj *self);
 ...
 */
void func_ov186_020d184c(struct Obj *self)
{
    struct OutgoingFrame frame;
    frame.work = data_ov186_020d34cc;
    struct PoolEntry *slot;
    int result;
    u8 capacity;
    self->fn08 = func_ov186_020d19d8;
    self->fn0c = func_ov186_020d19f4;
    self->fn1c = func_ov186_020d1a6c;
    self->fn30 = func_ov186_020d1c14;
    self->fn34 = func_ov186_020d1bdc;
    self->fn1d4 = func_ov186_020d1ae0;
    self->fn1d0 = func_ov186_020d1c60;
    self->fn1e0 = func_ov186_020d1df0;
    self->fn1dc = func_ov186_020d1af8;
    ...
    *(struct CameraWork *)self->camera64 = frame.work;
    ...
    func_02016b60(self->subitem384->container88->config78, 3,
                  data_ov186_020d34f0.value);

    data_ov186_020d34f0.value = (data_ov186_020d34f0.value + 1) & 0x1f;
