/*
 * func_ov186_020d0d40 -- x3 (ov185/186/187). AI-state tick: seed a randomized strafe and dispatch.
...
extern void func_ov186_020d0dc8(void);

void func_ov186_020d0d40(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov186_020d0dc8);
}
