...
extern void func_ov186_020d051c(struct Ov185ActionState *state, struct Vec3 *pos,
 ...
 */
void func_ov186_020d0f94(struct Ov120ActionNode *node)
{
    int nDist;
    int nTargetRadius;
    int nRange;
    ...
    func_ov186_020d051c(state, &state->vPos18, nDist, nTargetRadius);
