 ...
 */
extern void func_ov083_020b9794(int self);
extern void func_ov083_020b90a8(int self, char *p);
...
void func_ov083_020b8564(int self, int mode) {
    int flag;
    int ret;

    switch (mode) {
    case 0x2e:
        if (mode != *(int *)(self + 0x6bc)) { func_ov083_020b9794(self); }
        break;
    case 0x2f:
    case 0x30:
        if (mode != *(int *)(self + 0x6bc)) {
            func_ov083_020b90a8(self, (char *)(self + 0x2df0));
        }
        break;
    }
