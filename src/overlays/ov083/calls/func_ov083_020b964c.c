...
extern void func_ov083_020b9848(void);
extern void func_ov083_020b97e0(void);
extern int data_ov083_020b9ae8;

void func_ov083_020b964c(char *self)
{
    ...
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) = (void *)&func_ov083_020b9848;
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x24) = (void *)&func_ov083_020b97e0;
}
