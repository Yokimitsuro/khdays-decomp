 ...
 * the tracking step (func_ov222_020d314c) ends the state when negative, otherwise the +0x3fc
...
extern int func_ov222_020d314c(int *node, int arg);
...
void func_ov222_020d5188(int *node)
{
