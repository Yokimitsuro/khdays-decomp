 ...
 * (the data_ov222_020d6bfc kind is copied to the stack between the two writes), bit 2 of +0x1ae
 ...
 * +0x78 the rolling data_ov222_020d6c74 slot (which then advances, wrapping to 3 at 0x1f);
...
extern void func_ov222_020d6038(void);
extern void func_ov222_020d606c(void);
extern void func_ov222_020d60d0(void);
extern void func_ov222_020d625c(void);
extern const struct Ov221Saved data_ov222_020d6bfc;
extern struct RollingCounter data_ov222_020d6c74;

void func_ov222_020d5e40(char *self) {
    int owner;
    unsigned short v;
    struct Ov221Saved saved;

    owner = *(int *)(self + 0x390);
    *(void **)(self + 8) = (void *)func_ov222_020d6038;
    *(void **)(self + 0xc) = (void *)func_ov222_020d606c;
    *(void **)(self + 0x1c) = (void *)func_ov222_020d60d0;
    *(void **)(self + 0x30) = (void *)func_ov222_020d625c;
    ...
    *(int *)(self + 0x384) = func_0203b898(func_ov107_020c9440(owner, 0x1a));
    ...
    data_ov222_020d6c74.value = data_ov222_020d6c74.value + 1;
    if (data_ov222_020d6c74.value >= 0x1f) {
        data_ov222_020d6c74.value = 3;
    }
