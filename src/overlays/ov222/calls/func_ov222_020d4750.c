...
extern void func_ov222_020d5d58(int self, int mode, Vec3 at, Vec3 facing, Vec3 dir);
...
void func_ov222_020d4750(int *node)
{
    ...
    if (*(u8 *)((char *)state + 0x75) == 0 && state[0x17] >= 0x17e8) {
        ...
        for (i = 0; i < n; i++) {
            ...
            func_ov222_020d5d58(((struct Ov221Family *)*state)->aChildren[i], bNoTarget, vAt, vFacing, vChildDir);
