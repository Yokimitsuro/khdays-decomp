/* Sub-state script of the ov222 enemy: runs while the +0x40c script id is the current sub-state and
 ...
 * +0x41c/+0x420 clear. When the rig is free and either held or grounded, func_ov222_020d2dec (with
...
extern void func_ov222_020d2dec(char *self, int hold);
extern const Vec3 data_02041dc8;

void func_ov222_020d2e64(char *self, int *node)
{
    Fx32 scratchZ;
    Fx32 scratchY;
    Fx32 scratchX;
    ...
    *(int *)(self + 0x404) += *(int *)(*node + 0x2c);
    ...
    func_ov222_020d2dec(self, *(int *)(self + 0x408));
}
