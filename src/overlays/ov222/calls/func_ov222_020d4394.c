/* func_ov222_020d4394 -- the strafe tick: re-acquire the target, then either correct the distance
 * or settle on a facing.
 *
 * func_ov222_020d314c hands back the range and fills a direction vector; negative means give up,
 * and func_ov222_020d2b40 gets a veto too. Both bail through a plain c634 re-entry.
 *
 ...
 * Either one hands off to func_ov222_020d45dc. In the band between, or with the flag set, it
...
extern int func_ov222_020d314c(int self, VecFx32 *dir);
extern void func_0203c634(int self, int action, void *cb);
extern int func_ov222_020d2b40(int self, int range);
extern void func_ov222_020d45dc(void);
extern void func_ov222_020d41a4(int self, int angle);
...
void func_ov222_020d4394(int self) {
    int *ctx;
    VecFx32 dir;
    int range;
    int facing;
    ...
    *(int *)(ctx[0] + 0x3e8) = func_ov107_020cab14(ctx[0], 0);
    ...
    range = func_ov222_020d314c(self, &dir);
    if (range < 0) {
        func_0203c634(self, *(signed char *)(self + 0x20), 0);
        return;
    }
    if (func_ov222_020d2b40(self, range) != 0) {
        func_0203c634(self, *(signed char *)(self + 0x20), 0);
        return;
    }
    ...
    *(VecFx32 *)((char *)ctx + 0x38) = *(VecFx32 *)ctx[2];
    ...
    if (((Flags17a *)(ctx[0] + 0x17a))->b1 == 0) {
        if (range > 0xf000) {
            *(int *)((char *)ctx + 0x38) += dir.x * (range - 0x5000) / 0x1000;
            ...
            func_0203c634(self, *(signed char *)(self + 0x20), func_ov222_020d45dc);
            return;
        }
        if (range < 0x3800) {
            *(int *)((char *)ctx + 0x38) += -dir.x * (range + 0x5000) / 0x1000;
    ...
    func_ov222_020d41a4(self, facing);
}
