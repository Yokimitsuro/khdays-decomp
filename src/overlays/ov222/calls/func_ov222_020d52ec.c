/* func_ov222_020d52ec -- enter the approach: pick a lane, a speed and a duration, then dispatch.
 * A negative reading from func_ov222_020d314c aborts straight to the dispatcher.
 *
...
extern int func_ov222_020d314c(int self, int kind);
...
extern void func_ov222_020d5430(void);

void func_ov222_020d52ec(int self) {
    int *ctx;
    int v;
    int speed;
    int steps;
    ...
    *(unsigned char *)((char *)ctx + 0x76) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov222_020d5430);
}
