/*
 * func_ov222_020d69c0 -- x4 (ov221/222/224/225). AI-state tick: drive a spin/lunge along a matrix.
...
void func_ov222_020d69c0(int *self) {
    ...
    func_ov222_020d6770((int)self, 1, 1);
}
