 ...
 * register it (+0x1a4), install the 020d1bdc callback (+0x18c) and init. Return it. */
extern int func_0203d15c(int a);
extern void OS_SPrintf(char *buf, const char *fmt, int a);
extern int func_ov107_020c9c24(char *buf);
extern void func_ov107_020c6624(int a, int b);
extern const char data_ov222_020d6c20[];
extern void func_ov222_020d1bdc(int);
int func_ov222_020d1998(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x464);
    *(signed char *)(obj + 0x19c) = 0x33;
    OS_SPrintf(buf, data_ov222_020d6c20, 51);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov222_020d1bdc;
