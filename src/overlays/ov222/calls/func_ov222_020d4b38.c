 ...
 * the tick hands over to func_ov222_020d4db4. */
...
extern int func_ov222_020d314c(int *node, Vec3 *dir);
...
extern void func_ov222_020d4db4(int *node);

void func_ov222_020d4b38(int *node)
{
    ...
    if (func_ov222_020d314c(node, 0) < 0) {
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov222_020d4db4);
}
