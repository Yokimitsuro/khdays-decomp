...
extern void func_ov222_020d2e64(int self, int *node);
extern void func_ov222_020d284c(int *state, int mode, struct Ov221SweepParams *params);
extern const Vec3 data_02042264;
extern const Vec3 data_02042270;
extern const Vec3 data_02042258;

void func_ov222_020d3618(int *node)
{
    ...
    *(Vec3 *)(*state + 0xf0) = step;
    ...
    func_ov222_020d2e64(*state, node);
    ...
    *(int *)(*state + 0x41c) += *(int *)(*node + 0x2c);
    ...
    params.bFlag = 1;
    func_ov222_020d284c(state, 6, &params);
}
