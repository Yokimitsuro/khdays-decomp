...
void func_ov241_020d083c(int node)
{
    ...
    if ((unsigned int)func_02023eb4(0x64) < wp->uChance) {
        ...
        func_0203c634(node, *(signed char *)(node + 0x20), func_ov241_020d08ec);
        return;
    }
    if (state[0xb] <= 0x100) {
    ...
    func_0203c634(node, *(signed char *)(node + 0x20), func_ov241_020d0994);
}
