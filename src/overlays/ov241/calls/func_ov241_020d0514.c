...
struct Ov241Actor { char pad[0x38c]; int *parts[3]; };

extern int func_ov241_020d02a0(int *node);
...
void func_ov241_020d0514(int *node)
{
    ...
    if (!(*(signed char *)(*state + 0x1c6) != 3 && *(signed char *)(*state + 0x1c6) != 2 &&
        ...
        state[0xc] = func_ov241_020d02a0(node);
        if (state[0xc] != 0) {
    ...
    if (*(signed char *)(*state + 0x1c7) != -1) {
        ...
        *(unsigned short *)(*state + 0x1ae) &= ~1;
        for (i = 0; i < 3; i++) {
            ((struct Ov241Actor *)*state)->parts[i][0x17] &= ~2;
        }
        switch (*(signed char *)(*state + 0x1c6)) {
        case 0:
            func_0203c634(node, 1, func_ov241_020d075c);
            break;
        case 1:
            func_0203c634(node, 1, func_ov241_020d0818);
            break;
        case 2:
            func_0203c634(node, 1, func_ov241_020d083c);
            break;
        case 3:
            func_0203c634(node, 1, func_ov241_020d0a30);
            break;
        case 6:
            func_0203c634(node, 1, func_ov241_020d0c08);
            break;
        }
    }
