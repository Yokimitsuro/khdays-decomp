...
extern void func_ov057_020b6178(int self);
extern void func_ov057_020b62c8(int self, void *p);
extern void func_ov022_020a4490(int self, int a, int b);
extern void func_ov057_020b67e8(int self, void *p, int flag);
extern void func_ov057_020b6304(int self, void *p);
extern void func_ov057_020b6600(int self, void *p);
extern void func_ov022_020a384c(int self, int mode);

void func_ov057_020b5cf0(int self, int mode) {
    char *p = (char *)(data_ov057_020b74a0 + 0x2c2c);
    int id = -1;

    switch (mode - 0x2e) {
    case 0:
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov057_020b6178(self);
        }
        break;
    case 3:
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov057_020b62c8(self, p + 0x228);
        }
        break;
    case 1:
    case 4:
        ...
        if (*(int *)(self + 0x6bc) != mode) {
            *(int *)p = flag;
            ...
            func_ov057_020b67e8(self, p + 0x444, flag);
            func_ov057_020b6304(self, p + 0x228);
        } }
        if (mode == 0x32) {
            id = 0x32;
            mode = 0x2f;
    ...
    case 2:
        if (*(int *)(self + 0x6bc) != mode) {
            *(int *)p = 1;
            func_ov057_020b6600(self, p + 0x338);
            func_ov057_020b6304(self, p + 0x228);
