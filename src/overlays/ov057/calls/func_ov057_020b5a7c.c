/* func_ov057_020b5a7c -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov057_020b5cf0(void);
extern void WM_EndKeySharing_0x020b5e0c(void);
extern void func_ov057_020b5f58(void);
extern void func_ov057_020b5c90(void);
extern void func_ov057_020b5cc8(void);
extern void func_ov057_020b5e18(void);
extern void func_ov057_020b5f90(void);
extern void func_ov057_020b6f2c(void);

extern void *data_ov057_020b74a0;
extern int data_ov057_020b73e8;
extern int data_ov057_020b73fc;
extern int data_ov057_020b737c;
extern int data_ov057_020b736c;
extern int data_ov057_020b735c;
extern int data_ov057_020b734c;
...
void func_ov057_020b5a7c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov057_020b73e8, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov057_020b73fc, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov057_020b5cf0;
    *(void **)(obj + 0x664 + 0x04) = (void *)&WM_EndKeySharing_0x020b5e0c;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov057_020b5f58;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov057_020b5c90;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov057_020b5cc8;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov057_020b5e18;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov057_020b5f90;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov057_020b6f2c;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov057_020b737c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov057_020b736c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov057_020b735c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov057_020b734c) : -1;
