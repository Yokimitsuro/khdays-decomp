/* Constructor of the ov220 enemy (and its byte-identical twin ov220): installs the handlers
 ...
 * +0x64 pose, then loads sound 0x137. Codegen: the box is spelled with the max corner derived
...
extern void func_ov220_020d1c1c(void);
extern void func_ov220_020d1c5c(void);
extern void func_ov220_020d1d04(void);
extern void func_ov220_020d1eac(void);
extern void func_ov220_020d1e10(void);
extern void func_ov220_020d1f08(void);
extern void func_ov220_020d1e74(void);
extern void func_ov220_020d2148(void);
extern void func_ov220_020d2168(void);
extern void func_ov220_020d2194(void);
...
extern const Kinds data_ov220_020d3b94;
extern const char data_ov220_020d3bac[];

void func_ov220_020d1a24(char *self)
{
    Kinds kinds = data_ov220_020d3b94;
    Bounds bounds;
    const u8 *kind;
    int *slot;
    int item;
    ...
    *(Callback *)(self + 0x8) = func_ov220_020d1c1c;
    *(Callback *)(self + 0xc) = func_ov220_020d1c5c;
    *(Callback *)(self + 0x1c) = func_ov220_020d1d04;
    *(Callback *)(self + 0x30) = func_ov220_020d1eac;
    *(Callback *)(self + 0x34) = func_ov220_020d1e10;
    *(Callback *)(self + 0x1d0) = func_ov220_020d1f08;
    *(Callback *)(self + 0x1dc) = func_ov220_020d1e74;
    *(Callback *)(self + 0x1d4) = func_ov220_020d2148;
    *(Callback *)(self + 0x1e0) = func_ov220_020d2168;
    *(Callback *)(self + 0x1e4) = func_ov220_020d2194;
    *(int *)(self + 0x70) = 0x7cc;
    *(int *)(self + 0x64) = 0;
    *(int *)(self + 0x68) = 0x7cc;
    *(int *)(self + 0x6c) = 0;
    ...
    *(int *)(self + 0x394) = func_ov107_020c9e50(func_ov107_020c9440(self, 1), data_ov220_020d3bac);
    kind = kinds.id;
    for (i = 0; i < 3; i++) {
