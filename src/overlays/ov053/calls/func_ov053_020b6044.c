 ...
 * below 0x2e a still-raised sequence latch (+0x2e1c) is released (020b6404). No slot at all
...
extern void func_ov053_020b6404(char *self);
...
void func_ov053_020b6044(char *self)
{
    char *rig;
    int *seq;
    int frame;
