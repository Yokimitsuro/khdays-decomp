/* func_ov053_020b5aac -- overlay boot of the ov034 enemy (x4: ov034/052/072/090): the ov042 shape
...
extern void func_ov053_020b5e0c(void);
extern void func_ov053_020b5f84(void);
extern void func_ov053_020b6470(void);
extern void func_ov053_020b5c94(void);
extern void func_ov053_020b5de4(void);
extern void func_ov053_020b64a8(void);
extern void func_ov053_020b6694(void);
extern void func_ov053_020b6730(void);

extern void *data_ov053_020b7e60;
extern int data_ov053_020b7dd4;
extern int data_ov053_020b7de8;
extern int data_ov053_020b7d8c;
extern int data_ov053_020b7d7c;
extern int data_ov053_020b7d9c;
...
void func_ov053_020b5aac(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov053_020b7dd4, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov053_020b7de8, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov053_020b5e0c;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov053_020b5f84;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov053_020b6470;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov053_020b5c94;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov053_020b5de4;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov053_020b64a8;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov053_020b6694;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov053_020b6730;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov053_020b7d8c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov053_020b7d7c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov053_020b7d9c) : -1;
