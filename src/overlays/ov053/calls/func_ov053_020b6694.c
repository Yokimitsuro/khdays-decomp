...
u8 func_ov053_020b6694(char *self)
{
    char *block = self + 0x2f8 + 0x2000;

    block[0x334] = 0;
    func_ov022_020b15b0(*(u8 *)(self + 9), 3);
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov053_020b7dfc, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov053_020b7e0c, *(u8 *)(self + 9), 1, self + 0xf10);
    *(u8 **)(block + 0x348) = func_ov022_020b14a4(data_ov053_020b7e20, *(u8 *)(self + 9), 2, self + 0xdac);
