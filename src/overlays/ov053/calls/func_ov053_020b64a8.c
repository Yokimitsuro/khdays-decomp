...
extern void func_ov053_020b67dc(void);
extern void func_ov053_020b6c00(void);
extern void func_ov053_020b6a4c(void);
extern void func_ov053_020b6d10(void);
extern void func_ov053_020b6f20(void);
extern void func_ov053_020b7220(void);

void *func_ov053_020b64a8(char *self, int msg)
{
    ...
    case 2:
        ...
        *(int *)(rig + 0x1c) = *(int *)(self + 0x490);
        break;
    case 3:
        next = (void *)&func_ov053_020b6f20;
        *(int *)(rig + 4) = 0;
        *(int *)(rig + 8) = 0;
        *(int *)(self + 0x58) = -0xe66;
        break;
    case 4:
        next = (void *)&func_ov053_020b7220;
