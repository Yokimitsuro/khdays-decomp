 ...
 */
extern void func_ov053_020b7964(int self, int p);
extern void func_ov053_020b79e0(int self, int p);
extern void func_ov053_020b7a78(int self, int p);
extern void func_ov053_020b7b10(int self, int p);
extern void func_ov053_020b7924(int self);
...
void func_ov053_020b5e0c(int self, int mode) {
    int p = self + 0x2ce4;
    int reached = -1;

    switch (mode - 0x2f) {
    case 0:
        if (*(int *)(self + 0x6bc) != mode) { func_ov053_020b7964(self, p); }
        break;
    case 1:
        if (*(int *)(self + 0x6bc) != mode) { func_ov053_020b79e0(self, p); }
        break;
    case 2:
        if (*(int *)(self + 0x6bc) != mode) { func_ov053_020b7a78(self, p); }
        break;
    case 3:
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov053_020b7b10(self, p);
            *(int *)(p + 0x10) = 0;
        }
        break;
    case 4:
    ...
    if (mode < 0x2e) {
        ...
        int p2 = self + 0x2ce4;
        if (mode == 0x2e && *(int *)(self + 0x6bc) != mode) { func_ov053_020b7924(self); }
