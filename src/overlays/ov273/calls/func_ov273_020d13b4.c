 ...
 * data_ov273_020d6b16 template (byte 4 = 1; three components packed as sign + 23-bit magnitude
...
extern struct Msg data_ov273_020d6b16;
extern void func_0203c634(void *obj, int idx, void *value);
extern void func_ov273_020d152c(void);

void func_ov273_020d13b4(int *node) {
    ...
    *(unsigned short *)(*state + 0x100 + 0xae) |= 1;
    ...
    state[7] = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov273_020d152c);
}
