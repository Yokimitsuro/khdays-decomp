 ...
 * from the data_ov273_020d6b7c entries into a fresh 16-byte slot table (+0x394, attached, bit 1
...
extern void func_ov273_020d5464(void);
extern void func_ov273_020d54a4(void);
extern void func_ov273_020d54e4(void);
extern void func_ov273_020d5548(void);
extern void func_ov273_020d56ec(void);
extern void func_ov273_020d573c(void);
...
extern const int data_ov273_020d6b7c[2];
extern const Vec3 data_02041dc8;

void func_ov273_020d529c(char *self)
{
    int kinds[2];
    u16 hw;
    int i;
    int *slot;
    kinds[0] = data_ov273_020d6b7c[0];
    kinds[1] = data_ov273_020d6b7c[1];
    *(Callback *)(self + 0x8) = func_ov273_020d5464;
    *(Callback *)(self + 0xc) = func_ov273_020d54a4;
    *(Callback *)(self + 0x20) = func_ov273_020d54e4;
    *(Callback *)(self + 0x1c) = func_ov273_020d5548;
    *(Callback *)(self + 0x30) = func_ov273_020d56ec;
    *(Callback *)(self + 0x1d0) = func_ov273_020d573c;
