...
extern void func_ov273_020d64dc(void);
extern void func_ov273_020d6590(void);

void func_ov273_020d6440(int self) {
    int obj = *(int *)(self + 4);
    ...
    if (kind != -1) {
        *(signed char *)(*(int *)obj + 0x1c6) = kind;
        ...
        case 0:
            func_0203c634(self, 1, &func_ov273_020d64dc);
            break;
        case 2:
            func_0203c634(self, 1, &func_ov273_020d6590);
            break;
        }
    }
