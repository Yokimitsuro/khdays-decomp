/* func_ov273_020d573c -- broadcast this node's position. When the caller's flag word has both
 * bit 0 and bit 4 set, build the 14-byte message from the template at data_ov273_020d6b92, pack
...
extern struct Msg data_ov273_020d6b92;

int func_ov273_020d573c(int self, int a, unsigned int *flags, int d) {
