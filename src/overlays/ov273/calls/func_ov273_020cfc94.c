...
extern void func_ov273_020d00a4(void);
extern void func_ov273_020d010c(void);
extern void func_ov273_020d01c4(void);
extern void func_ov273_020d0240(void);
extern void func_ov273_020d07d8(void);
extern void func_ov273_020d0c04(void);
extern void func_ov273_020d0898(void);
extern void func_ov273_020d0900(void);
extern void func_ov273_020d0c50(void);
extern void func_ov273_020d0968(void);
extern void func_ov273_020d0e98(void);
extern void func_ov273_020cfc08(void);
...
extern int func_ov273_020d41b4(char *self);
extern int func_ov273_020d5268(char *self);
extern int func_ov273_020d5fcc(char *self);
...
void func_ov273_020cfc94(char *self)
{
    ...
    *(Callback *)(self + 0x8) = func_ov273_020d00a4;
    *(Callback *)(self + 0xc) = func_ov273_020d010c;
    *(Callback *)(self + 0x20) = func_ov273_020d01c4;
    *(Callback *)(self + 0x1c) = func_ov273_020d0240;
    *(Callback *)(self + 0x34) = func_ov273_020d07d8;
    *(Callback *)(self + 0x30) = func_ov273_020d0c04;
    *(Callback *)(self + 0x28) = func_ov273_020d0898;
    *(Callback *)(self + 0x2c) = func_ov273_020d0900;
    *(Callback *)(self + 0x1d0) = func_ov273_020d0c50;
    *(Callback *)(self + 0x1dc) = func_ov273_020d0968;
    *(Callback *)(self + 0x1e0) = func_ov273_020d0e98;
    hw = *(u16 *)(self + 0x60);
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov273_020cfc08;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(int *)(self + 0x3e8) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov273_020d6bec);
    *(int *)(self + 0x3ec) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov273_020d6bf4);
    *(int *)(self + 0x3f0) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov273_020d6bfc);
    *(int *)(self + 0x3f4) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov273_020d6c0c);
    ...
    *(int *)(self + 0x3dc) = func_ov273_020d41b4(self);
    *(int *)(self + 0x3e0) = func_0203d15c(0x20);
    for (i = 0; i < 8; i++) {
        (*(int **)(self + 0x3e0))[i] = func_ov273_020d5268(self);
    }
    *(int *)(self + 0x3e4) = func_0203d15c(0x20);
    for (i = 0; i < 8; i++) {
        (*(int **)(self + 0x3e4))[i] = func_ov273_020d5fcc(self);
    }
    func_0203355c(0x162);
}
