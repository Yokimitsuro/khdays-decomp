...
extern void func_ov273_020d47b0(void);
extern void func_ov273_020d46ac(void);
extern void func_ov273_020d4750(void);
void func_ov273_020d45e8(int self) {
    int *obj = *(int **)(self + 4);
    struct vec4 seed;
    *(char *)(*obj + 0x1c6) = 0;
    *(char *)(*obj + 0x1c7) = -1;
    ...
    *(struct vec4 *)(obj + 0x10) = seed;
    func_0203c634(self, 1, &func_ov273_020d47b0);
    func_0203c634(self, 0, &func_ov273_020d46ac);
    func_0203c634(self, 2, &func_ov273_020d4750);
}
