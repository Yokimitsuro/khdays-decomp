...
void func_ov273_020d0240(char *self, u8 *msg, int arg)
{
    Vec3 pos;
    Srt srt;
    Vec3 at;
    ...
    if (msg[2] == 0) {
        ...
        case 1:
            ...
            break;
        case 2:
            PAIRS[4].handle = func_ov107_020c08cc(*(int *)(self + 0x3c), PAIRS[4].res, 0x17, 0, 0x3000, msg + 5);
        ...
        case 7:
            *(int *)(self + 0x424) = func_ov107_020cb040(self, 0x162, 0xc, 0, self + 0xa0);
            break;
        case 9:
            *(int *)(self + 0x428) = func_ov107_020cb040(self, 0x162, 5, 0, self + 0xa0);
            break;
        case 8:
            *(int *)(self + 0x42c) = func_ov107_020cb040(self, 0x162, 0xa, 0, self + 0xa0);
            break;
        }
    }
