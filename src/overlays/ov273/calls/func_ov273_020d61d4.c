 ...
 * the child under the slot's +0x394 parent, storing its handle at the slot's +0x398. The command
...
void func_ov273_020d61d4(int this_, int cmd, int p3) {
    SrtTransform srt;
    int pos[3];
    int w2, w1, w0;
    ...
    case 5:
        if (*(unsigned char *)(cmd + 3) == 0) {
            ...
            *(int *)(this_ + 0x398) =
                func_ov107_020c0794(*(int *)(this_ + 0x3c), *(int *)(this_ + 0x394), 0x17, 0, &srt);
        }
        break;
    }
