...
extern void func_ov273_020d6144(void);
extern void func_ov273_020d6170(void);
extern void func_ov273_020d61d4(void);
extern void func_ov273_020d639c(void);
extern void func_ov273_020d62b8(void);
...
void func_ov273_020d6000(int self) {
    struct Ov213PoolEntry entry = data_ov273_020d6bb0;
    int item;

    *(Callback *)(self + 0x8) = func_ov273_020d6144;
    *(Callback *)(self + 0x20) = func_ov273_020d6170;
    *(Callback *)(self + 0x1c) = func_ov273_020d61d4;
    *(Callback *)(self + 0x30) = func_ov273_020d639c;
    *(Callback *)(self + 0x1dc) = func_ov273_020d62b8;
    *(int *)(self + 0x70) = 0x100;
    *(int *)(self + 0x64) = 0;
    *(int *)(self + 0x68) = 0x100;
    *(int *)(self + 0x6c) = 0;
