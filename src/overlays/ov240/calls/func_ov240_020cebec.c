/* func_ov240_020cebec: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
void func_ov240_020cebec(int *ctx) {
    int b[4];
    int a[4];
    int *p = (int *)ctx[0];
    int *s = (int *)ctx[1];
    s[3] = func_0203d040(s[3], s[4], p[0xb] * 3, 0);
    func_0202f188(b, &data_02042264, s[3]);
