...
extern void func_ov240_020cedbc(int *node);

void func_ov240_020ced2c(int *node)
{
    ...
    *(unsigned short *)(*state + 0x1ae) |= 1;
    ...
    func_ov107_020c5af8(*state, 0x139, 0xb, (void *)(*state + 0x74));
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov240_020cedbc);
}
