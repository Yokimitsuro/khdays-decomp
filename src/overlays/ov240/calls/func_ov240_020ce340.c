...
int func_ov240_020ce340(char *actor, int nParam, struct ActorHitEvent *hit)
{
    ...
    if (hit->nDamage > 0) {
        if ((hit->uFlagsLo & 8) == 0 || (hit->uFlagsLo & 0x80) == 0 || hit->uFlagsHi != 0x80) {
            if ((hit->uFlagsLo & 0x22) != 0) {
                func_ov107_020c5af8(actor, 0x139, pair22.a[*(u8 *)((char *)state + 0x3d)], (void *)state[2]);
            } else {
                func_ov107_020c5af8(actor, 0x139, pair.a[*(u8 *)((char *)state + 0x3d)], (void *)state[2]);
            }
