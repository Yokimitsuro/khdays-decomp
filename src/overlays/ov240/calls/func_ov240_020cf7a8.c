/* Guard-break entry of the ov240 enemy: drops bit 0 of the +0x60 high byte, sets bits 0-1 of
...
extern void func_ov240_020cf8a0(int *node);

void func_ov240_020cf7a8(int *node)
{
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 0x86) << 0x18) >> 0x10);
    ...
    func_ov107_020c5af8(*state, 0x139, 0xc, (void *)(*state + 0x74));
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov240_020cf8a0);
}
