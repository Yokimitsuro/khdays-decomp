...
extern void func_ov240_020cf998(void);

struct LowByte32 { unsigned bits : 8; };

void func_ov240_020cf8c0(int *node) {
    ...
    *(unsigned short *)(state[0] + 0x1ae) |= 1;
    ...
    func_ov107_020c5af8(state[0], 0x139, 0xd, state[0] + 0x74);
    state[0xe] = 0;
    func_0203c634(node, *(signed char *)((int)node + 0x20), func_ov240_020cf998);
}
