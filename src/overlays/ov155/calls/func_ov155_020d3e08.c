...
extern void func_ov155_020d3fe8(void);
extern void func_ov155_020d4028(void);
extern void func_ov155_020d4060(void);
extern void func_ov155_020d4114(void);
extern void func_ov155_020d423c(void);
...
extern const int data_ov155_020d58a0[2];

void func_ov155_020d3e08(char *self)
{
    int kinds[2];
    u16 hw;
    int i;
    kinds[0] = data_ov155_020d58a0[0];
    kinds[1] = data_ov155_020d58a0[1];
    *(Callback *)(self + 0x8) = func_ov155_020d3fe8;
    *(Callback *)(self + 0xc) = func_ov155_020d4028;
    *(Callback *)(self + 0x1c) = func_ov155_020d4060;
    *(Callback *)(self + 0x30) = func_ov155_020d423c;
    *(Callback *)(self + 0x1d0) = func_ov155_020d4114;
    hw = *(u16 *)(self + 0x60);
