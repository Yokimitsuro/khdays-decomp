 ...
 * 0x13c/4 fires at the +0x38c node's +0x14 and func_ov155_020d3d94 launches from the +0x398 item
...
extern void func_ov155_020d3d94(int item, void *anchor, Vec3 *dir);
extern const Vec3 data_02042258;

void func_ov155_020d5744(int node)
{
    ...
    if (*(unsigned char *)(state + 9) == 0 && state[7] >= 0xccc) {
        *(unsigned char *)(state + 9) = 1;
        ...
        func_ov155_020d3d94(*(int *)(*state + 0x398), (void *)(*(int *)(*state + 0x38c) + 0x14), &dir);
    }
