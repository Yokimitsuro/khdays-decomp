...
void func_ov155_020d3b6c(int self, int msg, int size)
{
    if (*(unsigned char *)(msg + 2) == 5) {
        switch (*(unsigned char *)(msg + 3)) {
        case 0:
            *(int *)(*(int *)(self + 0x394) + 4) =
                func_ov107_020c09a0(*(int *)(self + 0x3c), **(int **)(self + 0x394), 0x17,
                                    self + 0x39c, 0, 0);
            *(int *)(*(int *)(self + 0x394) + 0xc) =
                func_ov107_020c09a0(*(int *)(self + 0x3c), *(int *)(*(int *)(self + 0x394) + 8),
                                    0x17, self + 0x39c, 0, 0);
            break;
        }
    }
