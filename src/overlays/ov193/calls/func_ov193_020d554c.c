/*
 * func_ov193_020d554c -- MATCHED (408/408 bytes, 102 instrs). x5 family.
 ...
 * test is `<= 0`.
 */
extern void func_ov193_020d4298(int *state, int *p);
extern long long func_01ff8a14(int a, int b);
extern void func_ov193_020d437c(int *state, int lo, int hi, int *p);
extern void func_ov107_020c9264(int a, int b, int c);
extern void func_0203c634(int self, int idx, int cb);
extern int func_ov193_020d581c(int obj, int out);
extern void VEC_Subtract(void *a, void *b, void *d);
extern int func_02023eb4(int mul);
extern int func_020050b4(int x, int z);
extern int func_ov193_020d56e4;

void func_ov193_020d554c(int *self) {
    ...
    if (*(unsigned char *)(state + 0xe) == 0 && state[0xb] >= 0x4cc) {
        func_ov193_020d4298(state, state + 8);
        *(unsigned char *)(state + 0xe) = 1;
    }
    t = state[0xb];
    if (t >= 0x4cc && t <= 0xbba) {
        long long fx = func_01ff8a14(t - 0x4cc, 0x6ee);
        func_ov193_020d437c(state, (int)fx, (int)((unsigned long long)fx >> 32), state + 8);
    }
    ...
    *(unsigned char *)((int)state + 0x39) &= ~2;
    ...
    if (c - 1 <= 0) {
        ...
        func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov193_020d56e4);
        return;
    }
    func_ov107_020c9264(*state, 5, 0);
    target = func_ov193_020d581c(*state, 0);
    state[6] = target;
    if (target == 0) {
        return;
    }
