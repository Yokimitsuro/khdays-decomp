...
extern void func_ov193_020d4298(int *node, Vec3 *out);
extern long long func_01ff8a14(int num, int denom);
extern void func_ov193_020d437c(int *node, long long t, Vec3 *at);
extern int func_02023eb4(int bound);
extern void func_ov107_020c9264(int obj, int anim, int flag);
extern void func_0203c634(int node, int slot, void *cb);
extern void func_ov193_020d554c(void);

void func_ov193_020d5378(int node)
{
    ...
    state[6] = func_ov193_020d581c(*state, 0);
    if (state[6] != 0) {
    ...
    if (*(unsigned char *)(state + 0xe) == 0 && state[0xb] >= 0x1bbb) {
        func_ov193_020d4298(state, (Vec3 *)(state + 8));
        *(unsigned char *)(state + 0xe) = 1;
    }
    if (state[0xb] >= 0x1bbb && state[0xb] <= 0x22a9) {
        func_ov193_020d437c(state, func_01ff8a14(state[0xb] - 0x1bbb, 0x1bbb >> 2), (Vec3 *)(state + 8));
    }
    ...
    *(unsigned char *)((char *)state + 0x39) &= ~2;
    func_0203c634(node, *(signed char *)(node + 0x20), func_ov193_020d554c);
}
