...
extern void func_ov145_020cf63c(int *node);
extern short data_0203d210[];

#define ANG2IDX(a) ((unsigned short)(((long long)(a) * 0x28be60db9391LL + 0x80000000000LL) >> 44) >> 4)
#define FX_MUL(a, b) ((int)(((long long)(a) * (b) + 0x800) >> 12))

void func_ov145_020cf3d4(int *node)
{
    ...
    if (*(signed char *)(*state + 0x1c6) == 3 && func_ov145_020ce78c(state, 1) != 0) {
        state[0x13] = 1;
    ...
    if (*(signed char *)(*state + 0x1c6) == 3 && dot < 0x800) {
        *(int *)(*state + 0x3f4) = 0;
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov145_020cf63c);
        return;
    }
    if (dot < 0xe00) {
        dot = 0;
