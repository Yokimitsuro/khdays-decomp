...
extern int func_ov145_020ce950(int *node);
extern void func_ov022_020ad838(int item, int on);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_ov145_020cf028(int *node);
extern void func_ov145_020cf1a8(int *node);
extern void func_ov145_020cf300(int *node);
extern void func_ov145_020cf744(int *node);
extern void func_ov145_020cf828(int *node);
extern void func_ov145_020cf988(int *node);

void func_ov145_020cec28(int *node)
{
    ...
    if ((((struct hw60 *)(actor + 0x60))->lo & 1) != 0 && *(signed char *)(actor + 0x1c7) == -1) {
        ...
        case 3:
        default:
            state[1] = func_ov145_020ce950(node);
            if (state[1] != 0) {
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 0x4c) << 0x18) >> 0x10);
    ...
    case 0:
        ...
        break;
    case 2:
        func_0203c634(node, 1, func_ov145_020cf1a8);
        break;
    case 3:
        func_0203c634(node, 1, func_ov145_020cf300);
        break;
    case 4:
        func_0203c634(node, 1, func_ov145_020cf300);
        break;
    case 5:
        func_0203c634(node, 1, func_ov145_020cf744);
        break;
    case 6:
        func_0203c634(node, 1, func_ov145_020cf744);
        break;
    case 7:
        ...
        break;
    case 8:
        func_0203c634(node, 1, func_ov145_020cf828);
        break;
    case 9:
        func_0203c634(node, 1, func_ov145_020cf988);
        break;
    }
