 ...
 * finalised), allocates the +0x390 block whose effect comes from the data_ov159_020d4fc0 pose
...
extern void func_ov159_020d45d4(void);
extern void func_ov159_020d4604(void);
extern void func_ov159_020d463c(void);
extern void func_ov159_020d470c(void);
extern void func_ov159_020d46b0(void);

void func_ov159_020d4434(char *self)
{
    struct Ov158Pose pose = data_ov159_020d4fc0;

    *(void **)(self + 0x8) = func_ov159_020d45d4;
    *(void **)(self + 0xc) = func_ov159_020d4604;
    *(void **)(self + 0x1c) = func_ov159_020d463c;
    *(void **)(self + 0x30) = func_ov159_020d470c;
    *(void **)(self + 0x1d0) = func_ov159_020d46b0;
    {
    ...
    *(int *)(self + 0x70) = 0xe00;
    *(int *)(self + 0x384) = func_0203b898(func_ov107_020c9440(*(int *)(self + 0x38c), 5));
