 ...
 * state at once); a 50.0 downward probe (func_ov159_020d3a10) that hits turns the +8 sub-object
 ...
 * func_ov159_020d413c. Otherwise the segment from the +0x10 point along the normalised probe
...
extern int func_ov159_020d3a10(int *state, Vec3 *dir, Vec3 *out);
...
extern void func_ov159_020d413c(int *node);
extern const Vec3 data_02042264;

void func_ov159_020d3e40(int *node)
{
    ...
    down.y = -0x32000;
    if (func_ov159_020d3a10(state, &down, &hit) != 0) {
    ...
    if (func_ov159_020d3a10(state, &down, &hit) != 0) {
        ...
        *(Vec3 *)(state + 4) = *(Vec3 *)(state + 7);
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov159_020d413c);
        return;
    }
