/* func_ov159_020d3530 -- commit the move once the counter allows. If the counter at +0x40 has
...
extern void func_ov159_020d35e8(void);
extern unsigned short data_ov159_020d4fa0[];

void func_ov159_020d3530(int self) {
    int *ctx;
    Ov158_Desc d;
    Ov158_Desc *p;
    ...
    *(unsigned char *)((char *)ctx + 0x54) = 0;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov159_020d35e8);
}
