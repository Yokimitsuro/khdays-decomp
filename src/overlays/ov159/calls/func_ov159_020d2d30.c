/* Start the ov159 leap: reseed the countdown from the owner's frame rate,
...
typedef struct Ov159ActionNode {
    void *pOwner;
    Ov159MoveState *pState;
    void *apHandlers[6];
...
extern void func_ov159_020d2e6c(Ov159ActionNode *node);
extern const short data_0203d210[];

void func_ov159_020d2d30(Ov159ActionNode *node)
{
    Ov159MoveState *state = node->pState;
    ...
    state->vVelocity.y = 0x400;
    {
        ...
        int nNextHandler = (int)func_ov159_020d2e6c;
