/* Send the ov158 enemy's position message: the overlay's 14-byte template (data_ov159_020d4fc4)
...
extern const PosMsg data_ov159_020d4fc4;
...
void func_ov159_020d4e78(int *state)
{
    PosMsg msg;
    FxVec vContact;
    FxVec *pPos;

    msg = data_ov159_020d4fc4;
    pPos = (FxVec *)state[1];
    vContact.x = pPos->x;
