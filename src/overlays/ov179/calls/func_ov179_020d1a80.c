/* Constructor of the ov179 enemy (twins by byte identity). Installs the handlers (+8 release, +0xc
...
extern void func_ov179_020d1e18(void);
extern void func_ov179_020d2118(void);
extern void func_ov179_020d2304(void);
extern void func_ov179_020d20e8(void);
extern void func_ov179_020d2528(void);
extern void func_ov179_020d1a24(void);
...
extern int *func_ov179_020d41bc(char *self);
extern const Vec3 data_02041dc8;
extern IdTable data_ov179_020d48d0;
extern char data_ov179_020d490c[];
extern char data_ov179_020d4914[];

void func_ov179_020d1a80(char *self)
{
    IdTable ids = data_ov179_020d48d0;
    Bounds bounds;
    CameraWork work;
    Vec3 v;
    u16 hw;
    ...
    *(Callback *)(self + 0x2c) = func_ov179_020d1e18;
    *(Callback *)(self + 0x34) = func_ov179_020d2118;
    *(Callback *)(self + 0x1d0) = func_ov179_020d2304;
    *(Callback *)(self + 0x1dc) = func_ov179_020d20e8;
    *(Callback *)(self + 0x1e0) = func_ov179_020d2528;
    hw = *(u16 *)(self + 0x60);
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov179_020d1a24;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(unsigned char *)(*(int *)(self + 0x384) + 0xad) = 0;
    *(int *)(self + 0x38c) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov179_020d490c);
    *(int *)(self + 0x390) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov179_020d490c);
    *(int *)(self + 0x394) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov179_020d4914);
    ...
    *(int **)(self + 0x3ac) = func_ov179_020d41bc(self);
    func_0203355c(0x143);
}
