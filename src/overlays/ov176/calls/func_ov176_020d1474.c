/* Hover-approach tick of the ov175 enemy (and its byte-identical twins): acquires a target (+0xc; none
...
extern int func_ov176_020d0774(int node);
extern int data_02042264;

void func_ov176_020d1474(int node)
{
