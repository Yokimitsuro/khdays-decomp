 ...
 * clear the +0x60 high-byte bit 6 is dropped and the state advances to func_ov135_020d1974.
...
extern const struct Msg data_ov135_020d1bf0;
...
void func_ov135_020d1694(struct Node *node)
{
    struct State *st;
    FxVec vLocal;
    void *aVictims[4];
    ...
    if (*(u8 *)((char *)st->pSub + 0xad) == 0) {
        ...
        func_0203c634(node, node->bSlot, func_ov135_020d1974);
    }
}
