...
extern void func_ov135_020cfe68(void), func_ov135_020cfeb0(void), func_ov135_020cff04(void);
extern void func_ov135_020d0184(void), func_ov135_020d0088(void), func_ov135_020d01e0(void);
extern void func_ov135_020d0438(void), func_ov135_020cfed4(void);
...
void func_ov135_020cfc04(int param_1) {
    struct v5 tbl;
    struct { struct v3 t; int scale; } g;
    int i;
    tbl = data_ov135_020d1bb8;
    *(void **)(param_1 + 8) = func_ov135_020cfe68;
    *(void **)(param_1 + 0xc) = func_ov135_020cfeb0;
    *(void **)(param_1 + 0x1c) = func_ov135_020cff04;
    *(void **)(param_1 + 0x30) = func_ov135_020d0184;
    *(void **)(param_1 + 0x34) = func_ov135_020d0088;
    *(void **)(param_1 + 0x1d0) = func_ov135_020d01e0;
    *(void **)(param_1 + 0x1e0) = func_ov135_020d0438;
    *(void **)(param_1 + 0x1dc) = func_ov135_020cfed4;
    ...
    *(void **)(param_1 + 0x394) = func_0203bee8(*(int *)(param_1 + 0x384), 1, data_ov135_020d1c2c);
    *(void **)(param_1 + 0x3a0) = func_ov107_020c9e50(func_ov107_020c9440(param_1, 1), &data_ov135_020d1c38);
    ...
    *(void **)(param_1 + 0x398) = func_0203bee8((int)((struct slot *)*(int *)(param_1 + 0x3a4))[0].ptr, 1, data_ov135_020d1c40);
    *(void **)(param_1 + 0x39c) = func_0203bee8((int)((struct slot *)*(int *)(param_1 + 0x3a4))[0].ptr, 1, data_ov135_020d1c44);
    g.t = data_02041dc8;
    g.scale = 0x99a;
