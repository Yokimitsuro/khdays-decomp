...
extern const struct Msg data_ov181_020cea12;
...
void func_ov181_020ce24c(int node)
{
    ...
    *(Vec3 *)(state + 0x15) = *(Vec3 *)(state + 0x1e);
    ...
    if (state[7] > 0x100 && ((struct Flags17a *)(*state + 0x17a))->bit0) {
        ...
        func_0203c634(node, *(signed char *)(node + 0x20), func_ov181_020ce5a8);
        return;
    }
