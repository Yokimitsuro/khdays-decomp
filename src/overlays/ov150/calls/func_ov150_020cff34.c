 ...
 * and handing the collected list to func_ov150_020d2318. */
...
extern int func_ov107_020cb040(struct Self *self, int id, int kind, int enabled,
                               void *transform);
...
extern void func_ov107_020c5af8(struct Self *self, int id, int kind,
                                struct Vec3 *at);
extern int func_ov150_020d2318(struct Self *self, short *ids);
extern void func_ov107_020c7500(struct Self *self, struct Command *cmd, int arg2);

void func_ov150_020cff34(struct Self *self, struct Command *cmd, int arg2)
{
    struct Other *other;
    void **it;
    int count;
    ...
    if (cmd->type02 == 5) {
        ...
        case 1:
            ...
            self->nEffect3d0 =
                func_ov107_020cb040(self, 0x14e, 7, 0,
        ...
        case 0: {
                ...
                if ((other->flags60.lo & 1) != 0
                    ...
                    if (VEC_Mag(&delta) - (other->nRadius80 + self->nRadius80)
                        ...
                        if (self->nMode50 == 1) {
                            ...
                            func_ov107_020c5af8(self, 0x14e, 8, &other->vPos74);
                        }
                        if (count >= 0x10) {
                            break;
                        }
            ...
            self->pSlots390->field04 = func_ov150_020d2318(self, ids);
            break;
        }
        }
    }
