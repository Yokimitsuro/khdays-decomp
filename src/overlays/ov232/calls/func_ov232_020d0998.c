/* func_ov232_020d0998 -- hit filter of the ov231 enemy (x5 with ov232/ov263/ov265/ov280), active
 ...
 * 2/4 and unguarded (+0x1c4 bit 1 clear), a 0x20 hit on a d100 below 25, or any hit on a d100 below
 * 10, is dodged: the +0x24 timer clears, +0x49 records on which side of the +0x3c facing the
...
int func_ov232_020d0998(char *self, int src, unsigned int *hit)
{
    ...
    if ((*(signed char *)(*state + 0x100 + 0xc6) == 2 || *(signed char *)(*state + 0x100 + 0xc6) == 4)
        ...
        if (((((struct HitWord *)hit)->lo & 0x20) != 0 && (unsigned int)func_02023eb4(100) < 0x19)
            || (unsigned int)func_02023eb4(100) < 0xa) {
            state[9] = 0;
