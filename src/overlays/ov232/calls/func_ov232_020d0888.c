/* func_ov232_020d0888 -- probe a direction: gather the candidates, skip the ones already handled,
...
int func_ov232_020d0888(int self, int kind, void *query, void *pt, int flags) {
    int *ctx = *(int **)(self + 4);
