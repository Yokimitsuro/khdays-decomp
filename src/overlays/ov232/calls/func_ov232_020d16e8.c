/* func_ov232_020d16e8 -- decide which way to sidestep, then hand off to func_ov232_020d18d0.
 *
 ...
 *
 *   0 -> probe both sides. Take the canned offset data_ov232_020d3680, run it through
 *        func_ov232_020d06b4 and ask func_ov232_020d0748 whether that way is blocked; then repeat
...
extern int func_ov232_020d0748(int self, const VecFx32 *v, int a);
...
extern void func_ov232_020d18d0(void);
extern VecFx32 data_ov232_020d3680;
...
void func_ov232_020d16e8(int self) {
    int *ctx;
    ...
    *(unsigned char *)((char *)ctx + 0x4a) = func_02023eb4(2);
    ...
    if (*(unsigned char *)((char *)ctx + 0x4a) == 0) {
        ...
        v = data_ov232_020d3680;
        func_ov232_020d06b4(&v, self, &v);
        if (func_ov232_020d0748(self, &v, 0) != 0) {
    ...
    func_ov232_020d0cd4(self, 2, 2, 0, func_ov232_020d18d0);
}
