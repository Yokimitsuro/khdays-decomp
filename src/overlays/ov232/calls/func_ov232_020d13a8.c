...
extern void func_ov232_020d0620(int);
extern void func_ov107_020c5af8(int a, int b, int c, int d);
extern int func_0203c634(int a, int b, void *handler);
extern void func_ov232_020d144c(int);
struct lo8_020cd768 { unsigned f : 8; };
void func_ov232_020d13a8(int param_1) {
    int child = *(int *)(param_1 + 4);
    func_ov232_020d0620(param_1);
    {
    ...
    *(int *)(child + 0x28) = 0;
    func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov232_020d144c);
}
