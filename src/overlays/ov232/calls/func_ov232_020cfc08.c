 ...
 * +0x38c children (func_ov232_020d2d64, bit 2 of their body's +0x5c). Registers actions 0/2, 1/2
...
extern void func_ov232_020d009c(void);
extern void func_ov232_020d00f4(void);
extern void func_ov232_020d019c(void);
extern void func_ov232_020d05bc(void);
extern void func_ov232_020d02cc(void);
extern void func_ov232_020d0308(void);
extern void func_ov232_020d0344(void);
extern void func_ov232_020d0998(void);
extern void func_ov232_020d0118(void);
extern void func_ov232_020d0d1c(void);

void func_ov232_020cfc08(char *self)
{
    ParamBlock params;
    KindTable kinds;
    Placement place;
    ...
    *(void **)(self + 0x8) = (void *)func_ov232_020d009c;
    *(void **)(self + 0xc) = (void *)func_ov232_020d00f4;
    *(void **)(self + 0x1c) = (void *)func_ov232_020d019c;
    *(void **)(self + 0x30) = (void *)func_ov232_020d05bc;
    *(void **)(self + 0x28) = (void *)func_ov232_020d02cc;
    *(void **)(self + 0x2c) = (void *)func_ov232_020d0308;
    *(void **)(self + 0x34) = (void *)func_ov232_020d0344;
    *(void **)(self + 0x1d0) = (void *)func_ov232_020d0998;
    *(void **)(self + 0x1dc) = (void *)func_ov232_020d0118;
    *(ParamBlock *)(self + 0x1fc) = params;
    *(void **)(self + 0x1e0) = (void *)func_ov232_020d0d1c;
    ...
    *(int *)(self + 0x3cc) = func_0203bee8(*(void **)(self + 0x384), 1, data_ov232_020d36ac);
    *(int *)(self + 0x3d0) = func_0203bee8(*(void **)(self + 0x384), 1, data_ov232_020d36b8);
    *(int *)(self + 0x3d4) = func_0203bee8(*(void **)(self + 0x384), 3, data_ov232_020d36c4);
    *(int *)(self + 0x3d8) = func_0203bee8(*(void **)(self + 0x384), 3, data_ov232_020d36d0);
    {
        unsigned int v = *(u16 *)(self + 0x60);
        *(u16 *)(self + 0x60) = (u16)((v & ~0xff00) | ((((v << 0x10) >> 0x18 | 0x40) << 0x18) >> 0x10));
    }
    *(int *)(self + 0x388) = func_ov107_020c9e50(func_ov107_020c9440(self, 0x11), data_ov232_020d36dc);
    *(void **)(self + 0x3b8) = func_0203d15c(0x40);
    ...
    for (i = 0; i < 2; i++) {
        ((void **)(self + 0x38c))[i] = func_ov232_020d2d64(self);
