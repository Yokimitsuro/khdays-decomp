...
extern const char data_ov232_020d36a0[];
extern void func_ov232_020cfc08(int);
int func_ov232_020cfb78(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x40c);
    *(signed char *)(obj + 0x19c) = 0x3b;
    OS_SPrintf(buf, data_ov232_020d36a0, 59);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov232_020cfc08;
