 ...
 * 020d2ec8, +0x30 020d2f1c, +0x1d0 020d2ee4), raises flags 0x42 in the +0x60 high byte and bit 2
...
extern void func_ov232_020d2ec8(void);
extern void func_ov232_020d2f1c(void);
extern void func_ov232_020d2ee4(void);

void func_ov232_020d2d98(char *self)
{
    int owner = *(int *)(self + 0x388);
    int w = FX_Inv(0x1119, 0x1119);
    u16 v;

    *(void **)(self + 8) = (void *)func_ov232_020d2ec8;
    *(void **)(self + 0x30) = (void *)func_ov232_020d2f1c;
    *(void **)(self + 0x1d0) = (void *)func_ov232_020d2ee4;
    v = *(u16 *)(self + 0x60);
