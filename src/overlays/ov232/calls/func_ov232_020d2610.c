/* func_ov232_020d2610 -- the per-tick update of the state entered by func_ov231_020cd118: refresh
 * the tracked point, fire once the timer passes 0x1078, and hand off when the gate byte clears.
 *
 * func_ov232_020d06b4 recomputes the point relative to *(ctx[0]+0x388)+0x2c and it is cached at
 ...
 * and func_ov232_020d0cd4 hands off to func_ov232_020d272c.
 *
...
extern void func_ov232_020d06b4(VecFx32 *out, int self, int ref);
...
extern void func_ov232_020d272c(void);
extern VecFx32 data_02041dc8;

void func_ov232_020d2610(int self) {
    int *ctx;
    VecFx32 pt;

    ctx = *(int **)(self + 4);
    func_ov232_020d0620(self);
    func_ov232_020d06b4(&pt, self, *(int *)(ctx[0] + 0x388) + 0x2c);
    *(VecFx32 *)((char *)ctx + 0x30) = pt;
    ...
    func_ov232_020d0cd4(self, 0xa, 0, 0, func_ov232_020d272c);
}
