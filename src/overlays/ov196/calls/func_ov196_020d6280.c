...
extern const struct Msg20 data_ov196_020d6834;
extern const Vec3 data_ov196_020d67e8;
extern const struct Msg14 data_ov196_020d6802;
...
void func_ov196_020d6280(int *node)
{
    ...
    if (state[0xc] >= 0xa88) {
        offBase = data_ov196_020d67e8;
        nPoint = 0;
        tmpl = data_ov196_020d6802;
        do {
