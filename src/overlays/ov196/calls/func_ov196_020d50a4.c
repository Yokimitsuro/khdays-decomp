...
extern const struct Msg20 data_ov196_020d6820;
extern const Vec3 data_02042258;
extern void func_0202f384(Vec3 *dst, void *xfm, Vec3 *src);
extern const struct Msg14 data_ov196_020d6810;
extern void func_ov196_020d54fc(void);
...
void func_ov196_020d50a4(int *node)
{
    ...
    if (*(u8 *)(state[1] + 0xad) == 0) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov196_020d54fc);
    }
}
