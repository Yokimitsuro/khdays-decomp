 ...
 * animation 7. The fourth 4-byte command of data_ov210_020d46ec (kind 5, command 4) goes to the
 * owner's +0x24 hook, the +0x2c/+0x30 timers clear, and the overlay's 14-byte message
 * (data_ov210_020d4726, flag 1) carries the +4 point raised 6.0, packed as 24-bit values. The
...
extern const Cmd14 data_ov210_020d4726;
extern void func_ov210_020d193c(int *node);

void func_ov210_020d1750(int *node)
{
    ...
    *(u16 *)(*state + 0x1ae) |= 1;
    ...
    {
        u16 *p = cmd;
        p[1] = data_ov210_020d46ec[7];
        p[0] = data_ov210_020d46ec[6];
    ...
    *(u8 *)((char *)state + 0x64) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov210_020d193c);
}
