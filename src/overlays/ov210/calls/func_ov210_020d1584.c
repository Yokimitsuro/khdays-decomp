/*
 * func_ov210_020d1584 -- x3. AI-state tick: set up flags, kick a sub-node, dispatch.
...
extern void func_ov210_020d162c(void);

void func_ov210_020d1584(int *self) {
    ...
    *(unsigned short *)(*state + 0x1ae) |= 1;
    ...
    func_ov210_020d3ffc(*(int *)(*(int *)(*(int *)(*state + 0x3d4)) + 0x194), 1, (int)(state + 0xd));
    state[0xb] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov210_020d162c);
}
