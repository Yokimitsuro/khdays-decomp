/*
 * func_ov210_020d0cc8 -- x3. AI-state tick: fire, seed a random timer, dispatch.
...
extern void func_ov210_020d0d24(void);

void func_ov210_020d0cc8(int *self) {
    ...
    state[0xb] = 0;
    state[0x1a] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov210_020d0d24);
}
