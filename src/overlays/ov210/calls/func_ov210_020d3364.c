 ...
 * between 1.4 and 1.67 a 0.42 sphere at each of the owner's +0x3cc and +0x3c8 part points (+0x14)
 * sweeps the actor list: every entity in it is pushed 1.0 away horizontally (the +z axis when
 * directly above, kind 0); on acceptance the message data_ov210_020d4718 / data_ov210_020d4750,
...
extern const Cmd14 data_ov210_020d4718;
extern const Cmd14 data_ov210_020d4750;
...
void func_ov210_020d3364(int *node)
{
