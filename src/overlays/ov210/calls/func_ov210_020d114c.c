 ...
 * +0x60 timer and +0x66 byte clear and the tick hands over to func_ov210_020d145c. */
...
extern const Cmd14 data_ov210_020d46fc;
extern void func_ov210_020d145c(int *node);

void func_ov210_020d114c(int *node)
{
    ...
    *(u8 *)((char *)state + 0x66) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov210_020d145c);
}
