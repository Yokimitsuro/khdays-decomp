/*
 * func_ov210_020d01cc -- x3. Message handler: map the kind through a 26-entry table, then set up a
...
extern void func_ov210_020d0388(int a1, int a2, int a3, int a4, int a5);
extern void func_0203c7ac(int a, int b);
extern struct t26 data_ov210_020d4684;

void func_ov210_020d01cc(int self, int kind) {
    struct t26 table = data_ov210_020d4684;

    func_ov210_020d0388(self, *(int *)(self + 0x384), func_ov107_020c9440(self, table.w[kind]),
