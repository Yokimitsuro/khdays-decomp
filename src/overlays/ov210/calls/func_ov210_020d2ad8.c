/*
 * func_ov210_020d2ad8 -- x3 (ov210/211/282). AI-state tick: acquire target, else enter a timed
 * recovery.
...
extern void func_ov210_020d2b60(void);

void func_ov210_020d2ad8(int *self) {
    ...
    state[0xb] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov210_020d2b60);
}
