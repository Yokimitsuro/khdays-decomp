...
extern const Cmd14 data_ov210_020d475e;
extern void func_ov210_020d3b28(int *node);

void func_ov210_020d3980(int *node)
{
    ...
    *(u8 *)((char *)state + 0x66) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov210_020d3b28);
}
