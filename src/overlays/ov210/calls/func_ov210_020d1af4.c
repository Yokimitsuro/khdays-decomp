/*
 * func_ov210_020d1af4 -- x3. AI-state entry: set the aim direction, notify, arm and dispatch.
...
extern void func_ov210_020d1c04(void);

void func_ov210_020d1af4(int *self) {
    ...
    *(char *)((int)state + 0x67) = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov210_020d1c04);
}
