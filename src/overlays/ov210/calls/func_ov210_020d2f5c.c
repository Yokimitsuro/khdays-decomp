/*
 * func_ov210_020d2f5c -- x3. AI-state tick: strafe the same target (negative sweep), fire on a timer.
...
extern void func_ov210_020d3050(void);

void func_ov210_020d2f5c(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov210_020d3050);
}
