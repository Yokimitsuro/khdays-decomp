...
extern int func_ov237_020ce82c(int);
struct w3 { int a, b, c; };
void func_ov237_020ce7a0(int param_1) {
    ...
    *(struct w3 *)(owner + 0x3c) = buf;
    ...
    func_ov107_020c9ee8(*(int *)(*(int *)owner + 0x3d8), 2, 0);
    func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov237_020ce82c);
}
