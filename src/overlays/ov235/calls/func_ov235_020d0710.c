/* Glide tick of an ov235 state: the +0x5c path point is resolved (func_ov235_020cccc0) into the
...
extern void func_ov235_020d07c4(int *node);

void func_ov235_020d0710(int *node)
{
    ...
    func_ov107_020c9264(*state, 0x25, 1);
    func_ov107_020c9ee8(*(int *)(*state + 0x3a8), 0x1b, 1);
    ((struct hw60 *)(*state + 0x60))->hi &= ~0x40;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov235_020d07c4);
}
