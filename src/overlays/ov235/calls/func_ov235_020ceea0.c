 ...
 * (func_ov235_020cccc0, never past the gap). The +0x44 timer accumulates the frame rate; up to
 ...
 * the tick hands over to func_ov235_020cf244. */
...
extern void func_ov235_020cf244(int *node);

void func_ov235_020ceea0(int *node)
{
    int obj;
    ...
    if (*((u8 *)state + 0x65) == 0 && state[0x15] >= 0x1000) {
        func_ov107_020c5af8(*state, (short)*(int *)(*state + 0x3c8), 5, (void *)(*(int *)(*state + 0x3b4) + 0x14));
        *((u8 *)state + 0x65) = 1;
    }
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3a8), 0xe, 0);
    state[0x11] = 0;
    *((u8 *)state + 0x63) = 0;
    *((u8 *)state + 0x65) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov235_020cf244);
}
