 ...
 * the owner is grounded (+0x17a bit 0), animation 0xc plays, the +0x3a8 part plays motion 0xb,
...
extern void func_ov235_020cea10(int *node);

void func_ov235_020ce938(int *node)
{
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3a8), 0xb, 0);
    func_ov107_020c5af8(state[0], (short)*(int *)(*state + 0x3c8), 3, (void *)state[1]);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov235_020cea10);
}
