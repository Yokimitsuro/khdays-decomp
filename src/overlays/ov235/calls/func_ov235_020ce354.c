 ...
 * tick hands over to func_ov235_020ce400. */
...
extern void func_ov235_020ce400(int *node);

void func_ov235_020ce354(int *node)
{
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3a8), 4, 0);
    state[0x15] = 0;
    *((unsigned char *)state + 0x65) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov235_020ce400);
}
