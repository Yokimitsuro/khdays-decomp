 ...
 * hands over to func_ov235_020ce6b4. */
...
extern void func_ov235_020ce6b4(int *node);

void func_ov235_020ce614(int *node)
{
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3a8), 7, 0);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov235_020ce6b4);
}
