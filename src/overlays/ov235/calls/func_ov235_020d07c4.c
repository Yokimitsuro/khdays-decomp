/* Glide-to-land tick of an ov235 state: the +0x5c path point is resolved (func_ov235_020cccc0)
 ...
 * the tick hands over to func_ov235_020d0868. */
...
extern void func_ov235_020d0868(int *node);

void func_ov235_020d07c4(int *node)
{
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3a8), 0x12, 0);
    func_ov107_020c5af8(state[0], (short)*(int *)(*state + 0x3c8), 3, (void *)state[2]);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov235_020d0868);
}
