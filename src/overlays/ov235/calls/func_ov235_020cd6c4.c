 ...
 * motion 0x16 and the tick hands over to func_ov235_020cd79c. */
...
extern void func_ov235_020cd79c(int *node);
extern const Vec3 data_02042264;

void func_ov235_020cd6c4(int *node)
{
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov235_020cd79c);
}
