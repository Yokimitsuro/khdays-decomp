/* func_ov171_020cd704: hover-approach tick of the ov171 enemy (x2), variant of the matched ov175 sibling (0x200 then x0x1a00 speed, height 0x20c5, leaves beyond 0x6000). */
...
extern int func_ov171_020ccaa0(int node);
extern int data_02042264;

void func_ov171_020cd704(int node)
{
