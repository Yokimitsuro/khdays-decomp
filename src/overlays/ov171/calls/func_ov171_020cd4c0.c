/* func_ov171_020cd4c0: hover-bob tick of the ov171 enemy (x2), variant of the matched ov175 sibling (0x180 pull, height 0x15d9, bob by sin/2, ends below 0x4000). */
/* Hover-bob tick of the ov171 enemy (and its byte-identical twins), the func_ov178_020cd6e0 shape:
...
extern int func_ov171_020cca08(int node, Vec3 *out);
extern void func_01ffa724(int scale, const Vec3 *v, Vec3 *out);
extern int func_02023eb4(int bound);
extern int func_02020400(int a, int b);
extern short data_0203d210[];

void func_ov171_020cd4c0(int node)
{
    ...
    dist = func_ov171_020cca08(node, &dir);
    func_01ffa724(0x180, &dir, (Vec3 *)(state + 8));
    state[9] = 0;
