/* Circle tick of the ov171 enemy (and its byte-identical twins), the func_ov178_020cdbc8 shape: acquires
...
void func_ov171_020cd958(int node)
{
    ...
    state[0x17] = 0;
    *(unsigned char *)(*state + 0x1c7) = (roll < 0x3c && func_ov171_020ccaa0(node) != 0) ? 8 : 5;
