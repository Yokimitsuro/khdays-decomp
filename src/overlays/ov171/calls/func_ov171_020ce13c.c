/* func_ov171_020ce13c: sub-item constructor of the ov171 enemy (x2), variant of the matched ov175 sibling (four handlers, latch 0x64c). */
...
extern void func_ov171_020ce294(void);
extern void func_ov171_020ce2b0(void);
extern void func_ov171_020ce370(void);
extern void func_ov171_020ce2e8(void);

void func_ov171_020ce13c(Ov169Object *self) {
    int owner = self->owner_038c;
    u16 v;

    self->callback_0008 = func_ov171_020ce294;
    self->callback_000c = func_ov171_020ce2b0;
    self->callback_0030 = func_ov171_020ce370;
    self->callback_01d0 = func_ov171_020ce2e8;
    v = self->flags_0060;
    self->flags_0060 =
