/* Message handler of the ov171 enemy (and its byte-identical twins). A "spawned" message (kind 5) carries
 ...
 * sub 8 registers effect 0x114 (kind 7 or 8 by the message's +4 slot) or effect 0x140 (kind 4)
...
void func_ov171_020cc3e0(int owner, unsigned char *command, int arg)
{
        ...
        case 8:
            ...
            case 1:
                *(int *)(owner + command[4] * 4 + 0x3a0) = func_ov107_020cb040(owner, 0x114, 8, 0, (void *)(owner + 0xa0));
                break;
            case 2:
                *(int *)(owner + command[4] * 4 + 0x3a0) = func_ov107_020cb040(owner, 0x140, 4, 0, (void *)(owner + 0xa0));
                break;
            }
            break;
        }
