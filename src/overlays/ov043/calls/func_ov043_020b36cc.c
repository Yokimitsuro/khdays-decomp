...
extern void func_ov043_020b3e24(void);
extern void func_ov043_020b4168(void);
extern void func_ov043_020b43dc(void);
...
void *func_ov043_020b36cc(char *self, int nState)
{
    ...
    switch (nState) {
    case 0x21:
        pHandler = (void *)&func_ov043_020b3e24;
        *(int *)(pBlock + 0x124) = 0;
        (*(void (**)(char *, int))(self + 0x664))(self, 0x2f);
        break;
    case 0x22:
        *(int *)(pBlock + 0xc) = 0xf6;
        pHandler = (void *)&func_ov043_020b4168;
        if (func_02023c40() == 1) {
        ...
        *(int *)(pBlock + 0x124) = 0;
        ...
        break;
    case 0x23:
        pHandler = (void *)&func_ov043_020b43dc;
