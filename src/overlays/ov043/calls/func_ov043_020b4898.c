...
extern void func_ov043_020b4b60(char *node, int mode);
extern void func_ov043_020b50ac(char *self, char *row, int tick);

void func_ov043_020b4898(char *self, char *node, int tick)
{
    int i;
    char *pRow;
    ...
    pRow = node + 0x12c;
    for (i = 0; i < 2; i++) {
        func_ov043_020b50ac(self, pRow, tick);
        pRow += 0x240;
    }
}
