...
extern char data_ov043_020b5864[];
extern char data_ov043_020b5874[];
extern char data_ov043_020b5888[];

u8 func_ov043_020b3c98(char *self)
{
    char *rig = data_ov043_020b58e0 + 0x138 + 0x2c00;
    char *block = self + 0x2f8 + 0x2000;

    block[0x334] = 0;
    func_ov022_020b15b0(*(u8 *)(self + 9), 3);
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov043_020b5864, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov043_020b5874, *(u8 *)(self + 9), 1, rig + 0x10);
    *(u8 **)(block + 0x348) = func_ov022_020b14a4(data_ov043_020b5888, *(u8 *)(self + 9), 2, *(char **)(*(char **)(self + 0x2644) + 0x3c) + 0x28);
