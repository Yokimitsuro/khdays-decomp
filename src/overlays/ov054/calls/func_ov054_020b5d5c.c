...
extern void WM_EndKeySharing_0x020b6308(int self);
extern void func_ov054_020b6344(int *p, int v);
...
void func_ov054_020b5d5c(int self, int mode) {
    int base = data_ov054_020b74a0;
    ...
    switch (mode - 0x2e) {
    case 0:
        if (*(int *)(self + 0x6bc) != mode) { WM_EndKeySharing_0x020b6308(self); }
        break;
    case 1:
        *p = 0;
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov054_020b6344((int *)((char *)p + 0x10), 0);
    ...
    case 4:
        *p = 1;
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov054_020b6344((int *)((char *)p + 0x10), 0xf000);
