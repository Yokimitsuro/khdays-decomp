/* Creates the ov046 enemy's sub-object: allocates it from the default expanding heap,
...
extern void func_ov065_020b63d4(void);
extern int data_ov065_020b7328;

void func_ov065_020b627c(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x30);
    ...
    func_ov022_02091298(*(void **)(self + 0x2000 + 0x644), self,
                        &data_ov065_020b7328, cfg, 2, 2);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) =
        (void *)&func_ov065_020b63d4;
}
