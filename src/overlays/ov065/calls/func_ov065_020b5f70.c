...
extern void func_ov065_020b6e94(void);
extern void func_ov065_020b7024(void);

void *func_ov065_020b5f70(char *self, int msg) {
    char *blk = data_ov065_020b7340 + 0x2c80;
    void *next = 0;
    Vec3 d;
    unsigned short a;
    int *node;
    ...
    switch (msg) {
    case 0x21:
        next = (void *)&func_ov065_020b6e94;
        (*(void (**)(char *, int))(self + 0x664))(self, 0x2f);
        break;
    case 0x22:
        *(int *)(blk + 0x118) = 0;
        next = (void *)&func_ov065_020b7024;
