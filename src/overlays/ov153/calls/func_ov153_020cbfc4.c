 ...
 * +0x388 on the +0x22c list; +0x398 is built by func_ov153_020cc554 and sound 0x13c is loaded. */
...
extern struct Ov153Vec3 data_ov153_020ce014;
extern const struct Ov153Vec3 data_02042264;
extern const char data_ov153_020ce08c[];

extern void func_ov153_020cc250(void);
extern void WM_EndKeySharing_0x020cc290(void);   /* the game's tail-call veneer to the ov107 draw hook, named after the byte-identical SDK thunk */
extern void func_ov153_020cc2ec(void);
extern void func_ov153_020cd2f0(void);
extern void func_ov153_020cc388(void);
extern void func_ov153_020cc3b0(void);
extern void func_ov153_020cc3d8(void);
extern void func_ov153_020cc41c(void);
extern void func_ov153_020cd470(void);
extern void func_ov153_020cd33c(void);
extern void func_ov153_020cc29c(void);
extern void *func_ov153_020cc554(int *self);
...
void func_ov153_020cbfc4(int param)
{
    ...
    kinds[0] = data_ov153_020ce00c[0];
    kinds[1] = data_ov153_020ce00c[1];
    offset = data_ov153_020ce014;

    *(u16 *)param |= 0x100;
    *(void **)(param + 0x08) = func_ov153_020cc250;
    *(void **)(param + 0x0c) = WM_EndKeySharing_0x020cc290;
    *(void **)(param + 0x1c) = func_ov153_020cc2ec;
    *(void **)(param + 0x30) = func_ov153_020cd2f0;
    *(void **)(param + 0x28) = func_ov153_020cc388;
    *(void **)(param + 0x2c) = func_ov153_020cc3b0;
    *(void **)(param + 0x10) = func_ov153_020cc3d8;
    *(void **)(param + 0x34) = func_ov153_020cc41c;
    *(void **)(param + 0x1e0) = func_ov153_020cd470;
    *(void **)(param + 0x1d0) = func_ov153_020cd33c;
    *(void **)(param + 0x1dc) = func_ov153_020cc29c;
    ...
    *(u16 *)(param + 0x100 + 0xae) |= 0x10;

    {
        ...
        ((void **)self)[0xe3] = func_0203bee8(self[0xe1], 1, data_ov153_020ce08c);
        ...
        *((int **)self)[0xe2] = func_ov107_020c3210(&req);
        ((void **)self)[0xe6] = func_ov153_020cc554(self);
        func_0203355c(0x13c);
    }
}
