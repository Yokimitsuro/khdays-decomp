...
extern void func_ov153_020cc768(void);
extern void func_ov153_020cc7a8(void);
extern void func_ov153_020cc7e0(void);
extern void func_ov153_020cc894(void);
extern void func_ov153_020cc9bc(void);
...
void func_ov153_020cc588(char *self)
{
    int kinds[2];
    u16 hw;
    int i;
    kinds[0] = data_ov153_020ce020[0];
    kinds[1] = data_ov153_020ce020[1];
    *(Callback *)(self + 0x8) = func_ov153_020cc768;
    *(Callback *)(self + 0xc) = func_ov153_020cc7a8;
    *(Callback *)(self + 0x1c) = func_ov153_020cc7e0;
    *(Callback *)(self + 0x30) = func_ov153_020cc9bc;
    *(Callback *)(self + 0x1d0) = func_ov153_020cc894;
    hw = *(u16 *)(self + 0x60);
