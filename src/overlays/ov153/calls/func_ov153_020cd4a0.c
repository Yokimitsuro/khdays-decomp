...
extern void func_ov153_020cd570(void);
extern void func_ov153_020cd754(void);
extern void func_ov153_020cd6d0(void);
void func_ov153_020cd4a0(int *node) {
    ...
    *(signed char *)(*state + 0x1c7) = 0xff;
    ...
    func_0203c634(node, 0, func_ov153_020cd570);
    func_0203c634(node, 1, func_ov153_020cd754);
    func_0203c634(node, 2, func_ov153_020cd6d0);
}
