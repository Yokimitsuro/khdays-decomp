...
extern void func_ov064_020b6ed0(Vec3 *src, Vec3 *out);
extern void func_ov064_020b6e30(char *self, char *rig, Vec3 *src);
extern short data_0203d210[];
extern OffsetTable data_ov064_020b72ac;

void func_ov064_020b6c84(char *self, int dt)
{
    OffsetTable table;
    Vec3 out;
    Mtx33 m;
    ...
    *(int *)(rig + 0x10c) += 1;
    ...
    func_ov064_020b6ed0(&out, &out);
    func_ov064_020b6e30(self, rig, &out);
}
