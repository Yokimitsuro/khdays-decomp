...
extern void func_ov064_020b7168(void);
extern void func_ov064_020b7100(void);
extern int data_ov064_020b7408;

void func_ov064_020b6f6c(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x30);
    ...
    func_ov022_02091298(*(void **)(self + 0x2000 + 0x644), self,
                        &data_ov064_020b7408, cfg, 2, 10);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) = (void *)&func_ov064_020b7168;
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x24) = (void *)&func_ov064_020b7100;
}
