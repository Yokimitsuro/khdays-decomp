...
extern void func_ov064_020b6c84(char *self, int dt);
...
void *func_ov064_020b6638(char *self)
{
    Vec3 sample;
    Vec3 step;
    void *next = 0;
    char *rig = data_ov064_020b7420 + 0xdf0 + 0x2000;
    int r;
    unsigned int *node;
    int len;
    ...
    func_ov064_020b6c84(self, *(short *)(self + 0x2aba));
