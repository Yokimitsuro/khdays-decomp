...
extern char data_ov064_020b73d0[];
extern char data_ov064_020b73e4[];

u8 func_ov064_020b63a4(char *self)
{
    char *block = self + 0x2f8 + 0x2000;

    block[0x334] = 0;
    func_ov022_020b15b0(*(u8 *)(self + 9), 2);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov064_020b73d0, *(u8 *)(self + 9), 0, *(char **)(*(char **)(self + 0x2644) + 0xc) + 0x28);
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov064_020b73e4, *(u8 *)(self + 9), 1, *(char **)(self + 0x20) + 4);
