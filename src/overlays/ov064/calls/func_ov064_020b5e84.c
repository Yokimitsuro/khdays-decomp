 ...
 */
extern void func_ov064_020b70b4(int self);
extern void func_ov064_020b69c8(int self, char *p);
...
void func_ov064_020b5e84(int self, int mode) {
    int flag;
    int ret;

    switch (mode) {
    case 0x2e:
        if (mode != *(int *)(self + 0x6bc)) { func_ov064_020b70b4(self); }
        break;
    case 0x2f:
    case 0x30:
        if (mode != *(int *)(self + 0x6bc)) {
            func_ov064_020b69c8(self, (char *)(self + 0x2df0));
        }
        break;
    }
