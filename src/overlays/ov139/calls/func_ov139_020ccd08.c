...
extern int func_ov139_020cc9d4(int *node, Vec3 *at);
extern void func_0203c634(int *node, int slot, void *cb);
extern short data_0203d210[];
extern const Vec3 data_ov139_020cec14;
...
void func_ov139_020ccd08(int *node)
{
    ...
    if (gap <= 0x4000 && state[0x10] <= 0) {
        ...
        if (roll < 0x46 && func_ov139_020cc9d4(node, &probe) == 0) {
