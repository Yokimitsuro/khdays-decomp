...
extern void func_ov139_020ceae8(int *node);
extern const PosMsg data_ov139_020cec58;
extern const PosMsg data_ov139_020cec4a;
...
void func_ov139_020ce2d8(int *node)
{
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov139_020ceae8);
}
