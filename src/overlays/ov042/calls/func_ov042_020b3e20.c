/* Creates the ov042 enemy's sub-objects (x4: ov042/061/081/098): allocates two 0x30 slots from
...
extern void func_ov042_020b4094(void);
extern void func_ov042_020b41a0(void);
extern int data_ov042_020b47c8;
extern int data_ov042_020b47dc;

void func_ov042_020b3e20(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x60);
    ...
    func_ov022_02091298(*(void **)(self + 0x2000 + 0x644), self, &data_ov042_020b47c8, cfg, 3, 6);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) = (void *)&func_ov042_020b4094;
    ...
    cfg2.field38 = 0x25;
    cfg2.field4c = 1;
    func_ov022_02091254((char *)*(void **)(self + 0x2000 + 0x644) + 0x30, self, &data_ov042_020b47dc, &cfg2);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x50) = (void *)&func_ov042_020b4094;
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x54) = (void *)&func_ov042_020b41a0;
}
