/* func_ov042_020b327c -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov042_020b34e4(void);
extern void func_ov042_020b3528(void);
extern void func_ov042_020b3664(void);
extern void func_ov042_020b348c(void);
extern void func_ov042_020b34bc(void);
extern void func_ov042_020b3690(void);
extern void func_ov042_020b3788(void);
extern void func_ov042_020b3810(void);

extern void *data_ov042_020b4800;
extern int data_ov042_020b4768;
extern int data_ov042_020b477c;
extern int data_ov042_020b46e4;
extern int data_ov042_020b46c4;
extern int data_ov042_020b46b4;
extern int data_ov042_020b46d4;
...
void func_ov042_020b327c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov042_020b4768, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov042_020b477c, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov042_020b34e4;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov042_020b3528;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov042_020b3664;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov042_020b348c;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov042_020b34bc;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov042_020b3690;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov042_020b3788;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov042_020b3810;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov042_020b46e4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x514) = b != 0 ? func_02016f10((void *)b, &data_ov042_020b46c4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov042_020b46b4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov042_020b46d4) : -1;
