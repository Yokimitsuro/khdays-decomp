...
extern void func_ov042_020b41f4(char *group, char *part, void *arg);            /* Ov042_SteerPart */
...
void func_ov042_020b4094(char *group, void *arg)
{
    int state;
    char *part;
    int launched;
    ...
    for (i = 0; i < *(u8 *)(group + 0x19); i++) {
        ...
        if (state != 2) {
            ...
            func_ov042_020b41f4(group, part, arg);
        } else {
