 ...
 * at state+0x50, and start event 0x159 on the sub-object.
 *
...
extern void func_ov251_020d586c(void);

void func_ov251_020d5748(int *node) {
    ...
    *(unsigned char *)((int)state + 0x50) = 0;
    func_ov107_020c5af8(state[0], 0x159, 7, state[1]);
    func_0203c634(node, *(signed char *)((int)node + 0x20), func_ov251_020d586c);
}
