...
extern void func_ov045_020b4484(char *self, int dt);
...
void *func_ov045_020b3e38(char *self)
{
    Vec3 sample;
    Vec3 step;
    void *next = 0;
    char *rig = data_ov045_020b4c20 + 0xdf0 + 0x2000;
    int r;
    unsigned int *node;
    int len;
    ...
    func_ov045_020b4484(self, *(short *)(self + 0x2aba));
