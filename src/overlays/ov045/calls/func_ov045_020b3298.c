/* func_ov045_020b3298 -- overlay boot of the ov045 enemy (x4: ov045/064/083/100): the ov042 shape (see
...
extern void func_ov045_020b3684(void);
extern void func_ov045_020b3760(void);
extern void func_ov045_020b3aec(void);
extern void func_ov045_020b3480(void);
extern void func_ov045_020b3618(void);
extern void func_ov045_020b3b3c(void);
extern void func_ov045_020b3ba4(void);
extern void func_ov045_020b3c2c(void);
...
void func_ov045_020b3298(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov045_020b4ba8, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov045_020b4bbc, 1, cfg[0] + 7);
    }
    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov045_020b3684;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov045_020b3760;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov045_020b3aec;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov045_020b3480;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov045_020b3618;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov045_020b3b3c;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov045_020b3ba4;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov045_020b3c2c;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov045_020b4a8c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov045_020b4a7c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov045_020b4a9c) : -1;
    if (cfg[3] != 0) {
        *(long long *)obj |= 0x20;
    }
    if (cfg[4] != 0) {
