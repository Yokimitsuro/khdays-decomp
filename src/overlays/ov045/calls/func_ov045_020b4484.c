...
extern void func_ov045_020b46d0(Vec3 *src, Vec3 *out);
extern void func_ov045_020b4630(char *self, char *rig, Vec3 *src);
extern short data_0203d210[];
extern OffsetTable data_ov045_020b4aac;

void func_ov045_020b4484(char *self, int dt)
{
    OffsetTable table;
    Vec3 out;
    Mtx33 m;
    ...
    *(int *)(rig + 0x10c) += 1;
    ...
    func_ov045_020b46d0(&out, &out);
    func_ov045_020b4630(self, rig, &out);
}
