/* func_ov096_020ba81c -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov096_020babf8(void);
extern void func_ov096_020bad78(void);
extern void func_ov096_020bb7f8(void);

extern void *data_ov096_020bc0c0;
extern int data_ov096_020bc028;
extern int data_ov096_020bc03c;
extern int data_ov096_020bbfd4;
extern int data_ov096_020bbfc4;
extern int data_ov096_020bbfb4;
extern int data_ov096_020bbfa4;
...
void func_ov096_020ba81c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov096_020bc028, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov096_020bc03c, 1, cfg[0] + 7);
    }
    ...
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov096_020baa30;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov096_020baa68;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov096_020babf8;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov096_020bad78;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov096_020bb7f8;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov096_020bbfd4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov096_020bbfc4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov096_020bbfb4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov096_020bbfa4) : -1;
