...
u8 func_ov096_020bad78(char *self)
{
    ...
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov096_020bc050, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov096_020bc060, *(u8 *)(self + 9), 1, rig + 0xc);
