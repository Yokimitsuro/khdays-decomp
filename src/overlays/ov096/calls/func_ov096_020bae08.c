...
void func_ov096_020bae08(char *self)
{
    Params p;
    ...
    *(int *)(rig + 0x120) = 0xccd;
    ...
    func_0202a634((int)(rig + 0xc), data_ov096_020bc074, 1, *(u8 *)(base + 9) + 7);
    func_0202a634((int)(rig + 0x128), data_ov096_020bc088, 1, *(u8 *)(base + 9) + 7);
    func_0202a634((int)(rig + 0x238), data_ov096_020bc09c, 1, *(u8 *)(base + 9) + 7);
