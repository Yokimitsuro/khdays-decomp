 ...
 * 0x5000, and chain to the next state func_ov264_020cdf24.
 *
...
extern void func_ov264_020cdf24(void);

void func_ov264_020cdde4(int param_1) {
    ...
    *(int *)((char *)node + 0x60) = 0;
    func_0203c634(param_1, *(signed char *)((char *)param_1 + 0x20), &func_ov264_020cdf24);
}
