...
extern void func_ov107_020c9264(struct Ov264Actor *actor, int mode, int zero);
extern void func_ov107_020c0b90(struct Ov264Actor *actor, int mode, struct VecFx32 value, int zero);
extern struct Ov264CollisionResult *func_01fff8e8(void *collision, struct VecFx32 *origin,
...
extern int func_ov107_020cab14(struct Ov264Actor *actor, int kind);
...
extern void func_0203c634(struct Ov264Task *task, int slot, void *callback);
extern void func_ov264_020cce44(struct Ov264State *state, unsigned int kind,
                                struct Ov264Params *params);
extern void func_ov264_020ce5cc(void);
...
void func_ov264_020cdf68(struct Ov264Task *task)
{
    ...
    if (state->nPhase6e >= state->nPhaseMax6f) {
        ...
        state->nCallback50 = 0;
        state->bEffect70 = 0;
        func_0203c634(task, task->nSlot20, func_ov264_020ce5cc);
        return;
    }
    ...
    if (collision != 0) {
        ...
        state->pTarget = (struct Ov264Actor *)func_ov107_020cab14(state->pActor, 0);
