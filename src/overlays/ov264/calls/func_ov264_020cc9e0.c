...
extern void func_ov264_020cc968(void *a, int b, int c, void *d);
extern void func_0203c7ac(void *a, int b);
extern int data_ov264_020cebd8[];

void func_ov264_020cc9e0(char *this) {
    int buf[9];
    int v;
    *(struct nine *)buf = *(struct nine *)data_ov264_020cebd8;
    v = func_ov107_020c9440(this, buf[*(signed char *)(this + 0x310)]);
    func_ov264_020cc968(*(void **)(this + 0x384), v,
