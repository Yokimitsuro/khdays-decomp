 ...
 * hands the canned 4-byte event record data_ov142_020d2610[1] to the owner's
...
extern u16 data_ov142_020d2610[4];
extern void func_ov142_020d0fa4(void);

void func_ov142_020d0ef0(Ov149Node *node)
{
    ...
    pp = buf;
    {
        char *src = (char *)data_ov142_020d2610;
        u16 high = *(u16 *)(src + 6);
        u16 low = *(u16 *)(src + 4);
