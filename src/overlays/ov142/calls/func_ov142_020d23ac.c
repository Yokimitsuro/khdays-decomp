...
extern void func_ov142_020d24fc(void);
extern void func_ov142_020d25a4(void);
int func_ov142_020d23ac(int param_1, int param_2) {
    int *local_28;
    int iVar1 = func_0203c5c0(*(int *)(param_1 + 0x3c), 0x64, 0x48,
                              func_ov142_020d24fc, func_ov142_020d25a4, &local_28);
    int iVar5 = 0;
    *local_28 = param_1;
