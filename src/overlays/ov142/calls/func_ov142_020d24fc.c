...
extern void func_ov142_020d2490(void);
extern void func_ov142_020d25dc(void);
void func_ov142_020d24fc(int *node) {
    void *cb = (void *)func_ov142_020d2490;
    ...
    *(unsigned int *)(state[1] + 0x5c) &= ~2;
    func_0203c634(node, *(signed char *)(node + 8), func_ov142_020d25dc);
}
