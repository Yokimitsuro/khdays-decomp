 ...
 * and handing the collected list to func_ov142_020d23ac. */
...
struct Ov142Other {
    ...
    u16 id02;
    char pad04[0x5c];
    struct Ov142Hw60 { u16 lo : 8, hi : 8; } flags60;
    char pad62[0x12];
    struct Ov142Vec3 vPos74;
    int nRadius80;
    char pad84[0x17c];
    u16 flags200_18;
    char pad202[0x16];
...
extern int func_ov107_020cb040(struct Ov142Self *self, int id, int kind, int enabled,
                               void *transform);
extern void **func_01fffd70(void *list);
extern void **func_01fffd8c(void *list);
extern void VEC_Subtract(const struct Ov142Vec3 *a, const struct Ov142Vec3 *b,
                         struct Ov142Vec3 *dst);
extern int VEC_Mag(const struct Ov142Vec3 *v);
extern void func_ov107_020c5af8(struct Ov142Self *self, int id, int kind,
                                struct Ov142Vec3 *at);
extern int func_ov142_020d23ac(struct Ov142Self *self, short *ids);
extern void func_ov107_020c7500(struct Ov142Self *self, struct Ov142Cmd *cmd, int arg2);

void func_ov142_020cff38(struct Ov142Self *self, struct Ov142Cmd *cmd, int arg2)
{
    struct Ov142Other *other;
    void **it;
    int count;
    int n;
    int cap;
    ...
    if (cmd->type02 == 5) {
        ...
        case 0: {
            ...
            short ids[16] = {0};
            struct Ov142Vec3 delta;

            count = 0;
            it = func_01fffd70((void *)(list + 0x80));
            other = (it == 0) ? 0 : (struct Ov142Other *)*it;
            while (other != 0) {
            ...
            self->pSlots390->field04 = func_ov142_020d23ac(self, ids);
            break;
        }
        }
    }
