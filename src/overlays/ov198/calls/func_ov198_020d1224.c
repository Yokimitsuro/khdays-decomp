...
extern void func_ov198_020d0764(int *state, struct Vec3 v, int flag);
extern void func_ov107_020c9264(int a, int b, int c);
extern void func_ov198_020d05f4(int a, int b);
extern void func_0203c634(int self, int idx, int cb);
extern int func_ov198_020d129c;

void func_ov198_020d1224(int self) {
    int *state = *(int **)(self + 4);

    func_ov198_020d0764(state, *(struct Vec3 *)(state + 10), 1);
    ...
    func_ov198_020d05f4(*state, 2);
    func_0203c634(self, *(signed char *)(self + 0x20), (int)&func_ov198_020d129c);
}
