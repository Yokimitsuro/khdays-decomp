...
extern const struct ReactionModes data_ov198_020d24d4;
...
int func_ov198_020d0438(int owner, int source, struct HitDescriptor *hit)
{
    ...
    modes.normal[0] = data_ov198_020d24d4.normal[0];
    modes.normal[1] = data_ov198_020d24d4.normal[1];
    modes.flagged[0] = data_ov198_020d24d4.flagged[0];
    modes.flagged[1] = data_ov198_020d24d4.flagged[1];
