...
extern void func_ov198_020d0090(void);
extern void func_ov198_020d00bc(void);
extern void func_ov198_020d0284(void);
extern void func_ov198_020d03dc(void);
extern void func_ov198_020d013c(void);
extern void func_ov198_020d0178(void);
extern void func_ov198_020d01b4(void);
extern void func_ov198_020d0438(void);
extern void func_ov198_020d03a4(void);
extern void func_ov198_020d0598(void);
extern void func_ov198_020d05c4(void);
extern void func_ov198_020cfc04(void);
extern void func_ov198_020cfc4c(void);
extern int func_ov198_020d1934(struct Obj *self);
...
void func_ov198_020cfdc8(struct Obj *self)
{
    struct Box box;
    struct Subitem *item;
    int *slot;
    ...
    self->fn08 = func_ov198_020d0090;
    self->fn0c = func_ov198_020d00bc;
    self->fn1c = func_ov198_020d0284;
    self->fn30 = func_ov198_020d03dc;
    self->fn28 = func_ov198_020d013c;
    self->fn2c = func_ov198_020d0178;
    self->fn34 = func_ov198_020d01b4;
    self->fn1d0 = func_ov198_020d0438;
    self->fn1dc = func_ov198_020d03a4;
    self->fn1e0 = func_ov198_020d0598;
    self->fn1e4 = func_ov198_020d05c4;
    ...
    self->subitem384->callback74 = func_ov198_020cfc04;
    self->subitem384->owner84 = self;
    func_0203bfb4(self->subscriberList9c, self->subitem384);
    self->resourceId3d4 = func_0203bdfc(self->subitem384, data_ov198_020d250c);

    (self->subitem388 = func_0203b898(func_ov107_020c9440(self, 1)))->callback6c = func_ov198_020cfc4c;
    self->subitem388->owner84 = self;
    func_0203c7ac(self->subitem388, 0);
    self->resourceId3d0 = func_0203bdfc(self->subitem388, data_ov198_020d2514);
    ...
    *self->poolEntry38c = func_ov107_020c319c(self->camera);
    ...
    for (i = 0; i < 3; i++) {
        self->child398[i] = func_ov198_020d1934(self);
    }
