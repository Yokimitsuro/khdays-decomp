...
extern const struct ChildIds data_ov198_020d24dc;
extern void func_ov198_020d1b34(void);
extern void func_ov198_020d1b6c(void);
extern void func_ov198_020d1ba4(void);
extern void func_ov198_020d1d34(void);
extern void func_ov198_020d1cd0(void);
...
void func_ov198_020d1968(struct Obj *self)
{
    struct ChildIds ids = data_ov198_020d24dc;
    struct Obj *owner = self->owner390;
    unsigned int flags;
    int i;

    self->fn08 = func_ov198_020d1b34;
    self->fn0c = func_ov198_020d1b6c;
    self->fn1c = func_ov198_020d1ba4;
    self->fn30 = func_ov198_020d1d34;
    self->fn1d0 = func_ov198_020d1cd0;
