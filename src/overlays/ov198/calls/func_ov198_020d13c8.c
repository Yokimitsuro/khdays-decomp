...
extern void func_ov198_020d065c(int *s, int b, int c);
...
void func_ov198_020d13c8(int *self) {
    Vec3 v;
    int *s = (int *)self[1];
    int p;
    v = data_02041dc8;
    ...
    func_ov198_020d065c(s, v.y, *s + 0x3d8);
    func_0203c634(self, *(signed char *)((char *)self + 0x20), (void *)&func_ov198_020d14a8);
}
