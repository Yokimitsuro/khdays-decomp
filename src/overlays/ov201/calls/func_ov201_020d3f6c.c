 ...
 * three beam nodes from the kinds of data_ov201_020d5484 (registered on the owner, bit 1 of
...
extern const KindTable data_ov201_020d5484;
extern void func_ov201_020d41bc(void);
extern void func_ov201_020d53a8(void);

int *func_ov201_020d3f6c(int owner, int nKind)
{
    int *state;
    KindTable kinds;
    unsigned int i;
    ...
    kinds = data_ov201_020d5484;
    func_0203c5c0(*(int *)(owner + 0x3c), 0x64, 0x54, (void *)func_ov201_020d41bc, 0, (int *)&state);
    state[0] = owner;
    for (i = 0; i < 3; i++) {
    ...
    func_0203c5c0(*(int *)(owner + 0x3c), 0x64, 8, (void *)func_ov201_020d53a8, 0, state + 0xc);
