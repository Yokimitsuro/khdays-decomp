/*
 * func_ov201_020d36a0 -- x3 (ov200/201/271). AI-state tick: fire, aim the pose at the target, and
 * transition.
...
extern void func_ov201_020d372c(void);
extern int  data_02042264;

void func_ov201_020d36a0(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov201_020d372c);
}
