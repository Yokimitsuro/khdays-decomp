/*
 * func_ov201_020d3dcc -- x3. AI-state entry: set flags, spawn effect 0x49, dispatch.
...
extern void func_ov201_020d3e90(void);

void func_ov201_020d3dcc(int *self) {
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 0x40) << 0x18) >> 0x10);
    ...
    state[0x14] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov201_020d3e90);
}
