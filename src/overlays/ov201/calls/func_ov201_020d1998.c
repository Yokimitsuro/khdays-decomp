...
extern const char data_ov201_020d54a0[];
extern void func_ov201_020d1a24(int);
int func_ov201_020d1998(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x3bc);
    *(signed char *)(obj + 0x19c) = 38;
    OS_SPrintf(buf, data_ov201_020d54a0, 38);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov201_020d1a24;
