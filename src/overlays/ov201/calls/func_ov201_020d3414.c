/*
 * func_ov201_020d3414 -- x3. AI-state tick: fire, roll a random strafe sign, dispatch.
...
extern void func_ov201_020d3468(void);

void func_ov201_020d3414(int *self) {
    ...
    state[0x14] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov201_020d3468);
}
