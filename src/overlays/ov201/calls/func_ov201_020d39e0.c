/*
 * func_ov201_020d39e0 -- x3. AI-state tick: orient toward the target, then transition on a timer.
...
extern int  func_ov201_020d41b4(int obj);
...
extern void func_ov201_020d3b34(void);

void func_ov201_020d39e0(int *self) {
    ...
    {
        int s0 = *state;
        if (func_ov201_020d41b4(*(int *)(s0 + 0x390)) != 0) {
            state[0xa] = 0x800;
    ...
    *(struct vec3 *)(state + 9) = data_02041dc8;
    ...
    if (state[0x14] >= 0x2a80) {
        ...
        func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov201_020d3b34);
        return;
    }
    if (state[0x14] < 0x59a6) {
        return;
    }
    if (func_ov201_020d4180(*(int *)(*state + 0x390)) != 0) {
        return;
    }
    func_ov107_020c9264(*state, 5, 0);
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov201_020d3b34);
