...
extern int func_ov201_020d419c(int node);
extern int data_02042264;

void func_ov201_020d3468(int *node)
{
    int actor;
    int target;
    ...
    if (state[0x20] <= 0) {
        ...
        if (func_ov201_020d419c(*(int *)(*state + 0x390)) != 0
            && func_ov201_020d419c(*(int *)(*state + 0x394)) != 0
            && func_ov201_020d419c(*(int *)(*state + 0x398)) != 0) {
            *(unsigned char *)(*state + 0x1c7) = 6;
            func_0203c634((int)node, *(signed char *)((int)node + 0x20), 0);
            return;
        }
        if (func_ov201_020d419c(*(int *)(*state + 0x394)) == 0) {
            return;
        }
        if (func_ov201_020d419c(*(int *)(*state + 0x398)) == 0) {
            return;
        }
