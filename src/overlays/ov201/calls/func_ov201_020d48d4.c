/* Ov201_TickBeam -- per-frame update of the ov201 enemy's beam (x3 with ov200 / ov271, which only
...
extern void func_ov201_020d52c8(int *ring, VecFx32 *pos, VecFx32 *normal);
...
void func_ov201_020d48d4(int *node, int len, int bTest)
{
    VecFx32 pos;
    Quat quat;
    VecFx32 fwd;
    ...
    if (hit != 0 && hit->nBlocked == 0) {
        ...
        func_ov201_020d52c8(state->pRing, &hitPos, &normal);
        plane.n = normal;
