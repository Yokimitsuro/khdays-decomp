/* Strafe move of the ov200 enemy (the handler func_ov201_020d2e68 dispatches on its d201). Without a
...
extern void func_ov201_020d2e68(void);
...
void func_ov201_020d3148(int self)
{
    int target;
    int *owner;
    int *ctx;
    ...
    if (ctx[0x20] <= 0) {
        ...
        if (func_ov201_020d419c(*(int *)(ctx[0] + 0x390))
            && func_ov201_020d419c(*(int *)(ctx[0] + 0x394))
            && func_ov201_020d419c(*(int *)(ctx[0] + 0x398))) {
            *(signed char *)(ctx[0] + 0x1c7) = (*(unsigned char *)(ctx[0] + 0x1c4) & 4) ? 2 : 6;
            func_0203c634(self, *(signed char *)(self + 0x20), 0);
            return;
        }
        if (func_ov201_020d419c(*(int *)(ctx[0] + 0x394))
            && func_ov201_020d419c(*(int *)(ctx[0] + 0x398))) {
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov201_020d2e68);
}
