 ...
 * hands over to func_ov201_020d4704. */
...
extern void func_ov201_020d4704(void);

void func_ov201_020d44b8(int *self) {
    ...
    *(int *)(state[1] + 0x5c) &= ~2;
    ...
    state[0x14] = 1;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (void *)func_ov201_020d4704);
}
