/*
 * func_ov201_020d43fc -- x3. AI-state entry: aim the sub-node at the anchor midpoint, arm it, dispatch.
...
extern void func_ov201_020d44b8(void);

void func_ov201_020d43fc(int *self) {
    ...
    *(char *)((int)state + 0x44) = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov201_020d44b8);
}
