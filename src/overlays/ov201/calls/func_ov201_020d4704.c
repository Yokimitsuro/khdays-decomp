 ...
 * length on y, and the beam runs through func_ov201_020d48d4 with the length and mode 1. */
...
extern void func_ov201_020d48d4(int *node, int nLength, int mode);

void func_ov201_020d4704(int *self) {
    ...
    func_ov201_020d48d4(self, nLen, 1);
}
