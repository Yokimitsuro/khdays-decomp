...
u8 func_ov037_020b3768(char *self)
{
    ...
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov037_020b4dd0, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov037_020b4de0, *(u8 *)(self + 9), 1, rig + 4);
