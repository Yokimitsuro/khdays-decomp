...
extern void func_ov037_020b46fc(char *self);
extern void func_ov037_020b4a74(char *self);

void *func_ov037_020b4104(char *self)
{
    int r;
    Vec3 sample;
    Vec3 step;
    ...
    if (*(int *)(self + 0x7b0) >= 0x36000) {
        func_ov037_020b4a74(self);
    } else {
        func_ov037_020b46fc(self);
    }
