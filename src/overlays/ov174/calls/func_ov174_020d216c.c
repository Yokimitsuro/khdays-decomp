 ...
 * animation 7 plays and the state advances to func_ov174_020d22ac. */
...
extern void func_ov174_020d22ac(void);

void func_ov174_020d216c(int *node)
{
    ...
    *(Vec3 *)(state + 8) = *(Vec3 *)(state + 0xb);
    ...
    if (*(unsigned char *)(state[1] + 0xad) == 0) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov174_020d22ac);
    }
}
