/* func_ov174_020cffd4: spawn-message handler of the ov173 enemy (x2), variant of the matched ov166 sibling: subs 2/4 start entry 2 from the transform (two separate bodies, laid out 3-4-2-5), sub 3 fixes entries 6 and 4 to the +0x38c/+0x390 placements, sub 5 starts entry 0, and sub 8 registers effect 0x141 (modes 4/5; kind 2 is an empty case). */
...
void func_ov174_020cffd4(int owner, unsigned char *command, int arg)
{
