/* Constructor of the ov174 enemy (twins by byte identity). Installs the handlers (+8 release, +0xc
...
extern void func_ov174_020cff70(void);
extern void WM_EndKeySharing_0x020cffb0(void);
extern void func_ov174_020cffd4(void);
extern void func_ov174_020d03ac(void);
extern void WM_EndKeySharing_ov174_0x020cffbc(void);
extern void WM_EndKeySharing_0x020cffc8(void);
extern void func_ov174_020d024c(void);
extern void func_ov174_020d0408(void);
extern void func_ov174_020d021c(void);
extern void func_ov174_020d06e8(void);
extern void func_ov174_020cfc04(void);
...
void func_ov174_020cfc60(char *self)
{
    ...
    bounds.w[4] = 0x1000;
    bounds.w[5] = 0x1000;
    *(Callback *)(self + 0x8) = func_ov174_020cff70;
    *(Callback *)(self + 0xc) = WM_EndKeySharing_0x020cffb0;
    *(Callback *)(self + 0x1c) = func_ov174_020cffd4;
    *(Callback *)(self + 0x30) = func_ov174_020d03ac;
    *(Callback *)(self + 0x28) = WM_EndKeySharing_ov174_0x020cffbc;
    *(Callback *)(self + 0x2c) = WM_EndKeySharing_0x020cffc8;
    *(Callback *)(self + 0x34) = func_ov174_020d024c;
    *(Callback *)(self + 0x1d0) = func_ov174_020d0408;
    *(Callback *)(self + 0x1dc) = func_ov174_020d021c;
    *(Callback *)(self + 0x1e0) = func_ov174_020d06e8;
    hw = *(u16 *)(self + 0x60);
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov174_020cfc04;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(unsigned char *)(*(int *)(self + 0x384) + 0xad) = 0;
    *(int *)(self + 0x38c) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov174_020d290c);
    *(int *)(self + 0x390) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov174_020d290c);
    *(int *)(self + 0x394) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov174_020d2914);
    *(int **)(self + 0x39c) = func_0203d15c(0x20);
    for (i = 0; i < 4; i++) {
        if (i < 0) {
