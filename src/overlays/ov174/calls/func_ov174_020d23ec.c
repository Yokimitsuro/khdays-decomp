 ...
 * animation 9 plays and the state advances to func_ov174_020d2528. */
...
extern void func_ov174_020d2528(void);

void func_ov174_020d23ec(int *node)
{
    ...
    *(Vec3 *)(state + 8) = *(Vec3 *)(state + 0xb);
    ...
    if (state[0x16] <= 0) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov174_020d2528);
    }
}
