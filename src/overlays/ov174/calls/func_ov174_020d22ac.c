/* Flight step 2 of the ov173 enemy (x2: ov173/174): the +0x20 velocity takes the +0x2c aim
 ...
 * animation 8 plays (looping) and the state advances to func_ov174_020d23ec. */
...
extern void func_ov174_020d23ec(void);

void func_ov174_020d22ac(int *node)
{
    ...
    *(Vec3 *)(state + 8) = *(Vec3 *)(state + 0xb);
    ...
    if (*(unsigned char *)(state[1] + 0xad) == 0) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov174_020d23ec);
    }
}
