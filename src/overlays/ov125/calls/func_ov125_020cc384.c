...
extern void func_ov125_020ce55c(int node, int active);
...
void func_ov125_020cc384(int actor, unsigned char *msg, int param)
{
    u8 payload[9];
    FxVec vA;
    FxVec vB;
    ...
    if (msg[2] == 5) {
        ...
        case 4:
            ...
            break;
        case 1:
            func_ov125_020ce55c(*(int *)(actor + 0x390), 1);
            *(int *)(actor + 0x3a8) = func_ov107_020cb040(actor, 0x11b, 7, 0, (void *)(actor + 0xa0));
            break;
        case 2:
            func_ov125_020ce55c(*(int *)(actor + 0x390), 0);
            break;
        case 3:
