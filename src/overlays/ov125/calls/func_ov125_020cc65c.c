...
extern void func_ov125_020ce55c(Ov125AimNode *node, int active);
extern int func_ov125_020ce594(Ov125AimNode *node);
extern void func_ov107_020c7ca4(Ov125Object *self);

void func_ov125_020cc65c(Ov125Object *self) {
    if ((self->leavingFlags_01c4 & 0xa) != 0) {
        ...
        func_ov125_020ce55c(self->aimNode_0390, 0);
    ...
    if (self->mode_01c6 != 6) {
        if (func_ov125_020ce594(self->aimNode_0390) != 0) {
            func_ov125_020ce55c(self->aimNode_0390, 0);
        }
        if (self->handle_03a8 != 0) {
            func_ov107_020cb100(self->handle_03a8);
