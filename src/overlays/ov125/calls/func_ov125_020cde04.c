...
extern void func_ov125_020cdf78(void);

void func_ov125_020cde04(int *self) {
    ...
    if (state[0xb] >= 0x5000) {
        ...
        func_0203c634((int)self, *(signed char *)((int)self + 0x20), func_ov125_020cdf78);
        return;
    }
    if (state[0xb] < 0x800) {
        return;
    }
    if (func_ov125_020ce594(*(int *)(*state + 0x390)) != 0) {
        return;
    }
    func_ov107_020c9264(*state, 5, 0);
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), func_ov125_020cdf78);
