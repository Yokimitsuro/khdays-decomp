/*
 * func_ov125_020cda84 -- AI-state entry: seed the +0x3c counter with 6 times the owner's +0x2c
...
extern void func_ov125_020cdb28(void);
extern int  data_02042264;

void func_ov125_020cda84(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov125_020cdb28);
}
