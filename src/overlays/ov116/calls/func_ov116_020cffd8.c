/* func_ov116_020cffd8: spawn-message handler of the ov115 enemy (x2), variant of the matched ov178 sibling (subs laid out 3-4-0-1-2-8; sub 0 spawns the +4 child from the scene id and fixes entries 2 and 12 to the +0x390 placement). */
...
extern int func_ov116_020d0478(int owner, int parent, int kind);

void func_ov116_020cffd8(int owner, unsigned char *command, int arg)
{
    ...
    if (command[2] == 5) {
        ...
        case 4:
            ...
            break;
        case 0:
            (*(int **)(owner + 0x39c))[1] = func_ov116_020d0478(owner, (*(int **)(owner + 0x39c))[0], func_ov107_020c2b50(*(int *)(owner + 4), *(unsigned short *)(command + 4)));
