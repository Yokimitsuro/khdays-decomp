/* Orbit tick of the ov115 enemy (and its byte-identical twins), variant of the matched ov178 sibling:
 ...
 * down and then rolls sub-state 4 (1/120 or too far), 5 (1/20) or 9. */
...
void func_ov116_020d1458(int node)
{
