/* func_ov116_020d02dc: tick handler of the ov115 enemy (x2), variant of the matched ov178 sibling: task slots +0xc (outside 8/9), +0x34 (outside 8) and +0x2c (outside 9) are finished, then the two +0x3a0 attachments (outside 9) and +0x3a8 (outside 8). */
...
void func_ov116_020d02dc(int self)
{
    int i;
