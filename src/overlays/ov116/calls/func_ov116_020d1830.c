/* Hover-bob tick of the ov115 enemy (and its byte-identical twins), the func_ov178_020cd6e0 shape:
 * acquires a target (+0xc; none requests sub-state 2), steps 0x180 along the direction from
...
extern int func_ov116_020d0cc4(int node, Vec3 *out);
extern void func_01ffa724(int scale, const Vec3 *v, Vec3 *out);
extern int func_02023eb4(int bound);
extern int func_02020400(int a, int b);
extern short data_0203d210[];

void func_ov116_020d1830(int node)
{
    ...
    dist = func_ov116_020d0cc4(node, &dir);
