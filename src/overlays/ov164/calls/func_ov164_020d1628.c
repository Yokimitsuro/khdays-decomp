/* func_ov164_020d1628: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern const struct Msg data_ov164_020d2c9e;
extern void func_ov164_020d1abc(void);

void func_ov164_020d1628(struct Node *node)
{
    struct State *st;
    FxVec vFwd;
    FxVec vToTarget;
    ...
    func_0203c634(node, node->bSlot, (void *)func_ov164_020d1abc);
}
