...
extern void func_ov164_020d28d4(void);
extern void func_ov164_020d2a14(void);

void func_ov164_020d292c(int *node) {
    int *state = (int *)node[1];
    state[1] = *(int *)(*(int *)(*state + 0x3c4) + 0x18);
    *(void **)(state[1] + 0x6c) = func_ov164_020d28d4;
    ...
    *(int *)(state[1] + 0x5c) &= ~2;
    ...
    state[2] = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov164_020d2a14);
}
