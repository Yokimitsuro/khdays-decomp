...
extern const struct tbl8 data_ov164_020d2cc8;

void func_ov164_020d02bc(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov164_020d02bc(newcenter, half, child, param_4,
