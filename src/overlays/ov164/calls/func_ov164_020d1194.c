...
extern void func_ov164_020d1218(void);

void func_ov164_020d1194(int *self) {
    int v;
    int *obj = (int *)self[1];

    obj[5] = *(int *)(self[0] + 0x2c) * 0x1e / 10;
    *(signed char *)((int)obj + 0x6c) = func_02023eb4(2) + (v - v) != 0 ? -1 : 1;
    obj[0x13] = func_02023eb4(0x81) + (v - v);
    func_ov107_020c9264(*obj, 1, 1);
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), &func_ov164_020d1218);
}
