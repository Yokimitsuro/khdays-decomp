/*
 * func_ov121_020ce388 -- Ov121_Actor_OnHit.
 *
 * The actor's hit handler, installed by the ov121 initializer. Shared byte-for-byte with
 * ov120 and ov122; against ov120 even the relocations match.
 *
 ...
 *
 * Ghidra: Ov121_Actor_OnHit(Ov120Actor *pActor, int nParam, ActorHitEvent *pHit), types
...
int func_ov121_020ce388(struct Ov120Actor *actor, int nParam, struct ActorHitEvent *hit)
{
