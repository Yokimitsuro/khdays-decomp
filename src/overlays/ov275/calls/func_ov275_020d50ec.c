 ...
 * (data_ov275_020d6030, the +4 point packed as 24-bit values) goes to the owner's +0x24 hook,
 ...
 * heading of the direction and the tick hands over to func_ov275_020d5378. */
...
extern const PosMsg data_ov275_020d6030;
extern const Vec3 data_02041dc8;
extern const short data_0203d210[];
extern void func_ov275_020d5378(int *node);

void func_ov275_020d50ec(int *node)
{
    ...
    *(Vec3 *)(state + 0xc) = data_02041dc8;
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov275_020d5378);
}
