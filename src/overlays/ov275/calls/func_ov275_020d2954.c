...
extern const struct tbl8 data_ov275_020d60a0;

void func_ov275_020d2954(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov275_020d2954(newcenter, half, child, param_4,
