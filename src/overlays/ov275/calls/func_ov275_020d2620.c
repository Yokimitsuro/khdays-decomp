...
extern void func_ov275_020d2720(void);
extern void func_ov275_020d269c(void);
extern void func_ov275_020d25d8(void);
int func_ov275_020d2620(int param_1) {
    int *entry;
    int spawn = func_0203c5c0(*(int *)(param_1 + 0x3c), 100, 8,
                              &func_ov275_020d269c, &func_ov275_020d2720, &entry);
    entry[0] = param_1;
    entry[1] = **(int **)(*entry + 0x3e0);
    *(int *)(entry[1] + 0x6c) = (int)&func_ov275_020d25d8;
