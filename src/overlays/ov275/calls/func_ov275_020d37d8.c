/*
 * func_ov275_020d37d8 -- x4 (ov206/207/274/275). AI-state tick: acquire the target, wind up, then
...
extern void func_ov275_020d38b8(void);

void func_ov275_020d37d8(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov275_020d38b8);
}
