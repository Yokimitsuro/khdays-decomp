 ...
 * data_ov275_020d5fb4 kinds in a fresh 40-byte slot table (+0x3e0, attached, bit 1 on their
 * +0x5c), configures actions 0/2/1/4 (modes 2/3/2/2, the second with a (0, -0x1d00, 0) offset,
 * rates 0x1000 / 0x99a / 0xccd / 0x1000), keeps pool entry 0x14's data_ov275_020d613c motion
...
extern struct Ov274Kinds data_ov275_020d5fb4;
extern struct Ov274Vec3 data_02041dc8;
extern struct Ov274Vec3 data_02042264;
extern const char data_ov275_020d60ec[];
extern const char data_ov275_020d60f8[];
extern const char data_ov275_020d6108[];
extern const char data_ov275_020d6118[];
extern const char data_ov275_020d6120[];
extern const char data_ov275_020d6130[];
extern const char data_ov275_020d613c[];

extern void func_ov275_020d1ea0(void);
extern void func_ov275_020d1ef8(void);
extern void func_ov275_020d2150(void);
extern void func_ov275_020d2b08(void);
extern void func_ov275_020d2264(void);
extern void func_ov275_020d2414(void);
extern void func_ov275_020d2b54(void);
extern void func_ov275_020d2e7c(void);
extern void func_ov275_020d2328(void);
...
void func_ov275_020d1a24(int param)
{
    ...
    kinds = data_ov275_020d5fb4;

    *(void **)(param + 0x08) = func_ov275_020d1ea0;
    *(void **)(param + 0x0c) = func_ov275_020d1ef8;
    *(void **)(param + 0x1c) = func_ov275_020d2150;
    *(void **)(param + 0x30) = func_ov275_020d2b08;
    *(void **)(param + 0x2c) = func_ov275_020d2264;
    *(void **)(param + 0x34) = func_ov275_020d2414;
    *(void **)(param + 0x1d0) = func_ov275_020d2b54;
    *(void **)(param + 0x1e0) = func_ov275_020d2e7c;
    *(void **)(param + 0x1dc) = func_ov275_020d2328;
    ...
    *(unsigned short *)(param + 0x100 + 0xae) |= 8;

    {
        ...
        ((void **)self)[0xf2] = func_0203bee8(self[0xe1], 1, data_ov275_020d60ec);
        ((void **)self)[0xf3] = func_0203bee8(self[0xe1], 1, data_ov275_020d60f8);
        ((void **)self)[0xf4] = func_0203bee8(self[0xe1], 1, data_ov275_020d6108);
        ((void **)self)[0xf5] = func_0203bee8(self[0xe1], 3, data_ov275_020d6118);
        ((void **)self)[0xf7] = func_0203bee8(self[0xe1], 1, data_ov275_020d6120);
        ((void **)self)[0xf6] = func_0203bee8(self[0xe1], 3, data_ov275_020d6130);
        ...
        ((void **)self)[0xed] = func_ov107_020c9e50(func_ov107_020c9440(self, 0x14), data_ov275_020d613c);
