/* Ov275_EnterMoveState -- resets the owner's move state (+0x1c6 = 0, +0x1c7 = -1), clears the two
 ...
 * handlers (1: 020d3278, 0: 020d2f7c, 2: 020d318c). */
extern void func_0203c634(int node, int slot, void *handler);
extern void func_ov275_020d3278(void);
extern void func_ov275_020d2f7c(void);
extern void func_ov275_020d318c(void);

void func_ov275_020d2ec4(int node)
{
    ...
    *(unsigned short *)(*state + 0x60) =
    ...
    func_0203c634(node, 1, &func_ov275_020d3278);
    func_0203c634(node, 0, &func_ov275_020d2f7c);
    func_0203c634(node, 2, &func_ov275_020d318c);
}
