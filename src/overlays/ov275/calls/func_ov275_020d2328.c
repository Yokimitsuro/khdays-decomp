/*
 * func_ov275_020d2328 -- x4. Message handler: on kinds 6 and 0xa, (re-)arm the emitter, then map the
...
extern void func_ov275_020d22bc(int a, int b, int c, int d);
extern void func_0203c7ac(int a, int b);
extern struct t17 data_ov275_020d5fc8;

void func_ov275_020d2328(int self, int kind, int arg3) {
    struct t17 table = data_ov275_020d5fc8;
    ...
    func_ov275_020d22bc(*(int *)(self + 0x384), func_ov107_020c9440(self, table.w[kind]), arg3,
                        self + 0x388);
