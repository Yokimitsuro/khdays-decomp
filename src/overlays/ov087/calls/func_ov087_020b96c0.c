...
extern void func_ov087_020b8fa4(char *self, int dt);
...
void *func_ov087_020b96c0(char *self)
{
    Vec3 sample;
    Vec3 step;
    void *next = 0;
    ...
    func_ov087_020b8fa4(self, *(short *)(self + 0x2aba));
    ...
    if (((Flags *)(self + 0x694))->b1) {
        if (func_ov022_02095524(self + 0x2f8 + 0x2000) != 0 && *(int *)(rig + 0x11c) == 0) {
            if (func_ov022_02095554(self + 0x2f8 + 0x2000) != 0 && *(int *)(rig + 0x118) == 0) {
                *(int *)(rig + 0x118) = 1;
                next = func_ov022_020a35f4(self, 0x22);
            } else {
                len = func_0202aef8(*(char **)(self + 0x20) + 4, 0) - 0xc000;
                *(unsigned long long *)self &= ~0x2000000000000ULL;
                node = *(unsigned int **)(self + 0x20);
                if ((*node & 0x20) == 0) {
