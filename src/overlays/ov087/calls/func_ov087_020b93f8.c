...
extern char data_ov087_020b9ba0[];
extern char data_ov087_020b9bb0[];
extern char data_ov087_020b9bc4[];

u8 func_ov087_020b93f8(char *self)
{
    char *rig = data_ov087_020b9be0 + 0xfc + 0x2c00;
    char *block = self + 0x2f8 + 0x2000;

    block[0x334] = 0;
    func_ov022_020b15b0(*(u8 *)(self + 9), 4);
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov087_020b9ba0, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov087_020b9bb0, *(u8 *)(self + 9), 1, *(char **)(*(char **)(self + 0x2644) + 0xc) + 0x28);
    *(u8 **)(block + 0x348) = func_ov022_020b14a4(data_ov087_020b9bc4, *(u8 *)(self + 9), 2, rig + 4);
