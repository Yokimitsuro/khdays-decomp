...
extern void func_ov087_020b91e4(Vec3 *src, Vec3 *out);
extern void func_ov087_020b915c(char *self, char *rig, Vec3 *src);
extern short data_0203d210[];
extern OffsetTable data_ov087_020b9a38;
extern char *data_ov087_020b9be0;

void func_ov087_020b8fa4(char *self, int dt)
{
    OffsetTable table;
    Vec3 out;
    Mtx33 m;
    ...
    *(int *)(rig + 0x110) += 1;
    ...
    func_ov087_020b91e4(&out, &out);
    func_ov087_020b915c(self, rig, &out);
}
