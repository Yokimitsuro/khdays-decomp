...
extern void func_ov087_020b96c0(void);
extern void func_ov087_020b8888(void);
extern void func_ov087_020b94e0(void);

void *func_ov087_020b84d0(char *self, int msg) {
    ...
    case 0x21:
        ...
        *(int *)(self + 0x58) = 0;
        ...
        return (void *)&func_ov087_020b8888;
    case 0x22:
        if (*(int *)(blk + 0x118) != 0) {
        ...
        return (void *)&func_ov087_020b94e0;
    case 0x23:
        next = (void *)&func_ov087_020b96c0;
        break;
    }
    return next;
}
