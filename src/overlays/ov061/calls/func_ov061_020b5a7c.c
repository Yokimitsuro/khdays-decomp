/* func_ov061_020b5a7c -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov061_020b5ce4(void);
extern void func_ov061_020b5d28(void);
extern void func_ov061_020b5e64(void);
extern void func_ov061_020b5c8c(void);
extern void func_ov061_020b5cbc(void);
extern void func_ov061_020b5e90(void);
extern void func_ov061_020b5f88(void);
extern void func_ov061_020b6010(void);
...
void func_ov061_020b5a7c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov061_020b6f68, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov061_020b6f7c, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov061_020b5ce4;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov061_020b5d28;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov061_020b5e64;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov061_020b5c8c;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov061_020b5cbc;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov061_020b5e90;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov061_020b5f88;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov061_020b6010;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov061_020b6ee4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x514) = b != 0 ? func_02016f10((void *)b, &data_ov061_020b6ec4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov061_020b6eb4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov061_020b6ed4) : -1;
