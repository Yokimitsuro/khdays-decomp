...
extern void func_ov061_020b6620(char *self);
extern char *data_ov061_020b7000;
extern char data_ov061_020b6fb4[];

void func_ov061_020b6534(void)
{
    char *self = data_ov061_020b7000;
    ...
    *(int *)(self + 0x2c2c) = 0;
    ...
    for (i = 0; i < 7; i++) {
        func_0202a634(seq, data_ov061_020b6fb4, 1, *(u8 *)(self + 9) + 7);
        seq += sizeof(Ov042SeqSlot);
    }
    func_ov061_020b6620(self);
}
