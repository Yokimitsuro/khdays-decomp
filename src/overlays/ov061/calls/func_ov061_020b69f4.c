...
extern void func_ov061_020b6c24(Vec3 *origin, Vec3 *move);                     /* Ov042_LayTrail */
...
int func_ov061_020b69f4(char *group, char *part, void *arg)
{
    Vec3 vTo;
    Vec3 vStep;
    Vec3 vFrom;
    ...
    *(Vec3 *)(part + 0xcc) = vTo;
    func_ov061_020b6c24(&vFrom, &vStep);
