/* Creates the ov061 enemy's sub-objects (byte-identical twin of ov042 020b3e20): allocates two
 * 0x30 slots from
...
extern int data_ov061_020b6fc8;
extern int data_ov061_020b6fdc;

void func_ov061_020b6620(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x60);
    ...
    func_ov022_02091298(*(void **)(self + 0x2000 + 0x644), self, &data_ov061_020b6fc8, cfg, 3, 6);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) = (void *)&func_ov061_020b6894;
    ...
    cfg2.field38 = 0x25;
    cfg2.field4c = 1;
    func_ov022_02091254((char *)*(void **)(self + 0x2000 + 0x644) + 0x30, self, &data_ov061_020b6fdc, &cfg2);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x50) = (void *)&func_ov061_020b6894;
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x54) = (void *)&func_ov061_020b69a0;
}
