...
extern Vec3 data_ov061_020b6ea8;            /* muzzle offset */
extern Angles data_ov061_020b6e90;          /* heading offsets of the three shots */
extern PermTable data_ov061_020b6ef4;       /* the six permutations of {0,1,2} */
extern const Vec3 data_ov061_020b6e9c;            /* unit z ray */
extern short data_0203d210[];

void *func_ov061_020b60d4(char *self)
{
    PermTable perm;
    Vec3 sample;
    Vec3 muzzle;
    ...
    Vec3 step;
    void *next = 0;
    char *rig = data_ov061_020b7000 + 0x2c + 0x2c00;
    int limit;
    int count;
    int rand;
    int i;
    ...
    if (*(int *)(self + 0x4cc) >= limit && *(int *)(rig + 4) == 0) {
        muzzle = data_ov061_020b6ea8;
        angles = data_ov061_020b6e90;
        perm = data_ov061_020b6ef4;
        count = 1;
        p.f14 = 0;
        p.f1c = 1;
        p.f20 = 0;
