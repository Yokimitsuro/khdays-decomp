...
extern void func_ov061_020b6ce8(Vec3 *pos, Vec3 *dir);                         /* Ov042_ClaimSlotAndLaunch */
extern char *data_ov061_020b7000;

void func_ov061_020b6c24(Vec3 *origin, Vec3 *move)
{
    Vec3 vDir;
    Vec3 vPos;
    char *trail = data_ov061_020b7000 + 0x2c + 0x2c00;
