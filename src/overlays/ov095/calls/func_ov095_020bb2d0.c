...
extern void func_ov095_020bb874(char *self);
extern char *data_ov095_020bcba0;
extern char data_ov095_020bcb68[];
extern Params data_ov095_020bc93c;

void func_ov095_020bb2d0(char *self)
{
    Params p;
    char *base = data_ov095_020bcba0;
    ...
    *(int *)(rig + 0x314) = 0x59a;
    ...
    slot = rig + 0x1c;
    for (i = 0; i < 2; i++) {
        func_0202a634((int)slot, data_ov095_020bcb68, 1, *(u8 *)(base + 9) + 7);
        slot += 0x10c;
    }
    p = data_ov095_020bc93c;
    func_ov022_02092384((int)(self + 0x248 + 0x2400), *(u8 *)(self + 9), 5, &p);
    func_ov095_020bb874(self);
}
