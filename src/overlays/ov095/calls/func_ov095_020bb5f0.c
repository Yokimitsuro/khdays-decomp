...
extern const Vec3 data_ov095_020bc930;               /* the plain anchor offset */
extern const Ov039SidePair data_ov095_020bc950;      /* the left/right anchor offsets */
extern short data_0203d210[];

void func_ov095_020bb5f0(char *self, int side, Vec3 *out)
{
    Mtx33 mFacing;
    Vec3 vDefault;
    Ov039SidePair sides;
    ...
    vDefault = data_ov095_020bc930;
    sides = data_ov095_020bc950;

    if (*(int *)(data_ov095_020bcba0 + 0x2000 + 0xcd4) == 0) {
        out->x = vDefault.x;
        out->y = vDefault.y;
        out->z = vDefault.z;
    } else {
