...
extern void func_ov095_020bbf2c(char *self, char *shot, int bCharged);          /* Ov039_FireStoredShot */

void func_ov095_020bb708(char *self, char *shot, int dt)
{
    Vec3 vMove;
    int speed;
    char *hit;
    ...
    *(int *)(shot + 4) += 1;
    ...
    func_ov095_020bbf2c(self, shot, bCharged);
    if (bCharged != 0) {
        *(int *)(shot + 8) = 0;
    }
}
