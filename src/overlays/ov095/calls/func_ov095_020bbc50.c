...
extern void func_ov095_020bb5f0(char *self, int side, Vec3 *out);              /* Ov039_GetAttackAnchor */
extern void func_ov022_020ad208(char *self, int event, Vec3 *pos, int range, int angle, int flag);
extern char *data_ov095_020bcba0;
extern const Ov039BandRow data_ov095_020bc968;      /* the single-anchor per-band flags */

void func_ov095_020bbc50(char *self)
{
    Vec3 vAnchor;
    ...
    if (band >= 15) band = 0;
    if (*(int *)rig == 0) {
        Ov039BandRow single = data_ov095_020bc968;
        func_ov095_020bb5f0(self, 0, &vAnchor);
    ...
    }
    {
        ...
        func_ov095_020bb5f0(self, 1, &vAnchor);
