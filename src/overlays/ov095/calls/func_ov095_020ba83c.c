/* func_ov095_020ba83c -- overlay boot of the ov039 enemy (x4: ov039/058/078/095): the ov042 shape (see
...
extern void *data_ov095_020bcba0;
extern int data_ov095_020bcb1c;
extern int data_ov095_020bcb30;
extern int data_ov095_020bc9b4;
extern int data_ov095_020bc9a4;
extern int data_ov095_020bc9c4;
...
void func_ov095_020ba83c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov095_020bcb1c, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov095_020bcb30, 1, cfg[0] + 7);
    }
    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov095_020bab10;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov095_020bae28;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov095_020bb074;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov095_020baa20;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov095_020baae8;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov095_020bb0ac;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov095_020bb248;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov095_020bc088;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov095_020bc9b4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov095_020bc9a4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov095_020bc9c4) : -1;
    if (cfg[3] != 0) {
        *(long long *)obj |= 0x20;
    }
    if (cfg[4] != 0) {
