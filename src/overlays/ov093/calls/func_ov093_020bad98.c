...
extern void func_ov093_020bb2a8(void);
extern void func_ov093_020bb6a4(void);

void *func_ov093_020bad98(char *self, int msg) {
    ...
    case 0x21:
        *(int *)(blk + 0x110) = 0;
        ...
        next = (void *)&func_ov093_020bb2a8;
        break;
    case 0x22:
        next = (void *)&func_ov093_020bb6a4;
