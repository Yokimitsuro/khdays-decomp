...
extern void func_ov093_020bbc9c(char *self);
extern void func_ov093_020bc014(char *self);

void *func_ov093_020bb6a4(char *self)
{
    int r;
    Vec3 sample;
    Vec3 step;
    ...
    if (*(int *)(self + 0x7b0) >= 0x36000) {
        func_ov093_020bc014(self);
    } else {
        func_ov093_020bbc9c(self);
    }
