...
extern void func_ov144_020cd450(int *node);
extern void func_ov144_020cd41c(int *node);

void func_ov144_020cd38c(int *node)
{
    ...
    if (*(int *)(actor + 0x39c) != 0 && *(int *)(actor + 0x3b8) != 0) {
        if (state[0x10] <= 0x100) {
            func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov144_020cd450);
            return;
        }
        func_ov107_020c9264(actor, 0, 1);
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov144_020cd41c);
        return;
    }
    func_ov107_020c9264(actor, 0, 1);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov144_020cd450);
