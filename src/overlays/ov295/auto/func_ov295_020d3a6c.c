/* func_ov295_020d3a6c -- tick this enemy's stagger timer (+0x21a) and, when a hit lands, flip
...
int func_ov295_020d3a6c(int param_1, int param_2, unsigned int *param_3) {
