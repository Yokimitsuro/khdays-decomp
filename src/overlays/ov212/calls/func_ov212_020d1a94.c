/* func_ov212_020d1a94 -- notify the owner's callback, then run the finaliser if we are in state 1.
 *
 ...
 * independently of any of that, state 1 at +0x50 runs func_ov212_020d1c70 over +0x214. */
...
extern void func_ov212_020d1c70(int a);

void func_ov212_020d1a94(int obj) {
    ...
    if (*(int *)(obj + 0x50) == 1) {
        func_ov212_020d1c70(*(int *)(obj + 0x214));
    }
}
