/* Pre-update of the ov212 enemy: outside mode 9 the +0x620 task is dropped, outside mode 0xc
 * the +0x658 one; the +0x514 offset is reset to (0, 0x17cd, 0), turned by the actor's +0xa0
...
void func_ov212_020cd168(int self)
{
