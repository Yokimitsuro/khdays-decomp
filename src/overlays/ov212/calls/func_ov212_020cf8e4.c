/* Carry tick of the ov212 enemy. Idle means the +0x57c speed is at most 0x1b3 with the +4 item
...
void func_ov212_020cf8e4(int *node)
{
    ...
    if (*(int *)(*state + 0x57c) <= 0x1b3 && *(unsigned char *)(state[1] + 0xad) == 0) {
        bIdle = 1;
    }
