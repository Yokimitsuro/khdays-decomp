/* func_ov212_020cd860 -- hit filter of the +0x214 sub-state while the +0x21a stock is positive.
 ...
 * the hit is the 0x88-flagged 0x80-kind one, reaction 0x128 of the kind picked from the {2,3} /
...
extern void func_ov212_020cd5ec(int *state, int a);
...
int func_ov212_020cd860(int self, int param, unsigned int *hit) {
    ...
    if (func_ov212_020cd63c(state, 1) != 0 && *(signed char *)(*state + 0x100 + 0xc6) != 5) {
        bGrab = 1;
    } else {
        bGrab = 0;
    }
    ...
    if ((int)hit[10] > 0) {
        if (!((((struct HitWord *)hit)->lo & 8) != 0 && (((struct HitWord *)hit)->lo & 0x80) != 0 && ((struct HitWord *)hit)->hi == 0x80)) {
            if ((((struct HitWord *)hit)->lo & 0x22) != 0) {
                func_ov107_020c5af8(self, 0x128, hurt[*((unsigned char *)state + 0x5c)], (void *)state[2]);
            } else {
                func_ov107_020c5af8(self, 0x128, idle[*((unsigned char *)state + 0x5c)], (void *)state[2]);
            }
