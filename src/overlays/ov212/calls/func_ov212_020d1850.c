/* func_ov212_020d1850 -- push one entry into the ring buffer at ctx[0]+0x90 and advance the write
 * index with a wrap.
 *
...
void func_ov212_020d1850(int *ctx, const VecFx32 *v, const Quaternion *q) {
    int i;
    int base;
    int slot;
