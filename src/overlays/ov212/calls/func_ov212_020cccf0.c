/* Message hook of the ov212 enemy, receiving side of func_ov212_020cd2a0 (x3 with ov266/ov267). A
 ...
 * 5..0xd) and, by byte 3, spawns into the +0x60c pair table: slots 0/1 effect 0x17 scaled 1.02
...
void func_ov212_020cccf0(char *self, u8 *msg, int arg)
{
    Vec3 w;
    Quat q;
    SrtTransform t;
    ...
    if (msg[2] == 0) {
        ...
        case 0:
        case 1:
            func_0203ca9c(&t, 0x1052);
            ((struct Ov212 *)self)->pairs[msg[3]].handle =
                func_ov107_020c0794(*(int *)(self + 0x3c), ((struct Ov212 *)self)->pairs[msg[3]].res, 0x17,
                                    msg[3] == 0 ? 1 : 3, &t);
            break;
        case 3:
        case 8:
            ((struct Ov212 *)self)->pairs[msg[3]].handle =
                func_ov107_020c0794(*(int *)(self + 0x3c), ((struct Ov212 *)self)->pairs[msg[3]].res, 5, msg[4], &t);
            break;
        case 7:
            ((struct Ov212 *)self)->pairs[msg[3]].handle =
                func_ov107_020c0794(*(int *)(self + 0x3c), ((struct Ov212 *)self)->pairs[msg[3]].res, 0x15, msg[4], &t);
            break;
        case 2:
        case 4:
            ((struct Ov212 *)self)->pairs[msg[3]].handle =
                func_ov107_020c09a0(*(int *)(self + 0x3c), ((struct Ov212 *)self)->pairs[msg[3]].res, 0x15,
                                    self + 0x54c, msg[4], msg[3] == 2 ? 1 : 0);
            break;
        case 5:
            ((struct Ov212 *)self)->pairs[msg[3]].handle =
                func_ov107_020c09a0(*(int *)(self + 0x3c), ((struct Ov212 *)self)->pairs[msg[3]].res, 5,
                                    self + 0x54c, msg[4], 0);
            break;
        case 6:
            ((struct Ov212 *)self)->pairs[msg[3]].handle =
