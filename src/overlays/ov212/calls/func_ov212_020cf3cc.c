...
extern int func_ov212_020cd63c(int a, int b);
extern int func_0203c634(int a, int b, void *handler);
extern void func_ov212_020cf438(int);
void func_ov212_020cf3cc(int param_1) {
    int child = *(int *)(param_1 + 4);
    if (func_ov212_020cd63c(child, 1) != 0) {
        func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov212_020cf438);
        return;
    }
    if (func_ov212_020cd63c(child, 0) != 0) return;
