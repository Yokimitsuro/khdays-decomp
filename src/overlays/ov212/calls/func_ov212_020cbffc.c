...
extern int func_ov212_020cbfc8(int a, int b);
...
void func_ov212_020cbffc(int rig, char *self)
{
    Mtx43 probe;
    Vec3 first;
    Vec3 pos;
        ...
        *(SrtTransform *)(self + 0x54c) = *(SrtTransform *)(self + 0xa0);
        ...
        if (func_02016320(*(int *)(rig + 0x88) + 0x20, &probe, 0, *(int *)(self + 0x59c)) != 0) {
            ...
            for (k = 0; k < 2; k++) {
                ...
                func_01ffa724(0x1467, (void *)(part + 0x64), (void *)(part + 0x58));
    ...
    for (i = 0; i < 16; i++) {
        ...
        if (blocked != 0 || (i != 0 && VEC_DotProduct(&dir, &first) <= 0)) {
            ...
            if (i != 0) {
                int diff = func_ov212_020cbfc8(ang, prev);
        ...
        func_0202f55c(&quat, weight, &((struct Ov212Chain *)self)->quats[i], &quat);
