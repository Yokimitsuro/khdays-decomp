/* func_ov212_020d0a48 -- move the object, notify the owner's callback, latch the ready flag, and
...
extern void func_ov212_020d0d90(int a, int b, int c);

void func_ov212_020d0a48(int obj, int a, int b, int c) {
    ...
    *(int *)(obj + 0x388) = 1;
    if (*(int *)(obj + 0x50) == 1) {
        func_ov212_020d0d90(*(int *)(obj + 0x214), b, c);
    }
}
