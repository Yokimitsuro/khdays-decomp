...
extern void func_ov212_020cd66c(int *state);
...
extern int func_ov212_020cd60c(int *state, int a);
extern const Vec3 data_02042264;
extern const Vec3 data_02041dc8;

void func_ov212_020ce800(int *node)
{
    ...
    if (func_ov212_020cd60c(state, 1) != 0) {
        state[0x11] = 0;
