...
extern void func_ov212_020d1850(int *ctx, const VecFx32 *v, const Quaternion *q);
extern void func_ov212_020d18b4(int *ctx);
extern int func_ov107_020c7500(int a, int b, int c);

union W { unsigned char b[4]; int w; };

void func_ov212_020d0c48(int param_1, unsigned char *msg, int param_3) {
    VecFx32 pos;
    union W t[3];
    ...
    if (msg[2] == 5) {
        ...
        switch (msg[3]) {
        case 0xb:
            func_ov212_020d1850(*(int **)(param_1 + 0x390), &pos, (const Quaternion *)(msg + 4));
            break;
        case 0xc:
            func_ov212_020d18b4(*(int **)(param_1 + 0x390));
            break;
        }
    }
