/* func_ov233_020ce354 -- steer toward the target: rotate the owner's offset vector by the stored
 ...
 *   - func_ov233_020cd4b0 returning negative (nothing to steer toward);
...
void func_ov233_020ce354(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
