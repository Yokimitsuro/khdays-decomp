/* Contact sweep of the ov233 enemy: collects the entities in the given box (or
 ...
 * surface along the push, and the id bit is set. When anything was hit, reaction 0x164 mode 5
...
void func_ov233_020cd028(int *state, int kind, Sphere *sphere, void *box)
{
    int hits[4];
    Vec3 push;
    Vec3 dir;
