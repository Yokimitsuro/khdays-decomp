/* func_ov233_020cddb8 -- the approach tick: age the timer, re-acquire the target, and decide
 ...
 * func_ov233_020cd2bc, which decides whether to re-enter at all.
 *
...
void func_ov233_020cddb8(int self) {
    ...
    *(int *)(ctx[0] + 0x3bc) = func_ov107_020cab14(ctx[0], 0);
    ...
    if (ctx[0x15] <= 0) {
        if (func_ov233_020cd2bc(self, range) == 0) {
            goto reset;
        }
