/* func_ov233_020ce19c -- the wait loop of the approach: hold the stance for a few ticks, then
 * commit. This is the other half of func_ov233_020ce018, which enters here; from here the object
 * either loops back into 020cfeac or moves on to func_ov233_020ce354.
 *
 * func_ov233_020cd4b0 returns the current range (negative aborts). Inside 0x1000 there is a 45%
...
extern int func_ov233_020cd4b0(int self);
...
extern void func_ov233_020ce018(void);
extern void func_ov233_020ce354(void);
...
void func_ov233_020ce19c(int self) {
    int *ctx;
    MtxFx33 mtx;
    int range;
    int idx;
    ...
    ctx = *(int **)(self + 4);
    range = func_ov233_020cd4b0(self);
    if (range < 0) {
    ...
    if (*(unsigned char *)(ctx[1] + 0xad) == 0) {
        ...
        if (--ctx[0x14] > 0) {
            func_0203c634(self, *(signed char *)(self + 0x20), func_ov233_020ce018);
            return;
        }
        ...
        func_0203c634(self, *(signed char *)(self + 0x20), func_ov233_020ce354);
        return;
    }
