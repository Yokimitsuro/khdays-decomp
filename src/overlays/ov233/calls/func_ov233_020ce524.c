/* func_ov233_020ce524 -- the steering tick that leads into func_ov233_020ce608. Structurally the
...
extern void func_ov233_020ce608(void);
extern short data_0203d210[];

void func_ov233_020ce524(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
    ...
    func_ov233_020cd49c(ctx[0], 0xa);
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov233_020ce608);
}
