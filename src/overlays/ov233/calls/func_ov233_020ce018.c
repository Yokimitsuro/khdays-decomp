/* func_ov233_020ce018 -- pick the reaction for the current stance, or fall through to steering.
 *
 * func_ov233_020cd4b0 returning negative aborts to a plain c634 re-entry.
 *
 ...
 * 2 -> (9, 7), 3 -> (6, 5) -- and then continues into func_ov233_020ce19c. Any other stance
...
extern void func_ov233_020ce19c(void);
...
void func_ov233_020ce018(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;

    ctx = *(int **)(self + 4);
    if (func_ov233_020cd4b0(self) < 0) {
    ...
    if (*(unsigned char *)(ctx[1] + 0xad) == 0) {
        ...
        case 0:
            ...
            func_ov233_020cd49c(ctx[0], 2);
            break;
        case 2:
            func_ov107_020c9264(ctx[0], 9, 0);
            func_ov233_020cd49c(ctx[0], 7);
            break;
        case 3:
            func_ov107_020c9264(ctx[0], 6, 0);
            func_ov233_020cd49c(ctx[0], 5);
            break;
        default:
        ...
        func_0203c634(self, *(signed char *)(self + 0x20), func_ov233_020ce19c);
        return;
    }
