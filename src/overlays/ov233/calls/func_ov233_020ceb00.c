/* Spin attack tick of the ov233 enemy. The +0x4c timer accumulates the frame-time; until bit 7
...
extern int func_ov233_020cd4b0(int *node);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_01ffa724(int scale, Vec3 *v, Vec3 *d);
extern void func_ov233_020cd028(int *state, int kind, Sphere *sphere, void *box);
...
void func_ov233_020ceb00(int *node)
{
    ...
    if (state[0x13] <= 0xbb0 && func_ov233_020cd4b0(node) < 0) {
    ...
    if (state[0x13] >= 0xbb0 && state[0x13] <= 0x1188) {
        ...
        func_ov233_020cd028(state, 0, &sphere, 0);
        ...
        func_ov233_020cd028(state, 5, &sphere, 0);
    }
