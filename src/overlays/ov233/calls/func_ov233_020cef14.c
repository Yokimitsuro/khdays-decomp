/* Charge tick of the ov233 enemy: the +0x4c timer accumulates the frame-time and, past 0x550,
...
extern void func_ov233_020cf02c(int *node);
...
void func_ov233_020cef14(int *node)
{
    ...
    if (*(unsigned char *)(state[1] + 0xad) == 0) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov233_020cf02c);
        return;
    }
