...
extern void func_ov233_020cd49c();
extern void func_0203c634(void *obj, int idx, void *value);
extern short data_0203d210[];
extern void func_ov233_020cef14(void);
void func_ov233_020cee10(int *node) {
    ...
    func_ov233_020cd49c(*state, 0xd);
    state[0x13] = 0;
    *(signed char *)((char *)state + 0x61) = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov233_020cef14);
}
