/* Effect message hook of the ov233 enemy. A "spawned" message (kind 5) carries
 ...
 * reaction 0x164 mode 9 on the +0xa0 pose into +0x4a4. The base hook always runs. */
...
void func_ov233_020cc5e4(char *self, u8 *cmd, void *arg3)
{
    int rawZ;
    int rawY;
    int rawX;
    ...
    if (cmd[2] == 5) {
        ...
        case 5:
            *(void **)(self + (cmd[3] << 3) + 0x4ac) =
            ...
            break;
        case 0xb:
            *(void **)(self + 0x4a4) = func_ov107_020cb040(self, 0x164, 9, 0, self + 0xa0);
            break;
        }
    }
