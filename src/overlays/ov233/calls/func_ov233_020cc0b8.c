/* Constructor of the ov233 enemy. Installs the handlers (+8, +0xc, +0x1c message, +0x28, +0x2c, +0x30,
 ...
 * of data_ov233_020d0d74 into the +0x4a8 pair table (the first from the shared scene resource, the
 ...
 * creates the eight +0x3c0 projectiles (020d0194) and loads sound 0x164. */
...
extern void func_ov233_020cc4a0(void);
extern void func_ov233_020cc4f8(void);
extern void func_ov233_020cc5e4(void);
extern void func_ov233_020cca8c(void);
extern void func_ov233_020cc56c(void);
extern void func_ov233_020cc5a8(void);
extern void func_ov233_020cc84c(void);
extern void func_ov233_020ccae8(void);
extern void func_ov233_020cc9d4(void);
extern void func_ov233_020ccfcc(void);
extern void func_ov233_020ccff8(void);
extern void func_ov233_020cbfc8(void);
...
extern int func_ov233_020d0194(char *self);
...
void func_ov233_020cc0b8(char *self)
{
    IdTable ids = data_ov233_020d0d74;
    Bounds bounds;
    Placement place;
    Vec3 lift;
    int i;
    ...
    *(Callback *)(self + 0x8) = func_ov233_020cc4a0;
    *(Callback *)(self + 0xc) = func_ov233_020cc4f8;
    *(Callback *)(self + 0x1c) = func_ov233_020cc5e4;
    *(Callback *)(self + 0x30) = func_ov233_020cca8c;
    *(Callback *)(self + 0x28) = func_ov233_020cc56c;
    *(Callback *)(self + 0x2c) = func_ov233_020cc5a8;
    *(Callback *)(self + 0x34) = func_ov233_020cc84c;
    *(Callback *)(self + 0x1d0) = func_ov233_020ccae8;
    *(Callback *)(self + 0x1dc) = func_ov233_020cc9d4;
    *(Callback *)(self + 0x1e0) = func_ov233_020ccfcc;
    *(Callback *)(self + 0x1e4) = func_ov233_020ccff8;
    ...
    *(Callback *)(*(int *)(self + 0x3a8) + 0x74) = func_ov233_020cbfc8;
    ...
    *(int *)(self + 0x3b4) = func_0203bdfc(*(int *)(self + 0x3a8), data_ov233_020d0e4c);
    *(int *)(self + 0x3b8) = func_0203bdfc(*(int *)(self + 0x3a8), data_ov233_020d0e5c);
    ...
    *(int *)(self + 0x490) = func_ov107_020c9e50(func_ov107_020c9440(self, 0x1c), data_ov233_020d0e6c);
    for (i = 0; i < 10; i++) {
        if (i < 1) {
    ...
    *(int *)(self + 0x3b0) = *slot = node;
    for (i = 0; i < 8; i++) {
        ((struct Shots *)self)->shots[i] = func_ov233_020d0194(self);
    }
    func_0203355c(0x164);
}
