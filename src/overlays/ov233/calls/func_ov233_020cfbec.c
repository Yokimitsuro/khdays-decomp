/*
 * func_ov233_020cfbec -- x4 (ov228/229/233/249). AI-state tick: circle/orbit a tracked node.
...
extern void func_ov233_020d0144(int node, struct vec v, struct vec v2);
extern void func_ov233_020cfd64(void);
extern short data_0203d210;

void func_ov233_020cfbec(int *self, int p2, int p3, int p4) {
    ...
    if (state[0x12] == 0 && func_ov233_020cd4b0((int)self) < 0) {
    ...
    do {
        if ((((struct hw60 *)(((int *)*state)[i + 0xf0] + 0x60))->lo & 1) == 0) {
            ...
            func_ov233_020d0144(*(int *)(*state + i * 4 + 0x3c0), out, vec);
            break;
        }
        i++;
    } while (i < 8);
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov233_020cfd64);
}
