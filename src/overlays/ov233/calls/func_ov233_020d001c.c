/* func_ov233_020d001c -- face the target and close in, unless it is already too near.
 *
 ...
 * func_ov233_020cd49c). Otherwise the tail is the same Y-rotation steering as
...
void func_ov233_020d001c(int self) {
    int *ctx;
