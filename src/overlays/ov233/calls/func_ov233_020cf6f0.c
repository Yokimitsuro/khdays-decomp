/* func_ov233_020cf6f0 -- the recoil tick: bleed the stored impulse away over 0x1800 of timer,
 ...
 * hw60 hi-byte (it HAS the trunc pair, so bitfield form) and hands off to func_ov233_020cf908. */
...
extern void func_ov233_020cf908(void);
extern short data_0203d210[];

void func_ov233_020cf6f0(int self) {
    int *ctx;
    ...
    *(unsigned char *)((char *)ctx + 0x61) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov233_020cf908);
}
