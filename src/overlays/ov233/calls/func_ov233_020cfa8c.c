/* func_ov233_020cfa8c -- drive the timed effect, then end the move.
 *
 ...
 * func_ov233_020cd028: the object's own vector from ctx+0x34, three constant vectors, a scaled
...
extern void func_ov233_020cd028(int *ctx, int a, int b, EffectParams *p);
...
void func_ov233_020cfa8c(int self) {
    int *ctx;
    EffectParams p;
    int t;
