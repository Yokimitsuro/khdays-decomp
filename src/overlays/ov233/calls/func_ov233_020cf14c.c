/* c634 handler: run the guard func_ov233_020cd4b0; if it fails (<0), dispatch null. Else,
...
extern void func_ov233_020cf1fc(void);
void func_ov233_020cf14c(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(char *)((char *)obj + 0x61) = 0;
    obj[2] = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov233_020cf1fc);
}
