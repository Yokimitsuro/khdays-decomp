...
extern void func_ov138_020d14f4(void);
extern unsigned short data_ov138_020d2fbc[];
void func_ov138_020d1428(int self) {
    int obj = *(int *)(self + 4);
    ...
    *(int *)(obj + 0x14) = *(int *)(*(int *)self + 0x2c) * 30 / 5;
    ...
    }
    {
        ...
        p[1] = data_ov138_020d2fbc[7];
        p[0] = data_ov138_020d2fbc[6];
    ...
    *(unsigned char *)(obj + 0x54) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov138_020d14f4);
}
