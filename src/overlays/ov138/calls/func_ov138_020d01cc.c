/* Tick handler of the ov137 enemy. If flagged (+0x1c4 & 0xa) the +0x390 block's +0x24 effect is
 ...
 * bone's +0x14 (unit direction, length, radius 0xd00) is written into the +0x38c item's +0x58
...
void func_ov138_020d01cc(int self)
{
    Segment seg;
