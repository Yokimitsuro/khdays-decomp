/* Start the ov138 leap: reseed the countdown from the owner's frame rate,
...
typedef struct Ov138ActionNode {
    void *pOwner;
    Ov138MoveState *pState;
    void *apHandlers[6];
...
extern void func_ov138_020d1054(Ov138ActionNode *node);
extern const short data_0203d210[];

void func_ov138_020d0f18(Ov138ActionNode *node)
{
    Ov138MoveState *state = node->pState;
    ...
    state->vVelocity.y = 0x400;
    {
        ...
        int nNextHandler = (int)func_ov138_020d1054;
        Ov138ActionNode *pNextNode = node;
