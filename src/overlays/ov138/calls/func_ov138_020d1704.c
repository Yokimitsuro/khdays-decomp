/* func_ov138_020d1704 -- set the follow-up delay, and if the counter allows, commit the move.
 ...
 * Otherwise a 2-field descriptor is built from data_ov138_020d2fbc and passed to the owner's own
 ...
 * the action dispatched with func_ov138_020d17e0.
 *
...
extern void func_ov138_020d17e0(void);
extern unsigned short data_ov138_020d2fbc[];

void func_ov138_020d1704(int self) {
    int *ctx;
    Ov137_Desc d;
    Ov137_Desc *p;
    ...
    p = &d;
    d.b = data_ov138_020d2fbc[1];
    d.a = data_ov138_020d2fbc[0];
    ...
    *(unsigned char *)((char *)ctx + 0x54) = 0;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov138_020d17e0);
}
