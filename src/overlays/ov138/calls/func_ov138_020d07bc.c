...
extern void func_ov138_020d0890(void);
extern void func_ov138_020d0a30(void);

void func_ov138_020d07bc(int *node) {
    ...
    *(unsigned char *)((char *)state + 0x56) = *(unsigned short *)(*state + 0x100 + 0xb0);
    ...
    func_0203c634(node, 1, func_ov138_020d0ae4);
    func_0203c634(node, 0, func_ov138_020d0890);
    func_0203c634(node, 2, func_ov138_020d0a30);
}
