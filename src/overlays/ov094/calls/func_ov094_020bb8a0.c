...
extern void func_ov094_020bb894(int self, int *p);
extern unsigned int func_0202a818(void *p, int a);
extern void func_ov094_020bb7d4(int self, int *p, int mode);

void func_ov094_020bb8a0(int self, int *p, int p3) {
    if (*p != 0) {
        if (*(int *)(self + 0x6bc) != 0x2e &&
            (((struct Self *)self)->flags & 0x10000ULL) == 0 &&
            func_ov022_02095524((void *)(self + 0x22f8)) == 0) {
            func_ov094_020bb894(self, p);
        }
    ...
    case 1:
        if (func_0202a818((char *)p + 4, p3) != 0) {
            func_ov094_020bb7d4(self, p, 1);
        }
        return;
    case 2:
        if (func_0202a818((char *)p + 4, p3) != 0) {
            func_ov094_020bb7d4(self, p, 3);
        }
        return;
    case 3:
