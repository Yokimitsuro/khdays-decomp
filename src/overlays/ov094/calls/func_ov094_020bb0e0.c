...
extern void func_ov094_020bb0a4(int self, int *p2);
extern void func_ov094_020bb780(int p2, int a);
extern void func_ov094_020bb29c(int self, void *block);
extern void func_ov094_020bb7d4(int self, void *block, int a);
...
void func_ov094_020bb0e0(int self, int *p2, int p3) {
    char *blk = (char *)(*(int *)&data_ov094_020bc240 + 0x2c + 0x2c00);

    if (*p2 != 0 && (((struct Ov094Self *)self)->nStage6bc != 0x31 ||
                     (((struct Ov094Self *)self)->flags464 & 0x4000000000LL) != 0)) {
        func_ov094_020bb0a4(self, p2);
    }
    if (*p2 == 0) {
        return;
    }
    ...
    case 2:
        ...
        func_ov094_020bb780((int)p2, 1);
        func_ov094_020bb29c(self, blk);
        func_ov094_020bb7d4(self, blk + 0x118, 0);
        *p2 = 3;
        *(int *)((char *)p2 + 0x10c) = 0;
        return;
    case 3:
        ...
        func_ov094_020bb780((int)p2, 2);
        func_ov094_020bb29c(self, blk);
        func_ov094_020bb7d4(self, blk + 0x118, 2);
        *p2 = 4;
        *(int *)((char *)p2 + 0x10c) = 0;
        return;
    case 4:
