/*
 * func_ov268_020d202c -- x3 (ov208/209/268). AI-state tick: face the cached target, fire attack 0xa
...
extern void func_ov268_020d20c8(void);

void func_ov268_020d202c(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov268_020d20c8);
}
