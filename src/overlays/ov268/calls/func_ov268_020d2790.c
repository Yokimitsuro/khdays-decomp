/*
 * func_ov268_020d2790 -- x3. AI-state tick: during a mid-window, drive two anchors, then transition.
 ...
 */
struct v4 { int w[4]; };
extern void func_ov268_020d0f90(int a, int b, void *c, int d);
extern void func_0203c634(int self, int idx, int cb);

void func_ov268_020d2790(int *self) {
    ...
    if (state[0xb] > 0x2aa && state[0xb] < 0xc44) {
        ...
        func_ov268_020d0f90((int)state, 2, &v, 0);
