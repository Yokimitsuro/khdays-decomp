 ...
 * +0x24, clears the +0x45 byte and hands the tick over to func_ov268_020d40e0. */
...
extern void func_ov268_020d40e0(int *node);

void func_ov268_020d3f94(int *node)
{
