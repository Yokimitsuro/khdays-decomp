/* Hit filter of the ov268 enemy (x3 with ov208/ov209), active while the +0x21a stock is positive.
 ...
 * of the +0x218 maximum (0x3000) or the hit is an 8-flagged kind-4 hit (0x9000), the bonus goes to
 ...
 * reaction 0x15f with the {2,3} (bits 1/5) or {0,1} mode it picks at the hit body's +4 point.
...
int func_ov268_020d0b7c(char *self, u16 *src, unsigned int *hit)
{
    ...
    if (hit[6] == *(unsigned int *)(self + 0x3b8)) {
        *((u8 *)state + 0x4a + src[1]) = 5;
        if (*(signed char *)(*state + 0x100 + 0xc6) == 7) {
            ...
            if ((((struct HitWord *)hit)->lo & 8) != 0 && (((struct HitWord *)hit)->hi & 4) != 0) {
                bonus = 0x9000;
            }
            if (bonus != 0) {
                state[0x11] = 0;
        ...
        if ((int)hit[10] > 0) {
            if (!((((struct HitWord *)hit)->lo & 8) != 0 && (((struct HitWord *)hit)->lo & 0x80) != 0 && ((struct HitWord *)hit)->hi == 0x80)) {
                if ((((struct HitWord *)hit)->lo & 0x22) != 0) {
                    ...
                    func_ov107_020c5af8((int)self, 0x15f, hurt[((struct Parity *)((u8 *)state + 0x48))->b0 & 1], (void *)(*(int *)hit[6] + 4));
                } else {
                    ((struct Parity *)((u8 *)state + 0x48))->b0++;
                    func_ov107_020c5af8((int)self, 0x15f, idle[((struct Parity *)((u8 *)state + 0x48))->b0 & 1], (void *)(*(int *)hit[6] + 4));
                }
            }
        }
    ...
    if (hit[6] == *(unsigned int *)(self + 0x3b4)) {
        if (*((u8 *)state + 0x4a + src[1]) == 0) {
            if ((short)hit[4] > 0) {
                func_ov107_020c5af8(*state, 0x15f, 5, (void *)(*(int *)hit[6] + 4));
            }
            hit[10] = 0;
