/*
 * func_ov268_020d174c -- x3 (ov208/209/268). AI-state tick: wind up, then face the target and reset.
...
extern void func_ov268_020d1814(void);

void func_ov268_020d174c(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov268_020d1814);
}
