...
extern void func_ov268_020d0f90(int *state, int kind, Sphere *sphere, void *box);
extern void func_0203c634(int *node, int slot, void *cb);

void func_ov268_020d233c(int *node)
{
    ...
    if (state[0xb] >= 0x1b28 && state[0xb] <= 0x1ee6) {
        if ((*((u8 *)state + 0x49) & 1) == 0) {
            func_ov107_020c5af8(*state, 0x15f, 6, (void *)(*(int *)(*state + 0x3c4) + 4));
            *((u8 *)state + 0x49) |= 1;
        }
        sphere = *(Sphere *)(*(int *)(*state + 0x3c4) + 0x68);
        sphere.radius = FX_MUL(sphere.radius, 0x1800);
        func_ov268_020d0f90(state, 0, &sphere, 0);
    }
    if (state[0xb] >= 0xded && state[0xb] <= 0x1199) {
        if ((*((u8 *)state + 0x49) & 2) == 0) {
            func_ov107_020c5af8(*state, 0x15f, 6, (void *)(*(int *)(*state + 0x3c8) + 4));
            *((u8 *)state + 0x49) |= 2;
        }
