/*
 * func_ov268_020d4320 -- x3. AI-state tick: wait a timer, flag, fire and push a fixed motion twice.
...
extern void func_ov268_020d4458(void);

void func_ov268_020d4320(int *self) {
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 1) << 0x18) >> 0x10);
    ...
    state[0x10] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov268_020d4458);
}
