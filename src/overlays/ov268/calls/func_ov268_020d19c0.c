/*
 * func_ov268_020d19c0 -- x3. AI-state tick: set the turn rate, aim/steer, transition once the timer
...
extern void func_ov268_020d1b04(void);

void func_ov268_020d19c0(int *self) {
    ...
    *(char *)(state[1] + 0xa8) = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov268_020d1b04);
}
