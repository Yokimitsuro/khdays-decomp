/*
 * func_ov268_020d1e8c -- x3 (ov208/209/268). AI-state tick: face the target and fire, branching the
...
extern int  func_ov268_020d0ea8(int obj, void *p);
...
extern void func_ov268_020d2164(void);
extern void func_ov268_020d202c(void);
extern short data_0203d210;

void func_ov268_020d1e8c(int *self) {
    ...
    target = func_ov268_020d0ea8(*state, 0);
    state[4] = target;
    if (target == 0) {
        *(char *)(*state + 0x1c7) = 2;
    ...
    *(char *)((int)state + 0x49) = 0;
    ...
    if (VEC_DotProduct(&dir, &v) >= 0xf00) {
        ...
        func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov268_020d2164);
        return;
    }
    func_ov107_020c9264(*state, 9, 0);
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov268_020d202c);
}
