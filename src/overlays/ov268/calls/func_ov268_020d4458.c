 ...
 * animation 2) and hands over to func_ov268_020d4780; otherwise the travelled length accumulates
...
extern void func_ov268_020d4780(int *node);

void func_ov268_020d4458(int *node)
{
    ...
    *(Vec3 *)(state + 9) = *(Vec3 *)state[2];
    if (func_01fff920(*(void **)(world + 0x7c), (Vec3 *)state[2], &delta) != 0) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov268_020d4780);
        return;
    }
