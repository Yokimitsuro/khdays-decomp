/*
 * func_ov268_020d0698 -- x3. Message handler: map the message kind through a 15-entry table and
...
extern void func_ov268_020d062c(int a, int b, int c, int d);
extern void func_0203c7ac(int a, int b);
extern struct t15 data_ov268_020d47c4;

void func_ov268_020d0698(int self, int kind, int arg3) {
    struct t15 table = data_ov268_020d47c4;

    func_ov268_020d062c(*(int *)(self + 0x384), func_ov107_020c9440(self, table.w[kind]), arg3,
                        self + 0x388);
