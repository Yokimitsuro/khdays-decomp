...
extern const struct tbl8 data_ov268_020d4818;

void func_ov268_020d096c(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov268_020d096c(newcenter, half, child, param_4,
