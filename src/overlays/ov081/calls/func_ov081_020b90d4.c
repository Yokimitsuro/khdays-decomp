...
extern void func_ov081_020b9304(Vec3 *origin, Vec3 *move);                     /* Ov042_LayTrail */
...
int func_ov081_020b90d4(char *group, char *part, void *arg)
{
    Vec3 vTo;
    Vec3 vStep;
    Vec3 vFrom;
    ...
    *(Vec3 *)(part + 0xcc) = vTo;
    func_ov081_020b9304(&vFrom, &vStep);
