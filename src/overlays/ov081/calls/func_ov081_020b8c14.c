...
extern void func_ov081_020b8d00(char *self);
extern char *data_ov081_020b96e0;
extern char data_ov081_020b9694[];

void func_ov081_020b8c14(void)
{
    char *self = data_ov081_020b96e0;
    ...
    *(int *)(self + 0x2c2c) = 0;
    ...
    for (i = 0; i < 7; i++) {
        func_0202a634(seq, data_ov081_020b9694, 1, *(u8 *)(self + 9) + 7);
        seq += sizeof(Ov042SeqSlot);
    }
    func_ov081_020b8d00(self);
}
