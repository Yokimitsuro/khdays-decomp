...
extern void func_ov091_020bb2e4(char *self);
extern void func_ov091_020bb490(char *self);
extern char *data_ov091_020bc240;

void *func_ov091_020bbdcc(char *self)
{
    int r;
    Vec3 d;
    Vec3 sample;
    Vec3 step;
    char *rig = data_ov091_020bc240 + 0xa4 + 0x2c00;
    void *next = 0;
    unsigned int *node;
    unsigned short a;
    ...
    if (*(int *)(self + 0x7b0) == 0) {
        if (*(int *)rig == 0) {
            func_ov091_020bb2e4(self);
        } else {
            func_ov091_020bb490(self);
        }
