/* Circle tick of the ov181 enemy (x4: ov181/182/183/184): the +0x20 step is 30 x dt / 20; the
 * closest target goes to +0x10 (none returns) and its surface distance (root minus both +0x80
 * radii) must be inside the actor's +0x2d8 range. The offset from the +4 position to the
...
void func_ov183_020d0ba4(int node)
{
