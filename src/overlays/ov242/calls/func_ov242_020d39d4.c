...
void func_ov242_020d39d4(char *self)
{
    struct Names names;
    int i;
    int *p;

    *(void **)(self + 0x8) = func_ov242_020d3c64;
    *(void **)(self + 0xc) = func_ov242_020d3ccc;
    *(void **)(self + 0x30) = func_ov242_020d3db0;
    *(void **)(self + 0x38) = func_ov242_020d3d44;
    *(void **)(self + 0x1dc) = func_ov242_020d3d14;
    ...
    *(char **)(*(int *)(*(int *)(self + 0x384) + 0x88) + 0x4c) = self;
    func_02014e18(*(int *)(*(int *)(self + 0x384) + 0x88) + 0x20, func_ov242_020d3844, 0, 6, 3);
    func_0203ca14((void *)(*(int *)(self + 0x384) + 4), 0, 0x200, 0);
    *(int *)(self + 0x39c) = func_ov107_020c9e50(func_ov107_020c9440((int)self, 1), data_ov242_020d4904);
    for (i = 0; i < 3; i++) {
