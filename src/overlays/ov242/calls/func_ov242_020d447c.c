...
void func_ov242_020d447c(int node)
{
    ...
    if ((unsigned int)func_02023eb4(0x64) < wp->uChance) {
        ...
        func_0203c634(node, *(signed char *)(node + 0x20), func_ov242_020d452c);
        return;
    }
    if (state[0xb] <= 0x100) {
        func_0203c634(node, *(signed char *)(node + 0x20), func_ov242_020d4608);
        return;
    }
    func_ov107_020c9264(*state, 0, 1);
    func_0203c634(node, *(signed char *)(node + 0x20), func_ov242_020d45d4);
}
