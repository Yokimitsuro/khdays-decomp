...
extern void func_ov071_020b92bc(char *self);
extern void func_ov071_020b9408(char *self);
extern int func_ov022_02095524(char *emitter);
extern char *data_ov071_020b9a60;

void *func_ov071_020b8cf0(char *self)
{
    int r;
    Vec3 sample;
    Vec3 step;
    void *next = 0;
    char *rig = data_ov071_020b9a60 + 0x2c + 0x2c00;
    unsigned int *node;
    ...
    if (*(int *)(rig + 4) == 0) {
        func_ov071_020b92bc(self);
    } else {
        func_ov071_020b9408(self);
    }
