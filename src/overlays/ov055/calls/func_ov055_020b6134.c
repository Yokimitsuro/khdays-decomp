...
extern void func_ov055_020b61b0(int p);
extern void func_ov055_020b62c4(int self, int p, int c);
extern int data_ov055_020b7740;

void func_ov055_020b6134(int self, int a, int b) {
    int base = *(int *)&data_ov055_020b7740 + 0x2d94;
    if (*(int *)(self + 0x6bc) == 0x2f &&
        (*(int *)(self + 0x7b0) == 0 || *(int *)(self + 0x7b0) == 0xc000)) {
        func_ov055_020b61b0(base + 0x14);
    }
    func_ov055_020b62c4(self, a + 0x14, b);
}
