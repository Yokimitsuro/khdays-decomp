/*
 * func_ov288_020d3d98 -- Ov287_Actor_SetSubStateAndNotify.
 *
 * Installed in the +0x1dc slot by func_ov288_020d3844, shared with ov288 and ov289. Does
...
void func_ov288_020d3d98(struct Actor *actor, int index, int on)
{
