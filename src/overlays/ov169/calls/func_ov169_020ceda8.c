 ...
 * runs the attack sweep (func_ov169_020ce424) with a query built from the +8 position raised by
...
extern void func_ov169_020ce424(int *state, int kind, struct Ov169SweepQuery *query);
extern void func_0203c634(int *node, int slot, void *cb);

void func_ov169_020ceda8(int *node)
{
    ...
    if (state[0x11] <= 0xbb0) {
        ...
        func_ov169_020ce424(state, 0, &query);
        return;
    }
