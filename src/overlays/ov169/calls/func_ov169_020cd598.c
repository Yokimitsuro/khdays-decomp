/* Hover-bob tick of the ov169 enemy (and its byte-identical twins), the func_ov178_020cd6e0 shape:
...
void func_ov169_020cd598(int node)
{
    ...
    func_01ffa724(0x240, &dir, (Vec3 *)(state + 8));
    state[9] = 0;
