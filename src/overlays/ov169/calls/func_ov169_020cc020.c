/* Constructor of the ov169 enemy (twins by byte identity). Installs the handlers (+8 release, +0xc
...
extern void func_ov169_020cc3b0(void);
extern void func_ov169_020cc650(void);
extern void func_ov169_020cc7e4(void);
extern void func_ov169_020cc620(void);
extern void func_ov169_020cca08(void);
extern void func_ov169_020cbfc4(void);
...
extern int *func_ov169_020ce1a8(char *self);
extern const Vec3 data_02041dc8;
extern IdTable data_ov169_020cee44;
extern char data_ov169_020cee6c[];
extern char data_ov169_020cee74[];

void func_ov169_020cc020(char *self)
{
    IdTable ids = data_ov169_020cee44;
    Bounds bounds;
    CameraWork work;
    Vec3 v;
    u16 hw;
    ...
    *(Callback *)(self + 0x2c) = func_ov169_020cc3b0;
    *(Callback *)(self + 0x34) = func_ov169_020cc650;
    *(Callback *)(self + 0x1d0) = func_ov169_020cc7e4;
    *(Callback *)(self + 0x1dc) = func_ov169_020cc620;
    *(Callback *)(self + 0x1e0) = func_ov169_020cca08;
    hw = *(u16 *)(self + 0x60);
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov169_020cbfc4;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(unsigned char *)(*(int *)(self + 0x384) + 0xad) = 0;
    *(int *)(self + 0x38c) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov169_020cee6c);
    *(int *)(self + 0x390) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov169_020cee6c);
    *(int *)(self + 0x394) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov169_020cee74);
    ...
    *(int **)(self + 0x3ac) = func_ov169_020ce1a8(self);
    func_0203355c(0x13f);
}
