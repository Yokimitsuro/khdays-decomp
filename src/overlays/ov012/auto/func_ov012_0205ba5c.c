/* func_ov012_0205ba5c -- MobiClip: initialise the decoder from the parsed stream header.
...
void func_ov012_0205ba5c(int ctx, unsigned short *dst, unsigned short *src) {
    int i;
