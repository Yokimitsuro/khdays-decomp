...
extern const Vec3 data_ov078_020ba270;               /* the plain anchor offset */
extern const Ov039SidePair data_ov078_020ba290;      /* the left/right anchor offsets */
extern short data_0203d210[];

void func_ov078_020b8f30(char *self, int side, Vec3 *out)
{
    Mtx33 mFacing;
    Vec3 vDefault;
    Ov039SidePair sides;
    ...
    vDefault = data_ov078_020ba270;
    sides = data_ov078_020ba290;

    if (*(int *)(data_ov078_020ba4e0 + 0x2000 + 0xcd4) == 0) {
        out->x = vDefault.x;
        out->y = vDefault.y;
        out->z = vDefault.z;
    } else {
