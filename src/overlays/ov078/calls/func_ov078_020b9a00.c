...
extern int func_ov078_020b9508(char *self);
extern int func_0203084c(void);
extern void func_ov078_020b9590(char *self);
...
void *func_ov078_020b9a00(char *self)
{
    int r;
    Vec3 sample;
    Vec3 step;
    ...
    if (*(int *)(rig + 8) == 0 && *(int *)(rig + 0x14) == 0 && *(int *)(self + 0x7b0) >= 0x9000) {
        ...
        if (fire != 0) {
            *(int *)(rig + 0x14) = func_ov078_020b9508(self);
            func_ov078_020b9590(self);
