...
extern void func_ov078_020b91b4(char *self);
extern char *data_ov078_020ba4e0;
extern char data_ov078_020ba4a8[];
extern Params data_ov078_020ba27c;

void func_ov078_020b8c10(char *self)
{
    Params p;
    char *base = data_ov078_020ba4e0;
    ...
    *(int *)(rig + 0x314) = 0x59a;
    ...
    slot = rig + 0x1c;
    for (i = 0; i < 2; i++) {
        func_0202a634((int)slot, data_ov078_020ba4a8, 1, *(u8 *)(base + 9) + 7);
        slot += 0x10c;
    }
    p = data_ov078_020ba27c;
    func_ov022_02092384((int)(self + 0x248 + 0x2400), *(u8 *)(self + 9), 5, &p);
    func_ov078_020b91b4(self);
}
