...
extern void func_ov078_020b986c(char *self, char *shot, int bCharged);          /* Ov039_FireStoredShot */

void func_ov078_020b9048(char *self, char *shot, int dt)
{
    Vec3 vMove;
    int speed;
    char *hit;
    ...
    *(int *)(shot + 4) += 1;
    ...
    func_ov078_020b986c(self, shot, bCharged);
    if (bCharged != 0) {
        *(int *)(shot + 8) = 0;
    }
}
