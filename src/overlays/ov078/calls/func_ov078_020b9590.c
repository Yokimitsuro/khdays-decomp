...
extern void func_ov078_020b8f30(char *self, int side, Vec3 *out);              /* Ov039_GetAttackAnchor */
extern void func_ov022_020ad208(char *self, int event, Vec3 *pos, int range, int angle, int flag);
extern char *data_ov078_020ba4e0;
extern const Ov039BandRow data_ov078_020ba2a8;      /* the single-anchor per-band flags */

void func_ov078_020b9590(char *self)
{
    Vec3 vAnchor;
    ...
    if (band >= 15) band = 0;
    if (*(int *)rig == 0) {
        Ov039BandRow single = data_ov078_020ba2a8;
        func_ov078_020b8f30(self, 0, &vAnchor);
    ...
    }
    {
        ...
        func_ov078_020b8f30(self, 1, &vAnchor);
