 ...
 */
extern void WM_EndKeySharing_0x020b8d60(char *self);
extern void func_ov078_020b8df8(char *chan, int which);
...
void func_ov078_020b8450(char *self, int mode) {
    int reached = -1;
    ...
    case 0:
        if (*(int *)(self + 0x6bc) != mode) {
            WM_EndKeySharing_0x020b8d60(self);
        }
        break;
    case 1:
        if (*(int *)(self + 0x6bc) != mode) {
            *(int *)rig = 0;
            *(int *)(rig + 0x10) = 0;
            func_ov078_020b8df8(rig + 0x18, 0);
    ...
    case 4:
        if (*(int *)(self + 0x6bc) != mode) {
            *(int *)rig = 1;
            *(int *)(rig + 0x10) = 0;
            func_ov078_020b8df8(rig + 0x18, 1);
            func_ov078_020b8df8(rig + 0x124, 2);
            if (*(unsigned char *)(self + 8) == func_02030788()
                && (*(int *)self & 0x10000) == 0) {
                func_ov002_0204cb70(func_ov022_02083f0c(), 10, 0);
            }
