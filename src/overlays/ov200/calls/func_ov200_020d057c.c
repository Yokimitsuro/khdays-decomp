/*
 * func_ov200_020d057c -- x3. AI-state entry: wire up the sub-nodes and their hit regions, register two
 * handlers. Mark bit1 of *(node+0x5c) on each sub-node state[1..4]. On the first sub-node state[1] also
 * install the physics callback func_ov200_020d02e4 at +0x6c and back-link the state at +0x84, then arm
...
extern void func_ov200_020d02e4(void);
extern void func_ov200_020d06a4(void);
extern void func_ov200_020d0764(void);

void func_ov200_020d057c(int *self) {
    int *state = (int *)self[1];

    *(int *)(state[1] + 0x5c) |= 2;
    *(int *)(state[1] + 0x6c) = (int)&func_ov200_020d02e4;
    ...
    *(int *)(state[4] + 0x5c) |= 2;
    ...
    func_0203c634((int)self, 0, (int)&func_ov200_020d06a4);
    func_0203c634((int)self, 1, (int)&func_ov200_020d0764);
}
