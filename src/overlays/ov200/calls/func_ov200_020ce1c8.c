 ...
 * two other (3) +0x390 parts (func_ov200_020d0508) and start reaction 0x157 mode 7 on the +0xa0 pose
...
extern void func_ov200_020d0508(int part, int on);
...
void func_ov200_020ce1c8(char *self, u8 *msg, int arg)
{
    ...
    if (msg[2] == 5) {
        ...
        case 7:
            ...
            break;
        case 1:
            func_ov200_020d0508(*(int *)(self + 0x390), 1);
        ...
        case 3:
            for (i = 1; i < 3; i++) {
                func_ov200_020d0508(((int *)(self + 0x390))[i], 1);
            }
            *(int *)(self + 0x3b0) = func_ov107_020cb040(self, 0x157, 7, 0, self + 0xa0);
            break;
        case 4:
            for (i = 1; i < 3; i++) {
                func_ov200_020d0508(((int *)(self + 0x390))[i], 0);
            }
            break;
        case 5:
