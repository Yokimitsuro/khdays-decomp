/*
 * func_ov200_020d1768 -- x3 (ov200/...). Reset the ring buffer to its idle state.
...
extern void func_ov200_020d1708(void);

void func_ov200_020d1768(int param1) {
    int *state = *(int **)(param1 + 4);
    int i;

    *(int *)(*state + 0x78) = (int)&func_ov200_020d1708;
