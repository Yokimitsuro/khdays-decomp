 ...
 * length on y, and the beam runs through func_ov200_020d0c94 with the length and mode 1. */
...
extern void func_ov200_020d0c94(int *node, int nLength, int mode);

void func_ov200_020d0ac4(int *self) {
    ...
    func_ov200_020d0c94(self, nLen, 1);
}
