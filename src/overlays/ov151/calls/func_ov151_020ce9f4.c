...
extern void func_ov151_020cc954(int item, void *from, void *placement);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_ov151_020cea90(void);

void func_ov151_020ce9f4(int *node)
{
    ...
    for (i = 0; i < 3; i++) {
        if ((((struct hw60 *)((*(int **)(*state + 0x3c8))[i] + 0x60))->lo & 1) == 0) {
            func_ov151_020cc954((*(int **)(*state + 0x3c8))[i], (void *)(*(int *)(*state + 0x394) + 0x14), (void *)(*state + 0xa0));
            state[0xe]++;
            break;
        }
    }
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov151_020cea90);
}
