...
extern void func_ov151_020cd3ac(void);
...
void func_ov151_020cd16c(int *node)
{
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov151_020cd3ac);
}
