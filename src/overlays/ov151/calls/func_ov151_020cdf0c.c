...
extern void func_ov151_020cdfd4(void);

void func_ov151_020cdf0c(int *node) {
    Vec3 delta;
    ...
    state[0x1] = target;
    if (target != 0) {
        VEC_Subtract((Vec3 *)(target + 0x74), (Vec3 *)state[0x11], &delta);
    ...
    func_0203c634(node, *(signed char *)(node + 8), func_ov151_020cdfd4);
}
