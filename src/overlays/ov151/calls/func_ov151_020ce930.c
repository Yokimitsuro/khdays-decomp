...
extern void func_ov151_020ce9f4(void);
void func_ov151_020ce930(int *node) {
    ...
    pp = buf;
    pp[1] = data_ov151_020cec34[5];
    pp[0] = data_ov151_020cec34[4];
    cb = *(void (**)())(*state + 0x24);
    ...
    *(signed char *)((char *)state + 0x4c) = 0;
    ...
    func_0203c634(node, *(signed char *)(node + 8), func_ov151_020ce9f4);
}
