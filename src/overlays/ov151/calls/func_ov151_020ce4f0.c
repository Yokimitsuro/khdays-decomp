 ...
 * hands the canned 4-byte event record data_ov151_020cec34[1] to the owner's
...
extern u16 data_ov151_020cec34[4];
extern void func_ov151_020ce5a4(void);

void func_ov151_020ce4f0(Ov149Node *node)
{
    ...
    pp = buf;
    {
        char *src = (char *)data_ov151_020cec34;
        u16 high = *(u16 *)(src + 6);
        u16 low = *(u16 *)(src + 4);
