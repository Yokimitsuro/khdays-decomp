...
extern void func_ov151_020cc7f8(void);
extern void func_ov151_020cc934(void);
void func_ov151_020cc864(int *node) {
    void *cb = (void *)func_ov151_020cc7f8;
    ...
    *(unsigned int *)(state[1] + 0x5c) &= ~2;
    func_0203c634(node, *(signed char *)(node + 8), func_ov151_020cc934);
}
