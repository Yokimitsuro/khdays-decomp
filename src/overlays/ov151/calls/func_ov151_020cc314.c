 ...
 * and handing the collected list to func_ov151_020cc714. */
...
extern void func_ov107_020c5af8(struct Ov151Self *self, int id, int kind,
                                struct Ov151Vec3 *at);
extern int func_ov151_020cc714(struct Ov151Self *self, short *ids);
extern void func_ov107_020c7500(struct Ov151Self *self, struct Ov151Cmd *cmd, int arg2);

void func_ov151_020cc314(struct Ov151Self *self, struct Ov151Cmd *cmd, int arg2)
{
    ...
    if (cmd->type02 == 0x5) {
        ...
        case 0: {
            ...
            self->pSlots390->field04 = func_ov151_020cc714(self, ids);
            break;
        }
        }
    }
