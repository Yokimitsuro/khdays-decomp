...
extern void func_ov151_020cc864(void);
extern void func_ov151_020cc90c(void);
int func_ov151_020cc714(int param_1, int param_2) {
    int *local_28;
    int iVar1 = func_0203c5c0(*(int *)(param_1 + 0x3c), 0x64, 0x48,
                              func_ov151_020cc864, func_ov151_020cc90c, &local_28);
    int iVar5 = 0;
    *local_28 = param_1;
