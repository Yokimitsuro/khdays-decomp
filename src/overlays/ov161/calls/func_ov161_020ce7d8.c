/* func_ov161_020ce7d8: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern const struct Msg data_ov161_020cf2aa;
extern void func_ov161_020ce9a4(void);

void func_ov161_020ce7d8(struct Node *node)
{
    struct State *st;
    struct Msg msg;
    FxVec raw;
    ...
    *(u8 *)(st->pActor + 0x1c5) &= ~0xf;
    ...
    st->nField4c = 0;
    st->nField50 = 0;
    func_ov107_020c5af8(st->pActor, 0x152, 6, st->nParam44);
    func_0203c634(node, node->bSlot, (void *)func_ov161_020ce9a4);
}
