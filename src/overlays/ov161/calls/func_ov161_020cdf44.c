/* func_ov161_020cdf44: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern const struct Msg data_ov161_020cf28e;
extern void func_ov161_020ce3dc(void);

void func_ov161_020cdf44(struct Node *node)
{
    struct State *st;
    FxVec vFwd;
    FxVec vToTarget;
    ...
    func_0203c634(node, node->bSlot, (void *)func_ov161_020ce3dc);
}
