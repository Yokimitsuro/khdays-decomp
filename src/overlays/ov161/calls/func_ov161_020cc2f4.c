/* func_ov161_020cc2f4: spawn-message handler of the ov161 enemy (x2), variant of the matched ov163 sibling (sub 3 uses entry 6 with weight 0x2000; sub 4 also attaches entry 4 to the +0x394 placement, spawns the +0x2c child and registers effect 0x152 mode 7 into +0x3d4). */
/* func_ov161_020cc2f4: ported from a matched sibling family (same shape, constants and offsets adjusted). */
extern int func_ov161_020cc7e0(int, int, int, int);
...
extern int func_ov161_020cc5f4(int, int, int, int);
extern int func_ov107_020c09a0(int, int, int, int, int, int);
extern int func_ov161_020cc9dc(int);
extern void func_ov107_020c7500(int, int, int);
void func_ov161_020cc2f4(int param_1, int param_2, int param_3, int param_4) {
    int result;
    if (*(unsigned char *)(param_2 + 2) == 0x5) {
        switch (*(unsigned char *)(param_2 + 3)) {
        case 0:
            if (*(int *)(*(int *)(param_1 + 0x3c4) + 4) == 0) {
                result = func_ov161_020cc7e0(param_1, *(int *)(*(int *)(param_1 + 0x3c4) + 4),
                                             param_3, param_4);
        ...
        case 3:
            ...
            *(int *)(*(int *)(param_1 + 0x3c4) + 0x1c) = result;
            ...
            break;
        case 4:
            result = func_ov161_020cc5f4(param_1, *(unsigned char *)(param_2 + 3), param_3, param_4);
            ...
            *(int *)(*(int *)(param_1 + 0x3c4) + 0x14) = result;
            result = func_ov161_020cc9dc(param_1);
