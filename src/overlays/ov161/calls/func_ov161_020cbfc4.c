/* func_ov161_020cbfc4: ported from a matched sibling family (same shape, constants and offsets adjusted). */
struct v5 { int w[6]; };
struct v3 { int a, b, c; };
...
extern void func_ov161_020cc214(void), func_ov161_020cc25c(void), func_ov161_020cc280(void);
extern void func_ov161_020cc2f4(void), func_ov161_020ccde4(void), func_ov161_020cc4ac(void);
extern void func_ov161_020cce40(void), func_ov161_020cd0f0(void), func_ov161_020cc47c(void);
...
void func_ov161_020cbfc4(int param_1) {
    struct v5 tbl;
    struct { struct v3 t; int scale; } g;
    int i;
    long long r;
    tbl = data_ov161_020cf260;
    *(void **)(param_1 + 8) = func_ov161_020cc214;
    *(void **)(param_1 + 0xc) = func_ov161_020cc25c;
    *(void **)(param_1 + 0x10) = func_ov161_020cc280;
    *(void **)(param_1 + 0x1c) = func_ov161_020cc2f4;
    *(void **)(param_1 + 0x30) = func_ov161_020ccde4;
    *(void **)(param_1 + 0x34) = func_ov161_020cc4ac;
    *(void **)(param_1 + 0x1d0) = func_ov161_020cce40;
    *(void **)(param_1 + 0x1e0) = func_ov161_020cd0f0;
    *(void **)(param_1 + 0x1dc) = func_ov161_020cc47c;
    ...
    *(void **)(param_1 + 0x390) = func_0203bee8(*(int *)(param_1 + 0x384), 1, data_ov161_020cf2ec);
    *(void **)(param_1 + 0x3c0) = func_0203bee8(*(int *)(param_1 + 0x384), 1, data_ov161_020cf2f8);
    *(void **)(param_1 + 0x3c8) = func_ov107_020c9e50(func_ov107_020c9440(param_1, 1), &data_ov161_020cf304);
