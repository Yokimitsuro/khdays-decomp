/* func_ov161_020cc4ac: release hook of the ov161 enemy (x2), variant of the matched ov131 sibling with a third task slot (+0x2c) and attachment (+0x3d4) finished outside sub-state 7. */
...
void func_ov161_020cc4ac(char *actor) {
