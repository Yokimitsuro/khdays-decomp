...
extern void func_ov076_020b8be8(void);
extern void func_ov076_020b8fe4(void);

void *func_ov076_020b86d8(char *self, int msg) {
    char *blk = data_ov076_020b9d00 + 0x2c + 0x2c00;
    void *next = 0;
    Vec3 d;
    unsigned short a;
    int *node;
    ...
    case 0x21:
        *(int *)(blk + 0x110) = 0;
        ...
        next = (void *)&func_ov076_020b8be8;
        break;
    case 0x22:
        next = (void *)&func_ov076_020b8fe4;
