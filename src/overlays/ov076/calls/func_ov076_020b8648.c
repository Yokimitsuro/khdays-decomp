...
extern char data_ov076_020b9cb0[];
extern char data_ov076_020b9cc0[];

u8 func_ov076_020b8648(char *self)
{
    char *rig = data_ov076_020b9d00 + 0x2c + 0x2c00;
    char *block = self + 0x2f8 + 0x2000;

    block[0x334] = 0;
    func_ov022_020b15b0(*(u8 *)(self + 9), 2);
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov076_020b9cb0, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov076_020b9cc0, *(u8 *)(self + 9), 1, rig + 4);
