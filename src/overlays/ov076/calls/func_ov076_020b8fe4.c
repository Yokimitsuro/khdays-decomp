...
extern void func_ov076_020b95dc(char *self);
extern void func_ov076_020b9954(char *self);

void *func_ov076_020b8fe4(char *self)
{
    int r;
    Vec3 sample;
    Vec3 step;
    ...
    if (*(int *)(self + 0x7b0) >= 0x36000) {
        func_ov076_020b9954(self);
    } else {
        func_ov076_020b95dc(self);
    }
