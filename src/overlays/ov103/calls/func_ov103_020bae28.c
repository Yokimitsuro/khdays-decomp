...
u8 func_ov103_020bae28(char *self)
{
    ...
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov103_020bc09c, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov103_020bc0ac, *(u8 *)(self + 9), 1, rig + 0xc);
    *(u8 **)(block + 0x348) = func_ov022_020b14a4(data_ov103_020bc0c0, *(u8 *)(self + 9), 2, rig + 0x24c);
