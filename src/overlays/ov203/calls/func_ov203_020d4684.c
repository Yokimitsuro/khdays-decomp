/* func_ov203_020d4684: motion tick of the ov202 enemy (x2), variant of the matched ov163 sibling: the +0xc angle only advances while the actor's +0x1c4 bit 1 is clear. */
...
void func_ov203_020d4684(Obj *obj)
{
