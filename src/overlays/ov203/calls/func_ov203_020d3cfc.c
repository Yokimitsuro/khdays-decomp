/* func_ov203_020d3cfc: release hook of the ov202 enemy (x2: ov202/203), variant of the matched ov131 sibling: the sub-state-dependent task finishes come first (slots +0x3dc, attachment +0x410), then both item transforms are refreshed from the +0x3d8 item. */
...
void func_ov203_020d3cfc(char *actor) {
