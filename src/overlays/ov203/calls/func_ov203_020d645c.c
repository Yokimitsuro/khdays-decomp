...
extern void func_ov203_020d6404(void);
extern void func_ov203_020d6544(void);

void func_ov203_020d645c(int *node) {
    int *state = (int *)node[1];
    state[1] = *(int *)(*(int *)(*state + 0x3dc) + 0x20);
    *(void **)(state[1] + 0x6c) = func_ov203_020d6404;
    ...
    *(int *)(state[1] + 0x5c) &= ~2;
    ...
    state[2] = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov203_020d6544);
}
