/* func_ov203_020d5934: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern const struct Msg data_ov203_020d6816;
extern void func_ov203_020d5b00(void);

void func_ov203_020d5934(struct Node *node)
{
    struct State *st;
    struct Msg msg;
    FxVec raw;
    ...
    *(u16 *)(st->pActor + 0x1ae) |= 1;
    ((struct Comp388 *)*(void **)(st->pActor + 0x38c))->bLow &= ~1;
    *(u8 *)(st->pActor + 0x1c5) &= ~0xf;

    msg = data_ov203_020d6816;
    ...
    st->nField4c = 0;
    st->nField50 = 0;
    func_ov107_020c5af8(st->pActor, 0x156, 6, st->nParam44);
    func_0203c634(node, node->bSlot, (void *)func_ov203_020d5b00);
}
