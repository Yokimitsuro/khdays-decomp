/* func_ov203_020d5b00: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern int func_ov203_020d3e08(void *world, struct Sphere *shape, void **out);
...
extern const struct Msg data_ov203_020d67ec;
extern const struct Msg data_ov203_020d6808;
...
void func_ov203_020d5b00(struct Node *node)
{
    struct State *st;
    void *world;
    void *aVictims[4];
    ...
    nHits = func_ov203_020d3e08(*(void **)((char *)world + 0x7c), &shape, aChildren);
    i = 0;
    if (nHits > 0) {
        do {
