/* func_ov203_020d40ec: hit handler of the ov202 enemy (x2: ov202/203), variant of the matched ov131 sibling with the health always dropping and the state one word shorter. */
...
int func_ov203_020d40ec(char *actor, int source, struct HitMsg *msg)
{
    struct HitState *hs;
    int state;
    int left;
