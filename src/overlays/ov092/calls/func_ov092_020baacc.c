...
extern void WM_EndKeySharing_0x020baec8(int self);
extern void func_ov092_020bc108(int self);
...
void func_ov092_020baacc(int self, int mode) {
    int base = data_ov092_020bc4e0;
    int flag;
    int ret;

    switch (mode) {
    case 0x2e:
        if (*(int *)(self + 0x6bc) != mode) { WM_EndKeySharing_0x020baec8(self); }
        break;
    case 0x2f:
    case 0x30:
        break;
    }
    if (*(int *)(self + 0x6bc) != mode) { func_ov092_020bc108(self); }
