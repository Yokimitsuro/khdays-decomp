/* func_ov092_020ba844 -- overlay boot of the ov036 enemy (x4: ov036/054/074/091): the ov042 shape (see
...
void func_ov092_020ba844(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov092_020bc408, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov092_020bc41c, 1, cfg[0] + 7);
    }
    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov092_020baacc;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov092_020bab98;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov092_020bac24;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov092_020baa38;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov092_020baaa4;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov092_020bace4;
    *(void **)(obj + 0x664 + 0x1c) = (void *)&func_ov092_020bc264;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov092_020bad8c;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov092_020bb7fc;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov092_020bc3a8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov092_020bc3b8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov092_020bc3c8) : -1;
    if (cfg[3] != 0) {
        *(long long *)obj |= 0x20;
    }
    if (cfg[4] != 0) {
