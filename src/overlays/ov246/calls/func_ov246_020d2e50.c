 ...
 * data_ov246_020d3108) is cast against the collision owner (+4 -> +0x7c); hitting nothing sets
 ...
 * the drop tick func_ov246_020d2f4c runs once before it takes the slot. */
...
extern void func_ov246_020d2f4c(int *node);
extern Vec3 data_ov246_020d3108;

void func_ov246_020d2e50(int *node)
{
    ...
    *(int *)(state[3] + 0x5c) &= ~2;
    ...
    func_ov107_020c5af8(*state, 0x158, 7, state + 4);
    state[0xa] = 0x400;
    *(unsigned char *)((char *)state + 0x30) = 0;
    func_ov246_020d2f4c(node);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov246_020d2f4c);
}
