/* func_ov246_020d16b0 -- set the follow-up delay, and if the counter allows, commit the move.
 ...
 * Otherwise a 2-field descriptor is built from data_ov246_020d30e0 and passed to the owner's own
 ...
 * the action dispatched with func_ov246_020d178c.
 *
...
extern void func_ov246_020d178c(void);
extern unsigned short data_ov246_020d30e0[];

void func_ov246_020d16b0(int self) {
    int *ctx;
    Ov137_Desc d;
    Ov137_Desc *p;
    ...
    p = &d;
    d.b = data_ov246_020d30e0[1];
    d.a = data_ov246_020d30e0[0];
    ...
    *(unsigned char *)((char *)ctx + 0x54) = 0;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov246_020d178c);
}
