...
extern void func_ov246_020d16b0(void);
void func_ov246_020d15ec(int self) {
    int obj = *(int *)(self + 4);
    int buf[3];
    *(int *)(obj + 8) = func_ov107_020cab14(*(int *)obj, 0);
    ...
    VEC_Subtract((void *)(*(int *)(obj + 8) + 0x190), *(void **)(obj + 0x4c), buf);
    buf[1] = 0;
    func_01ff8d18(buf, buf, 0);
    *(int *)(obj + 0x10) = func_020050b4(buf[0], buf[2]);
    *(int *)(obj + 0x14) = *(int *)(*(int *)self + 0x2c) * 30 / 5;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov246_020d16b0);
}
