...
extern void func_ov246_020d2584(int *state);
...
void func_ov246_020d216c(int *node)
{
        ...
        if (n > 0) {
            do {
                if (func_ov107_020ca918(results[i], *state, *(int *)(*state + 0x38c), 1, state + 2, 0) != 0) {
                    func_ov246_020d2584(state);
                    func_ov107_020c5af8(*(int *)(*state + 0x38c), 0x158, 7, (void *)state[1]);
                    *(u8 *)(*state + 0x1c7) = 0;
