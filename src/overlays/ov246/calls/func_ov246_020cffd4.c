 ...
 * (kind 0x15, c0794) there; 4 builds pair 4 through func_ov246_020d268c from pairs 6 and 5.
...
extern int func_ov246_020d268c(char *self, int item, int a, int b);
extern void func_ov107_020c7500(char *self, u8 *cmd, void *arg3);

void func_ov246_020cffd4(char *self, u8 *cmd, void *arg3)
{
    if (cmd[2] == 5) {
        switch (cmd[3]) {
        case 0:
        ...
        case 4:
            (*(struct Ov246Pair **)(self + 0x390))[4].pChild =
                func_ov246_020d268c(self, (*(struct Ov246Pair **)(self + 0x390))[4].pItem,
