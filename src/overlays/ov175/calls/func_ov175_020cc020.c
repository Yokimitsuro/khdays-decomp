...
extern void func_ov175_020cc33c(void);
extern void WM_EndKeySharing_ov175_0x020cc37c(void);
extern void func_ov175_020cc3d8(void);
extern void func_ov175_020cc75c(void);
extern void func_ov175_020cc388(void);
extern void func_ov175_020cc3b0(void);
extern void func_ov175_020cc624(void);
extern void func_ov175_020cc7b8(void);
extern void func_ov175_020cc5f4(void);
extern void func_ov175_020cca70(void);
extern void func_ov175_020cbfc4(void);
...
extern int *func_ov175_020ce210(char *self);
extern Vec3 data_02041dc8;
extern IdTable data_ov175_020cea78;
extern char data_ov175_020ceaac[];
extern char data_ov175_020ceab4[];

void func_ov175_020cc020(char *self)
{
    IdTable ids = data_ov175_020cea78;
    Bounds bounds;
    CameraWork work;
    Vec3 v;
    u16 hw;
    ...
    *(Callback *)(self + 0x8) = func_ov175_020cc33c;
    *(Callback *)(self + 0xc) = WM_EndKeySharing_ov175_0x020cc37c;
    *(Callback *)(self + 0x1c) = func_ov175_020cc3d8;
    *(Callback *)(self + 0x30) = func_ov175_020cc75c;
    *(Callback *)(self + 0x28) = func_ov175_020cc388;
    *(Callback *)(self + 0x2c) = func_ov175_020cc3b0;
    *(Callback *)(self + 0x34) = func_ov175_020cc624;
    *(Callback *)(self + 0x1d0) = func_ov175_020cc7b8;
    *(Callback *)(self + 0x1dc) = func_ov175_020cc5f4;
    *(Callback *)(self + 0x1e0) = func_ov175_020cca70;
    bounds.w[0] = -0x1000;
    bounds.w[2] = -0x1000;
    bounds.w[1] = 0;
    bounds.w[3] = 0x1000;
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov175_020cbfc4;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(unsigned char *)(*(int *)(self + 0x384) + 0xad) = 0;
    *(int *)(self + 0x38c) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov175_020ceaac);
    *(int *)(self + 0x390) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov175_020ceaac);
    *(int *)(self + 0x394) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov175_020ceab4);
    ...
    *(int **)(self + 0x3ac) = func_ov175_020ce210(self);
    func_0203355c(0x142);
}
