/* Message handler of the ov175 enemy (and its byte-identical twins). A "spawned" message (kind 5) carries
...
void func_ov175_020cc3d8(int owner, unsigned char *command, int arg)
{
        ...
        case 8:
            ...
            case 1:
                *(int *)(owner + command[4] * 4 + 0x3a0) = func_ov107_020cb040(owner, 0x114, 8, 0, (void *)(owner + 0xa0));
                break;
            case 2:
                *(int *)(owner + command[4] * 4 + 0x3a0) = func_ov107_020cb040(owner, 0x142, 4, 0, (void *)(owner + 0xa0));
                break;
            }
            break;
        }
