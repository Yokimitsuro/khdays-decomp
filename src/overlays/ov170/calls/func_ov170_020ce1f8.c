/* func_ov170_020ce1f8: spawn-message handler of the ov169 enemy (x2), variant of the matched ov166 sibling with an extra sub 7 (entry 6 from the transform) and effect 0x13f. */
 ...
 * sub 8 registers effect 0x114 (kind 7 or 8 by the message's +4 slot) or effect 0x13f (kind 4)
...
void func_ov170_020ce1f8(int owner, unsigned char *command, int arg)
{
        ...
        case 8:
            ...
            case 1:
                *(int *)(owner + command[4] * 4 + 0x3a0) = func_ov107_020cb040(owner, 0x114, 8, 0, (void *)(owner + 0xa0));
                break;
            case 2:
                *(int *)(owner + command[4] * 4 + 0x3a0) = func_ov107_020cb040(owner, 0x13f, 4, 0, (void *)(owner + 0xa0));
                break;
            }
            break;
        }
