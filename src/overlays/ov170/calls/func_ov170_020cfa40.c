/* Hover-hold tick of the ov169 enemy (and its byte-identical twins). With +0x88 clear the +0x24 height
...
extern void func_ov170_020cff88(int subitem, Vec3 *from, Vec3 *dir);
extern void func_0203c634(int node, int slot, void *cb);
extern int data_02042264;
extern struct vec3 data_02041dc8;

void func_ov170_020cfa40(int node)
{
    int target;
    ...
    if ((*(unsigned char *)((char *)state + 0x84) & 1) == 0 && state[0x12] >= 0x2200) {
    ...
    if ((*(unsigned char *)((char *)state + 0x84) & 2) == 0 && state[0x12] >= 0x3a70) {
        for (i = 0; i < 1; i++) {
            ...
            if ((((struct hw60 *)(sub + 0x60))->lo & 1) == 0) {
                func_ov170_020cff88(sub, (Vec3 *)(*(int *)(*state + 0x390) + 0x14), &dir);
                break;
            }
        }
