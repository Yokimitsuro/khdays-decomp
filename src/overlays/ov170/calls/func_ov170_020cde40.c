...
extern void func_ov170_020ce1d0(void);
extern void func_ov170_020ce470(void);
extern void func_ov170_020ce604(void);
extern void func_ov170_020ce440(void);
extern void func_ov170_020ce828(void);
extern void func_ov170_020cdde4(void);
...
void func_ov170_020cde40(char *self)
{
    ...
    *(Callback *)(self + 0x2c) = func_ov170_020ce1d0;
    *(Callback *)(self + 0x34) = func_ov170_020ce470;
    *(Callback *)(self + 0x1d0) = func_ov170_020ce604;
    *(Callback *)(self + 0x1dc) = func_ov170_020ce440;
    *(Callback *)(self + 0x1e0) = func_ov170_020ce828;
    hw = *(u16 *)(self + 0x60);
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov170_020cdde4;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(unsigned char *)(*(int *)(self + 0x384) + 0xad) = 0;
    *(int *)(self + 0x38c) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov170_020d0c8c);
    *(int *)(self + 0x390) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov170_020d0c8c);
    *(int *)(self + 0x394) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov170_020d0c94);
    ...
    *(int **)(self + 0x3ac) = func_ov170_020cffc8(self);
    func_0203355c(0x13f);
}
