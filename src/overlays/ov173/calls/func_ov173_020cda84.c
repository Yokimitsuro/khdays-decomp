/* func_ov173_020cda84: circle tick of the ov173 enemy (x2), variant of the matched ov175 sibling (pull 0x300 capped, height steps of 0xc0, rolls 9 or 5). */
/*
...
extern int func_ov173_020ccad4(int self, void *out);
...
void func_ov173_020cda84(int *self) {
    ...
    mag = func_ov173_020ccad4((int)self, v1);
    if (mag > 0x100) {
        mag = 0x300;
    }
