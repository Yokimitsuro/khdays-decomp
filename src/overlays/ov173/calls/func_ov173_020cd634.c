/* func_ov173_020cd634: hover-bob tick of the ov173 enemy (x2), variant of the matched ov166 sibling (0x480 pull, period rand(0x15)+0x14, height 0x1800, bob by the sign of the sine). */
...
void func_ov173_020cd634(int node)
{
