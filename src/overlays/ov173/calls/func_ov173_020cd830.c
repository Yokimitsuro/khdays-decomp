...
extern int func_ov173_020ccb6c(int node);
extern int data_02042264;

void func_ov173_020cd830(int node)
{
    ...
    func_01ffa724(0x600, &d, (Vec3 *)(state + 8));
    if (state[0x22] != 0) {
        height = state[6];
    } else {
    ...
    if (dist > 0x3000 && func_02023eb4(3) == 0) {
        if ((unsigned int)func_02023eb4(100) < 0x23 && func_ov173_020ccb6c(node) != 0) {
