...
extern void func_ov173_020ce36c(void);
...
void func_ov173_020ce300(int *this, int p2, int p3, int p4)
{
    int *node = (int *)this[1];
    ...
    *(signed char *)((int)node + 0x84) = 0;
    func_0203c634((int)this, *(signed char *)((int)this + 0x20), (int)&func_ov173_020ce36c);
}
