...
extern void func_ov173_020cc330(void);
extern void WM_EndKeySharing_0x020cc370(void);
extern void func_ov173_020cc394(void);
extern void func_ov173_020cc76c(void);
extern void WM_EndKeySharing_ov173_0x020cc37c(void);
extern void WM_EndKeySharing_0x020cc388(void);
extern void func_ov173_020cc60c(void);
extern void func_ov173_020cc7c8(void);
extern void func_ov173_020cc5dc(void);
extern void func_ov173_020ccaa8(void);
extern void func_ov173_020cbfc4(void);
...
void func_ov173_020cc020(char *self)
{
    ...
    bounds.w[4] = 0x1000;
    bounds.w[5] = 0x1000;
    *(Callback *)(self + 0x8) = func_ov173_020cc330;
    *(Callback *)(self + 0xc) = WM_EndKeySharing_0x020cc370;
    *(Callback *)(self + 0x1c) = func_ov173_020cc394;
    *(Callback *)(self + 0x30) = func_ov173_020cc76c;
    *(Callback *)(self + 0x28) = WM_EndKeySharing_ov173_0x020cc37c;
    *(Callback *)(self + 0x2c) = WM_EndKeySharing_0x020cc388;
    *(Callback *)(self + 0x34) = func_ov173_020cc60c;
    *(Callback *)(self + 0x1d0) = func_ov173_020cc7c8;
    *(Callback *)(self + 0x1dc) = func_ov173_020cc5dc;
    *(Callback *)(self + 0x1e0) = func_ov173_020ccaa8;
    hw = *(u16 *)(self + 0x60);
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov173_020cbfc4;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(unsigned char *)(*(int *)(self + 0x384) + 0xad) = 0;
    *(int *)(self + 0x38c) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov173_020ceccc);
    *(int *)(self + 0x390) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov173_020ceccc);
    *(int *)(self + 0x394) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov173_020cecd4);
