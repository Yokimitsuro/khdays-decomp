 ...
 * animation 8 plays (looping) and the state advances to func_ov173_020ce7ac. */
...
extern void func_ov173_020ce7ac(void);

void func_ov173_020ce66c(int *node)
{
    ...
    *(Vec3 *)(state + 8) = *(Vec3 *)(state + 0xb);
    ...
    if (*(unsigned char *)(state[1] + 0xad) == 0) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov173_020ce7ac);
    }
}
