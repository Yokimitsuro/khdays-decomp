/* func_ov173_020cc394: spawn-message handler of the ov173 enemy (x2), variant of the matched ov166 sibling: subs 2/4 start entry 2 from the transform (two separate bodies, laid out 3-4-2-5), sub 3 fixes entries 6 and 4 to the +0x38c/+0x390 placements, sub 5 starts entry 0, and sub 8 registers effect 0x141 (modes 4/5; kind 2 is an empty case). */
/* Message handler of the ov173 enemy (x3: ov173/167/168). A "spawned" message (kind 5) carries
...
void func_ov173_020cc394(int owner, unsigned char *command, int arg)
{
    ...
    if (command[2] == 5) {
        ...
        switch (command[3]) {
        case 3:
            (*(int **)(owner + 0x39c))[7] = func_ov107_020c09a0(*(int *)(owner + 0x3c), (*(int **)(owner + 0x39c))[6], 7, (void *)(*(int *)(owner + 0x38c) + 4), 0, 0);
            (*(int **)(owner + 0x39c))[5] = func_ov107_020c09a0(*(int *)(owner + 0x3c), (*(int **)(owner + 0x39c))[4], 7, (void *)(*(int *)(owner + 0x390) + 4), 0, 0);
            break;
        case 4:
        ...
        case 2:
            ...
            break;
        case 5:
            (*(int **)(owner + 0x39c))[1] = func_ov107_020c0794(*(int *)(owner + 0x3c), (*(int **)(owner + 0x39c))[0], 7, 0, &transform);
            break;
        case 8:
            switch (command[4]) {
            case 0:
                *(int *)(owner + command[4] * 4 + 0x3a0) = func_ov107_020cb040(owner, 0x141, 4, 0, (void *)(owner + 0xa0));
                break;
            case 1:
                *(int *)(owner + command[4] * 4 + 0x3a0) = func_ov107_020cb040(owner, 0x141, 5, 0, (void *)(owner + 0xa0));
                break;
            case 2:
                break;
            }
