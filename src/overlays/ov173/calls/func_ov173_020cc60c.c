/* Tick handler of the ov173 enemy (x2: ov173/174), variant of the matched ov178 sibling (task slots +0x14/+0x1c outside sub-state 9). If flagged (+0x1c4 & 0xa) and idle
...
void func_ov173_020cc60c(int self)
{
    int i;
    ...
    if (*(signed char *)(self + 0x1c6) != 9) {
        if (*(int *)(*(int *)(self + 0x39c) + 0x14) != 0) {
            func_0203c650(*(int *)(self + 0x3c), *(int *)(*(int *)(self + 0x39c) + 0x14));
            *(int *)(*(int *)(self + 0x39c) + 0x14) = 0;
        }
