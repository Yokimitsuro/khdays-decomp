...
extern void func_ov033_020b43dc(char *self);
extern void func_ov033_020b4528(char *self);
extern int func_ov022_02095524(char *emitter);
extern char *data_ov033_020b4b80;

void *func_ov033_020b3e10(char *self)
{
    int r;
    Vec3 sample;
    Vec3 step;
    void *next = 0;
    char *rig = data_ov033_020b4b80 + 0x2c + 0x2c00;
    unsigned int *node;
    ...
    if (*(int *)(rig + 4) == 0) {
        func_ov033_020b43dc(self);
    } else {
        func_ov033_020b4528(self);
    }
