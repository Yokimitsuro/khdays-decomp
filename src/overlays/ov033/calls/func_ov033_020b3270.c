/* func_ov033_020b3270 -- overlay boot of the ov033 enemy (x4: ov033/051/071/089): the ov042 shape (see
...
extern void func_ov033_020b364c(void);
extern void func_ov033_020b3710(void);
extern void func_ov033_020b38e0(void);
extern void func_ov033_020b34ac(void);
extern void func_ov033_020b34e4(void);
extern void func_ov033_020b3970(void);
extern void func_ov033_020b350c(void);
extern void func_ov033_020b3abc(void);
...
void func_ov033_020b3270(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov033_020b4b14, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov033_020b4b28, 1, cfg[0] + 7);
    }
    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov033_020b364c;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov033_020b3710;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov033_020b38e0;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov033_020b34ac;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov033_020b34e4;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov033_020b3970;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov033_020b350c;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov033_020b3abc;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov033_020b4aa8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov033_020b4ac8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x514) = b != 0 ? func_02016f10((void *)b, &data_ov033_020b4ab8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov033_020b4ae8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov033_020b4ad8) : -1;
    if (cfg[3] != 0) {
        *(long long *)obj |= 0x20;
    }
    if (cfg[4] != 0) {
