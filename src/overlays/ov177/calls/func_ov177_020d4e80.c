/* Hover-bob tick of the ov175 enemy (and its byte-identical twins), the func_ov178_020cd6e0 shape:
...
extern int func_ov177_020d431c(int node, Vec3 *out);
extern void func_01ffa724(int scale, const Vec3 *v, Vec3 *out);
extern int func_02023eb4(int bound);
extern int func_02020400(int a, int b);
extern short data_0203d210[];

void func_ov177_020d4e80(int node)
{
    ...
    dist = func_ov177_020d431c(node, &dir);
