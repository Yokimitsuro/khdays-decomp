...
extern void func_ov177_020d3c30(void);
extern void func_ov177_020d3ea4(void);
extern void func_ov177_020d4038(void);
extern void func_ov177_020d3e74(void);
extern void func_ov177_020d42f0(void);
extern void func_ov177_020d3844(void);
...
extern int *func_ov177_020d5a90(char *self);
...
void func_ov177_020d38a0(char *self)
{
    ...
    *(Callback *)(self + 0x8) = func_ov177_020d3bbc;
    *(Callback *)(self + 0xc) = WM_EndKeySharing_ov177_0x020d3bfc;
    *(Callback *)(self + 0x1c) = func_ov177_020d3c58;
    *(Callback *)(self + 0x30) = func_ov177_020d3fdc;
    *(Callback *)(self + 0x28) = func_ov177_020d3c08;
    *(Callback *)(self + 0x2c) = func_ov177_020d3c30;
    *(Callback *)(self + 0x34) = func_ov177_020d3ea4;
    *(Callback *)(self + 0x1d0) = func_ov177_020d4038;
    *(Callback *)(self + 0x1dc) = func_ov177_020d3e74;
    *(Callback *)(self + 0x1e0) = func_ov177_020d42f0;
    bounds.w[0] = -0x1000;
    bounds.w[2] = -0x1000;
    bounds.w[1] = 0;
    bounds.w[3] = 0x1000;
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov177_020d3844;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(unsigned char *)(*(int *)(self + 0x384) + 0xad) = 0;
    *(int *)(self + 0x38c) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov177_020d632c);
    *(int *)(self + 0x390) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov177_020d632c);
    *(int *)(self + 0x394) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov177_020d6334);
    ...
    *(int **)(self + 0x3ac) = func_ov177_020d5a90(self);
    func_0203355c(0x142);
}
