...
extern void func_ov172_020cfff8(void);
extern void func_ov172_020d0268(void);
extern void func_ov172_020d03fc(void);
extern void func_ov172_020d0238(void);
extern void func_ov172_020d061c(void);
extern void func_ov172_020cfc04(void);
...
extern int *func_ov172_020d1d48(char *self);
...
void func_ov172_020cfc60(char *self)
{
    IdTable ids = data_ov172_020d2aec;
    Bounds bounds;
    CameraWork work;
    Vec3 v;
    u16 hw;
    ...
    *(Callback *)(self + 0x2c) = func_ov172_020cfff8;
    *(Callback *)(self + 0x34) = func_ov172_020d0268;
    *(Callback *)(self + 0x1d0) = func_ov172_020d03fc;
    *(Callback *)(self + 0x1dc) = func_ov172_020d0238;
    *(Callback *)(self + 0x1e0) = func_ov172_020d061c;
    bounds.w[0] = -0x1000;
    bounds.w[2] = -0x1000;
    bounds.w[1] = 0;
    bounds.w[3] = 0x1000;
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov172_020cfc04;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(unsigned char *)(*(int *)(self + 0x384) + 0xad) = 0;
    *(int *)(self + 0x38c) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov172_020d2b0c);
    *(int *)(self + 0x390) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov172_020d2b0c);
    *(int *)(self + 0x394) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov172_020d2b14);
    ...
    *(int **)(self + 0x3ac) = func_ov172_020d1d48(self);
    func_0203355c(0x140);
}
