/* func_ov172_020d1344: hover-approach tick of the ov171 enemy (x2), variant of the matched ov175 sibling (0x200 then x0x1a00 speed, height 0x20c5, leaves beyond 0x6000). */
/* Hover-approach tick of the ov171 enemy (and its byte-identical twins): acquires a target (+0xc; none
...
extern int func_ov172_020d06e0(int node);
extern int data_02042264;

void func_ov172_020d1344(int node)
{
    ...
    func_01ffa724(0x200, &dir, (Vec3 *)(state + 8));
    func_01ffa724(0x1a00, (Vec3 *)(state + 8), (Vec3 *)(state + 8));
    h = state[0x22] != 0 ? state[6] : *(int *)(state[3] + 0x78) + 0x20c5;
    diff = h - *(int *)(state[2] + 4);
    state[9] += (int)(((long long)(diff / 30) * 0x1000 + 0x800) >> 12);
    if (dist > 0x6000 && func_02023eb4(3) == 0) {
        if (func_ov172_020d06e0(node) != 0) {
