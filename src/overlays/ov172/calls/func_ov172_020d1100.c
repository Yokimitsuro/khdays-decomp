/* func_ov172_020d1100: hover-bob tick of the ov171 enemy (x2), variant of the matched ov175 sibling (0x180 pull, height 0x15d9, bob by sin/2, ends below 0x4000). */
...
void func_ov172_020d1100(int node)
{
