...
extern void func_ov172_020d200c(int scene, VecFx32 *pos, int actor);
...
void func_ov172_020d2954(int *node)
{
    ...
    if ((*(u64 *)((char *)state[3] + 0x464) & 0x8000) != 0) {
        ...
        func_ov172_020d200c(scene, &drop, *(int *)(*state + 0x38c) + 0x74);
        func_ov172_020d200c(scene, &at, (int)(state + 4));
