/* func_ov172_020d1d7c: sub-item constructor of the ov171 enemy (x2), variant of the matched ov175 sibling (four handlers, latch 0x64c). */
...
extern void func_ov172_020d1ed4(void);
extern void func_ov172_020d1ef0(void);
extern void func_ov172_020d1fb0(void);
extern void func_ov172_020d1f28(void);

void func_ov172_020d1d7c(Ov169Object *self) {
    int owner = self->owner_038c;
    u16 v;

    self->callback_0008 = func_ov172_020d1ed4;
    self->callback_000c = func_ov172_020d1ef0;
    self->callback_0030 = func_ov172_020d1fb0;
    self->callback_01d0 = func_ov172_020d1f28;
    v = self->flags_0060;
    self->flags_0060 =
