/* Volley tick of the ov277 enemy. Once the owner's +0x420 phase reaches 4 the overlay's end message
...
void func_ov277_020d05b4(int *node)
{
    ...
    Quat spin;
    Quat base;
    Counts counts = data_ov277_020d36bc.counts;
    long i;
    int k;
    int sign;

    if (((struct Phase *)(*state + 0x420))->n >= 4) {
        Msg4 msg = data_ov277_020d36bc.msgEnd;
    ...
    if (*((unsigned char *)state + 9) == 0 && state[7] >= 0x2555) {
        *((unsigned char *)state + 9) = 1;
        ...
        for (i = 0; i < 6; i++) {
            ...
            func_ov277_020cd3f0(((int *)*(int *)(*state + 0x404))[i], (Vec3 *)(*(int *)(*state + 0x3b0) + 0x14), &spin);
            if (++k == counts.c[*(short *)(state + 5)]) {
                break;
            }
        }
        func_ov107_020c5af8(*state, 0x165, 0xe, (void *)(*(int *)(*state + 0x3b0) + 0x14));
    }
    if (state[7] <= 0x555) {
        return;
    }
    ...
    *(short *)(state + 5) += 1;
    if (*(short *)(state + 5) == 4) {
        ...
        pp = note;
        pp[1] = data_ov277_020d36bc.msgDone.arg;
        pp[0] = data_ov277_020d36bc.msgDone.id;
        if (*(MsgHook *)(*state + 0x24) != 0) {
            (*(MsgHook *)(*state + 0x24))(*state, (Msg4 *)pp, 4);
        }
        func_ov107_020c9264(*state, 9, 0);
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov277_020d08a4);
        return;
    }
    {
        u16 note[2];
        ...
        pp = note;
        pp[1] = data_ov277_020d36bc.msgNext.arg;
        pp[0] = data_ov277_020d36bc.msgNext.id;
        if (*(MsgHook *)(*state + 0x24) != 0) {
            (*(MsgHook *)(*state + 0x24))(*state, (Msg4 *)pp, 4);
        }
    }
