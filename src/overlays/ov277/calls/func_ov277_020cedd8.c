...
extern void func_ov277_020ced3c(void);
extern void func_ov277_020ceeb4(void);
extern void func_ov277_020ceeb8(void);

void func_ov277_020cedd8(int param_1) {
    int *node = *(int **)(param_1 + 4);
    *(int *)(node[1] + 0x5c) &= ~2;
    *(void **)(node[1] + 0x6c) = (void *)&func_ov277_020ced3c;
    *(int **)(node[1] + 0x84) = node;
    ...
    node[2] = 0;
    func_0203c634(param_1, 2, &func_ov277_020ceeb4);
    func_0203c634(param_1, *(signed char *)((char *)param_1 + 0x20), &func_ov277_020ceeb8);
}
