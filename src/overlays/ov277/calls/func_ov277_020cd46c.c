 ...
 * enabled and it is reset (c7ac); the three poses of data_ov277_020d3668 build the +0x3a4 pair
...
extern const struct PoseIds data_ov277_020d3668;
extern void func_ov277_020cd64c(void);
extern void func_ov277_020cd68c(void);
extern void func_ov277_020cd6c4(void);
extern void func_ov277_020cd7f8(void);
extern void func_ov277_020cd7ac(void);
...
void func_ov277_020cd46c(struct Obj *self)
{
    struct PoseIds ids = data_ov277_020d3668;
    unsigned int flags;
    int i;

    self->fn08 = func_ov277_020cd64c;
    self->fn0c = func_ov277_020cd68c;
    self->fn1c = func_ov277_020cd6c4;
    self->fn30 = func_ov277_020cd7f8;
    self->fn1d0 = func_ov277_020cd7ac;
