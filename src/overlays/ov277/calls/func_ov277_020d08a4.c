/* Once the low nibble of the actor's +0x420 word reaches 4, the cue at data_ov277_020d36bc
...
void func_ov277_020d08a4(int *node) {
    ...
    if (((struct Nib420 *)(actor + 0x420))->lo >= 4) {
        pp = pair;
        pp[1] = data_ov277_020d36bc[7];
        pp[0] = data_ov277_020d36bc[6];
        cb = *(void (**)())(*state + 0x24);
