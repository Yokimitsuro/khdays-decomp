...
extern void func_ov277_020cc6fc(void);
extern void func_ov277_020cc794(void);
extern void func_ov277_020cc8a4(void);
extern void func_ov277_020ccbc4(void);
extern void func_ov277_020ccc70(void);
extern void func_ov277_020cf698(void);
extern void func_ov277_020cccec(void);
extern void func_ov277_020cd170(void);
...
extern int func_ov277_020d1544(void *list);
extern int func_ov277_020cd438(char *self);
extern int func_ov277_020d0c3c(char *self);
...
void func_ov277_020cbfc8(char *self)
{
    ...
    *(Callback *)(self + 0x8) = func_ov277_020cc6fc;
    *(Callback *)(self + 0xc) = func_ov277_020cc794;
    *(Callback *)(self + 0x1c) = func_ov277_020cc8a4;
    *(Callback *)(self + 0x28) = func_ov277_020ccbc4;
    *(Callback *)(self + 0x2c) = func_ov277_020ccc70;
    *(Callback *)(self + 0x30) = func_ov277_020cf698;
    *(Callback *)(self + 0x34) = func_ov277_020cccec;
    *(Callback *)(self + 0x38) = func_ov277_020cd170;
    ...
    *(int *)(self + 0x3a8) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov277_020d376c);
    *(int *)(self + 0x3ac) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov277_020d377c);
    *(int *)(self + 0x3b0) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov277_020d3788);
    *(int *)(self + 0x3b4) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov277_020d3794);
    *(int *)(self + 0x3b8) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov277_020d37a4);
    *(int *)(self + 0x3bc) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov277_020d37ac);
    *(int *)(self + 0x3c0) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov277_020d37b8);
    *(int *)(self + 0x3c4) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov277_020d37cc);
    *(int *)(self + 0x3c8) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov277_020d37dc);
    *(int *)(self + 0x3cc) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov277_020d37ec);
    *(int *)(self + 0x3d0) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov277_020d37fc);
    *(int *)(self + 0x3d4) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov277_020d3810);
    *(int *)(self + 0x3d8) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov277_020d3820);
    *(int *)(self + 0x3dc) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov277_020d3830);
    ...
    *(int *)(self + 0x40c) = func_0203d15c(0x40);
    ...
    func_ov107_020c2f94(0x56, self + 0x424);
    *(int *)(self + 0x400) = func_0203d15c(8);
    for (i = 0; i < 2; i++) {
        (*(int **)(self + 0x400))[i] = func_ov277_020d1544(self + 0x424);
    }
    *(int *)(self + 0x404) = func_0203d15c(0x18);
    for (i = 0; i < 6; i++) {
        (*(int **)(self + 0x404))[i] = func_ov277_020cd438(self);
    }
    *(int *)(self + 0x408) = func_0203d15c(0x10);
    for (i = 0; i < 4; i++) {
        (*(int **)(self + 0x408))[i] = func_ov277_020d0c3c(self);
    }
    zero = data_02041dc8;
    cap.pos = zero;
