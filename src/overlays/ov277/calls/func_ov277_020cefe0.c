...
extern void func_ov277_020cf104(void);
extern void func_ov277_020cf068(void);
int func_ov277_020cefe0(int param_1, int owner) {
    int *entry;
    int spawn = func_0203c5c0(*(int *)(param_1 + 0x3c), 100, 0xc,
                              &func_ov277_020cf068, &func_ov277_020cf104, &entry);
    entry[0] = param_1;
    entry[1] = owner;
