...
extern void func_ov277_020cec40(void);
extern void func_ov277_020ceba8(void);
extern void func_ov277_020ce8c4(void);
extern const char data_ov277_020d3840[];

int func_ov277_020ce7e0(int actor, int owner)
{
    int *entry;
    struct vec at;
    int r = func_0203c5c0(*(int *)(actor + 0x3c), 100, 0x14,
                          &func_ov277_020ceba8, &func_ov277_020cec40, &entry);
    entry[1] = actor;
    entry[0] = owner;
    if (*(int *)(entry[1] + 0x50) == 1) {
        *(void **)(entry[0] + 0x74) = (void *)&func_ov277_020ce8c4;
