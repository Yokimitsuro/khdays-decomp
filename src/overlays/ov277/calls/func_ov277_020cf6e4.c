...
int func_ov277_020cf6e4(char *self, int src, unsigned int *hit)
{
    ...
    if ((int)hit[10] > 0) {
        if (!((((struct HitWord *)hit)->lo & 8) != 0 && (((struct HitWord *)hit)->lo & 0x80) != 0 && ((struct HitWord *)hit)->hi == 0x80)) {
            if ((((struct HitWord *)hit)->lo & 0x22) != 0) {
                ...
                func_ov107_020c5af8(self, 0x165, (((struct Parity *)((u8 *)state + 8))->b0 & 1) ? 2 : 3, at);
            } else {
                ((struct Parity *)((u8 *)state + 8))->b0++;
                func_ov107_020c5af8(self, 0x165, (((struct Parity *)((u8 *)state + 8))->b0 & 1) ? 0 : 1, at);
            }
        }
    }
