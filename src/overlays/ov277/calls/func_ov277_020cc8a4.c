/* Message handler of the ov277 enemy (x2 with ov277). A "spawned" message (kind 5) is dispatched on
 * its sub-kind through the +0x40c effect table: 0 starts the 020ce414 entry into slot 1, attaches
 * effects 0x13 / 0x17 at the +0x3cc bone into slots 3 / 5 and registers effect 0x165 (kind 0xa)
 * at the +0x3c8 bone into +0x490; 1 does the same with 020ce7d8 into slot 7, the attachments
 * flagged and effect 0x165 kind 4 into +0x494; 2 starts slot 0xe (mode 0x17, weight 1.0) into 0xf
 ...
 * bit; 6 registers effect 0x165 (kind 0xd) at the +0x3b0 prop into +0x498; 7 starts 020cf010 into
...
extern int func_ov277_020ce41c(char *self, int item);
extern int func_ov277_020ce7e0(char *self, int item);
extern int func_ov277_020ced84(char *self, int item);
extern int func_ov277_020cefe0(char *self, int item);
extern int func_ov277_020cf428(char *self, int item);
...
void func_ov277_020cc8a4(char *self, unsigned char *msg, int param)
{
    u8 payload[9];
    FxVec vAt;
    char *anchor;
    ...
    if (msg[2] == 5) {
        switch (msg[3]) {
        case 0:
            (*(int **)(self + 0x40c))[1] = func_ov277_020ce41c(self, (*(int **)(self + 0x40c))[0]);
            ...
            *(int *)(self + 0x490) = func_ov107_020cb040(self, 0x165, 0xa, 0, (void *)(*(int *)(self + 0x3c8) + 4));
            break;
        case 1:
            (*(int **)(self + 0x40c))[7] = func_ov277_020ce7e0(self, (*(int **)(self + 0x40c))[6]);
            ...
            *(int *)(self + 0x494) = func_ov107_020cb040(self, 0x165, 4, 0, (void *)(*(int *)(self + 0x3c8) + 4));
            break;
        case 2:
        ...
        case 3:
            *(int *)(self + 0x420) &= ~0x10;
            (*(int **)(self + 0x40c))[0xb] = func_ov277_020ced84(self, (*(int **)(self + 0x40c))[0xa]);
            break;
        case 4:
            *(int *)(self + 0x420) |= 0x10;
            break;
        case 6:
            *(int *)(self + 0x498) = func_ov107_020cb040(self, 0x165, 0xd, 0, (void *)(*(int *)(self + 0x3b0) + 4));
            break;
        case 7:
            (*(int **)(self + 0x40c))[0xd] = func_ov277_020cefe0(self, (*(int **)(self + 0x40c))[0xc]);
            (*(int **)(self + 0x40c))[7] = func_ov277_020cf428(self, (*(int **)(self + 0x40c))[6]);
            break;
        }
    }
