 ...
 * sub-items of data_ov277_020d370c into the +0x38c pair table. */
...
extern IdTable3 data_ov277_020d370c;

void func_ov277_020d0c70(char *self)
{
    IdTable3 ids = data_ov277_020d370c;
    u16 hw;
    int i;
