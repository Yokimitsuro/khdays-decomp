...
extern void func_ov277_020cd904(void);
extern void func_ov277_020cd9c8(void);
extern void func_ov277_020cd998(void);

void func_ov277_020cd844(int self) {
    int *obj = *(int **)(self + 4);
    int zero;
    obj[7] = *obj + 0xb0;
    ...
    *(u16 *)(*obj + 0x100 + 0xae) &= ~1;
    func_0203c634(self, 0, &func_ov277_020cd904);
    func_0203c634(self, 1, &func_ov277_020cd9c8);
    func_0203c634(self, 2, &func_ov277_020cd998);
}
