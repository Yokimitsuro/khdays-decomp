...
extern char *func_ov277_020cd300(char *actor);
extern void func_ov277_020d0c0c(int part, struct Vec3 *at);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_ov277_020d0bac(void);

void func_ov277_020d0aa8(int *node) {
    ...
    if (state[7] > 0x1800) {
        for (i = 0; i < 4; i++) {
            ...
            if ((((struct Hw60 *)(part + 0x60))->lo & 1) == 0) {
                char *mate = func_ov277_020cd300((char *)*state);
                at.x = *(int *)(mate + 0x190);
                at.y = *(int *)(mate + 0x194) + 0xa000;
                at.z = *(int *)(mate + 0x198);
                func_ov277_020d0c0c(((int *)*(int *)(*state + 0x408))[i], &at);
    ...
    *(unsigned char *)(*(int *)(*state + 0x384) + 0xa8) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov277_020d0bac);
}
