/* Swing callback of the ov277 enemy's arm (twin of ce8c4): between frames 4.55 and 5.72 of the event
...
extern const PosMsg data_ov277_020d36ae;
...
void func_ov277_020cf13c(char *self, struct SwingEvent *ev)
{
    Mtx43 mtx;
    int hits[4];
    Vec3 tip;
