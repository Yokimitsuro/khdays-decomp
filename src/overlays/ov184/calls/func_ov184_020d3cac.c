...
extern void func_ov184_020d4008(void);
struct hw60 { unsigned short lo : 8, hi : 8; };

void func_ov184_020d3cac(int node)
{
    ...
    *(Vec3 *)(state + 0x15) = *(Vec3 *)(state + 0x1e);
    ...
    if (state[7] > 0x100 && ((struct Flags17a *)(*state + 0x17a))->bit0) {
        ...
        func_0203c634(node, *(signed char *)(node + 0x20), func_ov184_020d4008);
        return;
    }
