 ...
 * +0x1ae, clear bit 0 of the status word at +8 of the component at +0x38c, zero the field at
...
extern void func_ov239_020cda74(void);

struct LowByte32 { unsigned bits : 8; };

void func_ov239_020cd9a0(int *node) {
    ...
    *(unsigned short *)(state[0] + 0x1ae) |= 1;
    ...
    func_ov107_020c0b90(state[0], 2, *(VecFx32 *)(state[0] + 0x74), 0);
    func_ov107_020c5af8(state[0], 0x138, 0xb, state[0] + 0x74);
    state[0xb] = 0;
    func_0203c634(node, *(signed char *)((int)node + 0x20), func_ov239_020cda74);
}
