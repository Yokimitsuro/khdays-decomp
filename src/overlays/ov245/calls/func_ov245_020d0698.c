/* func_ov245_020d0698 -- finish entry (variant): clears bit 0 then raises bits 1, 2 and 7 of the
...
void func_ov245_020d0698(int *node) {
    ...
    *(u16 *)(*state + 0x100 + 0xae) |= 3;
    ...
    func_ov107_020c0b90(*state, 1, *(Vec3 *)(*state + 0x74), 0);
