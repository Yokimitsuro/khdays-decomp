/*
 * func_ov245_020d37b0 -- x3. Node update entry: fire an optional callback, tick, forward.
...
extern void func_ov245_020d3ce8(int p, int arg2);

void func_ov245_020d37b0(int self, int arg2) {
    int *s = (int *)self;
    ...
    if (s[0x14] == 1) {
        func_ov245_020d3ce8(s[0x85], arg2);
    }
}
