 ...
 * and if the owner is in state 1 (+0x50), forward param_3 to func_ov245_020d0af0. */
extern void func_ov107_020c5c54(int a, int b);
extern void func_0203c7ac(int a, int b);
extern void func_ov245_020d0af0(int *a, void *b);
void func_ov245_020d0794(int param_1, int param_2, void *param_3, int param_4) {
    ...
    if (*(int *)(param_1 + 0x50) == 1) {
        func_ov245_020d0af0(*(int **)(param_1 + 0x214), param_3);
    }
}
