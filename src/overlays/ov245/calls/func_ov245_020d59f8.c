/* func_ov245_020d59f8 -- bind a motion: resets the actor's +0x3a8 track (0202a440), refreshes the
...
void func_ov245_020d59f8(int self, int index, int flag) {
    struct Ov245Model *model = *(struct Ov245Model **)(*(int *)(self + 0x384) + 0x88);

    func_0202a440((void *)(self + 0x3a8));
    func_02014b5c(model->anim, model->pool78);
    func_0202a388((void *)(self + 0x3a8), model, func_ov107_020c9440(*(int *)(self + 0x3cc), index + 0x27), 0xc);
