/* func_ov162_020cec60: hit handler of the ov161 enemy (x2), ported from the matched ov131 sibling; the health always drops here and a kind-4 hit keeps the stored impact point. */
...
int func_ov162_020cec60(char *actor, int source, struct HitMsg *msg)
{
    struct HitState *hs;
    int state;
    int left;
