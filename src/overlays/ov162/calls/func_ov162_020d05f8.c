/* func_ov162_020d05f8: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern const struct Msg data_ov162_020d10ca;
extern void func_ov162_020d07c4(void);

void func_ov162_020d05f8(struct Node *node)
{
    struct State *st;
    struct Msg msg;
    FxVec raw;
    ...
    *(u8 *)(st->pActor + 0x1c5) &= ~0xf;
    ...
    func_0203c634(node, node->bSlot, (void *)func_ov162_020d07c4);
}
