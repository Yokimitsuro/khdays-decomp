/* func_ov162_020d07c4: throw-release tick of the ov161 enemy (x2), ported from the matched ov202 sibling (radius = timer * 4 + 0x800, pushes raised to 0x1000, kind bit 0x20000, +0x60 bit 7 set at the end). */
/* func_ov162_020d07c4: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern int func_ov162_020ce970(void *world, struct Sphere *shape, void **out);
...
void func_ov162_020d07c4(struct Node *node)
{
    struct State *st;
    void *world;
    void *aVictims[4];
    ...
    nHits = func_ov162_020ce970(*(void **)((char *)world + 0x7c), &shape, aChildren);
    i = 0;
    if (nHits > 0) {
        do {
