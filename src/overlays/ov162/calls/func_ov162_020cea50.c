...
extern const struct tbl8 data_ov162_020d10d8;

void func_ov162_020cea50(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov162_020cea50(newcenter, half, child, param_4,
