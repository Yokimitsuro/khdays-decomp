/* func_ov038_020b327c -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov038_020b34f0(void);
extern void WM_EndKeySharing_0x020b360c(void);
extern void func_ov038_020b3758(void);
extern void func_ov038_020b3490(void);
extern void func_ov038_020b34c8(void);
extern void func_ov038_020b3618(void);
extern void func_ov038_020b3790(void);
extern void func_ov038_020b472c(void);
...
void func_ov038_020b327c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov038_020b4be8, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov038_020b4bfc, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov038_020b34f0;
    *(void **)(obj + 0x664 + 0x04) = (void *)&WM_EndKeySharing_0x020b360c;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov038_020b3758;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov038_020b3490;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov038_020b34c8;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov038_020b3618;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov038_020b3790;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov038_020b472c;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov038_020b4b7c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov038_020b4b6c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov038_020b4b5c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov038_020b4b4c) : -1;
