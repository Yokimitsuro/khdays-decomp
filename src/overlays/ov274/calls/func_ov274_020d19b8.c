/*
 * func_ov274_020d19b8 -- x4 (ov206/207/274/275). AI-state tick: acquire the target, wind up, then
...
extern void func_ov274_020d1a98(void);

void func_ov274_020d19b8(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov274_020d1a98);
}
