...
extern void func_ov274_020d0900(void);
extern void func_ov274_020d087c(void);
extern void func_ov274_020d07b8(void);
int func_ov274_020d0800(int param_1) {
    int *entry;
    int spawn = func_0203c5c0(*(int *)(param_1 + 0x3c), 100, 8,
                              &func_ov274_020d087c, &func_ov274_020d0900, &entry);
    entry[0] = param_1;
    entry[1] = **(int **)(*entry + 0x3e0);
    *(int *)(entry[1] + 0x6c) = (int)&func_ov274_020d07b8;
