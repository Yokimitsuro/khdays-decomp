...
extern const struct tbl8 data_ov274_020d4280;

void func_ov274_020d0b34(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov274_020d0b34(newcenter, half, child, param_4,
