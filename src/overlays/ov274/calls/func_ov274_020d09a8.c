/* Ov274_WaitNotStaggered -- state step of the ov274-family enemy: unless the owner's +0x310 state is
...
extern void func_ov274_020d0a34(int node);

void func_ov274_020d09a8(int node)
{
    ...
    if (nState != 4 && nState != 3) {
        ...
        func_0203c634(node, *(signed char *)(node + 0x20), (void *)&func_ov274_020d0a34);
        return;
    }
}
