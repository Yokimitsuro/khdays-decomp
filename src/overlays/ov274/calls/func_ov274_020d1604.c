/* func_ov274_020d1604 -- accumulate time and, once past the threshold, re-face and hand on.
 ...
 * dispatched with func_ov274_020d16cc.
 *
...
extern void func_ov274_020d16cc(void);

void func_ov274_020d1604(int self) {
    int *ctx;
    Vec3 v;
    int target;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov274_020d16cc);
}
