 ...
 * func_ov274_020d2464); otherwise the +0x20 step counter fires reaction 0x163 mode 4 at 5 and
...
extern void func_ov274_020d2464(int *node);

void func_ov274_020d20b4(int *node)
{
    ...
    if (state->nHits52 >= 4) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov274_020d2464);
        return;
    }
    state->nStep++;
    if (state->nStep == 5) {
