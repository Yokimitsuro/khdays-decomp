/* func_ov274_020d1f68 -- reset the tuning, quiesce the owner and queue the effect, then hand on.
 ...
 * func_0203c634 with func_ov274_020d2000 as the continuation. */
...
extern void func_ov274_020d2000(void);
extern Vec3 data_02041dc8;
extern unsigned short data_ov274_020d41ec[];

void func_ov274_020d1f68(int self) {
    int *ctx;
    ...
    *(unsigned char *)((char *)ctx + 0x52) = 0;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov274_020d2000);
}
