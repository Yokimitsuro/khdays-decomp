...
extern void func_ov100_020bbc70(Vec3 *src, Vec3 *out);
extern void func_ov100_020bbbd0(char *self, char *rig, Vec3 *src);
extern short data_0203d210[];
extern OffsetTable data_ov100_020bc04c;

void func_ov100_020bba24(char *self, int dt)
{
    OffsetTable table;
    Vec3 out;
    Mtx33 m;
    ...
    *(int *)(rig + 0x10c) += 1;
    ...
    func_ov100_020bbc70(&out, &out);
    func_ov100_020bbbd0(self, rig, &out);
}
