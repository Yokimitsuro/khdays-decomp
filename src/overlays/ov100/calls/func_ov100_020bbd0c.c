...
extern void func_ov100_020bbf08(void);
extern void func_ov100_020bbea0(void);
extern int data_ov100_020bc1a8;

void func_ov100_020bbd0c(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x30);
    ...
    func_ov022_02091298(*(void **)(self + 0x2000 + 0x644), self,
                        &data_ov100_020bc1a8, cfg, 2, 10);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) = (void *)&func_ov100_020bbf08;
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x24) = (void *)&func_ov100_020bbea0;
}
