/* func_ov100_020ba838 -- overlay boot of the ov045 enemy (x4: ov045/064/083/100): the ov042 shape (see
...
extern void func_ov100_020bac24(void);
extern void func_ov100_020bad00(void);
extern void func_ov100_020bb08c(void);
extern void func_ov100_020baa20(void);
extern void func_ov100_020babb8(void);
extern void func_ov100_020bb0dc(void);
extern void func_ov100_020bb144(void);
extern void func_ov100_020bb1cc(void);
...
void func_ov100_020ba838(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov100_020bc148, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov100_020bc15c, 1, cfg[0] + 7);
    }
    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov100_020bac24;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov100_020bad00;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov100_020bb08c;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov100_020baa20;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov100_020babb8;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov100_020bb0dc;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov100_020bb144;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov100_020bb1cc;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov100_020bc02c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov100_020bc01c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov100_020bc03c) : -1;
    if (cfg[3] != 0) {
        *(long long *)obj |= 0x20;
    }
    if (cfg[4] != 0) {
