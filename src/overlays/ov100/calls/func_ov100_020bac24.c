 ...
 */
extern void func_ov100_020bbe54(int self);
extern void func_ov100_020bb768(int self, char *p);
...
void func_ov100_020bac24(int self, int mode) {
    int flag;
    int ret;

    switch (mode) {
    case 0x2e:
        if (mode != *(int *)(self + 0x6bc)) { func_ov100_020bbe54(self); }
        break;
    case 0x2f:
    case 0x30:
        if (mode != *(int *)(self + 0x6bc)) {
            func_ov100_020bb768(self, (char *)(self + 0x2df0));
        }
        break;
    }
