 ...
 */
extern void func_ov104_020bb4bc(int self);
extern void func_ov104_020bb0cc(int self, char *p);
...
void func_ov104_020bacc8(int self, int mode) {
    int p = self + 0x2cfc;
    int kind = -1;
    int arg = 0;
    int i;
    ...
    switch (mode) {
    case 0x2e:
        if (mode != *(int *)(self + 0x6bc)) { func_ov104_020bb4bc(self); }
        break;
    case 0x2f:
    case 0x30:
        *(int *)(p + 0x118) = (mode == 0x30);
        if (mode != *(int *)(self + 0x6bc)) { func_ov104_020bb0cc(self, (char *)p); }
        break;
    }
