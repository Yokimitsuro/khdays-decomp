...
extern void func_ov104_020bb8a4(Vec3 *src, Vec3 *out);
extern void func_ov104_020bb81c(char *self, char *rig, Vec3 *src);
extern short data_0203d210[];
extern OffsetTable data_ov104_020bc0f8;
extern char *data_ov104_020bc2a0;

void func_ov104_020bb664(char *self, int dt)
{
    OffsetTable table;
    Vec3 out;
    Mtx33 m;
    ...
    *(int *)(rig + 0x110) += 1;
    ...
    func_ov104_020bb8a4(&out, &out);
    func_ov104_020bb81c(self, rig, &out);
}
