 ...
 * the tracking step (func_ov221_020d132c) ends the state when negative, otherwise the +0x3fc
...
extern int func_ov221_020d132c(int *node, int arg);
...
void func_ov221_020d3368(int *node)
{
