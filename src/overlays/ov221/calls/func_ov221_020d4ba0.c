/*
 * func_ov221_020d4ba0 -- x4 (ov221/222/224/225). AI-state tick: drive a spin/lunge along a matrix.
...
extern void func_ov221_020d4950(int self, int a, int b);
extern int  data_02042258;

void func_ov221_020d4ba0(int *self) {
    ...
    func_ov221_020d4950((int)self, 1, 1);
}
