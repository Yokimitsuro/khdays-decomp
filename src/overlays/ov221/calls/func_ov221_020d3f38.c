 ...
 * `rest` is never read, and leaves `mode` in r1. Its sibling func_ov221_020d43a0 has the same
...
void func_ov221_020d3f38(int self, int mode, int rest, ...) {
    int m;
    void (*notify)(int, int);
    ...
    *(int *)(self + 0x38c) = 1;
    ...
    func_ov221_020d43a0(*(int *)(self + 0x214), m, va_at(rest, 0xc), va_at(rest, 0x18));
}
