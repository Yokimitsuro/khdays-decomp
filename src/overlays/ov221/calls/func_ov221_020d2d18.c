 ...
 * the tick hands over to func_ov221_020d2f94. */
...
extern int func_ov221_020d132c(int *node, Vec3 *dir);
...
extern void func_ov221_020d2f94(int *node);

void func_ov221_020d2d18(int *node)
{
    ...
    if (func_ov221_020d132c(node, 0) < 0) {
    ...
    if ((*(u8 *)((char *)state + 0x75) & 1) == 0) {
        if ((state[0x1e] != 0 && state[0x17] >= 0x1320) || (state[0x1e] == 0 && state[0x17] >= 0x1100)) {
            func_ov107_020c5af8(*state, 0x12a, state[0x1e] != 0 ? 0xa : 0xb, (void *)state[2]);
            if (state[0x1e] == 0) {
                func_ov107_020c5af8(*state, 0x12a, 5, (void *)state[2]);
            }
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov221_020d2f94);
}
