...
extern void func_ov221_020d2930(int *node);

void func_ov221_020d2888(int *node)
{
    ...
    *(unsigned char *)((char *)state + 0x75) = 0;
    state[0x17] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov221_020d2930);
}
