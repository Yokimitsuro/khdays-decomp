 ...
 * centre goes out as the mode-0 message (func_ov221_020d4498), reaction 0x12a
...
int func_ov221_020d44e0(int *node, Sphere *sphere)
{
        ...
        do {
            ...
            if ((*(unsigned char *)((char *)state + 0x64) & bit) == 0) {
                ...
                if (func_ov107_020ca918(hits[i], *state, *(int *)(*state + 0x390), state[0x16] & 0xff, &push, 0) != 0) {
                    ...
                    func_ov107_020c5af8(*state, 0x12a, 8, (void *)state[2]);
