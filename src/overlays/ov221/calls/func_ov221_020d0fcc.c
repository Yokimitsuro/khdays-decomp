 ...
 * raise flag 0x40 in the high byte at +0x60 and run func_ov221_020d0fb8; always
 * reset +0x400/+0x404 and mirror the state byte +0x1c6 into +0x40c. */
extern void func_ov107_020c9264(int a, int b, int c);
extern void func_ov221_020d0fb8(int a, int b);
void func_ov221_020d0fcc(int param_1, int param_2) {
