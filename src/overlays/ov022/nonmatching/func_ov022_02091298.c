/*
 * [nonmatching: mwcc redundantly spills param_1/param_2 addresses to the stack (+0xc frame vs +8); the original keeps both in r6/r7 with immediate-offset loads]
 *
...
void func_ov022_02091298(int arg0, int arg1, unsigned int *arg2, unsigned short *arg3, int arg4, int arg5) {
    int i;
    func_ov022_02090c04(arg0, arg1, arg3, arg4, arg5);
    i = 0;
