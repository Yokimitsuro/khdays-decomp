...
extern const char data_ov231_020cfa60[];
extern void func_ov231_020cbfc8(int);
int func_ov231_020cbf38(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x40c);
    *(signed char *)(obj + 0x19c) = 0x3b;
    OS_SPrintf(buf, data_ov231_020cfa60, 59);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov231_020cbfc8;
