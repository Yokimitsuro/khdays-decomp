/* Draw pre-pass of the ov231 enemy (x2 with ov232). The +0xa0 pose is copied to +0x3dc and
 * rescaled by the unit ratio 0x1119/0x1119. Outside sub-state 8 a pending slot-6 effect is finished; a
...
void func_ov231_020cc704(char *self)
{
