/* c634 state-entry handler: clear obj->f28, run func_ov231_020cc9e0(self), then
...
extern void func_ov231_020ce10c(void);
struct b8 { unsigned int f:8; };
void func_ov231_020cdffc(int self) {
    int obj = *(int *)(self + 4);
    int v;
    *(int *)(obj + 0x28) = 0;
    ...
    *(int *)(obj + 0x18) = v;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov231_020ce10c);
}
