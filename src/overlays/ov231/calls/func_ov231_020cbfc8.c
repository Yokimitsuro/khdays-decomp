 ...
 * of data_ov231_020cfa10 into the +0x3b8 pair table (registered, bit 1 of +0x5c) and spawns the two
 * +0x38c children (func_ov231_020cf124, bit 2 of their body's +0x5c). Registers actions 0/2, 1/2
...
extern void *func_ov231_020cf124(void *self);
...
extern void func_ov231_020cc45c(void);
extern void func_ov231_020cc4b4(void);
extern void func_ov231_020cc55c(void);
extern void func_ov231_020cc97c(void);
extern void func_ov231_020cc68c(void);
extern void func_ov231_020cc6c8(void);
extern void func_ov231_020cc704(void);
extern void func_ov231_020ccd58(void);
extern void func_ov231_020cc4d8(void);
extern void func_ov231_020cd0dc(void);

void func_ov231_020cbfc8(char *self)
{
    ParamBlock params;
    KindTable kinds;
    Placement place;
    ...
    *(void **)(self + 0x8) = (void *)func_ov231_020cc45c;
    *(void **)(self + 0xc) = (void *)func_ov231_020cc4b4;
    *(void **)(self + 0x1c) = (void *)func_ov231_020cc55c;
    *(void **)(self + 0x30) = (void *)func_ov231_020cc97c;
    *(void **)(self + 0x28) = (void *)func_ov231_020cc68c;
    *(void **)(self + 0x2c) = (void *)func_ov231_020cc6c8;
    *(void **)(self + 0x34) = (void *)func_ov231_020cc704;
    *(void **)(self + 0x1d0) = (void *)func_ov231_020ccd58;
    *(void **)(self + 0x1dc) = (void *)func_ov231_020cc4d8;
    *(ParamBlock *)(self + 0x1fc) = params;
    *(void **)(self + 0x1e0) = (void *)func_ov231_020cd0dc;
    ...
    *(int *)(self + 0x3cc) = func_0203bee8(*(void **)(self + 0x384), 1, data_ov231_020cfa6c);
    *(int *)(self + 0x3d0) = func_0203bee8(*(void **)(self + 0x384), 1, data_ov231_020cfa78);
    *(int *)(self + 0x3d4) = func_0203bee8(*(void **)(self + 0x384), 3, data_ov231_020cfa84);
    *(int *)(self + 0x3d8) = func_0203bee8(*(void **)(self + 0x384), 3, data_ov231_020cfa90);
    {
        unsigned int v = *(u16 *)(self + 0x60);
        *(u16 *)(self + 0x60) = (u16)((v & ~0xff00) | ((((v << 0x10) >> 0x18 | 0x40) << 0x18) >> 0x10));
    }
    *(int *)(self + 0x388) = func_ov107_020c9e50(func_ov107_020c9440(self, 0x11), data_ov231_020cfa9c);
    *(void **)(self + 0x3b8) = func_0203d15c(0x40);
    ...
    for (i = 0; i < 2; i++) {
        ((void **)(self + 0x38c))[i] = func_ov231_020cf124(self);
        *(int *)(*(int *)((char *)((void **)(self + 0x38c))[i] + 0x9c) + 0x5c) |= 4;
    }
    lift = *(VecFx32 *)(self + 0xb0);
    lift.y += 0x1800;
    func_ov107_020c92b0(self, 0, 2, &lift, 0xa3c);
    func_ov107_020c92b0(self, 1, 2, &lift, 0xa3c);
    func_ov107_020c92b0(self, 2, 3, 0, 0xa3c);
    func_ov107_020c92b0(self, 4, 2, &lift, 0xa3c);
