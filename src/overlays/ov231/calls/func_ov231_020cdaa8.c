/* func_ov231_020cdaa8 -- decide which way to sidestep, then hand off to func_ov231_020cdc90.
 *
 ...
 *
 *   0 -> probe both sides. Take the canned offset data_ov231_020cfa40, run it through
 *        func_ov231_020cca74 and ask func_ov231_020ccb08 whether that way is blocked; then repeat
...
extern int func_ov231_020ccb08(int self, const VecFx32 *v, int a);
...
extern void func_ov231_020cdc90(void);
extern VecFx32 data_ov231_020cfa40;
...
void func_ov231_020cdaa8(int self) {
    int *ctx;
    ...
    *(unsigned char *)((char *)ctx + 0x4a) = func_02023eb4(2);
    ...
    func_ov231_020cd094(self, 2, 2, 0, func_ov231_020cdc90);
}
