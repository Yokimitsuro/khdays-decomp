...
extern void func_ov107_020c5af8(struct Ov194Owner *owner, int a, int id, void *at);
...
extern int func_ov107_020c8eb8(struct Ov194Owner *owner, Sphere *sphere, int *out);
extern int func_ov107_020ca918(int hit, struct Ov194Owner *a, struct Ov194Owner *b, int kind, Vec3 *push, int z);
extern int func_02023eb4(int range);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_ov107_020c9264(struct Ov194Owner *actor, int anim, int flag);
extern const PosMsg data_ov194_020cef74;
...
void func_ov194_020cde54(int *node)
{
    ...
    if (*(u8 *)((char *)state + 0x53) == 0) {
        ...
        if (state[0x15] > 0x1333) {
            func_ov107_020c5af8((struct Ov194Owner *)*state, 0x134, 6, (char *)*(int *)(*state + 0x398) + 0x14);
    ...
    if (state[0xc] >= 0x200) {
        ...
        nHits = func_ov107_020c8eb8((struct Ov194Owner *)*state, &sphere, hits);
        i = 0;
        if (nHits > 0) {
            tmpl = data_ov194_020cef74;
            do {
                if (((*(u8 *)((char *)state + 0x51) >> *(u8 *)(hits[i] + 0x1b4)) & 1) == 0 &&
                    func_ov107_020ca918(hits[i], (struct Ov194Owner *)*state, (struct Ov194Owner *)*state, 1, (Vec3 *)&data_02041dc8, 0) != 0) {
                    msg = tmpl;
                    ...
                    *(u8 *)((char *)state + 0x51) |= 1 << *(u8 *)(hits[i] + 0x1b4);
                    func_ov107_020c5af8((struct Ov194Owner *)*state, 0x134, 7, &raw);
                }
            } while (++i < nHits);
        }
    }
    if (*(u8 *)(*(int *)(*(int *)(*state + 0x3d0) + 0x3c) + 0xad) == 0) {
        ...
        func_ov107_020c9264((struct Ov194Owner *)*state, 9, 0);
        *(u8 *)((char *)state + 0x50) = 0;
        state[0xc] = 0;
        *(u8 *)((char *)state + 0x51) = 0;
        *(u8 *)((char *)state + 0x53) = 0;
        state[0x15] = 0;
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov194_020cdd54);
        return;
    }
