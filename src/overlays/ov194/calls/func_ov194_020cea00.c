...
extern const struct Msg20 data_ov194_020cefb4;
extern const Vec3 data_ov194_020cef68;
extern const struct Msg14 data_ov194_020cef82;
...
void func_ov194_020cea00(int *node)
{
    ...
    if (state[0xc] >= 0xa88) {
        offBase = data_ov194_020cef68;
        nPoint = 0;
        tmpl = data_ov194_020cef82;
        do {
