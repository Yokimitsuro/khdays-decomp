...
void func_ov194_020cc318(int owner, unsigned char *command, int arg)
{
    ...
    if (command[2] == 5) {
        ...
        case 0:
            ...
            break;
        case 1:
            (*(int **)(owner + 0x3d4))[3] = func_ov107_020c08cc(*(int *)(owner + 0x3c), (*(int **)(owner + 0x3d4))[2], 0x15, 0, 0x1784, command + 5);
            break;
        case 2:
