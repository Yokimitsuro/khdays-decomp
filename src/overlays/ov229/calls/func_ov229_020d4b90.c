 ...
 * func_ov107_020c0b90, clear obj+0x62, and dispatch into func_ov229_020d4c30. */
...
extern void func_ov229_020d4c30(void);
void func_ov229_020d4b90(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(char *)((char *)obj + 0x62) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov229_020d4c30);
}
