/* func_ov229_020d51dc -- the recoil tick: bleed the stored impulse away over 0x1800 of timer,
 ...
 * hw60 hi-byte (it HAS the trunc pair, so bitfield form) and hands off to func_ov229_020d53f4. */
...
extern void func_ov229_020d53f4(void);
extern short data_0203d210[];

void func_ov229_020d51dc(int self) {
    int *ctx;
    ...
    *(unsigned char *)((char *)ctx + 0x61) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov229_020d53f4);
}
