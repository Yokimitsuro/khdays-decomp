/* func_ov229_020d53f4 -- the slam tick (x2 with ov229): the impulse at ctx+0x1c is copied out to
 ...
 * with kind 2 (func_ov229_020d2af8). Once the owner lands (+0x17a bit 0) the owner's +0x180 point
 ...
 * restarts and the tick hands over to func_ov229_020d557c. */
...
extern void func_ov229_020d2af8(int *ctx, int kind, Sphere *sphere, void *box);
...
extern void func_ov229_020d557c(void);

void func_ov229_020d53f4(int self) {
    int *ctx;
    Sphere sphere;
    int step;
    ...
    *(VecFx32 *)((char *)ctx + 0x10) = *(VecFx32 *)((char *)ctx + 0x1c);
    ...
    func_ov229_020d2af8(ctx, 2, &sphere, 0);
    ...
    *(VecFx32 *)((char *)ctx + 0x34) = *(VecFx32 *)(ctx[0] + 0x180);
    ...
    func_ov107_020c5af8(ctx[0], 0x12b, 0xc, (char *)ctx + 0x34);
    ctx[0x13] = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov229_020d557c);
}
