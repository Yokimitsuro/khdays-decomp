 ...
 * timer and the +0x61/+0x62 flags reset and the tick hands over to func_ov229_020d4e80. */
typedef struct { int x, y, z; } Vec3;

extern void func_ov107_020c0b90(int actor, int a, Vec3 v, int b);
extern void func_ov107_020c5af8(int owner, int id, int mode, void *at);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_ov229_020d4e80(int *node);

void func_ov229_020d4d6c(int *node)
{
    ...
    *((unsigned char *)state + 0x62) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov229_020d4e80);
}
