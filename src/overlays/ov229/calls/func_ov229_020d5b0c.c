/* func_ov229_020d5b0c -- face the target and close in, unless it is already too near.
 *
 ...
 * func_ov229_020d2f70). Otherwise the tail is the same Y-rotation steering as
...
void func_ov229_020d5b0c(int self) {
    int *ctx;
