...
extern void func_ov229_020d1f04(void);
extern void func_ov229_020d1f5c(void);
extern void func_ov229_020d2048(void);
extern void func_ov229_020d24f4(void);
extern void func_ov229_020d1fd0(void);
extern void func_ov229_020d200c(void);
extern void func_ov229_020d22b4(void);
extern void func_ov229_020d2550(void);
extern void func_ov229_020d243c(void);
extern void func_ov229_020d2a9c(void);
extern void func_ov229_020d2ac8(void);
extern void func_ov229_020d1a28(void);
...
extern int func_ov229_020d5c84(char *self);
...
void func_ov229_020d1b18(char *self)
{
    ...
    *(Callback *)(self + 0x8) = func_ov229_020d1f04;
    *(Callback *)(self + 0xc) = func_ov229_020d1f5c;
    *(Callback *)(self + 0x1c) = func_ov229_020d2048;
    *(Callback *)(self + 0x30) = func_ov229_020d24f4;
    *(Callback *)(self + 0x28) = func_ov229_020d1fd0;
    *(Callback *)(self + 0x2c) = func_ov229_020d200c;
    *(Callback *)(self + 0x34) = func_ov229_020d22b4;
    *(Callback *)(self + 0x1d0) = func_ov229_020d2550;
    *(Callback *)(self + 0x1dc) = func_ov229_020d243c;
    *(Callback *)(self + 0x1e0) = func_ov229_020d2a9c;
    *(Callback *)(self + 0x1e4) = func_ov229_020d2ac8;
    ...
    *(Callback *)(*(int *)(self + 0x3a8) + 0x74) = func_ov229_020d1a28;
    ...
    *(int *)(self + 0x3b4) = func_0203bdfc(*(int *)(self + 0x3a8), data_ov229_020d692c);
    *(int *)(self + 0x3b8) = func_0203bdfc(*(int *)(self + 0x3a8), data_ov229_020d693c);
    ...
    *(int *)(self + 0x490) = func_ov107_020c9e50(func_ov107_020c9440(self, 0x1c), data_ov229_020d694c);
    for (i = 0; i < 10; i++) {
        if (i < 1) {
    ...
    *(int *)(self + 0x3b0) = *slot = node;
    for (i = 0; i < 8; i++) {
        ((struct Shots *)self)->shots[i] = func_ov229_020d5c84(self);
    }
    func_0203355c(0x12b);
}
