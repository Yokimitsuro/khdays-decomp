 ...
 * (0, 1.5, 0) and the tick hands over to func_ov229_020d51dc. */
...
extern void func_ov229_020d51dc(int *node);

void func_ov229_020d50e0(int *node)
{
    ...
    *(unsigned short *)(*state + 0x60) = (unsigned short)((v & ~0xff00) | (((((unsigned int)v << 0x10) >> 0x18 | 0x40) << 0x18) >> 0x10));
    ...
    state[8] = 0x1800;
    state[9] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov229_020d51dc);
}
