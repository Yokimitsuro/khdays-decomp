...
extern void func_ov229_020d2f70();
extern void func_0203c634(void *obj, int idx, void *value);
extern short data_0203d210[];
extern void func_ov229_020d49f4(void);
void func_ov229_020d48f0(int *node) {
    ...
    func_ov229_020d2f70(*state, 0xd);
    state[0x13] = 0;
    *(signed char *)((char *)state + 0x61) = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov229_020d49f4);
}
