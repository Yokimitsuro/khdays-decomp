/* Contact sweep of the ov228 enemy (x2 with ov229): collects the entities in the given box (or
...
void func_ov229_020d2af8(int *state, int kind, Sphere *sphere, void *box)
{
    int hits[4];
    Vec3 push;
    Vec3 dir;
    ...
    case 0:
    case 5:
        func_ov107_020c5af8(*state, 0x12b, 5, (void *)state[3]);
        break;
    case 1:
        func_ov107_020c5af8(*state, 0x12b, 6, (void *)state[3]);
        break;
    case 2:
