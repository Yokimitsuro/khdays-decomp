/* func_ov229_020d3e28 -- steer toward the target: rotate the owner's offset vector by the stored
 ...
 *   - func_ov229_020d2f84 returning negative (nothing to steer toward);
...
void func_ov229_020d3e28(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
