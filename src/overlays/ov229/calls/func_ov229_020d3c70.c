/* func_ov229_020d3c70 -- the wait loop of the approach: hold the stance for a few ticks, then
 * commit. This is the other half of func_ov229_020d3aec, which enters here; from here the object
 * either loops back into 020cfeac or moves on to func_ov229_020d3e28.
 *
 * func_ov229_020d2f84 returns the current range (negative aborts). Inside 0x1000 there is a 45%
...
extern void func_ov229_020d3aec(void);
extern void func_ov229_020d3e28(void);
...
void func_ov229_020d3c70(int self) {
    int *ctx;
    MtxFx33 mtx;
    int range;
    int idx;
    ...
    ctx = *(int **)(self + 4);
    range = func_ov229_020d2f84(self);
    if (range < 0) {
    ...
    if (*(unsigned char *)(ctx[1] + 0xad) == 0) {
        ...
        if (--ctx[0x14] > 0) {
            func_0203c634(self, *(signed char *)(self + 0x20), func_ov229_020d3aec);
            return;
        }
        ...
        func_0203c634(self, *(signed char *)(self + 0x20), func_ov229_020d3e28);
        return;
    }
