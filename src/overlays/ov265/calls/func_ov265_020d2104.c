/* Lunge tick of the ov265 enemy. The target is re-acquired
 * (func_ov265_020d0628) and a sideways drift is chosen from the +0x20 distance (0x180 out past
 ...
 * (func_ov265_020d0890); on a hit reaction 0/0x50 fires at the owner's +0x74 point. Past 0x1100 a
 * pending +0x54 flag spawns effect 3 at the origin once. The +0x30 velocity is the +0x388 part's
 * +0x2c vector plus the drift, both turned by the heading (func_ov265_020d06bc). When the +0x10
...
extern void func_ov265_020d0628(int *node);
extern void func_ov107_020c5af8(int owner, int id, int mode, void *at);
extern int func_ov265_020d0890(int *self, Sphere *sphere, void *query, void *pt, int flags);
extern void func_ov107_020c0b90(int actor, int a, Vec3 v, int b);
extern void func_ov265_020d06bc(void *out, int *self, Vec3 *vec);
...
void func_ov265_020d2104(int *node)
{
    ...
    if (state[0xa] >= 0x1100 && state[0xa] < 0x1650) {
        ...
        sphere.radius = 0x2ca1;
        sphere.pos = *(Vec3 *)(*(int *)(*state + 0x3d0) + 0x14);
        if (func_ov265_020d0890(node, &sphere, 0, &dir, 1) != 0) {
    ...
    func_ov265_020d06bc(&lift, node, &lift);
    func_ov265_020d06bc(&v, node, (Vec3 *)(*(int *)(*state + 0x388) + 0x2c));
    *(Vec3 *)(state + 0xc) = v;
