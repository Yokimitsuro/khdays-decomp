/* func_ov265_020d16fc -- decide which way to sidestep, then hand off to func_ov265_020d18e4.
 *
 ...
 *
 *   0 -> probe both sides. Take the canned offset data_ov265_020d3698, run it through
 *        func_ov265_020d06bc and ask func_ov265_020d0750 whether that way is blocked; then repeat
...
extern int func_ov265_020d0750(int self, const VecFx32 *v, int a);
...
extern void func_ov265_020d0ce8(int self, int a, int b, int c, void (*cb)(void));
extern void func_ov265_020d18e4(void);
extern VecFx32 data_ov265_020d3698;
...
void func_ov265_020d16fc(int self) {
    int *ctx;
    ...
    *(unsigned char *)((char *)ctx + 0x4a) = func_02023eb4(2);
    ...
    if (*(unsigned char *)((char *)ctx + 0x4a) == 0) {
        ...
        v = data_ov265_020d3698;
        func_ov265_020d06bc(&v, self, &v);
        if (func_ov265_020d0750(self, &v, 0) != 0) {
    ...
    func_ov265_020d0ce8(self, 2, 2, 0, func_ov265_020d18e4);
}
