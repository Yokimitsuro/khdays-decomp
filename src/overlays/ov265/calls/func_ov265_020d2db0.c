/* Construction of the ov265 enemy's item: installs the handlers (+8
 ...
 * sub-item is subscribed to +0x9c, uniformly scaled by 0x1ec6/0x1119, its channels 0 and 2 are
...
extern void func_ov265_020d2ee4(void);
extern void func_ov265_020d2f38(void);
extern void func_ov265_020d2f00(void);
...
void func_ov265_020d2db0(char *self)
{
    ...
    *(void **)(self + 0x30) = (void *)func_ov265_020d2f38;
    *(void **)(self + 0x1d0) = (void *)func_ov265_020d2f00;
    v = *(u16 *)(self + 0x60);
