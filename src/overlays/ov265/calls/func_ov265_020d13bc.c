...
extern void func_ov265_020d0628(int);
extern void func_ov107_020c5af8(int a, int b, int c, int d);
extern int func_0203c634(int a, int b, void *handler);
extern void func_ov265_020d1460(int);
struct lo8_020cd768 { unsigned f : 8; };
void func_ov265_020d13bc(int param_1) {
    int child = *(int *)(param_1 + 4);
    func_ov265_020d0628(param_1);
    {
    ...
    *(int *)(child + 0x28) = 0;
    func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov265_020d1460);
}
