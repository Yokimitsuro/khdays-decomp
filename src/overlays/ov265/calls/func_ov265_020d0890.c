/* func_ov265_020d0890 -- probe a direction: gather the candidates, skip the ones already handled,
...
int func_ov265_020d0890(int self, int kind, void *query, void *pt, int flags) {
    int *ctx = *(int **)(self + 4);
