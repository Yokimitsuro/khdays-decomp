...
int func_ov265_020d09a0(char *self, int src, unsigned int *hit)
{
    ...
    if ((*(signed char *)(*state + 0x100 + 0xc6) == 2 || *(signed char *)(*state + 0x100 + 0xc6) == 4)
        ...
        if (((((struct HitWord *)hit)->lo & 0x20) != 0 && (unsigned int)func_02023eb4(100) < 0x1e)
            || (unsigned int)func_02023eb4(100) < 0xf) {
            state[9] = 0;
