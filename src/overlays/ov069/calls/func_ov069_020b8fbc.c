...
extern void func_ov069_020b8a90(void *ctx, void *obj, int a, int b, int flag);
extern void func_ov069_020b8e74(Params *p, void *block);

void func_ov069_020b8fbc(void *ctx, Params *p, char *block) {
    int one = 1;
    int i;
    int a = p->a;
    ...
    for (i = 0; i < 4; i++) {
        ...
        func_ov069_020b8a90(ctx, *(void **)(row + 0x34), a, p->b, one);
    }
