...
extern void func_ov069_020b9fe0(int *self);
extern int func_ov069_020b88c0(int a);
...
extern void func_ov069_020b9734(int *self, int a, void *node, int idx);
extern void func_ov069_020b9ca8(int *self, int base, int a, int b, unsigned long long *m);

struct Pair { int a, b; };
struct Self { char pad[0xcc]; struct Pair pairs[3]; };
extern void func_ov069_020b894c(void *p);

void func_ov069_020ba250(int *self, int base, void *list, int p4) {
    ...
    func_ov069_020b9fe0(self);
    tc = func_ov069_020b88c0(0);
    self[0x3d] = 0;
    self[0x3c] = 0;
    self[0x3a] = 0;
    ...
    for (node = NNS_FndGetNextListObject(list, 0); node != 0;
        ...
        func_ov069_020b9734(self, *(unsigned short *)((char *)node + 0xa) * 0xa0 + base, node,
    ...
    for (k = 0; k < 3; k++, base += 0xa0) {
        func_ov069_020b9ca8(self, base, ((struct Self *)self)->pairs[k].a,
    ...
    func_ov069_020b894c((char *)self + 0x2c);
    if (self[0x3a] != 0) {
        func_02034258(0x13);
        self[0x3a] = 0;
    }
