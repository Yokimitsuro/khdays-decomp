...
struct Ov189Actor {
    ...
    int resource03c;
    char pad040[0x60];
    struct Ov189Transform transform0a0;
    char pad0cc[0x2f8];
    int specialHandle3c4;
    struct Ov189NodeSlot nodes3c8[4];
};

extern void func_0203c960(struct Ov189Transform *transform);
extern void func_0203ca30(struct Ov189Transform *transform,
...
extern int func_ov107_020c09a0(int resource, int node, int kind,
                               ...
                               int enabled);
extern int func_ov107_020cb040(struct Ov189Actor *self, int resourceId,
                               int kind, int enabled,
                               struct Ov189Transform *transform);
extern void func_0203c650(int resource, int handle);
extern void func_ov107_020cb100(int handle);
extern void func_ov107_020c7500(struct Ov189Actor *self,
                                struct Ov189Command *command, int arg2);

void func_ov189_020d0074(struct Ov189Actor *self,
                         struct Ov189Command *command, int arg2)
{
    struct Ov189Transform transform;
