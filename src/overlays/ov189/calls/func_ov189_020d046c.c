...
struct Ov189ReactionObject {
    char pad000[0x1c6];
    signed char state1c6;
    u8 nextState1c7;
};

struct Ov189ReactionWork {
    struct Ov189ReactionObject *object00;
    char pad004[0x08];
    int reactionContext0c;
    char pad010[0x1c];
    struct Ov189Vec3 position2c;
    int source38;
    char pad03c[0x02];
    u8 facing3e;
};
...
extern int func_ov107_020c89e8(struct Ov189ActorHitState *self,
                               struct Ov189Hit *hit);
extern void func_ov107_020c5af8(struct Ov189ActorHitState *self,
                                int reactionId, u8 mode, int context);

int func_ov189_020d046c(struct Ov189ActorHitState *self, int source,
                        struct Ov189Hit *hit)
{
    u8 normalModes[2] = {
        data_ov189_020d2098.normal[0],
        data_ov189_020d2098.normal[1]
    };
    u8 specialModes[2] = {
    ...
    if (hit->damage28 > 0) {
        flags = (struct Ov189HitFlags *)hit;
