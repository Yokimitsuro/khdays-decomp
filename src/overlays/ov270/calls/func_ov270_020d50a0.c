...
extern const Vec3 data_ov270_020d6858;
extern const struct Msg14 data_ov270_020d687c;
...
void func_ov270_020d50a0(int *node)
{
    ...
    if (state[0xc] >= 0xaaa) {
        offBase = data_ov270_020d6858;
        nPoint = 0;
        tmpl = data_ov270_020d687c;
        do {
    ...
    if (*(u8 *)(state[1] + 0xad) == 0) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov270_020d5574);
    }
}
