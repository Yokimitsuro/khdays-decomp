...
extern const Vec3 data_ov270_020d6864;
extern const struct Msg14 data_ov270_020d6898;
...
void func_ov270_020d62fc(int *node)
{
    ...
    if (*(u8 *)((char *)state + 0x53) == 0) {
        ...
        if (state[0x15] > 0x999) {
            func_ov107_020c5af8((struct Ov269Owner *)*state, 0x160, 8, (char *)*(int *)(*state + 0x398) + 0x14);
    ...
    if (state[0xc] >= 0xa88) {
        offBase = data_ov270_020d6864;
        nPoint = 0;
        tmpl = data_ov270_020d6898;
        do {
