/* Retreat tick of the ov227 enemy. The +0x78 target clears and the +0x5c timer accumulates
 ...
 * 0x14d fires mode 0xb at 0x1a90 and mode 4 at 0xaa0 at the +8 point (bits 0/1 of +0x75), and
...
void func_ov227_020d223c(int *node)
{
    ...
    if (*(signed char *)(*state + 0x1c6) != 0xd) {
        ...
        if ((*(u8 *)((char *)state + 0x75) & 1) == 0 && state[0x17] >= 0x1a90) {
            *(u8 *)((char *)state + 0x75) |= 1;
            func_ov107_020c5af8(*state, 0x14d, 0xb, (void *)state[2]);
        }
        if ((*(u8 *)((char *)state + 0x75) & 2) == 0 && state[0x17] >= 0xaa0) {
            *(u8 *)((char *)state + 0x75) |= 2;
            func_ov107_020c5af8(*state, 0x14d, 4, (void *)state[2]);
        }
