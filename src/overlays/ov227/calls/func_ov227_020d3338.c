/* func_ov227_020d3338 -- enter the approach: pick a lane, a speed and a duration, then dispatch.
 * A negative reading from func_ov227_020d14bc aborts straight to the dispatcher.
 *
...
extern int func_ov227_020d14bc(int self, int kind);
...
extern void func_ov227_020d347c(void);

void func_ov227_020d3338(int self) {
    int *ctx;
    int v;
    int speed;
    int steps;
    ...
    *(unsigned char *)((char *)ctx + 0x76) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov227_020d347c);
}
