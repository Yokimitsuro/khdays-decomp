 ...
 * While still below obj[0x18]+0x800, re-arm via func_ov227_020d0a10 with mode 2/4 (by the
...
extern void func_ov227_020d0a10(int *obj, int mode, int b);
extern struct vec data_02041dc8;
extern void func_ov227_020d2ed0(void);
void func_ov227_020d2e00(int self) {
    int *obj = *(int **)(self + 4);
    int t, flag;
    *(struct vec *)(obj + 5) = *(struct vec *)(obj + 8);
    ...
    if (t >= obj[0x18] + 0x800) {
        ...
        func_0203c634(self, *(signed char *)(self + 0x20), &func_ov227_020d2ed0);
        return;
    }
    func_ov227_020d0a10(obj, flag != 0 ? 2 : 4, 0);
}
