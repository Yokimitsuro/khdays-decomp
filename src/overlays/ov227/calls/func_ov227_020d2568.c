/* Steering of the ov227 enemy: with a +0x78 target the +0x14 step is the sine/cosine of the
 * given heading scaled 0x100, otherwise the +0x414 part's +0x2c offset rotated by it
...
void func_ov227_020d2568(int *node, int rad)
{
