/* func_ov146_020cc570 -- bind a motion: resets the actor's +0x388 track (0202a440), refreshes the
...
extern void func_0202a388(void *track, struct Ov146Model *model, void *resource, int slot);
...
void func_ov146_020cc570(int self, int index, int flag) {
    ...
    func_0202a388((void *)(self + 0x388), model, func_ov107_020c9440(self, index + 1), 0xc);
