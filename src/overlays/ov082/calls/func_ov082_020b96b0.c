...
extern void func_ov082_020b89b0(int a);
...
void func_ov082_020b96b0(int p1, int state) {
    struct s5 buf;
    *(int *)(state + 0xdb4) = p1;
    *(int *)(state + 0xc) = 0;
    *(int *)(state + 0x14) = 0;
    *(int *)(state + 0x230) = 0;
    func_0202a634(state + 0x18, data_ov082_020ba4b8, 1, *(unsigned char *)(p1 + 9) + 7);
    if (*(int *)(p1 + 0xc) == 0)
        func_0202a634(state + 0x128, data_ov082_020ba4cc, 1, *(unsigned char *)(p1 + 9) + 7);
    else
        func_0202a634(state + 0x128, data_ov082_020ba4e0, 1, *(unsigned char *)(p1 + 9) + 7);
    buf = data_ov082_020ba3b4;
    buf.b = 4;
    func_ov022_02092384(p1 + 0x2648, *(unsigned char *)(p1 + 9), 5, &buf);
    func_ov082_020b89b0(state);
}
