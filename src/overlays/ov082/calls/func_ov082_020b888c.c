...
struct Ov082Runtime {
    ...
    u8 slot09;
    char pad00a[0x16];
    struct Ov082SceneLink *scene20;
    char pad024[0x2b8];
    char parameterBase2dc;
    char pad2dd[0x201b];
    struct Ov082BuildBlock buildBlock22f8;
};

struct Ov082Descriptor {
    char bytes[0x10];
};
...
u8 func_ov082_020b888c(struct Ov082Runtime *self)
{
    struct Ov082BuildBlock *block = &self->buildBlock22f8;
