...
extern void func_ov058_020b718c(char *self, char *shot, int bCharged);          /* Ov039_FireStoredShot */

void func_ov058_020b6968(char *self, char *shot, int dt)
{
    Vec3 vMove;
    int speed;
    char *hit;
    ...
    *(int *)(shot + 4) += 1;
    ...
    func_ov058_020b718c(self, shot, bCharged);
    if (bCharged != 0) {
        *(int *)(shot + 8) = 0;
    }
}
