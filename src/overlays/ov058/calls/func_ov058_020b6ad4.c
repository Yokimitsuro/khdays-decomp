...
extern void func_ov058_020b6c80(void);
extern void func_ov058_020b6dc0(void);
extern int data_ov058_020b7ddc;

void func_ov058_020b6ad4(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x30);
    ...
    func_ov022_02091298(*(void **)(self + 0x2000 + 0x644), self,
                        &data_ov058_020b7ddc, cfg, 2, 6);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) = (void *)&func_ov058_020b6c80;
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x24) = (void *)&func_ov058_020b6dc0;
}
