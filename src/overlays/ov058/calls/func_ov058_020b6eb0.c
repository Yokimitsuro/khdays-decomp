...
extern void func_ov058_020b6850(char *self, int side, Vec3 *out);              /* Ov039_GetAttackAnchor */
extern void func_ov022_020ad208(char *self, int event, Vec3 *pos, int range, int angle, int flag);
extern char *data_ov058_020b7e00;
extern const Ov039BandRow data_ov058_020b7bc8;      /* the single-anchor per-band flags */

void func_ov058_020b6eb0(char *self)
{
    Vec3 vAnchor;
    ...
    if (band >= 15) band = 0;
    if (*(int *)rig == 0) {
        Ov039BandRow single = data_ov058_020b7bc8;
        func_ov058_020b6850(self, 0, &vAnchor);
    ...
    }
    {
        ...
        func_ov058_020b6850(self, 1, &vAnchor);
