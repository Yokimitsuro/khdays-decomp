...
extern void func_ov026_02084d64(int a);
extern void func_ov026_02084b5c(int a);
extern void NNSi_FndFreeFromDefaultHeap(int a);
void func_ov026_02084cd0(int param_1) {
    func_ov026_02084d64(param_1);
    func_ov026_02084b5c(param_1);
