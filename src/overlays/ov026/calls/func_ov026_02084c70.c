...
extern void func_ov026_02084d3c(int a, void *b);
extern int func_0201ef9c(int a, int b);
extern void func_ov026_02084bbc(int a, int b, int c);
extern int data_ov026_02091214;
void func_ov026_02084c70(int param_1, int param_2) {
    MI_CpuFill8((void *)param_1, 0, 0x24);
    NNS_FndInitList(param_1 + 0x18, 0x4c);
    func_ov026_02084d3c(param_1, &data_ov026_02091214);
    *(int *)(param_1 + 0xc) = *(int *)(param_2 + 8);
    *(int *)(param_1 + 0x14) = func_0201ef9c(*(int *)param_2, 0xe);
    func_ov026_02084bbc(param_1, *(int *)(param_2 + 8), *(int *)(param_2 + 4));
}
