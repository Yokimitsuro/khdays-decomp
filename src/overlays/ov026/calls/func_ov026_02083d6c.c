/* func_ov026_02083d6c -- per-frame update for a scene's widget layer.
 * Runs func_ov026_02083d24 first, then unless bit 2 of +0x4a6c suppresses it, re-projects the
 * anchor at +0x4a54 and feeds the Q12 result (>> 12) to func_020327e0.
 * Bit 0 of +0x4a7c enables the hit/selection pass (func_ov026_0208393c); if that found nothing
 * and bit 1 is set, func_ov026_02083a1c handles the fallback, otherwise the field at +0x4a78 is
...
extern void func_ov026_02083d24(Obj *o);
extern void func_0203602c(int *anchor, int *out);
extern void func_020327e0(Obj *o, int v);
extern int func_ov026_0208393c(Obj *o);
extern void func_ov026_02083a1c(Obj *o, int p);
extern void func_0203256c(Obj *o);
extern void func_0203255c(Obj *o);

void func_ov026_02083d6c(Obj *o, int p, int flag) {
    int v;
    int sel;

    sel = 0;
    v = 0;
    func_ov026_02083d24(o);
    if (!o->b4a6c_2) {
        func_0203602c(&o->f4a54, &v);
        func_020327e0(o, v >> 12);
    }
    if (o->b4a7c_0) {
        sel = func_ov026_0208393c(o);
    }
    if (sel == 0 && o->b4a7c_1) {
        func_ov026_02083a1c(o, p);
    } else {
        o->f4a78 = 0xf0;
    }
    if (flag != 0) {
