/* func_ov026_02085070 -- per-frame refresh of the ov008 panel widget.
...
extern int  data_ov026_02091368;   /* -> panel context */

void func_ov026_02085070(void) {
    int ctx = data_ov026_02091368;
    int w = ctx + 0xbfb8;
