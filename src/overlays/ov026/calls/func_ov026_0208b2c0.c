/* func_ov026_0208b2c0 -- Ov008_ShopListInput: one frame of input on the
...
extern void  func_ov026_0208c2c0(void);                                /* confirm handler (recipes) */
extern void  func_ov026_0208bb84(void);                                /* confirm handler */
extern void  func_ov026_0208bad4(void);                                /* next step after a confirm */
extern void  func_ov026_0208ab5c(void);                                /* cancel handler */
extern void  func_ov026_0208bab0(void);                                /* next step after a cancel */
...
extern int   func_ov026_02088820(void);                                /* Ov008_CanConfirmShopRow */
...
extern void  func_ov026_020885cc(void);                                /* refresh the cursor */
...
Ov008ShopStep func_ov026_0208b2c0(void)
{
    ...
    if (nKeys & KEY_DOWN) {
        ...
        if (nPressed & KEY_R) {
            ...
            } while (func_ov026_02087570(1, 0) == 0 && pShop->nCategory != nCategory);
            ...
            if (pView->nCount != 0 && func_ov026_02088820() != 0) {
                if (ctx->nTab == TAB_RECIPES) {
                    func_02033b78(0, func_ov026_0208e6a0(pView->apRows[pView->nRow]) != 0 ? 1 : 4);
                    pfnPending = func_ov026_0208c2c0;
                } else {
                    func_02033b78(0, 1);
                    pfnPending = func_ov026_0208bb84;
                }
                pView->pfnPending = pfnPending;
                pfnNext = func_ov026_0208bad4;
            } else {
                func_02033b78(0, 4);
            }
        } else if (nPressed & KEY_B) {
            func_02033b78(0, 3);
            pView->pfnPending = func_ov026_0208ab5c;
            pfnNext = func_ov026_0208bab0;
        }
    }
    ...
    func_ov026_02085aa4();
    if (pfnNext == 0) {
        if ((pView->nCount > ROWS_VISIBLE && pView->bDragging == 0 && ctx->bTouch != 0 && func_ov026_02085b9c(&data_ov026_020910d4[nTab == TAB_REWARDS]) != 0)
            ...
            if (nLimit > 0) {
                ...
                do {
                    if (func_ov026_02085b9c(&pCategoryBox[nTab == TAB_REWARDS ? 8 : 0]) != 0) {
                        nCategory = pShop->nCategory;
                        if (nCategory != i) {
                            pShop->nCategory = i;
                            if (func_ov026_02087570(1, 0) == 0) {
                        ...
                        for (nRow = 0, nY += pBox->nH; nRow < ROWS_VISIBLE; nRow++, nY += pBox->nH) {
                            if (nY > nTouchY) {
                                ...
                                if (nHit < pView->nCount) {
                                    pView->nRow = nHit;
                                    if (func_ov026_02088820() != 0) {
                                        func_02033b78(0, 1);
                                        pView->pfnPending = nTab == TAB_RECIPES ? func_ov026_0208c2c0 : func_ov026_0208bb84;
                                        pfnNext = func_ov026_0208bad4;
                                    } else {
    ...
    if (nRowPrev != pView->nRow) {
        ...
        if (pView->apRows != 0 && nTab != TAB_ITEMS) {
            if (nTab != TAB_REWARDS || pView->nRow < ctx->aFunds[ctx->shop.nCategory] || pView->apRows[pView->nRow]->bLocked != 0) {
                func_ov026_0208e218(pView->apRows, pView->nRow, 1);
            }
        }
    }
    func_ov026_020885cc();
    ...
    if (nTab == TAB_RECIPES) {
        ...
        if (data_0204be18->aItemCount[nItem] < func_ov026_020850e4(pRecord)) {
            nOwned = -1;
        } else {
            nOwned = data_0204be18->aItemCount[func_ov026_0208df6c(pRecord)];
        }
        func_ov026_02086af4(pRecord, nOwned);
    } else {
        func_ov026_02086af4(0, -1);
    }
    func_ov026_0208a774();
    return pfnNext;
}
