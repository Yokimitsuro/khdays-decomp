/* func_ov026_0208a658 -- Ov008_CloseBuyDialog: the inverse of
...
extern void  func_ov026_020835e0(void *pTracker, int nCell);             /* ov008_InvokeCallback40 */
extern void *func_ov026_0208427c(void *pWidgets, int nId);               /* FindEntryById */
extern void  func_ov026_020843e8(void *pWidgets, void *pWidget, int bVisible); /* SetEntrySlotsVisible */
...
void func_ov026_0208a658(void)
{
    ...
    func_ov026_020835e0(ctx->tracker, func_ov026_02083530(ctx->tracker, TAG_BUY_DIALOG));
    func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, WIDGET_DIALOG_A), 0);
    func_ov026_020843e8(pWidgets, func_ov026_0208427c(pWidgets, WIDGET_DIALOG_B), 0);
