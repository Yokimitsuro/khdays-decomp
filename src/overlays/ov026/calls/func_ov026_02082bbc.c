...
extern void func_ov026_02083494(int owner, void *obj, unsigned short kind);
void func_ov026_02082bbc(int param_1, int param_2) {
    ...
    for (i = 0; i < n; i++) {
        ...
        func_ov026_02083494(param_1, obj, *(unsigned short *)(p + 4));
        p += *(int *)p;
    }
}
