 ...
 * four sub-values out of param_2 via func_ov026_02084544, threading the cursor. */
...
extern short *func_ov026_02084544(short **cursor, short *in);
unsigned int *func_ov026_02084588(int param_1, short *param_2) {
    short *cur;
    ...
    *(int *)((char *)n + 0x38) = *(u16 *)(param_1 + 0x2e);
    n[0xf] = (unsigned int)func_ov026_02084544(&cur, param_2);
    n[0x10] = (unsigned int)func_ov026_02084544(&cur, cur);
    n[0x11] = (unsigned int)func_ov026_02084544(&cur, cur);
    n[0x12] = (unsigned int)func_ov026_02084544(0, cur);
    return n;
}
