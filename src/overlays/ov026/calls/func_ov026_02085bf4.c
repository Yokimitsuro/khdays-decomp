/* func_ov026_02085bf4 -- draw a string with a 1px drop shadow: renders it once offset by (+1,+1)
...
void func_ov026_02085bf4(int param_1, int param_2, int param_3, int param_4, int param_5, unsigned int param_6) {
