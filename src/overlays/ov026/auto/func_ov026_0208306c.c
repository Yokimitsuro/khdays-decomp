/* func_ov026_0208306c -- re-resolve which entry of this tag-tracker table the pointer is over,
 * and notify on change.
 *
 * The table asks func_ov026_02082e5c for the current probe: a `struct key`
 ...
 *     probe point (func_ov026_02082c9c). That entry becomes the active one
...
extern int func_ov026_02082e5c(int obj, struct key *out);
extern void *NNS_FndGetNextListObject(void *list, void *prev);
extern int func_ov026_02082c9c(unsigned int a, unsigned int b, int e);
extern void MI_CpuCopy8(void *dst, void *src, unsigned int n);
void func_ov026_0208306c(unsigned int *param_1, unsigned int param_2, unsigned int param_3,
    ...
    if (!func_ov026_02082e5c((int)param_1, &k)) goto done;
