/* Idle float tick of the ov279 enemy. The +0x5c phase advances by the owner's
 ...
 * 0x80). A target found by func_ov279_020d0640 (kept at +8) requests sub-state 6 and ends the tick.
 ...
 * heading and the tick hands over to func_ov279_020d12e0. */
typedef struct { int x, y, z; } Vec3;

#define ANG2IDX(a) ((unsigned short)(((long long)(a) * 0x28be60db9391LL + 0x80000000000LL) >> 44) >> 4)
#define FX_MUL(a, b) ((int)(((long long)(a) * (b) + 0x800) >> 12))

extern int func_ov279_020d0640(int owner);
...
extern void func_ov279_020d12e0(int *node);
...
void func_ov279_020d1110(int *node)
{
    ...
    state[2] = func_ov279_020d0640(*state);
    if (state[2] != 0) {
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov279_020d12e0);
}
