/*
 * func_ov279_020d1434 -- x3. AI-state tick: fire, then face the target with a look-at orientation.
...
extern void func_ov279_020d14e8(void);

void func_ov279_020d1434(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov279_020d14e8);
}
