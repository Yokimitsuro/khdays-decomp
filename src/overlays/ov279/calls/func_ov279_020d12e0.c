 ...
 * target found by func_ov279_020d0640 (kept at +8) requests sub-state 6 and ends the tick; otherwise
 * once the +0x50 delay runs out the tick hands over to func_ov279_020d10b8. */
...
extern void func_ov279_020d10b8(int *node);

void func_ov279_020d12e0(int *node)
{
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov279_020d10b8);
}
