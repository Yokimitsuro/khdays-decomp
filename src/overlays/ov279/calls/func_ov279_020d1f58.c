 ...
 * attack chosen by func_ov279_020d0750 ends the tick; within 7.0 of the target (gap between the
 * collision radii) the tick hands over to func_ov279_020d1d30, and beyond the owner's +0x2d8 leash
...
extern void func_ov279_020d1d30(int *node);

void func_ov279_020d1f58(int *node)
{
    int target;
    ...
    if (gap <= 0x7000) {
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov279_020d1d30);
        return;
    }
