/* Reposition tick of the ov279 enemy. Every 1.0 of the +0x50 timer (fed by
 ...
 * from its +0x74 point. The timer restarts and the tick hands over to func_ov279_020d285c. */
...
extern void func_ov279_020d285c(int *node);

void func_ov279_020d2708(int *node)
{
    ...
    state[0x14] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov279_020d285c);
}
