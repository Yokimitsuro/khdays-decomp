/* Circle tick of the ov279 enemy. Gives up (sub-state 2) once the +8 target
 ...
 * height) and the +0x1c facing aims at the target. An attack chosen by func_ov279_020d0750 ends the
 * tick; beyond 14.0 the tick goes back to func_ov279_020d1f58, within 3.0 on to
 * func_ov279_020d1b04, and beyond the owner's +0x2d8 leash sub-state 2 is requested. */
...
extern int func_ov279_020d0750(int *node);
extern void func_0203c634(int *node, int slot, void *cb);
extern const short data_0203d210[];
extern const Vec3 data_02042264;
extern void func_ov279_020d1f58(int *node);
extern void func_ov279_020d1b04(int *node);

void func_ov279_020d1d30(int *node)
{
    int target;
    ...
    if (func_ov279_020d0750(node) != 0) {
        func_0203c634(node, *(signed char *)((char *)node + 0x20), 0);
        return;
    }
    if (gap > 0xe000) {
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov279_020d1f58);
        return;
    }
    if (gap < 0x3000) {
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov279_020d1b04);
        return;
    }
