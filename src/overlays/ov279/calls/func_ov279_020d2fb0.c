/* Carry tick of the ov279 enemy. When the +0x3ac grab partner's +0x4ec
 ...
 * while the target is flagged 0x10; it is pushed out of the world (func_ov279_020d0888, the
...
extern void func_ov279_020d0888(int world, Vec3 *point, int unused, int radius);
...
void func_ov279_020d2fb0(int *node)
{
    int target;
    ...
    *(Quat *)(state + 3) = *(Quat *)(state + 7);
    ...
    func_ov279_020d0888(world, &pos, rad, *(int *)(state[2] + 0x80));
    ...
    *(int *)(*(int *)(*state + 0x3ac) + 0x58) = 0;
    ...
    func_ov279_020d0888(world, &pos, rad, *(int *)(*state + 0x80));
    func_ov107_020c5c54(*state, &pos);
