/* Effect message hook of the ov279 enemy. A "spawned" message (kind 5) picks
 * by byte 3: slots 0/1 spawn pair 2 (kind 0x15) at the packed position (bytes 5..) and, clearing
 * (slot 0) or raising (slot 1) bit 4 of +0x1ae, restart the +0x3a4 aura (func_ov279_020d33f0 with
...
extern int func_ov279_020d33f0(char *self, int on);
extern void func_ov107_020c7500(char *self, u8 *msg, int arg);

void func_ov279_020cffe8(char *self, u8 *msg, int arg)
{
    if (msg[2] == 5) {
        switch (msg[3]) {
        case 0:
        case 1:
            ...
            if (msg[3] == 0) {
                *(u16 *)(self + 0x1ae) &= ~0x10;
                *(int *)(self + 0x3a4) = func_ov279_020d33f0(self, 0);
            } else {
                *(u16 *)(self + 0x1ae) |= 0x10;
                *(int *)(self + 0x3a4) = func_ov279_020d33f0(self, 1);
            }
            break;
        case 2:
        ...
        case 3:
            ...
            *(int *)(self + 0x3b0) = func_ov107_020cb040(self, 0x167, 6, 0, self + 0xa0);
            break;
        case 4:
