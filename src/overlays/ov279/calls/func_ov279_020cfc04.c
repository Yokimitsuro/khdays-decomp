/* func_ov279_020cfc04 -- refresh sub-node #0's local transform, then publish it.
 * Copies the 4-word constant at data_ov279_020d357c into a scratch, runs func_0202ef54 in place
...
extern struct blk4 data_ov279_020d357c;

void func_ov279_020cfc04(int arg0, Self *self) {
    struct blk4 scratch = data_ov279_020d357c;
