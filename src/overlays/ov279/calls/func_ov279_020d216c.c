/* Bite entry of the ov279 enemy: effect 1 spawns at the +0x4c point,
 ...
 * timer restarts and the tick hands over to func_ov279_020d2250. */
...
extern void func_ov279_020d2250(int *node);

void func_ov279_020d216c(int *node)
{
    ...
    *(unsigned short *)(*state + 0x100 + 0xae) |= 1;
    ...
    state[0x14] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov279_020d2250);
}
