/* Tick handler of the ov279 enemy. A flagged (+0x1c4 & 0xa), idle (+0x1c7 ==
 ...
 * 0x480) is written into the +0x38c item's and the +0x388 part's +0x58 and the base tick runs. */
...
void func_ov279_020d0174(int self)
{
    Segment seg;
