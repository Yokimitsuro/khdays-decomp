/* Grab approach finish of the ov279 enemy. The owner is set 0.94 behind the
 * +8 target (its rig yaw turned half a circle), effect 0 spawns there and reaction 0x167 mode 5
...
extern void func_ov279_020d2a04(int *node);

void func_ov279_020d285c(int *node)
{
    ...
    state[0x14] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov279_020d2a04);
}
