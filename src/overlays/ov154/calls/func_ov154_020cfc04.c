 ...
 * +0x388 on the +0x22c list; +0x398 is built by func_ov154_020d0194 and sound 0x13c is loaded. */
...
extern struct Ov153Vec3 data_ov154_020d1c54;
...
extern void func_ov154_020cfff0(void);
extern void func_ov154_020d0018(void);
extern void func_ov154_020d005c(void);
extern void func_ov154_020d10b0(void);
extern void func_ov154_020d0f7c(void);
extern void func_ov154_020cfedc(void);
extern void *func_ov154_020d0194(int *self);
...
void func_ov154_020cfc04(int param)
{
    ...
    *(void **)(param + 0x2c) = func_ov154_020cfff0;
    *(void **)(param + 0x10) = func_ov154_020d0018;
    *(void **)(param + 0x34) = func_ov154_020d005c;
    *(void **)(param + 0x1e0) = func_ov154_020d10b0;
    *(void **)(param + 0x1d0) = func_ov154_020d0f7c;
    *(void **)(param + 0x1dc) = func_ov154_020cfedc;
    ...
    *(u16 *)(param + 0x100 + 0xae) |= 0x10;

    {
        ...
        ((void **)self)[0xe3] = func_0203bee8(self[0xe1], 1, data_ov154_020d1ccc);
        ...
        *((int **)self)[0xe2] = func_ov107_020c3210(&req);
        ((void **)self)[0xe6] = func_ov154_020d0194(self);
        func_0203355c(0x13c);
    }
}
