/* Creates the ov049 enemy's sub-object (x4: ov049/068/087/104; the ov047 shape): allocates it
 * from the default expanding heap, hangs it off the runtime at +0x2644, resets it with kind 1,
...
extern void func_ov068_020b6ba8(void);
extern int data_ov068_020b74ac;

void func_ov068_020b6754(char *self)
{
    struct PanelSubCfg cfg[2];

    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x30);
    func_ov022_020911f0(*(void **)(self + 0x2000 + 0x644), 0, 1);
    ...
    cfg[1] = cfg[0];
    cfg[1].field0c = 0x1333;
    cfg[1].flags00 |= 0x200;
    cfg[1].field38 |= 0x20;

    func_ov022_02091298(*(void **)(self + 0x2000 + 0x644), self,
                        &data_ov068_020b74ac, cfg, 2, 10);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) = (void *)&func_ov068_020b6ba8;
}
