...
u8 func_ov068_020b6d18(char *self)
{
    ...
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov068_020b74c0, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov068_020b74d0, *(u8 *)(self + 9), 1, *(char **)(*(char **)(self + 0x2644) + 0xc) + 0x28);
    *(u8 **)(block + 0x348) = func_ov022_020b14a4(data_ov068_020b74e4, *(u8 *)(self + 9), 2, rig + 4);
