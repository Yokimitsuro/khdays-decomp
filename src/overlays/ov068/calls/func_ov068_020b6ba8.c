...
extern void (*data_ov068_020b7448[])(char *pGroup, char *pPart, int nArg);

void func_ov068_020b6ba8(char *pGroup, int nArg)
{
...
do {
    ...
    nKind = *(signed char *)(pPart + 2);
        ...
        if (nKind != 0) {
            ...
            data_ov068_020b7448[*(signed char *)(pPart + 2)](pGroup, pPart, nArg);
        }
        i++;
        off += 0x1c8;
