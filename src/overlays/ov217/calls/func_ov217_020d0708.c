/* func_ov217_020d0708: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern u8 data_ov217_020d285c[];
extern const s16 data_0203d210[];

int func_ov217_020d0708(char *self, char *attacker, unsigned int *evt)
{
    u8 pickA[2];
    u8 pickB[2];
    VecFx32 delta;
    ...
    *(char **)(node + 3) = attacker;
    if ((int)evt[10] > 0) {
            ...
            if (EW(evt) & 0x22) {
                *(Pair2 *)pickA = *(Pair2 *)&data_ov217_020d285c[0];
                func_ov107_020c5af8(self, 0x144, pickA[*((u8 *)node + 0x72)],
                                    *(void **)(node + 4));
            } else {
                *(Pair2 *)pickB = *(Pair2 *)&data_ov217_020d285c[2];
                func_ov107_020c5af8(self, 0x144, pickB[*((u8 *)node + 0x72)],
                                    *(void **)(node + 4));
            }
            *((u8 *)node + 0x72) ^= 1;
        }
