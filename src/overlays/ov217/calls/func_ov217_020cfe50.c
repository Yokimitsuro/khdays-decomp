/* func_ov217_020cfe50: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern void *func_ov217_020d265c(void *self);
...
extern KindTable data_ov217_020d2824;
extern const char data_ov217_020d288c[];
extern const char data_ov217_020d2898[];
extern const VecFx32 data_02041dc8;

extern void func_ov217_020cfc08(void);
extern void func_ov217_020cfcf0(void);
extern void func_ov217_020d0218(void);
extern void func_ov217_020d0270(void);
extern void func_ov217_020d02fc(void);
extern void func_ov217_020d06ac(void);
extern void func_ov217_020d0538(void);
extern void func_ov217_020d0708(void);
extern void func_ov217_020d0634(void);
extern void func_ov217_020d0a38(void);
extern void func_ov217_020d0a64(void);

void func_ov217_020cfe50(char *self)
{
    KindTable kinds;
    ParamBlock params;
    SpawnSeed seed;
    ...
    *(void **)(self + 0x8) = (void *)func_ov217_020d0218;
    *(void **)(self + 0xc) = (void *)func_ov217_020d0270;
    *(void **)(self + 0x1c) = (void *)func_ov217_020d02fc;
    *(void **)(self + 0x30) = (void *)func_ov217_020d06ac;
    *(void **)(self + 0x34) = (void *)func_ov217_020d0538;
    *(void **)(self + 0x1d0) = (void *)func_ov217_020d0708;
    *(void **)(self + 0x1dc) = (void *)func_ov217_020d0634;
    *(void **)(self + 0x1e0) = (void *)func_ov217_020d0a38;
    *(void **)(self + 0x1e4) = (void *)func_ov217_020d0a64;
    ...
    *(char *)(self + 0x1c9) = 1;
...

    {
        ...
        *(void **)(self + 0x384) = rig;
        *(void **)((char *)rig + 0x74) = (void *)func_ov217_020cfc08;
    }
    *(char **)(*(char **)(self + 0x384) + 0x84) = self;
...

    {
        ...
        *(int *)(self + 0x438) = func_0203bdfc(*(void **)(self + 0x384), data_ov217_020d288c);

        {
            *(void **)(self + 0x420) = func_0203b898(func_ov107_020c9440(self, 0xa));
            *(void **)(*(char **)(self + 0x420) + 0x6c) = (void *)func_ov217_020cfcf0;
            *(char **)(*(char **)(self + 0x420) + 0x84) = self;
            func_0203c7ac(*(void **)(self + 0x420), 0);
            *(int *)(self + 0x434) = func_0203bdfc(*(void **)(self + 0x420), data_ov217_020d2898);
        }
    }
    ...
    velocity.y = 0x1800;
    velocity.z = 0;
    func_ov107_020c92b0(self, 0, 2, &velocity, 0xd9a);
    velocity.x = 0;
    velocity.z = 0;
    velocity.y = -0x1800;
    ...
    *(void **)(self + 0x3c0) = func_ov217_020d265c(self);
