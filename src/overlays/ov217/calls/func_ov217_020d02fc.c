/* func_ov217_020d02fc: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern void func_ov217_020d02a0(void *self);
extern void func_ov217_020d26a8(void *node, const VecFx32 *pos);
extern void func_ov107_020c7500(void *self, void *cmd, void *arg3);

void func_ov217_020d02fc(char *self, u8 *cmd, void *arg3)
{
    int rawZ;
    int rawY;
    int rawX;
    ...
    if (cmd[2] == 5) {
        ...
        case 4:
            *(void **)(self + (cmd[3] << 3) + 0x444) =
            ...
            if (cmd[3] == 2) {
                *(void **)(self + 0x43c) =
                    func_ov107_020cb040(self, 0x144, 5, 1, self + 0x3c8);
            }
            break;
        case 5:
            break;
        case 6:
            func_ov217_020d02a0(self);
            break;
        case 7:
            func_ov217_020d26a8(*(void **)(self + 0x3c0), &pos);
            break;
        }
    }
