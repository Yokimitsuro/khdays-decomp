 ...
 * it has got (v * 0x4ccd / 0x7f8) plus the three canned direction vectors. Once the sub-object's
...
extern void func_ov217_020d0a94(int *state, int kind, Ov216Params *p);
extern void func_0203c634(void *node, int idx, void *cb);
extern VecFx32 data_02042270;
extern VecFx32 data_02042258;
extern VecFx32 data_02042264;

void func_ov217_020d1934(int *node) {
    ...
    if (state[0x14] <= 0x7f8) {
        ...
        p.nSteps = state[0x14] * 0x4ccd / 0x7f8;
        p.v0c = data_02042270;
        p.v18 = data_02042258;
        p.v24 = data_02042264;
        p.bFlag = 1;
        func_ov217_020d0a94(state, 1, &p);
    }
