/* func_ov217_020d0a94: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
void func_ov217_020d0a94(struct Ov264Node *node, unsigned int kind, struct Ov264Params *params) {
    struct Vec4 origin;
    ...
    case 0:
    case 2:
        func_ov107_020c5af8(node->pOwner, 0x144, 9, node->nEffect10);
        break;
    }
}
