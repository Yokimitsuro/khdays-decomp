...
extern void func_ov217_020d05bc(void *a, int b, int c, void *d);
extern void func_0203c7ac(void *a, int b);
extern int data_ov217_020d2838[];

void func_ov217_020d0634(char *this) {
    int buf[9];
    int v;
    *(struct nine *)buf = *(struct nine *)data_ov217_020d2838;
    v = func_ov107_020c9440(this, buf[*(signed char *)(this + 0x310)]);
    func_ov217_020d05bc(*(void **)(this + 0x384), v,
