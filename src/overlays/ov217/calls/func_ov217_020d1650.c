...
extern void func_ov217_020d1708(void);

void func_ov217_020d1650(int *node) {
    ...
    func_ov107_020c5af8(*state, 0x144, 6, state[4]);
    func_0203c634(node, *(signed char *)(node + 8), func_ov217_020d1708);
}
