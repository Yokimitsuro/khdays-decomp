...
extern void func_ov217_020d0a94(int *state, int a, int b);
extern void func_ov217_020d1934(void);
extern short data_0203d210[];

void func_ov217_020d177c(int *self) {
    ...
    if (((LandingFlag *)(*state + 0x17a))->hasLanding) {
        *(struct Vecx32 *)(state + 0xe) = *(struct Vecx32 *)(*state + 0x180);
        ...
        state[0x14] = 0;
        func_0203c634((int)self, *(signed char *)((int)self + 0x20), func_ov217_020d1934);
    } else {
        func_ov217_020d0a94(state, 1, 0);
    }
}
