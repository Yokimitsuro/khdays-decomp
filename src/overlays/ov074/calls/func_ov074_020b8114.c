...
extern void func_ov074_020b8180(int a);
extern int func_02020a9c(void);
extern void func_ov074_020b8910(int a);
extern void func_ov022_020a4798(int a, int b, int c);
extern void func_ov022_0209fb24(void);
void *func_ov074_020b8114(int param) {
    int obj = func_02023c00();
    func_ov074_020b8180(param);
    if (func_02020a9c() != 0x2a)
        func_ov074_020b8910(obj);
