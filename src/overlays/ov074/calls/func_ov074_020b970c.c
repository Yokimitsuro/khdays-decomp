...
extern void func_ov074_020b8c24(char *self);
extern void func_ov074_020b8dd0(char *self);
extern char *data_ov074_020b9b80;

void *func_ov074_020b970c(char *self)
{
    int r;
    Vec3 d;
    Vec3 sample;
    ...
    if (*(int *)(self + 0x7b0) == 0) {
        if (*(int *)rig == 0) {
            func_ov074_020b8c24(self);
        } else {
            func_ov074_020b8dd0(self);
        }
