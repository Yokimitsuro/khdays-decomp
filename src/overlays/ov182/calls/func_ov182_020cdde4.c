...
extern void func_ov182_020cdfb0(void);
extern void func_ov182_020cdff8(void);
extern void func_ov182_020ce098(void);
extern void func_ov182_020ce0fc(void);
extern void func_ov182_020ce220(void);
extern void func_ov182_020ce4bc(void);
extern void func_ov182_020ce26c(void);
extern void func_ov182_020ce068(void);
...
void func_ov182_020cdde4(int param)
{
    ...
    *(void **)(param + 0x08) = func_ov182_020cdfb0;
    *(void **)(param + 0x0c) = func_ov182_020cdff8;
    *(void **)(param + 0x20) = func_ov182_020ce098;
    *(void **)(param + 0x1c) = func_ov182_020ce0fc;
    *(void **)(param + 0x30) = func_ov182_020ce220;
    *(void **)(param + 0x1e0) = func_ov182_020ce4bc;
    *(void **)(param + 0x1d0) = func_ov182_020ce26c;
    *(void **)(param + 0x1dc) = func_ov182_020ce068;
    ...
    *(u16 *)(param + 0x100 + 0xae) |= 0x10;

    {
        ...
        ((void **)self)[0xe4] = func_ov107_020c9e50(func_ov107_020c9440(self, 1), data_ov182_020d086c);
