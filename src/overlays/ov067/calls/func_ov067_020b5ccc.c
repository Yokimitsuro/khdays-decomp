...
extern void func_ov067_020b6228(char *self);
extern void func_ov067_020b6668(char *self, char *rig);
extern void func_ov067_020b63fc(char *self, char *rig);
extern void func_ov067_020b667c(char *self, char *rig);
extern void func_ov022_020a384c(char *self, int mode);
extern char *data_ov067_020b7380;

void func_ov067_020b5ccc(char *self, int mode)
{
    ...
    case 0:
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov067_020b6228(self);
        }
        break;
    case 1:
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov067_020b6668(self, rig);
        }
        break;
    case 2:
        break;
    ...
    case 5:
        if (*(int *)(self + 0x6bc) != mode) {
            *(int *)rig = 0;
            ...
            func_ov067_020b63fc(self, rig);
            func_ov067_020b667c(self, rig);
        }
        reached = mode;
        mode = 0x2f;
        break;
