...
extern void func_ov067_020b6ba8(void);
extern void func_ov067_020b6d8c(void);
extern void func_ov067_020b7048(void);

void *func_ov067_020b5e0c(char *self, int msg)
{
    ...
    switch (msg - 0x21) {
    case 0:
        next = (void *)&func_ov067_020b6ba8;
        (*(void (**)(char *, int))(self + 0x664))(self, 0x2f);
        break;
    case 1:
        next = (void *)&func_ov067_020b6d8c;
