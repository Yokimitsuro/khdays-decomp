/* Attack burst of the ov067 enemy (x4: ov048/067/086/103): every third tick of the +0x7b0 timer
...
extern struct GlobalState *data_ov067_020b7380;
...
int func_ov067_020b68c8(struct Actor *self)
{
    ...
    rigBytes = (u8 *)data_ov067_020b7380 + 0x2c2c;
    rem = angle % 3;
    next = 0;
    if (rem == 0) {
