...
extern void func_ov160_020ced50(void);
extern void func_ov160_020ced80(void);
extern void func_ov160_020cedb8(void);
extern void func_ov160_020cee2c(void);

void func_ov160_020cebc0(char *self)
{
    struct Ov160Pose pose = data_ov160_020cf7c4;

    *(void **)(self + 0x8) = func_ov160_020ced50;
    *(void **)(self + 0xc) = func_ov160_020ced80;
    *(void **)(self + 0x1c) = func_ov160_020cedb8;
    *(void **)(self + 0x30) = func_ov160_020cee2c;
    {
    ...
    *(int *)(self + 0x384) = func_0203b898(func_ov107_020c9440(*(int *)(self + 0x38c), 6));
    ...
    func_0203ca9c((void *)(*(int *)(self + 0x384) + 4), 0x2000);
