/* Start the ov160 leap: reseed the countdown from the owner's frame rate,
...
typedef struct Ov160ActionNode {
    void *pOwner;
    Ov160MoveState *pState;
    void *apHandlers[6];
...
extern void func_ov160_020cd478(Ov160ActionNode *node);
extern const short data_0203d210[];

void func_ov160_020cd33c(Ov160ActionNode *node)
{
    Ov160MoveState *state = node->pState;
    ...
    state->vVelocity.y = 0x400;
    {
        ...
        int nNextHandler = (int)func_ov160_020cd478;
        Ov160ActionNode *pNextNode = node;
