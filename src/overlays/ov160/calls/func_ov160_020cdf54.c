/* Spawn a registry entry (func_0203c5c0, size 0x3c, cbs ce190/ce234) into *entry, stash the
...
extern void func_ov160_020ce2c4(void);
extern void func_ov160_020ce220(void);
int func_ov160_020cdf54(int param_1, int param_2, int param_3, int param_4) {
    int *entry;
    int r = func_0203c5c0(*(int *)(param_1 + 0x3c), 100, 0x3c,
                          &func_ov160_020ce220, &func_ov160_020ce2c4, &entry);
    entry[0] = param_1;
    entry[1] = param_2;
    entry[2] = param_3;
    entry[3] = param_4;
