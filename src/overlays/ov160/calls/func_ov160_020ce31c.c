/* func_ov160_020ce31c -- the fall tick: drop the object, orient it to the surface it is over, and
 ...
 *
 * The probe is a straight -0x32000 Y ray (func_ov160_020ce02c); when it finds something, the hit
 ...
 *
 * The timer at +0x28 runs to 0x1000, then resets and hands off to func_ov160_020ce474.
 *
...
extern int func_ov160_020ce02c(int *ctx, const VecFx32 *ray, VecFx32 *hit);
...
extern void func_ov160_020ce474(void);
...
void func_ov160_020ce31c(int self) {
    int *ctx = *(int **)(self + 4);
    ...
    v.y = -0x32000;
    if (func_ov160_020ce02c(ctx, &v, &hit) != 0) {
    ...
    ctx[0xa] = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov160_020ce474);
}
