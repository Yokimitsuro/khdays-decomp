...
extern const char data_ov160_020cf800[];
extern void func_ov160_020cbfc4(int);
int func_ov160_020cbf38(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x3b0);
    *(signed char *)(obj + 0x19c) = 23;
    OS_SPrintf(buf, data_ov160_020cf800, 23);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov160_020cbfc4;
