/* Aimed attack wait tick of the ov160 enemy: the +0x18 direction takes the owner's +0xa0 basis
 * turned by the +0x3a0 aim (9f48) and scaled by its reach. The +0x3c timer accumulates the
 * owner's rate: in phase 0 (+0x54) past 0x22aa the data_ov160_020cf794[8..9] message pair goes
 * to the +0x24 hook (arg 4), phase 1 begins and reaction 0x151 mode 6 fires at the +0x398
 * bone's +0x14; in phase 1 past 0x23bb the +0x3a4 emitter is launched (func_ov160_020ceb4c)
...
extern void func_ov160_020ceb4c(int emitter, void *at, Vec3 *dir);
extern int func_02023eb4(int bound);
extern void func_0203c634(int *node, int slot, void *cb);
extern unsigned short data_ov160_020cf794[];
extern short data_0203d210[];

void func_ov160_020cdc04(int *node)
{
    ...
    reach = func_ov107_020c9f48(*(int *)(*state + 0x3a0), &aim);
    ...
    if (*(unsigned char *)((char *)state + 0x54) == 0 && state[0xf] > 0x22aa) {
        pp = pair;
        pp[1] = data_ov160_020cf794[9];
        pp[0] = data_ov160_020cf794[8];
        cb = *(void (**)())(*state + 0x24);
        ...
        *(unsigned char *)((char *)state + 0x54) = 1;
        ...
        func_ov160_020ceb4c(*(int *)(*state + 0x3a4), (void *)(*(int *)(*state + 0x398) + 0x14), &dir);
