...
extern struct pt data_ov211_020d650c[];
extern void func_ov211_020d5184(void);

void func_ov211_020d50c0(int *self) {
    ...
    state[0x14] = 0x6000;
    pp = &pt;
    pp->b = data_ov211_020d650c[1].b;
    pp->a = data_ov211_020d650c[1].a;
    ...
    *(char *)((int)state + 0x66) = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov211_020d5184);
}
