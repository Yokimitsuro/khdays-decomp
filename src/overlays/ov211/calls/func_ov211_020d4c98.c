/*
 * func_ov211_020d4c98 -- x3 (ov210/211/282). Twin of Ov210_StrafeSameTarget (020d2b60) with the cross
...
extern void func_ov211_020d4d7c(void);

void func_ov211_020d4c98(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov211_020d4d7c);
}
