/*
 * func_ov211_020d445c -- x3 (ov210/211/282). AI-state tick: rebuild the steer vector; once the
...
extern void func_ov211_020d4500(void);

void func_ov211_020d445c(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov211_020d4500);
}
