/*
 * func_ov211_020d4c10 -- x3 (ov210/211/282). AI-state tick: acquire target, else timed recovery.
...
extern void func_ov211_020d4c98(void);

void func_ov211_020d4c10(int *self) {
    ...
    state[0xb] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov211_020d4c98);
}
