 ...
 * random angle, +0x40 clears and the tick hands over to func_ov211_020d6188. */
...
void func_ov211_020d5f60(int *node)
{
    ...
    *(u16 *)(*state + 0x60) = (u16)((v & ~0xff00) | (((((unsigned int)v << 0x10) >> 0x18 | 1) << 0x18) >> 0x10));
    ...
    state[0x10] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov211_020d6188);
}
