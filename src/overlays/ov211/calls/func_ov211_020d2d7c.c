/*
 * func_ov211_020d2d7c -- x3 (ov210/211/282). AI-state tick: pick a melee reaction toward the target.
...
extern void func_ov211_020d2f08(void);
extern int  data_02042258;

void func_ov211_020d2d7c(int self) {
    ...
    if (state[8] != 0) {
        ...
        if (VEC_DotProduct(&v, &w) > 0) {
            if (((struct b17a *)(*state + 0x17a))->b0) {
                ...
                state[10] = a;
                state[9] = a;
                func_0203c634(self, *(signed char *)(self + 0x20), (int)&func_ov211_020d2f08);
                return;
            }
