 ...
 * (data_ov211_020d652a, flag 2) carries the +4 point raised 6.0, then the third 4-byte command of
...
extern const Cmd14 data_ov211_020d652a;
extern void func_ov211_020d4050(int *node);

void func_ov211_020d3e5c(int *node)
{
    ...
    *(u16 *)(*state + 0x1ae) |= 1;
    ...
    {
        u16 *p = cmd;
        p[1] = data_ov211_020d650c[5];
        p[0] = data_ov211_020d650c[4];
    ...
    *(u8 *)((char *)state + 0x64) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov211_020d4050);
}
