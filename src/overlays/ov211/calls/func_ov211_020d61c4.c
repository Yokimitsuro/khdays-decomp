 ...
 * func_ov211_020d5ecc. The end point sits on the circle of radius +0x3c around the target's
...
extern void func_ov211_020d5ecc(int *node);
extern void func_ov211_020d645c(int *node);

void func_ov211_020d61c4(int *node)
{
    ...
    if (state[0x11] == 0) {
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov211_020d5ecc);
        return;
    }
    {
        Vec3 end;
    ...
    *(Vec3 *)(*state + 0xf0) = data_02041dc8;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov211_020d645c);
}
