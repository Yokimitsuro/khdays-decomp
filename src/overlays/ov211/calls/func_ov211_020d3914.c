/*
 * func_ov211_020d3914 -- x3. AI-state entry: set the aim direction, notify, arm and dispatch.
...
extern struct h2 data_ov211_020d650c;
extern void func_ov211_020d3a24(void);

void func_ov211_020d3914(int *self) {
    ...
    *(char *)((int)state + 0x67) = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov211_020d3a24);
}
