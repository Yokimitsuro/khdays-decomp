/*
 * func_ov211_020d21a8 -- x3. Set up a sub-object (arg5) bound to owner arg2. Init it (0202a440),
...
void func_ov211_020d21a8(int arg1, int arg2, int arg3, int arg4, int arg5) {
    int p;
