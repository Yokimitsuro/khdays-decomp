/*
 * func_ov211_020d48f8 -- x3 (ov210/211/282). AI-state tick: acquire target, else enter a timed
 * recovery.
...
extern void func_ov211_020d4980(void);

void func_ov211_020d48f8(int *self) {
    ...
    state[0xb] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov211_020d4980);
}
