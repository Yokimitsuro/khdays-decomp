/*
 * func_ov211_020d4a64 -- x3 (ov210/211/282). AI-state tick: strafe the same target on a timer, fire.
...
extern void func_ov211_020d4b58(void);

void func_ov211_020d4a64(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov211_020d4b58);
}
