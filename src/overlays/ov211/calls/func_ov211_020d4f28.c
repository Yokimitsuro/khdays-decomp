/* func_ov211_020d4f28 -- enter the state: play mode 0x15, seed the offset vector at ctx+0x54 by
...
extern void func_ov211_020d4f78(void);
extern VecFx32 data_02042264;

void func_ov211_020d4f28(int self) {
    int *ctx;
    ...
    ctx[0xb] = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov211_020d4f78);
}
