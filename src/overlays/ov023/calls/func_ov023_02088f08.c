/* func_ov023_02088f08 -- Ov023_ActorStartTrack: put an actor on a motion track.  An actor
...
void func_ov023_02088f08(Ov023Actor *pActor, char *pszTrack, int nTurnState)
{
    Ov023AnimCtl *pAnim;
    ...
    pActor->nFlags |= 0x40;
    pActor->nTrack = func_ov023_02087510(&pActor->pEntity->wFlags, pszTrack);
