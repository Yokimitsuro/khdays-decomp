/* func_ov023_02087018 -- Ov023_CmdStepLightFade: one frame of the light fade started by
...
int func_ov023_02087018(Ov023ScriptCtx *pCtx, u8 *pOperand)
{
    ...
    func_ov023_02089cdc(pCtx->pEvent->nFadeLevel, nLight);
