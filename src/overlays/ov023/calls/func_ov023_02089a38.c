/* func_ov023_02089a38 -- Ov023_DrawNoiseTile: draw one tile of the noise overlay at its
...
void func_ov023_02089a38(Fx32Pair *pTile)
{
    VecFx32 vPos;
    u32 nPolygonAttr;
    u32 nColor;
    ...
    func_02015880(&vPos);
    func_020157c4();
    func_01ff9f00(0x2b2a, &data_ov023_0208a7c0->nTexImageParam, 2);
