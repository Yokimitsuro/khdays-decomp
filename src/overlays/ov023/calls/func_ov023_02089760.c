/* func_ov023_02089760 -- Ov023_LoadNoiseTexture: load the noise overlay's texture into the
 * state block data_ov023_0208a7c0 points at.  The resource is opened (0201ef9c, kind 0xd),
...
void func_ov023_02089760(const char *pszTexture)
{
    ...
    data_ov023_0208a7c0->nWidth = (u16)(texData->extraParam & 0x7ff);
    data_ov023_0208a7c0->nHeight = (u16)((texData->extraParam >> 11) & 0x7ff);
    data_ov023_0208a7c0->nPlttBase = (u16)(plttOffset + plttBase);
    data_ov023_0208a7c0->nTexImageParam = (texData->texImageParam + texOffset) | 0x20000000;
