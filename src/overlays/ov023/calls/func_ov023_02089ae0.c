/* func_ov023_02089ae0 -- Ov023_DrawNoiseQuad: draw one tile of the noise overlay as a textured
...
extern void func_ov023_02089a38(Fx32Pair *pTile);                   /* Ov023_DrawNoiseTile */
...
void func_ov023_02089ae0(Fx32Pair *pTile)
{
    u32 nBegin;
    u32 nTexCoord0;
    u32 aVtx0[2];
    ...
    nWidth = data_ov023_0208a7c0->nWidth;
    nHeight = data_ov023_0208a7c0->nHeight;
    func_ov023_02089a38(pTile);
    nBegin = 1;
