/* func_ov044_020b3b64 -- spawn four particle emitters into the owner's emitter pool
...
extern void func_ov044_020b3c7c(int slot, int b);
extern void func_ov044_020b3c58(int slot);

void func_ov044_020b3b64(int self) {
