...
struct v3 { int a, b, c; };
extern void func_ov044_020b3ff4(void *p);
extern void func_ov044_020b4434(void *this);
extern void func_0202aa9c(void *p);

void func_ov044_020b42c0(char *this) {
    ...
    p = this + 0x234;
    for (i = 0; i < 8; i++) {
        func_ov044_020b3ff4(p);
        p += 0x170;
    }
    func_ov044_020b4434(this);
