...
extern void func_ov032_020b43dc(int root);
...
extern Params data_ov032_020b5710;

void func_ov032_020b3524(char *self)
{
    int root = *(int *)&data_ov032_020b58c0;
    ...
    func_ov032_020b43dc(root);
    p = data_ov032_020b5710;
