...
extern void func_ov032_020b4a10(char *self, void *block);
extern void func_ov032_020b4ae8(char *self, void *block, int alt);
extern void func_ov032_020b4bd8(char *self, void *block);
extern void func_ov032_020b4e5c(char *self, int prev);   /* the callee ignores the second argument */

void func_ov032_020b3ba8(char *self, int mode)
{
    int sec = -1;
    int set = 0;
    int i;
    ...
    *(u8 *)(self + 0x2000 + 0xc30) &= ~4;
    ...
    case 0x2e:
        if (mode != *(int *)(self + 0x6bc)) {
            func_ov032_020b4e5c(self, *(int *)(self + 0x6bc));
        }
        break;
    case 0x2f:
        if (mode != *(int *)(self + 0x6bc)) {
            func_ov032_020b4a10(self, self + 0x278 + 0x2c00);
    ...
    case 0x31:
        if (mode != *(int *)(self + 0x6bc)) {
            ...
            func_ov032_020b4bd8(self, self + 0x278 + 0x2c00);
        }
        set = 4;
        break;
    case 0x32:
        if (mode != *(int *)(self + 0x6bc)) {
            func_ov032_020b4ae8(self, self + 0x278 + 0x2c00, set);
        }
        *(u8 *)(self + 0x2000 + 0xc30) |= 4;
        set = 3;
        break;
    case 0x30:
        if (mode != *(int *)(self + 0x6bc)) {
            func_ov032_020b4ae8(self, self + 0x278 + 0x2c00, 1);
        }
        *(u8 *)(self + 0x2000 + 0xc30) |= 4;
        set = 3;
        break;
