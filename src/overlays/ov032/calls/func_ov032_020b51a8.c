...
extern Vec3 data_ov032_020b56e8;
extern Vec3 data_ov032_020b56f4;
extern const short data_0203d210[];

int func_ov032_020b51a8(char *self)
{
    Vec3 vSpawn;
    Vec3 vAim;
    Vec3 vDir;
    ...
    Vec3 vOffset;
    int nRet = 0;
    int *pBlock = (int *)(*(int *)&data_ov032_020b58c0 + 0x278 + 0x2c00);
    int nLimit;
    ...
    *(int *)(self + 0x24) &= ~0x80;
    ...
    if (*(int *)(self + 0x4cc) >= 0 && pBlock[1] == 0) {
        int nIndex;
        vAim = data_ov032_020b56e8;
        vDir = data_ov032_020b56f4;
