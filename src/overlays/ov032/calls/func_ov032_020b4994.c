...
extern void func_ov032_020b4da4(int a);
...
void func_ov032_020b4994(int self)
{
    int base = *(int *)&data_ov032_020b58c0;
    Params p;
    char *blk;
    ...
    *(int *)blk = 0;
    *(int *)(blk + 4) = 0;
    func_0202a634((int)(blk + 0xc), &data_ov032_020b587c, 1, *(unsigned char *)(base + 9) + 7);
    p = data_ov032_020b5724;
    func_ov022_02092384(self + 0x2648, *(unsigned char *)(self + 9), 5, &p);
    func_ov032_020b4da4(base);
}
