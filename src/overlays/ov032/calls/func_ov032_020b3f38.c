...
extern void func_ov032_020b4be4(int self, char *block, int rate);
extern void func_ov032_020b4cb0(int self, char *block);
...
void func_ov032_020b3f38(int self)
{
    int i;
    int frame;
    int len;
    ...
    func_ov032_020b4be4(self, (char *)(self + 0x2e78), *(short *)(self + 0x2aba));
    func_ov032_020b4cb0(self, (char *)(self + 0x2e78));
