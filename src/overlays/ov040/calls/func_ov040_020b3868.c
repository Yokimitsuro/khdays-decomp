...
extern char data_ov040_020b4ad4[];
extern char data_ov040_020b4ae8[];
extern char data_ov040_020b4afc[];
extern Params data_ov040_020b4a44;

void func_ov040_020b3868(char *self)
{
    Params p;
    char *base = data_ov040_020b4b20;
    ...
    *(int *)(rig + 0x120) = 0xccd;
    ...
    func_0202a634((int)(rig + 0xc), data_ov040_020b4ad4, 1, *(u8 *)(base + 9) + 7);
    func_0202a634((int)(rig + 0x128), data_ov040_020b4ae8, 1, *(u8 *)(base + 9) + 7);
    func_0202a634((int)(rig + 0x238), data_ov040_020b4afc, 1, *(u8 *)(base + 9) + 7);
    p = data_ov040_020b4a44;
