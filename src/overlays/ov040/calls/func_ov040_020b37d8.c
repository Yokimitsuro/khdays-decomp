...
u8 func_ov040_020b37d8(char *self)
{
    ...
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov040_020b4ab0, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov040_020b4ac0, *(u8 *)(self + 9), 1, rig + 0xc);
