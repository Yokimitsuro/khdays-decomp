...
extern void func_ov040_020b399c(int self);
extern void func_ov040_020b3a3c(void *p, int a);
extern void func_ov022_020a4490(int self, int a, int b);
extern void func_ov040_020b3d18(int self, void *p);
extern void func_ov040_020b3d78(int self, void *p);
extern void func_ov040_020b3bcc(int self, void *p);
extern void func_ov022_020a384c(int self, int mode);

void func_ov040_020b34f0(int self, int mode) {
    int *p = (int *)(data_ov040_020b4b20 + 0x2c50);
    int id = -1;

    switch (mode - 0x2e) {
    case 0:
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov040_020b399c(self);
        }
        break;
    case 1:
        *p = 0;
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov040_020b3a3c((char *)p + 8, 0);
        }
        break;
    case 4:
        *p = 1;
    ...
    case 3:
        if (*(int *)(self + 0x6bc) != mode) {
            if (mode == 0x31) {
                func_ov040_020b3d78(self, p);
            } else {
                func_ov040_020b3bcc(self, p);
            }
        }
        break;
    }
