/* func_ov040_020b327c -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov040_020b34f0(void);
extern void WM_EndKeySharing_0x020b3614(void);
extern void func_ov040_020b3620(void);
extern void func_ov040_020b3490(void);
extern void func_ov040_020b34c8(void);
extern void func_ov040_020b3658(void);
extern void func_ov040_020b37d8(void);
extern void func_ov040_020b4258(void);
...
void func_ov040_020b327c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov040_020b4a88, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov040_020b4a9c, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov040_020b34f0;
    *(void **)(obj + 0x664 + 0x04) = (void *)&WM_EndKeySharing_0x020b3614;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov040_020b3620;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov040_020b3490;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov040_020b34c8;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov040_020b3658;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov040_020b37d8;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov040_020b4258;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov040_020b4a34) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov040_020b4a24) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov040_020b4a14) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov040_020b4a04) : -1;
