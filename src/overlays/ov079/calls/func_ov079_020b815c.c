/* func_ov079_020b815c -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov079_020b83d0(void);
extern void WM_EndKeySharing_0x020b84f4(void);
extern void func_ov079_020b8500(void);
extern void func_ov079_020b8370(void);
extern void func_ov079_020b83a8(void);
extern void func_ov079_020b8538(void);
extern void func_ov079_020b86b8(void);
extern void func_ov079_020b9138(void);
...
void func_ov079_020b815c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov079_020b9968, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov079_020b997c, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov079_020b83d0;
    *(void **)(obj + 0x664 + 0x04) = (void *)&WM_EndKeySharing_0x020b84f4;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov079_020b8500;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov079_020b8370;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov079_020b83a8;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov079_020b8538;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov079_020b86b8;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov079_020b9138;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov079_020b9914) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov079_020b9904) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov079_020b98f4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov079_020b98e4) : -1;
