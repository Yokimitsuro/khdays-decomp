...
extern char data_ov079_020b99b4[];
extern char data_ov079_020b99c8[];
extern char data_ov079_020b99dc[];
extern Params data_ov079_020b9924;

void func_ov079_020b8748(char *self)
{
    Params p;
    char *base = data_ov079_020b9a00;
    ...
    *(int *)(rig + 0x120) = 0xccd;
    ...
    func_0202a634((int)(rig + 0xc), data_ov079_020b99b4, 1, *(u8 *)(base + 9) + 7);
    func_0202a634((int)(rig + 0x128), data_ov079_020b99c8, 1, *(u8 *)(base + 9) + 7);
    func_0202a634((int)(rig + 0x238), data_ov079_020b99dc, 1, *(u8 *)(base + 9) + 7);
    p = data_ov079_020b9924;
