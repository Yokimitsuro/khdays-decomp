...
extern void func_ov079_020b887c(int self);
extern void func_ov079_020b891c(void *p, int a);
extern void func_ov022_020a4490(int self, int a, int b);
extern void func_ov079_020b8bf8(int self, void *p);
extern void func_ov079_020b8c58(int self, void *p);
extern void func_ov079_020b8aac(int self, void *p);
extern void func_ov022_020a384c(int self, int mode);

void func_ov079_020b83d0(int self, int mode) {
    int *p = (int *)(data_ov079_020b9a00 + 0x2c50);
    int id = -1;

    switch (mode - 0x2e) {
    case 0:
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov079_020b887c(self);
        }
        break;
    case 1:
        *p = 0;
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov079_020b891c((char *)p + 8, 0);
        }
        break;
    case 4:
        *p = 1;
    ...
    case 3:
        if (*(int *)(self + 0x6bc) != mode) {
            if (mode == 0x31) {
                func_ov079_020b8c58(self, p);
            } else {
                func_ov079_020b8aac(self, p);
            }
        }
        break;
    }
