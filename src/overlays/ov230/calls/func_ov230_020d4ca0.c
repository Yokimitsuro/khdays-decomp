/* c634 handler: run the guard func_ov230_020d303c; if it fails (<0), dispatch null. Else,
...
extern void func_ov230_020d4d50(void);
void func_ov230_020d4ca0(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(char *)((char *)obj + 0x61) = 0;
    obj[2] = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov230_020d4d50);
}
