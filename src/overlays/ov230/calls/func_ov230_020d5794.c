/* func_ov230_020d5794 -- drive the timed effect, then end the move.
 *
 ...
 * func_ov230_020d2af8: the object's own vector from ctx+0x34, three constant vectors, a scaled
...
extern void func_ov230_020d2af8(int *ctx, int a, int b, EffectParams *p);
...
void func_ov230_020d5794(int self) {
    int *ctx;
    EffectParams p;
    int t;
