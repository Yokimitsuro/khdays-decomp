/* func_ov230_020d4efc -- the wind-up: hold, then emit along the heading during a timing window.
 *
 ...
 * hands the anchor to func_ov230_020d2af8.
 *
...
extern void func_ov230_020d2af8(int *ctx, int kind, void *a, void *b);
...
void func_ov230_020d4efc(int self) {
    int *ctx;
    ...
    if (ctx[0x13] >= 0x990 && ctx[0x13] <= 0xf68) {
        ...
        func_ov230_020d2af8(ctx, 1, &anchor, 0);
    }
