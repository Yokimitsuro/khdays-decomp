/* func_ov230_020d5b30 -- face the target and close in, unless it is already too near.
 *
 ...
 * func_ov230_020d3028). Otherwise the tail is the same Y-rotation steering as
...
void func_ov230_020d5b30(int self) {
    int *ctx;
