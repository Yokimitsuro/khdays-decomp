...
extern void func_ov230_020d4198(void);
extern const short data_0203d210[];

#define ANG2IDX(a) ((unsigned short)(((long long)(a) * 0x28be60db9391LL + 0x80000000000LL) >> 44) >> 4)

void func_ov230_020d40a0(int *node)
{
    ...
    func_ov230_020d3028(*state, 0xa);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov230_020d4198);
}
