/* func_ov230_020d3ecc -- steer toward the target: rotate the owner's offset vector by the stored
 ...
 *   - func_ov230_020d303c returning negative (nothing to steer toward);
...
void func_ov230_020d3ecc(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
