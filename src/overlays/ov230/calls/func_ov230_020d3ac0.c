...
extern void func_ov230_020d3b90(int);
void func_ov230_020d3ac0(int param_1) {
    ...
    *(int *)(child + 0x50) = func_02023eb4(3) + 1;
    switch (*(int *)(child + 0x5c)) {
        ...
        case 2:
            ...
            func_ov230_020d3028(*(int *)child, 6);
            break;
        case 3:
            func_ov107_020c9264(*(int *)child, 5, 0);
            func_ov230_020d3028(*(int *)child, 4);
            break;
        case 1:
            func_ov107_020c9264(*(int *)child, 0xb, 0);
            func_ov230_020d3028(*(int *)child, 8);
            break;
    }
    func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov230_020d3b90);
}
