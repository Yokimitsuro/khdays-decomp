/* Contact sweep of the ov230 enemy: collects the entities in the given box (or
 ...
 * surface along the push, and the id bit is set. When anything was hit, reaction 0x147 mode 5
...
void func_ov230_020d2af8(int *state, int kind, Sphere *sphere, void *box)
{
    int hits[4];
    Vec3 push;
    Vec3 dir;
    ...
    case 0:
    case 5:
        func_ov107_020c5af8(*state, 0x147, 5, (void *)state[3]);
        break;
    case 1:
