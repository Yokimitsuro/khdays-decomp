/* Spin attack tick of the ov230 enemy. The +0x4c timer accumulates the frame-time; until bit 7
 ...
 * Reaction 0x147 modes 7 (from 0xbb0) and 8 (from 0x1430) fire once each (bits 0/1) at the
...
extern int func_ov230_020d303c(int *node);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_01ffa724(int scale, Vec3 *v, Vec3 *d);
extern void func_ov230_020d2af8(int *state, int kind, Sphere *sphere, void *box);
...
void func_ov230_020d464c(int *node)
{
    ...
    if (state[0x13] <= 0xbb0 && func_ov230_020d303c(node) < 0) {
    ...
    if (state[0x13] >= 0xbb0 && state[0x13] <= 0x1188) {
        ...
        func_ov230_020d2af8(state, 0, &sphere, 0);
        ...
        func_ov230_020d2af8(state, 5, &sphere, 0);
    }
    if ((*(u8 *)((char *)state + 0x61) & 1) == 0 && state[0x13] >= 0xbb0) {
        func_ov107_020c5af8(*state, 0x147, 7, (void *)state[3]);
        *(u8 *)((char *)state + 0x61) |= 1;
    }
    if ((*(u8 *)((char *)state + 0x61) & 2) == 0 && state[0x13] >= 0x1430) {
        func_ov107_020c5af8(*state, 0x147, 8, (void *)state[3]);
