/* func_ov230_020d3930 -- the approach tick: age the timer, re-acquire the target, and decide
 ...
 * func_ov230_020d2ed4, which decides whether to re-enter at all.
 *
...
void func_ov230_020d3930(int self) {
    ...
    *(int *)(ctx[0] + 0x3bc) = func_ov107_020cab14(ctx[0], 0);
    ...
    if (ctx[0x15] <= 0) {
        if (func_ov230_020d2ed4(self, range) == 0) {
            goto reset;
        }
