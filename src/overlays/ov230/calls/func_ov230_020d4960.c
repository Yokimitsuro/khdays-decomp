...
extern void func_ov230_020d3028();
extern void func_0203c634(void *obj, int idx, void *value);
extern short data_0203d210[];
extern void func_ov230_020d4a64(void);
void func_ov230_020d4960(int *node) {
    ...
    func_ov230_020d3028(*state, 0xd);
    state[0x13] = 0;
    *(signed char *)((char *)state + 0x61) = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov230_020d4a64);
}
