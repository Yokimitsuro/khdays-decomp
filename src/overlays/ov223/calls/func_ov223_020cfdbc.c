...
extern void func_ov223_020d020c(void);
extern void func_ov223_020d0264(void);
extern void func_ov223_020d0310(void);
extern void func_ov223_020d06ac(void);
extern void func_ov223_020d0288(void);
extern void func_ov223_020d02cc(void);
extern void func_ov223_020d05bc(void);
extern void func_ov223_020d0708(void);
extern void func_ov223_020d0628(void);
extern void func_ov223_020d0970(void);
extern void func_ov223_020d099c(void);
extern void *func_ov107_020c9440(char *self, int index);
extern int func_0203b898(void *item);
extern void func_ov223_020cfd80(char *self);
...
extern int func_ov223_020d3e24(char *self);
...
void func_ov223_020cfdbc(char *self)
{
    ...
    bounds.max.y = 0x2000;
    bounds.max.z = 0x2000;
    *(Callback *)(self + 0x8) = func_ov223_020d020c;
    *(Callback *)(self + 0xc) = func_ov223_020d0264;
    *(Callback *)(self + 0x1c) = func_ov223_020d0310;
    *(Callback *)(self + 0x30) = func_ov223_020d06ac;
    *(Callback *)(self + 0x28) = func_ov223_020d0288;
    *(Callback *)(self + 0x2c) = func_ov223_020d02cc;
    *(Callback *)(self + 0x34) = func_ov223_020d05bc;
    *(Callback *)(self + 0x1d0) = func_ov223_020d0708;
    *(Callback *)(self + 0x1dc) = func_ov223_020d0628;
    *(Callback *)(self + 0x1e0) = func_ov223_020d0970;
    *(Callback *)(self + 0x1e4) = func_ov223_020d099c;
    ...
    *(int *)(self + 0x3d8) = func_0203bdfc(*(int *)(self + 0x384), data_ov223_020d510c);
    *(int *)(self + 0x3dc) = func_0203bdfc(*(int *)(self + 0x384), data_ov223_020d5118);
    *(int *)(self + 0x3d4) = func_0203bdfc(*(int *)(self + 0x384), data_ov223_020d5128);
    *(int *)(self + 0x3e0) = func_0203bdfc(*(int *)(self + 0x384), data_ov223_020d5134);
    *(int *)(self + 0x3e4) = func_0203bdfc(*(int *)(self + 0x384), data_ov223_020d5140);
    *(int *)(self + 0x3fc) = func_ov107_020c9e50(func_ov107_020c9440(self, 0x24), data_ov223_020d514c);
    lift.x = 0;
    lift.y = -0x11ae;
    lift.z = 0;
    ...
    for (i = 0; i < 8; i++) {
        if (ids.id[i] >= 0) {
            ...
            func_ov107_020c9074(self, ((struct Ov223 *)self)->items[i].res = node);
    ...
    for (k = 0; k < 5; k++) {
        ...
        ((struct Ov223 *)self)->bodyShapes[k] = func_01fffca8(self + 0x22c, 0x10, 100);
        *((struct Ov223 *)self)->bodyShapes[k] = func_ov107_020c319c(&sph);
    ...
    for (i = 0; i < 4; i++) {
        ((struct Ov223 *)self)->helpers[i] = func_ov223_020d3e24(self);
    }
    func_0203355c(0x149);
}
