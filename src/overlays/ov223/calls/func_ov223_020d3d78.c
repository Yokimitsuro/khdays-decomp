/* func_ov223_020d3d78 -- retune, notify, and (in mode 1) start the homing move.
 ...
 * forwarded BY VALUE to func_ov223_020d4384 (itself variadic).
 *
 ...
 * `rest` is never read, and leaves `mode` in r1. Its sibling func_ov223_020d4384 has the same
...
extern void func_ov223_020d4384(int ctx, int mode, Vec3 a, Vec3 b);
...
void func_ov223_020d3d78(int self, int mode, int rest, ...) {
    int m;
    void (*notify)(int, int);
    ...
    *(int *)(self + 0x388) = 1;
    ...
    func_ov223_020d4384(*(int *)(self + 0x214), m, va_at(rest, 0xc), va_at(rest, 0x18));
}
