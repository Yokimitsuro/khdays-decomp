 ...
 * +0x78 target or 0x1100 without, reaction 0x149 fires at the +8 point in mode 0xa (0xb without
 ...
 * the tick hands over to func_ov223_020d2dd8. */
...
extern int func_ov223_020d1240(int *node, Vec3 *dir);
...
extern void func_ov223_020d2dd8(int *node);

void func_ov223_020d2b5c(int *node)
{
    ...
    if (func_ov223_020d1240(node, 0) < 0) {
    ...
    if ((*(u8 *)((char *)state + 0x75) & 1) == 0) {
        if ((state[0x1e] != 0 && state[0x17] >= 0x1320) || (state[0x1e] == 0 && state[0x17] >= 0x1100)) {
            func_ov107_020c5af8(*state, 0x149, state[0x1e] != 0 ? 9 : 0xa, (void *)state[2]);
            if (state[0x1e] == 0) {
                func_ov107_020c5af8(*state, 0x149, 5, (void *)state[2]);
            }
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov223_020d2dd8);
}
