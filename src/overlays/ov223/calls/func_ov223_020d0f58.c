/* Sub-state script of the ov223 enemy: runs while the +0x40c script id is the current sub-state and
 * none is pending. The +0x404 timer accumulates the node's rate; without the +0x408 hold it fires
 * reaction 0x149 at the +0xb0 point in mode 4 at 0x220, 5 at 0x1d38 and 0x11 at 0x1fe0 (bits 0/2/3
 ...
 * +0x41c/+0x420 clear. When the rig is free and either held or grounded, func_ov223_020d0ee0 (with
...
extern void func_ov223_020d0ee0(char *self, int hold);
extern const Vec3 data_02041dc8;

void func_ov223_020d0f58(char *self, int *node)
{
    Fx32 scratchZ;
    Fx32 scratchY;
    Fx32 scratchX;
    ...
    *(int *)(self + 0x404) += *(int *)(*node + 0x2c);
    if (*(int *)(self + 0x408) == 0) {
        if ((*(u8 *)(self + 0x400) & 1) == 0 && *(int *)(self + 0x404) >= 0x220) {
            *(u8 *)(self + 0x400) |= 1;
            func_ov107_020c5af8(self, 0x149, 4, self + 0xb0);
        }
        if ((*(u8 *)(self + 0x400) & 4) == 0 && *(int *)(self + 0x404) >= 0x1d38) {
            *(u8 *)(self + 0x400) |= 4;
            func_ov107_020c5af8(self, 0x149, 5, self + 0xb0);
        }
        if ((*(u8 *)(self + 0x400) & 8) == 0 && *(int *)(self + 0x404) >= 0x1fe0) {
            *(u8 *)(self + 0x400) |= 8;
            func_ov107_020c5af8(self, 0x149, 0x11, self + 0xb0);
        }
    ...
    func_ov223_020d0ee0(self, *(int *)(self + 0x408));
}
