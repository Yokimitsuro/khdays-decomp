 ...
 * the tracking step (func_ov223_020d1240) ends the state when negative, otherwise the +0x3fc
 ...
 * reaction 0x149 mode 5 at the +8 point. Once the +4 item goes idle (+0xad) the +0x78 target
...
extern int func_ov223_020d1240(int *node, int arg);
...
void func_ov223_020d31ac(int *node)
{
