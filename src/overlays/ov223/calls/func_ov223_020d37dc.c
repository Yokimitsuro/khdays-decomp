...
extern void func_ov223_020d09cc(int *state, int mode, void *params);
extern void func_0203c634(int *node, int slot, void *cb);

void func_ov223_020d37dc(int *node)
{
