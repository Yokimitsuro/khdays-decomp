/* func_ov041_020b3290 -- overlay boot: builds the enemy rig object and publishes it.
 *
...
extern void func_ov041_020b3530(void);
extern void func_ov041_020b3628(void);
extern void func_ov041_020b366c(void);
extern void func_ov041_020b34a4(void);
extern void func_ov041_020b3510(void);
extern void func_ov041_020b36f8(void);
extern void func_ov041_020b3698(void);
extern void func_ov041_020b43f8(void);

extern void *data_ov041_020b4d00;
extern int data_ov041_020b4c74;
extern int data_ov041_020b4c88;
extern int data_ov041_020b4c1c;
extern int data_ov041_020b4c3c;
extern int data_ov041_020b4c2c;
extern int data_ov041_020b4c0c;
...
void func_ov041_020b3290(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov041_020b4c74, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov041_020b4c88, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov041_020b3530;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov041_020b3628;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov041_020b366c;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov041_020b34a4;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov041_020b3510;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov041_020b36f8;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov041_020b3698;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov041_020b43f8;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov041_020b4c1c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov041_020b4c3c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov041_020b4c2c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov041_020b4c0c) : -1;
