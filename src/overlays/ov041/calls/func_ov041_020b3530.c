 ...
 */
extern void func_ov041_020b3c70(int *p);
extern void func_ov041_020b42a0(int *p);
...
void func_ov041_020b3530(int self, int mode) {
    int p = self + 0x2c84;
    int flag;
    int ret;
    ...
    case 0x2f:
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov041_020b3c70((int *)p);
            *(int *)(p + 0x664) = 0;
        }
        break;
    case 0x30:
        if (*(int *)(self + 0x6bc) != mode) {
            func_ov041_020b3c70((int *)(p + 0x110));
            func_ov041_020b42a0((int *)(p + 0x220));
            *(int *)(p + 0x664) = 1;
        }
        break;
    }
