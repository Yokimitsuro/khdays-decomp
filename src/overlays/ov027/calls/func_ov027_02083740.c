/* func_ov027_02083740 -- Ov027_PollMenu: read the game-over panel's input while no fade is
...
extern void  func_020235e8(int nFlag, int nValue, int nArg);        /* GameState_SetFlag */
...
void func_ov027_02083740(void)
{
    if (func_0201e428() == 0) {
        func_ov027_0208360c(&data_ov027_02084364->nCursor);
        if (data_0204c190 & 1) {
            func_02033b78(0, 1);
            switch (data_ov027_02084364->nCursor) {
            case 0:
                data_ov027_02084364->nMode = 2;
                if (data_ov027_02084364->bPrompt != 0) {
                    func_020235e8(0x20ea, 2, 1);
                }
                return;
            case 1:
                data_ov027_02084364->nMode = 2;
                func_020235e8(0x20ea, 2, 0);
                break;
            case 2:
                data_ov027_02084364->nMode = 4;
                break;
            }
            data_ov027_02084364->nMode |= 0x10;
            data_ov027_02084364->character.nSlot = 1;
        }
    }
