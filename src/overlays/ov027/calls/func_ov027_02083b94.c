/* func_ov027_02083b94 -- Ov027_LayoutMenuPanel: lay out the two-line game-over menu.  The
 * blink phases of the two lines are reset (line 0 dark, line 1 lit) and the three text strips
...
void func_ov027_02083b94(void)
{
    data_ov027_02084364->aBlink[0].nPhase = 0;
    data_ov027_02084364->aBlink[1].nPhase = 1;
    func_ov027_02083c1c(&data_ov027_02084364->panel, 2, 0xf, 6, 8, 0xe, 0xf, 2);
    func_ov027_02083c1c(&data_ov027_02084364->panel, 0, 0xf, 3, 8, 0x10, 0xf, 2);
    func_ov027_02083c1c(&data_ov027_02084364->panel, 1, 0, 6, 8, 0x12, 0xf, 2);
}
