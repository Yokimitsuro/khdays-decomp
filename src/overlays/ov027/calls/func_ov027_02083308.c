/* func_ov027_02083308 -- Ov027_UpdateModels: advance the game-over screen's model animations.
...
extern void  func_0202a818(Ov027Model *pModel, int nStep);         /* Anim_Advance */
extern void  func_0202aa9c(Ov027Model *pModel);                    /* Anim_Apply */
/* khdays: shared-bss */
int data_ov027_02084360 = 0;                                        /* the fade-out frame counter */
Ov027Scene *data_ov027_02084364 = 0;                                /* the scene work */

void func_ov027_02083308(void)
{
    int i;

    for (i = 0; i < data_ov027_02084364->nModels; i++) {
        func_0202a818(&data_ov027_02084364->aModel[i], 0x1000);
        func_0202aa9c(&data_ov027_02084364->aModel[i]);
    }
}
