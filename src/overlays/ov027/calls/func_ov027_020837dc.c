/* func_ov027_020837dc -- Ov027_StepScreenSwap: swap which screen shows the game-over 3D view.
...
void func_ov027_020837dc(void)
{
    data_ov027_02084364->nSwapTimer++;
    if (data_ov027_02084364->nSwapTimer == 30) {
        data_ov027_02084364->nSwapTimer = 0;
        *REG_DISPCNT = (*REG_DISPCNT & 0xffffe0ff) | 0x300;
    } else if ((int)(func_02020400(data_ov027_02084364->nSwapTimer, 15) >> 32) == 0) {
