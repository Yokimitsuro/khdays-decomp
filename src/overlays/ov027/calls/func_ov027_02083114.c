/* func_ov027_02083114 -- Ov027_GameOverFadeOut: the closing state of the game-over scene.  After
 * five frames of the root counter (data_ov027_02084360) the master brightness (+0x20 of the scene
 ...
 * (func_ov027_02083164) is returned; both screens get the brightness on those frames.  0 to stay. */
...
void *func_ov027_02083114(void)
{
    ...
    pNext = 0;
    data_ov027_02084360++;
    if (data_ov027_02084360 >= 5) {
        if (pScene->nBrightness <= -16) {
            pScene->nBrightness = -16;
            data_ov027_02084360 = 0;
