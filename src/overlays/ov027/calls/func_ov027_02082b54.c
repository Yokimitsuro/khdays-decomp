/* Opens the two resources named by data_ov027_020842f4 / data_ov027_02084304 (mode 0xe),
...
extern char data_ov027_020842f4[];
extern char data_ov027_02084304[];

void func_ov027_02082b54(char *self) {
    int zero = 0;
    *(int *)(self + 4) = func_0201ef9c(data_ov027_020842f4, 0xe);
    func_02024c94(self + 0xc, *(int *)(self + 4), zero, zero, zero);
    func_02024ba4(5, *(int *)(self + 0xc), *(int *)(self + 0x10), *(int *)(self + 0x14),
                  0x15, 2);
    *(int *)self = func_02024c1c(self + 8, data_ov027_02084304, 0xe);
}
