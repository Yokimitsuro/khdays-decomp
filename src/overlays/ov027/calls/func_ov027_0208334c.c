/* func_ov027_0208334c -- Ov027_InitCamera: set the game-over scene's camera up.  The camera
...
extern void  func_02023c60(Ov027Camera *pCamera);                  /* Camera_Init */
...
void func_ov027_0208334c(void)
{
    func_02023c60(&data_ov027_02084364->camera);
    data_ov027_02084364->camera.nAngle += 0xccd;
    data_ov027_02084364->camera.nAngleTarget = data_ov027_02084364->camera.nAngle;
    data_ov027_02084364->camera.nDistance = 1 << 14;
    data_ov027_02084364->camera.nNear = 0x579;
    data_ov027_02084364->camera.nFar = 0xf09;
    func_02023cc0(&data_ov027_02084364->camera);
}
