/* Decision tick of the ov269 enemy (and its byte-identical twin): acquires the closest target (+8, with
...
void func_ov269_020d2960(int node)
{
    ...
    state[5] = *(int *)(*(int *)node + 0x2c) * 30 / 15;
