/* Chase tick of the ov269 enemy (and its byte-identical twin): acquires a target (+8) -- none requests
...
extern void func_ov269_020d2fd4(void);
extern const short data_0203d210[];

void func_ov269_020d2dc4(int node)
{
    ...
    state[5] = *(int *)(*(int *)node + 0x2c) * 30 / 20;
    ...
    if (state[0x11] > 0) {
        ...
        *(unsigned char *)(state[1] + 0xa8) = 0;
        func_0203c634(node, *(signed char *)(node + 0x20), func_ov269_020d2fd4);
        return;
    }
