/* Charge tick of the ov269 enemy (and its byte-identical twin). Until the +0x53 one-shot fires,
 * the +0x54 timer accumulates and past 0xccc reaction 0x160/4 fires at the +0x398 joint's +0x14
...
extern const struct Msg20 data_ov269_020d4a9c;
extern const Vec3 data_ov269_020d4a38;
extern const struct Msg14 data_ov269_020d4a5c;
extern const short data_0203d210[];
extern void func_ov269_020d3754(void);
...
void func_ov269_020d3280(int *node)
{
    ...
    if (*(u8 *)((char *)state + 0x53) == 0) {
        ...
        if (state[0x15] > 0xccc) {
            func_ov107_020c5af8((struct Ov269Owner *)*state, 0x160, 4, (char *)*(int *)(*state + 0x398) + 0x14);
            *(u8 *)((char *)state + 0x53) = 1;
        }
    }
    state[0xc] += *(int *)(*node + 0x2c);
    if (*(u8 *)((char *)state + 0x50) == 0 && state[0xc] >= 0x999) {
        msg20 = data_ov269_020d4a9c;
    ...
    if (state[0xc] >= 0xaaa) {
        offBase = data_ov269_020d4a38;
        nPoint = 0;
        tmpl = data_ov269_020d4a5c;
        do {
                    ...
                    if (((*(u8 *)((char *)state + 0x51) >> *(u8 *)(hits[i] + 0x1b4)) & 1) == 0) {
                        ...
                        if (func_ov107_020ca918(hits[i], (struct Ov269Owner *)*state, (struct Ov269Owner *)*state, 0, &push, 0) != 0) {
                            ...
                            *(u8 *)((char *)state + 0x51) |= 1 << *(u8 *)(hits[i] + 0x1b4);
                            func_ov107_020c5af8((struct Ov269Owner *)*state, 0x160, 5, &raw);
                        }
                    }
                } while (++i < nHits);
            }
    ...
    if (*(u8 *)(state[1] + 0xad) == 0) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov269_020d3754);
    }
}
