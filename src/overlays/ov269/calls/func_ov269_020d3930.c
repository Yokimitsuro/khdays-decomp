...
extern const PosMsg data_ov269_020d4a6a;
extern const Vec3 data_02041dc8;
extern void func_ov269_020d382c(void);
...
void func_ov269_020d3930(int *node)
{
    ...
    if (*(u8 *)(*(int *)(*(int *)(*state + 0x3d0) + 0x3c) + 0xad) == 0) {
        ...
        *(u8 *)((char *)state + 0x53) = 0;
        state[0x15] = 0;
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov269_020d382c);
        return;
    }
