 ...
 * and if the owner is in state 1 (+0x50), poke func_ov254_020d2e34(*(param_1+0x214)). */
extern void func_ov107_020c5c54(int a, int b);
extern void func_0203c7ac(int a, int b);
extern void func_ov254_020d2e34(int *a);
void func_ov254_020d2ab8(int param_1, int param_2, void *param_3, int param_4) {
    ...
    if (*(int *)(param_1 + 0x50) == 1) {
        func_ov254_020d2e34(*(int **)(param_1 + 0x214));
    }
}
