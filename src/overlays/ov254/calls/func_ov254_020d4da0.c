...
extern void func_ov254_020d4e50(void);
extern void func_ov254_020d4f44(void);
extern void func_ov254_020d4e6c(void);
...
void func_ov254_020d4da0(char *self)
{
    int pool = *(int *)(self + 0x388);
    Vec3 *pose;

    *(Callback *)(self + 0x8) = func_ov254_020d4e50;
    *(Callback *)(self + 0x30) = func_ov254_020d4f44;
    *(Callback *)(self + 0x1dc) = func_ov254_020d4e6c;
    {
    ...
    *(int *)(self + 0x384) = func_0203b898(func_ov107_020c9440(pool, 0x45));
