...
extern void func_ov187_020d6f20(void);
extern VecFx32 data_020475ac;
extern VecFx32 data_02042264;
extern VecFx32 data_02041dc8;
extern Pair16 data_ov187_020d7100[];
 ...
 */
void func_ov187_020d6c54(OrbitTask *self) {
    ...
    if ((flags & 3) != 0) {
        Pair16 *rp = &rec;
        rp->b = data_ov187_020d7100[1].b;
        rp->a = data_ov187_020d7100[1].a;
        cb = ctx->owner->notify;
        if (cb != 0) {
        ...
        func_0203c634(self, self->actionSlot, func_ov187_020d6f20);
        return;
    }
    if ((flags & 4) != 0) {
        ctx->owner->state = 2;
