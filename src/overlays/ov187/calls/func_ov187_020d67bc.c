...
extern Pair data_ov187_020d7100[];
extern void func_ov187_020d695c(void);
 ...
 */
void func_ov187_020d67bc(int *self) {
    ...
    if (ctx->direction.y < 0
        ...
        Pair *eventPtr = &event;
        eventPtr->b = data_ov187_020d7100[0].b;
        eventPtr->a = data_ov187_020d7100[0].a;
