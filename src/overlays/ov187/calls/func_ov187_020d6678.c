...
extern void func_ov187_020d67bc(void);
...
extern void func_ov187_020d5a88(struct Ov185ActionState *state, struct Vec3 *pos);
 ...
 */
void func_ov187_020d6678(struct Ov120ActionNode *node)
{
    struct Vec3 vDelta;
    ...
    func_ov187_020d5a88(state, &state->vPos18);
    ...
    func_0203c634(node, node->bSlot, func_ov187_020d67bc);
}
