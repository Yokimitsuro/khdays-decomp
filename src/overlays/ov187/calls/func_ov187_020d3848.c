...
extern void func_ov187_020d3a94(struct Obj *self);
extern void func_ov187_020d3ab8(struct Obj *self);
extern void func_ov187_020d3e20(struct Obj *self);
extern void func_ov187_020d3bd8(struct Obj *self);
extern void func_ov187_020d3c40(struct Obj *self);
extern void func_ov187_020d3c7c(struct Obj *self);
extern void func_ov187_020d3d04(struct Obj *self);
extern void func_ov187_020d3e6c(struct Obj *self);
extern void func_ov187_020d3ffc(struct Obj *self);
extern void func_ov187_020d3b14(struct Obj *self);
extern void func_ov187_020d3d44(struct Obj *self);
extern void func_ov187_020d3da4(struct Obj *self);
extern void func_ov187_020d3de4(struct Obj *self);
...
extern void *func_ov187_020d5400(void *spawner);
 ...
 */
void func_ov187_020d3848(struct Obj *self)
{
    ...
    self->fn08 = func_ov187_020d3a94;
    self->fn0c = func_ov187_020d3ab8;
    self->fn30 = func_ov187_020d3e20;
    self->fn28 = func_ov187_020d3bd8;
    self->fn2c = func_ov187_020d3c40;
    self->fn1c = func_ov187_020d3c7c;
    self->fn34 = func_ov187_020d3d04;
    self->fn1d0 = func_ov187_020d3e6c;
    self->fn1e0 = func_ov187_020d3ffc;
    self->fn1dc = func_ov187_020d3b14;
    self->fn1ec = func_ov187_020d3d44;
    self->fn1f0 = func_ov187_020d3da4;
    self->fn1f8 = func_ov187_020d3de4;
    ...
    *(struct CameraWork *)self->camera64 = work;
    ...
    for (i = 0; i < 4; i++) {
        self->entities390[i] = func_ov187_020d5400(self->spawner394);
    }
    func_0203355c(0x120);
}
