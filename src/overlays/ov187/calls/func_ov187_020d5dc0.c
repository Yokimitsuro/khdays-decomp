/* func_ov187_020d5dc0 -- AI think tick: step the spline, push it to the render node, and while the
 ...
 *    above the shift.
 * Byte-identical twin of func_ov117_020cc8f8. */
...
void func_ov187_020d5dc0(int *obj)
{
    Mid *mid = (Mid *)obj[1];
    int sum;
    int idx;
