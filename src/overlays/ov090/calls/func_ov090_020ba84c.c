/* func_ov090_020ba84c -- overlay boot of the ov034 enemy (x4: ov034/052/072/090): the ov042 shape
...
extern void func_ov090_020babac(void);
extern void func_ov090_020bad24(void);
extern void func_ov090_020bb210(void);
extern void func_ov090_020baa34(void);
extern void func_ov090_020bab84(void);
extern void func_ov090_020bb248(void);
extern void func_ov090_020bb434(void);
extern void func_ov090_020bb4d0(void);
...
void func_ov090_020ba84c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov090_020bcb74, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov090_020bcb88, 1, cfg[0] + 7);
    }

    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov090_020babac;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov090_020bad24;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov090_020bb210;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov090_020baa34;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov090_020bab84;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov090_020bb248;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov090_020bb434;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov090_020bb4d0;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov090_020bcb2c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov090_020bcb1c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov090_020bcb3c) : -1;
