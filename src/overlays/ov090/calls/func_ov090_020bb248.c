...
extern void func_ov090_020bb57c(void);
extern void func_ov090_020bb9a0(void);
extern void func_ov090_020bb7ec(void);
extern void func_ov090_020bbab0(void);
extern void func_ov090_020bbcc0(void);
extern void func_ov090_020bbfc0(void);

void *func_ov090_020bb248(char *self, int msg)
{
    ...
    case 2:
        ...
        *(int *)(rig + 0x1c) = *(int *)(self + 0x490);
        break;
    case 3:
        next = (void *)&func_ov090_020bbcc0;
        *(int *)(rig + 4) = 0;
        *(int *)(rig + 8) = 0;
        *(int *)(self + 0x58) = -0xe66;
        break;
    case 4:
        next = (void *)&func_ov090_020bbfc0;
