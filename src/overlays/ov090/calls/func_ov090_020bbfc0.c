/* Landing step of the ov034 enemy (x4: ov034/052/072/090): on the local player both 64-bit flag
 ...
 * raised and the enemy hands over to state 0 when grounded, otherwise to state 2. */
...
void *func_ov090_020bbfc0(char *self)
{
    int r;
    Vec3 sample;
    Vec3 step;
