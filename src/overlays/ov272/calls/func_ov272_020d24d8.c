 ...
 * is committed to +0xc, the +0x50 timer restarts and the tick hands over to func_ov272_020d25d8. */
...
extern void func_ov272_020d25d8(int *node);

void func_ov272_020d24d8(int *node)
{
    ...
    *(Quat *)(state + 3) = *(Quat *)(state + 7);
    state[0x14] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov272_020d25d8);
}
