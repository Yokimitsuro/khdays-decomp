/* Hover tick of the ov272 enemy. The +0x30 velocity is the owner's forward
 ...
 * target found by func_ov272_020d060c (kept at +8) requests sub-state 6 and ends the tick; otherwise
 * once the +0x50 delay runs out the tick hands over to func_ov272_020d108c. */
...
extern int func_ov272_020d060c(int owner);
extern void func_0203c634(int *node, int slot, void *cb);
extern const Vec3 data_02042258;
extern const short data_0203d210[];
extern void func_ov272_020d108c(int *node);

void func_ov272_020d12b4(int *node)
{
    ...
    bob = data_0203d210[ANG2IDX(FX_MUL(state[0x17], 0x3244) / 2) * 2] + 0x3000;
    state[0x18] = bob;
    state[0xd] = height > bob ? -0x80 : 0x80;
    state[2] = func_ov272_020d060c(*state);
    if (state[2] != 0) {
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov272_020d108c);
}
