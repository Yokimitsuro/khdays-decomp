/* Idle float tick of the ov272 enemy. The +0x5c phase advances by the owner's
 ...
 * 0x80). A target found by func_ov272_020d060c (kept at +8) requests sub-state 6 and ends the tick.
 ...
 * heading and the tick hands over to func_ov272_020d12b4. */
...
extern void func_ov272_020d12b4(int *node);
...
void func_ov272_020d10e4(int *node)
{
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov272_020d12b4);
}
