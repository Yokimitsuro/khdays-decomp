/* Circle tick of the ov272 enemy. Gives up (sub-state 2) once the +8 target
 ...
 * height) and the +0x1c facing aims at the target. An attack chosen by func_ov272_020d071c ends the
 * tick; beyond 14.0 the tick goes back to func_ov272_020d1f48, within 3.0 on to
 * func_ov272_020d1af4, and beyond the owner's +0x2d8 leash sub-state 2 is requested. */
...
extern void func_ov272_020d1f48(int *node);
extern void func_ov272_020d1af4(int *node);

void func_ov272_020d1d20(int *node)
{
    int target;
    ...
    if (gap > 0xe000) {
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov272_020d1f48);
        return;
    }
    if (gap < 0x3000) {
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov272_020d1af4);
        return;
    }
