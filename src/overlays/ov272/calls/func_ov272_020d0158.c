/* Tick handler of the ov272 enemy (variant of ov119/ov279's). A flagged (+0x1c4 & 0xa), idle (+0x1c7 ==
 * -1) enemy outside sub-states 0, 1, 3, 4 and 0xb is forced into sub-state 4. Outside sub-state 7
 * the +0x3a8 block's +0x24 effect is released, outside 0xa its +0x1c
...
void func_ov272_020d0158(int self)
{
    Segment seg;
    ...
    if (*(s8 *)(self + 0x1c6) != 7 && *(int *)(*(int *)(self + 0x3a8) + 0x24) != 0) {
