/* Constructor of the ov272 enemy (x3 with ov272/ov279). Installs the handlers (+8, +0x1c message,
 * +0x30, +0x34 tick, +0x1d0 hit filter, +0x1dc, +0x1e0), raises bit 6 of the +0x60 high byte, sets
 * the +0x64 pose (scale 0.9), builds the +0x384 rig from pose 0 (subscribed to +0x9c, callback
 * func_ov272_020cfc04 with the enemy as its +0x84 owner) and resolves its five bones (+0x390 in set
 * 3; +0x398, +0x394, +0x39c, +0x3a0 in set 1); builds the five sub-items of data_ov272_020d3578
...
extern void func_ov272_020cff34(void);
extern void func_ov272_020cfff0(void);
extern void func_ov272_020d0158(void);
extern void func_ov272_020d0374(void);
extern void func_ov272_020d03d0(void);
extern void func_ov272_020d05dc(void);
extern void func_ov272_020cff74(void);
extern void func_ov272_020cfc04(void);

void func_ov272_020cfc6c(char *self)
{
    KindTable kinds;
    Capsule cap;
    int i;

    kinds = data_ov272_020d3578;
    *(void **)(self + 0x8) = (void *)func_ov272_020cff34;
    *(void **)(self + 0x1c) = (void *)func_ov272_020cfff0;
    *(void **)(self + 0x34) = (void *)func_ov272_020d0158;
    *(void **)(self + 0x30) = (void *)func_ov272_020d0374;
    *(void **)(self + 0x1d0) = (void *)func_ov272_020d03d0;
    *(void **)(self + 0x1e0) = (void *)func_ov272_020d05dc;
    *(void **)(self + 0x1dc) = (void *)func_ov272_020cff74;
    {
    ...
    *(void **)(*(char **)(self + 0x384) + 0x74) = (void *)func_ov272_020cfc04;
    *(char **)(*(char **)(self + 0x384) + 0x84) = self;
    *(int *)(self + 0x390) = func_0203bee8(*(void **)(self + 0x384), 3, data_ov272_020d35ac);
    *(int *)(self + 0x398) = func_0203bee8(*(void **)(self + 0x384), 1, data_ov272_020d35b8);
    *(int *)(self + 0x394) = func_0203bee8(*(void **)(self + 0x384), 1, data_ov272_020d35c4);
    *(int *)(self + 0x39c) = func_0203bee8(*(void **)(self + 0x384), 1, data_ov272_020d35d0);
    *(int *)(self + 0x3a0) = func_0203bee8(*(void **)(self + 0x384), 1, data_ov272_020d35dc);
    *(void **)(self + 0x3a8) = func_0203d15c(0x28);
    ...
    func_ov107_020c92b0(self, 0, 1, 0, 0x1ccc);
    func_ov107_020c92b0(self, 1, 1, 0, 0x1ccc);
    func_ov107_020c92b0(self, 2, 1, 0, 0x1ccc);
    func_ov107_020c92b0(self, 4, 1, 0, 0x1ccc);
