/* Hold tick of the ov272 enemy. While the owner's +0x3ac grab partner is
...
extern void func_ov272_020d2f9c(int *node);

void func_ov272_020d2d84(int *node)
{
    int target;
    ...
    pos.x = *(int *)(target + 0x74) + (int)(((long long)data_0203d210[ANG2IDX(rad) * 2] * 0x1680LL + 0x800LL) >> 12);
    ...
    *(Quat *)(state + 3) = *(Quat *)(state + 7);
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov272_020d2f9c);
}
