/* Swipe hit window of the ov272 enemy (x3 with ov272/ov279). The +0x50 timer advances by the
 * node's +0x2c speed; between 0.56 and 1.13 it queries a 0.45-radius sphere at the midpoint of the
...
void func_ov272_020d18b4(int *node)
{
