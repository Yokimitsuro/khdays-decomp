 ...
 * +0x50 timer restarts and the tick hands over to func_ov272_020d26f8. */
...
extern void func_ov272_020d26f8(int *node);

void func_ov272_020d2614(int *node)
{
    ...
    *(unsigned short *)(*state + 0x60) = (unsigned short)((v & ~0xff00) | (((((unsigned int)v << 0x10) >> 0x18 | 6) << 0x18) >> 0x10));
    state[0x14] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov272_020d26f8);
}
