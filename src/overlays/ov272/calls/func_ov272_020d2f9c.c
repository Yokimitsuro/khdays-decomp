 ...
 * while the target is flagged 0x10; it is pushed out of the world (func_ov272_020d0854, the
...
extern void func_ov272_020d0854(int world, Vec3 *point, int unused, int radius);
...
void func_ov272_020d2f9c(int *node)
{
    int target;
    ...
    *(Quat *)(state + 3) = *(Quat *)(state + 7);
    ...
    func_ov272_020d0854(world, &pos, rad, *(int *)(state[2] + 0x80));
    ...
    *(int *)(*(int *)(*state + 0x3ac) + 0x58) = 0;
    ...
    func_ov272_020d0854(world, &pos, rad, *(int *)(*state + 0x80));
    func_ov107_020c5c54(*state, &pos);
