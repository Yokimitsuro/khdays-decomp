/*
 * func_ov272_020d1408 -- x3. AI-state tick: fire, then face the target with a look-at orientation.
...
extern void func_ov272_020d14bc(void);

void func_ov272_020d1408(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov272_020d14bc);
}
