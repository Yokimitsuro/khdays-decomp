 ...
 * from its +0x74 point. The timer restarts and the tick hands over to func_ov272_020d284c. */
...
extern void func_ov272_020d284c(int *node);

void func_ov272_020d26f8(int *node)
{
    ...
    state[0x14] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov272_020d284c);
}
