/* Stalk tick of the ov272 enemy. Gives up (sub-state 2) once the +8 target
 ...
 * attack chosen by func_ov272_020d071c ends the tick; within 7.0 of the target (gap between the
 * collision radii) the tick hands over to func_ov272_020d1d20, and beyond the owner's +0x2d8 leash
...
void func_ov272_020d1f48(int *node)
{
    int target;
