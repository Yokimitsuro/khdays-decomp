/* Approach tick of the ov272 enemy (x2 with ov279). Gives up (sub-state 2, tick cleared) once
...
extern void func_ov272_020d18b4(int *node);

void func_ov272_020d1700(int *node)
{
    int target;
    ...
    if (!(gap >= 0x2000)) {
        ...
        func_ov107_020c5af8(*state, 0x167, 6, (void *)state[0x13]);
        *((unsigned char *)state + 0x70) = 0;
        state[0x14] = 0;
        *(Quat *)(state + 3) = *(Quat *)(state + 7);
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov272_020d18b4);
        return;
    }
}
