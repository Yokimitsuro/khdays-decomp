 ...
 * (slot 0) or raising (slot 1) bit 4 of +0x1ae, restart the +0x3a4 aura (func_ov272_020d33dc with
...
extern int func_ov272_020d33dc(char *self, int on);
extern void func_ov107_020c7500(char *self, u8 *msg, int arg);

void func_ov272_020cfff0(char *self, u8 *msg, int arg)
{
    if (msg[2] == 5) {
        switch (msg[3]) {
        case 0:
        case 1:
            (*(struct Pair **)(self + 0x3a8))[2].handle =
                func_ov107_020c08cc(*(int *)(self + 0x3c), (*(struct Pair **)(self + 0x3a8))[2].res, 0x15, 0, 0x1800, msg + 5);
            if (msg[3] == 0) {
                *(u16 *)(self + 0x1ae) &= ~0x10;
                *(int *)(self + 0x3a4) = func_ov272_020d33dc(self, 0);
            } else {
                *(u16 *)(self + 0x1ae) |= 0x10;
                *(int *)(self + 0x3a4) = func_ov272_020d33dc(self, 1);
            }
            break;
        case 2:
            (*(struct Pair **)(self + 0x3a8))[1].handle =
                func_ov107_020c08cc(*(int *)(self + 0x3c), (*(struct Pair **)(self + 0x3a8))[1].res, 5, 0, 0x1800, msg + 5);
            break;
        case 3:
