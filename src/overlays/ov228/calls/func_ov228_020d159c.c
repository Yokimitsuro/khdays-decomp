/* func_ov228_020d159c -- the recoil tick: bleed the stored impulse away over 0x1800 of timer,
 ...
 * hw60 hi-byte (it HAS the trunc pair, so bitfield form) and hands off to func_ov228_020d17b4. */
...
extern void func_ov228_020d17b4(void);
extern short data_0203d210[];

void func_ov228_020d159c(int self) {
    int *ctx;
    ...
    *(unsigned char *)((char *)ctx + 0x61) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov228_020d17b4);
}
