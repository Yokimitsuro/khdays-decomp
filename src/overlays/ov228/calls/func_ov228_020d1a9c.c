/*
 * func_ov228_020d1a9c -- x4 (ov228/229/233/249). AI-state tick: circle/orbit a tracked node.
...
extern void func_ov228_020d1ff4(int node, struct vec v, struct vec v2);
extern void func_ov228_020d1c14(void);
extern short data_0203d210;

void func_ov228_020d1a9c(int *self, int p2, int p3, int p4) {
    ...
    if (state[0x12] == 0 && func_ov228_020cf344((int)self) < 0) {
    ...
    do {
        if ((((struct hw60 *)(((int *)*state)[i + 0xf0] + 0x60))->lo & 1) == 0) {
            ...
            func_ov228_020d1ff4(*(int *)(*state + i * 4 + 0x3c0), out, vec);
            break;
        }
        i++;
    } while (i < 8);
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov228_020d1c14);
}
