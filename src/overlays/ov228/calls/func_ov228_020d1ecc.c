/* func_ov228_020d1ecc -- face the target and close in, unless it is already too near.
 *
 ...
 * func_ov228_020cf330). Otherwise the tail is the same Y-rotation steering as
...
void func_ov228_020d1ecc(int self) {
    int *ctx;
