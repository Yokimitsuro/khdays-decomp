/* func_ov228_020d04a0 -- the steering tick: age the timer, re-aim, and once the owner is ready
 * hand off to func_ov228_020d058c.
 *
 ...
 * hand-off fires modes 0xe/0xb, clears the byte at +0x62 and re-enters at func_ov228_020d058c. */
...
extern void func_ov228_020d058c(void);
extern short data_0203d210[];

void func_ov228_020d04a0(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
    ...
    func_ov228_020cf330(ctx[0], 0xb);
    *(unsigned char *)((char *)ctx + 0x62) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov228_020d058c);
}
