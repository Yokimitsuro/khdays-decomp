/* Constructor of the ov228 enemy. Installs the handlers (+8, +0xc, +0x1c message, +0x28, +0x2c, +0x30,
 * +0x34, +0x1d0, +0x1dc, +0x1e0, +0x1e4), the +0x1fc bounds box, the +0x64 pose (scale 2.0) and bit 3
 * of +0x1ae; builds the +0x3a8 rig from pose 0 (owned by the enemy, callback 020cdde8, subscribed to
 ...
 * of data_ov228_020d2c2c into the +0x4a8 pair table (the first from the shared scene resource, the
 ...
 * creates the eight +0x3c0 projectiles (020d2044) and loads sound 0x12b. */
...
extern void func_ov228_020ce2c4(void);
extern void func_ov228_020ce31c(void);
extern void func_ov228_020ce408(void);
extern void func_ov228_020ce8b4(void);
extern void func_ov228_020ce390(void);
extern void func_ov228_020ce3cc(void);
extern void func_ov228_020ce674(void);
extern void func_ov228_020ce910(void);
extern void func_ov228_020ce7fc(void);
extern void func_ov228_020cee5c(void);
extern void func_ov228_020cee88(void);
extern void func_ov228_020cdde8(void);
...
extern int func_ov228_020d2044(char *self);
...
void func_ov228_020cded8(char *self)
{
    IdTable ids = data_ov228_020d2c2c;
    Bounds bounds;
    Placement place;
    Vec3 lift;
    int i;
    ...
    *(Callback *)(self + 0x8) = func_ov228_020ce2c4;
    *(Callback *)(self + 0xc) = func_ov228_020ce31c;
    *(Callback *)(self + 0x1c) = func_ov228_020ce408;
    *(Callback *)(self + 0x30) = func_ov228_020ce8b4;
    *(Callback *)(self + 0x28) = func_ov228_020ce390;
    *(Callback *)(self + 0x2c) = func_ov228_020ce3cc;
    *(Callback *)(self + 0x34) = func_ov228_020ce674;
    *(Callback *)(self + 0x1d0) = func_ov228_020ce910;
    *(Callback *)(self + 0x1dc) = func_ov228_020ce7fc;
    *(Callback *)(self + 0x1e0) = func_ov228_020cee5c;
    *(Callback *)(self + 0x1e4) = func_ov228_020cee88;
    ...
    *(Callback *)(*(int *)(self + 0x3a8) + 0x74) = func_ov228_020cdde8;
    ...
    *(int *)(self + 0x3b4) = func_0203bdfc(*(int *)(self + 0x3a8), data_ov228_020d2cec);
    *(int *)(self + 0x3b8) = func_0203bdfc(*(int *)(self + 0x3a8), data_ov228_020d2cfc);
    ...
    *(int *)(self + 0x490) = func_ov107_020c9e50(func_ov107_020c9440(self, 0x1c), data_ov228_020d2d0c);
    for (i = 0; i < 10; i++) {
        if (i < 1) {
    ...
    *(int *)(self + 0x3b0) = *slot = node;
    for (i = 0; i < 8; i++) {
        ((struct Shots *)self)->shots[i] = func_ov228_020d2044(self);
    }
    func_0203355c(0x12b);
}
