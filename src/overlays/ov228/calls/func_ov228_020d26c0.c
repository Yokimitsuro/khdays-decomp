 ...
 * the tick hands over to func_ov228_020d2804. */
...
extern void func_ov228_020d2804(int *node);

void func_ov228_020d26c0(int *node)
{
    ...
    *((unsigned char *)state + 0x34) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov228_020d2804);
}
