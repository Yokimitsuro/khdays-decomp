 ...
 * +0x28 heading, is added to the step. A blocked step (func_ov228_020d238c) spawns the body's
 ...
 * restarts and the tick hands over to func_ov228_020d2bd4. */
...
extern int func_ov228_020d238c(int *state);
...
extern void func_ov228_020d2bd4(int *node);

void func_ov228_020d2848(int *node)
{
    ...
    if (func_ov228_020d238c(state) != 0) {
        item = *state;
    ...
    state[8] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov228_020d2bd4);
}
