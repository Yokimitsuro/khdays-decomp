 ...
 * (0, 1.5, 0) and the tick hands over to func_ov228_020d159c. */
...
extern void func_ov228_020d159c(int *node);

void func_ov228_020d14a0(int *node)
{
    ...
    if (*((unsigned char *)state + 0x61) == 0 && state[0x13] >= 0x770) {
        func_ov107_020c5af8(*state, 0x12b, 0xb, (void *)state[3]);
    ...
    *(unsigned short *)(*state + 0x60) = (unsigned short)((v & ~0xff00) | (((((unsigned int)v << 0x10) >> 0x18 | 0x40) << 0x18) >> 0x10));
    ...
    state[8] = 0x1800;
    state[9] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov228_020d159c);
}
