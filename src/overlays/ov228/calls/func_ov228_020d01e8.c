/* func_ov228_020d01e8 -- steer toward the target: rotate the owner's offset vector by the stored
 ...
 *   - func_ov228_020cf344 returning negative (nothing to steer toward);
...
void func_ov228_020d01e8(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
