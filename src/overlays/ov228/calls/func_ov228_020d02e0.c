...
extern void func_ov228_020cf330(int actor, int anim);
...
extern void func_ov228_020d03bc(int *node);
extern struct Vecx32 data_02041dc8;

void func_ov228_020d02e0(int *node)
{
