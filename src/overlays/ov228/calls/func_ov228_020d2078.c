...
extern const KindTable data_ov228_020d2cd8;

void func_ov228_020d2078(char *self)
{
    int pool = *(int *)(self + 0x38c);
    KindTable kinds;
    u16 hw;

    kinds = data_ov228_020d2cd8;
    *(Callback *)(self + 0x8) = func_ov228_020d21d4;
    *(Callback *)(self + 0xc) = func_ov228_020d21f8;
    *(Callback *)(self + 0x1c) = func_ov228_020d2230;
    *(Callback *)(self + 0x30) = func_ov228_020d2340;
    *(Callback *)(self + 0x1dc) = func_ov228_020d22a8;
    hw = *(u16 *)(self + 0x60);
