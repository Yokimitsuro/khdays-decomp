/* func_ov228_020d1240 -- the wind-up: hold, then emit along the heading during a timing window.
 *
 ...
 * hands the anchor to func_ov228_020ceeb8.
 *
...
extern void func_ov228_020ceeb8(int *ctx, int kind, void *a, void *b);
...
void func_ov228_020d1240(int self) {
    int *ctx;
    ...
    if (ctx[0x13] >= 0x990 && ctx[0x13] <= 0xf68) {
        ...
        func_ov228_020ceeb8(ctx, 1, &anchor, 0);
    }
