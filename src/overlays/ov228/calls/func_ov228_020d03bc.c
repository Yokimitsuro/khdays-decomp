/* func_ov228_020d03bc -- the steering tick that leads into func_ov228_020d04a0. Structurally the
...
extern void func_ov228_020d04a0(void);
extern short data_0203d210[];

void func_ov228_020d03bc(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
    ...
    func_ov228_020cf330(ctx[0], 0xa);
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov228_020d04a0);
}
