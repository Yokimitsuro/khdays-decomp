...
extern int func_ov228_020cf344(int *node);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_01ffa724(int scale, Vec3 *v, Vec3 *d);
extern void func_ov228_020ceeb8(int *state, int kind, Sphere *sphere, void *box);
...
void func_ov228_020d099c(int *node)
{
    ...
    if (state[0x13] <= 0xbb0 && func_ov228_020cf344(node) < 0) {
    ...
    if (state[0x13] >= 0xbb0 && state[0x13] <= 0x1188) {
        ...
        func_ov228_020ceeb8(state, 0, &sphere, 0);
        ...
        func_ov228_020ceeb8(state, 5, &sphere, 0);
    }
