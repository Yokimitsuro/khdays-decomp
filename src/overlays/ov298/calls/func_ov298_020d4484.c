/* Orientation tick of the ov298 enemy: unless +0x88 locks it, the +0x2c yaw turns toward the
...
void func_ov298_020d4484(int *node)
{
    ...
    *(unsigned char *)(state + 0x25) = state[0x16] > 0;
    if (*(signed char *)(state + 0x25) != was) {
        state[0x1e] = 0;
    }
}
