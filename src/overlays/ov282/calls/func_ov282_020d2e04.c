/*
 * func_ov282_020d2e04 -- x3 (ov210/211/282). AI-state tick: acquire target, else timed recovery.
...
extern void func_ov282_020d2e8c(void);

void func_ov282_020d2e04(int *self) {
    ...
    state[0xb] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov282_020d2e8c);
}
