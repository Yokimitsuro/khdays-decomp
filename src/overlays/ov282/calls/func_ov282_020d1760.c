 ...
 * animation 7. The fourth 4-byte command of data_ov282_020d4700 (kind 5, command 4) goes to the
...
extern void func_ov282_020d194c(int *node);

void func_ov282_020d1760(int *node)
{
    ...
    *(u8 *)((char *)state + 0x64) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov282_020d194c);
}
