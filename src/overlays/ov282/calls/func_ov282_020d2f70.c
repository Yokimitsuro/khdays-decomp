/*
 * func_ov282_020d2f70 -- x3. AI-state tick: strafe the same target (negative sweep), fire on a timer.
...
extern void func_ov282_020d3064(void);

void func_ov282_020d2f70(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov282_020d3064);
}
