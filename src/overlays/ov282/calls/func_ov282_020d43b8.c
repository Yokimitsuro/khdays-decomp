 ...
 * func_ov282_020d40c0. The end point sits on the circle of radius +0x3c around the target's
...
extern void func_ov282_020d40c0(int *node);
extern void func_ov282_020d4650(int *node);

void func_ov282_020d43b8(int *node)
{
    ...
    if (state[0x11] == 0) {
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov282_020d40c0);
        return;
    }
    {
        Vec3 end;
    ...
    *(Vec3 *)(*state + 0xf0) = data_02041dc8;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov282_020d4650);
}
