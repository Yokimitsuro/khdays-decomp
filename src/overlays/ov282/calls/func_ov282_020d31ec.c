/*
 * func_ov282_020d31ec -- x3 (ov210/211/282). AI-state tick: advance a lunge, then commit or wait.
...
extern void func_ov282_020d3280(void);
extern struct vec3 data_02041dc8;

void func_ov282_020d31ec(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov282_020d3280);
}
