/* Message handler of the ov282 enemy (x3 with ov211/ov282). A "spawned" message (kind 5)
...
void func_ov282_020cffc4(char *self, u8 *msg, int arg)
{
    if (msg[2] == 5) {
        switch (msg[3]) {
        case 1:
        ...
        case 7:
            ...
            break;
        case 8:
            *(int *)(self + 0x3d8) = func_ov107_020cb040(self, 0x16a, 7, 0, self + 0xa0);
            break;
        }
    }
