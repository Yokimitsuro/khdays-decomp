/*
 * func_ov282_020d2e8c -- x3 (ov210/211/282). Twin of Ov210_StrafeSameTarget (020d2b60) with the cross
...
extern void func_ov282_020d2f70(void);

void func_ov282_020d2e8c(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov282_020d2f70);
}
