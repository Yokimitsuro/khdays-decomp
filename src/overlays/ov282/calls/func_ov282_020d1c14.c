 ...
 * (data_ov282_020d4756, low nibble of byte 4 = 6, high nibble cleared) carries the entity's +0x74
...
extern const Cmd14 data_ov282_020d4756;
extern void func_ov282_020d1f24(int *node);

void func_ov282_020d1c14(int *node)
{
    ...
    if (((struct Bits17a *)(*state + 0x17a))->b0 != 0 || ((struct Bits17a *)(*state + 0x17a))->b1 != 0
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov282_020d1f24);
    }
}
