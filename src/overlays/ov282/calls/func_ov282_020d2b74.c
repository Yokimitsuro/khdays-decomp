/*
 * func_ov282_020d2b74 -- x3 (ov210/211/282). AI-state tick: keep strafing the same target, fire when
 * the sub-node frees.
...
extern void func_ov282_020d2c58(void);

void func_ov282_020d2b74(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov282_020d2c58);
}
