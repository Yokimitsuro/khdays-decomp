/* func_ov282_020d311c -- enter the state: play mode 0x15, seed the offset vector at ctx+0x54 by
...
extern void func_ov282_020d316c(void);
extern VecFx32 data_02042264;

void func_ov282_020d311c(int self) {
    int *ctx;
    ...
    ctx[0xb] = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov282_020d316c);
}
