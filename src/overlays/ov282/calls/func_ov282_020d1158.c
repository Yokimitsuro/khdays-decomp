/* Rise decision of the ov282 enemy (the ov210/ov211 rise decision). With any of bits 0-3 of the owner's
 ...
 * +0x60 timer and +0x66 byte clear and the tick hands over to func_ov282_020d1468. */
...
extern const Cmd14 data_ov282_020d4710;
extern void func_ov282_020d1468(int *node);

void func_ov282_020d1158(int *node)
{
    ...
    *(u8 *)((char *)state + 0x66) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov282_020d1468);
}
