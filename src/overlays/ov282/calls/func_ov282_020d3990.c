...
extern const Cmd14 data_ov282_020d4772;
extern void func_ov282_020d3b38(int *node);

void func_ov282_020d3990(int *node)
{
    ...
    *(u8 *)((char *)state + 0x66) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov282_020d3b38);
}
