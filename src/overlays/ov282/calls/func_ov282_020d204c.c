/* Rise-and-strike entry of the ov282 enemy (x3 with ov211/ov282): raises bits 3 and 6 of the
 ...
 * (data_ov282_020d471e, flag 2) carries the +4 point raised 6.0, then the third 4-byte command of
...
extern const Cmd14 data_ov282_020d471e;
extern void func_ov282_020d2244(int *node);

void func_ov282_020d204c(int *node)
{
    ...
    *(u16 *)(*state + 0x1ae) |= 1;
    ...
    {
        u16 *p = cmd;
        p[1] = data_ov282_020d4700[5];
        p[0] = data_ov282_020d4700[4];
        if (*(void (**)(int, u16 *, int))(*state + 0x24) != 0) {
            (*(void (**)(int, u16 *, int))(*state + 0x24))(*state, p, 4);
        }
    }
    *(u8 *)((char *)state + 0x64) = 1;
    func_ov107_020c5af8(*state, 0x16a, 6, (void *)state[1]);
    *(u8 *)((char *)state + 0x64) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov282_020d2244);
}
