/*
 * func_ov282_020d2650 -- x3 (ov210/211/282). AI-state tick: rebuild the steer vector; once the
...
extern void func_ov282_020d26f4(void);

void func_ov282_020d2650(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov282_020d26f4);
}
