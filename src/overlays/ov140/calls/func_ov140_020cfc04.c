...
extern void func_ov140_020cfe00(void);
extern void func_ov140_020cfe48(void);
extern void func_ov140_020cfee8(void);
extern void func_ov140_020cffd8(void);
extern void func_ov140_020d0024(void);
extern void func_ov140_020d0294(void);
extern void func_ov140_020cfeb8(void);
...
void func_ov140_020cfc04(char *self)
{
    ...
    pools = data_ov140_020d283c;
    lift = data_ov140_020d2848;
    *(Callback *)(self + 0x8) = func_ov140_020cfe00;
    *(Callback *)(self + 0xc) = func_ov140_020cfe48;
    *(Callback *)(self + 0x1c) = func_ov140_020cfee8;
    *(Callback *)(self + 0x30) = func_ov140_020cffd8;
    *(Callback *)(self + 0x1d0) = func_ov140_020d0024;
    *(Callback *)(self + 0x1e0) = func_ov140_020d0294;
    *(Callback *)(self + 0x1dc) = func_ov140_020cfeb8;
    *(int *)(self + 0x1f4) = 0;
    *(int *)(self + 0x70) = 0x800;
    *(int *)(self + 0x64) = 0;
    *(int *)(self + 0x68) = 0x800;
    ...
    *(int *)(self + 0x390) = func_ov107_020c9e50(func_ov107_020c9440((int)self, 1), data_ov140_020d28cc);
