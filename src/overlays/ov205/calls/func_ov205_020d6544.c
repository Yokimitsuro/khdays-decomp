...
extern const PosMsg data_ov205_020d725a;
extern void func_ov205_020d6794(int *node);
...
void func_ov205_020d6544(int *node)
{
    ...
    func_ov107_020c9ee8(*(void **)((char *)state->pOwner + 0x390), 6, 0);
    func_ov107_020c9264(state->pOwner, 0xf, 0);
    state->bHitMask44 = 0;
    state->nPhase = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov205_020d6794);
}
