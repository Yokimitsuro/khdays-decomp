...
extern const PosMsg data_ov205_020d724c;
extern void func_ov205_020d6c34(int *node);
...
void func_ov205_020d69e4(int *node)
{
    ...
    state->bHitMask44 = 0;
    state->nPhase = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov205_020d6c34);
}
