...
extern void func_ov205_020d6d54(int *state);
...
extern void func_ov205_020d6d20(int *node);

void func_ov205_020d6c34(int *node)
{
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov205_020d6d20);
}
