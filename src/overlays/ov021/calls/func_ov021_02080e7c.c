...
extern void func_ov021_02080bd0(int a, unsigned short b, unsigned short c, void *d,
                                 int e, unsigned short f, int g);

int func_ov021_02080e7c(void *arg1, int arg2) {
    ...
    func_ov021_02080bd0(r5, (unsigned short)r7, (unsigned short)t10, &buf[0],
                        (short)fx, (unsigned short)r6, (unsigned char)(unsigned short)(r6 >> 0x10));
    return 1;
}
