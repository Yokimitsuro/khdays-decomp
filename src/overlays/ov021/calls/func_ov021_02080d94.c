...
extern void func_ov021_02080390(int a, unsigned short b, unsigned short c, unsigned short d,
                                 int e, void *f, int g);

int func_ov021_02080d94(void *arg1, int arg2) {
    ...
    func_ov021_02080390(r5, (unsigned short)r7, (unsigned short)t10, (unsigned short)r6,
