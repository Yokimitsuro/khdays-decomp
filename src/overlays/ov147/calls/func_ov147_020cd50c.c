...
extern int func_ov147_020ccb30(int *ctx, Vec3 v, int flag);
...
extern void func_ov147_020cd5f0(void);

void func_ov147_020cd50c(int *self) {
    int *ctx = (int *)self[1];
    int reach;
    int i;

    reach = func_ov147_020ccb30(ctx, *(Vec3 *)((char *)ctx + 0x28), 1);
    ...
    if (i >= 3) {
        ...
        if (ctx[0x10] <= 0) {
            ...
            if (reach < 0x20000) {
                *(int *)(*ctx + 0x3e8) = 0;
                func_0203c634(self, *(signed char *)((char *)self + 0x20), &func_ov147_020cd5f0);
                return;
            }
        }
    }
