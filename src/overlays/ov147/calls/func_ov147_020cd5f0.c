...
extern void func_ov147_020ccb30(int *state, struct Vec3 v, int flag);
extern void func_ov107_020c9264(int a, int b, int c);
extern void func_ov147_020cc9c0(int a, int b);
extern void func_0203c634(int self, int idx, int cb);
extern int func_ov147_020cd668;

void func_ov147_020cd5f0(int self) {
    int *state = *(int **)(self + 4);

    func_ov147_020ccb30(state, *(struct Vec3 *)(state + 10), 1);
    ...
    func_ov147_020cc9c0(*state, 2);
    func_0203c634(self, *(signed char *)(self + 0x20), (int)&func_ov147_020cd668);
}
