...
extern void func_ov147_020cc454(void);
extern void func_ov147_020cc480(void);
extern void func_ov147_020cc648(void);
extern void func_ov147_020cc7a4(void);
extern void func_ov147_020cc500(void);
extern void func_ov147_020cc53c(void);
extern void func_ov147_020cc578(void);
extern void func_ov147_020cc800(void);
extern void func_ov147_020cc76c(void);
extern void func_ov147_020cc964(void);
extern void func_ov147_020cc990(void);
extern void func_ov147_020cbfc4(void);
extern void func_ov147_020cc00c(void);
extern int func_ov147_020cdd00(struct Obj *self);
...
void func_ov147_020cc188(struct Obj *self)
{
    struct Box box;
    struct Subitem *item;
    int *slot;
    ...
    self->fn08 = func_ov147_020cc454;
    self->fn0c = func_ov147_020cc480;
    self->fn1c = func_ov147_020cc648;
    self->fn30 = func_ov147_020cc7a4;
    self->fn28 = func_ov147_020cc500;
    self->fn2c = func_ov147_020cc53c;
    self->fn34 = func_ov147_020cc578;
    self->fn1d0 = func_ov147_020cc800;
    self->fn1dc = func_ov147_020cc76c;
    self->fn1e0 = func_ov147_020cc964;
    self->fn1e4 = func_ov147_020cc990;
    ...
    self->subitem384->callback74 = func_ov147_020cbfc4;
    self->subitem384->owner84 = self;
    func_0203bfb4(self->subscriberList9c, self->subitem384);
    self->resourceId3d4 = func_0203bdfc(self->subitem384, data_ov147_020ce8cc);

    (self->subitem388 = func_0203b898(func_ov107_020c9440(self, 1)))->callback6c = func_ov147_020cc00c;
    self->subitem388->owner84 = self;
    func_0203c7ac(self->subitem388, 0);
    self->resourceId3d0 = func_0203bdfc(self->subitem388, data_ov147_020ce8d4);
    ...
    *self->poolEntry38c = func_ov107_020c319c(self->camera);
    ...
    for (i = 0; i < 3; i++) {
        self->child398[i] = func_ov147_020cdd00(self);
    }
