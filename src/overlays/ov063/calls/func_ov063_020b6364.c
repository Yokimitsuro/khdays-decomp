/* func_ov063_020b6364 -- spawn four particle emitters into the owner's emitter pool
...
extern void func_ov063_020b647c(int slot, int b);
extern void func_ov063_020b6458(int slot);

void func_ov063_020b6364(int self) {
