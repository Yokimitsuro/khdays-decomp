...
struct Outer;
extern void func_ov063_020b7910(struct Outer *outer, int sel);
extern void func_ov063_020b6290(void);
extern void func_ov063_020b62a4(void);

void *func_ov063_020b622c(struct Outer *obj, int a) {
    struct Outer *base = (struct Outer *)((char *)obj + 0xa8);
    void *r = 0;
    switch (a) {
    case 0x22:
        func_ov063_020b7910((struct Outer *)((char *)base + 0x2c00), 0x22);
        r = (void *)func_ov063_020b6290;
        break;
    case 0x23:
        func_ov063_020b7910((struct Outer *)((char *)base + 0x2c00), 0x23);
        r = (void *)func_ov063_020b62a4;
        break;
    }
    return r;
}
