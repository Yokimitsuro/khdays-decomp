...
extern void func_ov022_020ad44c(struct Vec3 *, struct Ov063Actor4498 *);
extern void func_ov022_020a23a4(struct Ov063Actor4498 *, int, int *, int *);
extern int func_ov022_020a0fb8(struct Ov063Actor4498 *, struct StructOut *, int *, int);
...
struct Ov063Controller4498 {
    int variant000;
    char pad004[0xdb0];
    struct Ov063Actor4498 *actorDb4;
};
...
void func_ov063_020b6c98(struct Ov063Controller4498 *this) {
    struct Ov063Actor4498 *p = this->actorDb4;
    int v = p->timeline7b0;
    int ok;
    int idx;
    register int angle;
