...
extern int func_ov022_020ad114(struct Ov063Actor *actor);
extern struct Vec3 *func_ov022_020ad0c0(struct Ov063Actor *actor);
...
extern void func_ov022_0209fe20(struct Ov063Actor *actor, struct Vec3 *out);
extern void VEC_Add(const struct Vec3 *a, const struct Vec3 *b,
                    struct Vec3 *out);
extern void func_ov063_020b6c98(struct Ov063Controller4908 *self);
extern void func_0202af1c(u16 *nodeFlags);
extern void *func_ov022_020a35f4(struct Ov063Actor *actor, int mode);

void *func_ov063_020b7108(struct Ov063Controller4908 *self)
{
    void *result = 0;
