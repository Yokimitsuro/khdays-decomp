...
extern int func_ov022_020ad718(struct Ov063Actor *actor);
extern void func_ov022_020a4490(struct Ov063Actor *actor, int cue, int mode);
extern void func_ov063_020b6364(struct Ov063Controller *self);
extern int func_ov063_020b64f4(struct Ov063Controller *self,
...
extern void func_ov063_020b6bb0(struct Ov063Controller *self, int delta);
extern void func_ov063_020b6ac0(struct Ov063Controller *self);

void func_ov063_020b7a80(struct Ov063Controller *self, int delta)
{
...
afterSpawn:
    ...
    i = 0;
    do {
        if (func_ov063_020b64f4(self, motion, delta) != 0) {
            active = 1;
        }
        i++;
        motion++;
...
afterAnimation:
    ...
    func_ov063_020b6bb0(self, delta);
    func_ov063_020b6ac0(self);
}
