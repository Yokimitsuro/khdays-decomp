...
extern char data_ov086_020b99dc[];
extern char data_ov086_020b99ec[];
extern char data_ov086_020b9a00[];

u8 func_ov086_020b8768(char *self)
{
    ...
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov086_020b99dc, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov086_020b99ec, *(u8 *)(self + 9), 1, rig + 0xc);
    *(u8 **)(block + 0x348) = func_ov022_020b14a4(data_ov086_020b9a00, *(u8 *)(self + 9), 2, rig + 0x24c);
