/* func_ov086_020b815c -- overlay boot of the ov048 enemy (x4: ov048/067/086/103): the ov042 shape (see
...
extern void func_ov086_020b83ac(void);
extern void func_ov086_020b847c(void);
extern void func_ov086_020b8730(void);
extern void func_ov086_020b8354(void);
extern void func_ov086_020b838c(void);
extern void func_ov086_020b84ec(void);
extern void func_ov086_020b8768(void);
extern void func_ov086_020b9220(void);
...
void func_ov086_020b815c(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov086_020b99c8, 1, cfg[0] + 7);
    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov086_020b83ac;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov086_020b847c;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov086_020b8730;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov086_020b8354;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov086_020b838c;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov086_020b84ec;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov086_020b8768;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov086_020b9220;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov086_020b995c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov086_020b994c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov086_020b993c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov086_020b992c) : -1;
    if (cfg[3] != 0) {
        *(long long *)obj |= 0x20;
    }
    if (cfg[4] != 0) {
