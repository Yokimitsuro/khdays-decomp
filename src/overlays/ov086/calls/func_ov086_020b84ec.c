...
extern void func_ov086_020b9288(void);
extern void func_ov086_020b946c(void);
extern void func_ov086_020b9728(void);

void *func_ov086_020b84ec(char *self, int msg)
{
    ...
    switch (msg - 0x21) {
    case 0:
        next = (void *)&func_ov086_020b9288;
        (*(void (**)(char *, int))(self + 0x664))(self, 0x2f);
        break;
    case 1:
        next = (void *)&func_ov086_020b946c;
