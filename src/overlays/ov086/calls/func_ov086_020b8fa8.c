/* Attack burst of the ov086 enemy (x4: ov048/067/086/103): every third tick of the +0x7b0 timer
...
extern struct GlobalState *data_ov086_020b9a60;
...
int func_ov086_020b8fa8(struct Actor *self)
{
    ...
    rigBytes = (u8 *)data_ov086_020b9a60 + 0x2c2c;
    rem = angle % 3;
    next = 0;
    if (rem == 0) {
