 ...
 * tick hands over to func_ov244_020d0130. */
...
extern void func_ov244_020d0130(int *node);

void func_ov244_020cfe90(int *node)
{
    ...
    *(short *)((u8 *)state + 0x12) = 0;
    state[7] = 0;
    state[8] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov244_020d0130);
}
