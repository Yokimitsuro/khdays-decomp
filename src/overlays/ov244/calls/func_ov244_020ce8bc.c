/* Swing callback of the ov244 enemy's arm (ov277 ce8c4 with a per-swing hit mask; twin of cf16c):
 * between frames 3.33 and 31.25 of the event the +0x88 animation's bone matrix at the event frame
 * (02016320) gives the arm tip; the sweep box
...
extern const PosMsg data_ov244_020d3708;
...
void func_ov244_020ce8bc(char *self, struct SwingEvent *ev)
{
    Mtx43 mtx;
    int hits[4];
    Vec3 tip;
