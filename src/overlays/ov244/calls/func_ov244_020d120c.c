 ...
 * (kind 5) receives the 14-byte message data_ov244_020d3780, flag 0x10, carrying the point of its
 * +0x80 radius towards the actor; the rider's reaction 0x113 mode 8 fires at the +4 point and
...
extern const Cmd14 data_ov244_020d3780;
extern const Cmd14 data_ov244_020d378e;
...
void func_ov244_020d120c(int *node)
{
    ...
    for (i = 0; i < n; i++) {
        ...
        func_ov107_020c5af8(*(int *)(state[0] + 0x384), 0x113, 8, (void *)state[1]);
        *(u8 *)(*state + 0x1c7) = 0;
