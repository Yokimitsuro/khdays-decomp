...
void func_ov244_020cd6c4(int actor, unsigned char *msg, int param)
{
    if (msg[2] == 5) {
        switch (msg[3]) {
        case 0:
            (*(void ***)(actor + 0x3a4))[1] =
                func_ov107_020c08cc(*(void **)(actor + 0x3c), (*(void ***)(actor + 0x3a4))[0], 0x17, 0, msg[4] << 8, msg + 5);
            break;
        case 1:
            (*(void ***)(actor + 0x3a4))[3] =
                func_ov107_020c08cc(*(void **)(actor + 0x3c), (*(void ***)(actor + 0x3a4))[2], 0x17, 0, 0x1000, msg + 5);
            (*(void ***)(actor + 0x3a4))[5] =
                func_ov107_020c08cc(*(void **)(actor + 0x3c), (*(void ***)(actor + 0x3a4))[4], 0x17, 0, 0x1000, msg + 5);
            break;
        }
    }
