 ...
 * +0x3a8 / +0x3bc joints' poses turned by data_ov244_020d3628 (the +0x39c shape copies +0x3bc's),
...
extern const Quat data_ov244_020d3628;
...
void func_ov244_020cccec(char *self)
{
    Quat rot = data_ov244_020d3628;
    Quat tmp;
    Seg *seg;
