 ...
 * at +9) effect 0x113 of kind 7 fires at the actor's +0x3d8 item's +0x14 point. When the +0x30
...
extern void func_ov244_020d0b10(void);

void func_ov244_020d0a64(int *node) {
    ...
    if (*((unsigned char *)state + 9) == 0) {
        if (state[7] >= 0x55a0) {
            func_ov107_020c5af8(*state, 0x113, 7, (void *)(*(int *)(*state + 0x3d8) + 0x14));
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov244_020d0b10);
}
