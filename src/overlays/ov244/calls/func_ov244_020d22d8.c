/* func_ov244_020d22d8 -- x3 (ov114/...). Advance the tracked motion and publish it to the owner.
...
void func_ov244_020d22d8(int self) {
    int *ctx;
    Xform b;
    Xform a;
    int owner;
    ...
    ctx = *(int **)(self + 4);
    ctx[5] = func_0203d040(ctx[5], ctx[6], *(int *)(*(int *)self + 0x2c) * 0x1e >> 3, 0);
    func_0202f188(&a, &data_02042264, ctx[5]);
