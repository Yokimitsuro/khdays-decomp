...
extern void func_ov244_020ce590(void);
extern void func_ov244_020ce4ac(void);

int func_ov244_020ce414(int actor, int owner)
{
    int *entry;
    struct vec at;
    int r = func_0203c5c0(*(int *)(actor + 0x3c), 100, 0x14,
                          &func_ov244_020ce4ac, &func_ov244_020ce590, &entry);
    entry[0] = owner;
    entry[3] = actor;
