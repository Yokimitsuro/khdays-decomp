...
extern void func_ov039_020b42d4(char *self);
extern char *data_ov039_020b5600;
extern char data_ov039_020b55c8[];
extern Params data_ov039_020b539c;

void func_ov039_020b3d30(char *self)
{
    Params p;
    char *base = data_ov039_020b5600;
    ...
    *(int *)(rig + 0x314) = 0x59a;
    ...
    slot = rig + 0x1c;
    for (i = 0; i < 2; i++) {
        func_0202a634((int)slot, data_ov039_020b55c8, 1, *(u8 *)(base + 9) + 7);
        slot += 0x10c;
    }
    p = data_ov039_020b539c;
    func_ov022_02092384((int)(self + 0x248 + 0x2400), *(u8 *)(self + 9), 5, &p);
    func_ov039_020b42d4(self);
}
