...
extern void func_ov039_020b4820(char *self);                                    /* Ov039_StartFlight */
...
void *func_ov039_020b3b0c(char *self, int msg)
{
    void *next = 0;
