...
extern void func_ov204_020d2728(int *node);
extern const PosMsg data_ov204_020d3628;
extern const PosMsg data_ov204_020d3636;
...
void func_ov204_020d1f14(int *node)
{
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov204_020d2728);
}
