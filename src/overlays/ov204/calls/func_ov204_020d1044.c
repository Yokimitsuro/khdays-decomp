...
extern void func_ov204_020d1130(void);
void func_ov204_020d1044(int *node, int p2, int p3, int param_4) {
    ...
    if (*(unsigned char *)state[10] == 0) {
        ...
        func_0203c634(node, *(signed char *)(node + 8), func_ov204_020d1130);
    }
}
