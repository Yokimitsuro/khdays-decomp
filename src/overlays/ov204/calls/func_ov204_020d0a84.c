...
extern int func_ov204_020d0750(int *node, Vec3 *at);
extern void func_0203c634(int *node, int slot, void *cb);
extern short data_0203d210[];
extern const Vec3 data_ov204_020d3600;
...
void func_ov204_020d0a84(int *node)
{
    ...
    if (state[0xc] <= 0) {
        if (gap < 0x6000) {
            ...
            if (roll < 0x28 && func_ov204_020d0750(node, &probe) == 0) {
