/* func_ov204_020d069c -- x3 (ov204/...). Advance the tracked motion and publish it to the owner.
...
void func_ov204_020d069c(int self) {
    int *ctx;
    Xform a;
    Xform b;
    int owner;
    ...
    ctx = *(int **)(self + 4);
    ctx[0xd] = func_0203d040(ctx[0xd], ctx[0xe], ctx[0xf], 0);
    func_0202f188(&a, &data_02042264, ctx[0xd]);
