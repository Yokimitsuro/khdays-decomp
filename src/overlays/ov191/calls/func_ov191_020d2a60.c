...
extern PosMsg data_ov191_020d2db6;
extern const Vec3 data_02041dc8;
extern void func_ov191_020d2c08(void);
...
void func_ov191_020d2a60(int node)
{
    ...
    st->timer = 0;
    func_0203c634(node, *(signed char *)(node + 0x20), func_ov191_020d2c08);
}
