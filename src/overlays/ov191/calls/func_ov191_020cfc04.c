 ...
 * +8 flags), fills the +0x3a4 table with four func_ov191_020d1e18 records and loads sound 0x133. */
...
extern void *func_ov191_020d1e18(int *self);
...
void func_ov191_020cfc04(int param)
{
    ...
    *(u16 *)param |= 0x100;
    *(void **)(param + 0x08) = func_ov191_020cff74;
    *(void **)(param + 0x1c) = func_ov191_020d000c;
    ...
    *(void **)(param + 0x1d0) = func_ov191_020d0408;
    *(void **)(param + 0x1dc) = func_ov191_020cffbc;
    ...
    *(u16 *)(param + 0x100 + 0xae) |= 0x10;

    {
        ...
        ((void **)self)[0xe6] = func_0203bee8(self[0xe1], 1, data_ov191_020d2dec);
        ((void **)self)[0xe7] = func_0203bee8(self[0xe1], 1, data_ov191_020d2df4);
        ...
        *((int **)self)[0xe2] = func_ov107_020c319c(&pose);
        ...
        for (i = 0; i < 4; i++) {
            ((void **)((void **)self)[0xe9])[i] = func_ov191_020d1e18(self);
        }
        func_0203355c(0x133);
    }
}
