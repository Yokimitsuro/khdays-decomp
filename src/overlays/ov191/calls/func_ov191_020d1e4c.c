...
extern void func_ov191_020d2020(void);
extern void func_ov191_020d2060(void);
extern void func_ov191_020d2098(void);
extern void func_ov191_020d214c(void);
extern void func_ov191_020d21a8(void);
...
extern const int data_ov191_020d2d84[2];

void func_ov191_020d1e4c(char *self)
{
    int kinds[2];
    u16 hw;
    int i;
    i = 0;
    kinds[0] = data_ov191_020d2d84[0];
    kinds[1] = data_ov191_020d2d84[1];
    *(Callback *)(self + 0x8) = func_ov191_020d2020;
    *(Callback *)(self + 0xc) = func_ov191_020d2060;
    *(Callback *)(self + 0x1c) = func_ov191_020d2098;
    *(Callback *)(self + 0x30) = func_ov191_020d21a8;
    *(Callback *)(self + 0x1d0) = func_ov191_020d214c;
    hw = *(u16 *)(self + 0x60);
