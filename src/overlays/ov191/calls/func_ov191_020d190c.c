/*
 * func_ov191_020d190c -- MATCHED (408/408 bytes, 102 instrs). x5 family.
 ...
 * test is `<= 0`.
 */
extern void func_ov191_020d0658(int *state, int *p);
extern long long func_01ff8a14(int a, int b);
extern void func_ov191_020d073c(int *state, int lo, int hi, int *p);
...
extern int func_ov191_020d1aa4;

void func_ov191_020d190c(int *self) {
    ...
    if (*(unsigned char *)(state + 0xe) == 0 && state[0xb] >= 0x4cc) {
        func_ov191_020d0658(state, state + 8);
        *(unsigned char *)(state + 0xe) = 1;
    }
    t = state[0xb];
    if (t >= 0x4cc && t <= 0xbba) {
        long long fx = func_01ff8a14(t - 0x4cc, 0x6ee);
        func_ov191_020d073c(state, (int)fx, (int)((unsigned long long)fx >> 32), state + 8);
    }
    ...
    *(unsigned char *)((int)state + 0x39) &= ~2;
    ...
    if (c - 1 <= 0) {
        ...
        func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov191_020d1aa4);
        return;
    }
    func_ov107_020c9264(*state, 5, 0);
    target = func_ov191_020d1bdc(*state, 0);
    state[6] = target;
    if (target == 0) {
        return;
    }
