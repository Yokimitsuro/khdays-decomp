...
extern Vec3 data_ov098_020bbc48;            /* muzzle offset */
extern Angles data_ov098_020bbc30;          /* heading offsets of the three shots */
extern PermTable data_ov098_020bbc94;       /* the six permutations of {0,1,2} */
extern const Vec3 data_ov098_020bbc3c;            /* unit z ray */
extern short data_0203d210[];

void *func_ov098_020bae74(char *self)
{
    PermTable perm;
    Vec3 sample;
    Vec3 muzzle;
    ...
    Vec3 step;
    void *next = 0;
    char *rig = data_ov098_020bbda0 + 0x2c + 0x2c00;
    int limit;
    int count;
    int rand;
    int i;
    ...
    if (*(int *)(self + 0x4cc) >= limit && *(int *)(rig + 4) == 0) {
        muzzle = data_ov098_020bbc48;
        angles = data_ov098_020bbc30;
        perm = data_ov098_020bbc94;
        count = 1;
        p.f14 = 0;
        p.f1c = 1;
        p.f20 = 0;
