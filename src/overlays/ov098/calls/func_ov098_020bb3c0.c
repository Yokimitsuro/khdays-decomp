/* Creates the ov098 enemy's sub-objects (byte-identical twin of ov042 020b3e20): allocates two
 * 0x30 slots from
...
void func_ov098_020bb3c0(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x60);
    ...
    func_ov022_02091298(*(void **)(self + 0x2000 + 0x644), self, &data_ov098_020bbd68, cfg, 3, 6);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) = (void *)&func_ov098_020bb634;
    ...
    cfg2.field38 = 0x25;
    cfg2.field4c = 1;
    func_ov022_02091254((char *)*(void **)(self + 0x2000 + 0x644) + 0x30, self, &data_ov098_020bbd7c, &cfg2);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x50) = (void *)&func_ov098_020bb634;
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x54) = (void *)&func_ov098_020bb740;
}
