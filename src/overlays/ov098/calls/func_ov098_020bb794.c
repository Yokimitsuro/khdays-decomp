...
extern void func_ov098_020bb9c4(Vec3 *origin, Vec3 *move);                     /* Ov042_LayTrail */
...
int func_ov098_020bb794(char *group, char *part, void *arg)
{
    Vec3 vTo;
    Vec3 vStep;
    Vec3 vFrom;
    ...
    *(Vec3 *)(part + 0xcc) = vTo;
    func_ov098_020bb9c4(&vFrom, &vStep);
