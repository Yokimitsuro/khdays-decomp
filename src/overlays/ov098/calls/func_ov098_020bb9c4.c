...
extern void func_ov098_020bba88(Vec3 *pos, Vec3 *dir);                         /* Ov042_ClaimSlotAndLaunch */
extern char *data_ov098_020bbda0;

void func_ov098_020bb9c4(Vec3 *origin, Vec3 *move)
{
    Vec3 vDir;
    Vec3 vPos;
    char *trail = data_ov098_020bbda0 + 0x2c + 0x2c00;
