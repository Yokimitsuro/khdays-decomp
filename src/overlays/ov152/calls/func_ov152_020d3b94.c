 ...
 * and handing the collected list to func_ov152_020d3f94. */
...
extern int func_ov107_020cb040(struct Ov151Self *self, int id, int kind, int enabled,
                               void *transform);
extern void **func_01fffd70(void *list);
extern void **func_01fffd8c(void *list);
extern void VEC_Subtract(const struct Ov151Vec3 *a, const struct Ov151Vec3 *b,
                         struct Ov151Vec3 *dst);
extern int VEC_Mag(const struct Ov151Vec3 *v);
extern void func_ov107_020c5af8(struct Ov151Self *self, int id, int kind,
                                struct Ov151Vec3 *at);
extern int func_ov152_020d3f94(struct Ov151Self *self, short *ids);
extern void func_ov107_020c7500(struct Ov151Self *self, struct Ov151Cmd *cmd, int arg2);

void func_ov152_020d3b94(struct Ov151Self *self, struct Ov151Cmd *cmd, int arg2)
{
    ...
    if (cmd->type02 == 0x5) {
        ...
        case 1:
            ...
            self->nEffect3d0 =
                func_ov107_020cb040(self, 0x14f, 0x7, 0,
        ...
        case 0: {
                ...
                if ((other->flags60.lo & 1) != 0
                    ...
                    if (VEC_Mag(&delta) - (other->nRadius80 + self->nRadius80)
                        ...
                        if (self->nMode50 == 1) {
                            ...
                            func_ov107_020c5af8(self, 0x14f, 0x8, &other->vPos74);
                        }
                        if (count >= 0x10) {
                            break;
                        }
            ...
            self->pSlots390->field04 = func_ov152_020d3f94(self, ids);
            break;
        }
        }
    }
