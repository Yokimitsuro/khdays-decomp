 ...
 * hands the canned 4-byte event record data_ov152_020d64b4[1] to the owner's
...
extern void func_ov152_020d5e24(void);

void func_ov152_020d5d70(Ov149Node *node)
{
    ...
    pp = buf;
    {
        char *src = (char *)data_ov152_020d64b4;
        u16 high = *(u16 *)(src + 6);
        u16 low = *(u16 *)(src + 4);
