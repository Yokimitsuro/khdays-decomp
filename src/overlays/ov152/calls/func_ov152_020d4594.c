/* func_ov152_020d4594 -- broadcast this node's position. When the caller's flag word has both
 * bit 0 and bit 4 set, build the 14-byte message from the template at data_ov152_020d6498, pack
...
extern struct Msg data_ov152_020d6498;

int func_ov152_020d4594(int self, int a, unsigned int *flags, int d) {
