...
extern void func_ov152_020d4078(void);
extern void func_ov152_020d41b4(void);
void func_ov152_020d40e4(int *node) {
    void *cb = (void *)func_ov152_020d4078;
    ...
    *(unsigned int *)(state[1] + 0x5c) &= ~2;
    func_0203c634(node, *(signed char *)(node + 8), func_ov152_020d41b4);
}
