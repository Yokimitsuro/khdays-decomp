 ...
 * p4+0x24, the hit owner parked at p4+0x38, and reaction id 0x14f.
 *
...
int func_ov152_020d5190(int this, int a1, int a2)
{
    ...
    *(Blk3 *)((char *)p4 + 0x24) = *(Blk3 *)(a2 + 4);
    ...
    if (((struct HitGate *)(a2 + 0x10))->lo > 0) {
        ...
        if ((hf->lo & 8) == 0 || (hf->lo & 0x80) == 0 || hf->hi != 0x80) {
            fb = (struct NodeFacing *)((char *)p4 + 0x4d);
            if (hf->lo & 0x22) {
                fb->facing = fb->facing + 1;
                func_ov107_020c5af8(this, 0x14f, (fb->facing & 1) ? 2 : 3,
                                    *(int *)((char *)p4 + 0x40));
            } else {
                fb->facing = fb->facing + 1;
                func_ov107_020c5af8(this, 0x14f, (fb->facing & 1) ? 0 : 1,
                                    *(int *)((char *)p4 + 0x40));
            }
        }
    }
