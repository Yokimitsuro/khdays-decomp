...
extern void func_ov152_020d4444(void);
extern void func_ov152_020d4484(void);
extern void func_ov152_020d44e0(void);
extern void func_ov152_020d4594(void);
extern void func_ov152_020d46b4(void);
...
void func_ov152_020d4248(char *self)
{
    int kinds[2];
    u16 hw;
    int i;
    int *p;
    kinds[0] = data_ov152_020d6474[0];
    kinds[1] = data_ov152_020d6474[1];
    *(Callback *)(self + 0x8) = func_ov152_020d4444;
    *(Callback *)(self + 0xc) = func_ov152_020d4484;
    *(Callback *)(self + 0x1c) = func_ov152_020d44e0;
    *(Callback *)(self + 0x30) = func_ov152_020d46b4;
    *(Callback *)(self + 0x1d0) = func_ov152_020d4594;
    hw = *(u16 *)(self + 0x60);
