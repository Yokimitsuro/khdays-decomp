/* func_ov024_0208365c -- MobiClip: stream state machine; deliver `event` to `stream`.
...
extern void func_ov024_02083600(int stream);

int func_ov024_0208365c(int stream, int event) {
    int *counter;
