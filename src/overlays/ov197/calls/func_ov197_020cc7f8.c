...
extern const struct ReactionModes data_ov197_020ce894;
...
int func_ov197_020cc7f8(int owner, int source, struct HitDescriptor *hit)
{
    ...
    modes.normal[0] = data_ov197_020ce894.normal[0];
    modes.normal[1] = data_ov197_020ce894.normal[1];
    modes.flagged[0] = data_ov197_020ce894.flagged[0];
    modes.flagged[1] = data_ov197_020ce894.flagged[1];
