...
extern void func_ov197_020cc450(void);
extern void func_ov197_020cc47c(void);
extern void func_ov197_020cc644(void);
extern void func_ov197_020cc79c(void);
extern void func_ov197_020cc4fc(void);
extern void func_ov197_020cc538(void);
extern void func_ov197_020cc574(void);
extern void func_ov197_020cc7f8(void);
extern void func_ov197_020cc764(void);
extern void func_ov197_020cc958(void);
extern void func_ov197_020cc984(void);
extern void func_ov197_020cbfc4(void);
extern void func_ov197_020cc00c(void);
extern int func_ov197_020cdcf4(struct Obj *self);
...
void func_ov197_020cc188(struct Obj *self)
{
    struct Box box;
    struct Subitem *item;
    int *slot;
    ...
    self->fn08 = func_ov197_020cc450;
    self->fn0c = func_ov197_020cc47c;
    self->fn1c = func_ov197_020cc644;
    self->fn30 = func_ov197_020cc79c;
    self->fn28 = func_ov197_020cc4fc;
    self->fn2c = func_ov197_020cc538;
    self->fn34 = func_ov197_020cc574;
    self->fn1d0 = func_ov197_020cc7f8;
    self->fn1dc = func_ov197_020cc764;
    self->fn1e0 = func_ov197_020cc958;
    self->fn1e4 = func_ov197_020cc984;
    ...
    self->subitem384->callback74 = func_ov197_020cbfc4;
    self->subitem384->owner84 = self;
    func_0203bfb4(self->subscriberList9c, self->subitem384);
    self->resourceId3d4 = func_0203bdfc(self->subitem384, data_ov197_020ce8cc);

    (self->subitem388 = func_0203b898(func_ov107_020c9440(self, 1)))->callback6c = func_ov197_020cc00c;
    self->subitem388->owner84 = self;
    func_0203c7ac(self->subitem388, 0);
    self->resourceId3d0 = func_0203bdfc(self->subitem388, data_ov197_020ce8d4);
    ...
    *self->poolEntry38c = func_ov107_020c319c(self->camera);
    ...
    for (i = 0; i < 3; i++) {
        self->child398[i] = func_ov197_020cdcf4(self);
    }
