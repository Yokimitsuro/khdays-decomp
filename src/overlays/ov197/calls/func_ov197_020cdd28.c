...
extern const struct ChildIds data_ov197_020ce89c;
extern void func_ov197_020cdef4(void);
extern void func_ov197_020cdf2c(void);
extern void func_ov197_020cdf64(void);
extern void func_ov197_020ce0f4(void);
extern void func_ov197_020ce090(void);
...
void func_ov197_020cdd28(struct Obj *self)
{
    struct ChildIds ids = data_ov197_020ce89c;
    struct Obj *owner = self->owner390;
    unsigned int flags;
    int i;

    self->fn08 = func_ov197_020cdef4;
    self->fn0c = func_ov197_020cdf2c;
    self->fn1c = func_ov197_020cdf64;
    self->fn30 = func_ov197_020ce0f4;
    self->fn1d0 = func_ov197_020ce090;
