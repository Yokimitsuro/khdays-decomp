...
extern void func_ov124_020d1328(void);
extern void func_ov124_020d1368(void);
extern void func_ov124_020d13a0(void);
extern void func_ov124_020d1454(void);
extern void func_ov124_020d14b0(void);
...
void func_ov124_020d1140(char *self)
{
    int kinds[2];
    u16 hw;
    int i;
    ...
    *(Callback *)(self + 0x8) = func_ov124_020d1328;
    *(Callback *)(self + 0xc) = func_ov124_020d1368;
    *(Callback *)(self + 0x1c) = func_ov124_020d13a0;
    *(Callback *)(self + 0x30) = func_ov124_020d14b0;
    *(Callback *)(self + 0x1d0) = func_ov124_020d1454;
    hw = *(u16 *)(self + 0x60);
