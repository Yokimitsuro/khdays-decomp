...
extern int func_ov124_020d0e64(int actor, int mode);
extern void VEC_Subtract(const void *a, const void *b, Vec3 *out);
extern int func_01ff8d18(Vec3 *v, Vec3 *d);
extern void func_0202f384(Vec3 *dst, void *quat, const Vec3 *src);
extern void func_ov124_020d10c4(int shot, void *from, Vec3 *dir);
extern void func_0203c634(int *node, int slot, void *cb);
extern const Vec3 data_02042258;

void func_ov124_020d0b2c(int *node)
{
    int *state = (int *)node[1];
    Vec3 dir;
    int y;

    state[9] = func_ov124_020d0e64(*state, 0);
    if (state[9] == 0) {
    ...
    if (state[0xb] == 0 && state[10] >= 0xccc) {
        ...
        dir.y = y;
        func_01ff8d18(&dir, &dir);
        func_ov124_020d10c4(*(int *)(*state + 0x394), (void *)(*(int *)(*state + 0x390) + 0x14), &dir);
    }
