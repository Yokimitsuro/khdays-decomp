...
extern void func_ov124_020d08c4(void);

void func_ov124_020d086c(char *obj) {
    char *p = *(char **)(obj + 4);
    func_ov107_020c9264(*(int *)p, 1, 1);
    int min = *(int *)(*(char **)p + 0x224);
    int range = *(int *)(*(char **)p + 0x228) - min;
    if (range < 0) range = -range;
    *(int *)(p + 0x28) = min + func_02023eb4(range + 1);
    func_0203c634(obj, *(signed char *)(obj + 0x20), func_ov124_020d08c4);
}
