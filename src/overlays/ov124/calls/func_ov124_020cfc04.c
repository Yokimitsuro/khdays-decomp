...
extern const int data_ov124_020d1ed8[2];
extern struct Ov153Vec3 data_ov124_020d1ee0;
...
extern void *func_ov124_020d110c(int *self);
...
void func_ov124_020cfc04(int param)
{
    ...
    kinds[0] = data_ov124_020d1ed8[0];
    kinds[1] = data_ov124_020d1ed8[1];
    offset = data_ov124_020d1ee0;
    ...
    *(void **)(param + 0x2c) = func_ov124_020cffa4;
    *(void **)(param + 0x10) = func_ov124_020d001c;
    *(void **)(param + 0x34) = func_ov124_020d0060;
    *(void **)(param + 0x38) = func_ov124_020d0158;
    *(void **)(param + 0x1e0) = func_ov124_020d0328;
    *(void **)(param + 0x1d0) = func_ov124_020d01b0;
    *(void **)(param + 0x1dc) = func_ov124_020cffcc;
    ...
    *(u16 *)(param + 0x100 + 0xae) |= 0x10;

    {
        ...
        ((void **)self)[0xe4] = func_0203bee8(self[0xe1], 1, data_ov124_020d1f4c);
        ...
        *((int **)self)[0xe2] = func_ov107_020c3210(&req);
        ((void **)self)[0xe5] = func_ov124_020d110c(self);
        func_0203355c(0x115);
    }
}
