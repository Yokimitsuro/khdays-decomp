...
struct Buf_020ce7fc { int w[22]; };
extern const struct Buf_020ce7fc data_ov276_020d2ba0;
struct b0_020ce7fc { unsigned char b0 : 1; };
void func_ov276_020d044c(int param_1) {
    struct Buf_020ce7fc buf = data_ov276_020d2ba0;
