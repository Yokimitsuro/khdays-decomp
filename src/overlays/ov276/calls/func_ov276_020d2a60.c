/* func_ov276_020d2a60 -- face the target and close in, unless it is already too near.
 *
 ...
 * magnitude). Subtracting ctx[0]+0x480 from it and comparing against 0x2000 is the range test:
 ...
 * func_ov276_020d0cdc). Otherwise the tail is the same Y-rotation steering as
...
void func_ov276_020d2a60(int self) {
    int *ctx;
    ...
    if (func_01ff8d18(&d, &d) - *(int *)(ctx[0] + 0x480) < 0x2000) {
