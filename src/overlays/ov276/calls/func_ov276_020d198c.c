/* func_ov276_020d198c -- the wait loop of the approach: hold the stance for a few ticks, then
 * commit. This is the other half of func_ov276_020d1808, which enters here; from here the object
 * either loops back into 020cfeac or moves on to func_ov276_020d1b44.
 *
 * func_ov276_020d0cf0 returns the current range (negative aborts). Inside 0x1000 there is a 45%
...
extern int func_ov276_020d0cf0(int self);
...
extern void func_ov276_020d1b44(void);
...
void func_ov276_020d198c(int self) {
    int *ctx;
    MtxFx33 mtx;
    int range;
    int idx;
    ...
    ctx = *(int **)(self + 4);
    range = func_ov276_020d0cf0(self);
    if (range < 0) {
    ...
    if (*(unsigned char *)(ctx[1] + 0xad) == 0) {
        ...
        if (--ctx[0x14] > 0) {
            func_0203c634(self, *(signed char *)(self + 0x20), func_ov276_020d1808);
            return;
        }
        ...
        func_0203c634(self, *(signed char *)(self + 0x20), func_ov276_020d1b44);
        return;
    }
    ...
    MTX_MultVec33((const VecFx32 *)(*(int *)(ctx[0] + 0x470) + 0x2c), &mtx,
