/* func_ov276_020d0cf0: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
int func_ov276_020d0cf0(Param *param)
{
    Wrap *wrap;
    Obj *obj;
    P3bc *p3bc;
    ...
    obj = wrap->obj;
    diff = diff - (obj->v480 + obj->p3bc->v80);
    if (diff < 0) {
        diff = 0;
    }
