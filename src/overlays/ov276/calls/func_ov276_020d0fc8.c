/* func_ov276_020d0fc8: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
void func_ov276_020d0fc8(Obj *obj)
{
    ...
    box[0] = 0;
    res = (Result *)func_01fff8e8(*(int *)((char *)node4 + 0x7c), &box[1], &local1c, 0x10cd);
    if (res != 0 && res->f8 == 0) {
