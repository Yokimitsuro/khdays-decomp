...
extern void func_ov276_020d2230(void);
void func_ov276_020d2194(int self) {
    int *obj = *(int **)(self + 4);
    func_ov107_020c0b90(*obj, 0x5, *(struct vec *)(*obj + 0x474), 0);
    func_ov107_020c0b90(*obj, 3, *(struct vec *)(*obj + 0x474), 0);
    obj[0x13] = 0;
    *(char *)((char *)obj + 0x61) = 0;
    *(char *)((char *)obj + 0x62) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov276_020d2230);
}
