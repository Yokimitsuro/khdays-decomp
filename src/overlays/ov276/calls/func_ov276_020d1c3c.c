...
extern void func_ov276_020d0cdc(int actor, int anim);
...
extern void func_ov276_020d1d14(int *node);
extern struct Vecx32 data_02041dc8;

void func_ov276_020d1c3c(int *node)
{
