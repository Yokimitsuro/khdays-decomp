...
extern void func_ov148_020d0668(int *s, int b, int c);
extern void func_0203c634(int *self, int idx, void *cb);
extern void func_ov148_020d14b4(void);

typedef struct { int x, y, z; } Vec3;
extern Vec3 data_02041dc8;

void func_ov148_020d13d4(int *self) {
    Vec3 v;
    int *s = (int *)self[1];
    int p;
    v = data_02041dc8;
    ...
    func_ov148_020d0668(s, v.y, *s + 0x3d8);
    func_0203c634(self, *(signed char *)((char *)self + 0x20), (void *)&func_ov148_020d14b4);
}
