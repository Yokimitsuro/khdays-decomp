...
extern void func_ov148_020d0770(int *state, struct Vec3 v, int flag);
extern void func_ov107_020c9264(int a, int b, int c);
extern void func_ov148_020d0600(int a, int b);
extern void func_0203c634(int self, int idx, int cb);
extern int func_ov148_020d12a8;

void func_ov148_020d1230(int self) {
    int *state = *(int **)(self + 4);

    func_ov148_020d0770(state, *(struct Vec3 *)(state + 10), 1);
    ...
    func_ov148_020d0600(*state, 2);
    func_0203c634(self, *(signed char *)(self + 0x20), (int)&func_ov148_020d12a8);
}
