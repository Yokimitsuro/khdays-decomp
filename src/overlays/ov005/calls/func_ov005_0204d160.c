...
extern void func_ov005_0204cac0(int ctx, int section);
extern void func_ov005_0204cb00(int ctx, int section);
extern void func_ov005_0204cb68(int ctx, int section);
extern void NNSi_FndFreeFromDefaultHeap(int ptr);
void func_ov005_0204d160(int ctx, int param2) {
    int *buf = (int *)func_0201ef9c(param2, 0xe);
    int a = buf[0], c = buf[2], b = buf[1];
    func_ov005_0204cac0(ctx, (int)buf + a);
    func_ov005_0204cb00(ctx, (int)buf + b);
    func_ov005_0204cb68(ctx, (int)buf + c);
    if (buf != 0) {
