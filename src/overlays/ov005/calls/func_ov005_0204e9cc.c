 ...
 * param_4(rec, param_3) is nonzero, build a node via func_ov005_0204e5a8 and append it
...
unsigned short func_ov005_0204e9cc(int param_1, unsigned short *param_2, int param_3,
    ...
    for (i = 0; i < count; i++) {
        if (param_4(param_2, param_3)) {
            int *node = func_ov005_0204e5a8(param_2, (short *)(param_2 + 0x18));
