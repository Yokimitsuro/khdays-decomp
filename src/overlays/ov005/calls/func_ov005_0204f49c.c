...
extern void func_ov005_0204ef70(void *ctx, void *obj, int a, int b, int flag);
extern void func_ov005_0204f354(Params *p, void *block);

void func_ov005_0204f49c(void *ctx, Params *p, char *block) {
    int one = 1;
    int i;
    int a = p->a;
    ...
    for (i = 0; i < 4; i++) {
        ...
        func_ov005_0204ef70(ctx, *(void **)(row + 0x34), a, p->b, one);
    }
