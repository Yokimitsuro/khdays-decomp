...
extern void func_ov005_020504c0(int *self);
extern int func_ov005_0204eda0(int a);
...
extern void func_ov005_0204fc14(int *self, int a, void *node, int idx);
extern void func_ov005_02050188(int *self, int base, int a, int b, unsigned long long *m);

struct Pair { int a, b; };
struct Self { char pad[0xcc]; struct Pair pairs[3]; };
extern void func_ov005_0204ee2c(void *p);

void func_ov005_02050730(int *self, int base, void *list, int p4) {
    ...
    func_ov005_020504c0(self);
    tc = func_ov005_0204eda0(0);
    self[0x3d] = 0;
    self[0x3c] = 0;
    self[0x3a] = 0;
    ...
    for (node = NNS_FndGetNextListObject(list, 0); node != 0;
        ...
        func_ov005_0204fc14(self, *(unsigned short *)((char *)node + 0xa) * 0xa0 + base, node,
    ...
    for (k = 0; k < 3; k++, base += 0xa0) {
        func_ov005_02050188(self, base, ((struct Self *)self)->pairs[k].a,
    ...
    func_ov005_0204ee2c((char *)self + 0x2c);
    if (self[0x3a] != 0) {
        func_02034258(0x13);
        self[0x3a] = 0;
    }
