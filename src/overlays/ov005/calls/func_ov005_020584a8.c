...
extern void func_ov005_0204ec90(
    Ov009ObjectList *list,
    const Ov009ListConfig *config
);
extern void func_ov005_0204ecf0(Ov009ObjectList *list);
extern int func_ov005_020583b0(
...
int func_ov005_020584a8(void)
{
    ...
    func_ov005_0204ec90(&firstList, &config);
    config.capacity = 6;
    func_ov005_0204ec90(&secondList, &config);
    ...
    func_ov005_0204ecf0(&secondList);
    func_ov005_0204ecf0(&firstList);
