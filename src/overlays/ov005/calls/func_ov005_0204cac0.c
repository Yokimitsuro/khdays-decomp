...
extern void func_ov005_0204d398(int owner, void *obj, unsigned short kind);
void func_ov005_0204cac0(int param_1, int param_2) {
    ...
    for (i = 0; i < n; i++) {
        ...
        func_ov005_0204d398(param_1, obj, *(unsigned short *)(p + 4));
        p += *(int *)p;
    }
}
