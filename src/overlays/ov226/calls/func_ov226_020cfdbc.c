/* Constructor of the ov226 enemy. Installs the handlers (+8, +0xc, +0x1c message, +0x30, +0x28, +0x2c,
 ...
 * builds the eight sub-items of data_ov226_020d4b20 into the +0x424 pair table (attached, hidden);
...
extern void func_ov226_020d0208(void);
extern void func_ov226_020d0260(void);
extern void func_ov226_020d030c(void);
extern void func_ov226_020d06a8(void);
extern void func_ov226_020d0284(void);
extern void func_ov226_020d02c8(void);
extern void func_ov226_020d05b8(void);
extern void func_ov226_020d0704(void);
extern void func_ov226_020d0624(void);
extern void func_ov226_020d09d0(void);
extern void func_ov226_020d09fc(void);
extern void *func_ov107_020c9440(char *self, int index);
extern int func_0203b898(void *item);
extern void func_ov226_020cfd80(char *self);
...
extern int func_ov226_020d3f60(char *self);
...
void func_ov226_020cfdbc(char *self)
{
    IdTable8 ids = data_ov226_020d4b20;
    Bounds bounds;
    Vec3 lift;
    Sphere sph;
    Vec3 origin;
    ...
    bounds.max.y = 0x2000;
    bounds.max.z = 0x2000;
    *(Callback *)(self + 0x8) = func_ov226_020d0208;
    *(Callback *)(self + 0xc) = func_ov226_020d0260;
    *(Callback *)(self + 0x1c) = func_ov226_020d030c;
    *(Callback *)(self + 0x30) = func_ov226_020d06a8;
    *(Callback *)(self + 0x28) = func_ov226_020d0284;
    *(Callback *)(self + 0x2c) = func_ov226_020d02c8;
    *(Callback *)(self + 0x34) = func_ov226_020d05b8;
    *(Callback *)(self + 0x1d0) = func_ov226_020d0704;
    *(Callback *)(self + 0x1dc) = func_ov226_020d0624;
    *(Callback *)(self + 0x1e0) = func_ov226_020d09d0;
    *(Callback *)(self + 0x1e4) = func_ov226_020d09fc;
    ...
    *(int *)(self + 0x3d8) = func_0203bdfc(*(int *)(self + 0x384), data_ov226_020d4b6c);
    *(int *)(self + 0x3dc) = func_0203bdfc(*(int *)(self + 0x384), data_ov226_020d4b78);
    *(int *)(self + 0x3d4) = func_0203bdfc(*(int *)(self + 0x384), data_ov226_020d4b88);
    *(int *)(self + 0x3e0) = func_0203bdfc(*(int *)(self + 0x384), data_ov226_020d4b94);
    *(int *)(self + 0x3e4) = func_0203bdfc(*(int *)(self + 0x384), data_ov226_020d4ba0);
    *(int *)(self + 0x3fc) = func_ov107_020c9e50(func_ov107_020c9440(self, 0x21), data_ov226_020d4bac);
    lift.x = 0;
    lift.y = -0x11ae;
    lift.z = 0;
    ...
    for (i = 0; i < 4; i++) {
        ((struct Ov226 *)self)->helpers[i] = func_ov226_020d3f60(self);
    }
    func_0203355c(0x14c);
}
