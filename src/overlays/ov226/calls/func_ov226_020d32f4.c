 ...
 * the tracking step (func_ov226_020d1330) ends the state when negative, otherwise the +0x3fc
 ...
 * reaction 0x14c mode 5 at the +8 point. Once the +4 item goes idle (+0xad) the +0x78 target
...
extern int func_ov226_020d1330(int *node, int arg);
...
void func_ov226_020d32f4(int *node)
{
