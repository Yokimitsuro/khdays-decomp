...
extern void func_ov226_020d104c(int self, int *node);
extern void func_ov226_020d0a2c(int *state, int mode, struct Ov221SweepParams *params);
extern const Vec3 data_02042264;
extern const Vec3 data_02042270;
extern const Vec3 data_02042258;

void func_ov226_020d17fc(int *node)
{
    ...
    *(Vec3 *)(*state + 0xf0) = step;
    ...
    func_ov226_020d104c(*state, node);
    ...
    *(int *)(*state + 0x41c) += *(int *)(*node + 0x2c);
    ...
    params.nReach = 0x1900 + (t * 0x4a00 / 0xc38 + 0x33);
    params.v0c = data_02042270;
    params.v18 = data_02042258;
    params.v24 = data_02042264;
    params.bFlag = 1;
    func_ov226_020d0a2c(state, 6, &params);
}
