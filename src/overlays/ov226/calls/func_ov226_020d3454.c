/* func_ov226_020d3454 -- enter the approach: pick a lane, a speed and a duration, then dispatch.
 * A negative reading from func_ov226_020d1330 aborts straight to the dispatcher.
 *
...
extern int func_ov226_020d1330(int self, int kind);
...
extern void func_ov226_020d3598(void);

void func_ov226_020d3454(int self) {
    int *ctx;
    int v;
    int speed;
    int steps;
    ...
    *(unsigned char *)((char *)ctx + 0x76) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov226_020d3598);
}
