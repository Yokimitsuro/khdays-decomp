/* func_ov226_020d030c -- effect command hook (byte-identical in ov221 /
 * ov222 / ov223 / ov226).  A type-5 command carries three big-endian
 ...
 * handle): slots 0 / 5 / 6 spawn kind 0x15 / 5 / 5 at the transform (020c0794) and slot 1 kind 0x15 on the actor,
...
void func_ov226_020d030c(EffectActor *pActor, u8 *pCommand, int nArg)
{
