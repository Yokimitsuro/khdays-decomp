/* c634 state-entry handler: wire owner->f78 to the func_ov266_020d36b8 hook,
 ...
 * obj->f4, then dispatch state with the func_ov266_020d37ec callback. owner is
 * re-read from *obj each section. self->+0x20 = slot index. */
extern void func_0202accc(int a, int b, int c, int d);
extern void func_0203c634(int self, int index, void *cb);
extern void func_ov266_020d36b8(void);
extern void func_ov266_020d37ec(void);
void func_ov266_020d3724(int self) {
    int obj = *(int *)(self + 4);
    int i;
    *(int *)(*(int *)obj + 0x78) = (int)&func_ov266_020d36b8;
    ...
    *(int *)(obj + 4) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov266_020d37ec);
}
