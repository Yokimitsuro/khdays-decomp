/* func_ov266_020d3648 -- push one entry into the ring buffer at ctx[0]+0x90 and advance the write
 * index with a wrap.
 *
...
void func_ov266_020d3648(int *ctx, const VecFx32 *v, const Quaternion *q) {
    int i;
    int base;
    int slot;
