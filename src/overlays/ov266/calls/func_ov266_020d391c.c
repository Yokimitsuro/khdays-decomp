...
extern void func_ov266_020d39f0(void);
extern void func_ov266_020d3ae8(void);
extern void func_ov266_020d3a84(void);
extern PoolEntry *func_01fffca8(void *pool, int elementSize, int capacity);
extern int func_ov107_020c319c(void *camera);

void func_ov266_020d391c(char *self)
{
    u16 hw;
    int nHalf;

    *(Callback *)(self + 0xc) = func_ov266_020d39f0;
    *(Callback *)(self + 0x30) = func_ov266_020d3ae8;
    *(Callback *)(self + 0x1d0) = func_ov266_020d3a84;
    hw = *(u16 *)(self + 0x60);
