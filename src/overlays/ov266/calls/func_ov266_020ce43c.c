/* Constructor of the ov266 enemy. Installs the handlers (+8, +0xc draw,
 ...
 * +0x1ae; builds the +0x384 rig from pose 0 (owned by the enemy, callback func_ov266_020cde1c,
 ...
 * func_ov266_020ce2f4), all hidden, subscribed and posed with the identity quaternion at +0x3cc;
 * builds the +0x388 grab part from pose 0xd (callback func_ov266_020ce360, bone at +0x588);
 * registers action 2/3 lowered by the scale (rate 0.6) and action 1/2 (rate 0.8); builds the
 * ten sub-items of data_ov266_020d3f20 into the +0x60c pair table (the first two from the shared
 ...
 * trails (func_ov266_020d28b0) and the +0x5d4 shadow (func_ov266_020d38e8), and loads sound
 * 0x15e. */
...
extern void func_ov266_020ce9c8(void);
extern void func_ov266_020cea38(void);
extern void func_ov266_020ceaf8(void);
extern void func_ov266_020cf5f8(void);
extern void func_ov266_020cea68(void);
extern void func_ov266_020ceab0(void);
extern void func_ov266_020cef70(void);
extern void func_ov266_020cf010(void);
extern void func_ov266_020cf0a4(void);
extern void func_ov266_020cf314(void);
extern void func_ov266_020cf654(void);
extern void func_ov266_020cf284(void);
extern void func_ov266_020cf884(void);
extern void func_ov266_020cf8b0(void);
extern void func_ov266_020cde1c(void);
extern void func_ov266_020ce2f4(void);
extern void func_ov266_020ce360(void);
...
extern int func_ov266_020d28b0(char *self);
extern int func_ov266_020d38e8(char *self);
...
void func_ov266_020ce43c(char *self)
{
    IdTable ids = data_ov266_020d3f20;
    Box params;
    Placement place;
    Capsule cap;
    Vec3 lift;
    ...
    params.w[4] = 0x2000;
    params.w[5] = 0x2000;
    *(Callback *)(self + 0x8) = func_ov266_020ce9c8;
    *(Callback *)(self + 0xc) = func_ov266_020cea38;
    *(Callback *)(self + 0x1c) = func_ov266_020ceaf8;
    *(Callback *)(self + 0x30) = func_ov266_020cf5f8;
    *(Callback *)(self + 0x28) = func_ov266_020cea68;
    *(Callback *)(self + 0x2c) = func_ov266_020ceab0;
    *(Callback *)(self + 0x34) = func_ov266_020cef70;
    *(Callback *)(self + 0x20) = func_ov266_020cf010;
    *(Callback *)(self + 0x24) = func_ov266_020cf0a4;
    *(Callback *)(self + 0x38) = func_ov266_020cf314;
    *(Callback *)(self + 0x1d0) = func_ov266_020cf654;
    *(Callback *)(self + 0x1dc) = func_ov266_020cf284;
    *(Callback *)(self + 0x1e0) = func_ov266_020cf884;
    *(Callback *)(self + 0x1e4) = func_ov266_020cf8b0;
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov266_020cde1c;
    func_0203bfb4(*(int *)(self + 0x9c), *(int *)(self + 0x384));
    func_0203ca14((void *)(*(int *)(self + 0x384) + 4), 0, 0, -0x2000);
    *(int *)(self + 0x58c) = func_0203bdfc(*(int *)(self + 0x384), data_ov266_020d3f6c);
    *(int *)(self + 0x590) = func_0203bdfc(*(int *)(self + 0x384), data_ov266_020d3f7c);
    *(int *)(self + 0x598) = func_0203bdfc(*(int *)(self + 0x384), data_ov266_020d3f88);
    *(int *)(self + 0x59c) = func_0203bdfc(*(int *)(self + 0x384), data_ov266_020d3f94);
    *(int *)(self + 0x5a0) = func_0203bdfc(*(int *)(self + 0x384), data_ov266_020d3fa4);
    *(int *)(self + 0x5a4) = func_0203bdfc(*(int *)(self + 0x384), data_ov266_020d3fb0);
    *(char **)(self + 0x2cc) = self + 0x514;
    quat = data_020420f8;
    for (i = 0; i < 16; i++) {
        if (i < 15) {
            ((struct Items *)self)->items[i] = func_0203b898(func_ov107_020c9440(self, 1));
            *(int *)(self + 0x594) = func_0203bdfc(((struct Items *)self)->items[i], data_ov266_020d3fbc);
        } else {
            ((struct Items *)self)->items[i] = func_0203b898(func_ov107_020c9440(self, 2));
        }
        if (i == 0) {
            *(Callback *)(((struct Items *)self)->items[i] + 0x6c) = func_ov266_020ce2f4;
    ...
    *(Callback *)(*(int *)(self + 0x388) + 0x6c) = func_ov266_020ce360;
    *(char **)(*(int *)(self + 0x388) + 0x84) = self;
    func_0203c7ac(*(int *)(self + 0x388), 0);
    *(int *)(self + 0x588) = func_0203bdfc(*(int *)(self + 0x388), data_ov266_020d3fc4);
    lift.x = 0;
    lift.y = -0x3800;
    lift.z = 0;
    ...
    for (i = 0; i < 2; i++) {
        ((int *)(self + 0x5cc))[i] = func_ov266_020d28b0(self);
    }
    *(int *)(self + 0x5d4) = func_ov266_020d38e8(self);
    func_0203355c(0x15e);
}
