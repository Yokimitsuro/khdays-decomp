 ...
 *
 * NOTE the extern for func_ov266_020d2844 declares its 3rd parameter with its REAL
...
extern void func_ov266_020d2844(int obj, int a, struct vec3 *v, int c);
extern void func_0203c634(void *self, int idx, void *cb);
extern short data_0203d210[];

void func_ov266_020d1ca8(void *self) {
    int *c0 = ((int **)self)[0];
    int *ctx = ((int **)self)[1];
    int t;
    ...
    if (t >= 0x1c28 && *(unsigned char *)((char *)ctx + 0x5a) == 0) {
        ...
        func_ov266_020d2844(*(int *)(*ctx + 0x5cc), *ctx + 0x55c, &v, 1);
        func_ov266_020d2844(*(int *)(*ctx + 0x5d0), *ctx + 0x55c, &v, -1);
