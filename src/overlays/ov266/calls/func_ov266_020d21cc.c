...
extern void func_ov266_020cf914(int *state, int mode, Vec3 *sphere);
extern int func_ov266_020cf8e0(int *state);
...
void func_ov266_020d21cc(int *node)
{
    ...
    if (state[0x10] >= 0xbb0 && state[0x10] <= 0xff0) {
        if (*(unsigned char *)((char *)state + 0x5a) == 0) {
            ...
            func_ov107_020c5af8(*state, 0x15e, 0xe, (void *)state[2]);
        ...
        *(Vec3 *)(state + 4) = *(Vec3 *)(state + 0xa);
        ...
        func_ov266_020cf914(state, 2, &sphere.v);
    }
    if (*(unsigned char *)(state[1] + 0xad) != 0) {
        return;
    }
    if (func_ov266_020cf8e0(state) == 0 && state[0x19] != 0) {
        state[0x19] = 0;
