/* func_ov266_020d388c -- notify the owner's callback, then run the finaliser if we are in state 1.
 *
 ...
 * independently of any of that, state 1 at +0x50 runs func_ov266_020d3a64 over +0x214. */
...
extern void func_ov266_020d3a64(int a);

void func_ov266_020d388c(int obj) {
    ...
    if (*(int *)(obj + 0x50) == 1) {
        func_ov266_020d3a64(*(int *)(obj + 0x214));
    }
}
