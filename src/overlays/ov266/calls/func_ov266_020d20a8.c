...
extern void func_ov266_020d21cc(void);
extern const short data_0203d210[];

#define ANG2IDX(a) ((unsigned short)(((long long)(a) * 0x28be60db9391LL + 0x80000000000LL) >> 44) >> 4)

void func_ov266_020d20a8(void *self) {
    ...
    *(int *)(*ctx + 0x5a8) = (int)func_ov107_020cab14(*ctx, 0);
    ...
    func_01ffa724(0xa00, (struct vec3 *)(ctx + 0xa), (struct vec3 *)(ctx + 0xa));
    func_ov107_020c9264(*ctx, 0xe, 0);
    ctx[0x10] = 0;
    *(char *)((char *)ctx + 0x5a) = 0;
    *(char *)((char *)ctx + 0x5b) = 0;
    func_0203c634(self, *(signed char *)((char *)self + 0x20), func_ov266_020d21cc);
}
