...
extern void func_ov266_020cff18(int *node, int actor, void *at);
...
void func_ov266_020d0e30(int *node)
{
    ...
    if ((((struct Hw60 *)(*state + 0x60))->lo & 1) != 0) {
        func_ov266_020cff18(node, *state, (void *)state[2]);
    }
    *(int *)(*state + 0x5a8) = func_ov107_020cab14(*state, 0);
    ...
    if (func_ov266_020cf42c(state, 1) != 0) {
        if (gap < 0x3000) {
        ...
        if (gap > 0x9800) {
            ...
            func_01ffa724(-*(int *)(*state + 0x578), &fwd, (Vec3 *)(state + 4));
        } else if (*(unsigned char *)(state[1] + 0xad) == 0 && func_ov266_020cffbc(node) == 0
                   && func_ov266_020cfb00(node, gap) == 0) {
            *(unsigned char *)(*state + 0x1c7) = 2;
        }
    }
    if (*(unsigned char *)(state[1] + 0xad) == 0 && func_ov266_020cfb00(node, gap) == 0) {
    ...
    *(signed char *)(*state + 0x1c7) = -1;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov266_020d1124);
}
