/* func_ov266_020d0200 -- flag all 16 slots as dirty, then hand off.
 *
 ...
 * func_ov266_020d38cc with the thing at ctx[0]+0x5d4.
 *
...
extern void func_ov266_020d38cc(int a);

void func_ov266_020d0200(int *ctx) {
    int i;
    int slot;
    ...
    func_ov266_020d38cc(*(int *)(ctx[0] + 0x5d4));
}
