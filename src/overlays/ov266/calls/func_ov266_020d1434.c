...
extern void func_ov266_020d38cc(int handle);
extern void func_ov266_020d15c0(int *node);

void func_ov266_020d1434(int *node)
{
    ...
    *(int *)(*state + 0x57c) += (0x1000 - *(int *)(*state + 0x57c)) * 0x140 / 0x1000;
    if (*(int *)(*state + 0x57c) >= 0) {
        ...
        if (state[0x10] >= 0x1000) {
            func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov266_020d15c0);
            return;
        }
    } else {
    ...
    func_ov266_020d38cc(*(int *)(*state + 0x5d4));
