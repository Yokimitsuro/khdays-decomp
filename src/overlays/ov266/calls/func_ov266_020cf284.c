/* func_ov266_020cf284 -- push the current stance byte out to the sub-object's state channels.
 *
 ...
 *
 * One of a 3-member shape family; the twins live in ov212/ov267.
 *
...
void func_ov266_020cf284(int obj) {
