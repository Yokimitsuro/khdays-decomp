/* func_ov266_020d2844 -- move the object, notify the owner's callback, latch the ready flag, and
...
extern void func_ov266_020d2b88(int a, int b, int c);

void func_ov266_020d2844(int obj, int a, int b, int c) {
    ...
    *(int *)(obj + 0x388) = 1;
    if (*(int *)(obj + 0x50) == 1) {
        func_ov266_020d2b88(*(int *)(obj + 0x214), b, c);
    }
}
