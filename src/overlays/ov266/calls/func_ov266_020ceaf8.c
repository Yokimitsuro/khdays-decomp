/* Message hook of the ov266 enemy, receiving side of func_ov212_020cd2a0. A
...
void func_ov266_020ceaf8(char *self, u8 *msg, int arg)
{
    Vec3 w;
    Quat q;
    SrtTransform t;
    ...
    if (msg[2] == 0) {
        ...
        case 1:
            ...
            ((struct Ov266 *)self)->pairs[msg[3]].handle =
                func_ov107_020c0794(*(int *)(self + 0x3c), ((struct Ov266 *)self)->pairs[msg[3]].res, 0x17,
                                    msg[3] == 0 ? 1 : 3, &t);
            break;
        case 3:
        case 8:
            ((struct Ov266 *)self)->pairs[msg[3]].handle =
                func_ov107_020c0794(*(int *)(self + 0x3c), ((struct Ov266 *)self)->pairs[msg[3]].res, 5, msg[4], &t);
            break;
        case 7:
            ((struct Ov266 *)self)->pairs[msg[3]].handle =
                func_ov107_020c0794(*(int *)(self + 0x3c), ((struct Ov266 *)self)->pairs[msg[3]].res, 0x15, msg[4], &t);
            break;
        case 2:
        case 4:
            ((struct Ov266 *)self)->pairs[msg[3]].handle =
                func_ov107_020c09a0(*(int *)(self + 0x3c), ((struct Ov266 *)self)->pairs[msg[3]].res, 0x15,
                                    self + 0x54c, msg[4], msg[3] == 2 ? 1 : 0);
            break;
        case 5:
            ((struct Ov266 *)self)->pairs[msg[3]].handle =
                func_ov107_020c09a0(*(int *)(self + 0x3c), ((struct Ov266 *)self)->pairs[msg[3]].res, 5,
                                    self + 0x54c, msg[4], 0);
            break;
        case 6:
            ((struct Ov266 *)self)->pairs[msg[3]].handle =
