...
extern void func_ov123_020cc7e8(void);
extern void func_ov123_020cc9f0(void);
extern void func_ov123_020cc948(void);
void func_ov123_020cc718(int *node) {
    ...
    *(signed char *)(*state + 0x1c7) = 0xff;
    ...
    func_0203c634(node, 0, func_ov123_020cc7e8);
    func_0203c634(node, 1, func_ov123_020cc9f0);
    func_0203c634(node, 2, func_ov123_020cc948);
}
