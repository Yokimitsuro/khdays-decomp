...
extern void func_ov123_020cd6e8(void);
extern void func_ov123_020cd728(void);
extern void func_ov123_020cd760(void);
extern void func_ov123_020cd814(void);
extern void func_ov123_020cd870(void);
extern void *func_ov107_020c9440(int pool, int index);
extern int func_0203b898(void *item);
extern void func_0203ca50(char *pose, int x, int y, int z);
...
void func_ov123_020cd500(char *self)
{
    int kinds[2];
    u16 hw;
    int i;
    i = 0;
    kinds[0] = data_ov123_020ce2b0[0];
    kinds[1] = data_ov123_020ce2b0[1];
    *(Callback *)(self + 0x8) = func_ov123_020cd6e8;
    *(Callback *)(self + 0xc) = func_ov123_020cd728;
    *(Callback *)(self + 0x1c) = func_ov123_020cd760;
    *(Callback *)(self + 0x30) = func_ov123_020cd870;
    *(Callback *)(self + 0x1d0) = func_ov123_020cd814;
    hw = *(u16 *)(self + 0x60);
    ...
    *(int *)(self + 0x384) = func_0203b898(func_ov107_020c9440(*(int *)(self + 0x38c), 4));
    func_0203ca50(self + 0xa0, 0x1000, 0x1000, 0x1000);
