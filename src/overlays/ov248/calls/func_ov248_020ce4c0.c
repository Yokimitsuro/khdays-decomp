...
extern void func_ov248_020cd510(int actor, int anim);
...
extern void func_ov248_020ce59c(int *node);
extern struct Vecx32 data_02041dc8;

void func_ov248_020ce4c0(int *node)
{
    ...
    func_ov248_020cd510(*state, 9);
    func_ov107_020c0b90(*state, 2, data_02041dc8, 0);
    func_ov107_020c5af8(*state, 0x146, 4, (void *)state[3]);
    state[0x13] = 0;
    *(unsigned char *)((char *)state + 0x61) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov248_020ce59c);
}
