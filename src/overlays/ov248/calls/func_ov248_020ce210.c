/* func_ov248_020ce210 -- the wait loop of the approach: hold the stance for a few ticks, then
 * commit. This is the other half of func_ov248_020ce08c, which enters here; from here the object
 * either loops back into 020cfeac or moves on to func_ov248_020ce3c8.
 *
 * func_ov248_020cd524 returns the current range (negative aborts). Inside 0x1000 there is a 45%
...
extern void func_ov248_020ce08c(void);
extern void func_ov248_020ce3c8(void);
...
void func_ov248_020ce210(int self) {
    int *ctx;
    MtxFx33 mtx;
    int range;
    int idx;
    ...
    ctx = *(int **)(self + 4);
    range = func_ov248_020cd524(self);
    if (range < 0) {
    ...
    if (*(unsigned char *)(ctx[1] + 0xad) == 0) {
        ...
        if (--ctx[0x14] > 0) {
            func_0203c634(self, *(signed char *)(self + 0x20), func_ov248_020ce08c);
            return;
        }
        ...
        func_0203c634(self, *(signed char *)(self + 0x20), func_ov248_020ce3c8);
        return;
    }
