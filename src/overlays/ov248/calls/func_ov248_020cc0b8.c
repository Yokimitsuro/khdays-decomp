/* Constructor of the ov248 enemy. Installs the handlers (+8, +0xc, +0x1c message, +0x28, +0x2c, +0x30,
 * +0x34, +0x1d0, +0x1dc, +0x1e0, +0x1e4), the +0x1fc bounds box, the +0x64 pose (scale 2.0) and bit 3
 * of +0x1ae; builds the +0x3a8 rig from pose 0 (owned by the enemy, callback 020cbfc8, subscribed to
 ...
 * of data_ov248_020d0b58 into the +0x4a8 pair table (the first from the shared scene resource, the
...
extern void func_ov248_020cc4a4(void);
extern void func_ov248_020cc4fc(void);
extern void func_ov248_020cc5e8(void);
extern void func_ov248_020cca94(void);
extern void func_ov248_020cc570(void);
extern void func_ov248_020cc5ac(void);
extern void func_ov248_020cc854(void);
extern void func_ov248_020ccaf0(void);
extern void func_ov248_020cc9dc(void);
extern void func_ov248_020cd03c(void);
extern void func_ov248_020cd068(void);
extern void func_ov248_020cbfc8(void);
...
extern int func_ov248_020d02b4(char *self);
extern void func_0203355c(int resourceId);
extern IdTable data_ov248_020d0b58;
extern const char data_ov248_020d0c2c[];
extern const char data_ov248_020d0c3c[];
extern const char data_ov248_020d0c4c[];
extern const Vec3 data_02041dc8;

void func_ov248_020cc0b8(char *self)
{
    IdTable ids = data_ov248_020d0b58;
    Bounds bounds;
    Placement place;
    Vec3 lift;
    int i;
    ...
    *(Callback *)(self + 0x8) = func_ov248_020cc4a4;
    *(Callback *)(self + 0xc) = func_ov248_020cc4fc;
    *(Callback *)(self + 0x1c) = func_ov248_020cc5e8;
    *(Callback *)(self + 0x30) = func_ov248_020cca94;
    *(Callback *)(self + 0x28) = func_ov248_020cc570;
    *(Callback *)(self + 0x2c) = func_ov248_020cc5ac;
    *(Callback *)(self + 0x34) = func_ov248_020cc854;
    *(Callback *)(self + 0x1d0) = func_ov248_020ccaf0;
    *(Callback *)(self + 0x1dc) = func_ov248_020cc9dc;
    *(Callback *)(self + 0x1e0) = func_ov248_020cd03c;
    *(Callback *)(self + 0x1e4) = func_ov248_020cd068;
    ...
    *(Callback *)(*(int *)(self + 0x3a8) + 0x74) = func_ov248_020cbfc8;
    ...
    *(int *)(self + 0x3b4) = func_0203bdfc(*(int *)(self + 0x3a8), data_ov248_020d0c2c);
    *(int *)(self + 0x3b8) = func_0203bdfc(*(int *)(self + 0x3a8), data_ov248_020d0c3c);
    ...
    *(int *)(self + 0x490) = func_ov107_020c9e50(func_ov107_020c9440(self, 0x1c), data_ov248_020d0c4c);
    for (i = 0; i < 10; i++) {
        if (i < 1) {
    ...
    *(int *)(self + 0x3b0) = *slot = node;
    for (i = 0; i < 8; i++) {
        ((struct Shots *)self)->shots[i] = func_ov248_020d02b4(self);
    }
    func_0203355c(0x146);
}
