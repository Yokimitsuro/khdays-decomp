/* func_ov248_020ce08c -- pick the reaction for the current stance, or fall through to steering.
 *
 * func_ov248_020cd524 returning negative aborts to a plain c634 re-entry.
 *
 ...
 * 2 -> (9, 7), 3 -> (6, 5) -- and then continues into func_ov248_020ce210. Any other stance
...
extern void func_ov248_020ce210(void);
...
void func_ov248_020ce08c(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
    ...
    if (*(unsigned char *)(ctx[1] + 0xad) == 0) {
        ...
        case 2:
            ...
            func_ov248_020cd510(ctx[0], 7);
            break;
        case 3:
            func_ov107_020c9264(ctx[0], 6, 0);
            func_ov248_020cd510(ctx[0], 5);
            break;
        default:
        ...
        func_0203c634(self, *(signed char *)(self + 0x20), func_ov248_020ce210);
        return;
    }
