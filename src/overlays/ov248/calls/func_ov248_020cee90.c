...
extern void func_ov248_020cd510();
extern void func_0203c634(void *obj, int idx, void *value);
extern short data_0203d210[];
extern void func_ov248_020cef94(void);
void func_ov248_020cee90(int *node) {
    ...
    func_ov248_020cd510(*state, 0xd);
    state[0x13] = 0;
    *(signed char *)((char *)state + 0x61) = 0;
    func_0203c634(node, *(signed char *)(node + 8), func_ov248_020cef94);
}
