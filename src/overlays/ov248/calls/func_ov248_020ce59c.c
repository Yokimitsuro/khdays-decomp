/* func_ov248_020ce59c -- the steering tick that leads into func_ov248_020ce680. Structurally the
...
extern void func_ov248_020ce680(void);
extern short data_0203d210[];

void func_ov248_020ce59c(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
    ...
    func_ov248_020cd510(ctx[0], 0xa);
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov248_020ce680);
}
