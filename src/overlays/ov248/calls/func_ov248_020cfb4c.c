/* func_ov248_020cfb4c -- drive the timed effect, then end the move.
 *
 ...
 * func_ov248_020cd098: the object's own vector from ctx+0x34, three constant vectors, a scaled
...
extern void func_ov248_020cd098(int *ctx, int a, int b, EffectParams *p);
...
void func_ov248_020cfb4c(int self) {
    int *ctx;
    EffectParams p;
    int t;
