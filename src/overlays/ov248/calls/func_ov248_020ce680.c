/* func_ov248_020ce680 -- the steering tick: age the timer, re-aim, and once the owner is ready
 * hand off to func_ov248_020ce76c.
 *
 ...
 * hand-off fires modes 0xe/0xb, clears the byte at +0x62 and re-enters at func_ov248_020ce76c. */
...
extern void func_ov248_020ce76c(void);
extern short data_0203d210[];

void func_ov248_020ce680(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
    ...
    func_ov248_020cd510(ctx[0], 0xb);
    *(unsigned char *)((char *)ctx + 0x62) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov248_020ce76c);
}
