/* Spin attack tick of the ov248 enemy. The +0x4c timer accumulates the frame-time; until bit 7
...
extern void func_ov248_020cd098(int *state, int kind, Sphere *sphere, void *box);
...
void func_ov248_020ceb7c(int *node)
{
    ...
    if (state[0x13] <= 0xbb0 && func_ov248_020cd524(node) < 0) {
    ...
    if (state[0x13] >= 0xbb0 && state[0x13] <= 0x1188) {
        ...
        func_ov248_020cd098(state, 0, &sphere, 0);
        ...
        func_ov248_020cd098(state, 5, &sphere, 0);
    }
    if ((*(u8 *)((char *)state + 0x61) & 1) == 0 && state[0x13] >= 0xbb0) {
        func_ov107_020c5af8(*state, 0x146, 7, (void *)state[3]);
        *(u8 *)((char *)state + 0x61) |= 1;
    }
    if ((*(u8 *)((char *)state + 0x61) & 2) == 0 && state[0x13] >= 0x1430) {
        func_ov107_020c5af8(*state, 0x146, 8, (void *)state[3]);
