 ...
 * func_ov107_020c0b90, clear obj+0x62, and dispatch into func_ov248_020cf1d0. */
...
extern void func_ov248_020cf1d0(void);
void func_ov248_020cf130(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(char *)((char *)obj + 0x62) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov248_020cf1d0);
}
