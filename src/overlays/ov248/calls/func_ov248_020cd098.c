...
void func_ov248_020cd098(int *state, int kind, Sphere *sphere, void *box)
{
    int hits[4];
    Vec3 push;
    Vec3 dir;
    ...
    case 0:
    case 5:
        func_ov107_020c5af8(*state, 0x146, 5, (void *)state[3]);
        break;
    case 1:
        func_ov107_020c5af8(*state, 0x146, 6, (void *)state[3]);
        break;
    case 2:
