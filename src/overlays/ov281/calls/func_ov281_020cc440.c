...
extern void func_0203c960(struct Ov281Transform *transform);
extern void func_0203ca30(struct Ov281Transform *transform,
    ...
    if (command->type02 == 5) {
        ...
        case 5:
            self->specialHandle3c4 =
                func_ov107_020cb040(self, 0x169, 8, 1,
                                    &self->transform0a0);
            break;
        case 6:
