/* Creates the ov050 actor's three sub-objects: allocates one 0x90 block from the
...
extern void func_ov050_020b6d3c(void);
extern void func_ov050_020b6e30(void);
extern int data_ov050_020b7570;
extern int data_ov050_020b7584;
extern int data_ov050_020b7598;

void func_ov050_020b6600(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x90);
    ...
    func_ov022_02091254(*(void **)(self + 0x2000 + 0x644), self,
                        &data_ov050_020b7570, &cfg);
    *(void **)((char *)*(void **)(self + 0x2000 + 0x644) + 0x20) =
        (void *)&func_ov050_020b6d3c;
    ...
    *(void **)((char *)*(void **)(self + 0x2000 + 0x644) + 0x50) =
    ...
    func_ov022_02091254((char *)*(void **)(self + 0x2000 + 0x644) + 0x60, self,
                        &data_ov050_020b7598, &cfg);
    *(void **)((char *)*(void **)(self + 0x2000 + 0x644) + 0x80) =
        (void *)&func_ov050_020b6e30;
}
