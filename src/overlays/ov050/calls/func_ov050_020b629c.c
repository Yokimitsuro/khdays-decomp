/* Advance one ov050 actor node through its wind-up/attack state machine.
 *
...
extern void func_ov050_020b6238(char *pNode, int nKind, int nParam);
extern void func_ov050_020b6200(char *pNode);
extern int func_0202a818(char *pAnim, int nDelta);

void func_ov050_020b629c(char *self, char *pNode, int nDelta)
{
    ...
    if (*(int *)(pNode + 4) != 0) {
        if (*(int *)(pNode + 4) != 6 && *(int *)(self + 0x6bc) != 0x2e
            ...
            func_ov050_020b6238(pNode, 2, 0xf000);
            *(int *)(pNode + 4) = 6;
        }
    ...
    case 3:
        ...
        *(int *)(pNode + 0x114) += nDelta;
        ...
        func_ov050_020b6238(pNode, nKind, 0);
        *(int *)(pNode + 4) = 4;
        break;
