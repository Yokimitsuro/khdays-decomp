...
extern void func_ov050_020b5d34(void);
extern void func_ov050_020b5e10(void);
extern void func_ov050_020b5f28(void);
extern void func_ov050_020b5cb0(void);
extern void func_ov050_020b5d0c(void);
extern void func_ov050_020b5f58(void);
extern void func_ov050_020b6030(void);
extern void func_ov050_020b6920(void);
...
void func_ov050_020b5a70(struct PanelInitConfig *config)
{
    ...
    *(long long *)object = 0;
    ...
    if (config->alternateName == 0) {
        func_0202b914(*(signed char *)(object + 0x4bc), (void *)data_ov050_020b74fc, 1,
                      config->objectType + 7);
    } else {
        func_0202b914(*(signed char *)(object + 0x4bc), (void *)data_ov050_020b7510, 1,
                      config->objectType + 7);
    }

    *(void **)(object + 0x664 + 0x00) = (void *)&func_ov050_020b5d34;
    *(void **)(object + 0x664 + 0x04) = (void *)&func_ov050_020b5e10;
    *(void **)(object + 0x664 + 0x08) = (void *)&func_ov050_020b5f28;
    *(void **)(object + 0x664 + 0x0c) = 0;
    *(void **)(object + 0x664 + 0x10) = 0;
    *(void **)(object + 0x664 + 0x14) = (void *)&func_ov050_020b5cb0;
    *(void **)(object + 0x664 + 0x18) = (void *)&func_ov050_020b5d0c;
    *(void **)(object + 0x664 + 0x20) = (void *)&func_ov050_020b5f58;
    *(void **)(object + 0x664 + 0x28) = 0;
    *(void **)(object + 0x664 + 0x28) = (void *)&func_ov050_020b6030;
    *(void **)(object + 0x664 + 0x24) = (void *)&func_ov050_020b6920;
...
test:
    ...
    *(int *)(object + 0x520) = bone != 0
        ? func_02016f10((void *)bone, &data_ov050_020b7490) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x518) = bone != 0
        ? func_02016f10((void *)bone, &data_ov050_020b74a0) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x514) = bone != 0
        ? func_02016f10((void *)bone, &data_ov050_020b7470) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x51c) = bone != 0
        ? func_02016f10((void *)bone, &data_ov050_020b7460) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x524) = bone != 0
        ? func_02016f10((void *)bone, &data_ov050_020b7480) : -1;
