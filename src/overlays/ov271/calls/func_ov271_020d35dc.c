/*
 * func_ov271_020d35dc -- x3 (ov200/...). Reset the ring buffer to its idle state.
...
extern void func_ov271_020d357c(void);

void func_ov271_020d35dc(int param1) {
    int *state = *(int **)(param1 + 4);
    int i;

    *(int *)(*state + 0x78) = (int)&func_ov271_020d357c;
