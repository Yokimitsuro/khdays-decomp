/* Strafe move of the ov271 enemy, twin of ov200 020cf508 (the handler func_ov271_020d1048 dispatches on its d201). Without a
...
extern void func_ov271_020d1048(void);
...
void func_ov271_020d135c(int self)
{
    int target;
    int *owner;
    int *ctx;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov271_020d1048);
}
