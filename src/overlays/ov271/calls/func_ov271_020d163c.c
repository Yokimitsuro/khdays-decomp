/*
 * func_ov271_020d163c -- x3. AI-state tick: fire, roll a random strafe sign, dispatch.
...
extern void func_ov271_020d1690(void);

void func_ov271_020d163c(int *self) {
    ...
    state[0x14] = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov271_020d1690);
}
