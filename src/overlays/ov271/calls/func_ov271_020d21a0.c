 ...
 * three beam nodes from the kinds of data_ov271_020d36b8 (registered on the owner, bit 1 of
...
extern void func_ov271_020d23f0(void);
extern void func_ov271_020d35dc(void);

int *func_ov271_020d21a0(int owner, int nKind)
{
    int *state;
    KindTable kinds;
    unsigned int i;
    ...
    kinds = data_ov271_020d36b8;
    func_0203c5c0(*(int *)(owner + 0x3c), 0x64, 0x54, (void *)func_ov271_020d23f0, 0, (int *)&state);
    state[0] = owner;
    for (i = 0; i < 3; i++) {
    ...
    func_0203c5c0(*(int *)(owner + 0x3c), 0x64, 8, (void *)func_ov271_020d35dc, 0, state + 0xc);
