/*
 * func_ov271_020d1c14 -- x3. AI-state tick: orient toward the target, then transition on a timer.
...
extern int  func_ov271_020d23e8(int obj);
...
extern int  func_ov271_020d23b4(int obj);
extern int  data_02042264;
extern struct vec3 data_02041dc8;
extern struct h2 data_ov271_020d36a0[];
extern void func_ov271_020d1d68(void);

void func_ov271_020d1c14(int *self) {
    ...
    {
        int s0 = *state;
        if (func_ov271_020d23e8(*(int *)(s0 + 0x390)) != 0) {
            state[0xa] = 0x800;
    ...
    *(struct vec3 *)(state + 9) = data_02041dc8;
    ...
    if (state[0x14] >= 0x2a80) {
        ...
        ps->b = data_ov271_020d36a0[1].b;
        ps->a = data_ov271_020d36a0[1].a;
        cb = *(void (**)(int, void *, int))(*state + 0x24);
        if (cb != 0) {
            cb(*state, ps, 4);
        }
        func_ov107_020c9264(*state, 5, 0);
        func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov271_020d1d68);
        return;
    }
    if (state[0x14] < 0x59a6) {
        return;
    }
    if (func_ov271_020d23b4(*(int *)(*state + 0x390)) != 0) {
        return;
    }
    func_ov107_020c9264(*state, 5, 0);
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov271_020d1d68);
