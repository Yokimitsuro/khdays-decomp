 ...
 * +0x390 parts (func_ov271_020d21a0 kinds 0/1/2) and loads sound 0x161. */
...
extern void func_ov271_020cfef0(void);
extern void func_ov271_020cff54(void);
extern void func_ov271_020cffe8(void);
extern void func_ov271_020d02d8(void);
extern void WM_EndKeySharing_0x020d0458(void);
extern void WM_EndKeySharing_0x020d0464(void);
extern void func_ov271_020d0470(void);
extern void func_ov271_020d06e4(void);
extern void func_ov271_020d04cc(void);
extern void func_ov271_020cffb0(void);
...
extern int func_ov271_020d21a0(char *self, int kind);
...
void func_ov271_020cfc04(char *self)
{
    ...
    *(Callback *)(self + 0x8) = func_ov271_020cfef0;
    *(Callback *)(self + 0xc) = func_ov271_020cff54;
    *(Callback *)(self + 0x1c) = func_ov271_020cffe8;
    *(Callback *)(self + 0x34) = func_ov271_020d02d8;
    *(Callback *)(self + 0x28) = WM_EndKeySharing_0x020d0458;
    *(Callback *)(self + 0x2c) = WM_EndKeySharing_0x020d0464;
    *(Callback *)(self + 0x30) = func_ov271_020d0470;
    *(Callback *)(self + 0x1e0) = func_ov271_020d06e4;
    *(Callback *)(self + 0x1d0) = func_ov271_020d04cc;
    *(Callback *)(self + 0x1dc) = func_ov271_020cffb0;
    ...
    *(int *)(self + 0x39c) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov271_020d36ec);
    *(int *)(self + 0x3a0) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov271_020d36f4);
    ...
    *(int *)(self + 0x38c) = *slot = func_ov107_020c319c(self + 0x64);
    for (i = 0; i < 3; i++) {
        ...
        ((int *)(self + 0x390))[i] = func_ov271_020d21a0(self, kind);
    }
    func_0203355c(0x161);
}
