/*
 * func_ov271_020d18d4 -- x3 (ov200/201/271). AI-state tick: fire, aim the pose at the target, and
 * transition.
...
extern void func_ov271_020d1960(void);
extern int  data_02042264;

void func_ov271_020d18d4(int *self) {
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov271_020d1960);
}
