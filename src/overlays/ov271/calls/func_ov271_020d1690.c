/* Circle tick of the ov271 enemy (x3: ov271/ov201/ov271): acquires the target into +8 -- none
 ...
 * the rate; while the +0x80 count is spent a 0x65 roll re-arms it to a random
 * value between the actor's +0x224 and +0x228, and sub-state 6 is queued when the three
 * +0x390/+0x394/+0x398 aim nodes are all idle (ov271 23d0), 7 when only the last two are.
...
extern int func_ov271_020d23d0(int node);
extern int data_02042264;

void func_ov271_020d1690(int *node)
{
    int actor;
    int target;
    ...
    if (state[0x20] <= 0) {
        ...
        if (roll < 0x14
            && func_ov271_020d23d0(*(int *)(*state + 0x390)) != 0
            && func_ov271_020d23d0(*(int *)(*state + 0x394)) != 0
            && func_ov271_020d23d0(*(int *)(*state + 0x398)) != 0) {
            *(unsigned char *)(*state + 0x1c7) = 6;
            func_0203c634((int)node, *(signed char *)((int)node + 0x20), 0);
            return;
        }
        if (func_ov271_020d23d0(*(int *)(*state + 0x394)) == 0) {
            return;
        }
        if (func_ov271_020d23d0(*(int *)(*state + 0x398)) == 0) {
            return;
        }
