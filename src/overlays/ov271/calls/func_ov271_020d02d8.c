...
extern void func_ov271_020d237c(Ov200AimNode *node, int active);
extern int func_ov271_020d23b4(Ov200AimNode *node);
extern int func_ov271_020d23d0(Ov200AimNode *node);
extern void func_ov107_020cb100(void *handle);
extern void func_ov107_020c7ca4(Ov200Object *self);

void func_ov271_020d02d8(Ov200Object *self) {
    int i;

    if ((self->leavingFlags_01c4 & 0xa) != 0) {
        func_ov271_020d237c(self->aimNodes_0390[0], 0);
        for (i = 1; i < 3; i++) {
            func_ov271_020d237c(self->aimNodes_0390[i], 0);
        }
    ...
    if (func_ov271_020d23b4(self->aimNodes_0390[0]) != 0 && self->mode_01c6 != 6) {
        func_ov271_020d237c(self->aimNodes_0390[0], 0);
    }
    for (i = 1; i < 3; i++) {
        if (func_ov271_020d23b4(self->aimNodes_0390[i]) != 0 && self->mode_01c6 != 7) {
            func_ov271_020d237c(self->aimNodes_0390[i], 0);
        }
    }
    ...
    if (self->mode_01c6 != 7 &&
        func_ov271_020d23d0(self->aimNodes_0390[2]) != 0 &&
        func_ov271_020d23d0(self->aimNodes_0390[1]) != 0 &&
        self->handle_03b8 != 0) {
