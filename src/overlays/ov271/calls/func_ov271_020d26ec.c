 ...
 * hands over to func_ov271_020d2938. */
...
extern const Cmd4 data_ov271_020d36b4;
extern void func_ov271_020d2938(void);

void func_ov271_020d26ec(int *self) {
    ...
    *(int *)(state[1] + 0x5c) &= ~2;
    ...
    state[0x14] = 1;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (void *)func_ov271_020d2938);
}
