/* Constructor of the ov178 enemy (twins by byte identity). Installs the handlers (+8 release, +0xc
...
extern void func_ov178_020cc3b8(void);
extern void func_ov178_020cc6b8(void);
extern void func_ov178_020cc8a4(void);
extern void func_ov178_020cc688(void);
extern void func_ov178_020ccac8(void);
extern void func_ov178_020cbfc4(void);
...
extern int *func_ov178_020ce75c(char *self);
extern const Vec3 data_02041dc8;
extern IdTable data_ov178_020cee70;
extern char data_ov178_020ceeac[];
extern char data_ov178_020ceeb4[];

void func_ov178_020cc020(char *self)
{
    IdTable ids = data_ov178_020cee70;
    Bounds bounds;
    CameraWork work;
    Vec3 v;
    u16 hw;
    ...
    *(Callback *)(self + 0x2c) = func_ov178_020cc3b8;
    *(Callback *)(self + 0x34) = func_ov178_020cc6b8;
    *(Callback *)(self + 0x1d0) = func_ov178_020cc8a4;
    *(Callback *)(self + 0x1dc) = func_ov178_020cc688;
    *(Callback *)(self + 0x1e0) = func_ov178_020ccac8;
    hw = *(u16 *)(self + 0x60);
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov178_020cbfc4;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(unsigned char *)(*(int *)(self + 0x384) + 0xad) = 0;
    *(int *)(self + 0x38c) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov178_020ceeac);
    *(int *)(self + 0x390) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov178_020ceeac);
    *(int *)(self + 0x394) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov178_020ceeb4);
    ...
    *(int **)(self + 0x3ac) = func_ov178_020ce75c(self);
    func_0203355c(0x143);
}
