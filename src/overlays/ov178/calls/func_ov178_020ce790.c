...
extern void func_ov178_020ce864(void);
extern void func_ov178_020ce880(void);
extern void func_ov178_020ce8a8(void);
extern void func_ov178_020ce9f4(void);
extern void func_ov178_020ce9b0(void);
extern void func_ov178_020ce918(void);
extern void *func_ov107_020c9440(int pool, int index);
extern int func_0203b898(void *item);
extern int func_0203bfb4(int subscriber, int item);
extern void func_0203c7ac(int item, int a);

void func_ov178_020ce790(char *self)
{
    u16 hw;
    int pool = *(int *)(self + 0x388);
    *(Callback *)(self + 0x8) = func_ov178_020ce864;
    *(Callback *)(self + 0xc) = func_ov178_020ce880;
    *(Callback *)(self + 0x1c) = func_ov178_020ce8a8;
    *(Callback *)(self + 0x30) = func_ov178_020ce9f4;
    *(Callback *)(self + 0x34) = func_ov178_020ce9b0;
    *(Callback *)(self + 0x1dc) = func_ov178_020ce918;
    hw = *(u16 *)(self + 0x60);
