/* func_ov216_020cce54: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
void func_ov216_020cce54(struct Ov264Node *node, unsigned int kind, struct Ov264Params *params) {
    struct Vec4 origin;
