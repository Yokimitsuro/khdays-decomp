...
extern void func_ov216_020cce54(int *state, int a, int b);
extern void func_ov216_020cdcf4(void);
extern short data_0203d210[];

void func_ov216_020cdb3c(int *self) {
    ...
    if (((LandingFlag *)(*state + 0x17a))->hasLanding) {
        *(struct Vecx32 *)(state + 0xe) = *(struct Vecx32 *)(*state + 0x180);
        ...
        func_ov107_020c5af8(*state, 0x144, 7, state + 0xe);
        state[0x14] = 0;
        func_0203c634((int)self, *(signed char *)((int)self + 0x20), func_ov216_020cdcf4);
    } else {
        func_ov216_020cce54(state, 1, 0);
    }
}
