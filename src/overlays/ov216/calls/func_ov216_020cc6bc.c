/* func_ov216_020cc6bc: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern void func_ov216_020cc660(void *self);
extern void func_ov216_020cea68(void *node, const VecFx32 *pos);
extern void func_ov107_020c7500(void *self, void *cmd, void *arg3);

void func_ov216_020cc6bc(char *self, u8 *cmd, void *arg3)
{
    int rawZ;
    int rawY;
    int rawX;
    ...
    if (cmd[2] == 5) {
        ...
        case 5:
            break;
        case 6:
            func_ov216_020cc660(self);
            break;
        case 7:
            func_ov216_020cea68(*(void **)(self + 0x3c0), &pos);
            break;
        }
    }
