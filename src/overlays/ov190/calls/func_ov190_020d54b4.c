...
extern void func_ov190_020d5550(void);

void func_ov190_020d54b4(int *self) {
    int v[3];
    int *s = (int *)self[1];
    ...
    func_ov107_020c9ee8(*(int *)(*s + 0x3c0), 2, 0);
    func_0203c634(self, *(signed char *)((char *)self + 0x20), (void *)&func_ov190_020d5550);
}
