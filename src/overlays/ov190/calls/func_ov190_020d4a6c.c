...
extern void func_0203c634(struct Ov190ActionNode *node, int slot, void *next);
extern void func_ov190_020d4b50(void);

void func_ov190_020d4a6c(struct Ov190ActionNode *node)
{
    ...
    func_0203c634(node, node->slot20, func_ov190_020d4b50);
}
