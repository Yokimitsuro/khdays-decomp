...
void func_ov006_02055e9c(int visible) {
    int linked_slot;
    int alternate_slot;
    ...
    if (visible != 0) {
        int primary_slot = data_ov006_02056664->primary_slot;
        MissionRenderer *renderer = &data_ov006_02056664->renderer;
        ...
        linked_slot = data_ov006_02056664->linked_slot;
        if (linked_slot >= 0) {
            renderer->draw_slots[linked_slot].visible = 1;
        }

        alternate_slot = data_ov006_02056664->alternate_slot;
        if (alternate_slot >= 0) {
