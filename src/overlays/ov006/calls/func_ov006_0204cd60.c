...
extern int func_ov006_0204d5c4(int target);
extern void func_ov006_0204ccec(int self, int target);
struct f2c { unsigned char b0 : 1, b1 : 1, b2 : 1; };
int func_ov006_0204cd60(int param_1, int param_2) {
    ...
    if (fp->b1) {
        ...
        if (func_ov006_0204d5c4(param_2) == 0)
            func_ov006_0204ccec(param_1, param_2);
    }
    return r;
}
