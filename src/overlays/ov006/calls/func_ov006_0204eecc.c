...
extern void func_ov006_0204d97c(void);
extern void func_ov006_0204f008(void);
extern void func_ov006_0204ecdc(void);

MissionCallback func_ov006_0204eecc(void) {
    MissionCallback result = 0;

    switch (func_02001030()) {
    case 1:
        data_ov006_020565e4.context->signal = 0;
        func_ov105_020bf1f4(&data_ov006_020565e4.context->mode, 1);
        if (func_ov105_020bf7f4(1,
                &data_ov006_020565e4.context->active_record) == 0) {
            result = func_ov006_0204ece4;
        }
        break;
    ...
    case 4:
        ...
        func_ov105_020bf8c8(func_ov006_0204d97c);
