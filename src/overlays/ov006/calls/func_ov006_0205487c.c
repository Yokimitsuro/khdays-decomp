...
extern void func_ov006_0204d4e4(void *object);
extern void func_ov006_0204d138(void *object);
...
void func_ov006_0205487c(void) {
    u8 i;

    if (data_ov006_02056664->scene_active != 0) {
        func_02032494(&data_ov006_02056664->scene_object);
        func_02032428(&data_ov006_02056664->scene_object);
    }

    if (data_ov006_02056664->renderer_active != 0) {
        func_02032494(&data_ov006_02056664->renderer);
        func_02032428(&data_ov006_02056664->renderer);
    }

    func_ov006_0204d4e4(&data_ov006_02056664->work_object);
    func_ov006_0204d138(&data_ov006_02056664->work_object);
    func_0202f818(&data_ov006_02056664->cleanup_blocks[1].first);
    func_0202f818(&data_ov006_02056664->cleanup_blocks[0].first);
    func_0202f9ec(&data_ov006_02056664->cleanup_blocks[1].second);
    func_0202f9ec(&data_ov006_02056664->cleanup_blocks[0].second);
    func_02024fd4(data_ov006_02056664->primary_resource);

    if (data_ov006_02056664->secondary_resource != 0) {
        func_02024fd4(data_ov006_02056664->secondary_resource);
    }
