...
void func_ov006_0205341c(int state, int p2, int p3, int param4) {
    struct Cell info1;
    struct Cell info2;
    struct Cell *piVar1;
    struct Cell *piVar3;
    int iVar2;
    unsigned int base0 = (unsigned int)*data_ov006_02056664;
    ...
    case 14:
        ...
        if (iVar2) {
            ...
            unsigned int b = (unsigned int)data_ov006_02056664[1] + 0x8000;
