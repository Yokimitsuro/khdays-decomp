...
/* func_ov006_0204dbb4 -- pump the scene transition while the title screen is active.
 * On scene state 1 (loading): once func_ov105_020bf9c0 signals ready, clear the title busy field
