/* func_ov119_020cbfc4 -- refresh sub-node #0's local transform, then publish it.
 * Copies the 4-word constant at data_ov119_020cf93c into a scratch, runs func_0202ef54 in place
...
extern struct blk4 data_ov119_020cf93c;

void func_ov119_020cbfc4(int arg0, Self *self) {
    struct blk4 scratch = data_ov119_020cf93c;
