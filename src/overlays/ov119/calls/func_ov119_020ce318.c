/* Stalk tick of the ov119 enemy (x3 with ov272/ov279). Gives up (sub-state 2) once the +8 target
 ...
 * attack chosen by func_ov119_020ccb10 ends the tick; within 7.0 of the target (gap between the
 * collision radii) the tick hands over to func_ov119_020ce0f0, and beyond the owner's +0x2d8 leash
...
extern void func_ov119_020ce0f0(int *node);

void func_ov119_020ce318(int *node)
{
    int target;
    ...
    if (gap <= 0x7000) {
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov119_020ce0f0);
        return;
    }
