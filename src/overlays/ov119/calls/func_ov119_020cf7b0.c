...
extern void func_ov119_020cf848(void);
extern void func_ov119_020cf804(void);

int func_ov119_020cf7b0(int self, int arg) {
    int *out;

    int rc = func_0203c5c0(*(int *)(self + 0x3c), 100, 0x10, func_ov119_020cf804, func_ov119_020cf848, &out);
    out[0] = self;
    out[3] = arg;
    return rc;
}
