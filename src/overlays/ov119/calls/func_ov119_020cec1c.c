/* Grab approach finish of the ov119 enemy (x3 with ov272/ov279). The owner is set 0.94 behind the
...
extern void func_ov119_020cedc4(int *node);

void func_ov119_020cec1c(int *node)
{
    ...
    func_ov107_020c5af8(*state, 0x121, 5, &pos);
    {
    ...
    state[0x14] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov119_020cedc4);
}
