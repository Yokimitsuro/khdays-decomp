...
int func_ov119_020cc7c4(char *actor, int other, struct ActorHitEvent *hit)
{
    ...
    if ((short)hit->nDamage10 > 0) {
        if ((hit->uFlagsLo & 8) == 0 || (hit->uFlagsLo & 0x80) == 0 || hit->uFlagsHi != 0x80) {
            if ((hit->uFlagsLo & 0x22) != 0) {
                ...
                func_ov107_020c5af8(actor, 0x121, (((struct Parity *)((u8 *)state + 0x71))->b0 & 1) ? 2 : 3, (void *)state[0x13]);
            } else {
                ((struct Parity *)((u8 *)state + 0x71))->b0++;
                func_ov107_020c5af8(actor, 0x121, (((struct Parity *)((u8 *)state + 0x71))->b0 & 1) ? 0 : 1, (void *)state[0x13]);
            }
        }
    }
    return 1;
