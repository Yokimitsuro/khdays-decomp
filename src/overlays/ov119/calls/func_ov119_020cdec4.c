/* Back-off tick of the ov119 enemy (x3 with ov272/ov279). Gives up (sub-state 2) once the +8 target
 ...
 * func_ov119_020ccb10 ends the tick; beyond 5.0 the tick goes back to func_ov119_020ce0f0, and
...
void func_ov119_020cdec4(int *node)
{
    int target;
