/* Bite entry of the ov119 enemy (x3 with ov272/ov279): effect 1 spawns at the +0x4c point,
 * animation 1 plays (looping), bit 0 of the +0x388 part's flag byte clears, bit 1 of the +0x60
 * high byte and bit 0 of +0x1ae are raised, reaction 0x121 mode 4 fires at the point, the +0x50
 * timer restarts and the tick hands over to func_ov119_020ce610. */
...
extern void func_ov119_020ce610(int *node);

void func_ov119_020ce52c(int *node)
{
    ...
    *(unsigned short *)(*state + 0x100 + 0xae) |= 1;
    ...
    state[0x14] = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov119_020ce610);
}
