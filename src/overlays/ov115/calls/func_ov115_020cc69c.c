/* func_ov115_020cc69c: tick handler of the ov115 enemy (x2), variant of the matched ov178 sibling: task slots +0xc (outside 8/9), +0x34 (outside 8) and +0x2c (outside 9) are finished, then the two +0x3a0 attachments (outside 9) and +0x3a8 (outside 8). */
...
void func_ov115_020cc69c(int self)
{
    int i;
    ...
    if (*(signed char *)(self + 0x1c6) != 9 && *(signed char *)(self + 0x1c6) != 8 && *(int *)(*(int *)(self + 0x39c) + 0xc) != 0) {
        func_0203c650(*(int *)(self + 0x3c), *(int *)(*(int *)(self + 0x39c) + 0xc));
        *(int *)(*(int *)(self + 0x39c) + 0xc) = 0;
    }
    if (*(signed char *)(self + 0x1c6) != 8 && *(int *)(*(int *)(self + 0x39c) + 0x34) != 0) {
        func_0203c650(*(int *)(self + 0x3c), *(int *)(*(int *)(self + 0x39c) + 0x34));
        *(int *)(*(int *)(self + 0x39c) + 0x34) = 0;
    }
    if (*(signed char *)(self + 0x1c6) != 9 && *(int *)(*(int *)(self + 0x39c) + 0x2c) != 0) {
        func_0203c650(*(int *)(self + 0x3c), *(int *)(*(int *)(self + 0x39c) + 0x2c));
        *(int *)(*(int *)(self + 0x39c) + 0x2c) = 0;
    }
