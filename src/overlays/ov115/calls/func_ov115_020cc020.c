...
extern void func_ov115_020cc334(void);
extern void WM_EndKeySharing_0x020cc374(void);
extern void func_ov115_020cc398(void);
extern void func_ov115_020ccddc(void);
extern void WM_EndKeySharing_0x020cc380(void);
extern void WM_EndKeySharing_0x020cc38c(void);
extern void func_ov115_020cc69c(void);
extern void func_ov115_020cce38(void);
extern void func_ov115_020cc66c(void);
extern void func_ov115_020cd058(void);
extern void func_ov115_020cbfc4(void);
...
void func_ov115_020cc020(char *self)
{
    ...
    bounds.w[4] = 0x1000;
    bounds.w[5] = 0x1000;
    *(Callback *)(self + 0x8) = func_ov115_020cc334;
    *(Callback *)(self + 0xc) = WM_EndKeySharing_0x020cc374;
    *(Callback *)(self + 0x1c) = func_ov115_020cc398;
    *(Callback *)(self + 0x30) = func_ov115_020ccddc;
    *(Callback *)(self + 0x28) = WM_EndKeySharing_0x020cc380;
    *(Callback *)(self + 0x2c) = WM_EndKeySharing_0x020cc38c;
    *(Callback *)(self + 0x34) = func_ov115_020cc69c;
    *(Callback *)(self + 0x1d0) = func_ov115_020cce38;
    *(Callback *)(self + 0x1dc) = func_ov115_020cc66c;
    *(Callback *)(self + 0x1e0) = func_ov115_020cd058;
    hw = *(u16 *)(self + 0x60);
    ...
    *(Callback *)(*(int *)(self + 0x384) + 0x74) = func_ov115_020cbfc4;
    *(char **)(*(int *)(self + 0x384) + 0x84) = self;
    *(unsigned char *)(*(int *)(self + 0x384) + 0xad) = 0;
    *(int *)(self + 0x38c) = func_0203bee8(*(int *)(self + 0x384), 3, data_ov115_020ceb8c);
    *(int *)(self + 0x390) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov115_020ceb8c);
    *(int *)(self + 0x394) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov115_020ceb94);
