/* func_ov115_020cc398: spawn-message handler of the ov115 enemy (x2), variant of the matched ov178 sibling (subs laid out 3-4-0-1-2-8; sub 0 spawns the +4 child from the scene id and fixes entries 2 and 12 to the +0x390 placement). */
/* Message handler of the ov115 enemy (and its byte-identical twins). A "spawned" message (kind 5) carries
...
extern int func_ov107_020c2b50(int scene, int id);
extern int func_ov115_020cc838(int owner, int parent, int kind);

void func_ov115_020cc398(int owner, unsigned char *command, int arg)
{
    ...
    if (command[2] == 5) {
        ...
        switch (command[3]) {
        case 3:
            (*(int **)(owner + 0x39c))[3] = func_ov107_020c09a0(*(int *)(owner + 0x3c), (*(int **)(owner + 0x39c))[2], 7, (void *)(*(int *)(owner + 0x38c) + 4), 1, 0);
            (*(int **)(owner + 0x39c))[0xb] = func_ov107_020c09a0(*(int *)(owner + 0x3c), (*(int **)(owner + 0x39c))[0xa], 7, (void *)(*(int *)(owner + 0x390) + 4), 0, 0);
            break;
        case 4:
            (*(int **)(owner + 0x39c))[9] = func_ov107_020c0794(*(int *)(owner + 0x3c), (*(int **)(owner + 0x39c))[8], 7, 0, &transform);
            break;
        case 0:
            (*(int **)(owner + 0x39c))[1] = func_ov115_020cc838(owner, (*(int **)(owner + 0x39c))[0], func_ov107_020c2b50(*(int *)(owner + 4), *(unsigned short *)(command + 4)));
            (*(int **)(owner + 0x39c))[3] = func_ov107_020c09a0(*(int *)(owner + 0x3c), (*(int **)(owner + 0x39c))[2], 7, (void *)(*(int *)(owner + 0x390) + 4), 0, 0);
            (*(int **)(owner + 0x39c))[0xd] = func_ov107_020c09a0(*(int *)(owner + 0x3c), (*(int **)(owner + 0x39c))[0xc], 7, (void *)(*(int *)(owner + 0x390) + 4), 0, 0);
            break;
        case 1:
            (*(int **)(owner + 0x39c))[7] = func_ov107_020c0794(*(int *)(owner + 0x3c), (*(int **)(owner + 0x39c))[6], 7, 0, &transform);
            break;
        case 2:
