...
extern void func_ov115_020cc994(void);
extern void func_ov115_020cc8f8(void);
...
int func_ov115_020cc838(int owner, int spawner, int target)
{
    int *entry;
    struct vec at;
    int r = func_0203c5c0(*(int *)(owner + 0x3c), 100, 0x20,
                          &func_ov115_020cc8f8, &func_ov115_020cc994, &entry);
    entry[1] = owner;
    entry[0] = spawner;
    entry[2] = target;
