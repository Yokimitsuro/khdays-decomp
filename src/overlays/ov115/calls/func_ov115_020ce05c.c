/* func_ov115_020ce05c: circle tick of the ov115 enemy (x2), variant of the matched ov175 sibling (pull capped at 0x100, height steps of 0x40, rolls 9 (<0x28) or 8 (<0x3c) when the target check passes, else 5). */
/*
...
extern int func_ov115_020cd084(int self, void *out);
...
extern int func_ov115_020cd11c(int self);
extern int data_02042264;

void func_ov115_020ce05c(int *self) {
    ...
    mag = func_ov115_020cd084((int)self, v1);
    if (mag > 0x100) {
        mag = 0x100;
    }
    ...
    if (counter <= 0) {
        ...
        state[0x17] = 0;
        if (roll < 0x28 && func_ov115_020cd11c((int)self) != 0) {
            *(char *)(*state + 0x1c7) = 9;
        } else if (roll < 0x3c && func_ov115_020cd11c((int)self) != 0) {
            *(char *)(*state + 0x1c7) = 8;
        } else {
            *(char *)(*state + 0x1c7) = 5;
        }
