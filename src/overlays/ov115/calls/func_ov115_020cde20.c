/* Hover-approach tick of the ov115 enemy (and its byte-identical twins): acquires a target (+0xc; none
...
extern int func_ov115_020cd11c(int node);
extern int data_02042264;

void func_ov115_020cde20(int node)
{
