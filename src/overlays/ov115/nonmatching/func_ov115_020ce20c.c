...
extern void func_ov107_020c9264(int obj, int b);
extern void func_ov107_020c0b90(int obj, int cmd, struct vec3 v, int flag);
extern struct vec3 data_02041dc8;
extern void func_ov115_020ce2e4(void);
...
void func_ov115_020ce20c(int param_1) {
    ...
    piVar5[0x12] = 0;
    func_0203c634(param_1, *(signed char *)(param_1 + 0x20), func_ov115_020ce2e4);
}
