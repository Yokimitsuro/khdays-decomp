...
extern void func_ov267_020d56ec(int handle);
extern void func_ov267_020d33e0(int *node);

void func_ov267_020d3254(int *node)
{
    ...
    *(int *)(*state + 0x57c) += (0x1000 - *(int *)(*state + 0x57c)) * 0x140 / 0x1000;
    if (*(int *)(*state + 0x57c) >= 0) {
        ...
        if (state[0x10] >= 0x1000) {
            func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov267_020d33e0);
            return;
        }
    } else {
    ...
    func_ov267_020d56ec(*(int *)(*state + 0x5d4));
