...
extern void func_ov267_020d3a2c(int *node);

void func_ov267_020d39a0(int *node)
{
    int *state = (int *)node[1];

    func_ov107_020c9264(*state, 9, 0);
    func_ov107_020c0b90(*state, 2, data_02041dc8, 0);
    func_ov107_020c5af8(*state, 0x15e, 9, (void *)state[2]);
    state[0x10] = 0;
    *(unsigned char *)((char *)state + 0x5a) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov267_020d3a2c);
}
