/* c634 state-entry handler: wire owner->f78 to the func_ov267_020d54d8 hook,
 ...
 * obj->f4, then dispatch state with the func_ov267_020d560c callback. owner is
 * re-read from *obj each section. self->+0x20 = slot index. */
extern void func_0202accc(int a, int b, int c, int d);
extern void func_0203c634(int self, int index, void *cb);
extern void func_ov267_020d54d8(void);
extern void func_ov267_020d560c(void);
void func_ov267_020d5544(int self) {
    int obj = *(int *)(self + 4);
    int i;
    *(int *)(*(int *)obj + 0x78) = (int)&func_ov267_020d54d8;
    ...
    *(int *)(obj + 4) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov267_020d560c);
}
