/* func_ov267_020d1474 -- hit filter of the +0x214 sub-state while the +0x21a stock is positive.
...
extern void func_ov267_020d11fc(int *state, int a);
extern int func_02023eb4(int bound);

int func_ov267_020d1474(int self, int param, unsigned int *hit) {
    ...
    if (func_ov267_020d124c(state, 1) != 0 && *(signed char *)(*state + 0x100 + 0xc6) != 5) {
        bGrab = 1;
    } else {
        bGrab = 0;
    }
