...
extern void func_ov267_020d11fc(int child, int a, int b);
extern void func_ov107_020c9264(int a, int b, int c);
extern void func_ov107_020c5af8(int a, int b, int c, int d);
extern int func_0203c634(int a, int b, void *handler);
extern void func_ov267_020d37d0(int);
void func_ov267_020d374c(int param_1) {
    int child = *(int *)(param_1 + 4);
    ((struct hw60 *)(*(int *)child + 0x60))->hi |= (unsigned char)0x40;
    *(int *)(child + 0x40) = 0;
    func_ov267_020d11fc(child, 1, 0);
    func_ov107_020c9264(*(int *)child, 0xa, 0);
    func_ov107_020c5af8(*(int *)child, 0x15e, 0xc, *(int *)(child + 8));
    func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov267_020d37d0);
}
