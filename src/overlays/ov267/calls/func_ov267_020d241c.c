...
extern void func_ov267_020d127c(int *state);
...
extern int func_ov267_020d121c(int *state, int a);
extern const Vec3 data_02042264;
extern const Vec3 data_02041dc8;

void func_ov267_020d241c(int *node)
{
    ...
    if (func_ov267_020d121c(state, 1) != 0) {
        state[0x11] = 0;
