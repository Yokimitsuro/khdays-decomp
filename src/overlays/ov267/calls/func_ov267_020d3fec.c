...
extern void func_ov267_020d1734(int *state, int mode, Vec3 *sphere);
extern int func_ov267_020d1700(int *state);
...
void func_ov267_020d3fec(int *node)
{
    ...
    if (state[0x10] >= 0xbb0 && state[0x10] <= 0xff0) {
        ...
        *(Vec3 *)(state + 4) = *(Vec3 *)(state + 0xa);
        ...
        func_ov267_020d1734(state, 2, &sphere.v);
    }
    if (*(unsigned char *)(state[1] + 0xad) != 0) {
        return;
    }
    if (func_ov267_020d1700(state) == 0 && state[0x19] != 0) {
        state[0x19] = 0;
