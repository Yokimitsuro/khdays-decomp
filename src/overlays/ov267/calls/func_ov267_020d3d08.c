...
extern void func_ov267_020d1734(int *state, int mode, Vec3 *v);
...
void func_ov267_020d3d08(int *node)
{
    ...
    if (state[0x10] >= 0x15c8 && state[0x10] <= 0x1ed0) {
        if (*(unsigned char *)((char *)state + 0x5a) == 0) {
            ...
            func_ov107_020c5af8(*state, 0x15e, 8, (void *)state[2]);
        ...
        *(Vec3 *)(state + 4) = *(Vec3 *)(state + 0xa);
        ...
        func_ov267_020d1734(state, 1, &push.v);
    }
