 ...
 * below 0x2e a still-raised sequence latch (+0x2e1c) is released (020b3c04). No slot at all
...
extern void func_ov034_020b3c04(char *self);
...
void func_ov034_020b3844(char *self)
{
    char *rig;
    int *seq;
    int frame;
