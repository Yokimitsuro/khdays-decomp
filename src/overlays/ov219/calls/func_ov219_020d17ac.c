...
void func_ov219_020d17ac(int self) {
    ...
    VEC_Subtract((void *)(*state + 0x190), (void *)state[2], &aim);
    ...
    VEC_Set((struct Vecx32 *)(state + 9), (int)data_0203d210[idx * 2], 0,
            (int)data_0203d210[idx * 2 + 1]);
    func_01ffa724(0x600, (void *)(state + 9), (void *)(state + 9));
    if (dist < 0x2000) {
        *(char *)(*state + 0x1c7) = 2;
