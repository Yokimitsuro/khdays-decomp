...
extern void func_ov255_020d086c(int *node);

void func_ov255_020d07d4(int *node)
{
    ...
    func_ov107_020c9264(*state, 0x1f, 1);
    func_ov107_020c9ee8(*(int *)(*state + 0x3a4), 0x1a, 0);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov255_020d086c);
}
