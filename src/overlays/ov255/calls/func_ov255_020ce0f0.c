...
extern void func_ov255_020ce1c8(int *node);

void func_ov255_020ce0f0(int *node)
{
    ...
    func_ov107_020c9264(*state, 0x9, 0);
    func_ov107_020c9ee8(*(int *)(*state + 0x3a4), 0x8, 0);
    func_ov107_020c5af8(state[0], (short)*(int *)(*state + 0x3f8), 3, (void *)state[1]);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov255_020ce1c8);
}
