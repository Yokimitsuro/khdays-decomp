...
extern void func_ov255_020cfecc(int *node);

void func_ov255_020cfe34(int *node)
{
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3a4), 0x16, 0);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov255_020cfecc);
}
