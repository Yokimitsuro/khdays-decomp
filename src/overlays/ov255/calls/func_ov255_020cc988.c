/*
 * func_ov255_020cc988 -- x3 (ov185/186/187). Ping all 9 sub-nodes, then tick the owner.
...
void func_ov255_020cc988(int self, int arg) {
    int i;

    for (i = 0; i < 9; i++) {
        func_ov107_020c2b38(arg, (*(int **)(self + 0x3f0))[i]);
    }
