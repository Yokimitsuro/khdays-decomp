...
extern int func_ov255_020ce2d0(int);
void func_ov255_020ce258(int param_1) {
    ...
    *(int *)(owner + 0x5c) = child;
    if (child == 0) {
        *(signed char *)(*(int *)owner + 0x1c7) = 2;
        ...
        func_ov107_020c9ee8(*(int *)(*(int *)owner + 0x3a4), 9, 0);
        func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov255_020ce2d0);
    }
}
