/* Glide tick of an ov255 state: the +0x50 timer accumulates the owner's rate and the +0x5c path point is resolved (func_ov255_020ccdac) into the
...
extern void func_ov255_020d0bac(int *node);

void func_ov255_020d0ae8(int *node)
{
    ...
    func_ov107_020c9ee8(*(int *)(*state + 0x3a4), 0x1d, 1);
    ((struct hw60 *)(*state + 0x60))->hi &= ~0x40;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov255_020d0bac);
}
