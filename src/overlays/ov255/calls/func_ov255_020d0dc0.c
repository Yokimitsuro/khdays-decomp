...
extern void func_ov255_020d0ed0(int *node);
extern void func_ov255_020d0ea4(int *node);

void func_ov255_020d0dc0(int *node)
{
    ...
    *(int *)(state[0] + 0x5c) &= ~2;
    ...
    func_0203c634(node, 1, (void *)func_ov255_020d0ed0);
    func_0203c634(node, 2, (void *)func_ov255_020d0ea4);
}
