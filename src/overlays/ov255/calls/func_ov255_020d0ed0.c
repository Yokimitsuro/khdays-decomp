/* Re-arm tick of an ov255 part: once its rig is idle (+0xad), animation channels 0, 2, 4 and 1 are
...
extern void func_ov255_020d0f58(int *node);

void func_ov255_020d0ed0(int *node)
{
    ...
    if (*(unsigned char *)(*state + 0xad) == 0) {
        ...
        state[2] = 0;
        func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov255_020d0f58);
        return;
    }
}
