extern void func_ov255_020ccdac(int node, int arg, void *outVec, int *outScale);
extern void func_01ffa724(int scale, void *src, void *dst);
extern void func_0203c634(int self, int idx, int cb);

void func_ov255_020d06a4(int param_1) {
    int *node = *(int **)(param_1 + 4);
    int scale;
    int aim[3];
    func_ov255_020ccdac((int)node, node[0x17], aim, &scale);
