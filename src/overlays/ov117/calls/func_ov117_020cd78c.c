...
extern void func_ov117_020cda58(void);
extern VecFx32 data_020475ac;
extern VecFx32 data_02042264;
extern VecFx32 data_02041dc8;
extern Pair16 data_ov117_020cdc28[];
...
void func_ov117_020cd78c(OrbitTask *self) {
    ...
    if ((flags & 3) != 0) {
        Pair16 *rp = &rec;
        rp->b = data_ov117_020cdc28[1].b;
        rp->a = data_ov117_020cdc28[1].a;
        cb = ctx->owner->notify;
        if (cb != 0) {
        ...
        func_0203c634(self, self->actionSlot, func_ov117_020cda58);
        return;
    }
    if ((flags & 4) != 0) {
        ctx->owner->state = 2;
