...
extern const struct CameraWork data_ov117_020cdc34;
extern struct RollingCounter data_ov117_020cdc60;

extern void func_ov117_020cc150(struct Obj *self);
extern void func_ov117_020cc16c(struct Obj *self);
extern void func_ov117_020cc1e4(struct Obj *self);
extern void func_ov117_020cc38c(struct Obj *self);
extern void func_ov117_020cc354(struct Obj *self);
extern void func_ov117_020cc258(struct Obj *self);
extern void func_ov117_020cc3d8(struct Obj *self);
extern void func_ov117_020cc568(struct Obj *self);
extern void func_ov117_020cc270(struct Obj *self);
...
void func_ov117_020cbfc4(struct Obj *self)
{
    struct OutgoingFrame frame;
    frame.work = data_ov117_020cdc34;
    struct PoolEntry *slot;
    int result;
    u8 capacity;
    self->fn08 = func_ov117_020cc150;
    self->fn0c = func_ov117_020cc16c;
    self->fn1c = func_ov117_020cc1e4;
    self->fn30 = func_ov117_020cc38c;
    self->fn34 = func_ov117_020cc354;
    self->fn1d4 = func_ov117_020cc258;
    self->fn1d0 = func_ov117_020cc3d8;
    self->fn1e0 = func_ov117_020cc568;
    self->fn1dc = func_ov117_020cc270;
    ...
    *(struct CameraWork *)self->camera64 = frame.work;
    ...
    func_02016b60(self->subitem384->container88->config78, 3,
                  data_ov117_020cdc60.value);

    data_ov117_020cdc60.value = (data_ov117_020cdc60.value + 1) & 0x1f;
