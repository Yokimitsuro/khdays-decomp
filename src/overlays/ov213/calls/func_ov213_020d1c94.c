...
extern void func_ov213_020d1d8c(void);
extern void func_ov213_020d1e40(void);

void func_ov213_020d1c94(int self) {
    int obj = *(int *)(self + 4);
    ...
    if (kind != -1) {
        *(signed char *)(*(int *)obj + 0x1c6) = kind;
        ...
        case 0:
            func_0203c634(self, 1, &func_ov213_020d1d8c);
            break;
        case 2:
            func_0203c634(self, 1, &func_ov213_020d1e40);
            break;
        }
    }
