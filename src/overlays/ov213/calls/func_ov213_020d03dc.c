 ...
 * message built from the data_ov213_020d2e74 template (three components packed as sign + 23-bit
...
extern struct Msg data_ov213_020d2e74;
extern void func_ov107_020c5af8(int a, int b, int c, int d);
extern void func_0203c634(void *obj, int idx, void *value);

void func_ov213_020d03dc(int *node) {
