...
extern void func_ov213_020d1364(int *state);
extern struct v3 data_02042258;
extern void func_ov213_020d10b0(void);
extern void func_ov213_020d0f14(void);

void func_ov213_020d0d8c(int *self) {
            ...
            *(struct v3 *)(state + 0x19) = *(struct v3 *)(state + 3);
            ...
            if (state[0x20] == 5) {
                *(int *)(*state + 0x394) |= 4;
                ...
                func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov213_020d10b0);
                return;
            }
            *((unsigned char *)state + 0x84) = 0;
            func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov213_020d0f14);
            return;
        }
    }
    func_ov213_020d1364(state);
}
