 ...
 * is broadcast as a 14-byte message built from the data_ov213_020d2eba template (byte 4 = 1;
...
extern struct Msg data_ov213_020d2eba;
...
extern void func_ov213_020cecfc(void);

void func_ov213_020ceb7c(int *node) {
    ...
    if (((struct Flags394 *)(*(int *)(*state + 0x3dc) + 0x394))->b2 != 0) {
        ...
        state[7] = 0;
        func_0203c634(node, *(signed char *)(node + 8), func_ov213_020cecfc);
        return;
    }
