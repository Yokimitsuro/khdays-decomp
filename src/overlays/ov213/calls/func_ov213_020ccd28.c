 ...
 * come from the data_ov213_020d2d94 / data_ov213_020d2e00 tables (27 entries each, copied to
...
extern void func_ov213_020ccf48(int item, void *res, int arg, int block);
extern void func_0203b9fc(int item, int channel, int a, int b);
extern const struct Tbl27 data_ov213_020d2d94;
extern const struct Tbl27 data_ov213_020d2e00;

void func_ov213_020ccd28(int obj, int slot, int arg) {
    struct Tbl27 kindsA = data_ov213_020d2d94;
    struct Tbl27 kindsB = data_ov213_020d2e00;

    func_ov213_020ccf48(*(int *)(obj + 0x384), func_ov107_020c9440(obj, kindsA.w[slot]), arg, obj + 0x38c);
    func_ov213_020ccf48(*(int *)(obj + 0x388), func_ov107_020c9440(obj, kindsB.w[slot]), arg, obj + 0x3b0);
    if (slot == 0xb) {
