/* Scatter entry: builds the 0x44-byte spread message from the data_ov213_020d2ee4 template
...
extern void func_ov213_020cf5fc(void);

void func_ov213_020cf4ec(int *self) {
    int *state = (int *)self[1];
    struct SpreadMsg msg = data_ov213_020d2ee4;
    int i;
    ...
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov213_020cf5fc);
}
