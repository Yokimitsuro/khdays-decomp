...
extern void func_ov213_020cd35c(void);
extern void func_ov213_020cd5e4(void);
extern void func_ov213_020cd654(void);
void func_ov213_020cd2ac(int self) {
    int *obj = *(int **)(self + 4);
    *(char *)(*obj + 0x1c6) = 0;
    *(char *)(*obj + 0x1c7) = -1;
    ...
    *((unsigned char *)obj + 0x74) = *(unsigned short *)(*obj + 0x100 + 0xb0);
    ...
    func_0203c634(self, 0, &func_ov213_020cd35c);
    func_0203c634(self, 2, &func_ov213_020cd5e4);
}
