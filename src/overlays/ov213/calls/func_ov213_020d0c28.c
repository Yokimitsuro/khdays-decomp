...
void func_ov213_020d0c28(int *self) {
    ...
    *(struct m4 *)(state + 0xc) = *(struct m4 *)(state + 8);
    ...
    state[0x1f] = 0;
    state[0x20] = 0;
    func_ov107_020c5af8(*(int *)(*state + 0x384), 0x122, 6, (void *)state[1]);
    *((unsigned char *)state + 0x84) = 0;
    func_0203c634((int)self, *(signed char *)((int)self + 0x20), (int)&func_ov213_020d0d8c);
}
