...
extern void func_ov213_020d0d8c(void);

void func_ov213_020d0f14(int *node) {
    ...
    *(struct m4 *)(state + 0x10) = *(struct m4 *)(state + 8);
    if (t >= 0x1000) {
        state[6] = 0;
        state[0x1f] = 0;
        func_ov107_020c5af8(*(int *)(state[0] + 0x384), 0x122, 6, (void *)state[1]);
        func_0203c634(node, *(signed char *)(node + 8), func_ov213_020d0d8c);
        return;
    }
