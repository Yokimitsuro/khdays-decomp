 ...
 * data_ov213_020d2f74 carries its +0x74 point to the actor's +0x24 hook, its bit is set and the
...
extern const Cmd14 data_ov213_020d2f74;

void func_ov213_020d2a14(int *node)
{
