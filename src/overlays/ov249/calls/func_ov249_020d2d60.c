/* c634 handler: run the guard func_ov249_020d10b4; if it fails (<0), dispatch null. Else,
...
extern void func_ov249_020d2e10(void);
void func_ov249_020d2d60(int self) {
    int *obj = *(int **)(self + 4);
    ...
    *(char *)((char *)obj + 0x61) = 0;
    obj[2] = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov249_020d2e10);
}
