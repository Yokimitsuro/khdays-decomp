...
extern int func_ov249_020d10b4(int);
extern int func_0203c634(int, int, void *);
extern int func_ov107_020c9264(int, int, int);
extern int func_ov249_020d2ea8(int);
void func_ov249_020d2e10(int param_1) {
    int owner = *(int *)(param_1 + 4);
    if (func_ov249_020d10b4(param_1) < 0) {
        ...
        func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov249_020d2ea8);
    }
}
