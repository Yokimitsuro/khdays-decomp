/* Grab release of the ov249 enemy: with a +8 held actor and the +0x1c4 flags clear of bit 1,
 ...
 * origin, reaction 0x145 mode 4 fires at the position, the +0x4c timer and +0x61 flag reset and
...
extern void func_ov249_020d10a0(int actor, int anim);
...
extern void func_ov249_020d212c(int *node);
extern struct Vecx32 data_02041dc8;

void func_ov249_020d2050(int *node)
{
    ...
    func_ov249_020d10a0(*state, 9);
    func_ov107_020c0b90(*state, 2, data_02041dc8, 0);
    func_ov107_020c5af8(*state, 0x145, 4, (void *)state[3]);
    state[0x13] = 0;
    *(unsigned char *)((char *)state + 0x61) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov249_020d212c);
}
