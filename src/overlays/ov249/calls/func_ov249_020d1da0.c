/* func_ov249_020d1da0 -- the wait loop of the approach: hold the stance for a few ticks, then
 * commit. This is the other half of func_ov249_020d1c1c, which enters here; from here the object
 * either loops back into 020cfeac or moves on to func_ov249_020d1f58.
 *
 * func_ov249_020d10b4 returns the current range (negative aborts). Inside 0x1000 there is a 45%
...
extern void func_ov249_020d1c1c(void);
extern void func_ov249_020d1f58(void);
...
void func_ov249_020d1da0(int self) {
    int *ctx;
    MtxFx33 mtx;
    int range;
    int idx;
    ...
    ctx = *(int **)(self + 4);
    range = func_ov249_020d10b4(self);
    if (range < 0) {
    ...
    if (*(unsigned char *)(ctx[1] + 0xad) == 0) {
        ...
        if (--ctx[0x14] > 0) {
            func_0203c634(self, *(signed char *)(self + 0x20), func_ov249_020d1c1c);
            return;
        }
        ...
        func_0203c634(self, *(signed char *)(self + 0x20), func_ov249_020d1f58);
        return;
    }
