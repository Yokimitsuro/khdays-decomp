/* func_ov249_020d212c -- the steering tick that leads into func_ov249_020d2210. Structurally the
...
extern void func_ov249_020d2210(void);
extern short data_0203d210[];

void func_ov249_020d212c(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
    ...
    func_ov249_020d10a0(ctx[0], 0xa);
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov249_020d2210);
}
