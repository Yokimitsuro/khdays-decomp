/* func_ov249_020d2fbc -- the wind-up: hold, then emit along the heading during a timing window.
 *
 ...
 * hands the anchor to func_ov249_020d0c28.
 *
...
extern void func_ov249_020d0c28(int *ctx, int kind, void *a, void *b);
...
void func_ov249_020d2fbc(int self) {
    int *ctx;
    ...
    if (ctx[0x13] >= 0x990 && ctx[0x13] <= 0xf68) {
        ...
        func_ov249_020d0c28(ctx, 1, &anchor, 0);
    }
