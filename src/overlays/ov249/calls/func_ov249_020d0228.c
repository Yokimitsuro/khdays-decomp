/* Effect message hook of the ov249 enemy. A "spawned" message (kind 5) carries
...
void func_ov249_020d0228(char *self, u8 *cmd, void *arg3)
{
    int rawZ;
    int rawY;
    int rawX;
    ...
    if (cmd[2] == 5) {
        ...
        case 5:
            *(void **)(self + (cmd[3] << 3) + 0x4ac) =
            ...
            break;
        case 0xb:
            *(void **)(self + 0x4a4) = func_ov107_020cb040(self, 0x145, 9, 0, self + 0xa0);
            break;
        }
    }
