/* func_ov249_020d3c0c -- face the target and close in, unless it is already too near.
 *
 ...
 * func_ov249_020d10a0). Otherwise the tail is the same Y-rotation steering as
...
void func_ov249_020d3c0c(int self) {
    int *ctx;
