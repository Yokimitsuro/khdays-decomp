/* func_ov249_020d1f58 -- steer toward the target: rotate the owner's offset vector by the stored
 ...
 *   - func_ov249_020d10b4 returning negative (nothing to steer toward);
...
void func_ov249_020d1f58(int self) {
    int *ctx;
    MtxFx33 mtx;
    int idx;
