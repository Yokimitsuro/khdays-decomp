...
extern int func_ov249_020d10b4(int *node);
...
void func_ov249_020d270c(int *node)
{
    ...
    if (state[0x13] <= 0xbb0 && func_ov249_020d10b4(node) < 0) {
    ...
    if (state[0x13] >= 0xbb0 && state[0x13] <= 0x1188) {
        ...
        func_ov249_020d0c28(state, 0, &sphere, 0);
        ...
        func_ov249_020d0c28(state, 5, &sphere, 0);
    }
    if ((*(u8 *)((char *)state + 0x61) & 1) == 0 && state[0x13] >= 0xbb0) {
        func_ov107_020c5af8(*state, 0x145, 7, (void *)state[3]);
        *(u8 *)((char *)state + 0x61) |= 1;
    }
    if ((*(u8 *)((char *)state + 0x61) & 2) == 0 && state[0x13] >= 0x1430) {
        func_ov107_020c5af8(*state, 0x145, 8, (void *)state[3]);
