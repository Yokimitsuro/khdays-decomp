...
int func_ov249_020d0730(char *actor, int other, struct ActorHitEvent *hit)
{
    ...
    case 4:
        if ((hit->uFlagsLo & 0x20) != 0 && !guarded && frontal) {
            func_ov107_020c5af8(actor, 0x145, 5, (void *)state[3]);
            hit->uResultLo |= 1;
            *(u8 *)(*state + 0x1c7) = 5;
            return 1;
        }
    ...
    if ((hit->uFlagsLo & 0x8000) != 0) {
        if ((hit->uFlagsLo & 8) == 0 || (hit->uFlagsLo & 0x80) == 0 || hit->uFlagsHi != 0x80) {
            if ((hit->uFlagsLo & 0x22) != 0) {
                ...
                func_ov107_020c5af8(actor, 0x145, pair22.a[*(u8 *)((char *)state + 0x63)], (void *)state[3]);
            } else {
                pair = data_ov249_020d4970.pair;
                func_ov107_020c5af8(actor, 0x145, pair.a[*(u8 *)((char *)state + 0x63)], (void *)state[3]);
            }
