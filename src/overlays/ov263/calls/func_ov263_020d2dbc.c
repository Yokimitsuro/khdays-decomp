/* Construction of the ov263 enemy's item (x3 with ov265/ov280): installs the handlers (+8
...
extern void func_ov263_020d2ef0(void);
extern void func_ov263_020d2f44(void);
extern void func_ov263_020d2f0c(void);

void func_ov263_020d2dbc(char *self)
{
    int owner = *(int *)(self + 0x388);
    int w = FX_Inv(0x189e, 0x1119);
    u16 v;

    *(void **)(self + 8) = (void *)func_ov263_020d2ef0;
    *(void **)(self + 0x30) = (void *)func_ov263_020d2f44;
    *(void **)(self + 0x1d0) = (void *)func_ov263_020d2f0c;
    v = *(u16 *)(self + 0x60);
