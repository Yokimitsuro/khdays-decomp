/* func_ov263_020d1708 -- decide which way to sidestep, then hand off to func_ov263_020d18f0.
 *
 ...
 *
 *   0 -> probe both sides. Take the canned offset data_ov263_020d36a4, run it through
 *        func_ov263_020d06bc and ask func_ov263_020d0750 whether that way is blocked; then repeat
...
extern int func_ov263_020d0750(int self, const VecFx32 *v, int a);
...
extern void func_ov263_020d18f0(void);
extern VecFx32 data_ov263_020d36a4;
...
void func_ov263_020d1708(int self) {
    int *ctx;
    ...
    *(unsigned char *)((char *)ctx + 0x4a) = func_02023eb4(2);
    ...
    if (*(unsigned char *)((char *)ctx + 0x4a) == 0) {
        ...
        v = data_ov263_020d36a4;
        func_ov263_020d06bc(&v, self, &v);
        if (func_ov263_020d0750(self, &v, 0) != 0) {
    ...
    func_ov263_020d0cf4(self, 2, 2, 0, func_ov263_020d18f0);
}
