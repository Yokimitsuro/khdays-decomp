...
extern int func_ov263_020d0cf4(int a, int b, int c, int d, void *e);
extern void func_ov263_020d14ec(int);
void func_ov263_020d146c(int param_1) {
    int child = *(int *)(param_1 + 4);
    int t = *(int *)(child + 0x28) + *(int *)(*(int *)param_1 + 0x2c);
    *(int *)(child + 0x28) = t;
    if (t < 0x6ee) return;
    ((struct hw60 *)(*(int *)child + 0x60))->hi &= ~0x82;
    func_ov263_020d0cf4(param_1, 0, 0, 0, (void *)&func_ov263_020d14ec);
}
