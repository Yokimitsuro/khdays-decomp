/* func_ov263_020d1170 -- chase tick of the ov263 enemy. The +0x18
 ...
 * func_ov263_020d0628) sub-state 2 is requested and the tick ends. The +0x24 delay runs down in
 * sub-states 2/4. In those sub-states a 7.0 floor probe (func_ov263_020d0750) is cast; with a
...
extern int func_ov263_020d0750(int *node, Vec3 *dir, int direct);
extern void VEC_Add(const Vec3 *a, const Vec3 *b, Vec3 *out);
extern void VEC_Subtract(const Vec3 *a, const Vec3 *b, Vec3 *out);
extern int func_01ff8d18(Vec3 *v, Vec3 *out);
extern void func_01ffa724(int scale, const Vec3 *v, Vec3 *out);
extern const Vec3 data_02042264;
extern const Vec3 data_ov263_020d3698;

void func_ov263_020d1170(int *node)
{
    ...
    if (*(signed char *)(*state + 0x100 + 0xc6) == 2 || *(signed char *)(*state + 0x100 + 0xc6) == 4) {
        ...
        probe.y = func_ov263_020d0750(node, &probe, 1);
        if (state[5] != 0) {
