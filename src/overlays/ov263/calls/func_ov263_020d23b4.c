/* Lunge tick of the ov263 enemy (variant of ov231/ov232's). The +0x30
 ...
 * point. Between 0x1298 and 0x2b90 the target is re-acquired (func_ov263_020d0628) and a probe
 * segment from the +0xc point lifted 3.08 along data_02042240 (length 2.0, radius 2.88) hits kind 2
 * candidates towards the heading lifted 2.0 (func_ov263_020d0890); on a hit reaction 0/0x51 fires at
...
extern void func_ov263_020d06bc(void *out, int *self, Vec3 *vec);
extern void func_01ffa724(int scale, const Vec3 *v, Vec3 *out);
extern void func_ov107_020c5af8(int owner, int id, int mode, void *at);
extern void func_ov263_020d0628(int *node);
extern int func_ov263_020d0890(int *self, int kind, void *query, void *pt, int flags);
...
void func_ov263_020d23b4(int *node)
{
    ...
    func_ov263_020d06bc(&v, node, (Vec3 *)(*(int *)(*state + 0x388) + 0x2c));
    *(Vec3 *)(state + 0xc) = v;
    ...
    if (state[0xa] >= 0x1298 && state[0xa] < 0x2b90) {
        ...
        seg.nLength = 0x2000;
        seg.nRadius = 0x2e28;
        if (func_ov263_020d0890(node, 0, &seg, &dir, 2) != 0) {
