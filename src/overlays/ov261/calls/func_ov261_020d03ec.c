...
extern int func_ov261_020d04f0(int *state, int slot, u16 *order, unsigned int id, u8 depth, u16 *out, int *limit);
...
int func_ov261_020d03ec(int *state, unsigned int id)
{
    u16 order[16];
    struct Vecx32 d;
    int limit;
    ...
    return func_ov261_020d04f0(state, *(u8 *)(state + 0x12), order, id, 0, (u16 *)((char *)state + 0x49), &limit);
}
