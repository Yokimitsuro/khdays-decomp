...
extern void func_ov261_020d0348(Vec3 *anchor, Vec3 *pos, Vec3 *target);
...
extern void func_ov261_020d0cd8(int *node);
...
void func_ov261_020d0c0c(int *node)
{
    ...
    func_ov261_020d0348(&state->anchor, pos, state->pos);
    ...
    if (VEC_DotProduct(&fwd, &dir) > 0xf00) {
        ...
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov261_020d0cd8);
    }
}
