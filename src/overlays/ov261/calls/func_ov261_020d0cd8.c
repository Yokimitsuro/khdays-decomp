...
extern void func_ov261_020d0348(void *anchor, void *pos, int *target);
extern int func_02023eb4(int bound);
extern void func_0203c634(int *node, int slot, void *cb);

void func_ov261_020d0cd8(int *node)
{
    int *state = (int *)node[1];

    state[0xf] = *(int *)(*node + 0x2c) * 30 / 2;
    func_ov261_020d0348(state + 7, (void *)(*(int *)(*state + 0x3a8) + 0x74), (int *)state[1]);
