...
extern void func_ov261_020d0a08(int node);
extern void func_ov261_020d0818(int node);
extern void func_ov261_020d0920(int node);

void func_ov261_020d0700(int node)
{
    ...
    *(u8 *)(state + 0x12) = 0;
    func_0203c634(node, 1, func_ov261_020d0a08);
    func_0203c634(node, 0, func_ov261_020d0818);
    func_0203c634(node, 2, func_ov261_020d0920);
}
