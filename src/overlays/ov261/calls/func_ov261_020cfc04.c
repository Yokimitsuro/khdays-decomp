/* Constructor of the ov261 enemy (and its byte-identical twin ov262): raises bit 8 of the +0 flag
...
extern void func_ov261_020cfeac(void);
extern void func_ov261_020cff40(void);
extern void func_ov261_020d00c0(void);
extern void func_ov261_020d02fc(void);
extern void func_ov261_020cffc0(void);
extern void func_ov261_020d0020(void);
extern void func_ov261_020d020c(void);
extern void func_ov261_020cff90(void);
...
extern const char data_ov261_020d158c[];
extern const char data_ov261_020d159c[];

void func_ov261_020cfc04(char *self)
{
    volatile int *p;
    ...
    *(Callback *)(self + 0x8) = func_ov261_020cfeac;
    *(Callback *)(self + 0x8) = func_ov261_020cfeac;
    *(Callback *)(self + 0x8) = func_ov261_020cfeac;
    *(Callback *)(self + 0x8) = func_ov261_020cfeac;
    *(Callback *)(self + 0x8) = func_ov261_020cfeac;
    *(Callback *)(self + 0xc) = func_ov261_020cff40;
    *(Callback *)(self + 0x34) = func_ov261_020d00c0;
    *(Callback *)(self + 0x30) = func_ov261_020d02fc;
    *(Callback *)(self + 0x10) = func_ov261_020cffc0;
    *(Callback *)(self + 0x14) = func_ov261_020d0020;
    *(Callback *)(self + 0x38) = func_ov261_020d020c;
    *(Callback *)(self + 0x1dc) = func_ov261_020cff90;
    *(int *)(self + 0x40) &= ~4;
    ...
    *(int *)(self + 0x390) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov261_020d158c);
    *(int *)(self + 0x394) = func_0203bee8(*(int *)(self + 0x384), 1, data_ov261_020d159c);
