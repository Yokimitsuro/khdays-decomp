...
extern int func_ov261_020d03ec(int *state, int slot);
extern void func_0203c634(int *node, int slot, void *cb);
extern void func_ov107_020c9264(int actor, int anim, int flag);
extern void func_ov261_020d0f90(int *node);
extern void func_ov261_020d0e4c(int *node);

void func_ov261_020d0d80(int *node)
{
    ...
    state[0x1c] = func_ov261_020d03ec(state, *(u8 *)(*state + 0x3ac));
    if (state[0x1c] == 0) {
        *(u8 *)(*state + 0x1c7) = 2;
    ...
    if (*(int *)(*(int *)(actor + 0x3a8) + 4) == *(int *)(actor + 4)) {
        ...
        state[0x1b] = 0;
        func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov261_020d0f90);
        return;
    }
    ...
    *hw = h & ~0xff00 | (((((unsigned int)h << 0x10) >> 0x18 | 0x82) << 0x18) >> 0x10);
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov261_020d0e4c);
}
