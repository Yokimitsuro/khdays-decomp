 ...
 * into state+8), send the anchor point -- the vector at state[1] with y raised by 0xa00 --
...
void func_ov261_020d0a48(int *node) {
    ...
    state[0xb] = 0;
    *(Ov261Quad *)(state + 3) = data_020420f8;
    *(Ov261Quad *)(state + 7) = *(Ov261Quad *)(state + 3);
