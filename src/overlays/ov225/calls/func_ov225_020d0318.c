/* func_ov225_020d0318 -- effect command hook (byte-identical in ov221 /
 * ov222 / ov223 / ov225).  A type-5 command carries three big-endian
 ...
 * handle): slot 0 spawns kind 0x15 and slots 5 / 6 kind 5 at the transform (020c0794),
...
void func_ov225_020d0318(EffectActor *pActor, u8 *pCommand, int nArg)
{
