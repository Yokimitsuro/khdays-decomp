...
extern const char data_ov225_020d50e0[];
extern void func_ov225_020cfdbc(int);
int func_ov225_020cfb78(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x464);
    *(signed char *)(obj + 0x19c) = 0x36;
    OS_SPrintf(buf, data_ov225_020d50e0, 54);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov225_020cfdbc;
