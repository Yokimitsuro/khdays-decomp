/*
 * func_ov225_020d4e8c -- x4 (ov221/222/224/225). AI-state tick: drive a spin/lunge along a matrix.
...
extern void func_ov225_020d4c3c(int self, int a, int b);
extern int  data_02042258;

void func_ov225_020d4e8c(int *self) {
    ...
    func_ov225_020d4c3c((int)self, 1, 1);
}
