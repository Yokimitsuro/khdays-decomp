...
extern void func_ov225_020d4504(void);
extern void func_ov225_020d4538(void);
extern void func_ov225_020d459c(void);
extern void func_ov225_020d4728(void);
extern const struct Ov221Saved data_ov225_020d50c8;
extern struct RollingCounter data_ov225_020d5134;

void func_ov225_020d430c(char *self) {
    int owner;
    unsigned short v;
    struct Ov221Saved saved;

    owner = *(int *)(self + 0x390);
    *(void **)(self + 8) = (void *)func_ov225_020d4504;
    *(void **)(self + 0xc) = (void *)func_ov225_020d4538;
    *(void **)(self + 0x1c) = (void *)func_ov225_020d459c;
    *(void **)(self + 0x30) = (void *)func_ov225_020d4728;
