 ...
 * the tracking step (func_ov225_020d127c) ends the state when negative, otherwise the +0x3fc
...
extern int func_ov225_020d127c(int *node, int arg);
...
void func_ov225_020d3658(int *node)
{
