...
extern char data_ov056_020b75d0[];
extern char data_ov056_020b75e0[];

u8 func_ov056_020b5f68(char *self)
{
    ...
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov056_020b75d0, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov056_020b75e0, *(u8 *)(self + 9), 1, rig + 4);
