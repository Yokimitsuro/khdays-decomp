/* Send the ov246 enemy's position message: the overlay's 14-byte template (data_ov247_020d4f18)
...
extern const PosMsg data_ov247_020d4f18;
...
void func_ov247_020d43a4(int *state)
{
    PosMsg msg;
    FxVec vContact;
    FxVec *pPos;

    msg = data_ov247_020d4f18;
    pPos = (FxVec *)state[1];
    vContact.x = pPos->x;
