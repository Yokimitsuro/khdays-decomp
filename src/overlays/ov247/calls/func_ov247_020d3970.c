 ...
 * finalised), allocates the +0x390 block whose effect comes from the data_ov247_020d4f14 pose
...
extern const struct Ov246Pose data_ov247_020d4f14;
extern void func_ov247_020d3b10(void);
extern void func_ov247_020d3b40(void);
extern void func_ov247_020d3b78(void);
extern void func_ov247_020d3c4c(void);
extern void func_ov247_020d3bf0(void);

void func_ov247_020d3970(char *self)
{
    struct Ov246Pose pose = data_ov247_020d4f14;

    *(void **)(self + 0x8) = func_ov247_020d3b10;
    *(void **)(self + 0xc) = func_ov247_020d3b40;
    *(void **)(self + 0x1c) = func_ov247_020d3b78;
    *(void **)(self + 0x30) = func_ov247_020d3c4c;
    *(void **)(self + 0x1d0) = func_ov247_020d3bf0;
    {
