 ...
 * (kind 0x15, c0794) there; 4 builds pair 4 through func_ov247_020d44ac from pairs 6 and 5.
...
extern int func_ov247_020d44ac(char *self, int item, int a, int b);
extern void func_ov107_020c7500(char *self, u8 *cmd, void *arg3);

void func_ov247_020d1df4(char *self, u8 *cmd, void *arg3)
{
    if (cmd[2] == 5) {
        switch (cmd[3]) {
        case 0:
        case 1:
            (*(struct Ov246Pair **)(self + 0x390))[0].pChild =
                func_ov107_020c09a0(*(int *)(self + 0x3c), (*(struct Ov246Pair **)(self + 0x390))[0].pItem,
                                    0x15, *(char **)(self + 0x398) + 4, 0, 0);
            (*(struct Ov246Pair **)(self + 0x390))[7].pChild =
                func_ov107_020c09a0(*(int *)(self + 0x3c), (*(struct Ov246Pair **)(self + 0x390))[7].pItem,
                                    5, *(char **)(self + 0x398) + 4, 0, 0);
            if (cmd[3] == 0) {
                *(int *)(self + 0x3a8) = func_ov107_020cb040(self, 0x158, 5, 0, *(char **)(self + 0x398) + 4);
            } else if (cmd[3] == 1) {
                *(int *)(self + 0x3a4) = func_ov107_020cb040(self, 0x158, 4, 0, *(char **)(self + 0x398) + 4);
            }
            break;
        case 2:
            (*(struct Ov246Pair **)(self + 0x390))[2].pChild =
                func_ov107_020c09a0(*(int *)(self + 0x3c), (*(struct Ov246Pair **)(self + 0x390))[2].pItem,
                                    0x15, *(char **)(self + 0x394) + 4, 0, 0);
            break;
        case 3:
            (*(struct Ov246Pair **)(self + 0x390))[3].pChild =
                func_ov107_020c0794(*(int *)(self + 0x3c), (*(struct Ov246Pair **)(self + 0x390))[3].pItem,
                                    0x15, 0, *(char **)(self + 0x394) + 4);
            break;
        case 4:
            (*(struct Ov246Pair **)(self + 0x390))[4].pChild =
                func_ov247_020d44ac(self, (*(struct Ov246Pair **)(self + 0x390))[4].pItem,
