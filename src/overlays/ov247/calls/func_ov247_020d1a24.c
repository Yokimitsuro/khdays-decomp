 ...
 * entry 0 (subscribed), resolves its two mode-3 joints (+0x398 data_ov247_020d4f4c, +0x394
 * data_ov247_020d4f54), keeps the data_ov247_020d4f58 motion handle of pool entry 1 (+0x39c),
 * the eight sub-items of the data_ov247_020d4ee0 kinds in a fresh 64-byte slot table (+0x390,
 ...
 * func_ov247_020d393c and sound 0x158 is loaded. */
struct Ov246Vec3 {
    int x;
    int y;
    int z;
...
extern void func_ov247_020d1ca4(void);
extern void func_ov247_020d1cec(void);
extern void func_ov247_020d1df4(void);
extern void func_ov247_020d2180(void);
extern void func_ov247_020d1f94(void);
extern void func_ov247_020d1fbc(void);
extern void func_ov247_020d1fe4(void);
extern void func_ov247_020d21dc(void);
extern void func_ov247_020d23f0(void);
extern void func_ov247_020d1d38(void);
extern void *func_ov247_020d393c(int *self);
...
void func_ov247_020d1a24(int param)
{
    struct Ov246Kinds kinds;
    struct Ov246Capsule req;
    int i;

    kinds = data_ov247_020d4ee0;

    *(void **)(param + 0x08) = func_ov247_020d1ca4;
    *(void **)(param + 0x0c) = func_ov247_020d1cec;
    *(void **)(param + 0x1c) = func_ov247_020d1df4;
    *(void **)(param + 0x30) = func_ov247_020d2180;
    *(void **)(param + 0x28) = func_ov247_020d1f94;
    *(void **)(param + 0x2c) = func_ov247_020d1fbc;
    *(void **)(param + 0x34) = func_ov247_020d1fe4;
    *(void **)(param + 0x1d0) = func_ov247_020d21dc;
    *(void **)(param + 0x1e0) = func_ov247_020d23f0;
    *(void **)(param + 0x1dc) = func_ov247_020d1d38;
    ...
    *(int *)(param + 0x6c) = 0;

    {
        ...
        ((void **)self)[0xe6] = func_0203bee8(self[0xe2], 3, data_ov247_020d4f4c);
        ((void **)self)[0xe5] = func_0203bee8(self[0xe2], 3, data_ov247_020d4f54);
        ((void **)self)[0xe7] = func_ov107_020c9e50(func_ov107_020c9440(self, 1), data_ov247_020d4f58);
        ...
        *((int **)self)[0xe1] = func_ov107_020c319c(self + 0x19);
        ...
        ((void **)self)[0xe8] = func_ov247_020d393c(self);
        func_0203355c(0x158);
    }
}
