/* func_ov247_020d34d0 -- set the follow-up delay, and if the counter allows, commit the move.
 ...
 * Otherwise a 2-field descriptor is built from data_ov247_020d4f00 and passed to the owner's own
 ...
 * the action dispatched with func_ov247_020d35ac.
 *
...
extern void func_ov247_020d35ac(void);
extern unsigned short data_ov247_020d4f00[];

void func_ov247_020d34d0(int self) {
    int *ctx;
    Ov137_Desc d;
    Ov137_Desc *p;
    ...
    p = &d;
    d.b = data_ov247_020d4f00[1];
    d.a = data_ov247_020d4f00[0];
    ...
    *(unsigned char *)((char *)ctx + 0x54) = 0;
    ...
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov247_020d35ac);
}
