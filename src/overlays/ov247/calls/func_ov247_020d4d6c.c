/* Ground drop tick of the ov246 enemy. In owner mode 1 the +0x28 radius grows by the owner's
 * rate and, up to 0xe00, the entities inside 2.3 times that radius around the +0x10 anchor are
...
void func_ov247_020d4d6c(int *node)
{
