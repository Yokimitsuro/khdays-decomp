 ...
 * the drop tick func_ov247_020d4d6c runs once before it takes the slot. */
...
extern void func_ov247_020d4d6c(int *node);
extern Vec3 data_ov247_020d4f28;

void func_ov247_020d4c70(int *node)
{
    ...
    *(unsigned char *)((char *)state + 0x30) = 0;
    func_ov247_020d4d6c(node);
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov247_020d4d6c);
}
