...
extern void func_ov247_020d481c(void);
extern void func_ov247_020d4778(void);
int func_ov247_020d44ac(int param_1, int param_2, int param_3, int param_4) {
    int *entry;
    int r = func_0203c5c0(*(int *)(param_1 + 0x3c), 100, 0x34,
                          &func_ov247_020d4778, &func_ov247_020d481c, &entry);
    entry[0] = param_1;
    entry[1] = param_2;
    entry[2] = param_3;
    entry[3] = param_4;
