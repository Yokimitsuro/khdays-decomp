...
extern const char data_ov247_020d4f40[];
extern void func_ov247_020d1a24(int);
int func_ov247_020d1998(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x3ac);
    *(signed char *)(obj + 0x19c) = 72;
    OS_SPrintf(buf, data_ov247_020d4f40, 72);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov247_020d1a24;
