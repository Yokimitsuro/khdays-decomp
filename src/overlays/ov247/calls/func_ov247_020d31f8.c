...
extern void func_ov247_020d32c4(void);
extern unsigned short data_ov247_020d4f00[];
void func_ov247_020d31f8(int self) {
    int obj = *(int *)(self + 4);
    ...
    *(int *)(obj + 0x14) = *(int *)(*(int *)self + 0x2c) * 30 / 5;
    ...
    }
    {
        ...
        p[1] = data_ov247_020d4f00[7];
        p[0] = data_ov247_020d4f00[6];
    ...
    *(unsigned char *)(obj + 0x54) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), &func_ov247_020d32c4);
}
