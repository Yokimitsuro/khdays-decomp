 ...
 * and handing the collected list to func_ov141_020ce76c. */
...
extern int func_ov107_020cb040(struct Ov141Self *self, int id, int kind, int enabled,
                               void *transform);
...
extern void func_ov107_020c5af8(struct Ov141Self *self, int id, int kind,
                                struct Ov141Vec3 *at);
extern int func_ov141_020ce76c(struct Ov141Self *self, short *ids);
extern void func_ov107_020c7500(struct Ov141Self *self, struct Ov141Cmd *cmd, int arg2);

void func_ov141_020cc2f8(struct Ov141Self *self, struct Ov141Cmd *cmd, int arg2)
{
    struct Ov141Other *other;
    void **it;
    int count;
    int n;
    int cap;
    ...
    if (cmd->type02 == 5) {
        ...
        case 0: {
            ...
            other = (it == 0) ? 0 : (struct Ov141Other *)*it;
            while (other != 0) {
            ...
            self->pSlots390->field04 = func_ov141_020ce76c(self, ids);
            break;
        }
        }
    }
