 ...
 * hands the canned 4-byte event record data_ov141_020ce9d0[1] to the owner's
...
extern u16 data_ov141_020ce9d0[4];
extern void func_ov141_020cd364(void);

void func_ov141_020cd2b0(Ov149Node *node)
{
    ...
    pp = buf;
    {
        char *src = (char *)data_ov141_020ce9d0;
        u16 high = *(u16 *)(src + 6);
        u16 low = *(u16 *)(src + 4);
