...
extern void func_ov141_020ce850(void);
extern void func_ov141_020ce99c(void);
void func_ov141_020ce8bc(int *node) {
    void *cb = (void *)func_ov141_020ce850;
    ...
    *(unsigned int *)(state[1] + 0x5c) &= ~2;
    func_0203c634(node, *(signed char *)(node + 8), func_ov141_020ce99c);
}
