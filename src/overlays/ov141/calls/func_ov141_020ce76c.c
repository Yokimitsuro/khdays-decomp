...
extern void func_ov141_020ce8bc(void);
extern void func_ov141_020ce964(void);
int func_ov141_020ce76c(int param_1, int param_2) {
    int *local_28;
    int iVar1 = func_0203c5c0(*(int *)(param_1 + 0x3c), 0x64, 0x48,
                              func_ov141_020ce8bc, func_ov141_020ce964, &local_28);
    int iVar5 = 0;
    *local_28 = param_1;
