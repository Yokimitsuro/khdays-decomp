...
extern void func_ov141_020cd7b0(void);
void func_ov141_020cd6ec(int *node) {
    ...
    pp = buf;
    pp[1] = data_ov141_020ce9d0[5];
    pp[0] = data_ov141_020ce9d0[4];
    cb = *(void (**)())(*state + 0x24);
    ...
    *(signed char *)((char *)state + 0x48) = 0;
    ...
    func_0203c634(node, *(signed char *)(node + 8), func_ov141_020cd7b0);
}
