...
/* func_ov105_020bf8c8 -- WH_SetReceiver: register the data-port receiver and hook the
 * port callback; a refusal ends the helper in ERROR.
 */
void func_ov105_020bf8c8(WhReceiverFunc proc)
{
    sWh.pReceiver = proc;

    if (func_ov105_020bd59c(WH_DATA_PORT, func_ov105_020bf120, NULL) != WM_ERRCODE_SUCCESS) {
