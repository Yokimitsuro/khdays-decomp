...
/* func_ov105_020be43c -- WH_FreeBuffers: return the MP send and receive buffers to the
 * game heap (the game's addition to the helper; the buffers are re-allocated per
 * connection).
 */
void func_ov105_020be43c(void)
{
