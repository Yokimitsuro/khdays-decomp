...
/* func_ov105_020bf33c -- WH_StateInMeasureChannel: measure the first allowed channel at
 * or above `channel`; WH_ERRCODE_NOMORE_CHANNEL past channel 16 or with no radio.
 */
u16 func_ov105_020bf33c(u16 channel)
{
    u16 allowedChannel;
    u16 result;

    allowedChannel = func_ov105_020bd7a4();
    ...
    result = func_ov105_020bf480(func_ov105_020bf3d8, channel);
