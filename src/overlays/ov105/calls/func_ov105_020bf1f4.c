...
/* func_ov105_020bf1f4 -- WH_SetSsid: set the ssid a child connects with, at most 24
 * bytes, zero padded.
 */
void func_ov105_020bf1f4(const void *ssid, u32 length)
{
    if (length > WM_SIZE_CHILD_SSID) {
        length = WM_SIZE_CHILD_SSID;
    }
