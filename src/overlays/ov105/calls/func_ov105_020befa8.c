...
/* func_ov105_020befa8 -- WH_StateInEndChild: disconnect from the parent; a refusal is
 * recorded and the helper reset.
 */
BOOL func_ov105_020befa8(void)
{
    WMErrCode result;

    WH_ChangeSysState(WH_SYSSTATE_BUSY);

    result = func_ov105_020bdea4(func_ov105_020befe0, 0);
