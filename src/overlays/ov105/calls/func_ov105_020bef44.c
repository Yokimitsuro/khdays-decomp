/*
 * func_ov105_020bef44 -- x3 (ov105/...). Enter mode 3 and run its callback-driven step.
...
extern void func_ov105_020bef74(void);

int func_ov105_020bef44(void) {
    int r;

    func_ov105_020be49c(3);
    r = func_ov105_020be294(&func_ov105_020bef74);
    if (r == 2) {
        return 1;
    }
