...
/* func_ov105_020be604 -- WH_StateInStartParent: start beaconing as the parent unless a
 * session is already up; the parent owns aid 0 and its bitmap starts with itself.
 */
BOOL func_ov105_020be604(void)
{
    WMErrCode result;
    ...
    result = func_ov105_020bdc5c(func_ov105_020be668);
