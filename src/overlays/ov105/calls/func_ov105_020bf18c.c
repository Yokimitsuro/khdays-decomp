...
/* func_ov105_020bf18c -- WH_StateOutEnd: the WM library has shut down: free the WM
 * system buffer and stop; a failure leaves the helper FATAL.
 */
void func_ov105_020bf18c(void *arg)
{
