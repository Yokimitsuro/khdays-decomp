...
/* khdays: shared-bss */
u16 sWh_nChannelBusyRatio = 0;
u16 sWh_nDisconnectReason = 0;
u16 sWh_nField0e = 0;
u16 sWh_nMpFreq = 0;
u16 sWh_nMeasuredChannel = 0;
u16 sWh_nChannelBitmap = 0;
u16 sWh_bAutoConnect = 0;
u16 data_ov105_020c04c0 = 0;
void *sWh_pField3c = 0;
WHSysState sWh_nSysState = 0;
WhReceiverFunc sWh_pReceiver = 0;
u8 *sWh_pSendBuffer = 0;
u8 *sWh_pRecvBuffer = 0;
u32 sWh_nSendBufferSize = 0;
int sWh_nErrCode = 0;
WhJudgeAcceptFunc sWh_pJudgeAccept = 0;
WhChildWEPKeyGeneratorFunc sWh_pChildWEPKeyGenerator = 0;
WhScanCallbackFunc sWh_pScanCallback = 0;
u32 sWh_nRand = 0;
int sWh_nConnectMode = 0;
WhParentWEPKeyGeneratorFunc sWh_pParentWEPKeyGenerator = 0;
u32 sWh_nRecvBufferSize = 0;
int sWh_bPictoCatch = 0;
void *sWh_pWmBuffer = 0;
extern u16 data_ov105_020c0520[16];         /* sWh_aWEPKey */
extern WMScanParam data_ov105_020c0540;     /* sWh_scanParam */
extern u8 data_ov105_020c0560[24];          /* sWh_aConnectionSsid */
extern WMParentParam data_ov105_020c0580;   /* sWh_parentParam */
extern WMBssDesc data_ov105_020c05c0;       /* sWh_bssDesc */
...
extern WMErrCode func_ov105_020be164(WMCallbackFunc callback, void *arg, const u16 *sendData, u16 sendDataSize, u16 destBitmap, u16 port, u16 prio);   /* WM_SetMPDataToPortEx */
extern WMErrCode func_ov105_020bd59c(u16 port, WMCallbackFunc callback, void *arg);   /* WM_SetPortCallback */
extern u16 func_ov105_020bd7a4(void);             /* WM_GetAllowedChannel */
extern u16 func_ov105_020bd854(void);             /* WM_GetDispersionBeaconPeriod */
extern WMErrCode func_ov105_020bf480(WMCallbackFunc func, u16 channel);   /* MeasureChannel */
extern u16 func_ov105_020bf33c(u16 channel);      /* WH_StateInMeasureChannel */
extern void func_ov105_020bf3d8(void *arg);       /* WH_StateOutMeasureChannel */
extern BOOL func_ov105_020be4c8(void);            /* WH_StateInSetParentParam */
extern BOOL func_ov105_020bec64(void);            /* WH_StateInSetChildWEPKey */
extern BOOL func_ov105_020becfc(void);            /* WH_StateInStartChild */
extern BOOL func_ov105_020bee7c(void);            /* WH_StateInStartChildMP */
extern void func_ov105_020beee0(void *arg);       /* WH_StateOutStartChildMP */
extern void func_ov105_020befe0(void *arg);       /* WH_StateOutEndChild */
extern void func_ov105_020bf0e0(void *arg);       /* WH_StateOutSetMPData */
extern void func_ov105_020bf120(void *arg);       /* WH_PortReceiveCallback */
extern BOOL func_ov105_020bf66c(void);            /* WH_StateInInitialize */
extern void func_ov105_020bf90c(void);            /* WH_Reset */
extern BOOL func_ov105_020beb98(void);            /* WH_EndScan */
extern BOOL func_ov105_020be850(void);            /* WH_StateInEndParentMP */
extern BOOL func_ov105_020bef44(void);            /* WH_StateInEndChildMP */
...
extern void *func_020236f8(u32 size, int align, void **heap);   /* Heap_AllocAligned */
...
/* func_ov105_020bf704 -- WH_ParentConnect: become the parent: allocate the MP buffers
 * (0x2c0 receive, 0x200 send), fill in the parent parameter block (tgid, channel, a
 * dispersed beacon period, 0x1e0/0x60 frame sizes, `maxEntry` children, entry open,
 * key sharing in KS mode) and the poll frequency, then start with the parameter step.
 */
BOOL func_ov105_020bf704(int mode, u16 tgid, u16 channel, int mpFreq, u16 maxEntry)
{
    sWh_nRecvBufferSize = 0x2c0;
    sWh_nSendBufferSize = 0x200;

    sWh_pRecvBuffer = func_020236f8(0x2c0, 0x20, (void **)data_0204c024);
    sWh_pSendBuffer = func_020236f8(sWh_nSendBufferSize, 0x20, (void **)data_0204c024);

    sWh_nConnectMode = mode;
    WH_ChangeSysState(WH_SYSSTATE_BUSY);

    sParentParam.tgid = tgid;
    sParentParam.channel = channel;
    sParentParam.beaconPeriod = func_ov105_020bd854();
    sParentParam.parentMaxSize = 0x1e0;
    sParentParam.childMaxSize = 0x60;
    sParentParam.maxEntry = maxEntry;
