...
/* func_ov105_020bee7c -- WH_StateInStartChildMP: start the child's MP protocol with the
 * helper's buffers at two polls per frame.
 */
BOOL func_ov105_020bee7c(void)
{
    WMErrCode result;

    result = func_ov105_020be0fc(func_ov105_020beee0, (u16 *)sWh.pRecvBuffer, (u16)sWh.nRecvBufferSize, (u16 *)sWh.pSendBuffer, (u16)sWh.nSendBufferSize, 2);
