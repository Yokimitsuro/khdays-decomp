...
/* func_ov105_020be7fc -- WH_StateOutStartParentMP: the parent's MP events; only the
 * start marks the session connected, the frame indications are ignored.
 */
void func_ov105_020be7fc(void *arg)
{
