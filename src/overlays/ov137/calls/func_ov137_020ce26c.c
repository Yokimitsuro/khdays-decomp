 ...
 * state at once); a 50.0 downward probe (func_ov137_020cdf9c) that hits turns the +8
 ...
 * the +0x30 hit mask before handing over to func_ov137_020ce3c8. */
...
extern int func_ov137_020cdf9c(int *state, Vec3 *dir, Vec3 *out);
...
extern void func_ov137_020ce3c8(int *node);
extern const Vec3 data_02042264;

void func_ov137_020ce26c(int *node)
{
    ...
    down.y = -0x32000;
    if (func_ov137_020cdf9c(state, &down, &hit) != 0) {
    ...
    *(unsigned char *)((char *)state + 0x30) = 0;
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov137_020ce3c8);
}
