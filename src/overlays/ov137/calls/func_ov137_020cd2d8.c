/* Start the ov137 leap: reseed the countdown from the owner's frame rate,
...
typedef struct Ov137ActionNode {
    void *pOwner;
    Ov137MoveState *pState;
    void *apHandlers[6];
...
extern void func_ov137_020cd414(Ov137ActionNode *node);
extern const short data_0203d210[];

void func_ov137_020cd2d8(Ov137ActionNode *node)
{
    Ov137MoveState *state = node->pState;
    ...
    state->vVelocity.y = 0x400;
    {
        ...
        int nNextHandler = (int)func_ov137_020cd414;
        Ov137ActionNode *pNextNode = node;
