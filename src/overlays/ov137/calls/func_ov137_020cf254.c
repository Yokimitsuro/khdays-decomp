/* Send the ov137 enemy's position message: the overlay's 14-byte template (data_ov137_020cf3a0)
...
extern const PosMsg data_ov137_020cf3a0;
...
void func_ov137_020cf254(int *state)
{
    PosMsg msg;
    FxVec vContact;
    FxVec *pPos;

    msg = data_ov137_020cf3a0;
    pPos = (FxVec *)state[1];
    vContact.x = pPos->x;
