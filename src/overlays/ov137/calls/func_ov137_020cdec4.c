...
extern void func_ov137_020ce234(void);
extern void func_ov137_020ce190(void);
int func_ov137_020cdec4(int param_1, int param_2, int param_3, int param_4) {
    int *entry;
    int r = func_0203c5c0(*(int *)(param_1 + 0x3c), 100, 0x34,
                          &func_ov137_020ce190, &func_ov137_020ce234, &entry);
    entry[0] = param_1;
    entry[1] = param_2;
    entry[2] = param_3;
    entry[3] = param_4;
