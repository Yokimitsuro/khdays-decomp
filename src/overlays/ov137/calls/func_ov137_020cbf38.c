...
extern const char data_ov137_020cf3c0[];
extern void func_ov137_020cbfc4(int);
int func_ov137_020cbf38(int param_1) {
    char buf[0x1d] = {0};
    int obj = func_0203d15c(0x3ac);
    *(signed char *)(obj + 0x19c) = 11;
    OS_SPrintf(buf, data_ov137_020cf3c0, 11);
    *(int *)(obj + 0x1a4) = func_ov107_020c9c24(buf);
    *(int *)(obj + 0x18c) = (int)&func_ov137_020cbfc4;
