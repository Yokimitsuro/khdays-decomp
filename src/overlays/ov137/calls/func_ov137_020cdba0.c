/* Aimed attack wait tick of the ov137 enemy: the +0x18 direction takes the owner's +0xa0 basis
 * turned by the +0x39c aim (9f48) and scaled by its reach. The +0x3c timer accumulates the
 * owner's rate: in phase 0 (+0x54) past 0x22aa the data_ov137_020cf37c[8..9] message pair goes
 * to the +0x24 hook (arg 4), phase 1 begins and reaction 0x11d mode 6 fires at the +0x398
 * bone's +0x14; in phase 1 past 0x23bb the +0x3a0 emitter is launched (func_ov137_020ce8f0)
...
extern void func_ov137_020ce8f0(int emitter, void *at, Vec3 *dir);
extern int func_02023eb4(int bound);
extern void func_0203c634(int *node, int slot, void *cb);
extern unsigned short data_ov137_020cf37c[];
extern short data_0203d210[];

void func_ov137_020cdba0(int *node)
{
    ...
    if (*(unsigned char *)((char *)state + 0x54) == 0 && state[0xf] > 0x22aa) {
        pp = pair;
        pp[1] = data_ov137_020cf37c[9];
        pp[0] = data_ov137_020cf37c[8];
        cb = *(void (**)())(*state + 0x24);
        if (cb != 0) cb(*state, pp, 4);
        *(unsigned char *)((char *)state + 0x54) = 1;
        func_ov107_020c5af8(*state, 0x11d, 6, (void *)(*(int *)(*state + 0x398) + 0x14));
        ...
        func_ov137_020ce8f0(*(int *)(*state + 0x3a0), (void *)(*(int *)(*state + 0x398) + 0x14), &dir);
