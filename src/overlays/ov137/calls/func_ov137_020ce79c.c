/* Ground drop tick of the ov137 enemy. In owner mode 1 the +0x28 radius grows by the owner's
 * rate and, up to 0xe00, the entities inside twice that radius around the +0x10 anchor are
...
void func_ov137_020ce79c(int *node)
{
