...
extern void func_ov214_020cd78c(void);

void func_ov214_020cd734(char *obj) {
    char *p = *(char **)(obj + 4);
    func_ov107_020c9264(*(int *)p, 1, 1);
    int min = *(int *)(*(char **)p + 0x224);
    int range = *(int *)(*(char **)p + 0x228) - min;
    if (range < 0) range = -range;
    *(int *)(p + 0x50) = min + func_02023eb4(range + 1);
    func_0203c634(obj, *(signed char *)(obj + 0x20), func_ov214_020cd78c);
}
