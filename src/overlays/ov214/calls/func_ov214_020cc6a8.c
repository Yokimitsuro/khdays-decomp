...
extern void func_ov214_020cc64c(void *self);
extern void func_ov214_020cea68(void *node, const VecFx32 *pos);
extern void func_ov107_020c7500(void *self, void *cmd, void *arg3);

void func_ov214_020cc6a8(char *self, u8 *cmd, void *arg3)
{
    int rawZ;
    int rawY;
    int rawX;
    ...
    if (cmd[2] == 5) {
        ...
        case 5:
            break;
        case 6:
            func_ov214_020cc64c(self);
            break;
        case 7:
            func_ov214_020cea68(*(void **)(self + 0x3c0), &pos);
            break;
        }
    }
