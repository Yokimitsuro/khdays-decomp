...
extern void func_ov214_020cd8ac(void);

void func_ov214_020cd848(int *node) {
    int *state = (int *)node[1];
    func_ov107_020c9264(*state, 2, 1);
    func_ov214_020cd138(*state, 0);
    {
    ...
    func_0203c634(node, *(signed char *)(node + 8), func_ov214_020cd8ac);
}
