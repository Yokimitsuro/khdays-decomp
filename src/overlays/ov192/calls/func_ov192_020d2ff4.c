...
extern void func_ov192_020d3190(void);

void func_ov192_020d2ff4(int node)
{
    ...
    *(unsigned char *)(state + 0xe) = 0;
    ...
    {
        Pair *pp = &p;
        pp->b = data_ov192_020d4b90.b;
        pp->a = data_ov192_020d4b90.a;
    ...
    }
    {
        ...
        state[0xc] = *(int *)(*(int *)node + 0x2c) * 30 / 5;
        func_0203c634(node, *(signed char *)(node + 0x20), func_ov192_020d3190);
    }
}
