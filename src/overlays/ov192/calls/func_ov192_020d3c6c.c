...
extern void func_ov192_020d3e40(void);
extern void func_ov192_020d3e80(void);
extern void func_ov192_020d3eb8(void);
extern void func_ov192_020d3f6c(void);
extern void func_ov192_020d3fc8(void);
...
extern const int data_ov192_020d4ba4[2];

void func_ov192_020d3c6c(char *self)
{
    int kinds[2];
    u16 hw;
    int i;
    i = 0;
    kinds[0] = data_ov192_020d4ba4[0];
    kinds[1] = data_ov192_020d4ba4[1];
    *(Callback *)(self + 0x8) = func_ov192_020d3e40;
    *(Callback *)(self + 0xc) = func_ov192_020d3e80;
    *(Callback *)(self + 0x1c) = func_ov192_020d3eb8;
    *(Callback *)(self + 0x30) = func_ov192_020d3fc8;
    *(Callback *)(self + 0x1d0) = func_ov192_020d3f6c;
    hw = *(u16 *)(self + 0x60);
