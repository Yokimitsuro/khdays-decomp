...
extern void func_ov015_02082188(int a, unsigned short b, unsigned short c, void *d,
                                 int e, unsigned short f, int g);

int func_ov015_02082838(void *arg1, int arg2) {
    ...
    func_ov015_02082188(r5, (unsigned short)r7, (unsigned short)t10, &buf[0],
