 ...
 * event 0x159 on the sub-object. Once the sub-object stops reporting busy, roll a fresh hold
...
void func_ov250_020d25e0(int *node) {
    int *state = (int *)node[1];
    VecFx32 v;
    int scale;
    struct Ov250Flags *fl;
    int lo;
    int d;
    ...
    fl = (struct Ov250Flags *)((int)state + 0x51);
    if (fl->b1 == 0 && state[0x1b] >= 0x1000) {
        fl->b1 = 1;
        func_ov107_020c5af8(state[0], 0x159, 9, state[1]);
    }
