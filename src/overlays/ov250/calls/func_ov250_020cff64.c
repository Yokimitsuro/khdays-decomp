/* Message handler of the ov250 enemy (x4: ov250/182/183/184). A kind-0 message stores its +0x24
...
void func_ov250_020cff64(int actor, unsigned char *msg, int param)
{
    if (msg[2] == 0) {
