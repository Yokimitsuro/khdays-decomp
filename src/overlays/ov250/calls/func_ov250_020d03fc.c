...
extern void func_ov250_020d04d8(void);
extern void func_ov250_020d06d0(void);

struct hw60 { unsigned short lo : 8, hi : 8; };
struct b8 { unsigned int f : 8; };

void func_ov250_020d03fc(int *self) {
    int *s = (int *)self[1];
    int zero = 0;
    ...
    *(int *)(*s + 0x394) = zero;
    ...
    func_0203c634(self, 1, (void *)&func_ov250_020d0784);
    func_0203c634(self, 0, (void *)&func_ov250_020d04d8);
    func_0203c634(self, 2, (void *)&func_ov250_020d06d0);
}
