...
extern void func_ov250_020d0d54(void);

void func_ov250_020d0c34(int *self) {
    int *obj = (int *)self[1];
    int gap;
    struct Vec3 delta;
    int me;
    ...
    func_ov107_020c9264(obj[0], 3, 1);
    func_0203c634(self, *(signed char *)((char *)self + 0x20), func_ov250_020d0d54);
}
