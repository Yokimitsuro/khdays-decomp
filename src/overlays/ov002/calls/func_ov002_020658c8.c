 ...
 * func_ov002_02066c9c first when the caller asks for it. The slot index lives at
...
extern void func_ov002_02066c9c(int value, int notify);

extern int data_ov002_0207f99c;
extern Ov002TableSlot data_ov002_0207f9a8[];

void func_ov002_020658c8(int value, int notify) {
    int ctx = data_ov002_0207f99c;

    if (notify != 0) {
        func_ov002_02066c9c(value, notify);
    }
