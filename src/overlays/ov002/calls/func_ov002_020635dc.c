/* Build the VRAM key for the secondary tile block: the block's base offset,
...
unsigned int func_ov002_020635dc(unsigned int slot) {
    unsigned int base = data_ov002_0207f62c.pLayout->nSecondaryBase + 0x8000;
