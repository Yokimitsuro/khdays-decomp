/*
 * func_ov002_020521e4 -- x3 (ov002/...). Advance or commit a widget's scroll, then clear the dirty
...
void func_ov002_020521e4(int param1, int param2, int param3, int param4) {
