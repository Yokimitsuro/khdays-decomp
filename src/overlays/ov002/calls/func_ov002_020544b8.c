...
extern int func_ov002_02053efc(int a, int b);
int func_ov002_020544b8(int a, int b, unsigned short c, unsigned short d, unsigned short e,
                        short f, short g, int h) {
    int obj = func_ov002_02053f4c(a);
    ...
    *(short *)(obj + 0xa) = f;
    *(short *)(obj + 0xc) = g;
    *(int *)(obj + 0x18) = func_ov002_02053efc(a, b);
    *(int *)(obj + 0x14) = 1;
    return obj;
}
