...
extern int func_ov002_0206d194(int key);
...
{
    Ov002Record *r = (Ov002Record *)func_ov002_0206d194(param_2);
    func_ov002_02077b64(param_1, r->f42, r->f40, param_3, param_4, param_5, param_6);
}
