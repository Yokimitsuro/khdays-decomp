...
extern void func_ov002_02054850(int owner, int entry, unsigned short a, unsigned short b);
extern void func_ov002_02054878(int owner, int entry);

void func_ov002_02054bcc(int param_1, int param_2, unsigned short param_3, unsigned short param_4) {
    int i = 0;
    int n = *(unsigned short *)(param_2 + 2);
    if (n > 0) {
        do {
            func_ov002_02054850(param_1, (*(int **)(param_2 + 0x2c))[i], param_3, param_4);
            i = i + 1;
