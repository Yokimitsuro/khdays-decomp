...
extern void func_ov002_02054748(int owner, void *obj, unsigned short kind);
void func_ov002_02053de0(int param_1, int param_2) {
    ...
    for (i = 0; i < n; i++) {
        ...
        func_ov002_02054748(param_1, obj, *(unsigned short *)(p + 4));
        p += *(int *)p;
    }
}
