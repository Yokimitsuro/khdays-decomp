...
extern int func_ov002_02054d4c(int target);
extern void func_ov002_0205400c(int self, int target);
struct f2c { unsigned char b0 : 1, b1 : 1, b2 : 1; };
int func_ov002_02054080(int param_1, int param_2) {
    ...
    if (fp->b1) {
        ...
        if (func_ov002_02054d4c(param_2) == 0)
            func_ov002_0205400c(param_1, param_2);
    }
    return r;
}
