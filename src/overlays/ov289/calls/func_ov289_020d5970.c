/*
 * func_ov289_020d5970 -- Ov287_Actor_HandleEvent.
 *
 * The actor class event handler installed in the +0x1c slot by func_ov289_020d5664, shared
...
void func_ov289_020d5970(struct Actor *actor, struct ActorEventMsg *msg, u32 param)
{
