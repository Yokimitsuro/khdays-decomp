/*
 * func_ov289_020d5bb8 -- Ov287_Actor_SetSubStateAndNotify.
 *
 * Installed in the +0x1dc slot by func_ov289_020d5664, shared with ov288 and ov289. Does
...
void func_ov289_020d5bb8(struct Actor *actor, int index, int on)
{
