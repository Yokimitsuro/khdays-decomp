/*
 * func_ov136_020d2f8c -- burst attack tick of the ov134 enemy (and its byte-identical twins).
 *
...
extern struct Ov134AreaMsg data_ov136_020d3a02;
extern struct Ov134AreaMsg data_ov136_020d39f4;
...
extern void func_ov136_020d33c0(void);

void func_ov136_020d2f8c(struct Ov134ActionNode *node)
{
    ...
    if (*(u8 *)(state->pItem04 + 0xad) == 0) {
        ...
        func_0203c634(node, node->bSlot, (void *)&func_ov136_020d33c0);
    }
}
