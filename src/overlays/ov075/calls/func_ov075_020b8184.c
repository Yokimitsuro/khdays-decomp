/* func_ov075_020b8184 -- overlay boot of the ov036 enemy (x4: ov036/054/074/091): the ov042 shape (see
...
extern void func_ov075_020b840c(void);
extern void func_ov075_020b84d8(void);
extern void func_ov075_020b8564(void);
extern void func_ov075_020b8378(void);
extern void func_ov075_020b83e4(void);
extern void func_ov075_020b8624(void);
extern void func_ov075_020b9ba4(void);
extern void func_ov075_020b86cc(void);
extern void func_ov075_020b913c(void);
...
void func_ov075_020b8184(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov075_020b9d48, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov075_020b9d5c, 1, cfg[0] + 7);
    }
    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov075_020b840c;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov075_020b84d8;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov075_020b8564;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov075_020b8378;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov075_020b83e4;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov075_020b8624;
    *(void **)(obj + 0x664 + 0x1c) = (void *)&func_ov075_020b9ba4;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov075_020b86cc;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov075_020b913c;
...
test:
    ...
    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov075_020b9ce8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov075_020b9cf8) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov075_020b9d08) : -1;
    if (cfg[3] != 0) {
        *(long long *)obj |= 0x20;
    }
    if (cfg[4] != 0) {
