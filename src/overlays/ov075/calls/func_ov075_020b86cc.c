...
extern char data_ov075_020b9d70[];
extern char data_ov075_020b9d80[];
extern char data_ov075_020b9d94[];

u8 func_ov075_020b86cc(char *self)
{
    char *block = self + 0x2f8 + 0x2000;

    block[0x334] = 0;
    func_ov022_020b15b0(*(u8 *)(self + 9), 3);
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov075_020b9d70, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov075_020b9d80, *(u8 *)(self + 9), 1, *(char **)(*(char **)(self + 0x2644) + 0x3c) + 0x28);
    *(u8 **)(block + 0x348) = func_ov022_020b14a4(data_ov075_020b9d94, *(u8 *)(self + 9), 2, *(char **)(*(char **)(self + 0x2644) + 0x6c) + 0x28);
