 ...
 * the follow-up pass in func_ov075_020b9b74. One of four byte-identical siblings
 ...
 * come out swapped. The matched sibling func_ov075_020b9b74 hides this because it has
 * no second parameter and therefore nothing to schedule against. */
extern void func_ov022_0209145c(int part, int a);
extern void func_ov075_020b9b74(int this_);

void func_ov075_020b9b30(int this_, int a) {
    int i, off;
    for (i = 0, off = 0; i < 3; i++, off += 0x30) {
        func_ov022_0209145c(((int *)(this_ + 0x2000))[0x191] + off, a);
    }
    func_ov075_020b9b74(this_);
}
