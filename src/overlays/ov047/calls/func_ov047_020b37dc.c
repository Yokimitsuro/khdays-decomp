...
extern struct Ov047Descriptor data_ov047_020b431c;
extern struct Ov047Descriptor data_ov047_020b432c;

u8 func_ov047_020b37dc(struct Ov047Runtime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov047_020b431c.bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov047_020b432c.bytes, self->slot09, 1,
