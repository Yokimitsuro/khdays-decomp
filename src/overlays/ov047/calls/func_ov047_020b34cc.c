...
extern void func_ov047_020b3b40(char *self);
extern void func_ov047_020b38f0(char *blk);
...
void func_ov047_020b34cc(char *self, int nState)
{
    ...
    case 0x2e:
        if (*(int *)(self + 0x6bc) != nState) {
            *(int *)(blk + 0xc) = nArg;
            func_ov047_020b3b40(self);
        }
        break;

    case 0x31:
        if (*(int *)(self + 0x6bc) != nState) {
            func_ov047_020b38f0(blk);
        }
        break;
