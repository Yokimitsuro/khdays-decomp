...
extern void func_ov062_020b7a74(int self);
extern void func_ov062_020b73d8(int block);

void func_ov062_020b7060(int self) {
    int block = data_ov062_020b80e0 + 0x138 + 0x2c00;
    *(int *)(block + 0x118) = *(int *)(self + 0x2000 + 0x63c) + 4;
    func_ov062_020b7a74(self);
    func_ov062_020b73d8(block);
}
