...
extern void func_ov062_020b7060(char *self);
extern void func_ov062_020b7320(char *self, char *pBlock);
extern void func_ov022_020a4490(char *self, int nSound, int nVariant);
extern void func_ov062_020b7344(char *self, char *pBlock);
extern void func_ov022_020a384c(char *self, int nState);
extern char *data_ov062_020b80e0;

void func_ov062_020b5d44(char *self, int nState)
{
    ...
    case 0x2f:
        if (*(int *)(self + 0x6bc) != nState) {
            if (*(int *)(pBlock + 8) == 0) {
                *(int *)(pBlock + 8) = 1;
                func_ov062_020b7320(self, pBlock);
            }
        }
        break;
    case 0x30:
    ...
    case 0x31:
        if (*(int *)(self + 0x6bc) != nState) {
            func_ov062_020b7344(self, pBlock);
        }
        break;
    case 0x32:
        nState = 1;
