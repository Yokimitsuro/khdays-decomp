/* func_ov062_020b5a90 -- overlay boot of the mission enemy (ov043/ov062 twins): the ov042 shape
...
extern void func_ov062_020b5d44(void);
extern void func_ov062_020b5e28(void);
extern void func_ov062_020b5fa4(void);
extern void func_ov062_020b5cc4(void);
extern void func_ov062_020b5d1c(void);
extern void func_ov062_020b5ecc(void);
extern void func_ov062_020b634c(void);
extern void func_ov062_020b6498(void);
extern void *data_ov062_020b80e0;
extern int data_ov062_020b8028;
extern int data_ov062_020b803c;
extern void func_ov062_020b6550(void);
...
void func_ov062_020b5a90(int *cfg) {
    ...
    *(long long *)obj = 0;
    ...
    if (cfg[6] == 0) {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov062_020b8028, 1, cfg[0] + 7);
    } else {
        func_0202b914(*(signed char *)(obj + 0x4bc), &data_ov062_020b803c, 1, cfg[0] + 7);
    }
    *(void **)(obj + 0x664 + 0x00) = (void *)&func_ov062_020b5d44;
    *(void **)(obj + 0x664 + 0x04) = (void *)&func_ov062_020b5e28;
    *(void **)(obj + 0x664 + 0x08) = (void *)&func_ov062_020b5fa4;
    *(void **)(obj + 0x664 + 0x0c) = 0;
    *(void **)(obj + 0x664 + 0x10) = 0;
    *(void **)(obj + 0x664 + 0x14) = (void *)&func_ov062_020b5cc4;
    *(void **)(obj + 0x664 + 0x18) = (void *)&func_ov062_020b5d1c;
    *(void **)(obj + 0x664 + 0x20) = (void *)&func_ov062_020b5ecc;
    *(void **)(obj + 0x664 + 0x1c) = (void *)&func_ov062_020b634c;
    *(void **)(obj + 0x664 + 0x28) = (void *)&func_ov062_020b6498;
    *(void **)(obj + 0x664 + 0x24) = (void *)&func_ov062_020b6550;

    func_0202d968(obj + 0x20, func_0202bfcc(*(signed char *)(obj + 0x4bc)));

    b = bone(obj);
    *(int *)(obj + 0x520) = b != 0 ? func_02016f10((void *)b, &data_ov062_020b7fe4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x518) = b != 0 ? func_02016f10((void *)b, &data_ov062_020b7f4c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x514) = b != 0 ? func_02016f10((void *)b, &data_ov062_020b7fd4) : -1;
    b = bone(obj);
    *(int *)(obj + 0x51c) = b != 0 ? func_02016f10((void *)b, &data_ov062_020b7f5c) : -1;
    b = bone(obj);
    *(int *)(obj + 0x524) = b != 0 ? func_02016f10((void *)b, &data_ov062_020b7f3c) : -1;
    if (cfg[3] != 0) {
        *(long long *)obj |= 0x20;
    }
    if (cfg[4] != 0) {
