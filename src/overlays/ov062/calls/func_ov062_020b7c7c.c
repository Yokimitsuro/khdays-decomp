...
extern void func_ov062_020b76f0(struct Ov043Actor *pActor, int slot, VecFx32 *pOut);
extern void MTX_RotY33_(MtxFx33 *pMtx, int nSin, int nCos);
extern void func_ov062_020b74d4(struct Ov043RequestEffect *pEffect, VecFx32 *pOut);
...
extern void func_ov062_020b77b8(struct Ov043Actor *pActor, char *pNode, int slot,
...
int func_ov062_020b7c7c(struct Ov043EffectGroup *pGroup,
                        struct Ov043RequestEffect *pEffect, int dt)
{
    ...
    func_ov062_020b77b8(pActor, pNode, pEffect->slot001, &finalPosition, &swing);
