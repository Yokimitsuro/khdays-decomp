/* func_ov099_020bb104 -- spawn four particle emitters into the owner's emitter pool
...
extern void func_ov099_020bb21c(int slot, int b);
extern void func_ov099_020bb1f8(int slot);

void func_ov099_020bb104(int self) {
