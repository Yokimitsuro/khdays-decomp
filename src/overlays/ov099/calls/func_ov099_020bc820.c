...
extern int func_ov022_020ad718(struct TimelineActor *actor);
extern void func_ov022_020a4490(struct TimelineActor *actor, int cue, int mode);
extern void func_ov099_020bb104(struct TimelineActorOwner *self);
extern int func_ov099_020bb294(struct TimelineActorOwner *self,
...
extern void func_ov099_020bb950(struct TimelineActorOwner *self, int delta);
extern void func_ov099_020bb860(struct TimelineActorOwner *self);

void func_ov099_020bc820(struct TimelineActorOwner *self, int delta)
{
...
afterSpawn:
    ...
    i = 0;
    do {
        if (func_ov099_020bb294(self, motion, delta) != 0) {
            active = 1;
        }
        i++;
        motion++;
...
afterAnimation:
    ...
    func_ov099_020bb950(self, delta);
    func_ov099_020bb860(self);
}
