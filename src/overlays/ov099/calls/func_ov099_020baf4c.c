...
extern struct PanelResourcePath data_ov099_020bcb1c[];

u8 func_ov099_020baf4c(struct PanelRuntime *self)
{
    ...
    block->handle340 = func_ov022_020b14a4(
        data_ov099_020bcb1c[1].bytes, self->slot09, 0,
        &self->scene20->field04);
    block->handle344 = func_ov022_020b14a4(
        data_ov099_020bcb1c[2].bytes, self->slot09, 1,
