...
struct Outer;
extern void func_ov099_020bc6b0(struct Outer *outer, int sel);
extern void func_ov099_020bb030(void);
extern void func_ov099_020bb044(void);

void *func_ov099_020bafcc(struct Outer *obj, int a) {
    struct Outer *base = (struct Outer *)((char *)obj + 0xa8);
    void *r = 0;
    switch (a) {
    case 0x22:
        func_ov099_020bc6b0((struct Outer *)((char *)base + 0x2c00), 0x22);
        r = (void *)func_ov099_020bb030;
        break;
    case 0x23:
        func_ov099_020bc6b0((struct Outer *)((char *)base + 0x2c00), 0x23);
        r = (void *)func_ov099_020bb044;
        break;
    }
    return r;
}
