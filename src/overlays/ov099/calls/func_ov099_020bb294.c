...
extern void func_ov099_020bb1d4();
extern void func_ov099_020bb21c();
extern void func_ov099_020bb5e4();
extern void func_ov099_020bb708();
extern short data_0203d210[];
extern int data_02041dc8;

struct Vec3 { int x; int y; int z; };

int func_ov099_020bb294(char *owner, char *ent, int delta)
{
    ...
    *(int *)(ent + 0x130) += delta;
    ...
    case 3:
    {
        ...
        *(unsigned short *)(ent + 0x15e) += *(unsigned short *)(owner + 0x10);
        ...
        func_ov099_020bb708(&vec[3], owner, ent, &vec[3], &data_02041dc8, 0);
        *(struct Vec3 *)(ent + 0xa4) = *(struct Vec3 *)&vec[3];
        ...
        if (func_0202a818(ent, delta) != 0 && *(short *)(ent + 2) == 0) {
            if (*(int *)(cfg + 0x6bc) != 0x30)
                func_ov099_020bb1d4(ent);
            else
                func_ov099_020bb21c(ent, 1);
        }
        if (*(int *)(ent + 0x130) >= 0xc000)
            func_ov099_020bb5e4(owner, ent, ent + 0xa4, vec);
    ...
    case 4:
        func_ov099_020bb5e4(owner, ent, ent + 0xa4, ent + 0x148);
        if (*(unsigned char *)(ent + 0x12c) == 4) {
            func_ov099_020bb708(&vec[3], owner, ent, ent + 0xa4, ent + 0x148, 1);
            *(struct Vec3 *)(ent + 0xa4) = *(struct Vec3 *)&vec[3];
            if (func_0202a818(ent, delta) != 0 && *(short *)(ent + 2) == 0)
                func_ov099_020bb21c(ent, 1);
        }
