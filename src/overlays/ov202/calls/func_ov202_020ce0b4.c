/* func_ov202_020ce0b4: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern const struct Msg data_ov202_020cef96;
extern void func_ov202_020ce280(void);

void func_ov202_020ce0b4(struct Node *node)
{
    struct State *st;
    struct Msg msg;
    FxVec raw;
    ...
    *(u8 *)(st->pActor + 0x1c5) &= ~0xf;
    ...
    func_0203c634(node, node->bSlot, (void *)func_ov202_020ce280);
}
