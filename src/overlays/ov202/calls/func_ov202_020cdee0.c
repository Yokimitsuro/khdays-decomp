/* func_ov202_020cdee0: recoil entry of the ov202 enemy (x2), variant of the matched ov132 sibling (+0x60 bit 6 cleared before the +0x3e0 bit-0 clear; the zero vector is a const extern so its load hoists above the stores). */
struct v3 { int a, b, c; };
...
extern void func_ov202_020cdfc0(void);

void func_ov202_020cdee0(char *obj) {
    int *state = *(int **)(obj + 4);
    struct pair buf;
    ...
    *(struct v3 *)((char *)state + 0x20) = data_02041dc8;
    state[0x15] = 0;
    state[0xb] = 0;
    func_0203c634(obj, *(signed char *)(obj + 0x20), func_ov202_020cdfc0);
}
