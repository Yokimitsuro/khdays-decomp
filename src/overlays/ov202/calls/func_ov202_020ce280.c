/* func_ov202_020ce280: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern int func_ov202_020cc588(void *world, struct Sphere *shape, void **out);
...
void func_ov202_020ce280(struct Node *node)
{
    struct State *st;
    void *world;
    void *aVictims[4];
    ...
    nHits = func_ov202_020cc588(*(void **)((char *)world + 0x7c), &shape, aChildren);
    i = 0;
    if (nHits > 0) {
        do {
