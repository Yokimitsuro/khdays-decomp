/* func_ov202_020cc2f8: ported from a matched sibling family (same shape, constants and offsets adjusted). */
extern int func_ov202_020ced28(int, int, int, int);
    ...
    if (*(unsigned char *)(param_2 + 2) == 5) {
        ...
        case 3:
            ...
            *(int *)(*(int *)(param_1 + 0x3dc) + 0x1c) = result;
            ...
            break;
        case 4:
            result = func_ov202_020ceb3c(param_1, *(unsigned char *)(param_2 + 3), param_3, param_4);
