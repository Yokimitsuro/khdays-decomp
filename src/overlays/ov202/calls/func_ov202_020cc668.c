...
extern const struct tbl8 data_ov202_020cefa4;

void func_ov202_020cc668(int *param_1, int param_2, int param_3, int param_4,
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (child != 0) {
            ...
            func_ov202_020cc668(newcenter, half, child, param_4,
