/* func_ov202_020cd964: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
extern const struct Msg data_ov202_020cef7a;
extern void func_ov202_020cddf8(void);

void func_ov202_020cd964(struct Node *node)
{
    struct State *st;
    FxVec vFwd;
    FxVec vToTarget;
    ...
    func_0203c634(node, node->bSlot, (void *)func_ov202_020cddf8);
}
