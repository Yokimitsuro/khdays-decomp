extern int func_ov202_020cc668(int *pair, int a, int b, int c, int *box2, int *box, int *counter, int p3);
int func_ov202_020cc588(int param_1, int *param_2, int param_3) {
    ...
    for (i = 0; i < (int)(unsigned short)*(unsigned short *)(param_1 + 2); i++) {
        ...
        if ((*(unsigned short *)(child + 0x74) & 0x2000) == 0) {
            f[0] = *(int *)(child + 0x84);
            f[1] = *(int *)(child + 0x88);
            func_ov202_020cc668(&f[0], *(int *)(child + 0x8c), *(int *)(child + 0x9c),
