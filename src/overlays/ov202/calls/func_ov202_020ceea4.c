 ...
 * sub-item states 2->1 and 0->2 and advances to func_ov202_020cef30. */
struct Bits5c { unsigned b0 : 1, b1 : 1; };

extern void func_0203b9fc(int obj, int slot, int a, int b);
extern void func_0203c634(int *self, int idx, void *cb);
extern void func_ov202_020cef30(void);

void func_ov202_020ceea4(int *node) {
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), func_ov202_020cef30);
}
