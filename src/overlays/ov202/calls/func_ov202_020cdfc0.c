/* func_ov202_020cdfc0: ported from a matched sibling family (same shape, constants and offsets adjusted). */
...
void func_ov202_020cdfc0(struct Node *node)
{
    struct State *st;
    int bHeld;
    ...
    if (((struct Flags3cc *)(st->pActor + 0x3e0))->bBit0 != 0) {
