 ...
 * (the data_ov224_020d4e14 kind is copied to the stack between the two writes), bit 2 of +0x1ae
 ...
 * +0x78 the rolling data_ov224_020d4e74 slot (which then advances, wrapping to 3 at 0x1f);
...
extern void func_ov224_020d4240(void);
extern void func_ov224_020d4274(void);
extern void func_ov224_020d42d8(void);
extern void func_ov224_020d4464(void);
extern const struct Ov221Saved data_ov224_020d4e14;
extern struct RollingCounter data_ov224_020d4e74;

void func_ov224_020d4048(char *self) {
    int owner;
    unsigned short v;
    struct Ov221Saved saved;

    owner = *(int *)(self + 0x390);
    *(void **)(self + 8) = (void *)func_ov224_020d4240;
    *(void **)(self + 0xc) = (void *)func_ov224_020d4274;
    *(void **)(self + 0x1c) = (void *)func_ov224_020d42d8;
    *(void **)(self + 0x30) = (void *)func_ov224_020d4464;
    ...
    *(int *)(self + 0x384) = func_0203b898(func_ov107_020c9440(owner, 0x1a));
    ...
    data_ov224_020d4e74.value = data_ov224_020d4e74.value + 1;
    if (data_ov224_020d4e74.value >= 0x1f) {
        data_ov224_020d4e74.value = 3;
    }
