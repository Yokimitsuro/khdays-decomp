 ...
 * past 0x770 with a +0x78 target or past 0x1a90 without, reaction 0x14a mode 0x13 fires at
 * the +8 point. Between 0x1540 and 0x2178 with a target, or between 0x2200 and 0x2ec0
 * without, the sub-action 7 runs (func_ov224_020d0a3c). Once the +4 item goes idle (+0xad)
...
void func_ov224_020d39c0(int *node)
{
