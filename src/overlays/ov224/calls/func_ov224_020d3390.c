 ...
 * the tracking step (func_ov224_020d1344) ends the state when negative, otherwise the +0x3fc
 ...
 * reaction 0x14a mode 5 at the +8 point. Once the +4 item goes idle (+0xad) the +0x78 target
...
extern int func_ov224_020d1344(int *node, int arg);
...
void func_ov224_020d3390(int *node)
{
