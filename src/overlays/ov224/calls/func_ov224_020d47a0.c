...
struct Vec3_020d4768 { int x, y, z; };
extern const struct Vec3_020d4768 data_02041dc8;
extern int func_0203c634(int a, int b, void *handler);
extern void func_ov224_020d485c(int);
struct node60_020d4768 { unsigned short lo : 8; unsigned short hi : 8; };
struct lo8_020d4768 { unsigned f : 8; };
void func_ov224_020d47a0(int param_1) {
    ...
    *(struct Vec3_020d4768 *)(child + 0x18) = data_02041dc8;
    func_0203c634(param_1, *(signed char *)(param_1 + 0x20), (void *)&func_ov224_020d485c);
}
