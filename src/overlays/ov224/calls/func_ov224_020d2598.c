/* func_ov224_020d2598 -- the strafe tick: re-acquire the target, then either correct the distance
 * or settle on a facing.
 *
 * func_ov224_020d1344 hands back the range and fills a direction vector; negative means give up,
 * and func_ov224_020d0d38 gets a veto too. Both bail through a plain c634 re-entry.
 *
 ...
 * Either one hands off to func_ov224_020d27e0. In the band between, or with the flag set, it
...
extern int func_ov224_020d1344(int self, VecFx32 *dir);
extern void func_0203c634(int self, int action, void *cb);
extern int func_ov224_020d0d38(int self, int range);
extern void func_ov224_020d27e0(void);
extern void func_ov224_020d23a0(int self, int angle);
...
void func_ov224_020d2598(int self) {
    int *ctx;
    VecFx32 dir;
    int range;
    int facing;
    ...
    *(int *)(ctx[0] + 0x3e8) = func_ov107_020cab14(ctx[0], 0);
    ...
    range = func_ov224_020d1344(self, &dir);
    if (range < 0) {
        func_0203c634(self, *(signed char *)(self + 0x20), 0);
        return;
    }
    if (func_ov224_020d0d38(self, range) != 0) {
        func_0203c634(self, *(signed char *)(self + 0x20), 0);
        return;
    }
    ...
    *(VecFx32 *)((char *)ctx + 0x38) = *(VecFx32 *)ctx[2];
    ...
    if (((Flags17a *)(ctx[0] + 0x17a))->b1 == 0) {
        if (range > 0xf000) {
            *(int *)((char *)ctx + 0x38) += dir.x * (range - 0x5000) / 0x1000;
            ...
            func_0203c634(self, *(signed char *)(self + 0x20), func_ov224_020d27e0);
            return;
        }
        if (range < 0x3800) {
            *(int *)((char *)ctx + 0x38) += -dir.x * (range + 0x5000) / 0x1000;
    ...
    func_ov224_020d23a0(self, facing);
}
