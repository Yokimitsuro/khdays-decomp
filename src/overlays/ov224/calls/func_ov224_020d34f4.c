/* func_ov224_020d34f4 -- enter the approach: pick a lane, a speed and a duration, then dispatch.
 * A negative reading from func_ov224_020d1344 aborts straight to the dispatcher.
 *
...
extern int func_ov224_020d1344(int self, int kind);
...
extern void func_ov224_020d3638(void);

void func_ov224_020d34f4(int self) {
    int *ctx;
    int v;
    int speed;
    int steps;
    ...
    *(unsigned char *)((char *)ctx + 0x76) = 0;
    func_0203c634(self, *(signed char *)(self + 0x20), func_ov224_020d3638);
}
