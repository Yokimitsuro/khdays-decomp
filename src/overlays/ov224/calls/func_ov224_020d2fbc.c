 ...
 * While still below obj[0x18]+0x800, re-arm via func_ov224_020d0a3c with mode 2/4 (by the
...
extern void func_ov224_020d0a3c(int *obj, int mode, int b);
extern struct vec data_02041dc8;
extern void func_ov224_020d308c(void);
void func_ov224_020d2fbc(int self) {
    int *obj = *(int **)(self + 4);
    int t, flag;
    *(struct vec *)(obj + 5) = *(struct vec *)(obj + 8);
    ...
    if (t >= obj[0x18] + 0x800) {
        ...
        func_0203c634(self, *(signed char *)(self + 0x20), &func_ov224_020d308c);
        return;
    }
    func_ov224_020d0a3c(obj, flag != 0 ? 2 : 4, 0);
}
