/* Constructor of the ov224 enemy. Installs the handlers (+8, +0xc, +0x1c message, +0x30, +0x28, +0x2c,
 ...
 * builds the eight sub-items of data_ov224_020d4de0 into the +0x424 pair table (attached, hidden);
 ...
 * bit 1 of the second one, creates the four +0x3ec helpers (020d4014) and loads sound 0x14a. */
...
extern void func_ov224_020d0214(void);
extern void func_ov224_020d026c(void);
extern void func_ov224_020d0318(void);
extern void func_ov224_020d06b4(void);
extern void func_ov224_020d0290(void);
extern void func_ov224_020d02d4(void);
extern void func_ov224_020d05c4(void);
extern void func_ov224_020d0710(void);
extern void func_ov224_020d0630(void);
extern void func_ov224_020d09e0(void);
extern void func_ov224_020d0a0c(void);
extern void *func_ov107_020c9440(char *self, int index);
extern int func_0203b898(void *item);
extern void func_ov224_020cfd80(char *self);
...
extern int func_ov224_020d4014(char *self);
...
void func_ov224_020cfdbc(char *self)
{
    IdTable8 ids = data_ov224_020d4de0;
    Bounds bounds;
    Vec3 lift;
    Sphere sph;
    Vec3 origin;
    ...
    bounds.max.y = 0x2000;
    bounds.max.z = 0x2000;
    *(Callback *)(self + 0x8) = func_ov224_020d0214;
    *(Callback *)(self + 0xc) = func_ov224_020d026c;
    *(Callback *)(self + 0x1c) = func_ov224_020d0318;
    *(Callback *)(self + 0x30) = func_ov224_020d06b4;
    *(Callback *)(self + 0x28) = func_ov224_020d0290;
    *(Callback *)(self + 0x2c) = func_ov224_020d02d4;
    *(Callback *)(self + 0x34) = func_ov224_020d05c4;
    *(Callback *)(self + 0x1d0) = func_ov224_020d0710;
    *(Callback *)(self + 0x1dc) = func_ov224_020d0630;
    *(Callback *)(self + 0x1e0) = func_ov224_020d09e0;
    *(Callback *)(self + 0x1e4) = func_ov224_020d0a0c;
    ...
    *(int *)(self + 0x3d8) = func_0203bdfc(*(int *)(self + 0x384), data_ov224_020d4e2c);
    *(int *)(self + 0x3dc) = func_0203bdfc(*(int *)(self + 0x384), data_ov224_020d4e38);
    *(int *)(self + 0x3d4) = func_0203bdfc(*(int *)(self + 0x384), data_ov224_020d4e48);
    *(int *)(self + 0x3e0) = func_0203bdfc(*(int *)(self + 0x384), data_ov224_020d4e54);
    *(int *)(self + 0x3e4) = func_0203bdfc(*(int *)(self + 0x384), data_ov224_020d4e60);
    *(int *)(self + 0x3fc) = func_ov107_020c9e50(func_ov107_020c9440(self, 0x23), data_ov224_020d4e6c);
    lift.x = 0;
    lift.y = -0x1852;
    lift.z = 0;
    ...
    for (i = 0; i < 4; i++) {
        ((struct Ov226 *)self)->helpers[i] = func_ov224_020d4014(self);
    }
    func_0203355c(0x14a);
}
