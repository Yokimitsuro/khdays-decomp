 ...
 * +0x78 target or 0x1100 without, reaction 0x14a fires at the +8 point in mode 0xa (0xb without
 ...
 * the tick hands over to func_ov224_020d2fbc. */
...
extern void func_ov224_020d2fbc(int *node);

void func_ov224_020d2d40(int *node)
{
    ...
    if ((*(u8 *)((char *)state + 0x75) & 1) == 0) {
        if ((state[0x1e] != 0 && state[0x17] >= 0x1320) || (state[0x1e] == 0 && state[0x17] >= 0x1100)) {
            func_ov107_020c5af8(*state, 0x14a, state[0x1e] != 0 ? 0xa : 0xb, (void *)state[2]);
            if (state[0x1e] == 0) {
                func_ov107_020c5af8(*state, 0x14a, 5, (void *)state[2]);
            }
    ...
    func_0203c634(node, *(signed char *)((char *)node + 0x20), (void *)func_ov224_020d2fbc);
}
