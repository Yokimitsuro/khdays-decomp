 ...
 * centre goes out as the mode-0 message (func_ov224_020d44c0), reaction 0x14a
...
int func_ov224_020d4518(int *node, Sphere *sphere)
{
        ...
        do {
            ...
            if ((*(unsigned char *)((char *)state + 0x64) & bit) == 0) {
                ...
                if (func_ov107_020ca918(hits[i], *state, *(int *)(*state + 0x390), state[0x16] & 0xff, &push, 0) != 0) {
                    ...
                    func_ov107_020c5af8(*state, 0x14a, 8, (void *)state[2]);
