...
extern void func_ov049_020b4304(Vec3 *src, Vec3 *out);
extern void func_ov049_020b427c(char *self, char *rig, Vec3 *src);
extern short data_0203d210[];
extern OffsetTable data_ov049_020b4b58;
extern char *data_ov049_020b4d00;

void func_ov049_020b40c4(char *self, int dt)
{
    OffsetTable table;
    Vec3 out;
    Mtx33 m;
    ...
    *(int *)(rig + 0x110) += 1;
    ...
    func_ov049_020b4304(&out, &out);
    func_ov049_020b427c(self, rig, &out);
}
