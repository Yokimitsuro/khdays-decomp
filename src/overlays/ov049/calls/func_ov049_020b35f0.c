...
extern void func_ov049_020b47e0(void);
extern void func_ov049_020b39a8(void);
extern void func_ov049_020b4600(void);

void *func_ov049_020b35f0(char *self, int msg) {
    ...
    case 0x21:
        ...
        *(int *)(self + 0x58) = 0;
        ...
        return (void *)&func_ov049_020b39a8;
    case 0x22:
        if (*(int *)(blk + 0x118) != 0) {
        ...
        return (void *)&func_ov049_020b4600;
    case 0x23:
        next = (void *)&func_ov049_020b47e0;
        break;
    }
    return next;
}
