...
extern void func_ov049_020b43a8(void);
extern int data_ov049_020b4cac;

void func_ov049_020b3f54(char *self)
{
    ...
    *(void **)(self + 0x2000 + 0x644) = NNSi_FndAllocFromDefaultExpHeap(0x30);
    ...
    func_ov022_02091298(*(void **)(self + 0x2000 + 0x644), self,
                        &data_ov049_020b4cac, cfg, 2, 10);
    *(void **)(*(char **)(self + 0x2000 + 0x644) + 0x20) = (void *)&func_ov049_020b43a8;
}
