...
u8 func_ov049_020b4518(char *self)
{
    ...
    *(u8 **)(block + 0x340) = func_ov022_020b14a4(data_ov049_020b4cc0, *(u8 *)(self + 9), 0, *(char **)(self + 0x20) + 4);
    *(u8 **)(block + 0x344) = func_ov022_020b14a4(data_ov049_020b4cd0, *(u8 *)(self + 9), 1, *(char **)(*(char **)(self + 0x2644) + 0xc) + 0x28);
    *(u8 **)(block + 0x348) = func_ov022_020b14a4(data_ov049_020b4ce4, *(u8 *)(self + 9), 2, rig + 4);
