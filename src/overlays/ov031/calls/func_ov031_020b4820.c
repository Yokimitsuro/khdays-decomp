...
extern void func_ov031_020b4b08(struct vec3 *out, void *a, int b, int c);
...
int func_ov031_020b4820(void *param_1, int param_2, int param_3, int param_4) {
    struct vec3 s;
    struct vec3 out;
    int *iVar3 = *(int **)(param_2 + 0x138);

    s = *(struct vec3 *)(param_2 + 0xcc);
    func_ov031_020b4b08(&out, param_1, param_2, param_3);
