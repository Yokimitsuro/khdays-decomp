/* Mode change for the ov031 actor, the handler installed in slot 0 of the table its
 ...
 */
extern void func_ov031_020b39d4(char *self, char *pBlock);
extern void func_ov022_020a4490(char *self, int nSound, int nVariant);
extern void func_ov031_020b3a20(char *pObj, int nTime);
extern void func_ov022_020a384c(char *self, int nState);

void func_ov031_020b3534(char *self, int nState)
{
    ...
    case 0x2e:
        if (nState != *(int *)(self + 0x6bc)) {
            func_ov031_020b39d4(self, pBlock);
        }
        break;
    ...
    case 0x30:
        ...
        if (nState == 0x2f) {
            ...
            *(int *)(self + 0x2000 + 0xc34) = 0x9000;
            ...
            func_ov031_020b3a20(self + 0xd50 + 0x2000, 0);
        } else {
            *(int *)(self + 0x2000 + 0xc2c) = 1;
            *(int *)(self + 0x2000 + 0xc34) = 0x12000;
            func_ov022_020a4490(self, 0xcb, 3);
            func_ov031_020b3a20(self + 0x38 + 0x2c00, 0x9000);
            func_ov031_020b3a20(self + 0xd50 + 0x2000, 0x9000);
        }
        break;
    }
