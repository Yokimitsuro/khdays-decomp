...
extern void func_ov031_020b3534(void);
extern void func_ov031_020b3610(void);
extern void func_ov031_020b3728(void);
extern void func_ov031_020b34b0(void);
extern void func_ov031_020b350c(void);
extern void func_ov031_020b3758(void);
extern void func_ov031_020b3830(void);
extern void func_ov031_020b4120(void);
...
void func_ov031_020b3270(struct PanelInitConfig *config)
{
    ...
    *(long long *)object = 0;
    ...
    if (config->alternateName == 0) {
        func_0202b914(*(signed char *)(object + 0x4bc), (void *)data_ov031_020b4cfc, 1,
                      config->objectType + 7);
    } else {
        func_0202b914(*(signed char *)(object + 0x4bc), (void *)data_ov031_020b4d10, 1,
                      config->objectType + 7);
    }

    *(void **)(object + 0x664 + 0x00) = (void *)&func_ov031_020b3534;
    *(void **)(object + 0x664 + 0x04) = (void *)&func_ov031_020b3610;
    *(void **)(object + 0x664 + 0x08) = (void *)&func_ov031_020b3728;
    *(void **)(object + 0x664 + 0x0c) = 0;
    *(void **)(object + 0x664 + 0x10) = 0;
    *(void **)(object + 0x664 + 0x14) = (void *)&func_ov031_020b34b0;
    *(void **)(object + 0x664 + 0x18) = (void *)&func_ov031_020b350c;
    *(void **)(object + 0x664 + 0x20) = (void *)&func_ov031_020b3758;
    *(void **)(object + 0x664 + 0x28) = 0;
    *(void **)(object + 0x664 + 0x28) = (void *)&func_ov031_020b3830;
    *(void **)(object + 0x664 + 0x24) = (void *)&func_ov031_020b4120;
...
test:
    ...
    *(int *)(object + 0x520) = bone != 0
        ? func_02016f10((void *)bone, &data_ov031_020b4c90) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x518) = bone != 0
        ? func_02016f10((void *)bone, &data_ov031_020b4ca0) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x514) = bone != 0
        ? func_02016f10((void *)bone, &data_ov031_020b4c70) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x51c) = bone != 0
        ? func_02016f10((void *)bone, &data_ov031_020b4c60) : -1;
    bone = Ov044_GetBoneBase(object);
    *(int *)(object + 0x524) = bone != 0
        ? func_02016f10((void *)bone, &data_ov031_020b4c80) : -1;
