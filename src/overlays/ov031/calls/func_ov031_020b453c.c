/* ov031 actor: drive one update pass over the group's parts.
 *
 ...
 * anything else is called through the handler table at data_ov031_020b4cd4 indexed by
 * the kind.
 *
...
extern void func_ov031_020b4694(char *pGroup, char *pPart, int nArg);
extern void func_02033d0c(int nSound, int nVariant, char *pPos, int nOwner);
extern int func_02030788(void);

extern void (*data_ov031_020b4cd4[])(char *pGroup, char *pPart, int nArg);

void func_ov031_020b453c(char *pGroup, int nArg)
{
    char *pPart;
    ...
    do {
        ...
        if (nKind != 0) {
            if (nKind != 2) {
                ...
                func_ov031_020b4694(pGroup, pPart, nArg);
