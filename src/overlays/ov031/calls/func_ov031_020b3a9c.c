...
extern void func_ov031_020b3a38(char *pNode, int nKind, int nParam);
extern void func_ov031_020b3a00(char *pNode);
extern int func_0202a818(char *pAnim, int nDelta);

void func_ov031_020b3a9c(char *self, char *pNode, int nDelta)
{
    ...
    if (*(int *)(pNode + 4) != 0) {
        if (*(int *)(pNode + 4) != 6 && *(int *)(self + 0x6bc) != 0x2e
            ...
            func_ov031_020b3a38(pNode, 2, 0xf000);
            *(int *)(pNode + 4) = 6;
        }
    ...
    case 3:
        ...
        *(int *)(pNode + 0x114) += nDelta;
        ...
        func_ov031_020b3a38(pNode, nKind, 0);
        *(int *)(pNode + 4) = 4;
        break;
