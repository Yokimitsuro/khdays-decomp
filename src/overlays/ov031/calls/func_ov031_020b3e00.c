/* Creates the ov031 actor's three sub-objects: allocates one 0x90 block from the
 ...
 *
 * Slots 0 and 1 share the handler at 020b453c; slot 2 gets 020b4630. The three
...
void func_ov031_020b3e00(char *self)
{
