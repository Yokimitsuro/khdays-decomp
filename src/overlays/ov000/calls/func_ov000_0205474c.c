...
typedef struct Ov000TileBufferState {
    u8 pad_0000[0x10];
    u8 dirtyFlags;
} Ov000TileBufferState;

extern Ov000TileBufferState *volatile data_ov000_0205ac28;
extern u16 *func_ov000_02054714(int handle, int *bufferIndex);
