/* func_ov000_02058928 -- build, hand over and tear down one transient layout pass.
...
extern void func_ov000_020582e0(void *state, int v);
extern void func_ov000_020585e8(void *state, void *work, void *list, int arg);
...
void func_ov000_02058928(int obj, int arg) {
    ...
    func_ov000_020585e8(state, work, list, arg);
