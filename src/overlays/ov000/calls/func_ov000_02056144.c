...
extern int func_ov000_020569a8(int target);
extern void func_ov000_020560d0(int self, int target);
struct f2c { unsigned char b0 : 1, b1 : 1, b2 : 1; };
int func_ov000_02056144(int param_1, int param_2) {
    ...
    if (fp->b1) {
        ...
        if (func_ov000_020569a8(param_2) == 0)
            func_ov000_020560d0(param_1, param_2);
    }
    return r;
}
