...
extern void func_ov000_02055ea4(int ctx, int section);
extern void func_ov000_02055ee4(int ctx, int section);
extern void func_ov000_02055f4c(int ctx, int section);
extern void NNSi_FndFreeFromDefaultHeap(int ptr);
void func_ov000_02056544(int ctx, int param2) {
    int *buf = (int *)func_0201ef9c(param2, 0xe);
    int a = buf[0], c = buf[2], b = buf[1];
    func_ov000_02055ea4(ctx, (int)buf + a);
    func_ov000_02055ee4(ctx, (int)buf + b);
    func_ov000_02055f4c(ctx, (int)buf + c);
    if (buf != 0) {
