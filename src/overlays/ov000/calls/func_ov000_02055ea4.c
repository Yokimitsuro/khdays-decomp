...
extern void func_ov000_0205677c(int owner, void *obj, unsigned short kind);
void func_ov000_02055ea4(int param_1, int param_2) {
    ...
    for (i = 0; i < n; i++) {
        ...
        func_ov000_0205677c(param_1, obj, *(unsigned short *)(p + 4));
        p += *(int *)p;
    }
}
