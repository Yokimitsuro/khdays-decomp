...
extern int func_ov000_02055bc4(void);
extern void func_02035fb0(int dst, int mode, int a, int b, int extra);
extern void func_02035ffc(int dst);
void func_ov000_02055c48(int param_1, int param_2, int param_3, int param_4, int param_5, int param_6) {
    int *va = (int *)param_4;
    int *vb = (int *)param_5;
    if (param_4 == 0) va = (int *)func_ov000_02055bc4();
