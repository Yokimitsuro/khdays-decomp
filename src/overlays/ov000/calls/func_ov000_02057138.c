...
extern void func_ov000_02056cb4(void *ctx, void *node, unsigned int sx, unsigned int sy, int flag);
extern void func_ov000_02056f90(DrawParams *p, void *block);

void func_ov000_02057138(void *ctx, DrawParams *p, char *block, int flag) {
    int i;
    int sx = p->sx;
    int sy = p->sy;
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (i == 0) {
            func_ov000_02056cb4(ctx, *(void **)(row + 0x34),
