...
extern void func_ov000_02056cb4(void *owner, int id, unsigned int qtyA, unsigned int qtyB, int flag);
extern void func_ov000_02056f90(TallyParams *p, void *block);

void func_ov000_02057138(void *owner, TallyParams *p, char *block, int flag) {
    int i;
    int scaleA = p->scaleA;
    int scaleB = p->scaleB;
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (i == 0) {
            func_ov000_02056cb4(owner, *(int *)(row + 0x34),
