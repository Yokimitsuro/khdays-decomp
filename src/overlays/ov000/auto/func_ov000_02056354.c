/* func_ov000_02056354 -- re-resolve which entry of this tag-tracker table the pointer is over,
 * and notify on change.
 *
 * The table asks func_ov000_02056144 for the current probe: a `struct key`
 ...
 *     probe point (func_ov000_02055f84). That entry becomes the active one
