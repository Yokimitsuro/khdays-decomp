/* Build step for the ov088 actor: clears the ready flags, requests animation set 3,
...
struct Ov088Attach {
    char pad000[0x0c];
    struct Ov088Model *model0c;
    char pad010[0x5c];
    struct Ov088Model *model6c;
};
...
struct Ov088Runtime {
    ...
    u8 slot09;
    char pad00a[0x16];
    struct Ov088SceneLink *scene20;
    char pad024[0x22d4];
    struct Ov088BuildBlock buildBlock22f8;
    struct Ov088Attach *attach2644;
};

struct Ov088Descriptor {
    char bytes[0x10];
};
...
u8 func_ov088_020badd0(struct Ov088Runtime *self)
{
    struct Ov088BuildBlock *block = &self->buildBlock22f8;
