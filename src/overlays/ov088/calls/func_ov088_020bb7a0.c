/* ov088 actor: fire the attack. Marks the two effect slots busy, asks ov022_0209fe20
...
int func_ov088_020bb7a0(char *self)
{
    Vec3 vSpawn;
    Vec3 vAim;
    Vec3 vDir;
    ...
    if (*(int *)(self + 0x4cc) >= *(int *)(pBlock + 8) && *(int *)(pBlock + 4) == 0) {
        ...
        vAim = data_ov088_020bc1e8;
        vDir = data_ov088_020bc1f4;
