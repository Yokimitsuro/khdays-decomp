...
extern void func_ov008_02054aac(Root *self, void *obj, int n, void *a, void *b, int span);
extern void func_ov008_02054858(Root *self, void *obj, void *a);
...
void *func_ov008_020543b0(Root *self, WidgetDescriptor *desc) {
    Widget *obj;
    int i;
    char *keys;
    ...
    if (obj != 0) {
        ...
        if (desc->flags & 4) {
            func_ov008_02054aac(self, obj, 2, desc->point20, desc->point30, 0x3e8);
            MI_CpuCopy8(desc->point28, obj->point24, 8);
            obj->flags |= 4;
        } else {
            func_ov008_02054858(self, obj, desc->point30);
            obj->flags &= ~4;
        }
