/* func_ov008_0206e0e4 -- Ov008_InsertListEntry (208 B, 8 relocs).
...
void func_ov008_0206e0e4(int self, int id, int kind, int p4, int p5, int p6, int p7, int p8, short *label)
{
