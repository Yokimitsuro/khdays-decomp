/* func_ov008_02083464 -- Ov008_InitFilterRows: build the five filter rows of the
...
extern int  func_ov008_02082ecc(int hSlots, int nKind, int nLabel, int nX, int nY); /* create a cell */
extern void *func_ov008_02055c84(void *pCache, int nIndex);             /* GetVarRecordByIndex */
...
extern void *func_ov008_0205489c(void *pGroup, void *pWidget);          /* Ov008_GetEntryBlock2c */
extern void func_ov008_02054858(void *pGroup, void *pWidget, void *pPos); /* Ov008_SetEntryPos */
extern void func_ov008_02054ba4(void *pGroup, void *pWidget, int bVisible); /* SetEntrySlotsVisible */
extern void func_ov008_02083654(void);                                  /* refresh the row highlight */
extern void func_ov008_0208b4ac(void);                                  /* Ov008_MergePendingUnlockBits */

void func_ov008_02083464(void)
{
    ...
    for (i = 0; i < FILTER_ROWS; i++) {
        ...
        pRows->aOffCell[i] = func_ov008_02082ecc(hSlots, 2, 0, nX, nY);
        pRows->aOnCell[i] = func_ov008_02082ecc(hSlots, 1, 0, nX + ON_CELL_DX, nY);
        pRows->aLabel[i] = func_ov008_02055c84(ctx->textLoader, i);
    }
    func_ov008_0205589c(ctx->trackerB, func_ov008_02055808(ctx->trackerB, TAG_FILTER_FRAME));
    pWidget = func_ov008_02054788(pWidgets, WIDGET_FILTER_CURSOR);
    func_ov008_02054858(pWidgets, pWidget, func_ov008_0205489c(pWidgets, pWidget));
    func_ov008_02054ba4(pWidgets, pWidget, 1);
    pRows->nSelected = 0;
    func_ov008_02083654();
    func_ov008_0208b4ac();
}
