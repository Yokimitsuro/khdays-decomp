/* func_ov008_0206369c -- Ov008_SetupMenuGrid (244 B, 10 relocs).
 ...
 * func_ov008_0205f54c(p, arg4, arg5 + 1), and advances it (func_020300f8). Then, for the two grid
 ...
 * (func_ov008_0205da10) and re-links widget 0x56 (func_ov008_02054cc4 / func_ov008_0205cbb0 on
 * the widget from func_ov008_02054788). arg2 is the widget context; takes 5 args (arg5 on the
...
void func_ov008_0206369c(Ov008Setup *p, void *arg2, int arg3, int arg4, int arg5)
{
    int i;
    int id;
    ...
    for (i = 0x55; i <= 0x56; i++) {
        func_ov008_0205da10(arg2, i, 1);
    }
    func_ov008_02054cc4(arg2, func_ov008_02054788(arg2, 0x56));
    func_ov008_0205cbb0(func_ov008_02054788(arg2, 0x56));
}
