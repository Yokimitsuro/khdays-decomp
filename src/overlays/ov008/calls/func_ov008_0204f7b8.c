/* func_ov008_0204f7b8 -- advance the menu's page-slide and reset its offset, ov008.
 * Ticks the two page animators (func_ov008_020513f0/020514cc with base+0x959c/0x95a0); once
 * the swap-active bit (bit2 of base+0x95f0) clears it is done. While still swapping, zeroes the
 * scroll offset (base+0x95f8), re-scrolls (func_ov008_02050a40(1)) and re-arms the label
 * rebuild (func_ov008_0204ee28(3)). */
