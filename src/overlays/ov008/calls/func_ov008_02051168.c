...
int func_ov008_02051168(int durationFrames, int b, int c) {
    *(int *)(*(int *)((char *)&data_ov008_02090f04 + 4) + 0x9740) = durationFrames;
    *(int *)(*(int *)((char *)&data_ov008_02090f04 + 4) + 0x9744) = b;
    *(int *)(*(int *)((char *)&data_ov008_02090f04 + 4) + 0x9748) = c;
