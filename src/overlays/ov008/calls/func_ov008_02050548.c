/*
 * func_ov008_02050548 -- x3 (ov008/...). Commit the built page: unload the source overlay and push the
...
extern void func_ov008_0204ffe4(void);
...
int func_ov008_02050548(void) {
    ...
    *(int *)(CTXV + 0x95f4) = 1;
    ...
    if (*(int *)(data_ov008_02090f04[1] + 0x962c) != 0) {
        func_ov008_02054390(data_ov008_02090f04[1] + 0x4a80,
                            *(unsigned short *)(data_ov008_02090f04[1] + 0x9610));
    }
    func_ov008_020554e4((void *)(data_ov008_02090f04[1] + 0x9500));
    func_ov008_020554e4((void *)(data_ov008_02090f04[1] + 0x954c));
    func_ov008_0204ffe4();
