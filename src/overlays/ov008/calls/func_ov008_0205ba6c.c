...
extern const u8 data_ov008_02090344[];

void func_ov008_0205ba6c(int headingMode)
{
    ...
    case 0:
        ...
        break;
    case 1:
        text = func_ov008_02055c84(menuContext->textRecords, 2);
        func_020301c8(menuContext->headingSurface, 0x8e, 2, 1, 0x821, text);
        break;
    case 2:
        text = func_ov008_02055c84(menuContext->textRecords, 0);
        func_020301c8(menuContext->headingSurface, 0x8e, 2, 1, 0x821, text);
        break;
    }
