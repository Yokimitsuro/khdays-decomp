/* func_ov008_0205fdac -- find the grid hit entry matching (page, col, row) in the list at
 * obj+0x1e7c (keys at +10, +0x10, +0x12). Returns 0 when nothing matches. */
extern int NNS_FndGetNextListObject(void *list, int obj);

int func_ov008_0205fdac(int param_1, unsigned int param_2, unsigned int param_3, unsigned int param_4) {
    int n;
