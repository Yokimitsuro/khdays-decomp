/* func_ov008_020783bc -- Ov008_DrawPageBRows: redraw page B's seven text
...
extern void  func_ov008_020782dc(void *pSurface, const u16 *pText, int nX, int nY, u8 nStyle, int bShadow); /* Ov008_DrawStyledTextWithShadow */
...
extern int   func_ov008_02078364(const u16 *pText);                       /* CountWideStringLines */
extern void  func_ov008_02078390(void *pSurface, const u16 *pText, int nX, int nY); /* Ov008_ForwardConfigured */
...
void func_ov008_020783bc(void)
{
    ...
    draw:
        ...
        switch (i) {
        case 0:
            func_ov008_020782dc(&pPage->aRow[i], func_ov025_020b0848(pPage->list), 0x58, 6, 2, 1);
            break;
        case 1:
            func_020262a0(text, TEXT_CAP, func_ov008_02055c84(pPage->textCache, 0), pPage->nRow + 1, func_ov025_020b0850(pPage->list));
            func_ov008_020782dc(&pPage->aRow[i], text, 3, 6, 2, 0);
            break;
        case 2:
            pText = func_ov025_020b0864(pPage->list);
            nY = func_ov008_02078364(pText) > 1 ? 0 : 5;
            func_ov008_02078390(&pPage->aRow[i], pText, 0, nY + 4);
            break;
        case 3:
            pText = func_ov025_020b0864(pPage->list);
            nY = func_ov008_02078364(pText) > 1 ? 0 : 5;
            func_ov008_02078390(&pPage->aRow[i], pText, 0, nY + 2);
            break;
        case 4:
            func_ov008_02078390(&pPage->aRow[i], func_ov025_020b0864(pPage->list), 5, 2);
            break;
        case 5:
            func_ov008_02078390(&pPage->aRow[i], func_ov025_020b0864(pPage->list), 5, 6);
            break;
        case 6:
            func_ov008_02078390(&pPage->aRow[i], func_ov025_020b0864(pPage->list), 5, 2);
            break;
