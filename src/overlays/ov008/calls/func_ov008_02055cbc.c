/*
 * func_ov008_02055cbc -- x3 (ov002/...). Variadic thin wrapper around Ov002_MapAndForwardEntry
...
extern int func_ov008_02055cf8(int a, unsigned b, unsigned short *c, unsigned d, void *va);

unsigned short *func_ov008_02055cbc(int a, unsigned b, unsigned short *c, unsigned d, ...) {
    va_list ap;

    va_start(ap, d);
    func_ov008_02055cf8(a, b, c, d, ap);
    return c;
}
