/* func_ov008_02069320 -- Ov008_TickTitleFade (164 B, 5 relocs).
 * Ticks the title-menu "fade" SRT tween (a 0x18-byte object at ctx+0x218). Fetches the active
 * widget once (func_ov008_02050c54). When bit 2 of ctx->flags230 is set it (re)starts the tween --
...
extern Obj *func_ov008_02050c54(void);
...
void func_ov008_02069320(Ov008FadeCtx *ctx)
{
    int  val = 0;
    Obj *w = func_ov008_02050c54();
