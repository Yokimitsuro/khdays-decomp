...
extern int func_ov008_02055000(int a);
extern void MI_CpuFill8(void *dst, int val, int size);
extern int func_ov008_02054fb0(int a, int b);
int func_ov008_0205556c(int a, int b, unsigned short c, unsigned short d, unsigned short e,
                        short f, short g, int h) {
    int obj = func_ov008_02055000(a);
    ...
    *(short *)(obj + 0xa) = f;
    *(short *)(obj + 0xc) = g;
    *(int *)(obj + 0x18) = func_ov008_02054fb0(a, b);
    *(int *)(obj + 0x14) = 1;
    return obj;
}
