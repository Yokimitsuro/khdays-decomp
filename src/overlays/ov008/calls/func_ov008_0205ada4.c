/* func_ov008_0205ada4 -- Ov008_SetupMenuBgCellsAlt (236 B, 16 relocs).
...
void func_ov008_0205ada4(void)
{
    ...
    if (isMode1) {
        resource = func_0201ef9c(func_ov008_02050f08(0x16), 0xe);
    } else {
        resource = func_0201ef9c(func_ov008_02050f40(5), 0xe);
    }
    ...
    func_ov008_02055534(ctx, func_ov008_02050f08(0x15));
