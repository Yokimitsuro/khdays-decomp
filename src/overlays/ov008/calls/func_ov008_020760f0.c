/* func_ov008_020760f0 -- build the bitmask of occupied ranks for group param_2.
...
unsigned int func_ov008_020760f0(int param_1, unsigned int param_2) {
    unsigned int mask = 0;
    unsigned short *n;
    for (n = func_ov008_020565bc(param_1 + 0x548, 0); n != 0;
         n = func_ov008_020565bc(param_1 + 0x548, (int)n)) {
        if (*n == param_2) {
