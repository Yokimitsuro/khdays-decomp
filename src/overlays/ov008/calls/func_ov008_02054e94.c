...
extern void func_ov008_0205576c(int owner, void *obj, unsigned short kind);
void func_ov008_02054e94(int param_1, int param_2) {
    ...
    for (i = 0; i < n; i++) {
        ...
        func_ov008_0205576c(param_1, obj, *(unsigned short *)(p + 4));
        p += *(int *)p;
    }
}
