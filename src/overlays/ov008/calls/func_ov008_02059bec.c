/* func_ov008_02059bec -- if menu busy/lock bit 4 of *(u16*)(obj+0x5c6) is set, return; otherwise
 * kick a state transition: mode 5 (func_ov008_0205714c), slot set (func_ov008_02050970),
...
void func_ov008_02059bec(void) {
    if ((((unsigned)*(unsigned short *)(data_ov008_02090f1c + 0x5c6) << 0x1b) >> 0x1f) != 0) {
        return;
    }
    func_ov008_0205714c(5);
    func_ov008_02050970(5, -1);
    func_02033b78(0, 1);
}
