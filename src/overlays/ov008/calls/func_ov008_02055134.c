...
extern int func_ov008_02055dcc(int target);
extern void func_ov008_020550c0(int self, int target);
struct f2c { unsigned char b0 : 1, b1 : 1, b2 : 1; };
int func_ov008_02055134(int param_1, int param_2) {
    ...
    if (fp->b1) {
        ...
        if (func_ov008_02055dcc(param_2) == 0)
            func_ov008_020550c0(param_1, param_2);
    }
    return r;
}
