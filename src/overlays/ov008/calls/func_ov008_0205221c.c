...
extern void func_ov008_02051cf0(void *ctx, void *obj, int a, int b, int flag);
extern void func_ov008_020520d4(Params *p, void *block);

void func_ov008_0205221c(void *ctx, Params *p, char *block) {
    int one = 1;
    int i;
    int a = p->a;
    ...
    for (i = 0; i < 4; i++) {
        ...
        func_ov008_02051cf0(ctx, *(void **)(row + 0x34), a, p->b, one);
    }
