...
extern int func_ov008_0205ba30(unsigned short sel);
extern int func_ov008_0205ba1c(unsigned short node);
...
int func_ov008_0206fa1c(void) {
    ...
    id = func_ov008_0205ba1c(func_ov008_0205ba30(func_020235d0(0, 9)));
    result = 0;
