...
extern u8 *func_ov008_02050cd4(void);
extern void func_ov008_0205c54c(void *state, u32 entryId, int fastTransition);
...
extern void func_ov008_0205af08(void *surface, void *text);
extern void *WM_EndKeySharing_0x0205665c(void *list, u32 entryId);
extern void func_02030278(void *surface, int x, int y, int mode,
                          void *text, int shadow);
extern void func_020300f8(void *surface);

void func_ov008_0205b4ec(u32 entryId, int fastTransition)
{
    u8 *menuContext = func_ov008_02050cd4();
    int isEntryUnlocked;
    void *textRecord;
    ...
    func_ov008_0205c54c(menuContext + 4, entryId, fastTransition);
    *(u32 *)(menuContext + 0x14ec) = entryId;
    ...
    if (isEntryUnlocked == 0) {
        textRecord = func_ov008_02055c84(menuContext + 0x14f4, 4);
        func_ov008_0205af08(menuContext + 0x145c, textRecord);
    }
    if (isEntryUnlocked == 0) {
        textRecord = func_ov008_02055c84(menuContext + 0x14f4, 4);
    ...
    if (isEntryUnlocked != 0) {
        textRecord = WM_EndKeySharing_0x0205665c(menuContext + 0x13fc, entryId);
        func_ov008_0205af08(menuContext + 0x145c, textRecord);
    }
    if (isEntryUnlocked != 0) {
        textRecord = WM_EndKeySharing_0x0205665c(menuContext + 0x13fc, entryId);
