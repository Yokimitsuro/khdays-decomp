...
void func_ov008_02050bb0(int obj, int x, int y, int cells, int rows) {
    int i;
    int dst;

    dst = func_ov008_0204fd04(obj, 0);
    i = 0;
    if (rows <= 0) {
        return;
    }
    do {
        int addr = dst + func_ov008_0204fd48(x, y + i,
                       *(int *)((char *)data_ov008_02090f04[1] + 0x95d0), 0x20) * 2;
