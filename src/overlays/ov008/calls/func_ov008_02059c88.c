 ...
 *   - scene 0xe: a fixed archive (data_ov008_02090264);
...
extern char  data_ov008_02090264[];

void func_ov008_02059c88(u8 *panel, int resBase, int subId, int sceneId, u32 charFlags, int slot)
{
    u32 descriptor;
    int variant;
    ...
    case 0x13:
        ...
        break;
    case 0xe:
        *(void **)(panel + 0x160) = func_0201ef9c(data_ov008_02090264, panel[2] + 7);
