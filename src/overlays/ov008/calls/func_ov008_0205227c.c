...
extern void func_ov008_02051df8(void *owner, int id, unsigned int qtyA, unsigned int qtyB, int flag);
extern void func_ov008_020520d4(TallyParams *p, void *block);

void func_ov008_0205227c(void *owner, TallyParams *p, char *block, int flag) {
    int i;
    int scaleA = p->scaleA;
    int scaleB = p->scaleB;
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (i == 0) {
            func_ov008_02051df8(owner, *(int *)(row + 0x34),
