/* func_ov008_02069954 -- x3 (ov008/...). Does the cursor at tag `tag` overlap any of the first
...
int func_ov008_02069954(int param1, int tag, int a2, int a3, ...) {
    int dx;
    int i;
    int ctx;
    int *p3;
    ...
    p3 = func_ov008_02054820(ctx, func_ov008_02054788(ctx, tag + 1));
    i = 0;
    dx = *(int *)&a2;
