/* func_ov008_020669e0 -- confirm the current grid selection on pen-up.
...
extern void func_ov008_0206311c(int obj, int key);
extern void func_02033b78(int a, int b);

void func_ov008_020669e0(int param_1) {
    ...
    func_ov008_0206311c(param_1, *(int *)(param_1 + 0x70));
    func_02033b78(0, 2);
}
