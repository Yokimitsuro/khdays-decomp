/* func_ov008_0206a474 -- Ov008_LoadMenuBgWithAltChars (240 B, 13 relocs).
...
void func_ov008_0206a474(void)
{
    ...
    resource = func_0201ef9c(func_ov008_02050f08(3), 0xe);
    ...
    altHandle = func_ov008_02050f40(8);
    if (altHandle == 0) {
        return;
    }
