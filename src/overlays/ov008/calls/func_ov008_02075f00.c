/* func_ov008_02075f00 -- draw one mission-list row's caption and advance the running width.
 ...
 * param_2 * 0x10 + 3, and its measured width (func_ov008_02074b10) is added to the total at +0x14c.
 *
