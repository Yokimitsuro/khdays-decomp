/* func_ov008_020744d4 -- push (param_3,param_4) to the active widget for tag param_2, then mark it
...
void func_ov008_020744d4(int param_1, unsigned int param_2, unsigned short param_3, unsigned short param_4) {
