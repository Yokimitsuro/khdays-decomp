/* func_ov008_0206b814 -- Ov008_TickPageBTransition (632 B, 23 relocs).
 ...
 *
 * func_ov008_0205490c is 3-arg (owner, &point, 0): the ROM's r3 at the call still holds the
...
extern Ov008PageBCtx *func_ov008_02050cec(void);
...
extern void  func_ov008_02050ee0(int a);
extern int   func_ov008_02050c64(void);
extern void  func_ov008_0205490c(int a, Point *pt, int b);
extern int   func_ov008_02054788(int ctx, int id);
extern int   func_ov008_0205489c(int ctx, int entry);
extern int   FX_Inv(int num, int den);
extern void  func_ov008_020548bc(int ctx, int entry, Point *pt);
extern void  func_ov008_020543a0(int ctx, int a);
extern void *func_ov008_02050c7c(int id);
...
int func_ov008_0206b814(void)
{
    u32   cpctx[7];
    struct { Point pt; int sample; } v;
    Ov008PageBCtx *ctx = func_ov008_02050cec();
    ...
    if (ctx->field34.bit2 == 0) {
        ...
        v.pt.y = 0;
        v.pt.x = -v.sample;
        owner = func_ov008_02050c64();
        func_ov008_0205490c(owner, &v.pt, 0);
        e2c = func_ov008_02054788(owner, 0x2c);
        e2b = func_ov008_02054788(owner, 0x2b);
        iVar9 = 0xf0000 - *(int *)(func_ov008_0205489c(owner, e2c) + 4);
        inv = FX_Inv((int)(((long long)iVar9 * v.sample + 0x800) >> 0xc), 0xc0000);
        v.pt.x = -v.sample;
        v.pt.y = inv;
        func_ov008_020548bc(owner, e2c, &v.pt);
        v.pt.y = iVar9 - inv;
        func_ov008_020548bc(owner, e2b, &v.pt);
        inv = FX_Inv(v.sample, 0xc0000);
        v.pt.x = v.pt.x + (int)(((long long)inv * -0x30000 + 0x800) >> 0xc);
        v.pt.y = 0;
        func_ov008_020548bc(owner, func_ov008_02054788(owner, 2), &v.pt);
        func_ov008_020543a0(owner, 0);
    } else {
        func_ov008_02050ee0(0);
    }
    if (ctx->field04 != 0) {
        void *p;
        ctx->field3c = ctx->field40;
        p = func_ov008_02050c7c(0x1a);
