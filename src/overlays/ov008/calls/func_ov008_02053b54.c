/* func_ov008_02053b54 -- build, hand over and tear down one transient layout pass.
...
extern void func_ov008_020533e4(void *state, int v);
extern void func_ov008_020536ec(void *state, void *work, void *list, int arg);
...
void func_ov008_02053b54(int obj, int arg) {
    ...
    func_ov008_020533e4(state, 0);
    func_ov008_020536ec(state, work, list, arg);
