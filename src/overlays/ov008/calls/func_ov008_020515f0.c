/* func_ov008_020515f0 -- forward an input event to a pair of ov008 menu handler slots.
...
int func_ov008_020515f0(int param_1, int param_2) {
    int r = 0;
    void *m1 = *(void **)(data_ov008_0209009c[data_ov008_02090f0c[0]].obj + 0x1c);
    if (param_1 != 0) {
        r = func_ov008_020512e0(m1, param_1);
    }
    if (r == 0) {
        void *m2 = *(void **)(data_ov008_02090064[data_ov008_02090f0c[1]].obj + 0x18);
        if (param_2 != 0) {
