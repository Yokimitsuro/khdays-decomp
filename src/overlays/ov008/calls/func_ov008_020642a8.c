/* func_ov008_020642a8 -- Ov008_CanFillNodeGap: inspect the tracked node under
...
extern Ov008Message15Record *func_ov008_02063cac(Ov008MenuContext *pCtx, Ov008TrackedNode *pNode);
...
found:
    ...
    case ENTRY_KIND_SINGLE:
        pSpare = func_ov008_02063cac(pCtx, pNode);
        break;
    case ENTRY_KIND_PAIR:
        pSpare = func_ov008_02063e58(pCtx, pNode, pAnchor);
        break;
    default:
        pSpare = func_ov008_020641cc(pCtx, pAnchor);
        break;
    }
    return pSpare != 0;
}
