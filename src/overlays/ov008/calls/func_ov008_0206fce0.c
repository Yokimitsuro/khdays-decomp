 ...
 * each wrapped into [0,11] by `(cell + 12) % 12`, to the widget via func_ov008_0205b720 and
...
extern void func_ov008_0205b720(int slot);
extern unsigned short func_ov008_0205b708(void);

unsigned int func_ov008_0206fce0(int param_1, int param_2) {
    int i = 0;
    int cell = *(unsigned char *)(param_1 + 0x54) + param_2;
    do {
        int x = cell + 0xc;
        cell = x % 12;
        func_ov008_0205b720(cell & 0xffff);
