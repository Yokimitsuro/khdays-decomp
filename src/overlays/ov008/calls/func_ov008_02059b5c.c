/* func_ov008_02059b5c -- if menu busy/lock bit 4 of *(u16*)(obj+0x5c6) is set, return; otherwise
 * kick a state transition: mode 3 (func_ov008_0205714c), slot set (func_ov008_02050970),
