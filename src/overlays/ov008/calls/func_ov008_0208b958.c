/* func_ov008_0208b958 -- write the pending save block to backup memory, 0x80 bytes at a time.
 ...
 * (data_ov008_02090fb4+4) and in the context's own slot (+0x2cc); a clean run leaves that slot 0.
...
void func_ov008_0208b958(int ctx) {
    int src;
    int len;
    int dst;
    int chunk;
