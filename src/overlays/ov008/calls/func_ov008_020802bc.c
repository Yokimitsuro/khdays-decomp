/* func_ov008_020802bc -- scene constructor.
 *
 ...
 * function (func_ov008_02080770).
 *
 * Resource paths confirmed by reading RAM at runtime.
 *
 * PROVENANCE: byte-identical twin of func_ov006_0205454c -- same code, this overlay's own
...
extern void func_ov008_0205546c(int *dst, struct S5 *src);
...
extern void func_ov008_02080770(void);

#define OBJ ((char *)data_ov008_02090fa4)

void *func_ov008_020802bc(int arg) {
    unsigned int i;
    int *base;
    long long anim;
    struct S5 param;
    ...
    *(int *)OBJ = func_02024ee8((int)&data_ov008_02090d68, 0xe);
    *(int *)(OBJ + 4) = func_02024ee8((int)&data_ov008_02090d78, 0xe);

    param = data_ov008_0208fd58;
    func_ov008_0205546c((int *)(OBJ + 8), &param);
    func_0201e374(-0x10);
    func_0201e3cc(-0x10);
    ...
    *(signed char *)((char *)base + 0x950c) = -1;
    ...
    func_ov008_0207f4a4(*(int *)(OBJ + 0x94f4));
    func_ov008_0207f18c(*(int *)(OBJ + 0x94f4));
    func_ov008_0207f894(*(int *)(OBJ + 0x94f4));
    return (void *)func_ov008_02080770;
}
