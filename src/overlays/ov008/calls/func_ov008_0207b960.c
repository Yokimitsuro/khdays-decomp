...
extern int  func_ov008_0207928c(int icon);
extern int  data_ov008_02090f24;
#define OBJ (*(char **)&data_ov008_02090f24)
...
void func_ov008_0207b960(int row, struct Ov006RowInfo *out) {
    int off = row * 6;
    MI_CpuFill8(out, 0, 8);
    ...
    out->sprite = (signed char)func_ov008_0207928c(*(signed char *)(OBJ + off + 0x4ae));
    out->pad6 = 0;
}
