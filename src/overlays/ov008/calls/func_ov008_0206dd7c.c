/* func_ov008_0206dd7c -- Ov008_DrawStatusPage (712 B, 36 relocs).
 ...
 * setter func_ov008_0206eb64 (ids 1, 9, 0xe, 0x10, 0x14, 0x12, 0x13, 0xf) sourced from the global
 ...
 *
 * func_ov008_0206eb64 is variadic (id, flag, ...): the callers pass zero, one, or two value
...
extern void  func_ov008_0206f2a4(void *ids);
extern void  func_020300f8(int dctx);

void func_ov008_0206dd7c(int ctx)
{
    int eq3, counter;
    int uVar9 = 0;
    int local_28 = 0;
    ...
    rec = func_ov008_02055c84(ctx + 0x58, 4);
    func_02030278(ctx + 0x118, 5, 7, 0xf2, (int)rec, 1);
    rec = func_ov008_02055c84(ctx + 0x58, 7);
    func_02030278(ctx + 0x118, 0x59, 7, 0xf2, (int)rec, 1);
    rec = func_ov008_02055c84(ctx + 0x58, 5);
    func_02030278(ctx + 0x118, 5, 0x17, 0xf2, (int)rec, 1);

    rec = func_ov008_02055c84(ctx + 0x58, 8);
    eq3 = func_02024e5c() == 3;
    if (eq3)
        *(int *)(ctx + 0x138) = b;
    ...
    rec = func_ov008_02055c84(ctx + 0x58, 6);
    func_02030278(ctx + 0x118, 5, 0x27, 0xf2, (int)rec, 1);
    rec = func_ov008_02055c84(ctx + 0x58, 0xc);
    func_02030278(ctx + 0x118, 5, 0x57, 0xf2, (int)rec, 1);

    func_ov008_0206eb64(1, 0);
    func_ov008_0206eb64(9, 0, 0x64);
    func_ov008_0206eb64(0xe, 0, *(int *)(data_0204be18 + 4));
    func_ov008_0206eb64(0x10, 0, 0);
    func_ov008_0206eb64(0x14, 0, 6);
    func_ov008_0206eb64(0x12, 0, *(u16 *)(data_0204be18 + 0x196a),
                        *(u16 *)(data_0204be18 + 0x1968));
    if (func_020235d0(0x44e, 3) != 0)
        func_ov008_0206eb64(0x13, 0, func_020235d0(0x44e, 3) + 0xe);
    ...
    func_ov008_0206eb64(0xf, 0, uVar9);
    func_ov008_0206f2a4(data_0204be18 + 0xee0);
