/* func_ov008_02086da4 -- Ov008_SetupMenuScreen (216 B, 8 relocs).
 * Initializes a menu screen from the shared panel context (*data_ov008_02090fac): sets up the
 ...
 * trailing fields and disables widget id 6 (ctx+0x7530), then func_ov008_02083360.
...
void func_ov008_02086da4(void)
{
    ...
    *(int *)(ctx + 0xc31c) = 0;
    *(int *)(ctx + 0xc314) = 0;
    func_ov008_02054ba4(w, func_ov008_02054788(w, 6), 0);
    func_ov008_02083360();
}
