 ...
 * (RenderNode) takes 1 arg, func_ov008_02059e0c (SubmitObjectGfx) takes 1 arg. The two
...
extern void func_ov008_0205a030(int panel, int out, int scrollBase, int frame);
extern void MTX_ScaleApply43(int *dst, u32 *src, int sx, int sy, int sz);
extern void func_ov008_02059e88(void *panel, void *mtx);
extern void func_ov008_02059e0c(u8 *panel);

void func_ov008_0205a684(int obj)
{
    int frame;
    int scrollBase;
    ...
    if (*(int *)(obj + 0x140) != 0) {
        ...
        func_ov008_0205a030(obj + 0x1b8, obj + 0x480, scrollBase, frame);
        if (*(int *)(obj + 0x524) == 0xd) {
            MTX_ScaleApply43((int *)(obj + 0x150), (u32 *)(obj + 0x150), 0x64000, 0x64000, 0x64000);
        }
        func_ov008_02059e88((void *)(obj + 0x1b8), (void *)(obj + 0x150));
        func_ov008_02059e0c((u8 *)(obj + 0x1b8));
    }
    if (*(int *)(obj + 0x144) != 0) {
        frame = func_0202aee0((u16 *)(obj + 0x38), 0);
        scrollBase = *(int *)(obj + 0x1b0);
        func_ov008_0205a030(obj + 0x31c, obj + 0x480, scrollBase, frame);
        if (*(int *)(obj + 0x524) == 0xd) {
            MTX_ScaleApply43((int *)(obj + 0x180), (u32 *)(obj + 0x180), 0x64000, 0x64000, 0x64000);
        }
        func_ov008_02059e88((void *)(obj + 0x31c), (void *)(obj + 0x180));
        func_ov008_02059e0c((u8 *)(obj + 0x31c));
    }
}
