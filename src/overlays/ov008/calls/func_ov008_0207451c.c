/* func_ov008_0207451c -- push (param_3,param_4) to the widget bound to tag param_2, then fire its
...
void func_ov008_0207451c(int param_1, unsigned int param_2, unsigned short param_3, unsigned short param_4) {
