/* func_ov008_0205f54c -- Ov008_DrawMenuEntry (124 B, 4 relocs).
 * Draws menu entry arg1 (with value arg2) onto the surface at arg0+0x124. Copies the 6-entry text
 * table data_ov008_0208f180 to a local, opens the surface (func_02030158), builds a cell from the
 * table's arg1-th id via func_ov008_02055cbc(arg0+0x28c, tbl[arg1], work, 0x80, arg2) into a 0x100
...
extern int  func_ov008_02055cbc(void *a, int b, void *work, int n, int e);
extern void func_02030278(void *surface, int a, int b, int c, int d, int e);

void func_ov008_0205f54c(void *arg0, int arg1, int arg2)
{
    char *ctx = (char *)arg0;
    ...
    func_02030278(ctx + 0x124, 0, 0, 0xf3,
                  func_ov008_02055cbc(ctx + 0x28c, tbl.entries[arg1], work, 0x80, arg2), 1);
}
