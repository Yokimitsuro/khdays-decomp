/* NONMATCHING: frame-layout tie (class of func_ov008_0204d6a8) -- the ROM homes all 4 args with
 * push {r0,r1,r2,r3} and passes &param_4 into that block; our mwcc reserves a separate slot + str.
 * Create+place mission cell object. */
/* func_ov008_02082ecc -- create and place a mission cell object, ov008.
 * Instantiates a cell in slot param_3 from resource param_2 (WM_EndKeySharing_0x02032444),
 * makes it visible (func_0203281c), commits it (func_020326cc), sets frame 0 (func_02032710)
 * and applies the transform passed in param_4 via func_0203257c. Returns the new object. */
