int func_ov008_0208e1b4(int code) {
    switch (code) {
    ...
    case 0xcd: return 0xdf;
    case 0xce: return 0xdf;
    case 0xd9: return 0xe0;
    case 0xd8: return 0xe0;
    case 0xcf: return 0xcd;
    case 0xd0: return 0xcd;
    case 0xdb: return 0xce;
    case 0xda: return 0xce;
