/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov048_020b4a34).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov048_0x020b3220 but tail-calls
...
extern int func_ov048_020b4a34;

void SNDi_UnlockMutex_ov048_0x020b3220(void) {
    srand_0x0208875c(&func_ov048_020b4a34);
}
