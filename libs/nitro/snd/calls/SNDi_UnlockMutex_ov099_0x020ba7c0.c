/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov099_020bb058).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov099_0x020ba7c0 but tail-calls
...
extern int func_ov099_020bb058;

void SNDi_UnlockMutex_ov099_0x020ba7c0(void) {
    srand_0x0208875c(&func_ov099_020bb058);
}
