/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov097_020bc194).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov097_0x020ba7c0 but tail-calls
...
extern int func_ov097_020bc194;

void SNDi_UnlockMutex_ov097_0x020ba7c0(void) {
    srand_0x0208875c(&func_ov097_020bc194);
}
