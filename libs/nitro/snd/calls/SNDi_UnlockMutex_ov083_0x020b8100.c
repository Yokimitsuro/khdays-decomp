/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov083_020b9944).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov083_0x020b8100 but tail-calls
...
void SNDi_UnlockMutex_ov083_0x020b8100(void) {
    srand_0x0208875c(&func_ov083_020b9944);
}
