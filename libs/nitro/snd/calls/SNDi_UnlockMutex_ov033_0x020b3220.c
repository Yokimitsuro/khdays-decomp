/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov033_020b4a90).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov033_0x020b3220 but tail-calls
...
void SNDi_UnlockMutex_ov033_0x020b3220(void) {
    srand_0x0208875c(&func_ov033_020b4a90);
}
