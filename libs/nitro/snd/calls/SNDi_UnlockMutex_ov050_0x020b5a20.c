/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov050_020b742c).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov050_0x020b5a20 but tail-calls
...
void SNDi_UnlockMutex_ov050_0x020b5a20(void) {
    srand_0x0208875c(&func_ov050_020b742c);
}
