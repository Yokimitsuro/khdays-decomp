/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov096_020bbf8c).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov096_0x020ba7c0 but tail-calls
...
void SNDi_UnlockMutex_ov096_0x020ba7c0(void) {
    srand_0x0208875c(&func_ov096_020bbf8c);
}
