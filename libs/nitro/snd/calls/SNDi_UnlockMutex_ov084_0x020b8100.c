/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov084_020b9920).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov084_0x020b8100 but tail-calls
...
extern int func_ov084_020b9920;

void SNDi_UnlockMutex_ov084_0x020b8100(void) {
    srand_0x0208875c(&func_ov084_020b9920);
}
