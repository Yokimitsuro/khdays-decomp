/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov047_020b41f4).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov047_0x020b3220 but tail-calls
...
extern int func_ov047_020b41f4;

void SNDi_UnlockMutex_ov047_0x020b3220(void) {
    srand_0x0208875c(&func_ov047_020b41f4);
}
