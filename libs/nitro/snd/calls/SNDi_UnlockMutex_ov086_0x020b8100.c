/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov086_020b9914).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov086_0x020b8100 but tail-calls
...
extern int func_ov086_020b9914;

void SNDi_UnlockMutex_ov086_0x020b8100(void) {
    srand_0x0208875c(&func_ov086_020b9914);
}
