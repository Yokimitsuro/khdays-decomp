/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov045_020b4a64).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov045_0x020b3220 but tail-calls
...
void SNDi_UnlockMutex_ov045_0x020b3220(void) {
    srand_0x0208875c(&func_ov045_020b4a64);
}
