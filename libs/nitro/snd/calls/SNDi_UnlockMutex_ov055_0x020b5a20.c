/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov055_020b75f0).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov055_0x020b5a20 but tail-calls
...
void SNDi_UnlockMutex_ov055_0x020b5a20(void) {
    srand_0x0208875c(&func_ov055_020b75f0);
}
