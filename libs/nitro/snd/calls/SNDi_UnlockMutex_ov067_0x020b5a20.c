/* Tiny cross-overlay veneer: tail-call srand_0x0208875c(&func_ov067_020b7234).
 ...
 * pooled symbols.
 *
 * NOTE: the symbol name is almost certainly misattributed. This is called SNDi_UnlockMutex_ov067_0x020b5a20 but tail-calls
...
extern int func_ov067_020b7234;

void SNDi_UnlockMutex_ov067_0x020b5a20(void) {
    srand_0x0208875c(&func_ov067_020b7234);
}
