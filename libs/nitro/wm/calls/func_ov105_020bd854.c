...
/* func_ov105_020bd854 -- WM_GetDispersionBeaconPeriod: a beacon period of 200..219 ms
 * dispersed per console from the MAC address bytes and the vblank counter.
 */
u16 func_ov105_020bd854(void)
{
    u8 mac[6];
    u16 ret;
    s32 i;
