...
/* func_ov105_020bd0a0 -- WMi_CheckStateEx: succeed when the ARM7 WM state (re-read
 * from the shared status block) equals one of the `paramNum` states listed after it.
 */
WMErrCode func_ov105_020bd0a0(s32 paramNum, ...)
{
    WMErrCode result;
    u16 now;
    u32 temp;
