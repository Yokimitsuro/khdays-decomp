...
/* func_ov105_020be3f0 -- WM_SetEntry: allow or refuse new child connections on a
 * parent (SET_ENTRY); PARENT / MP_PARENT only.
 */
WMErrCode func_ov105_020be3f0(WMCallbackFunc callback, BOOL enabled)
{
    WMErrCode result;

    result = func_ov105_020bd0a0(2, WM_STATE_PARENT, WM_STATE_MP_PARENT);
    WM_CHECK_RESULT(result);

    func_ov105_020bcea0(WM_APIID_SET_ENTRY, callback);

    result = func_ov105_020bcf10(WM_APIID_SET_ENTRY, 1, (u32)enabled);
    WM_CHECK_RESULT(result);
