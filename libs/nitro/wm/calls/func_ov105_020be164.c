...
/* func_ov105_020be164 -- WM_SetMPDataToPortEx: queue `sendDataSize` bytes for the next
 ...
 */
WMErrCode func_ov105_020be164(WMCallbackFunc callback, void *arg, const u16 *sendData, u16 sendDataSize, u16 destBitmap, u16 port, u16 prio)
{
    WMErrCode result;
    BOOL isParent;
    ...
    result = func_ov105_020bd0a0(2, WM_STATE_MP_PARENT, WM_STATE_MP_CHILD);
    ...
    result = func_ov105_020bcf10(WM_APIID_SET_MP_DATA, 7,
                                 (u32)sendData,
                                 (u32)sendDataSize,
