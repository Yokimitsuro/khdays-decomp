...
extern WMErrCode func_ov105_020bd058(void);       /* WMi_CheckIdle */
...
extern int func_ov105_020bd674(void);             /* WM_GetMPSendBufferSize */
extern int func_ov105_020bd6e0(void);             /* WM_GetMPReceiveBufferSize */
...
extern WMErrCode func_ov105_020bdf8c(WMCallbackFunc callback, u16 *recvBuf, u16 recvBufSize, u16 *sendBuf, u16 sendBufSize, WMMPTmpParam *tmpParam);   /* WMi_StartMP */

/* func_ov105_020be0fc -- WM_StartMP: start MP with a fixed poll frequency: the temporary
 * parameters carry `mpFreq` as both the minimum and the current frequency.
 */
WMErrCode func_ov105_020be0fc(WMCallbackFunc callback, u16 *recvBuf, u16 recvBufSize, u16 *sendBuf, u16 sendBufSize, u16 mpFreq)
{
    WMMPTmpParam tmpParam;
    ...
    return func_ov105_020bdf8c(callback, recvBuf, recvBufSize, sendBuf, sendBufSize, &tmpParam);
}
