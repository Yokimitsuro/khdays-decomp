...
/* func_ov105_020be378 -- WM_MeasureChannel: ask the ARM7 to measure the occupancy of
 * `channel` for `measureTime` ms (MEASURE_CHANNEL) with the given CCA mode and energy
 * detection threshold; IDLE only.
 */
WMErrCode func_ov105_020be378(WMCallbackFunc callback, u16 ccaMode, u16 edThreshold, u16 channel, u16 measureTime)
{
    WMErrCode result;
    ...
    func_ov105_020bcea0(WM_APIID_MEASURE_CHANNEL, callback);
