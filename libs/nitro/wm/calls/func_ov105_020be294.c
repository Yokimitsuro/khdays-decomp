...
/* func_ov105_020be294 -- WM_EndMP: stop the MP protocol (END_MP) from MP_PARENT /
 * MP_CHILD; fails when MP is not running.
 */
WMErrCode func_ov105_020be294(WMCallbackFunc callback)
{
    WMErrCode result;
    ...
    func_ov105_020bcea0(WM_APIID_END_MP, callback);

    result = func_ov105_020bcf10(WM_APIID_END_MP, 0);
    WM_CHECK_RESULT(result);
