...
/* func_ov105_020bceb8 -- WmGetCommandBuffer4Arm7: take the next free 256-byte command
 * buffer from the message queue; a buffer the ARM7 has not accepted yet (request bit
 * clear) is jammed back at the head and the call fails.
 */
u32 *func_ov105_020bceb8(void)
{
    u32 *tmpAddr;
