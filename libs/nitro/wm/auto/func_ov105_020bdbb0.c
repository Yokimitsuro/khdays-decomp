...
/* func_ov105_020bdbb0 -- WmCheckParentParameter: sanity-check a parent parameter block:
 * the user game info fits (<= 112 bytes), the beacon period is 10..1000 ms and the
 * channel 1..14. The release build only reports the verdict.
 */
BOOL func_ov105_020bdbb0(const WMParentParam *param)
{
