/* NitroSDK FX_SinCosTable_: 0x4000 bytes of Q12 sine/cosine pairs.
 *
 * One table of 4096 {sin, cos} pairs covering a full turn, so entry i holds
 * sin and cos of 2*pi*i/4096 rounded to 1.19.12 fixed point. FX_SinIdx and
 * FX_CosIdx reach it as FX_SinCosTable_[((u16)idx >> 4) << 1], which is why the
 * table needs exactly 4096 entries for a 16-bit angle.
 *
 * The ROM has no single symbol for it. Five interior labels survive at
 * 0x0203d210, 0x0203da10, 0x0203e110, 0x0203e210 and 0x02040210, because
 * different callers index the table from different quadrants: the first three
 * cover the first 90 degrees, the fourth runs 90 to 270, the last closes the
 * turn. They are contiguous, 0x0203d210 through 0x02041210, and are kept as
 * separate arrays here so the referencing code still resolves.
 *
 * Every value is the rounded formula above, verified against the delinked
 * image. The one exception is the pair at 0x0204035c: dsd read it as a pointer
 * because sin=-4063 and cos=520 pack into the word 0x0208f041, which lands in
 * overlay 8. It is data, not a relocation, and config/arm9/relocs.txt no longer
 * claims otherwise.
 */
...
const FxSinCos data_0203d210[512] = {
...
const FxSinCos data_0203da10[448] = {
...
const FxSinCos data_0203e110[64] = {
...
const FxSinCos data_0203e210[2048] = {
...
const FxSinCos data_02040210[1024] = {
    {  -4096,      0 }, {  -4096,      6 }, {  -4096,     13 }, {  -4096,     19 },
    {  -4096,     25 }, {  -4096,     31 }, {  -4096,     38 }, {  -4096,     44 },
    {  -4096,     50 }, {  -4096,     57 }, {  -4096,     63 }, {  -4095,     69 },
    {  -4095,     75 }, {  -4095,     82 }, {  -4095,     88 }, {  -4095,     94 },
