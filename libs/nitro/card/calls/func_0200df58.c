...
/* card_common.c: cardi_common and cardi_arg are defined here ATTRIBUTE_ALIGN(32). */
extern CARDiCommon data_020464e0 __attribute__((aligned(32)));   /* cardi_common */
#define cardi_common data_020464e0
extern CARDiCommandArg data_02046480 __attribute__((aligned(32)));   /* cardi_arg */
#define cardi_arg data_02046480
/* cardi_thread_stack[0x400]: the pool holds its end (cardi_thread_stack + sizeof). */
extern u8 data_02046b00[];
#define cardi_thread_stack_end data_02046b00
...
extern void PXI_SetFifoRecvCallback(int fifotag, void (*callback)(int, u32, BOOL));
...
/* func_0200df58 -- NitroSDK card_common.c: CARDi_InitCommon. */
void func_0200df58 (void)
{
