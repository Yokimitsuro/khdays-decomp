...
u32 func_020021d0(void);
u32 func_02002204(void);
struct OSMutex {
    OSThreadQueue queue;
    OSThread * thread;
    s32 count;
...
extern void func_02001a94(OSThread * thread);
...
extern u32 func_020021d0 (void);
extern u32 func_02002204 (void);
...
/* func_02001ea0 -- NitroSDK os_thread.c: OSi_ExitThread_Destroy. */
