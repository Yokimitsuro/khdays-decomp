...
extern void func_02001e68(void * arg);
extern void func_02001e68 (void * arg);
...
/* func_02001e0c -- NitroSDK os_thread.c: OSi_ExitThread_ArgSpecified. */
void func_02001e0c (OSThread * thread, void * arg)
{
    if (OSi_StackForDestructor) {
        OS_InitContext(&thread->context, (u32)func_02001e68, (u32)OSi_StackForDestructor);
