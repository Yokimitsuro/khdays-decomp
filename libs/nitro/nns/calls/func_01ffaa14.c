...
void func_01ffaa14(MtxFx33 *pRot, fx32 Frame, const u32 *pData,
    ...
    if (info & 0x40000000) {
        ...
        if (frame & 3) {
            ...
            if (frame & 1) {
                ...
                doCross |= func_01ffae5c(pRot, pArrayRot3, pArrayRot5, p[idx]);
                doCross |= func_01ffae5c(&tmp, pArrayRot3, pArrayRot5, p[idx_sub]);
...
ROT_INTERP_2:
    {
        ...
        BOOL doCross = 0;
        doCross |= func_01ffae5c(pRot, pArrayRot3, pArrayRot5, p[idx]);
        doCross |= func_01ffae5c(&tmp, pArrayRot3, pArrayRot5, p[idx + 1]);
