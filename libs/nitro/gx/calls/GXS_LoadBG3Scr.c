/* NitroSDK GX_LoadBG0Scr -- load BG3 screen data for the sub engine.
 *
...
void GXS_LoadBG3Scr(const void *src, unsigned int offset, unsigned int size) {
