...
/* func_0200cbe4 -- NitroSDK pm.c: PMi_CommonCallback, the PXI reply handler: file register reads into their
 * buffers, raise the sync / sleep-end flags, then unlock and call back. */
void func_0200cbe4 (PXIFifoTag tag, u32 data, BOOL err)
{
