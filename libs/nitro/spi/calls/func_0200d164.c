...
/* func_0200d164 -- NitroSDK pm.c: PM_GoSleepMode: run the pre-sleep callbacks, mask every interrupt but
...
void func_0200d164 (PMWakeUpTrigger trigger, PMLogic logic, u16 keyPattern)
{
    BOOL prepIrq;
