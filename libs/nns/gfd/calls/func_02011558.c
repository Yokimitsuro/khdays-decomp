...
extern u16 func_02011358 (const NNSGfdVramTransferTaskQueue * pQueue, u16 idx);
extern BOOL func_02011390 (const NNSGfdVramTransferTaskQueue * pQueue);

/* func_02011558 -- NitroSystem gfd_VramTransferManager.c: NNSi_GfdPopVramTransferTaskQueue. */
BOOL func_02011558 (NNSGfdVramTransferTaskQueue * pQueue)
{

    if ( !func_02011390(pQueue)) {
        pQueue->idxFront = func_02011358(pQueue, pQueue->idxFront);
        pQueue->numTasks--;
        return TRUE;
    } else {
        return FALSE;
