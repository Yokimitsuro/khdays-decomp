...
extern LoadCommand * func_0201d358(void);
extern void func_0201d398(LoadCommand * command);
extern LoadCommand * func_0201d358 (void);
extern void func_0201d398 (LoadCommand * command);
...
/* func_0201d460 -- NitroSystem sndarc_stream.c: StrmCallback. */
void func_0201d460 (NNSSndStrmCallbackStatus status, int numChannels, void * buffer[], u32 len, NNSSndStrmFormat, void * arg)
{
    ...
    if (player->commandCount >= BLOCK_NUM - 2) {
        command = NULL;
        while ((command = (LoadCommand *)NNS_FndGetNextListObject(&data_0204b140.commandList, command)) != NULL) {
        ...
        NNS_FndRemoveListObject(&data_0204b140.commandList, command);
        player->commandCount--;
        func_0201d398(command);
    }

    command = func_0201d358();
