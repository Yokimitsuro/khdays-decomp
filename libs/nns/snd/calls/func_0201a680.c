...
/* func_0201a680 -- NitroSystem player.c: InitPlayer. */
void func_0201a680 (NNSSndSeqPlayer * seqPlayer)
{
    ...
    func_0201e12c(&seqPlayer->fader);
    func_0201e144(&seqPlayer->fader, 127 << FADER_SHIFT, 1);
}
