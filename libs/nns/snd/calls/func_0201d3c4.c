...
void func_0201aa18(NNSSndStrm * stream);
...
/* func_0201d3c4 -- NitroSystem sndarc_stream.c: DisposeCallback. */
void func_0201d3c4 (void * mem, u32, u32 data1, u32)
{
