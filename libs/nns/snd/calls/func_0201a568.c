...
extern void func_0201a680(NNSSndSeqPlayer * seqPlayer);
extern void func_0201a680 (NNSSndSeqPlayer * seqPlayer);

/* func_0201a568 -- NitroSystem player.c: NNSi_SndPlayerStartSeq. */
void func_0201a568 (NNSSndSeqPlayer * seqPlayer, const void * seqDataBase, u32 seqDataOffset, const SNDBankData * bank)
{
    NNSSndPlayer * player;
    ...
    func_0201a680(seqPlayer);
    seqPlayer->commandTag = func_020089e8();
