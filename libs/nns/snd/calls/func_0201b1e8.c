...
extern void func_0201b838(void * mem, u32 size, u32 data1, u32 data2);
extern void func_0201b844(void * mem, u32 size, u32 data1, u32 data2);
extern void func_0201b850(void * mem, u32 size, u32 data1, u32 data2);
extern void func_0201b838 (void * mem, u32 size, u32 data1, u32 data2);
extern void func_0201b844 (void * mem, u32 size, u32 data1, u32 data2);
extern void func_0201b850 (void * mem, u32 size, u32 data1, u32 data2);

/* func_0201b1e8 -- NitroSystem sndarc.c: NNS_SndArcSetup. */
BOOL func_0201b1e8 (NNSSndArc * arc, NNSSndHeapHandle heap, BOOL symbolLoadFlag)
{
    BOOL result;
    s32 readSize;
    ...
    if (heap != NNS_SND_HEAP_INVALID_HANDLE) {
        ...
        arc->info = (NNSSndArcInfo *)func_0201b9a0(heap, arc->header.infoSize, func_0201b838, (u32)arc, 0);
        ...
        if (symbolLoadFlag && arc->header.symbolDataSize > 0) {
            arc->symbol = (NNSSndArcSymbol *)func_0201b9a0(heap, arc->header.symbolDataSize, func_0201b850, (u32)arc, 0);
