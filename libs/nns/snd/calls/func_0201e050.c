...
/* func_0201e050 -- NitroSystem sndarc_stream.c: OpenMemoryStream. */
BOOL func_0201e050 (NNSSndStrmPlayer * player, u32 fileId)
{
    player->fileOffset = (u32)func_0201b7e0(fileId);
