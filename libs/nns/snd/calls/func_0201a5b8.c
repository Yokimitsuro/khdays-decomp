...
extern void func_0201a8e0(NNSSndSeqPlayer * seqPlayer, int priority);
extern void func_0201a76c (NNSSndSeqPlayer * seqPlayer);
extern void func_0201a8e0 (NNSSndSeqPlayer * seqPlayer, int priority);

/* func_0201a5b8 -- NitroSystem player.c: NNSi_SndPlayerStopSeq. */
void func_0201a5b8 (NNSSndSeqPlayer * seqPlayer, int fadeFrame)
{
    ...
    func_0201e144(&seqPlayer->fader, 0, fadeFrame);
    func_0201a8e0(seqPlayer, 0);
