...
void func_0201acbc(NNSSndStrm * stream, int chNo, int pan);
...
extern NNSSndStrmPlayer * func_0201cd60(NNSSndStrmHandle * handle, int playerNo, int playerPrio);
extern void func_0201cdec(NNSSndStrmPlayer * player);
extern BOOL func_0201d1dc(NNSSndStrmPlayer * player, int numChannels, const u8 chNoList[]);
extern void func_0201d214(NNSSndStrmPlayer * player);
extern void func_0201d460(NNSSndStrmCallbackStatus status, int numChannels, void * buffer[], u32 len, NNSSndStrmFormat format, void * arg);
extern void func_0201df04(NNSSndStrmPlayer * player, u32 fileId);
extern NNSSndStrmPlayer * func_0201cd60 (NNSSndStrmHandle * handle, int playerNo, int prio);
extern void func_0201cdec (NNSSndStrmPlayer * player);
extern BOOL func_0201d1dc (NNSSndStrmPlayer * player, int numChannels, const u8 chNoList[]);
extern void func_0201d214 (NNSSndStrmPlayer * player);
extern void func_0201d460 (NNSSndStrmCallbackStatus status, int numChannels, void * buffer[], u32 len, NNSSndStrmFormat, void * arg);
extern void func_0201df04 (NNSSndStrmPlayer * player, u32 fileId);
...
/* func_0201ce18 -- NitroSystem sndarc_stream.c: PrepareStrm. */
BOOL func_0201ce18 (struct NNSSndStrmHandle * handle, const NNSSndArcStrmInfo * strmInfo, int playerNo, int playerPrio, int strmNo, u32 offset, NNSSndStrmCallback strmCallback, void * strmCallbackArg, NNSSndArcStrmCallback sndArcStrmCallback, void * sndArcStrmCallbackArg)
{
    ...
    player = func_0201cd60(handle, playerNo, playerPrio);
    if (player == NULL) return FALSE;

    func_0201df04(player, strmInfo->fileId);

    if (!player->openStreamFunc(player, strmInfo->fileId)) {
        func_0201cdec(player);
        return FALSE;
    }
    ...
    func_0201e12c(&player->fader);
    func_0201e144(&player->fader, 127 << 8, 1);
    ...
    ret = func_0201d1dc(player, numChannels, player->chNoList);
    if (!ret) {
    ...
    if (numChannels == 2) {
        func_0201acbc(&player->stream, 0, 0);
        func_0201acbc(&player->stream, 1, 127);
    }
