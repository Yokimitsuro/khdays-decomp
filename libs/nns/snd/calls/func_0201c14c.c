...
extern void func_0201c334(void * mem, u32 size, u32 data1, u32 data2);
...
/* func_0201c14c -- NitroSystem sndarc_loader.c: LoadWaveArcTable. */
SNDWaveArc * func_0201c14c (u32 fileId, NNSSndHeapHandle heap, BOOL bSetAddr)
{
    ...
    waveArc = (SNDWaveArc *)func_0201b7e0(fileId);
    if (waveArc == NULL) {
        if (func_0201b6f4(fileId, &data_0204ad50, 0x3c, 0) != 0x3c) {
            return NULL;
        }
        ...
        result = func_0201b6f4(fileId, waveArc, (s32)(tableSize + 0x3c), 0);
