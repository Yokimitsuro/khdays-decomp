...
extern NNSSndArcLoadResult func_0201bc4c (int seqNo, u32 loadFlag, NNSSndHeapHandle heap, BOOL bSetAddr, struct NNSSndSeqData ** pData);

/* func_0201bbc8 -- NitroSystem sndarc_loader.c: NNS_SndArcLoadSeq. */
BOOL func_0201bbc8 (int seqNo, NNSSndHeapHandle heap)
{
    NNSSndArcLoadResult result;

    result = func_0201bc4c(seqNo, NNS_SND_ARC_LOAD_ALL, heap, TRUE, NULL);
