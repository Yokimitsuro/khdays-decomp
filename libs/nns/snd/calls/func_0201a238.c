...
s16 func_02008d1c(int playerNo, int varNo);
struct SNDExChannel;
typedef struct {
    void * prevObject;
    void * nextObject;
...
/* func_0201a238 -- NitroSystem player.c: NNS_SndPlayerReadVariable. */
BOOL func_0201a238 (NNSSndHandle * handle, int varNo, s16 * var)
{
    ...
    *var = func_02008d1c(seqPlayer->playerNo, varNo);
    return TRUE;
}
