...
/* func_0201c254 -- NitroSystem sndarc_loader.c: DisposeCallback. */
void func_0201c254 (void * mem, NNSSndArc * arc, u32 fileId)
{
    NNSSndArc * oldArc;
    OSIntrMode old;
    ...
    if (mem == func_0201b7e0(fileId)) {
        func_0201b808(fileId, NULL);
    }
