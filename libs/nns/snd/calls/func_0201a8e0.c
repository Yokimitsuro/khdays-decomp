...
extern void func_0201a718(NNSSndSeqPlayer * seqPlayer);
extern void func_0201a6c8 (NNSSndPlayer * player, NNSSndSeqPlayer * seqPlayer);
extern void func_0201a718 (NNSSndSeqPlayer * seqPlayer);

/* func_0201a8e0 -- NitroSystem player.c: SetPlayerPriority. */
void func_0201a8e0 (NNSSndSeqPlayer * seqPlayer, int priority)
{
    NNSSndPlayer * player;
