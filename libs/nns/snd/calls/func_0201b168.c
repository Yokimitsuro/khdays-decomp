...
extern BOOL func_0201b1e8 (NNSSndArc * arc, NNSSndHeapHandle heap, BOOL symbolLoadFlag);

/* khdays: shared-bss */
NNSSndArc * data_0204ad4c = 0;   /* sCurrent */

/* func_0201b168 -- NitroSystem sndarc.c: NNS_SndArcInit. */
void func_0201b168 (NNSSndArc * arc, const char * filePath, NNSSndHeapHandle heap, BOOL symbolLoadFlag)
{
    BOOL result;
    ...
    result = func_0201b1e8(arc, heap, symbolLoadFlag);
    if (!result) return;
