...
extern void func_0201c2ac(void * mem, u32 size, u32 data1, u32 data2);
extern void * func_0201befc (u32 fileId, NNSSndHeapDisposeCallback callback, u32 data1, u32 data2, NNSSndHeapHandle heap);
extern void func_0201c2ac (void * mem, u32 size, u32 data1, u32 data2);

/* func_0201c008 -- NitroSystem sndarc_loader.c: LoadSeqArc. */
NNSSndSeqArc * func_0201c008 (u32 fileId, NNSSndHeapHandle heap, BOOL bSetAddr)
{
    void * buffer;

    buffer = func_0201b7e0(fileId);
    if (buffer == NULL) {
