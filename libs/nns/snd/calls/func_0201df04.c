...
extern BOOL func_0201df84(NNSSndStrmPlayer * player, u32 fileId);
extern void func_0201dff8(NNSSndStrmPlayer * player);
extern s32 func_0201e008(NNSSndStrmPlayer * player, void * dest, u32 size, u32 offset);
extern void func_0201e040(NNSSndStrmPlayer * player);
extern BOOL func_0201e050(NNSSndStrmPlayer * player, u32 fileId);
extern void func_0201e078(NNSSndStrmPlayer * player);
extern s32 func_0201e07c(NNSSndStrmPlayer * player, void * dest, u32 size, u32 offset);
extern void func_0201e098(NNSSndStrmPlayer * player);
extern BOOL func_0201df84 (NNSSndStrmPlayer * player, u32 fileId);
extern void func_0201dff8 (NNSSndStrmPlayer * player);
extern s32 func_0201e008 (NNSSndStrmPlayer * player, void * dest, u32 size, u32 offset);
extern void func_0201e040 (NNSSndStrmPlayer * player);
...
/* func_0201df04 -- NitroSystem sndarc_stream.c: SetupStreamFunction. */
void func_0201df04 (NNSSndStrmPlayer * player, u32 fileId)
{
    if (func_0201b7e0(fileId) == NULL) {
        player->openStreamFunc = func_0201df84;
        player->closeStreamFunc = func_0201dff8;
        player->readStreamFunc = func_0201e008;
        player->cancelStreamFunc = func_0201e040;
    } else {
        player->openStreamFunc = func_0201e050;
        player->closeStreamFunc = func_0201e078;
        player->readStreamFunc = func_0201e07c;
        player->cancelStreamFunc = func_0201e098;
    }
