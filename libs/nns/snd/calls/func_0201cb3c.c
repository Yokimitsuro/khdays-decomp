...
void func_0201cb1c(struct NNSSndStrmHandle * handle);
...
extern BOOL func_0201cac0 (struct NNSSndStrmHandle * handle, int strmNo, u32 offset);
extern void func_0201cb1c (NNSSndStrmHandle * handle);
...
/* func_0201cb3c -- NitroSystem sndarc_stream.c: NNS_SndArcStrmStart. */
BOOL func_0201cb3c (NNSSndStrmHandle * handle, int strmNo, u32 offset)
{
    BOOL result;


    result = func_0201cac0(handle, strmNo, offset);
    if (!result) return FALSE;

    func_0201cb1c(handle);
