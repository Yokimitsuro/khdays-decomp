...
/* func_0201a124 -- NitroSystem player.c: NNS_SndPlayerMoveVolume. */
void func_0201a124 (NNSSndHandle * handle, int targetVolume, int frames)
{
    ...
    func_0201e144(&handle->player->fader, targetVolume << FADER_SHIFT, frames);
}
