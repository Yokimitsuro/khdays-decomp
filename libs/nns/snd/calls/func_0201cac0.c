...
const NNSSndArcStrmInfo * func_0201b578(int strmNo);
...
extern BOOL func_0201ce18(NNSSndStrmHandle * handle, const NNSSndArcStrmInfo * strmInfo, int playerNo, int playerPrio, int strmNo, u32 offset, NNSSndStrmCallback strmCallback, void * strmCallbackArg, NNSSndArcStrmCallback sndArcStrmCallback, void * sndArcStrmCallbackArg);
extern BOOL func_0201ce18 (struct NNSSndStrmHandle * handle, const NNSSndArcStrmInfo * strmInfo, int playerNo, int playerPrio, int strmNo, u32 offset, NNSSndStrmCallback strmCallback, void * strmCallbackArg, NNSSndArcStrmCallback sndArcStrmCallback, void * sndArcStrmCallbackArg);
...
/* func_0201cac0 -- NitroSystem sndarc_stream.c: NNS_SndArcStrmPrepare. */
BOOL func_0201cac0 (struct NNSSndStrmHandle * handle, int strmNo, u32 offset)
{
    const NNSSndArcStrmInfo * strmInfo;


    strmInfo = func_0201b578(strmNo);
    if (strmInfo == NULL) return FALSE;

    return func_0201ce18(
        handle,
        strmInfo,
        strmInfo->playerNo,
        strmInfo->playerPrio,
