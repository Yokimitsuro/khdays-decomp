...
void func_02008158(int playerNo, int varNo, s16 var);
struct SNDExChannel;
typedef struct {
    void * prevObject;
    void * nextObject;
...
/* func_0201a284 -- NitroSystem player.c: NNS_SndPlayerWriteVariable. */
BOOL func_0201a284 (NNSSndHandle * handle, int varNo, s16 var)
{

    if (!NNS_SndHandleIsValid(handle)) return FALSE;

    func_02008158(handle->player->playerNo, varNo, var);
