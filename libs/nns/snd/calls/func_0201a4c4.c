...
void func_0201a070(NNSSndHandle * handle);
...
extern void func_0201a76c(NNSSndSeqPlayer * seqPlayer);
extern NNSSndSeqPlayer * func_0201a7a4(int prio);
extern void func_0201a6c8(NNSSndPlayer * player, NNSSndSeqPlayer * seqPlayer);
extern void func_0201a070 (NNSSndHandle * handle);
extern void func_0201a6c8 (NNSSndPlayer * player, NNSSndSeqPlayer * seqPlayer);
extern void func_0201a76c (NNSSndSeqPlayer * seqPlayer);
extern NNSSndSeqPlayer * func_0201a7a4 (int prio);

/* func_0201a4c4 -- NitroSystem player.c: NNSi_SndPlayerAllocSeqPlayer. */
NNSSndSeqPlayer * func_0201a4c4 (NNSSndHandle * handle, int playerNo, int prio)
{
    ...
    if (player->playerList.numObjects >= player->playableSeqCount) {
        ...
        func_0201a76c(seqPlayer);
    }

    seqPlayer = func_0201a7a4(prio);
    if (seqPlayer == NULL) return NULL;

    func_0201a6c8(player, seqPlayer);
