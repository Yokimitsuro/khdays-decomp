...
extern void func_0201a80c(NNSSndSeqPlayer * seqPlayer);
extern void func_0201a76c(NNSSndSeqPlayer * seqPlayer);
extern void func_0201a76c (NNSSndSeqPlayer * seqPlayer);
extern void func_0201a80c (NNSSndSeqPlayer * seqPlayer);

/* func_0201a360 -- NitroSystem player.c: NNSi_SndPlayerMain. */
void func_0201a360 (void)
{
    ...
    for (seqPlayer = (NNSSndSeqPlayer *)NNS_FndGetNextListObject(&data_0204a314, NULL);
        ...
        if (!seqPlayer->startFlag) {
            if (func_02008a14(seqPlayer->commandTag)) {
        ...
        if (seqPlayer->status == NNS_SND_SEQ_PLAYER_STATUS_FADEOUT) {
            if (func_0201e1b8(&seqPlayer->fader)) {
