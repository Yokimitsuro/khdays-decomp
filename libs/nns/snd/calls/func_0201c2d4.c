...
void func_02008f44(struct SNDBankData * bank);
struct SNDBankData;
enum {
...
extern void func_0201c254(void * mem, NNSSndArc * arc, u32 fileId);
extern void func_0201c254 (void * mem, NNSSndArc * arc, u32 fileId);

/* func_0201c2d4 -- NitroSystem sndarc_loader.c: BankDisposeCallback. */
void func_0201c2d4 (void * mem, u32 size, u32 data1, u32 data2)
{
    SNDBankData * bank = (SNDBankData *)mem;
    NNSSndArc * arc = (NNSSndArc *)data1;
    u32 fileId = data2;

    func_0201c254(mem, arc, fileId);
