...
extern void func_0201a890(void * mem, u32 size, u32 data1, u32 data2);
extern void func_0201a890 (void * mem, u32, u32, u32);

/* func_02019e08 -- NitroSystem player.c: NNS_SndPlayerCreateHeap. */
BOOL func_02019e08 (int playerNo, NNSSndHeapHandle heap, u32 size)
{
    ...
    buffer = func_0201b9a0(heap, sizeof(NNSSndPlayerHeap) + size, func_0201a890, 0, 0);
    if (buffer == NULL) {
        return FALSE;
    }
    ...
    playerHeapHandle = func_0201b85c(
