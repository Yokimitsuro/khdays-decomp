...
extern void func_0201d0e0(NNSSndStrmPlayer * player);
extern void func_0201d3c4(void * mem, u32 size, u32 data1, u32 data2);
extern void func_0201d0e0 (NNSSndStrmPlayer * player);
extern void func_0201d3c4 (void * mem, u32, u32 data1, u32);
...
/* func_0201c9f8 -- NitroSystem sndarc_stream.c: NNS_SndArcStrmSetupPlayer. */
BOOL func_0201c9f8 (NNSSndHeapHandle heap)
{
    int playerNo;
    ...
    for (playerNo = 0; playerNo < NNS_SND_STRM_PLAYER_NUM; ++playerNo) {
        ...
        playerInfo = func_0201b640(playerNo);
        ...
        if (heap != NNS_SND_HEAP_INVALID_HANDLE) {
            ...
            buffer = func_0201b9a0(heap, bufSize, func_0201d3c4, (u32)player, 0);
            if (buffer == NULL) return FALSE;

            func_0201d0e0(player);
