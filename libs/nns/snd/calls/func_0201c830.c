...
/* func_0201c830 -- NitroSystem sndarc_player.c: StartSeqArc. */
BOOL func_0201c830 (NNSSndHandle * handle, int playerNo, int bankNo, int playerPrio, const NNSSndSeqArcSeqInfo * sound, const NNSSndSeqArc * seqArc, int seqArcNo, int index)
{
    ...
    func_0201a110(handle, sound->param.volume);
    func_0201a150(handle, sound->param.channelPrio);
    func_0201a1e4(handle, seqArcNo, index);
