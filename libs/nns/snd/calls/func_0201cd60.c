...
void func_0201cbd0(struct NNSSndStrmHandle * handle);
...
extern void func_0201cbd0 (NNSSndStrmHandle * handle);
extern void func_0201d0e0 (NNSSndStrmPlayer * player);
...
/* func_0201cd60 -- NitroSystem sndarc_stream.c: AllocPlayer. */
NNSSndStrmPlayer * func_0201cd60 (NNSSndStrmHandle * handle, int playerNo, int prio)
{
