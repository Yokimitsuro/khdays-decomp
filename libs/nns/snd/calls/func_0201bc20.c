...
/* func_0201bc20 -- NitroSystem sndarc_loader.c: NNS_SndArcLoadBank. */
BOOL func_0201bc20 (int bankNo, NNSSndHeapHandle heap)
{
    NNSSndArcLoadResult result;

    result = func_0201bd30(bankNo, NNS_SND_ARC_LOAD_ALL, heap, TRUE, NULL);
