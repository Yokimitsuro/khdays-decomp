...
extern NNSSndArcLoadResult func_0201bcd0 (int seqArcNo, u32 loadFlag, NNSSndHeapHandle heap, BOOL bSetAddr, struct NNSSndSeqArc ** pData);

/* func_0201bbf4 -- NitroSystem sndarc_loader.c: NNS_SndArcLoadSeqArc. */
BOOL func_0201bbf4 (int seqArcNo, NNSSndHeapHandle heap)
{
    NNSSndArcLoadResult result;

    result = func_0201bcd0(seqArcNo, NNS_SND_ARC_LOAD_ALL, heap, TRUE, NULL);
