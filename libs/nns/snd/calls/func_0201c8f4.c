...
/* func_0201c8f4 -- NitroSystem sndarc_stream.c: NNS_SndArcStrmInit. */
void func_0201c8f4 (u32 threadPrio, NNSSndHeapHandle heap)
{
    int i;
    int playerNo;
    ...
    func_0201d238(&data_0204b140, threadPrio);
}
