...
void func_02008180(int playerNo, u32 trackBitMask, int volume);
struct SNDExChannel;
...
/* func_0201a170 -- NitroSystem player.c: NNS_SndPlayerSetTrackVolume. */
void func_0201a170 (NNSSndHandle * handle, u16 trackBitMask, int volume)
{
