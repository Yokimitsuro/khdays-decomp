...
void func_0200d5d8(PMSleepCallbackInfo * info);
void func_0200d5f0(PMSleepCallbackInfo * info);
typedef struct {
    void * prevObject;
    void * nextObject;
} NNSFndLink;
...
extern void func_0201ad60(NNSSndStrm * stream);
extern void func_0201ad60 (NNSSndStrm * stream);

/* func_0201acec -- NitroSystem stream.c: ForceStopStrm. */
void func_0201acec (NNSSndStrm * stream)
{
    u32 commandTag;
    ...
    if (stream->startFlag) {
        ...
        func_0200d5d8(&stream->preSleepInfo);
        func_0200d5f0(&stream->postSleepInfo);
