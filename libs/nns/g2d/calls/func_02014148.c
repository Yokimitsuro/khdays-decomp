...
extern void func_02013ffc (NNSG2dCharCanvas * pCC, void * charBase, int areaWidth, int areaHeight, NNSG2dCharaColorMode colorMode, const NNSiG2dCharCanvasVTable * vtable, u32 param);

/* func_02014148 -- NitroSystem g2d_CharCanvas.c: NNS_G2dCharCanvasInitForBG. */
void func_02014148 (NNSG2dCharCanvas * pCC, void * charBase, int areaWidth, int areaHeight, NNSG2dCharaColorMode colorMode)
{
