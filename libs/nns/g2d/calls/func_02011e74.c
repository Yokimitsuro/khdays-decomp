...
void func_02011eb4(NNSG2dAnimCallBackFunctor * pCallBack);
extern void func_02011eb4 (NNSG2dCallBackFunctor * pCallBack);

/* func_02011e74 -- NitroSystem g2d_Animation.c: NNS_G2dInitAnimCtrl. */
void func_02011e74 (NNSG2dAnimController * pAnimCtrl)
{

    func_02011eb4(&pAnimCtrl->callbackFunctor);
