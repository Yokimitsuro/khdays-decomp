...
/* func_020132d8 -- NitroSystem g2d_Screen.c: LoadScreenPartAffine. */
void func_020132d8 (void * pScreenDst, const NNSG2dScreenData * pScnData, int srcX, int srcY, int dstX, int dstY, int dstW, int width, int height)
{
