...
extern BOOL func_02011c44 (NNSG2dAnimController * pAnimCtrl, u16 index);

/* func_02011e3c -- NitroSystem g2d_Animation.c: NNS_G2dSetAnimCtrlCurrentFrame. */
BOOL func_02011e3c (NNSG2dAnimController * pAnimCtrl, u16 index)
{
    {
        const BOOL result = func_02011c44(pAnimCtrl, index);
