...
extern void func_02012ca8 (NNSG2dBGSelect n, GXBGScrSize256x16Pltt size, GXBGAreaOver areaOver, GXBGScrBase scnBase, GXBGCharBase chrBase);

/* func_02012da4 -- NitroSystem g2d_Screen.c: SetBGControl256x16Pltt. */
void func_02012da4 (NNSG2dBGSelect bg, int screenWidth, int screenHeight, GXBGScrBase scnBase, GXBGCharBase chrBase)
{
    const ScreenSizeMap * pSizeMap;


    pSizeMap = func_02012880(data_02041a24, screenWidth, screenHeight);

    func_02012ca8(bg, (GXBGScrSize256x16Pltt)pSizeMap->scnSize, data_02047390, scnBase, chrBase);
}
