...
const NNSG2dCharWidths * func_0201371c(const NNSG2dFont * pFont, u16 idx);
...
{
    const u16 idx = func_020136d4(pFont, c);
...
inline const NNSG2dCharWidths * NNS_G2dFontGetCharWidths (const NNSG2dFont * pFont, u16 c)
{
    ...
    return func_0201371c(pFont, iGlyph);
}
...
extern u16 func_020136d4 (const NNSG2dFont * pFont, u16 c);
extern const NNSG2dCharWidths * func_0201371c (const NNSG2dFont * pFont, u16 idx);

/* func_02013768 -- NitroSystem g2d_Font.c: NNSi_G2dFontGetStringWidth. */
