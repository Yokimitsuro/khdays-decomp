...
void func_02011e74(NNSG2dAnimController * pAnimCtrl);
...
void func_0201231c(NNSG2dSRTControl * pCtrl, NNSG2dSRTControlType type);
static inline void InitCellAnimationImpl_ (NNSG2dCellAnimation * pCellAnim, const NNSG2dAnimSequence * pAnimSeq, const NNSG2dCellDataBank * pCellDataBank, u32 cellTransferStateHandle)
{
    ...
    func_02011e74(&pCellAnim->animCtrl);
    func_02012480(pCellAnim, pAnimSeq);
}
extern void func_02012480 (NNSG2dCellAnimation * pCellAnim, const NNSG2dAnimSequence * pAnimSeq);

/* func_02012444 -- NitroSystem g2d_CellAnimation.c: NNS_G2dInitCellAnimation. */
void func_02012444 (NNSG2dCellAnimation * pCellAnim, const NNSG2dAnimSequence * pAnimSeq, const NNSG2dCellDataBank * pCellDataBank)
{
