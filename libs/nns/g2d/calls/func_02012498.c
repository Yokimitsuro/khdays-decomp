...
/* func_02012498 -- NitroSystem g2d_CellAnimation.c: NNS_G2dTickCellAnimation. */
void func_02012498 (NNSG2dCellAnimation * pCellAnim, fx32 frames)
{

    if ( func_02011c88(&pCellAnim->animCtrl, frames)) {
