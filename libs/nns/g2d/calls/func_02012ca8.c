...
/* func_02012ca8 -- NitroSystem g2d_Screen.c: SetBGnControlTo256x16Pltt. */
void func_02012ca8 (NNSG2dBGSelect n, GXBGScrSize256x16Pltt size, GXBGAreaOver areaOver, GXBGScrBase scnBase, GXBGCharBase chrBase)
{
    if (IsMainBG(n)) {
        func_020128c0(data_020419f4[n - 2]);
    } else {
        func_02012904(data_020419f4[n - 6]);
    }
