...
inline void NNSi_G2dDmaCopy16 (u32 dmaNo, const void * src, void * dest, u32 size)
{
    if (dmaNo != ((u32) ~0) ) {
...
inline int GetBGCharOffset (void)
{
    return (int)(0x10000 * (((*( REGType32v *) (0x04000000 + 0x000)) & 0x07000000 ) >>
                            24 ));
}
inline void * GetBGnCharPtr (NNSG2dBGSelect n)
{
    const int baseBlock = 0x4000 * ((*GetBGnCNT(n) & 0x003c ) >>
                                    2 );
    return (void *)((IsMainBG(n) ? (0x06000000 + GetBGCharOffset()): 0x06200000 ) + baseBlock);
}
inline void LoadBGnChar (NNSG2dBGSelect n, const void * pSrc, u32 offset, u32 szByte)
{
    u32 ptr;
    ((void) 0); ;
    ptr = (u32)GetBGnCharPtr(n);
    NNSi_G2dDmaCopy16(data_020422b8, pSrc, (void *)(ptr + offset), szByte);
}

/* func_02012e90 -- NitroSystem g2d_Screen.c: LoadBGCharacter. */
void func_02012e90 (NNSG2dBGSelect bg, const NNSG2dCharacterData * pChrData, const NNSG2dCharacterPosInfo * pPosInfo)
{
    u32 offset = 0;
