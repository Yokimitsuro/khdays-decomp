...
extern void func_02012b98 (NNSG2dBGSelect n, GXBGScrSizeText size, GXBGColorMode cmode, GXBGScrBase scnBase, GXBGCharBase chrBase);

/* func_02012d24 -- NitroSystem g2d_Screen.c: SetBGControlText. */
void func_02012d24 (NNSG2dBGSelect bg, GXBGColorMode colorMode, int screenWidth, int screenHeight, GXBGScrBase scnBase, GXBGCharBase chrBase)
{
    const ScreenSizeMap * pSizeMap;


    pSizeMap = func_02012880(data_02041a54, screenWidth, screenHeight);

    func_02012b98(bg, (GXBGScrSizeText)pSizeMap->scnSize, colorMode, scnBase, chrBase);
}
