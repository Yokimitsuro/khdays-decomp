...
BOOL func_02011e3c(NNSG2dAnimController * pAnimCtrl, u16 index);
...
/* func_020124b8 -- NitroSystem g2d_CellAnimation.c: NNS_G2dSetCellAnimationCurrentFrame. */
void func_020124b8 (NNSG2dCellAnimation * pCellAnim, u16 frameIndex)
{

    if ( func_02011e3c(&pCellAnim->animCtrl, frameIndex)) {
