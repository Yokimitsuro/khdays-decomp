...
/* func_02013340 -- NitroSystem g2d_Screen.c: LoadScreenPart256x16Pltt. */
void func_02013340 (void * pScreenDst, const NNSG2dScreenData * pScnData, int srcX, int srcY, int dstX, int dstY, int dstW, int width, int height)
{
