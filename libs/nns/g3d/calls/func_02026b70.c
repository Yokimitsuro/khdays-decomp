...
extern const u8 data_020420ac[9][4];   /* pivotUtil_ */
#define pivotUtil_ data_020420ac
extern void MI_Zero36B(void * pDest);

/* func_02026b70 -- NitroSystem getMdlRot_, the copy with its own pivotUtil_ table: the node flags
 * are read once into a local and the pivot row is taken once. */
void func_02026b70 (NNSG3dJntAnmResult * pResult)
{
    u16 flag;
    const u8 * p;
