...
/* func_02014abc -- NitroSystem kernel.c: NNS_G3dAnmObjInit. */
void func_02014abc (NNSG3dAnmObj * pAnmObj, void * pResAnm, const NNSG3dResMdl * pResMdl, const NNSG3dResTex * pResTex)
{
