...
extern BOOL func_02014d50 (NNSG3dAnmObj ** l, NNSG3dAnmObj * item);

/* func_02014dc4 -- NitroSystem kernel.c: NNS_G3dRenderObjRemoveAnmObj. */
void func_02014dc4 (NNSG3dRenderObj * pRenderObj, NNSG3dAnmObj * pAnmObj)
{

    if (func_02014d50(&pRenderObj->anmMat, pAnmObj) ||
        func_02014d50(&pRenderObj->anmJnt, pAnmObj) ||
        func_02014d50(&pRenderObj->anmVis, pAnmObj)) {
