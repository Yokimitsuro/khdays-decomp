...
extern void func_02016b60 (NNSG3dResMdl * pMdl, u32 matID, int polygonID);

/* func_02016cd0 -- NitroSystem model.c: NNS_G3dMdlSetMdlPolygonIDAll. */
void func_02016cd0 (NNSG3dResMdl * pMdl, int polygonID)
{
    u32 matID;
    for (matID = 0; matID < pMdl->info.numMat; ++matID) {
        func_02016b60(pMdl, matID, polygonID);
    }
}
