...
#define getRotDataByIdx_ func_020186c4
extern void func_01ff8d18(const VecFx32 * pSrc, VecFx32 * pDst);   /* VEC_Normalize */
#define VEC_Normalize func_01ff8d18

/* func_02018380 -- NitroSystem nsbca.c: getRotDataEx_. */
void func_02018380 (MtxFx33 * pRot, fx32 Frame, const u32 * pData, const NNSG3dResJntAnm * pJntAnm)
{
