...
extern void func_02015280 (NNSG3dResMat * pMat, NNSG3dResDictPlttToMatIdxData * pBindData, const NNSG3dResTex * pTex, const NNSG3dResDictPlttData * pPlttData);

/* func_02015360 -- NitroSystem kernel.c: NNS_G3dBindMdlPltt. */
