...
extern void func_02017584(const NNSG3dResJntAnm * pJntAnm, u32 dataIdx, fx32 Frame, NNSG3dJntAnmResult * pResult);
extern void func_02017584 (const NNSG3dResJntAnm * pJntAnm, u32 dataIdx, fx32 Frame, NNSG3dJntAnmResult * pResult);

/* func_020172a0 -- NitroSystem nsbca.c: NNSi_G3dAnmCalcNsBca. */
void func_020172a0 (NNSG3dJntAnmResult * pResult, const NNSG3dAnmObj * pAnmObj, u32 dataIdx)
{

    {
        ...
        func_02017584(anm, dataIdx, frame, pResult);
    }
}
