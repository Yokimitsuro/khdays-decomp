...
files = []
for pat in ("src/overlays/ov000/calls/*.c", "src/overlays/ov002/calls/*.c",
            "src/overlays/ov000/auto/*.c", "src/overlays/ov002/auto/*.c"):
    files.extend(glob.glob(pat))
files = [f for f in files if os.path.getsize(f) > 2500]
