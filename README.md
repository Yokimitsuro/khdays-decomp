...
| SDK/library byte-match identifications | **438** / ~23,240 (~1.9%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **7,183** / ~23,240 (~30.9%) | Functions known to the project but not implemented as C |
