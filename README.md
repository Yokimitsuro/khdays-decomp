...
| SDK/library byte-match identifications | **182** / ~23,240 (~0.8%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **4,516** / ~23,240 (~19.4%) | Functions known to the project but not implemented as C |
