...
|---|---:|---|
| Real C-decompiled matched functions | **21,624** / ~23,235 (~93.1% by function count) | Functions implemented in C and verified byte-exact |
...
| SDK/library byte-match identifications | **40** / ~23,235 (~0.2%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **1,461** / ~23,235 (~6.3%) | Functions known to the project but not implemented as C |
