...
|---|---:|---|
| Real C-decompiled matched functions | **11,782** / ~23,240 (~50.7% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **1,148,794** / 4,728,790 (~24.29% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **7,522** / ~23,240 (~32.4%) | Functions known to the project but not implemented as C |
