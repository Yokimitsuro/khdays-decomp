...
| SDK/library byte-match identifications | **58** / ~23,236 (~0.2%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **2,414** / ~23,236 (~10.4%) | Functions known to the project but not implemented as C |
| Initialized DATA | **138,760** / 188,336 (**73.68%**) | Byte/relocation-verified `.rodata`/`.data`; includes the separately reported MobiClip executable payload at 26,012/26,012 bytes. |
