...
|---|---:|---|
| Real C-decompiled matched functions | **11,231** / ~23,240 (~48.3% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **1,026,060** / 4,728,790 (~21.70% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **8,068** / ~23,240 (~34.7%) | Functions known to the project but not implemented as C |
