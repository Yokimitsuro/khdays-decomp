...
|---|---:|---|
| Real C-decompiled matched functions | **3,140** / ~23,159 (~13.6%) | Functions implemented in C and verified byte-exact |
| Inline ASM / ASM stub matched functions | **6,832** / ~23,159 (~29.5%) | Temporary ASM-based placeholders; useful for matching, not counted as C decompilation |
