...
| SDK/library byte-match identifications | **351** / ~23,240 (~1.5%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **6,255** / ~23,240 (~26.9%) | Functions known to the project but not implemented as C |
