...
| SDK/library byte-match identifications | **43** / ~23,235 (~0.2%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **1,596** / ~23,235 (~6.9%) | Functions known to the project but not implemented as C |
