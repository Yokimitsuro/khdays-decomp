...
| SDK/library byte-match identifications | **437** / ~23,240 (~1.9%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **7,076** / ~23,240 (~30.4%) | Functions known to the project but not implemented as C |
