...
| Named but not decompiled | **791** / ~23,235 (~3.4%) | Functions known to the project but not implemented as C |
| Initialized DATA | **161,506** / 188,340 (**85.75%**) | Byte/relocation-verified `.rodata`/`.data`; includes the separately reported MobiClip executable payload at 26,012/26,012 bytes. |
