...
| Named but not decompiled | **1,281** / ~23,235 (~5.5%) | Functions known to the project but not implemented as C |
| Initialized DATA | **140,534** / 188,340 (**74.62%**) | Byte/relocation-verified `.rodata`/`.data`; includes the separately reported MobiClip executable payload at 26,012/26,012 bytes. |
