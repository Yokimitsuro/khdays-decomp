...
|---|---:|---|
| Real C-decompiled matched functions | **11,858** / ~23,240 (~51.0% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **1,191,290** / 4,728,790 (~25.19% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **7,446** / ~23,240 (~32.0%) | Functions known to the project but not implemented as C |
