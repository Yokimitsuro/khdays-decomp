...
| SDK/library byte-match identifications | **35** / ~23,235 (~0.2%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **681** / ~23,235 (~2.9%) | Functions known to the project but not implemented as C |
| Initialized DATA | **168,962** / 188,340 (**89.71%**) | Byte/relocation-verified `.rodata`/`.data`; includes the separately reported MobiClip executable payload at 26,012/26,012 bytes. |
