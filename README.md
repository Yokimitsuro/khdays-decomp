...
|---|---:|---|
| Real C-decompiled matched functions | **11,444** / ~23,240 (~49.2% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **1,056,922** / 4,728,790 (~22.35% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **7,855** / ~23,240 (~33.8%) | Functions known to the project but not implemented as C |
