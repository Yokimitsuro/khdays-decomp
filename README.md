...
| Named but not decompiled | **1,317** / ~23,235 (~5.7%) | Functions known to the project but not implemented as C |
| Initialized DATA | **140,526** / 188,340 (**74.61%**) | Byte/relocation-verified `.rodata`/`.data`; includes the separately reported MobiClip executable payload at 26,012/26,012 bytes. |
