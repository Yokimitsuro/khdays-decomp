...
|---|---:|---|
| Real C-decompiled matched functions | **17,565** / ~23,238 (~75.6% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **3,848** / ~23,238 (~16.6%) | Functions known to the project but not implemented as C |
