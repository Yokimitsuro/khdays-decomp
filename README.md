...
|---|---:|---|
| Real C-decompiled matched functions | **23,029** / ~23,235 (~99.1% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **82** / ~23,235 (~0.4%) | Functions known to the project but not implemented as C |
| Initialized DATA | **178,790** / 188,340 (**94.93%**) | Byte/relocation-verified `.rodata`/`.data`; includes the separately reported MobiClip executable payload at 26,012/26,012 bytes. |
