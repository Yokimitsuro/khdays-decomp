...
|---|---:|---|
| Real C-decompiled matched functions | **17,070** / ~23,240 (~73.5% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **4,240** / ~23,240 (~18.2%) | Functions known to the project but not implemented as C |
