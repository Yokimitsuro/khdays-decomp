...
|---|---:|---|
| Real C-decompiled matched functions | **11,599** / ~23,240 (~49.9% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **1,110,414** / 4,728,790 (~23.48% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **7,703** / ~23,240 (~33.1%) | Functions known to the project but not implemented as C |
