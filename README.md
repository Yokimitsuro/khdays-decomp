...
| SDK/library byte-match identifications | **33** / ~23,235 (~0.1%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **469** / ~23,235 (~2.0%) | Functions known to the project but not implemented as C |
