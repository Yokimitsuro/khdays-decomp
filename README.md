...
|---|---:|---|
| Real C-decompiled matched functions | **11,852** / ~23,240 (~51.0% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **1,186,570** / 4,728,790 (~25.09% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **7,452** / ~23,240 (~32.1%) | Functions known to the project but not implemented as C |
