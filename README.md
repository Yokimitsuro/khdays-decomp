...
|---|---:|---|
| Real C-decompiled matched functions | **13,550** / ~23,240 (~58.3% by function count) | Functions implemented in C and verified byte-exact |
...
| Inline ASM / ASM stub matched functions | **2,503** / ~23,240 (~10.8%) | Temporary ASM-based placeholders under `src/asm_stubs/`; useful for matching, not counted as C decompilation |
