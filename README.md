...
| SDK/library byte-match identifications | **34** / ~23,235 (~0.1%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **515** / ~23,235 (~2.2%) | Functions known to the project but not implemented as C |
