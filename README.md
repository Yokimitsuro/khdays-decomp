...
|---|---:|---|
| Real C-decompiled matched functions | **16,734** / ~23,240 (~72.0% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **4,569** / ~23,240 (~19.7%) | Functions known to the project but not implemented as C |
