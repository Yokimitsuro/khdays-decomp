...
|---|---:|---|
| Real C-decompiled matched functions | **11,402** / ~23,240 (~49.1% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **1,049,782** / 4,728,790 (~22.20% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **7,897** / ~23,240 (~34.0%) | Functions known to the project but not implemented as C |
