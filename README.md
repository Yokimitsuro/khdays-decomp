...
| SDK/library byte-match identifications | **42** / ~23,235 (~0.2%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **1,519** / ~23,235 (~6.5%) | Functions known to the project but not implemented as C |
