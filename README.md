...
|---|---:|---|
| Real C-decompiled matched functions | **18,428** / ~23,237 (~79.3% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **3,122** / ~23,237 (~13.4%) | Functions known to the project but not implemented as C |
