...
|---|---:|---|
| Real C-decompiled matched functions | **12,436** / ~23,240 (~53.5% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **7,247** / ~23,240 (~31.2%) | Functions known to the project but not implemented as C |
