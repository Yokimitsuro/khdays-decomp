...
|---|---:|---|
| Real C-decompiled matched functions | **10,828** / ~23,240 (~46.6% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **962,500** / 4,728,790 (~20.35% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **8,471** / ~23,240 (~36.5%) | Functions known to the project but not implemented as C |
