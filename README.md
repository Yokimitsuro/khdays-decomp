...
| SDK/library byte-match identifications | **37** / ~23,235 (~0.2%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **1,017** / ~23,235 (~4.4%) | Functions known to the project but not implemented as C |
