...
|---|---:|---|
| Real C-decompiled matched functions | **11,379** / ~23,240 (~49.0% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **1,044,108** / 4,728,790 (~22.08% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **7,920** / ~23,240 (~34.1%) | Functions known to the project but not implemented as C |
