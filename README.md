...
| SDK/library byte-match identifications | **137** / ~23,236 (~0.6%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **2,510** / ~23,236 (~10.8%) | Functions known to the project but not implemented as C |
