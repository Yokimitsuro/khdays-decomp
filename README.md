...
|---|---:|---|
| Real C-decompiled matched functions | **11,452** / ~23,240 (~49.3% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **1,058,730** / 4,728,790 (~22.39% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **7,847** / ~23,240 (~33.8%) | Functions known to the project but not implemented as C |
