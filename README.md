...
|---|---:|---|
| Real C-decompiled matched functions | **16,784** / ~23,240 (~72.2% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **4,520** / ~23,240 (~19.4%) | Functions known to the project but not implemented as C |
