...
|---|---:|---|
| Real C-decompiled matched functions | **19,467** / ~23,236 (~83.8% by function count) | Functions implemented in C and verified byte-exact |
...
| Inline ASM / ASM stub matched functions | **1,333** / ~23,236 (~5.7%) | ASM implementations, including temporary game stubs, canonical library assembly and authorized inline exceptions; never counted as real C. Only explicitly verified manifest entries contribute to decomp.dev matching coverage. |
