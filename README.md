...
|---|---:|---|
| Real C-decompiled matched functions | **14,832** / ~23,240 (~63.8% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **5,786** / ~23,240 (~24.9%) | Functions known to the project but not implemented as C |
