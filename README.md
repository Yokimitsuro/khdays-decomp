...
|---|---:|---|
| Real C-decompiled matched functions | **11,488** / ~23,240 (~49.4% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **1,066,534** / 4,728,790 (~22.55% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **7,812** / ~23,240 (~33.6%) | Functions known to the project but not implemented as C |
