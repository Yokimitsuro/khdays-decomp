...
|---|---:|---|
| Real C-decompiled matched functions | **15,062** / ~23,240 (~64.8% by function count) | Functions implemented in C and verified byte-exact |
...
| Inline ASM / ASM stub matched functions | **2,218** / ~23,240 (~9.5%) | Temporary ASM-based placeholders under `src/asm_stubs/`; useful for matching, not counted as C decompilation |
...
| Named but not decompiled | **5,628** / ~23,240 (~24.2%) | Functions known to the project but not implemented as C |
