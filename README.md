...
|---|---:|---|
| Real C-decompiled matched functions | **11,809** / ~23,240 (~50.8% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **1,163,830** / 4,728,790 (~24.61% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **7,495** / ~23,240 (~32.3%) | Functions known to the project but not implemented as C |
