...
| SDK/library byte-match identifications | **47** / ~23,235 (~0.2%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **1,742** / ~23,235 (~7.5%) | Functions known to the project but not implemented as C |
