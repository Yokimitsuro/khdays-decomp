...
| SDK/library byte-match identifications | **48** / ~23,235 (~0.2%) | NitroSDK or library functions identified separately by byte matching |
| Named but not decompiled | **1,774** / ~23,235 (~7.6%) | Functions known to the project but not implemented as C |
| Initialized DATA | **140,270** / 188,340 (**74.48%**) | Byte/relocation-verified `.rodata`/`.data`; includes the separately reported MobiClip executable payload at 26,012/26,012 bytes. |
