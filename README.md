...
|---|---:|---|
| Real C-decompiled matched functions | **3,152** / ~23,159 (~13.6%) | Functions implemented in C and verified byte-exact |
| Inline ASM / ASM stub matched functions | **6,820** / ~23,159 (~29.4%) | Temporary ASM-based placeholders; useful for matching, not counted as C decompilation |
