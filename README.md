...
|---|---:|---|
| Real C-decompiled matched functions | **22,987** / ~23,235 (~98.9% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **114** / ~23,235 (~0.5%) | Functions known to the project but not implemented as C |
