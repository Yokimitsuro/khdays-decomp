...
|---|---:|---|
| Real C-decompiled matched functions | **15,961** / ~23,240 (~68.7% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **5,042** / ~23,240 (~21.7%) | Functions known to the project but not implemented as C |
