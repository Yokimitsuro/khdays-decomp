...
|---|---:|---|
| Real C-decompiled matched functions | **16,664** / ~23,240 (~71.7% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **4,639** / ~23,240 (~20.0%) | Functions known to the project but not implemented as C |
