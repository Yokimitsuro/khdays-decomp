...
| Named but not decompiled | **796** / ~23,235 (~3.4%) | Functions known to the project but not implemented as C |
| Initialized DATA | **141,222** / 188,340 (**74.98%**) | Byte/relocation-verified `.rodata`/`.data`; includes the separately reported MobiClip executable payload at 26,012/26,012 bytes. |
