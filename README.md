...
|---|---:|---|
| Real C-decompiled matched functions | **17,502** / ~23,239 (~75.3% by function count) | Functions implemented in C and verified byte-exact |
...
| Inline ASM / ASM stub matched functions | **1,684** / ~23,239 (~7.2%) | ASM implementations, including temporary game stubs, canonical library assembly and authorized inline exceptions; never counted as real C. Only explicitly verified manifest entries contribute to decomp.dev matching coverage. |
