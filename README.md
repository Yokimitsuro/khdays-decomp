...
|---|---:|---|
| Real C-decompiled matched functions | **3,108** / ~23,159 (~13.4%) | Functions implemented in C and verified byte-exact |
| Inline ASM / ASM stub matched functions | **6,864** / ~23,159 (~29.6%) | Temporary ASM-based placeholders; useful for matching, not counted as C decompilation |
