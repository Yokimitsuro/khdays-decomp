...
|---|---:|---|
| Real C-decompiled matched functions | **3,449** / ~23,240 (~14.8%) | Functions implemented in C and verified byte-exact |
| Inline ASM / ASM stub matched functions | **6,604** / ~23,240 (~28.4%) | Temporary ASM-based placeholders under `src/asm_stubs/`; useful for matching, not counted as C decompilation |
