...
|---|---:|---|
| Real C-decompiled matched functions | **10,810** / ~23,240 (~46.5% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **958,612** / 4,728,790 (~20.27% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **8,489** / ~23,240 (~36.5%) | Functions known to the project but not implemented as C |
