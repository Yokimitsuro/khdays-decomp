...
|---|---:|---|
| Real C-decompiled matched functions | **10,792** / ~23,240 (~46.4% by function count) | Functions implemented in C and verified byte-exact |
| Real C-decompiled matched **bytes** | **954,594** / 4,728,790 (~20.19% by code bytes) | The honest metric — matches how decomp.dev reports progress. Function-count % is inflated because most decomped functions are small trampolines and setters; large semantic functions are still ASM stubs. |
...
| Named but not decompiled | **8,507** / ~23,240 (~36.6%) | Functions known to the project but not implemented as C |
