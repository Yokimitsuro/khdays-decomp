...
|---|---:|---|
| Real C-decompiled matched functions | **12,208** / ~23,240 (~52.5% by function count) | Functions implemented in C and verified byte-exact |
...
| Named but not decompiled | **7,343** / ~23,240 (~31.6%) | Functions known to the project but not implemented as C |
