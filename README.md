...
|---|---:|---|
| Real C-decompiled matched functions | **13,221** / ~23,240 (~56.9% by function count) | Functions implemented in C and verified byte-exact |
...
| Inline ASM / ASM stub matched functions | **2,831** / ~23,240 (~12.2%) | Temporary ASM-based placeholders under `src/asm_stubs/`; useful for matching, not counted as C decompilation |
